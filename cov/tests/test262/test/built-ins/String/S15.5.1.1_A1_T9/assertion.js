...
$assert.sameValue(globalThis["__str"], "__THIS__");
...
$assert.sameValue($Object_getPrototypeOf(globalThis["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["toString"]), true);
$assert.callable(globalThis["toString"]);
$assert.constructable(globalThis["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["toString"]), ['length', 'name', 'prototype'], globalThis["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["toString"]?.["prototype"]), ['constructor'], globalThis["toString"]?.["prototype"]);
$assert.sameValue(globalThis["toString"]?.["prototype"]?.["constructor"], globalThis["toString"]);
$verifyProperty(globalThis["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
