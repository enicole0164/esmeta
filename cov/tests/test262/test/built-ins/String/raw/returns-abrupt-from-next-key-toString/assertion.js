...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["raw"]), ['0', 'length'], globalThis["obj"]?.["raw"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["raw"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["raw"]?.["0"]), true);
$assert.notCallable(globalThis["obj"]?.["raw"]?.["0"]);
$assert.notConstructable(globalThis["obj"]?.["raw"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["raw"]?.["0"]), ['toString'], globalThis["obj"]?.["raw"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]), true);
$assert.callable(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]);
$assert.constructable(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["raw"]?.["0"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["obj"]?.["raw"]?.["0"]?.["toString"]);
$verifyProperty(globalThis["obj"]?.["raw"]?.["0"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["raw"]?.["0"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["raw"]?.["0"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["raw"]?.["0"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["raw"]?.["0"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["raw"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
