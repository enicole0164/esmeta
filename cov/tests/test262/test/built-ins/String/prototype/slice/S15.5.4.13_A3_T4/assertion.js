...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor', 'toString'], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]?.["toString"]), true);
$assert.callable(globalThis["__FACTORY"]?.["prototype"]?.["toString"]);
$assert.constructable(globalThis["__FACTORY"]?.["prototype"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["__FACTORY"]?.["prototype"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["__FACTORY"]?.["prototype"]?.["toString"]);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["toString"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['value', 'slice'], globalThis["__instance"]);
...
$assert.sameValue(globalThis["__instance"]?.["slice"], String.prototype.slice);
$verifyProperty(globalThis["__instance"], "slice", {
  writable: true,
  enumerable: true,
  configurable: true,
});
