...
$assert.sameValue($Object_getPrototypeOf(globalThis["regexp"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["regexp"]), true);
$assert.notCallable(globalThis["regexp"]);
$assert.notConstructable(globalThis["regexp"]);
$assert.compareArray($Reflect_ownKeys(globalThis["regexp"]), [Symbol.search], globalThis["regexp"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["regexp"]?.[Symbol.search]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["regexp"]?.[Symbol.search]), true);
$assert.callable(globalThis["regexp"]?.[Symbol.search]);
$assert.constructable(globalThis["regexp"]?.[Symbol.search]);
$assert.compareArray($Reflect_ownKeys(globalThis["regexp"]?.[Symbol.search]), ['length', 'name', 'prototype'], globalThis["regexp"]?.[Symbol.search]);
$assert.sameValue($Object_getPrototypeOf(globalThis["regexp"]?.[Symbol.search]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["regexp"]?.[Symbol.search]?.["prototype"]), true);
$assert.notCallable(globalThis["regexp"]?.[Symbol.search]?.["prototype"]);
$assert.notConstructable(globalThis["regexp"]?.[Symbol.search]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["regexp"]?.[Symbol.search]?.["prototype"]), ['constructor'], globalThis["regexp"]?.[Symbol.search]?.["prototype"]);
$assert.sameValue(globalThis["regexp"]?.[Symbol.search]?.["prototype"]?.["constructor"], globalThis["regexp"]?.[Symbol.search]);
$verifyProperty(globalThis["regexp"]?.[Symbol.search]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["regexp"]?.[Symbol.search], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["regexp"]?.[Symbol.search], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["regexp"]?.[Symbol.search], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["regexp"], Symbol.search, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["thisVal"], globalThis["regexp"]);
