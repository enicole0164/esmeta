...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get, "name", {
  value: "get toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "toString")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
