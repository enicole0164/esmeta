...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['toString', 'substring'], globalThis["__instance"]);
...
$assert.sameValue(globalThis["__instance"]?.["substring"], String.prototype.substring);
$verifyProperty(globalThis["__instance"], "substring", {
  writable: true,
  enumerable: true,
  configurable: true,
});
