...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor', 'substring'], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["substring"], String.prototype.substring);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "substring", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['value', 'toString'], globalThis["__instance"]);
