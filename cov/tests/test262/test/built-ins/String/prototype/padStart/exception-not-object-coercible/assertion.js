...
$assert.sameValue($Object_getPrototypeOf(globalThis["notCoercible"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["notCoercible"]), true);
$assert.notCallable(globalThis["notCoercible"]);
$assert.notConstructable(globalThis["notCoercible"]);
$assert.compareArray($Reflect_ownKeys(globalThis["notCoercible"]), ['toString'], globalThis["notCoercible"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["notCoercible"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["notCoercible"]?.["toString"]), true);
$assert.callable(globalThis["notCoercible"]?.["toString"]);
$assert.constructable(globalThis["notCoercible"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["notCoercible"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["notCoercible"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["notCoercible"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["notCoercible"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["notCoercible"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["notCoercible"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["notCoercible"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["notCoercible"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["notCoercible"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["notCoercible"]?.["toString"]);
$verifyProperty(globalThis["notCoercible"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["notCoercible"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["notCoercible"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["notCoercible"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["notCoercible"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
