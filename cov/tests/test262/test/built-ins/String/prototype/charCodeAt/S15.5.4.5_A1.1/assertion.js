...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor', 'charCodeAt'], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["charCodeAt"], String.prototype.charCodeAt);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "charCodeAt", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['toString'], globalThis["__instance"]);
