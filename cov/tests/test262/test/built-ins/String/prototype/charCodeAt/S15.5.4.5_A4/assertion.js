...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['valueOf', 'toString', 'charCodeAt'], globalThis["__obj"]);
$assert.sameValue(globalThis["__obj"]?.["charCodeAt"], String.prototype.charCodeAt);
$verifyProperty(globalThis["__obj"], "charCodeAt", {
  writable: true,
  enumerable: true,
  configurable: true,
});
