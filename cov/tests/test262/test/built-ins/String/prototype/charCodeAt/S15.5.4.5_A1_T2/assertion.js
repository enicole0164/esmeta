...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['charCodeAt'], globalThis["__instance"]);
$assert.sameValue(globalThis["__instance"]?.["charCodeAt"], String.prototype.charCodeAt);
$verifyProperty(globalThis["__instance"], "charCodeAt", {
  writable: true,
  enumerable: true,
  configurable: true,
});
