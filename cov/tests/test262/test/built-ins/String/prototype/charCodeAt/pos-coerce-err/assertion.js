...
$assert.sameValue(Object.isExtensible(globalThis["noCoerce"]), true);
$assert.notCallable(globalThis["noCoerce"]);
$assert.notConstructable(globalThis["noCoerce"]);
$assert.compareArray($Reflect_ownKeys(globalThis["noCoerce"]), [], globalThis["noCoerce"]);
