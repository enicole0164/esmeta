...
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedReplace"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedReplace"]), true);
$assert.notCallable(globalThis["poisonedReplace"]);
$assert.notConstructable(globalThis["poisonedReplace"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedReplace"]), [Symbol.replace], globalThis["poisonedReplace"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedReplace"], Symbol.replace)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedReplace"], Symbol.replace, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
