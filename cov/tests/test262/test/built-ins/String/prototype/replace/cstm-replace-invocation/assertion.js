...
$assert.compareArray($Reflect_ownKeys(globalThis["args"]), ['0', '1', 'length', 'callee', Symbol.iterator], globalThis["args"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["returnVal"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["returnVal"]), true);
$assert.notCallable(globalThis["returnVal"]);
$assert.notConstructable(globalThis["returnVal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["returnVal"]), [], globalThis["returnVal"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["searchValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["searchValue"]), true);
$assert.notCallable(globalThis["searchValue"]);
$assert.notConstructable(globalThis["searchValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]), [Symbol.replace], globalThis["searchValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["searchValue"]?.[Symbol.replace]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["searchValue"]?.[Symbol.replace]), true);
$assert.callable(globalThis["searchValue"]?.[Symbol.replace]);
$assert.constructable(globalThis["searchValue"]?.[Symbol.replace]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]?.[Symbol.replace]), ['length', 'name', 'prototype'], globalThis["searchValue"]?.[Symbol.replace]);
$assert.sameValue($Object_getPrototypeOf(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]), true);
$assert.notCallable(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]);
$assert.notConstructable(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]), ['constructor'], globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]);
$assert.sameValue(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"]?.["constructor"], globalThis["searchValue"]?.[Symbol.replace]);
$verifyProperty(globalThis["searchValue"]?.[Symbol.replace]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"]?.[Symbol.replace], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["searchValue"]?.[Symbol.replace], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"]?.[Symbol.replace], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"], Symbol.replace, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thisVal"], globalThis["searchValue"]);
