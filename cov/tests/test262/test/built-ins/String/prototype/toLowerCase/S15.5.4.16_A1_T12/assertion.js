...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['toString', 'valueOf', 'toLowerCase'], globalThis["__obj"]);
$assert.sameValue(globalThis["__obj"]?.["toLowerCase"], String.prototype.toLowerCase);
$verifyProperty(globalThis["__obj"], "toLowerCase", {
  writable: true,
  enumerable: true,
  configurable: true,
});
