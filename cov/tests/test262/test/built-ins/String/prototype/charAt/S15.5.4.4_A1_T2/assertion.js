...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['charAt'], globalThis["__instance"]);
$assert.sameValue(globalThis["__instance"]?.["charAt"], String.prototype.charAt);
$verifyProperty(globalThis["__instance"], "charAt", {
  writable: true,
  enumerable: true,
  configurable: true,
});
