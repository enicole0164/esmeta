...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['valueOf', 'toString', 'charAt'], globalThis["__obj"]);
$assert.sameValue(globalThis["__obj"]?.["charAt"], String.prototype.charAt);
$verifyProperty(globalThis["__obj"], "charAt", {
  writable: true,
  enumerable: true,
  configurable: true,
});
