...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor', 'charAt'], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["charAt"], String.prototype.charAt);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "charAt", {
  writable: true,
  enumerable: true,
  configurable: true,
});
