...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['toString'], globalThis["o"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["toString"]), true);
$assert.callable(globalThis["o"]?.["toString"]);
$assert.constructable(globalThis["o"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["o"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["o"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["o"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["o"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["o"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["o"]?.["toString"]);
$verifyProperty(globalThis["o"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
