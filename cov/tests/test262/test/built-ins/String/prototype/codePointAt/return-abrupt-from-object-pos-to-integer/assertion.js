...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['valueOf'], globalThis["o"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["valueOf"]), true);
$assert.callable(globalThis["o"]?.["valueOf"]);
$assert.constructable(globalThis["o"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["o"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["o"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["o"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["o"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["o"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["o"]?.["valueOf"]);
$verifyProperty(globalThis["o"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
