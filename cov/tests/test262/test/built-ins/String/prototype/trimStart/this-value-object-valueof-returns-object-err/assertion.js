...
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]), ['toString', 'valueOf', Symbol.toPrimitive], globalThis["thisVal"]);
$verifyProperty(globalThis["thisVal"], "toString", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]?.["valueOf"]), true);
$assert.callable(globalThis["thisVal"]?.["valueOf"]);
$assert.constructable(globalThis["thisVal"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["thisVal"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["thisVal"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["thisVal"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["thisVal"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["thisVal"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["thisVal"]?.["valueOf"]);
$verifyProperty(globalThis["thisVal"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thisVal"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
