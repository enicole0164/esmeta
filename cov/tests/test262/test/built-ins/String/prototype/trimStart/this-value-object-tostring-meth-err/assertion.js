...
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]), ['toString', Symbol.toPrimitive], globalThis["thisVal"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]?.["toString"]), true);
$assert.callable(globalThis["thisVal"]?.["toString"]);
$assert.constructable(globalThis["thisVal"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["thisVal"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["thisVal"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["thisVal"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["thisVal"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["thisVal"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["thisVal"]?.["toString"]);
$verifyProperty(globalThis["thisVal"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thisVal"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
