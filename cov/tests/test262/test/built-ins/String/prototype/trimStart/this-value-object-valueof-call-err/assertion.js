...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get, "name", {
  value: "get valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["thisVal"], "valueOf")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
