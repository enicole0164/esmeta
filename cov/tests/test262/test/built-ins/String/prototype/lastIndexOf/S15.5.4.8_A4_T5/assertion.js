...
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]), true);
$assert.callable(globalThis["__FACTORY"]);
$assert.constructable(globalThis["__FACTORY"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]), ['length', 'name', 'prototype'], globalThis["__FACTORY"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]), true);
$assert.notCallable(globalThis["__FACTORY"]?.["prototype"]);
$assert.notConstructable(globalThis["__FACTORY"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor', 'lastIndexOf'], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["constructor"], globalThis["__FACTORY"]);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["lastIndexOf"], String.prototype.lastIndexOf);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "lastIndexOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__FACTORY"], "name", {
  value: "__FACTORY",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]), globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]), true);
$assert.notCallable(globalThis["__instance"]);
$assert.notConstructable(globalThis["__instance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['value', 'toString', 'valueOf'], globalThis["__instance"]);
$verifyProperty(globalThis["__instance"], "value", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]?.["toString"]), true);
$assert.callable(globalThis["__instance"]?.["toString"]);
$assert.constructable(globalThis["__instance"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["__instance"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["__instance"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["__instance"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["__instance"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["__instance"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["__instance"]?.["toString"]);
$verifyProperty(globalThis["__instance"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__instance"]?.["toString"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]?.["valueOf"]), true);
$assert.callable(globalThis["__instance"]?.["valueOf"]);
$assert.constructable(globalThis["__instance"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["__instance"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["__instance"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["__instance"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["__instance"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["__instance"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["__instance"]?.["valueOf"]);
$verifyProperty(globalThis["__instance"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__instance"]?.["valueOf"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]), true);
$assert.notCallable(globalThis["__obj"]);
$assert.notConstructable(globalThis["__obj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['toString', 'valueOf'], globalThis["__obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]?.["toString"]), true);
$assert.callable(globalThis["__obj"]?.["toString"]);
$assert.constructable(globalThis["__obj"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["__obj"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["__obj"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["__obj"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["__obj"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["__obj"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["__obj"]?.["toString"]);
$verifyProperty(globalThis["__obj"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__obj"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]?.["valueOf"]), true);
$assert.callable(globalThis["__obj"]?.["valueOf"]);
$assert.constructable(globalThis["__obj"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["__obj"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["__obj"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["__obj"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["__obj"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["__obj"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["__obj"]?.["valueOf"]);
$verifyProperty(globalThis["__obj"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__obj"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj2"]), true);
$assert.notCallable(globalThis["__obj2"]);
$assert.notConstructable(globalThis["__obj2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj2"]), ['valueOf'], globalThis["__obj2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj2"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj2"]?.["valueOf"]), true);
$assert.callable(globalThis["__obj2"]?.["valueOf"]);
$assert.constructable(globalThis["__obj2"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj2"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["__obj2"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj2"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj2"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["__obj2"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["__obj2"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj2"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["__obj2"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["__obj2"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["__obj2"]?.["valueOf"]);
$verifyProperty(globalThis["__obj2"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj2"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__obj2"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj2"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj2"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
