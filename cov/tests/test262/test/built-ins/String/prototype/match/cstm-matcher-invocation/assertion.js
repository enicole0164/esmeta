...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), [Symbol.match], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.match]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.match]), true);
$assert.callable(globalThis["obj"]?.[Symbol.match]);
$assert.constructable(globalThis["obj"]?.[Symbol.match]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.match]), ['length', 'name', 'prototype'], globalThis["obj"]?.[Symbol.match]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.match]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.match]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.[Symbol.match]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.[Symbol.match]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.match]?.["prototype"]), ['constructor'], globalThis["obj"]?.[Symbol.match]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.[Symbol.match]?.["prototype"]?.["constructor"], globalThis["obj"]?.[Symbol.match]);
$verifyProperty(globalThis["obj"]?.[Symbol.match]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.[Symbol.match], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.[Symbol.match], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.[Symbol.match], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], Symbol.match, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["thisVal"], globalThis["obj"]);
