...
$assert.sameValue($Object_getPrototypeOf(globalThis["position"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["position"]), true);
$assert.notCallable(globalThis["position"]);
$assert.notConstructable(globalThis["position"]);
$assert.compareArray($Reflect_ownKeys(globalThis["position"]), ['valueOf'], globalThis["position"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["position"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["position"]?.["valueOf"]), true);
$assert.callable(globalThis["position"]?.["valueOf"]);
$assert.constructable(globalThis["position"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["position"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["position"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["position"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["position"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["position"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["position"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["position"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["position"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["position"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["position"]?.["valueOf"]);
$verifyProperty(globalThis["position"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["position"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["position"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["position"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["position"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
