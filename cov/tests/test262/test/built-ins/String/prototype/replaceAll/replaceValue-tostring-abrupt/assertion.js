...
$assert.sameValue($Object_getPrototypeOf(globalThis["replaceValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["replaceValue"]), true);
$assert.notCallable(globalThis["replaceValue"]);
$assert.notConstructable(globalThis["replaceValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replaceValue"]), ['toString'], globalThis["replaceValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["replaceValue"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["replaceValue"]?.["toString"]), true);
$assert.callable(globalThis["replaceValue"]?.["toString"]);
$assert.notConstructable(globalThis["replaceValue"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replaceValue"]?.["toString"]), ['length', 'name'], globalThis["replaceValue"]?.["toString"]);
$verifyProperty(globalThis["replaceValue"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["replaceValue"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["replaceValue"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]), ['toString'], globalThis["searchValue"]);
...
$assert.sameValue(globalThis["searchValueCalled"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisValue"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["thisValue"]), ['toString'], globalThis["thisValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisValue"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisValue"]?.["toString"]), true);
$assert.callable(globalThis["thisValue"]?.["toString"]);
$assert.notConstructable(globalThis["thisValue"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisValue"]?.["toString"]), ['length', 'name'], globalThis["thisValue"]?.["toString"]);
$verifyProperty(globalThis["thisValue"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisValue"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisValue"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thisValueCalled"], 1.0);
