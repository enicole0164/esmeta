...
$assert.sameValue(globalThis["called"], 3.0);
$assert.sameValue(globalThis["poisoned"], 0.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["replaceValue"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["replaceValue"]), true);
$assert.callable(globalThis["replaceValue"]);
$assert.constructable(globalThis["replaceValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replaceValue"]), ['length', 'name', 'prototype', 'toString'], globalThis["replaceValue"]);
...
$assert.constructable(globalThis["replaceValue"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replaceValue"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["replaceValue"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["replaceValue"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["replaceValue"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["replaceValue"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["replaceValue"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replaceValue"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["replaceValue"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["replaceValue"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["replaceValue"]?.["toString"]);
$verifyProperty(globalThis["replaceValue"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["replaceValue"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["replaceValue"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["replaceValue"]?.["prototype"]), true);
$assert.notCallable(globalThis["replaceValue"]?.["prototype"]);
$assert.notConstructable(globalThis["replaceValue"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replaceValue"]?.["prototype"]), ['constructor'], globalThis["replaceValue"]?.["prototype"]);
$assert.sameValue(globalThis["replaceValue"]?.["prototype"]?.["constructor"], globalThis["replaceValue"]);
$verifyProperty(globalThis["replaceValue"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["replaceValue"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["replaceValue"], "name", {
  value: "replaceValue",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["replaceValue"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["result"], "bbb");
