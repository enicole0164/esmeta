...
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]), ['flags', Symbol.match], globalThis["searchValue"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get, "name", {
  value: "get flags",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["searchValue"], "flags")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["value"], null);
