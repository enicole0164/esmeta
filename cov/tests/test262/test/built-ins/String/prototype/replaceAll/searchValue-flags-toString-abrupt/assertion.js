...
$assert.sameValue($Object_getPrototypeOf(globalThis["poison"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poison"]), true);
$assert.notCallable(globalThis["poison"]);
$assert.notConstructable(globalThis["poison"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poison"]), ['toString'], globalThis["poison"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["poison"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poison"]?.["toString"]), true);
$assert.callable(globalThis["poison"]?.["toString"]);
$assert.notConstructable(globalThis["poison"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poison"]?.["toString"]), ['length', 'name'], globalThis["poison"]?.["toString"]);
$verifyProperty(globalThis["poison"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poison"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poison"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["poisoned"], 0.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]), ['flags', 'toString', Symbol.match], globalThis["searchValue"]);
$verifyProperty(globalThis["searchValue"], Symbol.match, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["searchValue"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["searchValue"]?.["toString"]), true);
$assert.callable(globalThis["searchValue"]?.["toString"]);
$assert.notConstructable(globalThis["searchValue"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]?.["toString"]), ['length', 'name'], globalThis["searchValue"]?.["toString"]);
$verifyProperty(globalThis["searchValue"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["searchValue"]?.["flags"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["searchValue"]?.["flags"]), true);
$assert.notCallable(globalThis["searchValue"]?.["flags"]);
$assert.notConstructable(globalThis["searchValue"]?.["flags"]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]?.["flags"]), ['toString'], globalThis["searchValue"]?.["flags"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["searchValue"]?.["flags"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["searchValue"]?.["flags"]?.["toString"]), true);
$assert.callable(globalThis["searchValue"]?.["flags"]?.["toString"]);
$assert.notConstructable(globalThis["searchValue"]?.["flags"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]?.["flags"]?.["toString"]), ['length', 'name'], globalThis["searchValue"]?.["flags"]?.["toString"]);
$verifyProperty(globalThis["searchValue"]?.["flags"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"]?.["flags"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"]?.["flags"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["searchValue"], "flags", {
  writable: true,
  enumerable: true,
  configurable: true,
});
