...
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]), ['toString', Symbol.match], globalThis["searchValue"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get, "name", {
  value: "get [Symbol.match]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["searchValue"], Symbol.match)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
