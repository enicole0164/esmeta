...
$assert.compareArray($Reflect_ownKeys(globalThis["__expected"]), ['0', '1', '2', '3', '4', 'length'], globalThis["__expected"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__split"]), ['0', '1', '2', '3', '4', 'length'], globalThis["__split"]);
...
$assert.sameValue(globalThis["__string"], "thistrueistrueatruestringtrueobject");
...
$assert.sameValue(globalThis["i"], 5.0);
