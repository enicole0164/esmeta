...
$assert.sameValue($Object_getPrototypeOf(globalThis["nonNumberableLimit"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nonNumberableLimit"]), true);
$assert.notCallable(globalThis["nonNumberableLimit"]);
$assert.notConstructable(globalThis["nonNumberableLimit"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nonNumberableLimit"]), [Symbol.toPrimitive], globalThis["nonNumberableLimit"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["nonNumberableLimit"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["nonNumberableLimit"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
