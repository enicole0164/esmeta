...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['toString'], globalThis["__obj"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj2"]), ['valueOf', 'toString'], globalThis["__obj2"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__split"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__split"]), true);
$assert.notCallable(globalThis["__split"]);
$assert.notConstructable(globalThis["__split"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__split"]), ['0', '1', 'length'], globalThis["__split"]);
$verifyProperty(globalThis["__split"], "1", {
  value: "ABABA",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__split"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__split"], "0", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
