...
$assert.compareArray($Reflect_ownKeys(globalThis["__expected"]), ['length'], globalThis["__expected"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__split"]), ['length'], globalThis["__split"]);
