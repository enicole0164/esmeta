...
$assert.sameValue(globalThis["__class__"], "[object Undefined]");
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj__lim"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj__lim"]), true);
$assert.notCallable(globalThis["__obj__lim"]);
$assert.notConstructable(globalThis["__obj__lim"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj__lim"]), ['valueOf'], globalThis["__obj__lim"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj__lim"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj__lim"]?.["valueOf"]), true);
$assert.callable(globalThis["__obj__lim"]?.["valueOf"]);
$assert.constructable(globalThis["__obj__lim"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj__lim"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["__obj__lim"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["__obj__lim"]?.["valueOf"]);
$verifyProperty(globalThis["__obj__lim"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj__lim"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__obj__lim"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj__lim"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj__lim"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["split"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["split"]), true);
$assert.callable(globalThis["split"]);
$assert.notConstructable(globalThis["split"]);
$assert.compareArray($Reflect_ownKeys(globalThis["split"]), ['length', 'name'], globalThis["split"]);
$verifyProperty(globalThis["split"], "name", {
  value: "bound split",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["split"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["toString"], Object.prototype.toString);
