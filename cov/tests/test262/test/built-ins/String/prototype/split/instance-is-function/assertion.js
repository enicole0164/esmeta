...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['toString', 'split'], globalThis["__instance"]);
...
$assert.sameValue(globalThis["__instance"]?.["split"], String.prototype.split);
$verifyProperty(globalThis["__instance"], "split", {
  writable: true,
  enumerable: true,
  configurable: true,
});
