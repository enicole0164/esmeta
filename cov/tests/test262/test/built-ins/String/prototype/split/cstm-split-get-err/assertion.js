...
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedSplit"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedSplit"]), true);
$assert.notCallable(globalThis["poisonedSplit"]);
$assert.notConstructable(globalThis["poisonedSplit"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedSplit"]), [Symbol.split], globalThis["poisonedSplit"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedSplit"], Symbol.split)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedSplit"], Symbol.split, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
