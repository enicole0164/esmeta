...
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]), true);
$assert.notCallable(globalThis["separator"]);
$assert.notConstructable(globalThis["separator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]), ['toString', 'valueOf', Symbol.split], globalThis["separator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]?.["toString"]), true);
$assert.callable(globalThis["separator"]?.["toString"]);
$assert.constructable(globalThis["separator"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["separator"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["separator"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["separator"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["separator"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["separator"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["separator"]?.["toString"]);
$verifyProperty(globalThis["separator"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["separator"]?.["toString"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]?.["valueOf"]), true);
$assert.callable(globalThis["separator"]?.["valueOf"]);
$assert.constructable(globalThis["separator"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["separator"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["separator"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["separator"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["separator"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["separator"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["separator"]?.["valueOf"]);
$verifyProperty(globalThis["separator"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["separator"]?.["valueOf"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["separator"], Symbol.split, {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
