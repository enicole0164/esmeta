...
$assert.sameValue($Object_getPrototypeOf(limit), Object.prototype);
$assert.sameValue(Object.isExtensible(limit), true);
$assert.notCallable(limit);
$assert.notConstructable(limit);
$assert.compareArray($Reflect_ownKeys(limit), ['toString', 'valueOf'], limit);
$assert.sameValue($Object_getPrototypeOf(limit?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(limit?.["toString"]), true);
$assert.callable(limit?.["toString"]);
$assert.notConstructable(limit?.["toString"]);
$assert.compareArray($Reflect_ownKeys(limit?.["toString"]), ['length', 'name'], limit?.["toString"]);
$verifyProperty(limit?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(limit?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(limit, "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(limit?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(limit?.["valueOf"]), true);
$assert.callable(limit?.["valueOf"]);
$assert.notConstructable(limit?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(limit?.["valueOf"]), ['length', 'name'], limit?.["valueOf"]);
$verifyProperty(limit?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(limit?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(limit, "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
