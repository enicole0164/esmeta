...
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]), [Symbol.split], globalThis["separator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]?.[Symbol.split]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]?.[Symbol.split]), true);
$assert.callable(globalThis["separator"]?.[Symbol.split]);
$assert.constructable(globalThis["separator"]?.[Symbol.split]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]?.[Symbol.split]), ['length', 'name', 'prototype'], globalThis["separator"]?.[Symbol.split]);
$assert.sameValue($Object_getPrototypeOf(globalThis["separator"]?.[Symbol.split]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["separator"]?.[Symbol.split]?.["prototype"]), true);
$assert.notCallable(globalThis["separator"]?.[Symbol.split]?.["prototype"]);
$assert.notConstructable(globalThis["separator"]?.[Symbol.split]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]?.[Symbol.split]?.["prototype"]), ['constructor'], globalThis["separator"]?.[Symbol.split]?.["prototype"]);
$assert.sameValue(globalThis["separator"]?.[Symbol.split]?.["prototype"]?.["constructor"], globalThis["separator"]?.[Symbol.split]);
$verifyProperty(globalThis["separator"]?.[Symbol.split]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"]?.[Symbol.split], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["separator"]?.[Symbol.split], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["separator"]?.[Symbol.split], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["thisVal"], globalThis["separator"]);
