...
$assert.sameValue($Object_getPrototypeOf(globalThis["MyError"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyError"]), true);
$assert.callable(globalThis["MyError"]);
$assert.constructable(globalThis["MyError"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyError"]), ['length', 'name', 'prototype'], globalThis["MyError"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["MyError"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyError"]?.["prototype"]), true);
$assert.notCallable(globalThis["MyError"]?.["prototype"]);
$assert.notConstructable(globalThis["MyError"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyError"]?.["prototype"]), ['constructor'], globalThis["MyError"]?.["prototype"]);
$assert.sameValue(globalThis["MyError"]?.["prototype"]?.["constructor"], globalThis["MyError"]);
$verifyProperty(globalThis["MyError"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyError"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["MyError"], "name", {
  value: "MyError",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyError"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
