...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['indexOf'], globalThis["__instance"]);
$assert.sameValue(globalThis["__instance"]?.["indexOf"], String.prototype.indexOf);
$verifyProperty(globalThis["__instance"], "indexOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
