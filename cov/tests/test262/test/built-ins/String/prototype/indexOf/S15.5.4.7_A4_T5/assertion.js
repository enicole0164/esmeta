...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor', 'indexOf'], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["indexOf"], String.prototype.indexOf);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "indexOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
