...
$assert.compareArray($Reflect_ownKeys(globalThis["testPromises"]), ['0', '1', '2', '3', '4', '5', 'length'], globalThis["testPromises"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["testPromises"]?.["5"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testPromises"]?.["5"]), true);
$assert.notCallable(globalThis["testPromises"]?.["5"]);
$assert.notConstructable(globalThis["testPromises"]?.["5"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testPromises"]?.["5"]), [], globalThis["testPromises"]?.["5"]);
$verifyProperty(globalThis["testPromises"], "5", {
  writable: true,
  enumerable: true,
  configurable: true,
});
