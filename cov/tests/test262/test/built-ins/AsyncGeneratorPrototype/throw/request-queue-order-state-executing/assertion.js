...
$assert.sameValue($Object_getPrototypeOf(globalThis["caughtErr"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["caughtErr"]), true);
$assert.notCallable(globalThis["caughtErr"]);
$assert.notConstructable(globalThis["caughtErr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["caughtErr"]), ['message'], globalThis["caughtErr"]);
$verifyProperty(globalThis["caughtErr"], "message", {
  value: "Catch me.",
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["order"], 3.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["promises"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["promises"]), true);
$assert.notCallable(globalThis["promises"]);
$assert.notConstructable(globalThis["promises"]);
$assert.compareArray($Reflect_ownKeys(globalThis["promises"]), ['length'], globalThis["promises"]);
$verifyProperty(globalThis["promises"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
...
$assert.sameValue(globalThis["thrownErr"], globalThis["caughtErr"]);
