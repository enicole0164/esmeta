...
$assert.sameValue($Object_getPrototypeOf(globalThis["throwError"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["throwError"]), true);
$assert.notCallable(globalThis["throwError"]);
$assert.notConstructable(globalThis["throwError"]);
$assert.compareArray($Reflect_ownKeys(globalThis["throwError"]), ['message'], globalThis["throwError"]);
$verifyProperty(globalThis["throwError"], "message", {
  value: "Catch me",
  writable: true,
  enumerable: false,
  configurable: true,
