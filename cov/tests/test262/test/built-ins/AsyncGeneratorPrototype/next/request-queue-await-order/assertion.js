...
$assert.sameValue($Object_getPrototypeOf(globalThis["awaitnexts"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["awaitnexts"]), true);
$assert.callable(globalThis["awaitnexts"]);
$assert.notConstructable(globalThis["awaitnexts"]);
$assert.compareArray($Reflect_ownKeys(globalThis["awaitnexts"]), ['length', 'name'], globalThis["awaitnexts"]);
$verifyProperty(globalThis["awaitnexts"], "name", {
  value: "awaitnexts",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["awaitnexts"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["item1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["item1"]), true);
$assert.notCallable(globalThis["item1"]);
$assert.notConstructable(globalThis["item1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["item1"]), [], globalThis["item1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["item2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["item2"]), true);
$assert.notCallable(globalThis["item2"]);
$assert.notConstructable(globalThis["item2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["item2"]), [], globalThis["item2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["item3"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["item3"]), true);
$assert.notCallable(globalThis["item3"]);
$assert.notConstructable(globalThis["item3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["item3"]), [], globalThis["item3"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveLatePromise"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveLatePromise"]), true);
$assert.callable(globalThis["resolveLatePromise"]);
$assert.notConstructable(globalThis["resolveLatePromise"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveLatePromise"]), ['length', 'name'], globalThis["resolveLatePromise"]);
$verifyProperty(globalThis["resolveLatePromise"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveLatePromise"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveLater"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveLater"]), true);
$assert.callable(globalThis["resolveLater"]);
$assert.constructable(globalThis["resolveLater"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveLater"]), ['length', 'name', 'prototype'], globalThis["resolveLater"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveLater"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveLater"]?.["prototype"]), true);
$assert.notCallable(globalThis["resolveLater"]?.["prototype"]);
$assert.notConstructable(globalThis["resolveLater"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveLater"]?.["prototype"]), ['constructor'], globalThis["resolveLater"]?.["prototype"]);
$assert.sameValue(globalThis["resolveLater"]?.["prototype"]?.["constructor"], globalThis["resolveLater"]);
$verifyProperty(globalThis["resolveLater"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveLater"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["resolveLater"], "name", {
  value: "resolveLater",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveLater"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["yieldorder"], 2.0);
