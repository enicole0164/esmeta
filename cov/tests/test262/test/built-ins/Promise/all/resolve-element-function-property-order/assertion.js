...
$assert.sameValue($Object_getPrototypeOf(globalThis["NotPromise"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["NotPromise"]), true);
$assert.callable(globalThis["NotPromise"]);
$assert.constructable(globalThis["NotPromise"]);
$assert.compareArray($Reflect_ownKeys(globalThis["NotPromise"]), ['length', 'name', 'prototype', 'resolve'], globalThis["NotPromise"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["NotPromise"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["NotPromise"]?.["prototype"]), true);
$assert.notCallable(globalThis["NotPromise"]?.["prototype"]);
$assert.notConstructable(globalThis["NotPromise"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["NotPromise"]?.["prototype"]), ['constructor'], globalThis["NotPromise"]?.["prototype"]);
$assert.sameValue(globalThis["NotPromise"]?.["prototype"]?.["constructor"], globalThis["NotPromise"]);
$verifyProperty(globalThis["NotPromise"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["NotPromise"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["NotPromise"], "name", {
  value: "NotPromise",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["NotPromise"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["NotPromise"]?.["resolve"]), true);
$assert.callable(globalThis["NotPromise"]?.["resolve"]);
$assert.constructable(globalThis["NotPromise"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["NotPromise"]?.["resolve"]), ['length', 'name', 'prototype'], globalThis["NotPromise"]?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["NotPromise"]?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["NotPromise"]?.["resolve"]?.["prototype"]), true);
$assert.notCallable(globalThis["NotPromise"]?.["resolve"]?.["prototype"]);
$assert.notConstructable(globalThis["NotPromise"]?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["NotPromise"]?.["resolve"]?.["prototype"]), ['constructor'], globalThis["NotPromise"]?.["resolve"]?.["prototype"]);
$assert.sameValue(globalThis["NotPromise"]?.["resolve"]?.["prototype"]?.["constructor"], globalThis["NotPromise"]?.["resolve"]);
$verifyProperty(globalThis["NotPromise"]?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["NotPromise"]?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["NotPromise"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["NotPromise"]?.["resolve"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["NotPromise"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["NotPromise"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["lengthIndex"], 0.0);
$assert.sameValue(globalThis["nameIndex"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["propNames"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["propNames"]), true);
$assert.notCallable(globalThis["propNames"]);
$assert.notConstructable(globalThis["propNames"]);
$assert.compareArray($Reflect_ownKeys(globalThis["propNames"]), ['0', '1', 'length'], globalThis["propNames"]);
$verifyProperty(globalThis["propNames"], "1", {
  value: "name",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["propNames"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["propNames"], "0", {
  value: "length",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveElementFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveElementFunction"]), true);
$assert.callable(globalThis["resolveElementFunction"]);
$assert.notConstructable(globalThis["resolveElementFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveElementFunction"]), ['length', 'name'], globalThis["resolveElementFunction"]);
$verifyProperty(globalThis["resolveElementFunction"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveElementFunction"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenable"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenable"]), true);
$assert.notCallable(globalThis["thenable"]);
$assert.notConstructable(globalThis["thenable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenable"]), ['then'], globalThis["thenable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenable"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenable"]?.["then"]), true);
$assert.callable(globalThis["thenable"]?.["then"]);
$assert.constructable(globalThis["thenable"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenable"]?.["then"]), ['length', 'name', 'prototype'], globalThis["thenable"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenable"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenable"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["thenable"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["thenable"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenable"]?.["then"]?.["prototype"]), ['constructor'], globalThis["thenable"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["thenable"]?.["then"]?.["prototype"]?.["constructor"], globalThis["thenable"]?.["then"]);
$verifyProperty(globalThis["thenable"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenable"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thenable"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenable"]?.["then"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenable"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
