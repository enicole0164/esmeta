...
$assert.sameValue($Object_getPrototypeOf(globalThis["P"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["P"]), true);
$assert.callable(globalThis["P"]);
$assert.constructable(globalThis["P"]);
$assert.compareArray($Reflect_ownKeys(globalThis["P"]), ['length', 'name', 'prototype', 'resolve'], globalThis["P"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["P"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["P"]?.["prototype"]), true);
$assert.notCallable(globalThis["P"]?.["prototype"]);
$assert.notConstructable(globalThis["P"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["P"]?.["prototype"]), ['constructor'], globalThis["P"]?.["prototype"]);
$assert.sameValue(globalThis["P"]?.["prototype"]?.["constructor"], globalThis["P"]);
$verifyProperty(globalThis["P"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["P"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["P"], "name", {
  value: "P",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["P"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["P"]?.["resolve"]), true);
$assert.callable(globalThis["P"]?.["resolve"]);
$assert.constructable(globalThis["P"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["P"]?.["resolve"]), ['length', 'name', 'prototype'], globalThis["P"]?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["P"]?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["P"]?.["resolve"]?.["prototype"]), true);
$assert.notCallable(globalThis["P"]?.["resolve"]?.["prototype"]);
$assert.notConstructable(globalThis["P"]?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["P"]?.["resolve"]?.["prototype"]), ['constructor'], globalThis["P"]?.["resolve"]?.["prototype"]);
$assert.sameValue(globalThis["P"]?.["resolve"]?.["prototype"]?.["constructor"], globalThis["P"]?.["resolve"]);
$verifyProperty(globalThis["P"]?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["P"]?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["P"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["P"]?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["P"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["P"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["newCallCount"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["newThenable"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newThenable"]), true);
$assert.notCallable(globalThis["newThenable"]);
$assert.notConstructable(globalThis["newThenable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newThenable"]), ['then'], globalThis["newThenable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["newThenable"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newThenable"]?.["then"]), true);
$assert.callable(globalThis["newThenable"]?.["then"]);
$assert.constructable(globalThis["newThenable"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newThenable"]?.["then"]), ['length', 'name', 'prototype'], globalThis["newThenable"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["newThenable"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newThenable"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["newThenable"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["newThenable"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newThenable"]?.["then"]?.["prototype"]), ['constructor'], globalThis["newThenable"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["newThenable"]?.["then"]?.["prototype"]?.["constructor"], globalThis["newThenable"]?.["then"]);
$verifyProperty(globalThis["newThenable"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newThenable"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["newThenable"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newThenable"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newThenable"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["originalCallCount"], 0.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["originalThenable"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["originalThenable"]), true);
$assert.notCallable(globalThis["originalThenable"]);
$assert.notConstructable(globalThis["originalThenable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["originalThenable"]), ['then'], globalThis["originalThenable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["originalThenable"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["originalThenable"]?.["then"]), true);
$assert.callable(globalThis["originalThenable"]?.["then"]);
$assert.constructable(globalThis["originalThenable"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["originalThenable"]?.["then"]), ['length', 'name', 'prototype'], globalThis["originalThenable"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["originalThenable"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["originalThenable"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["originalThenable"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["originalThenable"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["originalThenable"]?.["then"]?.["prototype"]), ['constructor'], globalThis["originalThenable"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["originalThenable"]?.["then"]?.["prototype"]?.["constructor"], globalThis["originalThenable"]?.["then"]);
$verifyProperty(globalThis["originalThenable"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["originalThenable"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["originalThenable"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["originalThenable"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["originalThenable"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
