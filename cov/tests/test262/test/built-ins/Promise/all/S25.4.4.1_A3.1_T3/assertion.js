...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterThrows"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterThrows"]), true);
$assert.notCallable(globalThis["iterThrows"]);
$assert.notConstructable(globalThis["iterThrows"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterThrows"]), [Symbol.iterator], globalThis["iterThrows"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterThrows"], Symbol.iterator)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterThrows"], Symbol.iterator, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
