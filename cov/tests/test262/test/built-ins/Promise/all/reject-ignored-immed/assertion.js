...
$assert.sameValue($Object_getPrototypeOf(globalThis["fulfiller"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fulfiller"]), true);
$assert.notCallable(globalThis["fulfiller"]);
$assert.notConstructable(globalThis["fulfiller"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fulfiller"]), ['then'], globalThis["fulfiller"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fulfiller"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fulfiller"]?.["then"]), true);
$assert.callable(globalThis["fulfiller"]?.["then"]);
$assert.constructable(globalThis["fulfiller"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fulfiller"]?.["then"]), ['length', 'name', 'prototype'], globalThis["fulfiller"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fulfiller"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fulfiller"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["fulfiller"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["fulfiller"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fulfiller"]?.["then"]?.["prototype"]), ['constructor'], globalThis["fulfiller"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["fulfiller"]?.["then"]?.["prototype"]?.["constructor"], globalThis["fulfiller"]?.["then"]);
$verifyProperty(globalThis["fulfiller"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fulfiller"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fulfiller"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fulfiller"]?.["then"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fulfiller"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["lateRejector"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["lateRejector"]), true);
$assert.notCallable(globalThis["lateRejector"]);
$assert.notConstructable(globalThis["lateRejector"]);
$assert.compareArray($Reflect_ownKeys(globalThis["lateRejector"]), ['then'], globalThis["lateRejector"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["lateRejector"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["lateRejector"]?.["then"]), true);
$assert.callable(globalThis["lateRejector"]?.["then"]);
$assert.constructable(globalThis["lateRejector"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["lateRejector"]?.["then"]), ['length', 'name', 'prototype'], globalThis["lateRejector"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["lateRejector"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["lateRejector"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["lateRejector"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["lateRejector"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["lateRejector"]?.["then"]?.["prototype"]), ['constructor'], globalThis["lateRejector"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["lateRejector"]?.["then"]?.["prototype"]?.["constructor"], globalThis["lateRejector"]?.["then"]);
$verifyProperty(globalThis["lateRejector"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["lateRejector"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["lateRejector"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["lateRejector"]?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["lateRejector"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
