...
$assert.sameValue($Object_getPrototypeOf(globalThis["rejectFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejectFunction"]), true);
$assert.callable(globalThis["rejectFunction"]);
$assert.constructable(globalThis["rejectFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejectFunction"]), ['length', 'name', 'prototype'], globalThis["rejectFunction"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["rejectFunction"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejectFunction"]?.["prototype"]), true);
$assert.notCallable(globalThis["rejectFunction"]?.["prototype"]);
$assert.notConstructable(globalThis["rejectFunction"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejectFunction"]?.["prototype"]), ['constructor'], globalThis["rejectFunction"]?.["prototype"]);
$assert.sameValue(globalThis["rejectFunction"]?.["prototype"]?.["constructor"], globalThis["rejectFunction"]);
$verifyProperty(globalThis["rejectFunction"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejectFunction"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["rejectFunction"], "name", {
  value: "rejectFunction",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejectFunction"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
