...
$assert.constructable(globalThis["p1"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]?.["then"]), ['length', 'name', 'prototype'], globalThis["p1"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p1"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p1"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["p1"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["p1"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]?.["then"]?.["prototype"]), ['constructor'], globalThis["p1"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["p1"]?.["then"]?.["prototype"]?.["constructor"], globalThis["p1"]?.["then"]);
$verifyProperty(globalThis["p1"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.constructable(globalThis["p2"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]?.["then"]), ['length', 'name', 'prototype'], globalThis["p2"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p2"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p2"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["p2"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["p2"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]?.["then"]?.["prototype"]), ['constructor'], globalThis["p2"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["p2"]?.["then"]?.["prototype"]?.["constructor"], globalThis["p2"]?.["then"]);
$verifyProperty(globalThis["p2"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.constructable(globalThis["p3"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p3"]?.["then"]), ['length', 'name', 'prototype'], globalThis["p3"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p3"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p3"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["p3"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["p3"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p3"]?.["then"]?.["prototype"]), ['constructor'], globalThis["p3"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["p3"]?.["then"]?.["prototype"]?.["constructor"], globalThis["p3"]?.["then"]);
$verifyProperty(globalThis["p3"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p3"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
