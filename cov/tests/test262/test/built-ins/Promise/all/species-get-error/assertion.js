...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'resolve', Symbol.species], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], Symbol.species)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], Symbol.species, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["resolve"]), true);
$assert.callable(globalThis["C"]?.["resolve"]);
$assert.constructable(globalThis["C"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["resolve"]), ['length', 'name', 'prototype'], globalThis["C"]?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["resolve"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["resolve"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["resolve"]?.["prototype"]), ['constructor'], globalThis["C"]?.["resolve"]?.["prototype"]);
$assert.sameValue(globalThis["C"]?.["resolve"]?.["prototype"]?.["constructor"], globalThis["C"]?.["resolve"]);
$verifyProperty(globalThis["C"]?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
