...
$assert.sameValue(globalThis["callCount1"], 1.0);
$assert.sameValue(globalThis["callCount2"], 1.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveFunction"]), true);
$assert.callable(globalThis["resolveFunction"]);
$assert.constructable(globalThis["resolveFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveFunction"]), ['length', 'name', 'prototype'], globalThis["resolveFunction"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveFunction"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveFunction"]?.["prototype"]), true);
$assert.notCallable(globalThis["resolveFunction"]?.["prototype"]);
$assert.notConstructable(globalThis["resolveFunction"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveFunction"]?.["prototype"]), ['constructor'], globalThis["resolveFunction"]?.["prototype"]);
$assert.sameValue(globalThis["resolveFunction"]?.["prototype"]?.["constructor"], globalThis["resolveFunction"]);
$verifyProperty(globalThis["resolveFunction"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveFunction"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["resolveFunction"], "name", {
  value: "resolveFunction",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveFunction"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
