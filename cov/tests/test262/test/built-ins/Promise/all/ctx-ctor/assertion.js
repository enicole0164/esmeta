...
$assert.notConstructable(globalThis["executor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["executor"]), ['length', 'name'], globalThis["executor"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["instance"])), Promise.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["instance"])), ['constructor'], $Object_getPrototypeOf(globalThis["instance"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["instance"])?.["constructor"]), Promise);
...
$assert.sameValue(SubPromise, $Object_getPrototypeOf(globalThis["instance"])?.["constructor"]);
