...
$assert.sameValue($Object_getPrototypeOf(globalThis["pAll"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["pAll"]), true);
$assert.notCallable(globalThis["pAll"]);
$assert.notConstructable(globalThis["pAll"]);
$assert.compareArray($Reflect_ownKeys(globalThis["pAll"]), [], globalThis["pAll"]);
