...
$assert.compareArray($Reflect_ownKeys(globalThis["args"]?.["0"]), [], globalThis["args"]?.["0"]);
...
$assert.sameValue(globalThis["expectedThisValue"], undefined);
$assert.sameValue(globalThis["object"], globalThis["args"]?.["0"]);
