...
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p"]), true);
$assert.notCallable(globalThis["p"]);
$assert.notConstructable(globalThis["p"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p"]), [], globalThis["p"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["sequence"]), ['0', '1', '2', '3', 'length'], globalThis["sequence"]);
