...
$assert.sameValue(globalThis["rejectCallCount"], 0.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["resolvedValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolvedValue"]), true);
$assert.notCallable(globalThis["resolvedValue"]);
$assert.notConstructable(globalThis["resolvedValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolvedValue"]), [], globalThis["resolvedValue"]);
...
$assert.sameValue(globalThis["value"], globalThis["resolvedValue"]);
