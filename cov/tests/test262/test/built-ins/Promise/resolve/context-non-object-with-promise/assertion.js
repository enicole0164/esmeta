...
$assert.compareArray($Reflect_ownKeys(globalThis["promise"]), ['constructor'], globalThis["promise"]);
$verifyProperty(globalThis["promise"], "constructor", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["symbol"], globalThis["promise"]?.["constructor"]);
