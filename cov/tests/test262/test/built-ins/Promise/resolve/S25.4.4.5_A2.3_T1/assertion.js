...
$assert.sameValue($Object_getPrototypeOf(globalThis["rejectP1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejectP1"]), true);
$assert.callable(globalThis["rejectP1"]);
$assert.notConstructable(globalThis["rejectP1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejectP1"]), ['length', 'name'], globalThis["rejectP1"]);
$verifyProperty(globalThis["rejectP1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejectP1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
