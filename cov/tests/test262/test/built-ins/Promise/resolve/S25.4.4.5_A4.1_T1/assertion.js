...
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveP"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveP"]), true);
$assert.callable(globalThis["resolveP"]);
$assert.notConstructable(globalThis["resolveP"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveP"]), ['length', 'name'], globalThis["resolveP"]);
$verifyProperty(globalThis["resolveP"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveP"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
