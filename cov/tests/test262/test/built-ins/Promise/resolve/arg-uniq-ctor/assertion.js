...
$assert.sameValue($Object_getPrototypeOf(globalThis["promise1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["promise1"]), true);
$assert.notCallable(globalThis["promise1"]);
$assert.notConstructable(globalThis["promise1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["promise1"]), ['constructor'], globalThis["promise1"]);
$verifyProperty(globalThis["promise1"], "constructor", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["promise2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["promise2"]), true);
$assert.notCallable(globalThis["promise2"]);
$assert.notConstructable(globalThis["promise2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["promise2"]), [], globalThis["promise2"]);
