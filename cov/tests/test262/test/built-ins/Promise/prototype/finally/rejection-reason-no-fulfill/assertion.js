...
$assert.sameValue($Object_getPrototypeOf(globalThis["original"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["original"]), true);
$assert.notCallable(globalThis["original"]);
$assert.notConstructable(globalThis["original"]);
$assert.compareArray($Reflect_ownKeys(globalThis["original"]), [], globalThis["original"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["replacement"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["replacement"]), true);
$assert.notCallable(globalThis["replacement"]);
$assert.notConstructable(globalThis["replacement"]);
$assert.compareArray($Reflect_ownKeys(globalThis["replacement"]), [], globalThis["replacement"]);
