...
$assert.sameValue($Object_getPrototypeOf(globalThis["thrower"]), Promise.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["thrower"]), ['then'], globalThis["thrower"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thrower"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thrower"]?.["then"]), true);
$assert.callable(globalThis["thrower"]?.["then"]);
$assert.constructable(globalThis["thrower"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thrower"]?.["then"]), ['length', 'name', 'prototype'], globalThis["thrower"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thrower"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thrower"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["thrower"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["thrower"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thrower"]?.["then"]?.["prototype"]), ['constructor'], globalThis["thrower"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["thrower"]?.["then"]?.["prototype"]?.["constructor"], globalThis["thrower"]?.["then"]);
$verifyProperty(globalThis["thrower"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thrower"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thrower"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thrower"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thrower"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
