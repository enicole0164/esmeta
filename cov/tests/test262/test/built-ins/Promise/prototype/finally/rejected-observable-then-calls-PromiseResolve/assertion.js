...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["mp1"])), Promise.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["mp1"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["mp1"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["mp1"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["mp1"])), ['constructor'], $Object_getPrototypeOf(globalThis["mp1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]), Promise);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["mp1"]));
$verifyProperty($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"], "name", {
  value: "MyPromise",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["mp1"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["mp1"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["mp1"]), true);
$assert.notCallable(globalThis["mp1"]);
$assert.notConstructable(globalThis["mp1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mp1"]), [], globalThis["mp1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["mp1Value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mp1Value"]), true);
$assert.notCallable(globalThis["mp1Value"]);
$assert.notConstructable(globalThis["mp1Value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mp1Value"]), [], globalThis["mp1Value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["mp2"]), $Object_getPrototypeOf(globalThis["mp1"]));
$assert.sameValue(Object.isExtensible(globalThis["mp2"]), true);
$assert.notCallable(globalThis["mp2"]);
$assert.notConstructable(globalThis["mp2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mp2"]), [], globalThis["mp2"]);
$assert.sameValue(globalThis["then"], Promise.prototype.then);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]), true);
$assert.notCallable(globalThis["thenCalls"]);
$assert.notConstructable(globalThis["thenCalls"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]), ['0', '1', '2', '3', '4', 'length'], globalThis["thenCalls"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["4"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["4"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["4"]);
$assert.notConstructable(globalThis["thenCalls"]?.["4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["4"]), ['promise', 'resolve', 'reject'], globalThis["thenCalls"]?.["4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["4"]?.["reject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["4"]?.["reject"]), true);
$assert.callable(globalThis["thenCalls"]?.["4"]?.["reject"]);
$assert.notConstructable(globalThis["thenCalls"]?.["4"]?.["reject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["4"]?.["reject"]), ['length', 'name'], globalThis["thenCalls"]?.["4"]?.["reject"]);
$verifyProperty(globalThis["thenCalls"]?.["4"]?.["reject"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["4"]?.["reject"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["4"], "reject", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["4"]?.["promise"]), $Object_getPrototypeOf(globalThis["mp1"]));
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["4"]?.["promise"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["4"]?.["promise"]);
$assert.notConstructable(globalThis["thenCalls"]?.["4"]?.["promise"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["4"]?.["promise"]), [], globalThis["thenCalls"]?.["4"]?.["promise"]);
$verifyProperty(globalThis["thenCalls"]?.["4"], "promise", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["4"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["4"]?.["resolve"]), true);
$assert.callable(globalThis["thenCalls"]?.["4"]?.["resolve"]);
$assert.notConstructable(globalThis["thenCalls"]?.["4"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["4"]?.["resolve"]), ['length', 'name'], globalThis["thenCalls"]?.["4"]?.["resolve"]);
$verifyProperty(globalThis["thenCalls"]?.["4"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["4"]?.["resolve"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["4"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"], "4", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["2"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["2"]);
$assert.notConstructable(globalThis["thenCalls"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["2"]), ['promise', 'resolve', 'reject'], globalThis["thenCalls"]?.["2"]);
$assert.sameValue(globalThis["thenCalls"]?.["2"]?.["reject"], globalThis["$DONE"]);
$verifyProperty(globalThis["thenCalls"]?.["2"], "reject", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["2"]?.["promise"]), $Object_getPrototypeOf(globalThis["mp1"]));
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["2"]?.["promise"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["2"]?.["promise"]);
$assert.notConstructable(globalThis["thenCalls"]?.["2"]?.["promise"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["2"]?.["promise"]), [], globalThis["thenCalls"]?.["2"]?.["promise"]);
$verifyProperty(globalThis["thenCalls"]?.["2"], "promise", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thenCalls"]?.["2"]?.["resolve"], globalThis["$DONE"]);
$verifyProperty(globalThis["thenCalls"]?.["2"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"], "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"], "length", {
  value: 5.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["1"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["1"]);
$assert.notConstructable(globalThis["thenCalls"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["1"]), ['promise', 'resolve', 'reject'], globalThis["thenCalls"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["1"]?.["reject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["1"]?.["reject"]), true);
$assert.callable(globalThis["thenCalls"]?.["1"]?.["reject"]);
$assert.notConstructable(globalThis["thenCalls"]?.["1"]?.["reject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["1"]?.["reject"]), ['length', 'name'], globalThis["thenCalls"]?.["1"]?.["reject"]);
$verifyProperty(globalThis["thenCalls"]?.["1"]?.["reject"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["1"]?.["reject"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["1"], "reject", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["1"]?.["promise"]), $Object_getPrototypeOf(globalThis["mp1"]));
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["1"]?.["promise"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["1"]?.["promise"]);
$assert.notConstructable(globalThis["thenCalls"]?.["1"]?.["promise"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["1"]?.["promise"]), [], globalThis["thenCalls"]?.["1"]?.["promise"]);
$verifyProperty(globalThis["thenCalls"]?.["1"], "promise", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["1"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["1"]?.["resolve"]), true);
$assert.callable(globalThis["thenCalls"]?.["1"]?.["resolve"]);
$assert.notConstructable(globalThis["thenCalls"]?.["1"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["1"]?.["resolve"]), ['length', 'name'], globalThis["thenCalls"]?.["1"]?.["resolve"]);
$verifyProperty(globalThis["thenCalls"]?.["1"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["1"]?.["resolve"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["1"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["3"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["3"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["3"]);
$assert.notConstructable(globalThis["thenCalls"]?.["3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["3"]), ['promise', 'resolve', 'reject'], globalThis["thenCalls"]?.["3"]);
$verifyProperty(globalThis["thenCalls"]?.["3"], "reject", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thenCalls"]?.["3"]?.["promise"], globalThis["mp2"]);
$verifyProperty(globalThis["thenCalls"]?.["3"], "promise", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["3"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["3"]?.["resolve"]), true);
$assert.callable(globalThis["thenCalls"]?.["3"]?.["resolve"]);
$assert.notConstructable(globalThis["thenCalls"]?.["3"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["3"]?.["resolve"]), ['length', 'name'], globalThis["thenCalls"]?.["3"]?.["resolve"]);
$verifyProperty(globalThis["thenCalls"]?.["3"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["3"]?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["3"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"], "3", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["0"]), true);
$assert.notCallable(globalThis["thenCalls"]?.["0"]);
$assert.notConstructable(globalThis["thenCalls"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["0"]), ['promise', 'resolve', 'reject'], globalThis["thenCalls"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["0"]?.["reject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["0"]?.["reject"]), true);
$assert.callable(globalThis["thenCalls"]?.["0"]?.["reject"]);
$assert.notConstructable(globalThis["thenCalls"]?.["0"]?.["reject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["0"]?.["reject"]), ['length', 'name'], globalThis["thenCalls"]?.["0"]?.["reject"]);
$verifyProperty(globalThis["thenCalls"]?.["0"]?.["reject"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["0"]?.["reject"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["0"], "reject", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thenCalls"]?.["0"]?.["promise"], globalThis["mp1"]);
$verifyProperty(globalThis["thenCalls"]?.["0"], "promise", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["thenCalls"]?.["0"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenCalls"]?.["0"]?.["resolve"]), true);
$assert.callable(globalThis["thenCalls"]?.["0"]?.["resolve"]);
$assert.notConstructable(globalThis["thenCalls"]?.["0"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenCalls"]?.["0"]?.["resolve"]), ['length', 'name'], globalThis["thenCalls"]?.["0"]?.["resolve"]);
$verifyProperty(globalThis["thenCalls"]?.["0"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["0"]?.["resolve"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"]?.["0"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["thenCalls"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(MyPromise, $Object_getPrototypeOf(globalThis["mp1"])?.["constructor"]);
