...
$assert.sameValue($Object_getPrototypeOf(globalThis["checkSequence"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["checkSequence"]), true);
$assert.callable(globalThis["checkSequence"]);
$assert.constructable(globalThis["checkSequence"]);
$assert.compareArray($Reflect_ownKeys(globalThis["checkSequence"]), ['length', 'name', 'prototype'], globalThis["checkSequence"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["checkSequence"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["checkSequence"]?.["prototype"]), true);
$assert.notCallable(globalThis["checkSequence"]?.["prototype"]);
$assert.notConstructable(globalThis["checkSequence"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["checkSequence"]?.["prototype"]), ['constructor'], globalThis["checkSequence"]?.["prototype"]);
$assert.sameValue(globalThis["checkSequence"]?.["prototype"]?.["constructor"], globalThis["checkSequence"]);
$verifyProperty(globalThis["checkSequence"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["checkSequence"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["checkSequence"], "name", {
  value: "checkSequence",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["checkSequence"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["checkSettledPromises"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["checkSettledPromises"]), true);
$assert.callable(globalThis["checkSettledPromises"]);
$assert.constructable(globalThis["checkSettledPromises"]);
$assert.compareArray($Reflect_ownKeys(globalThis["checkSettledPromises"]), ['length', 'name', 'prototype'], globalThis["checkSettledPromises"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["checkSettledPromises"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["checkSettledPromises"]?.["prototype"]), true);
$assert.notCallable(globalThis["checkSettledPromises"]?.["prototype"]);
$assert.notConstructable(globalThis["checkSettledPromises"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["checkSettledPromises"]?.["prototype"]), ['constructor'], globalThis["checkSettledPromises"]?.["prototype"]);
$assert.sameValue(globalThis["checkSettledPromises"]?.["prototype"]?.["constructor"], globalThis["checkSettledPromises"]);
$verifyProperty(globalThis["checkSettledPromises"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["checkSettledPromises"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["checkSettledPromises"], "name", {
  value: "checkSettledPromises",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["checkSettledPromises"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["no"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["no"]), true);
$assert.notCallable(globalThis["no"]);
$assert.notConstructable(globalThis["no"]);
$assert.compareArray($Reflect_ownKeys(globalThis["no"]), ['then'], globalThis["no"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["no"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["no"]?.["then"]), true);
$assert.callable(globalThis["no"]?.["then"]);
$assert.constructable(globalThis["no"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["no"]?.["then"]), ['length', 'name', 'prototype'], globalThis["no"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["no"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["no"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["no"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["no"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["no"]?.["then"]?.["prototype"]), ['constructor'], globalThis["no"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["no"]?.["then"]?.["prototype"]?.["constructor"], globalThis["no"]?.["then"]);
$verifyProperty(globalThis["no"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["no"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["no"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["no"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["no"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["noReason"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["noReason"]), true);
$assert.notCallable(globalThis["noReason"]);
$assert.notConstructable(globalThis["noReason"]);
$assert.compareArray($Reflect_ownKeys(globalThis["noReason"]), [], globalThis["noReason"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["sequence"]), ['0', '1', '2', '3', '4', 'length'], globalThis["sequence"]);
$verifyProperty(globalThis["sequence"], "4", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["sequence"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["sequence"], "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["yes"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["yes"]), true);
$assert.notCallable(globalThis["yes"]);
$assert.notConstructable(globalThis["yes"]);
$assert.compareArray($Reflect_ownKeys(globalThis["yes"]), ['then'], globalThis["yes"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["yes"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["yes"]?.["then"]), true);
$assert.callable(globalThis["yes"]?.["then"]);
$assert.constructable(globalThis["yes"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["yes"]?.["then"]), ['length', 'name', 'prototype'], globalThis["yes"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["yes"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["yes"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["yes"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["yes"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["yes"]?.["then"]?.["prototype"]), ['constructor'], globalThis["yes"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["yes"]?.["then"]?.["prototype"]?.["constructor"], globalThis["yes"]?.["then"]);
$verifyProperty(globalThis["yes"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["yes"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["yes"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["yes"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["yes"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["yesValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["yesValue"]), true);
$assert.notCallable(globalThis["yesValue"]);
$assert.notConstructable(globalThis["yesValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["yesValue"]), [], globalThis["yesValue"]);
