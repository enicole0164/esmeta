...
$assert.sameValue($Object_getPrototypeOf(globalThis["thrown"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thrown"]), true);
$assert.notCallable(globalThis["thrown"]);
$assert.notConstructable(globalThis["thrown"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thrown"]), [], globalThis["thrown"]);
