...
$assert.sameValue($Object_getPrototypeOf(FooPromise), Promise);
$assert.sameValue(Object.isExtensible(FooPromise), true);
$assert.callable(FooPromise);
$assert.constructable(FooPromise);
$assert.compareArray($Reflect_ownKeys(FooPromise), ['length', 'name', 'prototype', Symbol.species], FooPromise);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get, "name", {
  value: "get [Symbol.species]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(FooPromise, Symbol.species)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(FooPromise, Symbol.species, {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(FooPromise?.["prototype"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(FooPromise?.["prototype"]), true);
$assert.notCallable(FooPromise?.["prototype"]);
$assert.notConstructable(FooPromise?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(FooPromise?.["prototype"]), ['constructor'], FooPromise?.["prototype"]);
$assert.sameValue(FooPromise?.["prototype"]?.["constructor"], FooPromise);
$verifyProperty(FooPromise?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(FooPromise, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(FooPromise, "name", {
  value: "FooPromise",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(FooPromise, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
