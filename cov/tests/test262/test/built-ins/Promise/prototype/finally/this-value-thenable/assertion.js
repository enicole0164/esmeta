...
$assert.sameValue($Object_getPrototypeOf(globalThis["Thenable"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Thenable"]), true);
$assert.callable(globalThis["Thenable"]);
$assert.constructable(globalThis["Thenable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Thenable"]), ['length', 'name', 'prototype'], globalThis["Thenable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Thenable"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Thenable"]?.["prototype"]), true);
$assert.notCallable(globalThis["Thenable"]?.["prototype"]);
$assert.notConstructable(globalThis["Thenable"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Thenable"]?.["prototype"]), ['constructor', 'then'], globalThis["Thenable"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Thenable"]?.["prototype"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Thenable"]?.["prototype"]?.["then"]), true);
$assert.callable(globalThis["Thenable"]?.["prototype"]?.["then"]);
$assert.constructable(globalThis["Thenable"]?.["prototype"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Thenable"]?.["prototype"]?.["then"]), ['length', 'name', 'prototype'], globalThis["Thenable"]?.["prototype"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]), ['constructor'], globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"]?.["constructor"], globalThis["Thenable"]?.["prototype"]?.["then"]);
$verifyProperty(globalThis["Thenable"]?.["prototype"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Thenable"]?.["prototype"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Thenable"]?.["prototype"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Thenable"]?.["prototype"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Thenable"]?.["prototype"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["Thenable"]?.["prototype"]?.["constructor"], globalThis["Thenable"]);
$verifyProperty(globalThis["Thenable"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Thenable"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Thenable"], "name", {
  value: "Thenable",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Thenable"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["thenResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenResult"]), true);
$assert.notCallable(globalThis["thenResult"]);
$assert.notConstructable(globalThis["thenResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenResult"]), [], globalThis["thenResult"]);
