...
$assert.compareArray($Reflect_ownKeys(globalThis["p"]), ['then'], globalThis["p"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]?.["then"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p"]?.["then"]), true);
$assert.notCallable(globalThis["p"]?.["then"]);
$assert.notConstructable(globalThis["p"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p"]?.["then"]), [], globalThis["p"]?.["then"]);
$verifyProperty(globalThis["p"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
