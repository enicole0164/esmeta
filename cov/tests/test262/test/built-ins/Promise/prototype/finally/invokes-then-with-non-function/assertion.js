...
$assert.sameValue(globalThis["argCount"], 2.0);
...
$assert.sameValue(globalThis["firstArg"], 1.0);
...
$assert.sameValue(globalThis["returnValue"], globalThis["result"]);
$assert.sameValue(globalThis["secondArg"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["target"]), Promise.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["target"]), ['then'], globalThis["target"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["target"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target"]?.["then"]), true);
$assert.callable(globalThis["target"]?.["then"]);
$assert.constructable(globalThis["target"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["target"]?.["then"]), ['length', 'name', 'prototype'], globalThis["target"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["target"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["target"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["target"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["target"]?.["then"]?.["prototype"]), ['constructor'], globalThis["target"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["target"]?.["then"]?.["prototype"]?.["constructor"], globalThis["target"]?.["then"]);
$verifyProperty(globalThis["target"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["target"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"]?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thisValue"], globalThis["target"]);
