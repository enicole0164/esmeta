...
$assert.sameValue(globalThis["booleanCount"], 1.0);
$assert.sameValue(globalThis["numberCount"], 1.0);
$assert.sameValue(globalThis["stringCount"], 1.0);
$assert.sameValue(globalThis["symbolCount"], 1.0);
