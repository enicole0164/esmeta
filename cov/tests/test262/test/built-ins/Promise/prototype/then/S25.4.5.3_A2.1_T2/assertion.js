...
$assert.sameValue($Object_getPrototypeOf(globalThis["ZeroArgConstructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ZeroArgConstructor"]), true);
$assert.callable(globalThis["ZeroArgConstructor"]);
$assert.constructable(globalThis["ZeroArgConstructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ZeroArgConstructor"]), ['length', 'name', 'prototype'], globalThis["ZeroArgConstructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ZeroArgConstructor"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ZeroArgConstructor"]?.["prototype"]), true);
$assert.notCallable(globalThis["ZeroArgConstructor"]?.["prototype"]);
$assert.notConstructable(globalThis["ZeroArgConstructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ZeroArgConstructor"]?.["prototype"]), ['constructor'], globalThis["ZeroArgConstructor"]?.["prototype"]);
$assert.sameValue(globalThis["ZeroArgConstructor"]?.["prototype"]?.["constructor"], globalThis["ZeroArgConstructor"]);
$verifyProperty(globalThis["ZeroArgConstructor"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ZeroArgConstructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ZeroArgConstructor"], "name", {
  value: "ZeroArgConstructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ZeroArgConstructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["z"]), globalThis["ZeroArgConstructor"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), [], globalThis["z"]);
