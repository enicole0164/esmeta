...
$assert.sameValue($Object_getPrototypeOf(globalThis["pReject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["pReject"]), true);
$assert.callable(globalThis["pReject"]);
$assert.notConstructable(globalThis["pReject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["pReject"]), ['length', 'name'], globalThis["pReject"]);
$verifyProperty(globalThis["pReject"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["pReject"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
