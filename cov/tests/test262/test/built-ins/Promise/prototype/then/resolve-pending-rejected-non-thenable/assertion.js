...
$assert.sameValue($Object_getPrototypeOf(globalThis["nonThenable"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nonThenable"]), true);
$assert.notCallable(globalThis["nonThenable"]);
$assert.notConstructable(globalThis["nonThenable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nonThenable"]), ['then'], globalThis["nonThenable"]);
$verifyProperty(globalThis["nonThenable"], "then", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
