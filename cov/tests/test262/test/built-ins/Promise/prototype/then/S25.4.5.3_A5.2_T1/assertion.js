...
$assert.sameValue($Object_getPrototypeOf(globalThis["pResolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["pResolve"]), true);
$assert.callable(globalThis["pResolve"]);
$assert.notConstructable(globalThis["pResolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["pResolve"]), ['length', 'name'], globalThis["pResolve"]);
$verifyProperty(globalThis["pResolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["pResolve"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
