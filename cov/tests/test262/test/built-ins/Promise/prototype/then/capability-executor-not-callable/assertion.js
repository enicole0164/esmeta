...
$assert.sameValue($Object_getPrototypeOf(globalThis["constructorFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["constructorFunction"]), true);
$assert.callable(globalThis["constructorFunction"]);
$assert.constructable(globalThis["constructorFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["constructorFunction"]), ['length', 'name', 'prototype'], globalThis["constructorFunction"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["constructorFunction"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["constructorFunction"]?.["prototype"]), true);
$assert.notCallable(globalThis["constructorFunction"]?.["prototype"]);
$assert.notConstructable(globalThis["constructorFunction"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["constructorFunction"]?.["prototype"]), ['constructor'], globalThis["constructorFunction"]?.["prototype"]);
$assert.sameValue(globalThis["constructorFunction"]?.["prototype"]?.["constructor"], globalThis["constructorFunction"]);
$verifyProperty(globalThis["constructorFunction"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["constructorFunction"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["constructorFunction"], "name", {
  value: "constructorFunction",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["constructorFunction"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["promise"])), Promise.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["promise"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["promise"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["promise"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["promise"])), ['constructor'], $Object_getPrototypeOf(globalThis["promise"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["promise"])?.["constructor"]), Promise);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["promise"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["promise"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["promise"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["promise"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["promise"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["promise"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["promise"]));
$verifyProperty($Object_getPrototypeOf(globalThis["promise"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["promise"])?.["constructor"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["promise"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["promise"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
