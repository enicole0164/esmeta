...
$assert.sameValue($Object_getPrototypeOf(globalThis["BadCtor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BadCtor"]), true);
$assert.callable(globalThis["BadCtor"]);
$assert.constructable(globalThis["BadCtor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BadCtor"]), ['length', 'name', 'prototype'], globalThis["BadCtor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["BadCtor"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BadCtor"]?.["prototype"]), true);
$assert.notCallable(globalThis["BadCtor"]?.["prototype"]);
$assert.notConstructable(globalThis["BadCtor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BadCtor"]?.["prototype"]), ['constructor'], globalThis["BadCtor"]?.["prototype"]);
$assert.sameValue(globalThis["BadCtor"]?.["prototype"]?.["constructor"], globalThis["BadCtor"]);
$verifyProperty(globalThis["BadCtor"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BadCtor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["BadCtor"], "name", {
  value: "BadCtor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BadCtor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["originalSpecies"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["originalSpecies"]);
$assert.sameValue(globalThis["originalSpecies"]?.["get"], get Promise[@@species]);
$verifyProperty(globalThis["originalSpecies"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$verifyProperty(globalThis["originalSpecies"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
