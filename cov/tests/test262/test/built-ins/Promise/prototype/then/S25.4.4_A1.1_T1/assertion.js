...
$assert.compareArray($Reflect_ownKeys(globalThis["sequence"]), ['0', '1', '2', '3', '4', '5', '6', '7', 'length'], globalThis["sequence"]);
...
$verifyProperty(globalThis["sequence"], "7", {
  value: 8.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["sequence"], "6", {
  value: 7.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["sequence"], "5", {
  value: 6.0,
  writable: true,
  enumerable: true,
  configurable: true,
