...
$assert.sameValue(globalThis["createBadPromise"], false);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["p"])), Promise.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["p"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["p"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["p"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["p"])), ['constructor'], $Object_getPrototypeOf(globalThis["p"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["p"])?.["constructor"]), Promise);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["p"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["p"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["p"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["p"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["p"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["p"]));
$verifyProperty($Object_getPrototypeOf(globalThis["p"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["p"])?.["constructor"], "name", {
  value: "P",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["p"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["p"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["q"], globalThis["object"]);
$assert.sameValue(P, $Object_getPrototypeOf(globalThis["p"])?.["constructor"]);
