...
$assert.sameValue($Object_getPrototypeOf(globalThis["rejectP2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejectP2"]), true);
$assert.callable(globalThis["rejectP2"]);
$assert.notConstructable(globalThis["rejectP2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejectP2"]), ['length', 'name'], globalThis["rejectP2"]);
$verifyProperty(globalThis["rejectP2"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejectP2"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["resolveP1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["resolveP1"]), true);
$assert.callable(globalThis["resolveP1"]);
$assert.notConstructable(globalThis["resolveP1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveP1"]), ['length', 'name'], globalThis["resolveP1"]);
$verifyProperty(globalThis["resolveP1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["resolveP1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["sequence"]), ['0', '1', '2', 'length'], globalThis["sequence"]);
