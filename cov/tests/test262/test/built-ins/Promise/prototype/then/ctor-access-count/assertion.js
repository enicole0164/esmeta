...
$assert.sameValue($Object_getPrototypeOf(globalThis["prms"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["prms"]), true);
$assert.notCallable(globalThis["prms"]);
$assert.notConstructable(globalThis["prms"]);
$assert.compareArray($Reflect_ownKeys(globalThis["prms"]), ['constructor'], globalThis["prms"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["prms"], "constructor")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["prms"], "constructor", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
