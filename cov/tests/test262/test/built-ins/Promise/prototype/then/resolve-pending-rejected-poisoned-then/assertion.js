...
$assert.sameValue($Object_getPrototypeOf(globalThis["reject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["reject"]), true);
$assert.callable(globalThis["reject"]);
$assert.notConstructable(globalThis["reject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["reject"]), ['length', 'name'], globalThis["reject"]);
$verifyProperty(globalThis["reject"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["reject"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
