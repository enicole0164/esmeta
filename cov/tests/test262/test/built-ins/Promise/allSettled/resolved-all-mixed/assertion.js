...
$assert.sameValue($Object_getPrototypeOf(globalThis["f1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f1"]), true);
$assert.notCallable(globalThis["f1"]);
$assert.notConstructable(globalThis["f1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]), [], globalThis["f1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f2"]), true);
$assert.notCallable(globalThis["f2"]);
$assert.notConstructable(globalThis["f2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f2"]), [], globalThis["f2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f3"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f3"]), true);
$assert.notCallable(globalThis["f3"]);
$assert.notConstructable(globalThis["f3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f3"]), [], globalThis["f3"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]), [], globalThis["obj1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), [], globalThis["obj2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["r1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["r1"]), true);
$assert.notCallable(globalThis["r1"]);
$assert.notConstructable(globalThis["r1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["r1"]), [], globalThis["r1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["r2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["r2"]), true);
$assert.notCallable(globalThis["r2"]);
$assert.notConstructable(globalThis["r2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["r2"]), [], globalThis["r2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["r3"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["r3"]), true);
$assert.notCallable(globalThis["r3"]);
$assert.notConstructable(globalThis["r3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["r3"]), [], globalThis["r3"]);
