...
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]), ['0', 'length'], globalThis["expected"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["expected"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["expected"]?.["0"]), true);
$assert.notCallable(globalThis["expected"]?.["0"]);
$assert.notConstructable(globalThis["expected"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]?.["0"]), ['status', 'value'], globalThis["expected"]?.["0"]);
$verifyProperty(globalThis["expected"]?.["0"], "status", {
  value: "fulfilled",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["expected"]?.["0"], "value", {
  value: "expectedValue",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["valuesArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["valuesArray"]), true);
$assert.notCallable(globalThis["valuesArray"]);
$assert.notConstructable(globalThis["valuesArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["valuesArray"]), ['0', 'length'], globalThis["valuesArray"]);
$verifyProperty(globalThis["valuesArray"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["valuesArray"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["valuesArray"]?.["0"]), true);
$assert.notCallable(globalThis["valuesArray"]?.["0"]);
$assert.notConstructable(globalThis["valuesArray"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["valuesArray"]?.["0"]), ['status', 'value'], globalThis["valuesArray"]?.["0"]);
$verifyProperty(globalThis["valuesArray"]?.["0"], "status", {
  value: "fulfilled",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["valuesArray"]?.["0"], "value", {
  value: "expectedValue",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["valuesArray"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
