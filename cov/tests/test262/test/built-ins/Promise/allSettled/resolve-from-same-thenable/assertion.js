...
$assert.sameValue($Object_getPrototypeOf(globalThis["p1"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]), ['then'], globalThis["p1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p1"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p1"]?.["then"]), true);
$assert.callable(globalThis["p1"]?.["then"]);
$assert.notConstructable(globalThis["p1"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]?.["then"]), ['length', 'name'], globalThis["p1"]?.["then"]);
$verifyProperty(globalThis["p1"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1"]?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["p1OnFulfilled"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p1OnFulfilled"]), true);
$assert.callable(globalThis["p1OnFulfilled"]);
$assert.notConstructable(globalThis["p1OnFulfilled"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1OnFulfilled"]), ['length', 'name'], globalThis["p1OnFulfilled"]);
$verifyProperty(globalThis["p1OnFulfilled"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1OnFulfilled"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["p2"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]), ['then'], globalThis["p2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p2"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p2"]?.["then"]), true);
$assert.callable(globalThis["p2"]?.["then"]);
$assert.notConstructable(globalThis["p2"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]?.["then"]), ['length', 'name'], globalThis["p2"]?.["then"]);
$verifyProperty(globalThis["p2"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2"]?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["p2OnFulfilled"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p2OnFulfilled"]), true);
$assert.callable(globalThis["p2OnFulfilled"]);
$assert.notConstructable(globalThis["p2OnFulfilled"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p2OnFulfilled"]), ['length', 'name'], globalThis["p2OnFulfilled"]);
$verifyProperty(globalThis["p2OnFulfilled"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2OnFulfilled"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["p3"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["p3"]), ['then'], globalThis["p3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p3"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p3"]?.["then"]), true);
$assert.callable(globalThis["p3"]?.["then"]);
$assert.notConstructable(globalThis["p3"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p3"]?.["then"]), ['length', 'name'], globalThis["p3"]?.["then"]);
$verifyProperty(globalThis["p3"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p3"]?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p3"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["p3OnFulfilled"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p3OnFulfilled"]), true);
$assert.callable(globalThis["p3OnFulfilled"]);
$assert.notConstructable(globalThis["p3OnFulfilled"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p3OnFulfilled"]), ['length', 'name'], globalThis["p3OnFulfilled"]);
$verifyProperty(globalThis["p3OnFulfilled"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p3OnFulfilled"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
