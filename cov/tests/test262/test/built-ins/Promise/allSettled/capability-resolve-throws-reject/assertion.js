...
$assert.sameValue($Object_getPrototypeOf(globalThis["thrown"]), globalThis["Test262Error"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["thrown"]), ['message'], globalThis["thrown"]);
$verifyProperty(globalThis["thrown"], "message", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
