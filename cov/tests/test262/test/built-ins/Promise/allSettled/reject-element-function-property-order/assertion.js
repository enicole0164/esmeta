...
$assert.sameValue($Object_getPrototypeOf(globalThis["rejectElementFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejectElementFunction"]), true);
$assert.callable(globalThis["rejectElementFunction"]);
$assert.notConstructable(globalThis["rejectElementFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejectElementFunction"]), ['length', 'name'], globalThis["rejectElementFunction"]);
$verifyProperty(globalThis["rejectElementFunction"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejectElementFunction"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
