...
$assert.sameValue(globalThis["afterNextThis"], null);
...
$assert.sameValue(globalThis["callCount"], 3.0);
$assert.sameValue(globalThis["currentThis"], null);
$assert.sameValue(globalThis["nextThis"], null);
...
$assert.sameValue(globalThis["p2"]?.["then"], globalThis["p1"]?.["then"]);
...
$assert.sameValue(globalThis["p3"]?.["then"], globalThis["p1"]?.["then"]);
