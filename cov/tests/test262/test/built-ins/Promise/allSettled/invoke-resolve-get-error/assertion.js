...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get, "name", {
  value: "get [Symbol.iterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(iter, Symbol.iterator)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(resolveError), Object.prototype);
$assert.sameValue(Object.isExtensible(resolveError), true);
$assert.notCallable(resolveError);
$assert.notConstructable(resolveError);
$assert.compareArray($Reflect_ownKeys(resolveError), ['name'], resolveError);
$verifyProperty(resolveError, "name", {
  value: "MyError",
  writable: true,
  enumerable: true,
  configurable: true,
