...
$assert.sameValue($Object_getPrototypeOf(globalThis["simulation"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["simulation"]), true);
$assert.notCallable(globalThis["simulation"]);
$assert.notConstructable(globalThis["simulation"]);
$assert.compareArray($Reflect_ownKeys(globalThis["simulation"]), [], globalThis["simulation"]);
