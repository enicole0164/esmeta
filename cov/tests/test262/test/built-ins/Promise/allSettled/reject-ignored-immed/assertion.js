...
$assert.notConstructable(globalThis["fulfiller"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fulfiller"]?.["then"]), ['length', 'name'], globalThis["fulfiller"]?.["then"]);
...
$assert.notConstructable(globalThis["lateRejector"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["lateRejector"]?.["then"]), ['length', 'name'], globalThis["lateRejector"]?.["then"]);
