...
$assert.compareArray($Reflect_ownKeys(globalThis["poison"]), ['length', Symbol.iterator], globalThis["poison"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poison"], Symbol.iterator)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poison"], Symbol.iterator, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
