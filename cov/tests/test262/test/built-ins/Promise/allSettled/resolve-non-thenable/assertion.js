...
$assert.sameValue($Object_getPrototypeOf(globalThis["v1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["v1"]), true);
$assert.notCallable(globalThis["v1"]);
$assert.notConstructable(globalThis["v1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["v1"]), [], globalThis["v1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["v2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["v2"]), true);
$assert.notCallable(globalThis["v2"]);
$assert.notConstructable(globalThis["v2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["v2"]), [], globalThis["v2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["v3"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["v3"]), true);
$assert.notCallable(globalThis["v3"]);
$assert.notConstructable(globalThis["v3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["v3"]), [], globalThis["v3"]);
