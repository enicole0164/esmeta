...
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["promise"], "then")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["promise"], "then")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["promise"], "then")?.get);
