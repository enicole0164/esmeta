...
$assert.notConstructable(globalThis["newThenable"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newThenable"]?.["then"]), ['length', 'name'], globalThis["newThenable"]?.["then"]);
...
$assert.notConstructable(globalThis["originalThenable"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["originalThenable"]?.["then"]), ['length', 'name'], globalThis["originalThenable"]?.["then"]);
