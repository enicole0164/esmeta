...
$assert.compareArray($Reflect_ownKeys(globalThis["P"]), ['length', 'name', 'prototype'], globalThis["P"]);
...
$assert.sameValue(globalThis["expectedThis"], undefined);
$assert.sameValue(globalThis["resolveCount"], 0.0);
$assert.sameValue(globalThis["thisValue"], undefined);
