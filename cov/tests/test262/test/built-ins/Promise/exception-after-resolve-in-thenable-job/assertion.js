...
$assert.sameValue($Object_getPrototypeOf(globalThis["thenableWithError"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenableWithError"]), true);
$assert.notCallable(globalThis["thenableWithError"]);
$assert.notConstructable(globalThis["thenableWithError"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenableWithError"]), ['then'], globalThis["thenableWithError"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenableWithError"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenableWithError"]?.["then"]), true);
$assert.callable(globalThis["thenableWithError"]?.["then"]);
$assert.constructable(globalThis["thenableWithError"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenableWithError"]?.["then"]), ['length', 'name', 'prototype'], globalThis["thenableWithError"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenableWithError"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenableWithError"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["thenableWithError"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["thenableWithError"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenableWithError"]?.["then"]?.["prototype"]), ['constructor'], globalThis["thenableWithError"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["thenableWithError"]?.["then"]?.["prototype"]?.["constructor"], globalThis["thenableWithError"]?.["then"]);
$verifyProperty(globalThis["thenableWithError"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenableWithError"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thenableWithError"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenableWithError"]?.["then"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenableWithError"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
