...
$assert.sameValue($Object_getPrototypeOf(globalThis["CustomPromise"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["CustomPromise"]), true);
$assert.callable(globalThis["CustomPromise"]);
$assert.constructable(globalThis["CustomPromise"]);
$assert.compareArray($Reflect_ownKeys(globalThis["CustomPromise"]), ['length', 'name', 'prototype', 'resolve'], globalThis["CustomPromise"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["CustomPromise"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["CustomPromise"]?.["prototype"]), true);
$assert.notCallable(globalThis["CustomPromise"]?.["prototype"]);
$assert.notConstructable(globalThis["CustomPromise"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["CustomPromise"]?.["prototype"]), ['constructor'], globalThis["CustomPromise"]?.["prototype"]);
$assert.sameValue(globalThis["CustomPromise"]?.["prototype"]?.["constructor"], globalThis["CustomPromise"]);
$verifyProperty(globalThis["CustomPromise"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["CustomPromise"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["CustomPromise"], "name", {
  value: "CustomPromise",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["CustomPromise"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["CustomPromise"]?.["resolve"]), true);
$assert.callable(globalThis["CustomPromise"]?.["resolve"]);
$assert.constructable(globalThis["CustomPromise"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["CustomPromise"]?.["resolve"]), ['length', 'name', 'prototype'], globalThis["CustomPromise"]?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["CustomPromise"]?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["CustomPromise"]?.["resolve"]?.["prototype"]), true);
$assert.notCallable(globalThis["CustomPromise"]?.["resolve"]?.["prototype"]);
$assert.notConstructable(globalThis["CustomPromise"]?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["CustomPromise"]?.["resolve"]?.["prototype"]), ['constructor'], globalThis["CustomPromise"]?.["resolve"]?.["prototype"]);
$assert.sameValue(globalThis["CustomPromise"]?.["resolve"]?.["prototype"]?.["constructor"], globalThis["CustomPromise"]?.["resolve"]);
$verifyProperty(globalThis["CustomPromise"]?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["CustomPromise"]?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["CustomPromise"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["CustomPromise"]?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["CustomPromise"], "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["CustomPromise"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["err"]), globalThis["Test262Error"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["err"]), true);
$assert.notCallable(globalThis["err"]);
$assert.notConstructable(globalThis["err"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err"]), ['message'], globalThis["err"]);
$verifyProperty(globalThis["err"], "message", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
