...
$assert.sameValue($Object_getPrototypeOf(globalThis["fn1"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fn1"]?.["resolve"]), true);
$assert.callable(globalThis["fn1"]?.["resolve"]);
$assert.constructable(globalThis["fn1"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn1"]?.["resolve"]), ['length', 'name', 'prototype'], globalThis["fn1"]?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fn1"]?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fn1"]?.["resolve"]?.["prototype"]), true);
$assert.notCallable(globalThis["fn1"]?.["resolve"]?.["prototype"]);
$assert.notConstructable(globalThis["fn1"]?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn1"]?.["resolve"]?.["prototype"]), ['constructor'], globalThis["fn1"]?.["resolve"]?.["prototype"]);
$assert.sameValue(globalThis["fn1"]?.["resolve"]?.["prototype"]?.["constructor"], globalThis["fn1"]?.["resolve"]);
$verifyProperty(globalThis["fn1"]?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fn1"]?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fn1"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fn1"]?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["fn2"]?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fn2"]?.["resolve"]), true);
$assert.callable(globalThis["fn2"]?.["resolve"]);
$assert.constructable(globalThis["fn2"]?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn2"]?.["resolve"]), ['length', 'name', 'prototype'], globalThis["fn2"]?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fn2"]?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fn2"]?.["resolve"]?.["prototype"]), true);
$assert.notCallable(globalThis["fn2"]?.["resolve"]?.["prototype"]);
$assert.notConstructable(globalThis["fn2"]?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn2"]?.["resolve"]?.["prototype"]), ['constructor'], globalThis["fn2"]?.["resolve"]?.["prototype"]);
$assert.sameValue(globalThis["fn2"]?.["resolve"]?.["prototype"]?.["constructor"], globalThis["fn2"]?.["resolve"]);
$verifyProperty(globalThis["fn2"]?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fn2"]?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fn2"]?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fn2"]?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
