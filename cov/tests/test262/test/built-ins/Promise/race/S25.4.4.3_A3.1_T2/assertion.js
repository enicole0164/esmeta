...
$assert.sameValue($Object_getPrototypeOf(globalThis["BadPromiseConstructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BadPromiseConstructor"]), true);
$assert.callable(globalThis["BadPromiseConstructor"]);
$assert.constructable(globalThis["BadPromiseConstructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BadPromiseConstructor"]), ['length', 'name', 'prototype'], globalThis["BadPromiseConstructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["BadPromiseConstructor"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BadPromiseConstructor"]?.["prototype"]), true);
$assert.notCallable(globalThis["BadPromiseConstructor"]?.["prototype"]);
$assert.notConstructable(globalThis["BadPromiseConstructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BadPromiseConstructor"]?.["prototype"]), ['constructor'], globalThis["BadPromiseConstructor"]?.["prototype"]);
$assert.sameValue(globalThis["BadPromiseConstructor"]?.["prototype"]?.["constructor"], globalThis["BadPromiseConstructor"]);
$verifyProperty(globalThis["BadPromiseConstructor"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BadPromiseConstructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["BadPromiseConstructor"], "name", {
  value: "BadPromiseConstructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BadPromiseConstructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
