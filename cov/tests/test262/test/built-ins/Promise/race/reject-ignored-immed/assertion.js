...
$assert.sameValue($Object_getPrototypeOf(globalThis["rejector"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejector"]), true);
$assert.notCallable(globalThis["rejector"]);
$assert.notConstructable(globalThis["rejector"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejector"]), ['then'], globalThis["rejector"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["rejector"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejector"]?.["then"]), true);
$assert.callable(globalThis["rejector"]?.["then"]);
$assert.constructable(globalThis["rejector"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejector"]?.["then"]), ['length', 'name', 'prototype'], globalThis["rejector"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["rejector"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejector"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["rejector"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["rejector"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejector"]?.["then"]?.["prototype"]), ['constructor'], globalThis["rejector"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["rejector"]?.["then"]?.["prototype"]?.["constructor"], globalThis["rejector"]?.["then"]);
$verifyProperty(globalThis["rejector"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejector"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["rejector"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejector"]?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rejector"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
