...
$assert.sameValue(globalThis["builtinResolve"], Promise.resolve);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["self"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(globalThis["self"]), true);
$assert.notCallable(globalThis["self"]);
$assert.notConstructable(globalThis["self"]);
$assert.compareArray($Reflect_ownKeys(globalThis["self"]), [], globalThis["self"]);
