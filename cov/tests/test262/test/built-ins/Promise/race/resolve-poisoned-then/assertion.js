...
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedThen"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedThen"]), true);
$assert.notCallable(globalThis["poisonedThen"]);
$assert.notConstructable(globalThis["poisonedThen"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedThen"]), ['then'], globalThis["poisonedThen"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedThen"], "then")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedThen"], "then", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["value"]), true);
$assert.notCallable(globalThis["value"]);
$assert.notConstructable(globalThis["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["value"]), [], globalThis["value"]);
