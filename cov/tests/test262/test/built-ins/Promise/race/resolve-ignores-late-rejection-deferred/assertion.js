...
$assert.sameValue($Object_getPrototypeOf(lateRejector), Object.prototype);
$assert.sameValue(Object.isExtensible(lateRejector), true);
$assert.notCallable(lateRejector);
$assert.notConstructable(lateRejector);
$assert.compareArray($Reflect_ownKeys(lateRejector), ['then'], lateRejector);
$assert.sameValue($Object_getPrototypeOf(lateRejector?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(lateRejector?.["then"]), true);
$assert.callable(lateRejector?.["then"]);
$assert.notConstructable(lateRejector?.["then"]);
$assert.compareArray($Reflect_ownKeys(lateRejector?.["then"]), ['length', 'name'], lateRejector?.["then"]);
$verifyProperty(lateRejector?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(lateRejector?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(lateRejector, "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(sequence), ['0', '1', '2', '3', '4', '5', '6', 'length'], sequence);
$verifyProperty(sequence, "4", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(sequence, "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(sequence, "5", {
  value: 6.0,
  writable: true,
  enumerable: true,
  configurable: true,
