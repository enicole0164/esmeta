...
$assert.sameValue($Object_getPrototypeOf(a), Object.prototype);
$assert.sameValue(Object.isExtensible(a), true);
$assert.notCallable(a);
$assert.notConstructable(a);
$assert.compareArray($Reflect_ownKeys(a), ['then'], a);
$assert.sameValue($Object_getPrototypeOf(a?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["then"]), true);
$assert.callable(a?.["then"]);
$assert.notConstructable(a?.["then"]);
$assert.compareArray($Reflect_ownKeys(a?.["then"]), ['length', 'name'], a?.["then"]);
$verifyProperty(a?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a, "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(callCount, 3.0);
$assert.sameValue($Object_getPrototypeOf(pResolve), Function.prototype);
$assert.sameValue(Object.isExtensible(pResolve), true);
$assert.callable(pResolve);
$assert.constructable(pResolve);
$assert.compareArray($Reflect_ownKeys(pResolve), ['length', 'name', 'prototype'], pResolve);
$assert.sameValue($Object_getPrototypeOf(pResolve?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(pResolve?.["prototype"]), true);
$assert.notCallable(pResolve?.["prototype"]);
$assert.notConstructable(pResolve?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(pResolve?.["prototype"]), ['constructor'], pResolve?.["prototype"]);
$assert.sameValue(pResolve?.["prototype"]?.["constructor"], pResolve);
$verifyProperty(pResolve?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(pResolve, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(pResolve, "name", {
  value: "resolve",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(pResolve, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
