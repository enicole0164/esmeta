...
$assert.sameValue($Object_getPrototypeOf(pReject), Function.prototype);
$assert.sameValue(Object.isExtensible(pReject), true);
$assert.callable(pReject);
$assert.constructable(pReject);
$assert.compareArray($Reflect_ownKeys(pReject), ['length', 'name', 'prototype'], pReject);
$assert.sameValue($Object_getPrototypeOf(pReject?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(pReject?.["prototype"]), true);
$assert.notCallable(pReject?.["prototype"]);
$assert.notConstructable(pReject?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(pReject?.["prototype"]), ['constructor'], pReject?.["prototype"]);
$assert.sameValue(pReject?.["prototype"]?.["constructor"], pReject);
$verifyProperty(pReject?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(pReject, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(pReject, "name", {
  value: "reject",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(pReject, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
