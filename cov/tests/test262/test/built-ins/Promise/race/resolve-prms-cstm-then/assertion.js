...
$assert.sameValue($Object_getPrototypeOf(globalThis["thenable"]), Promise.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["thenableValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenableValue"]), true);
$assert.notCallable(globalThis["thenableValue"]);
$assert.notConstructable(globalThis["thenableValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenableValue"]), ['then'], globalThis["thenableValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenableValue"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenableValue"]?.["then"]), true);
$assert.callable(globalThis["thenableValue"]?.["then"]);
$assert.constructable(globalThis["thenableValue"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenableValue"]?.["then"]), ['length', 'name', 'prototype'], globalThis["thenableValue"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thenableValue"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thenableValue"]?.["then"]?.["prototype"]), true);
$assert.notCallable(globalThis["thenableValue"]?.["then"]?.["prototype"]);
$assert.notConstructable(globalThis["thenableValue"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thenableValue"]?.["then"]?.["prototype"]), ['constructor'], globalThis["thenableValue"]?.["then"]?.["prototype"]);
$assert.sameValue(globalThis["thenableValue"]?.["then"]?.["prototype"]?.["constructor"], globalThis["thenableValue"]?.["then"]);
$verifyProperty(globalThis["thenableValue"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenableValue"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thenableValue"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenableValue"]?.["then"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thenableValue"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
