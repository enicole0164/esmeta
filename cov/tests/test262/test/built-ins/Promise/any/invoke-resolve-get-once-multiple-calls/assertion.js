...
$assert.compareArray($Reflect_ownKeys(promises?.["1"]), [], promises?.["1"]);
...
$assert.compareArray($Reflect_ownKeys(promises?.["2"]), [], promises?.["2"]);
...
$assert.compareArray($Reflect_ownKeys(promises?.["0"]), [], promises?.["0"]);
