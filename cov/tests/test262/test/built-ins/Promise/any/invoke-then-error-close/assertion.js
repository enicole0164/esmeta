...
$assert.sameValue($Object_getPrototypeOf(iter), Object.prototype);
$assert.sameValue(Object.isExtensible(iter), true);
$assert.notCallable(iter);
$assert.notConstructable(iter);
$assert.compareArray($Reflect_ownKeys(iter), [Symbol.iterator], iter);
$assert.sameValue($Object_getPrototypeOf(iter?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(iter?.[Symbol.iterator]), true);
$assert.callable(iter?.[Symbol.iterator]);
$assert.notConstructable(iter?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(iter?.[Symbol.iterator]), ['length', 'name'], iter?.[Symbol.iterator]);
$verifyProperty(iter?.[Symbol.iterator], "name", {
  value: "[Symbol.iterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iter?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iter, Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(promise), ['then'], promise);
$assert.sameValue($Object_getPrototypeOf(promise?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(promise?.["then"]), true);
$assert.callable(promise?.["then"]);
$assert.constructable(promise?.["then"]);
$assert.compareArray($Reflect_ownKeys(promise?.["then"]), ['length', 'name', 'prototype'], promise?.["then"]);
$assert.sameValue($Object_getPrototypeOf(promise?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(promise?.["then"]?.["prototype"]), true);
$assert.notCallable(promise?.["then"]?.["prototype"]);
$assert.notConstructable(promise?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(promise?.["then"]?.["prototype"]), ['constructor'], promise?.["then"]?.["prototype"]);
$assert.sameValue(promise?.["then"]?.["prototype"]?.["constructor"], promise?.["then"]);
$verifyProperty(promise?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promise?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(promise?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promise?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promise, "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
