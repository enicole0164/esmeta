...
$assert.sameValue($Object_getPrototypeOf(P), Function.prototype);
$assert.sameValue(Object.isExtensible(P), true);
$assert.callable(P);
$assert.constructable(P);
$assert.compareArray($Reflect_ownKeys(P), ['length', 'name', 'prototype', 'resolve'], P);
$assert.sameValue($Object_getPrototypeOf(P?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(P?.["prototype"]), true);
$assert.notCallable(P?.["prototype"]);
$assert.notConstructable(P?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(P?.["prototype"]), ['constructor'], P?.["prototype"]);
$assert.sameValue(P?.["prototype"]?.["constructor"], P);
$verifyProperty(P?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(P, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(P, "name", {
  value: "P",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(P?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(P?.["resolve"]), true);
$assert.callable(P?.["resolve"]);
$assert.constructable(P?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(P?.["resolve"]), ['length', 'name', 'prototype'], P?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(P?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(P?.["resolve"]?.["prototype"]), true);
$assert.notCallable(P?.["resolve"]?.["prototype"]);
$assert.notConstructable(P?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(P?.["resolve"]?.["prototype"]), ['constructor'], P?.["resolve"]?.["prototype"]);
$assert.sameValue(P?.["resolve"]?.["prototype"]?.["constructor"], P?.["resolve"]);
$verifyProperty(P?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(P?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(P?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(P?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(P, "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(P, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(newCallCount, 1.0);
$assert.sameValue($Object_getPrototypeOf(newThenable), Object.prototype);
$assert.sameValue(Object.isExtensible(newThenable), true);
$assert.notCallable(newThenable);
$assert.notConstructable(newThenable);
$assert.compareArray($Reflect_ownKeys(newThenable), ['then'], newThenable);
$assert.sameValue($Object_getPrototypeOf(newThenable?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(newThenable?.["then"]), true);
$assert.callable(newThenable?.["then"]);
$assert.notConstructable(newThenable?.["then"]);
$assert.compareArray($Reflect_ownKeys(newThenable?.["then"]), ['length', 'name'], newThenable?.["then"]);
$verifyProperty(newThenable?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(newThenable?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(newThenable, "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(originalCallCount, 0.0);
$assert.sameValue($Object_getPrototypeOf(originalThenable), Object.prototype);
$assert.sameValue(Object.isExtensible(originalThenable), true);
$assert.notCallable(originalThenable);
$assert.notConstructable(originalThenable);
$assert.compareArray($Reflect_ownKeys(originalThenable), ['then'], originalThenable);
$assert.sameValue($Object_getPrototypeOf(originalThenable?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(originalThenable?.["then"]), true);
$assert.callable(originalThenable?.["then"]);
$assert.notConstructable(originalThenable?.["then"]);
$assert.compareArray($Reflect_ownKeys(originalThenable?.["then"]), ['length', 'name'], originalThenable?.["then"]);
$verifyProperty(originalThenable?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(originalThenable?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(originalThenable, "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
