...
$assert.sameValue($Object_getPrototypeOf(Custom), Promise);
$assert.sameValue(Object.isExtensible(Custom), true);
$assert.callable(Custom);
$assert.constructable(Custom);
$assert.compareArray($Reflect_ownKeys(Custom), ['length', 'name', 'prototype', 'resolve'], Custom);
$assert.sameValue($Object_getPrototypeOf(Custom?.["prototype"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(Custom?.["prototype"]), true);
$assert.notCallable(Custom?.["prototype"]);
$assert.notConstructable(Custom?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Custom?.["prototype"]), ['constructor'], Custom?.["prototype"]);
$assert.sameValue(Custom?.["prototype"]?.["constructor"], Custom);
$verifyProperty(Custom?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Custom, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Custom, "name", {
  value: "Custom",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Custom?.["resolve"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Custom?.["resolve"]), true);
$assert.callable(Custom?.["resolve"]);
$assert.constructable(Custom?.["resolve"]);
$assert.compareArray($Reflect_ownKeys(Custom?.["resolve"]), ['length', 'name', 'prototype'], Custom?.["resolve"]);
$assert.sameValue($Object_getPrototypeOf(Custom?.["resolve"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Custom?.["resolve"]?.["prototype"]), true);
$assert.notCallable(Custom?.["resolve"]?.["prototype"]);
$assert.notConstructable(Custom?.["resolve"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Custom?.["resolve"]?.["prototype"]), ['constructor'], Custom?.["resolve"]?.["prototype"]);
$assert.sameValue(Custom?.["resolve"]?.["prototype"]?.["constructor"], Custom?.["resolve"]);
$verifyProperty(Custom?.["resolve"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Custom?.["resolve"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Custom?.["resolve"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Custom?.["resolve"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Custom, "resolve", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(Custom, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(boundCustomResolve), Function.prototype);
$assert.sameValue(Object.isExtensible(boundCustomResolve), true);
$assert.callable(boundCustomResolve);
$assert.notConstructable(boundCustomResolve);
$assert.compareArray($Reflect_ownKeys(boundCustomResolve), ['length', 'name'], boundCustomResolve);
$verifyProperty(boundCustomResolve, "name", {
  value: "bound resolve",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(boundCustomResolve, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(boundPromiseResolve), Function.prototype);
$assert.sameValue(Object.isExtensible(boundPromiseResolve), true);
$assert.callable(boundPromiseResolve);
$assert.notConstructable(boundPromiseResolve);
$assert.compareArray($Reflect_ownKeys(boundPromiseResolve), ['length', 'name'], boundPromiseResolve);
$verifyProperty(boundPromiseResolve, "name", {
  value: "bound resolve",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(boundPromiseResolve, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(cresolveCallCount, 3.0);
$assert.sameValue(presolveCallCount, 0.0);
$assert.sameValue($Object_getPrototypeOf(values), Array.prototype);
$assert.sameValue(Object.isExtensible(values), true);
$assert.notCallable(values);
$assert.notConstructable(values);
$assert.compareArray($Reflect_ownKeys(values), ['0', '1', '2', 'length'], values);
$verifyProperty(values, "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(values, "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(values, "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(values, "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
