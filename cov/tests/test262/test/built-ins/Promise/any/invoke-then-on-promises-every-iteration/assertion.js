...
$assert.sameValue(callCount, 3.0);
$assert.sameValue($Object_getPrototypeOf(promises), Array.prototype);
$assert.sameValue(Object.isExtensible(promises), true);
$assert.notCallable(promises);
$assert.notConstructable(promises);
$assert.compareArray($Reflect_ownKeys(promises), ['0', '1', '2', 'length'], promises);
$assert.sameValue($Object_getPrototypeOf(promises?.["1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(promises?.["1"]), true);
$assert.notCallable(promises?.["1"]);
$assert.notConstructable(promises?.["1"]);
$assert.compareArray($Reflect_ownKeys(promises?.["1"]), ['then'], promises?.["1"]);
$assert.sameValue($Object_getPrototypeOf(promises?.["1"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(promises?.["1"]?.["then"]), true);
$assert.callable(promises?.["1"]?.["then"]);
$assert.constructable(promises?.["1"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(promises?.["1"]?.["then"]), ['length', 'name', 'prototype'], promises?.["1"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(promises?.["1"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(promises?.["1"]?.["then"]?.["prototype"]), true);
$assert.notCallable(promises?.["1"]?.["then"]?.["prototype"]);
$assert.notConstructable(promises?.["1"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(promises?.["1"]?.["then"]?.["prototype"]), ['constructor'], promises?.["1"]?.["then"]?.["prototype"]);
$assert.sameValue(promises?.["1"]?.["then"]?.["prototype"]?.["constructor"], promises?.["1"]?.["then"]);
$verifyProperty(promises?.["1"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["1"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(promises?.["1"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["1"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["1"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(promises, "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(promises?.["2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(promises?.["2"]), true);
$assert.notCallable(promises?.["2"]);
$assert.notConstructable(promises?.["2"]);
$assert.compareArray($Reflect_ownKeys(promises?.["2"]), ['then'], promises?.["2"]);
$assert.sameValue($Object_getPrototypeOf(promises?.["2"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(promises?.["2"]?.["then"]), true);
$assert.callable(promises?.["2"]?.["then"]);
$assert.constructable(promises?.["2"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(promises?.["2"]?.["then"]), ['length', 'name', 'prototype'], promises?.["2"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(promises?.["2"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(promises?.["2"]?.["then"]?.["prototype"]), true);
$assert.notCallable(promises?.["2"]?.["then"]?.["prototype"]);
$assert.notConstructable(promises?.["2"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(promises?.["2"]?.["then"]?.["prototype"]), ['constructor'], promises?.["2"]?.["then"]?.["prototype"]);
$assert.sameValue(promises?.["2"]?.["then"]?.["prototype"]?.["constructor"], promises?.["2"]?.["then"]);
$verifyProperty(promises?.["2"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["2"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(promises?.["2"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["2"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["2"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(promises, "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(promises, "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(promises?.["0"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(promises?.["0"]), true);
$assert.notCallable(promises?.["0"]);
$assert.notConstructable(promises?.["0"]);
$assert.compareArray($Reflect_ownKeys(promises?.["0"]), ['then'], promises?.["0"]);
$assert.sameValue($Object_getPrototypeOf(promises?.["0"]?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(promises?.["0"]?.["then"]), true);
$assert.callable(promises?.["0"]?.["then"]);
$assert.constructable(promises?.["0"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(promises?.["0"]?.["then"]), ['length', 'name', 'prototype'], promises?.["0"]?.["then"]);
$assert.sameValue($Object_getPrototypeOf(promises?.["0"]?.["then"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(promises?.["0"]?.["then"]?.["prototype"]), true);
$assert.notCallable(promises?.["0"]?.["then"]?.["prototype"]);
$assert.notConstructable(promises?.["0"]?.["then"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(promises?.["0"]?.["then"]?.["prototype"]), ['constructor'], promises?.["0"]?.["then"]?.["prototype"]);
$assert.sameValue(promises?.["0"]?.["then"]?.["prototype"]?.["constructor"], promises?.["0"]?.["then"]);
$verifyProperty(promises?.["0"]?.["then"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["0"]?.["then"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(promises?.["0"]?.["then"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["0"]?.["then"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(promises?.["0"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(promises, "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
