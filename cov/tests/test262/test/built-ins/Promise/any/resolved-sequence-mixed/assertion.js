...
$assert.sameValue($Object_getPrototypeOf(p1), Promise.prototype);
$assert.sameValue(Object.isExtensible(p1), true);
$assert.notCallable(p1);
$assert.notConstructable(p1);
$assert.compareArray($Reflect_ownKeys(p1), [], p1);
$assert.sameValue($Object_getPrototypeOf(p2), Promise.prototype);
$assert.sameValue(Object.isExtensible(p2), true);
$assert.notCallable(p2);
$assert.notConstructable(p2);
$assert.compareArray($Reflect_ownKeys(p2), [], p2);
$assert.sameValue($Object_getPrototypeOf(p3), Promise.prototype);
$assert.sameValue(Object.isExtensible(p3), true);
$assert.notCallable(p3);
$assert.notConstructable(p3);
$assert.compareArray($Reflect_ownKeys(p3), [], p3);
...
$assert.compareArray($Reflect_ownKeys(sequence), ['0', '1', '2', '3', '4', '5', 'length'], sequence);
