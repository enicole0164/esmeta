...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(promise, "then")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(promise, "then")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(promise, "then")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(promise, "then")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(promise, "then")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(promise, "then")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(promise, "then")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(promise, "then")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
