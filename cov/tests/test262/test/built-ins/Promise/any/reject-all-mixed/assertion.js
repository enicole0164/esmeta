...
$assert.sameValue($Object_getPrototypeOf(rejections), Array.prototype);
$assert.sameValue(Object.isExtensible(rejections), true);
$assert.notCallable(rejections);
$assert.notConstructable(rejections);
$assert.compareArray($Reflect_ownKeys(rejections), ['0', '1', '2', '3', 'length'], rejections);
$assert.sameValue($Object_getPrototypeOf(rejections?.["2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(rejections?.["2"]), true);
$assert.notCallable(rejections?.["2"]);
$assert.notConstructable(rejections?.["2"]);
$assert.compareArray($Reflect_ownKeys(rejections?.["2"]), [], rejections?.["2"]);
$verifyProperty(rejections, "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(rejections, "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(rejections?.["1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(rejections?.["1"]), true);
$assert.notCallable(rejections?.["1"]);
$assert.notConstructable(rejections?.["1"]);
$assert.compareArray($Reflect_ownKeys(rejections?.["1"]), [], rejections?.["1"]);
$verifyProperty(rejections, "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(rejections?.["3"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(rejections?.["3"]), true);
$assert.notCallable(rejections?.["3"]);
$assert.notConstructable(rejections?.["3"]);
$assert.compareArray($Reflect_ownKeys(rejections?.["3"]), [], rejections?.["3"]);
$verifyProperty(rejections, "3", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(rejections?.["0"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(rejections?.["0"]), true);
$assert.notCallable(rejections?.["0"]);
$assert.notConstructable(rejections?.["0"]);
$assert.compareArray($Reflect_ownKeys(rejections?.["0"]), [], rejections?.["0"]);
$verifyProperty(rejections, "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
