...
$assert.sameValue($Object_getPrototypeOf(iterStepThrows), Object.prototype);
$assert.sameValue(Object.isExtensible(iterStepThrows), true);
$assert.notCallable(iterStepThrows);
$assert.notConstructable(iterStepThrows);
$assert.compareArray($Reflect_ownKeys(iterStepThrows), [Symbol.iterator], iterStepThrows);
$assert.sameValue($Object_getPrototypeOf(iterStepThrows?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(iterStepThrows?.[Symbol.iterator]), true);
$assert.callable(iterStepThrows?.[Symbol.iterator]);
$assert.notConstructable(iterStepThrows?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(iterStepThrows?.[Symbol.iterator]), ['length', 'name'], iterStepThrows?.[Symbol.iterator]);
$verifyProperty(iterStepThrows?.[Symbol.iterator], "name", {
  value: "[Symbol.iterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterStepThrows?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterStepThrows, Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(poisonedDone), Object.prototype);
$assert.sameValue(Object.isExtensible(poisonedDone), true);
$assert.notCallable(poisonedDone);
$assert.notConstructable(poisonedDone);
$assert.compareArray($Reflect_ownKeys(poisonedDone), ['done', 'value'], poisonedDone);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(poisonedDone, "done")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(poisonedDone, "done", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(poisonedDone, "value")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(poisonedDone, "value", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
