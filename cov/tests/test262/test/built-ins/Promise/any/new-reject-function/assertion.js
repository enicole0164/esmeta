...
$assert.sameValue($Object_getPrototypeOf(globalThis["p1OnRejected"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p1OnRejected"]), true);
$assert.callable(globalThis["p1OnRejected"]);
$assert.notConstructable(globalThis["p1OnRejected"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1OnRejected"]), ['length', 'name'], globalThis["p1OnRejected"]);
$verifyProperty(globalThis["p1OnRejected"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1OnRejected"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
