...
$assert.sameValue($Object_getPrototypeOf(error), AggregateError.prototype);
$assert.notCallable(error);
$assert.notConstructable(error);
$assert.compareArray($Reflect_ownKeys(error), ['errors'], error);
$assert.sameValue($Object_getPrototypeOf(error?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(error?.["errors"]), true);
$assert.notCallable(error?.["errors"]);
$assert.notConstructable(error?.["errors"]);
$assert.compareArray($Reflect_ownKeys(error?.["errors"]), ['0', '1', '2', 'length'], error?.["errors"]);
$verifyProperty(error?.["errors"], "1", {
  value: "p2-rejection",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(error?.["errors"], "2", {
  value: "p3-rejection",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(error?.["errors"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(error?.["errors"], "0", {
  value: "p1-rejection",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(error, "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(p2OnRejected), Function.prototype);
$assert.sameValue(Object.isExtensible(p2OnRejected), true);
$assert.callable(p2OnRejected);
$assert.notConstructable(p2OnRejected);
$assert.compareArray($Reflect_ownKeys(p2OnRejected), ['length', 'name'], p2OnRejected);
$verifyProperty(p2OnRejected, "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(p2OnRejected, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(p3OnRejected), Function.prototype);
$assert.sameValue(Object.isExtensible(p3OnRejected), true);
$assert.callable(p3OnRejected);
$assert.notConstructable(p3OnRejected);
$assert.compareArray($Reflect_ownKeys(p3OnRejected), ['length', 'name'], p3OnRejected);
$verifyProperty(p3OnRejected, "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(p3OnRejected, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
