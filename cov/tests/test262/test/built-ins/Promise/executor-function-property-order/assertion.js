...
$assert.compareArray($Reflect_ownKeys(globalThis["NotPromise"]), ['length', 'name', 'prototype'], globalThis["NotPromise"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["executorFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["executorFunction"]), true);
$assert.callable(globalThis["executorFunction"]);
$assert.notConstructable(globalThis["executorFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["executorFunction"]), ['length', 'name'], globalThis["executorFunction"]);
$verifyProperty(globalThis["executorFunction"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["executorFunction"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
