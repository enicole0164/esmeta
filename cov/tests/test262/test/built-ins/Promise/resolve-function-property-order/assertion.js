...
$assert.notConstructable(globalThis["resolveFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["resolveFunction"]), ['length', 'name'], globalThis["resolveFunction"]);
