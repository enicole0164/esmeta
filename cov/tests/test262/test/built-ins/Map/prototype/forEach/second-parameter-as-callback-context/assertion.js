...
$assert.compareArray($Reflect_ownKeys(globalThis["_this"]), ['0', '1', '2', 'length'], globalThis["_this"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["_this"]?.["1"]), Object.prototype);
...
$assert.sameValue(globalThis["_this"]?.["2"], globalThis["_this"]?.["1"]);
$verifyProperty(globalThis["_this"], "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["expectedThis"], globalThis["_this"]?.["1"]);
