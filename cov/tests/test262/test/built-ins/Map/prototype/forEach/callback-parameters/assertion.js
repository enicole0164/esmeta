...
$assert.sameValue($Object_getPrototypeOf(globalThis["callback"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callback"]), true);
$assert.callable(globalThis["callback"]);
$assert.constructable(globalThis["callback"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callback"]), ['length', 'name', 'prototype'], globalThis["callback"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["callback"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callback"]?.["prototype"]), true);
$assert.notCallable(globalThis["callback"]?.["prototype"]);
$assert.notConstructable(globalThis["callback"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callback"]?.["prototype"]), ['constructor'], globalThis["callback"]?.["prototype"]);
$assert.sameValue(globalThis["callback"]?.["prototype"]?.["constructor"], globalThis["callback"]);
$verifyProperty(globalThis["callback"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callback"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["callback"], "name", {
  value: "callback",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callback"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["map"]), Map.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]), ['value', 'key', 'thisArg'], globalThis["results"]?.["1"]);
...
$assert.sameValue(globalThis["results"]?.["1"]?.["thisArg"], globalThis["map"]);
$verifyProperty(globalThis["results"]?.["1"], "thisArg", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"]?.["1"], "key", {
  value: "bar",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["0"]), ['value', 'key', 'thisArg'], globalThis["results"]?.["0"]);
...
$assert.sameValue(globalThis["results"]?.["0"]?.["thisArg"], globalThis["map"]);
$verifyProperty(globalThis["results"]?.["0"], "thisArg", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"]?.["0"], "key", {
  value: "foo",
  writable: true,
  enumerable: true,
  configurable: true,
