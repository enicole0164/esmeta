...
$assert.sameValue(globalThis["count"], 3.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]), ['value', 'key'], globalThis["results"]?.["1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["2"]), ['value', 'key'], globalThis["results"]?.["2"]);
...
$verifyProperty(globalThis["results"]?.["2"], "key", {
  value: "baz",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["0"]), ['value', 'key'], globalThis["results"]?.["0"]);
