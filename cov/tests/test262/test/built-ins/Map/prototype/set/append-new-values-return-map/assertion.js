...
$assert.sameValue($Object_getPrototypeOf(globalThis["map2"]), Map.prototype);
$assert.sameValue(Object.isExtensible(globalThis["map2"]), true);
$assert.notCallable(globalThis["map2"]);
$assert.notConstructable(globalThis["map2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["map2"]), [], globalThis["map2"]);
$assert.sameValue(globalThis["result"], globalThis["map"]);
