...
$assert.sameValue($Object_getPrototypeOf(globalThis["e"]), MapIteratorPrototype);
$assert.sameValue(Object.isExtensible(globalThis["e"]), true);
$assert.notCallable(globalThis["e"]);
$assert.notConstructable(globalThis["e"]);
$assert.compareArray($Reflect_ownKeys(globalThis["e"]), [], globalThis["e"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m"]), Map.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["m"]), [], globalThis["m"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["n"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["n"]), ['value', 'done'], globalThis["n"]);
$verifyProperty(globalThis["n"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["n"], "value", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
