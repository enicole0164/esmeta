...
$assert.sameValue($Object_getPrototypeOf(globalThis["m1"]), Map.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m1"]), true);
$assert.notCallable(globalThis["m1"]);
$assert.notConstructable(globalThis["m1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m1"]), [], globalThis["m1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m2"]), Map.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m2"]), true);
$assert.notCallable(globalThis["m2"]);
$assert.notConstructable(globalThis["m2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m2"]), [], globalThis["m2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m3"]), Map.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m3"]), true);
$assert.notCallable(globalThis["m3"]);
$assert.notConstructable(globalThis["m3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m3"]), [], globalThis["m3"]);
