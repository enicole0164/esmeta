...
$assert.sameValue($Object_getPrototypeOf(globalThis["_this"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_this"]), true);
$assert.notCallable(globalThis["_this"]);
$assert.notConstructable(globalThis["_this"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_this"]), ['0', '1', 'length'], globalThis["_this"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["_this"]?.["1"]), Map.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_this"]?.["1"]), true);
$assert.notCallable(globalThis["_this"]?.["1"]);
$assert.notConstructable(globalThis["_this"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_this"]?.["1"]), [], globalThis["_this"]?.["1"]);
$verifyProperty(globalThis["_this"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["_this"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["_this"]?.["0"], globalThis["_this"]?.["1"]);
$verifyProperty(globalThis["_this"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]), ['0', '1', 'length'], globalThis["iterable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterable"]?.["1"]), true);
$assert.notCallable(globalThis["iterable"]?.["1"]);
$assert.notConstructable(globalThis["iterable"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]?.["1"]), ['0', '1', 'length'], globalThis["iterable"]?.["1"]);
$verifyProperty(globalThis["iterable"]?.["1"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterable"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["iterable"]?.["1"], "0", {
  value: "bar",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterable"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterable"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterable"]?.["0"]), true);
$assert.notCallable(globalThis["iterable"]?.["0"]);
$assert.notConstructable(globalThis["iterable"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]?.["0"]), ['0', '1', 'length'], globalThis["iterable"]?.["0"]);
$verifyProperty(globalThis["iterable"]?.["0"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterable"]?.["0"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["iterable"]?.["0"], "0", {
  value: "foo",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterable"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["map"], globalThis["_this"]?.["1"]);
$assert.sameValue(globalThis["mapSet"], Map.prototype.set);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]), ['0', '1', 'length'], globalThis["results"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]?.["1"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]), ['0', '1', 'length'], globalThis["results"]?.["1"]);
$verifyProperty(globalThis["results"]?.["1"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["results"]?.["1"], "0", {
  value: "bar",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]?.["0"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["0"]), ['0', '1', 'length'], globalThis["results"]?.["0"]);
$verifyProperty(globalThis["results"]?.["0"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"]?.["0"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["results"]?.["0"], "0", {
  value: "foo",
  writable: true,
  enumerable: true,
  configurable: true,
