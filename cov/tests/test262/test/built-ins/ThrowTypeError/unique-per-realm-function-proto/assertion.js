...
$assert.sameValue($Object_getPrototypeOf(globalThis["argumentsDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argumentsDesc"]), true);
$assert.notCallable(globalThis["argumentsDesc"]);
$assert.notConstructable(globalThis["argumentsDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argumentsDesc"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["argumentsDesc"]);
$assert.sameValue(globalThis["argumentsDesc"]?.["get"], ThrowTypeError);
$verifyProperty(globalThis["argumentsDesc"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["argumentsDesc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["argumentsDesc"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["argumentsDesc"]?.["set"], ThrowTypeError);
$verifyProperty(globalThis["argumentsDesc"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["callerDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callerDesc"]), true);
$assert.notCallable(globalThis["callerDesc"]);
$assert.notConstructable(globalThis["callerDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callerDesc"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["callerDesc"]);
$assert.sameValue(globalThis["callerDesc"]?.["get"], ThrowTypeError);
$verifyProperty(globalThis["callerDesc"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["callerDesc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["callerDesc"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["callerDesc"]?.["set"], ThrowTypeError);
$verifyProperty(globalThis["callerDesc"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
