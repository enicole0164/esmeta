...
$assert.sameValue($Object_getPrototypeOf(globalThis["strictFn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["strictFn"]), true);
$assert.callable(globalThis["strictFn"]);
$assert.constructable(globalThis["strictFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["strictFn"]), ['length', 'name', 'prototype'], globalThis["strictFn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["strictFn"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["strictFn"]?.["prototype"]), true);
$assert.notCallable(globalThis["strictFn"]?.["prototype"]);
$assert.notConstructable(globalThis["strictFn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["strictFn"]?.["prototype"]), ['constructor'], globalThis["strictFn"]?.["prototype"]);
$assert.sameValue(globalThis["strictFn"]?.["prototype"]?.["constructor"], globalThis["strictFn"]);
$verifyProperty(globalThis["strictFn"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["strictFn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["strictFn"], "name", {
  value: "strictFn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["strictFn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
