...
$assert.sameValue(globalThis["ThrowTypeError"], ThrowTypeError);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["nonSimple"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nonSimple"]), true);
$assert.callable(globalThis["nonSimple"]);
$assert.constructable(globalThis["nonSimple"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nonSimple"]), ['length', 'name', 'prototype'], globalThis["nonSimple"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["nonSimple"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nonSimple"]?.["prototype"]), true);
$assert.notCallable(globalThis["nonSimple"]?.["prototype"]);
$assert.notConstructable(globalThis["nonSimple"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nonSimple"]?.["prototype"]), ['constructor'], globalThis["nonSimple"]?.["prototype"]);
$assert.sameValue(globalThis["nonSimple"]?.["prototype"]?.["constructor"], globalThis["nonSimple"]);
$verifyProperty(globalThis["nonSimple"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["nonSimple"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["nonSimple"], "name", {
  value: "nonSimple",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["nonSimple"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["unmappedCalleeDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["unmappedCalleeDesc"]), true);
$assert.notCallable(globalThis["unmappedCalleeDesc"]);
$assert.notConstructable(globalThis["unmappedCalleeDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["unmappedCalleeDesc"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["unmappedCalleeDesc"]);
$assert.sameValue(globalThis["unmappedCalleeDesc"]?.["get"], ThrowTypeError);
$verifyProperty(globalThis["unmappedCalleeDesc"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["unmappedCalleeDesc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["unmappedCalleeDesc"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["unmappedCalleeDesc"]?.["set"], ThrowTypeError);
$verifyProperty(globalThis["unmappedCalleeDesc"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
