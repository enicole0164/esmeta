...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]), WeakMap.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["b"]), WeakMap.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["c"]), WeakMap.prototype);
