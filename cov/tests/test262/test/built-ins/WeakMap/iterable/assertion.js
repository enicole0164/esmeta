...
$assert.sameValue($Object_getPrototypeOf(globalThis["first"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["first"]), true);
$assert.notCallable(globalThis["first"]);
$assert.notConstructable(globalThis["first"]);
$assert.compareArray($Reflect_ownKeys(globalThis["first"]), [], globalThis["first"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["map"]), WeakMap.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]), ['_this', 'key', 'value'], globalThis["results"]?.["1"]);
...
$assert.sameValue(globalThis["results"]?.["1"]?.["_this"], globalThis["map"]);
$verifyProperty(globalThis["results"]?.["1"], "_this", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]?.["1"]?.["key"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["results"]?.["1"]?.["key"]), true);
$assert.notCallable(globalThis["results"]?.["1"]?.["key"]);
$assert.notConstructable(globalThis["results"]?.["1"]?.["key"]);
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]?.["key"]), [], globalThis["results"]?.["1"]?.["key"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["0"]), ['_this', 'key', 'value'], globalThis["results"]?.["0"]);
...
$assert.sameValue(globalThis["results"]?.["0"]?.["_this"], globalThis["map"]);
$verifyProperty(globalThis["results"]?.["0"], "_this", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["results"]?.["0"]?.["key"], globalThis["first"]);
...
$assert.sameValue(globalThis["second"], globalThis["results"]?.["1"]?.["key"]);
$assert.sameValue(globalThis["set"], WeakMap.prototype.set);
