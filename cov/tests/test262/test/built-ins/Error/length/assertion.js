...
$assert.sameValue($Object_getPrototypeOf(globalThis["err1"]), Error.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["err1"]), ['message'], globalThis["err1"]);
$verifyProperty(globalThis["err1"], "message", {
  value: "err",
  writable: true,
  enumerable: false,
  configurable: true,
