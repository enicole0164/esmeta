...
$assert.sameValue(globalThis["calls"], "toStringvalueOf");
$assert.sameValue($Object_getPrototypeOf(globalThis["val"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["val"]), true);
$assert.notCallable(globalThis["val"]);
$assert.notConstructable(globalThis["val"]);
$assert.compareArray($Reflect_ownKeys(globalThis["val"]), ['toString', 'valueOf'], globalThis["val"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["val"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["val"]?.["toString"]), true);
$assert.callable(globalThis["val"]?.["toString"]);
$assert.constructable(globalThis["val"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["val"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["val"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["val"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["val"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["val"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["val"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["val"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["val"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["val"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["val"]?.["toString"]);
$verifyProperty(globalThis["val"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["val"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["val"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["val"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["val"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["val"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["val"]?.["valueOf"]), true);
$assert.callable(globalThis["val"]?.["valueOf"]);
$assert.constructable(globalThis["val"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["val"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["val"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["val"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["val"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["val"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["val"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["val"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["val"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["val"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["val"]?.["valueOf"]);
$verifyProperty(globalThis["val"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["val"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["val"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["val"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["val"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
