...
$assert.sameValue($Object_getPrototypeOf(globalThis["symObj"]), Symbol.prototype);
$assert.sameValue(Object.isExtensible(globalThis["symObj"]), true);
$assert.notCallable(globalThis["symObj"]);
$assert.notConstructable(globalThis["symObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["symObj"]), [], globalThis["symObj"]);
