...
$assert.sameValue($Object_getPrototypeOf(globalThis["symbolObject"]), Symbol.prototype);
$assert.sameValue(Object.isExtensible(globalThis["symbolObject"]), true);
$assert.notCallable(globalThis["symbolObject"]);
$assert.notConstructable(globalThis["symbolObject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["symbolObject"]), [], globalThis["symbolObject"]);
$assert.sameValue(globalThis["valueOf"], Symbol.prototype.valueOf);
