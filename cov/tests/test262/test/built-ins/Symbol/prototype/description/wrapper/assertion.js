...
$assert.sameValue($Object_getPrototypeOf(empty), Symbol.prototype);
$assert.sameValue(Object.isExtensible(empty), true);
$assert.notCallable(empty);
$assert.notConstructable(empty);
$assert.compareArray($Reflect_ownKeys(empty), [], empty);
$assert.sameValue($Object_getPrototypeOf(emptyStr), Symbol.prototype);
$assert.sameValue(Object.isExtensible(emptyStr), true);
$assert.notCallable(emptyStr);
$assert.notConstructable(emptyStr);
$assert.compareArray($Reflect_ownKeys(emptyStr), [], emptyStr);
$assert.sameValue($Object_getPrototypeOf(symbol), Symbol.prototype);
$assert.sameValue(Object.isExtensible(symbol), true);
$assert.notCallable(symbol);
$assert.notConstructable(symbol);
$assert.compareArray($Reflect_ownKeys(symbol), [], symbol);
$assert.sameValue($Object_getPrototypeOf(undef), Symbol.prototype);
$assert.sameValue(Object.isExtensible(undef), true);
$assert.notCallable(undef);
$assert.notConstructable(undef);
$assert.compareArray($Reflect_ownKeys(undef), [], undef);
