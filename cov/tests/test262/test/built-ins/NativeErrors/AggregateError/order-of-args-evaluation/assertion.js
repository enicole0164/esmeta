...
$assert.sameValue($Object_getPrototypeOf(errors), Object.prototype);
$assert.sameValue(Object.isExtensible(errors), true);
$assert.notCallable(errors);
$assert.notConstructable(errors);
$assert.compareArray($Reflect_ownKeys(errors), [Symbol.iterator], errors);
$assert.sameValue($Object_getPrototypeOf(errors?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(errors?.[Symbol.iterator]), true);
$assert.callable(errors?.[Symbol.iterator]);
$assert.notConstructable(errors?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(errors?.[Symbol.iterator]), ['length', 'name'], errors?.[Symbol.iterator]);
$verifyProperty(errors?.[Symbol.iterator], "name", {
  value: "[Symbol.iterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(errors?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(errors, Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(message), Object.prototype);
$assert.sameValue(Object.isExtensible(message), true);
$assert.notCallable(message);
$assert.notConstructable(message);
$assert.compareArray($Reflect_ownKeys(message), ['toString'], message);
$assert.sameValue($Object_getPrototypeOf(message?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(message?.["toString"]), true);
$assert.callable(message?.["toString"]);
$assert.notConstructable(message?.["toString"]);
$assert.compareArray($Reflect_ownKeys(message?.["toString"]), ['length', 'name'], message?.["toString"]);
$verifyProperty(message?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(message?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(message, "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(sequence), Array.prototype);
$assert.sameValue(Object.isExtensible(sequence), true);
$assert.notCallable(sequence);
$assert.notConstructable(sequence);
$assert.compareArray($Reflect_ownKeys(sequence), ['0', '1', '2', 'length'], sequence);
$verifyProperty(sequence, "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(sequence, "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(sequence, "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(sequence, "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
