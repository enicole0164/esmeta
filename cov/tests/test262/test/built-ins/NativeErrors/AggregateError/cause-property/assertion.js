...
$assert.sameValue($Object_getPrototypeOf(globalThis["error"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["error"]), ['message', 'errors'], globalThis["error"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["error"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["error"]?.["errors"]), true);
$assert.notCallable(globalThis["error"]?.["errors"]);
$assert.notConstructable(globalThis["error"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["error"]?.["errors"]), ['length'], globalThis["error"]?.["errors"]);
$verifyProperty(globalThis["error"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["error"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errors"]), true);
$assert.notCallable(globalThis["errors"]);
$assert.notConstructable(globalThis["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errors"]), ['length'], globalThis["errors"]);
$verifyProperty(globalThis["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
