...
$assert.compareArray($Reflect_ownKeys(globalThis["case1"]), ['toString', 'valueOf', Symbol.toPrimitive], globalThis["case1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case1"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case1"]?.["toString"]), true);
$assert.callable(globalThis["case1"]?.["toString"]);
$assert.notConstructable(globalThis["case1"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case1"]?.["toString"]), ['length', 'name'], globalThis["case1"]?.["toString"]);
$verifyProperty(globalThis["case1"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case1"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case1"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case1"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case1"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["case1"]?.[Symbol.toPrimitive]);
$assert.notConstructable(globalThis["case1"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["case1"]?.[Symbol.toPrimitive]), ['length', 'name'], globalThis["case1"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["case1"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case1"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case1"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case1"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case1"]?.["valueOf"]), true);
$assert.callable(globalThis["case1"]?.["valueOf"]);
$assert.notConstructable(globalThis["case1"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case1"]?.["valueOf"]), ['length', 'name'], globalThis["case1"]?.["valueOf"]);
$verifyProperty(globalThis["case1"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case1"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["case2"]), ['toString', 'valueOf', Symbol.toPrimitive], globalThis["case2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case2"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case2"]?.["toString"]), true);
$assert.callable(globalThis["case2"]?.["toString"]);
$assert.notConstructable(globalThis["case2"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case2"]?.["toString"]), ['length', 'name'], globalThis["case2"]?.["toString"]);
$verifyProperty(globalThis["case2"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case2"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case2"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["case2"], Symbol.toPrimitive, {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case2"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case2"]?.["valueOf"]), true);
$assert.callable(globalThis["case2"]?.["valueOf"]);
$assert.notConstructable(globalThis["case2"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case2"]?.["valueOf"]), ['length', 'name'], globalThis["case2"]?.["valueOf"]);
$verifyProperty(globalThis["case2"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case2"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case2"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["case3"]), ['toString', 'valueOf', Symbol.toPrimitive], globalThis["case3"]);
$verifyProperty(globalThis["case3"], "toString", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["case3"], Symbol.toPrimitive, {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case3"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case3"]?.["valueOf"]), true);
$assert.callable(globalThis["case3"]?.["valueOf"]);
$assert.notConstructable(globalThis["case3"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case3"]?.["valueOf"]), ['length', 'name'], globalThis["case3"]?.["valueOf"]);
$verifyProperty(globalThis["case3"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case3"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case3"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
