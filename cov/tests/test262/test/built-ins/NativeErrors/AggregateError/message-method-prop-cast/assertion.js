...
$assert.sameValue($Object_getPrototypeOf(globalThis["case1"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["case1"]), ['errors'], globalThis["case1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case1"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case1"]?.["errors"]), true);
$assert.notCallable(globalThis["case1"]?.["errors"]);
$assert.notConstructable(globalThis["case1"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case1"]?.["errors"]), ['length'], globalThis["case1"]?.["errors"]);
$verifyProperty(globalThis["case1"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["case1"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case2"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["case2"]), ['errors'], globalThis["case2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case2"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case2"]?.["errors"]), true);
$assert.notCallable(globalThis["case2"]?.["errors"]);
$assert.notConstructable(globalThis["case2"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case2"]?.["errors"]), ['length'], globalThis["case2"]?.["errors"]);
$verifyProperty(globalThis["case2"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["case2"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case3"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["case3"]), ['errors'], globalThis["case3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case3"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case3"]?.["errors"]), true);
$assert.notCallable(globalThis["case3"]?.["errors"]);
$assert.notConstructable(globalThis["case3"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case3"]?.["errors"]), ['length'], globalThis["case3"]?.["errors"]);
$verifyProperty(globalThis["case3"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["case3"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case4"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["case4"]), ['errors'], globalThis["case4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case4"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case4"]?.["errors"]), true);
$assert.notCallable(globalThis["case4"]?.["errors"]);
$assert.notConstructable(globalThis["case4"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case4"]?.["errors"]), ['length'], globalThis["case4"]?.["errors"]);
$verifyProperty(globalThis["case4"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["case4"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["case5"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["case5"]), ['errors'], globalThis["case5"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case5"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case5"]?.["errors"]), true);
$assert.notCallable(globalThis["case5"]?.["errors"]);
$assert.notConstructable(globalThis["case5"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case5"]?.["errors"]), ['length'], globalThis["case5"]?.["errors"]);
$verifyProperty(globalThis["case5"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["case5"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
