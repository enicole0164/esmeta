...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), AggregateError.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['message', 'errors'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["errors"]), true);
$assert.notCallable(globalThis["obj"]?.["errors"]);
$assert.notConstructable(globalThis["obj"]?.["errors"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["errors"]), ['length'], globalThis["obj"]?.["errors"]);
$verifyProperty(globalThis["obj"]?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"], "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "message", {
  value: "",
  writable: true,
  enumerable: false,
  configurable: true,
