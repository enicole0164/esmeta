...
$assert.sameValue($Object_getPrototypeOf(globalThis["x3"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x3"]), true);
$assert.notCallable(globalThis["x3"]);
$assert.notConstructable(globalThis["x3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x3"]), [], globalThis["x3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x4"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x4"]), true);
$assert.notCallable(globalThis["x4"]);
$assert.notConstructable(globalThis["x4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x4"]), [], globalThis["x4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x7"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x7"]), true);
$assert.notCallable(globalThis["x7"]);
$assert.notConstructable(globalThis["x7"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x7"]), [], globalThis["x7"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x8"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x8"]), true);
$assert.notCallable(globalThis["x8"]);
$assert.notConstructable(globalThis["x8"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x8"]), [], globalThis["x8"]);
