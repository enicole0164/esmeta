...
$assert.sameValue($Object_getPrototypeOf(globalThis["x1"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x1"]), true);
$assert.notCallable(globalThis["x1"]);
$assert.notConstructable(globalThis["x1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x1"]), [], globalThis["x1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x2"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x2"]), true);
$assert.notCallable(globalThis["x2"]);
$assert.notConstructable(globalThis["x2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x2"]), [], globalThis["x2"]);
