...
$assert.sameValue($Object_getPrototypeOf(globalThis["syncIterator"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["syncIterator"]), ['next', 'throw', Symbol.iterator], globalThis["syncIterator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["syncIterator"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["syncIterator"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["syncIterator"]?.[Symbol.iterator]);
$assert.notConstructable(globalThis["syncIterator"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["syncIterator"]?.[Symbol.iterator]), ['length', 'name'], globalThis["syncIterator"]?.[Symbol.iterator]);
$verifyProperty(globalThis["syncIterator"]?.[Symbol.iterator], "name", {
  value: "[Symbol.iterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"], Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get, "name", {
  value: "get throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "throw")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"], "throw", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["syncIterator"]?.["next"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["syncIterator"]?.["next"]), true);
$assert.callable(globalThis["syncIterator"]?.["next"]);
$assert.notConstructable(globalThis["syncIterator"]?.["next"]);
$assert.compareArray($Reflect_ownKeys(globalThis["syncIterator"]?.["next"]), ['length', 'name'], globalThis["syncIterator"]?.["next"]);
$verifyProperty(globalThis["syncIterator"]?.["next"], "name", {
  value: "next",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"]?.["next"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"], "next", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["throwGets"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["thrownError"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["thrownError"]), ['name'], globalThis["thrownError"]);
$verifyProperty(globalThis["thrownError"], "name", {
  value: "err",
  writable: true,
  enumerable: true,
  configurable: true,
