...
$assert.sameValue(globalThis["nextArgumentsLength"], 0.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["syncIterator"]), ['next', Symbol.iterator], globalThis["syncIterator"]);
