...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['variableForHelpVerify', 'foo1', 'foo2'], globalThis["obj"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.get, globalThis["get_func"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set, "name", {
  value: "set_func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["set_func"], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set);
