...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['variableForHelpVerify', 'foo'], globalThis["obj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.get, globalThis["getFunc"]);
...
$verifyProperty(globalThis["obj"], "variableForHelpVerify", {
  value: 10.0,
  writable: true,
  enumerable: true,
  configurable: false,
...
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
