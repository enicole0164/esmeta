...
$assert.compareArray($Reflect_ownKeys(globalThis["actual"]), ['0', '1', '2', '3', '4', '5', '6', 'length'], globalThis["actual"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]), ['0', '1', '2', '3', '4', '5', '6', 'length'], globalThis["expected"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['0', '1', '2', 'p2', 'add', 'p4', 'p1', 'extra'], globalThis["o"]);
$verifyProperty(globalThis["o"], "extra", {
  value: "extra",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["o"], "2", {
  value: "2",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "add")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "add", {
  set: undefined,
  enumerable: true,
  configurable: false,
});
$verifyProperty(globalThis["o"], "p2", {
  value: "p2",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["o"], "p1", {
  value: "p1",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["o"], "p4", {
  value: "p4",
  writable: true,
  enumerable: true,
  configurable: true,
