...
$assert.sameValue($Object_getPrototypeOf(globalThis["fakeObjectKeys"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fakeObjectKeys"]), true);
$assert.callable(globalThis["fakeObjectKeys"]);
$assert.constructable(globalThis["fakeObjectKeys"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fakeObjectKeys"]), ['length', 'name', 'prototype'], globalThis["fakeObjectKeys"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fakeObjectKeys"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fakeObjectKeys"]?.["prototype"]), true);
$assert.notCallable(globalThis["fakeObjectKeys"]?.["prototype"]);
$assert.notConstructable(globalThis["fakeObjectKeys"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fakeObjectKeys"]?.["prototype"]), ['constructor'], globalThis["fakeObjectKeys"]?.["prototype"]);
$assert.sameValue(globalThis["fakeObjectKeys"]?.["prototype"]?.["constructor"], globalThis["fakeObjectKeys"]);
$verifyProperty(globalThis["fakeObjectKeys"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fakeObjectKeys"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fakeObjectKeys"], "name", {
  value: "fakeObjectKeys",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fakeObjectKeys"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
