...
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["b"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["b"]), true);
$assert.notCallable(globalThis["f"]?.["b"]);
$assert.notConstructable(globalThis["f"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["b"]), [], globalThis["f"]?.["b"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["1"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["1"]), ['0', '1', 'length'], globalThis["result"]?.["1"]);
$assert.sameValue(globalThis["result"]?.["1"]?.["1"], globalThis["f"]?.["c"]);
$verifyProperty(globalThis["result"]?.["1"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["result"]?.["1"], "0", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["0"]), true);
$assert.notCallable(globalThis["result"]?.["0"]);
$assert.notConstructable(globalThis["result"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["0"]), ['0', '1', 'length'], globalThis["result"]?.["0"]);
$assert.sameValue(globalThis["result"]?.["0"]?.["1"], globalThis["f"]?.["b"]);
$verifyProperty(globalThis["result"]?.["0"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["0"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["result"]?.["0"], "0", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
