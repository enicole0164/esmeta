...
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]), ['length', 'name', 'a'], globalThis["fn"]);
...
$verifyProperty(globalThis["fn"], "a", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fnKeys"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnKeys"]), true);
$assert.notCallable(globalThis["fnKeys"]);
$assert.notConstructable(globalThis["fnKeys"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnKeys"]), ['0', '1', 'length'], globalThis["fnKeys"]);
$verifyProperty(globalThis["fnKeys"], "1", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["fnKeys"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fnKeys"], "0", {
  value: "name",
  writable: true,
  enumerable: true,
  configurable: true,
