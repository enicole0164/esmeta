...
$assert.sameValue($Object_getPrototypeOf(globalThis["bAddsC"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bAddsC"]), true);
$assert.notCallable(globalThis["bAddsC"]);
$assert.notConstructable(globalThis["bAddsC"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bAddsC"]), ['a', 'b', 'c'], globalThis["bAddsC"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get, "name", {
  value: "get b",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["bAddsC"], "b")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bAddsC"], "b", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bAddsC"], "a", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bAddsC"], "c", {
  value: "C",
  writable: true,
  enumerable: true,
  configurable: true,
