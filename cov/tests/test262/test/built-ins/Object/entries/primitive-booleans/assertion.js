...
$assert.sameValue($Object_getPrototypeOf(globalThis["falseResult"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["falseResult"]), true);
$assert.notCallable(globalThis["falseResult"]);
$assert.notConstructable(globalThis["falseResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["falseResult"]), ['length'], globalThis["falseResult"]);
$verifyProperty(globalThis["falseResult"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["trueResult"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["trueResult"]), true);
$assert.notCallable(globalThis["trueResult"]);
$assert.notConstructable(globalThis["trueResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["trueResult"]), ['length'], globalThis["trueResult"]);
$verifyProperty(globalThis["trueResult"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
