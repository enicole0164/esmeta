...
$assert.sameValue($Object_getPrototypeOf(globalThis["bDeletesC"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bDeletesC"]), true);
$assert.notCallable(globalThis["bDeletesC"]);
$assert.notConstructable(globalThis["bDeletesC"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bDeletesC"]), ['a', 'b', 'c'], globalThis["bDeletesC"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get, "name", {
  value: "get b",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["bDeletesC"], "b")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bDeletesC"], "b", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bDeletesC"], "a", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bDeletesC"], "c", {
  value: "C",
  writable: true,
  enumerable: false,
  configurable: true,
