...
$assert.compareArray($Reflect_ownKeys(globalThis["arg"]), ['length', 'callee', 'prop', Symbol.iterator], globalThis["arg"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["arg"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arg"]?.["prop"]), true);
$assert.notCallable(globalThis["arg"]?.["prop"]);
$assert.notConstructable(globalThis["arg"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arg"]?.["prop"]), ['set'], globalThis["arg"]?.["prop"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arg"]?.["prop"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arg"]?.["prop"]?.["set"]), true);
$assert.callable(globalThis["arg"]?.["prop"]?.["set"]);
$assert.constructable(globalThis["arg"]?.["prop"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arg"]?.["prop"]?.["set"]), ['length', 'name', 'prototype'], globalThis["arg"]?.["prop"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]), ['constructor'], globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"]?.["constructor"], globalThis["arg"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["arg"]?.["prop"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arg"]?.["prop"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arg"]?.["prop"]?.["set"], "name", {
  value: "setFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arg"]?.["prop"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arg"]?.["prop"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arg"], "prop", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["data"], "argData");
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["arg"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["obj"], "prop", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["setFun"], globalThis["arg"]?.["prop"]?.["set"]);
