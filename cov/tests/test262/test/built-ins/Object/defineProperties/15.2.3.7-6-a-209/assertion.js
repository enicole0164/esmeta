...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['length', 'setVerifyHelpProp'], globalThis["arr"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["descObj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["set"]), true);
$assert.callable(globalThis["descObj"]?.["set"]);
$assert.constructable(globalThis["descObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["descObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["descObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["descObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["descObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["descObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["descObj"]?.["set"]);
$verifyProperty(globalThis["descObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descObj"]?.["set"], "name", {
  value: "set_func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["get_func"], globalThis["descObj"]?.["get"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]), ['0'], globalThis["properties"]);
$assert.sameValue(globalThis["properties"]?.["0"], globalThis["descObj"]);
$verifyProperty(globalThis["properties"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["set_func"], globalThis["descObj"]?.["set"]);
