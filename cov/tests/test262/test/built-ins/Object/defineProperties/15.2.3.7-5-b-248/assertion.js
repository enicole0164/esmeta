...
$assert.sameValue(globalThis["data"], "errorData");
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]), Error.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['message', 'description', 'name', 'prop'], globalThis["descObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["prop"]), true);
$assert.notCallable(globalThis["descObj"]?.["prop"]);
$assert.notConstructable(globalThis["descObj"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["prop"]), ['set'], globalThis["descObj"]?.["prop"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["prop"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["prop"]?.["set"]), true);
$assert.callable(globalThis["descObj"]?.["prop"]?.["set"]);
$assert.constructable(globalThis["descObj"]?.["prop"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["prop"]?.["set"]), ['length', 'name', 'prototype'], globalThis["descObj"]?.["prop"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]), ['constructor'], globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"]?.["constructor"], globalThis["descObj"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["descObj"]?.["prop"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["prop"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descObj"]?.["prop"]?.["set"], "name", {
  value: "setFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["prop"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["prop"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descObj"], "prop", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["name"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["name"]), true);
$assert.notCallable(globalThis["descObj"]?.["name"]);
$assert.notConstructable(globalThis["descObj"]?.["name"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["name"]), ['value'], globalThis["descObj"]?.["name"]);
$verifyProperty(globalThis["descObj"]?.["name"], "value", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descObj"], "name", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["message"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["message"]), true);
$assert.notCallable(globalThis["descObj"]?.["message"]);
$assert.notConstructable(globalThis["descObj"]?.["message"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["message"]), ['value'], globalThis["descObj"]?.["message"]);
$verifyProperty(globalThis["descObj"]?.["message"], "value", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descObj"], "message", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["description"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["description"]), true);
$assert.notCallable(globalThis["descObj"]?.["description"]);
$assert.notConstructable(globalThis["descObj"]?.["description"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["description"]), ['value'], globalThis["descObj"]?.["description"]);
$verifyProperty(globalThis["descObj"]?.["description"], "value", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descObj"], "description", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['description', 'name', 'prop'], globalThis["obj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["descObj"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["obj"], "prop", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"], "name", {
  value: 11.0,
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"], "description", {
  value: 11.0,
  writable: false,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["setFun"], globalThis["descObj"]?.["prop"]?.["set"]);
