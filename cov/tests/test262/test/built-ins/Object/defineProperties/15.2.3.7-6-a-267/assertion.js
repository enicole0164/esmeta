...
$assert.sameValue($Object_getPrototypeOf(globalThis["get_fun"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get_fun"]), true);
$assert.callable(globalThis["get_fun"]);
$assert.constructable(globalThis["get_fun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get_fun"]), ['length', 'name', 'prototype'], globalThis["get_fun"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["get_fun"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get_fun"]?.["prototype"]), true);
$assert.notCallable(globalThis["get_fun"]?.["prototype"]);
$assert.notConstructable(globalThis["get_fun"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get_fun"]?.["prototype"]), ['constructor'], globalThis["get_fun"]?.["prototype"]);
$assert.sameValue(globalThis["get_fun"]?.["prototype"]?.["constructor"], globalThis["get_fun"]);
$verifyProperty(globalThis["get_fun"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get_fun"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["get_fun"], "name", {
  value: "get_fun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get_fun"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["set_fun"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_fun"]), true);
$assert.callable(globalThis["set_fun"]);
$assert.constructable(globalThis["set_fun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_fun"]), ['length', 'name', 'prototype'], globalThis["set_fun"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["set_fun"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_fun"]?.["prototype"]), true);
$assert.notCallable(globalThis["set_fun"]?.["prototype"]);
$assert.notConstructable(globalThis["set_fun"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_fun"]?.["prototype"]), ['constructor'], globalThis["set_fun"]?.["prototype"]);
$assert.sameValue(globalThis["set_fun"]?.["prototype"]?.["constructor"], globalThis["set_fun"]);
$verifyProperty(globalThis["set_fun"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_fun"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["set_fun"], "name", {
  value: "set_fun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_fun"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
