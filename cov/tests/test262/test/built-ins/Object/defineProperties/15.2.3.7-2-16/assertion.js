...
$assert.compareArray($Reflect_ownKeys(globalThis["props"]), ['length', 'callee', 'prop', Symbol.iterator], globalThis["props"]);
$assert.sameValue(globalThis["props"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["props"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["props"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["props"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["props"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["props"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: true,
