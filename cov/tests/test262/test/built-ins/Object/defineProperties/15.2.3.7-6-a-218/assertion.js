...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["0"]), ['length'], globalThis["arr"]?.["0"]);
...
$assert.sameValue(globalThis["obj1"], globalThis["arr"]?.["0"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["properties"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["properties"]?.["0"]), true);
$assert.notCallable(globalThis["properties"]?.["0"]);
$assert.notConstructable(globalThis["properties"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]?.["0"]), ['value'], globalThis["properties"]?.["0"]);
$assert.sameValue(globalThis["properties"]?.["0"]?.["value"], globalThis["arr"]?.["0"]);
$verifyProperty(globalThis["properties"]?.["0"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
