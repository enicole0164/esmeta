...
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["prop"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["prop"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["prop"]), ['value'], globalThis["Con"]?.["prototype"]?.["prop"]);
$verifyProperty(globalThis["Con"]?.["prototype"]?.["prop"], "value", {
  value: 9.0,
  writable: true,
  enumerable: true,
  configurable: true,
