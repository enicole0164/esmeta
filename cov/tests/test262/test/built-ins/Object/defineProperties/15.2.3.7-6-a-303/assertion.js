...
$assert.compareArray($Reflect_ownKeys(globalThis["arg"]), ['0', '1', '2', 'length', 'callee', 'testGetFunction', Symbol.iterator], globalThis["arg"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["setFun"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setFun"]), true);
$assert.callable(globalThis["setFun"]);
$assert.constructable(globalThis["setFun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setFun"]), ['length', 'name', 'prototype'], globalThis["setFun"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["setFun"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setFun"]?.["prototype"]), true);
$assert.notCallable(globalThis["setFun"]?.["prototype"]);
$assert.notConstructable(globalThis["setFun"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setFun"]?.["prototype"]), ['constructor'], globalThis["setFun"]?.["prototype"]);
$assert.sameValue(globalThis["setFun"]?.["prototype"]?.["constructor"], globalThis["setFun"]);
$verifyProperty(globalThis["setFun"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setFun"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setFun"], "name", {
  value: "setFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setFun"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
