...
$assert.sameValue($Object_getPrototypeOf(globalThis["getFun"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getFun"]), true);
$assert.callable(globalThis["getFun"]);
$assert.constructable(globalThis["getFun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getFun"]), ['length', 'name', 'prototype'], globalThis["getFun"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getFun"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getFun"]?.["prototype"]), true);
$assert.notCallable(globalThis["getFun"]?.["prototype"]);
$assert.notConstructable(globalThis["getFun"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getFun"]?.["prototype"]), ['constructor'], globalThis["getFun"]?.["prototype"]);
$assert.sameValue(globalThis["getFun"]?.["prototype"]?.["constructor"], globalThis["getFun"]);
$verifyProperty(globalThis["getFun"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getFun"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getFun"], "name", {
  value: "getFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getFun"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['prop', 'setVerifyHelpProp'], globalThis["obj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.get, globalThis["getFun"]);
