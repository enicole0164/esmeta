...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['setVerifyHelpProp'], globalThis["obj"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]), ['foo1', 'foo2'], globalThis["properties"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["properties"]?.["foo1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["properties"]?.["foo1"]), true);
$assert.notCallable(globalThis["properties"]?.["foo1"]);
$assert.notConstructable(globalThis["properties"]?.["foo1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]?.["foo1"]), ['value', 'enumerable', 'writable', 'configurable'], globalThis["properties"]?.["foo1"]);
$verifyProperty(globalThis["properties"]?.["foo1"], "value", {
  value: 200.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo1"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo1"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo1"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"], "foo1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["properties"]?.["foo2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["properties"]?.["foo2"]), true);
$assert.notCallable(globalThis["properties"]?.["foo2"]);
$assert.notConstructable(globalThis["properties"]?.["foo2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]?.["foo2"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["properties"]?.["foo2"]);
$assert.sameValue(globalThis["properties"]?.["foo2"]?.["get"], globalThis["get_func"]);
$verifyProperty(globalThis["properties"]?.["foo2"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo2"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo2"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["properties"]?.["foo2"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["properties"]?.["foo2"]?.["set"]), true);
$assert.callable(globalThis["properties"]?.["foo2"]?.["set"]);
$assert.constructable(globalThis["properties"]?.["foo2"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]?.["foo2"]?.["set"]), ['length', 'name', 'prototype'], globalThis["properties"]?.["foo2"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]), ['constructor'], globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"]?.["constructor"], globalThis["properties"]?.["foo2"]?.["set"]);
$verifyProperty(globalThis["properties"]?.["foo2"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo2"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["properties"]?.["foo2"]?.["set"], "name", {
  value: "set_func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo2"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["properties"]?.["foo2"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["properties"], "foo2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["set_func"], globalThis["properties"]?.["foo2"]?.["set"]);
