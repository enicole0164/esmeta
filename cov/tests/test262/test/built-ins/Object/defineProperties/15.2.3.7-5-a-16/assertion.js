...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['name', 'description', 'prop'], globalThis["obj"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["props"]), ['message', 'name', 'description', 'prop'], globalThis["props"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["props"]?.["prop"]), ['value'], globalThis["props"]?.["prop"]);
