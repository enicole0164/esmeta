...
$assert.constructable(globalThis["getter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getter"]), ['length', 'name', 'prototype'], globalThis["getter"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getter"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getter"]?.["prototype"]), true);
$assert.notCallable(globalThis["getter"]?.["prototype"]);
$assert.notConstructable(globalThis["getter"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getter"]?.["prototype"]), ['constructor'], globalThis["getter"]?.["prototype"]);
$assert.sameValue(globalThis["getter"]?.["prototype"]?.["constructor"], globalThis["getter"]);
$verifyProperty(globalThis["getter"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getter"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getter"], "name", {
  value: "getter",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["getter"]);
