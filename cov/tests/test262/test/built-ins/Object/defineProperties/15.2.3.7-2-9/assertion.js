...
$assert.sameValue($Object_getPrototypeOf(globalThis["props"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["props"]), true);
$assert.callable(globalThis["props"]);
$assert.constructable(globalThis["props"]);
$assert.compareArray($Reflect_ownKeys(globalThis["props"]), ['length', 'name', 'prototype', 'prop'], globalThis["props"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["props"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["props"]?.["prototype"]), true);
$assert.notCallable(globalThis["props"]?.["prototype"]);
$assert.notConstructable(globalThis["props"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["props"]?.["prototype"]), ['constructor'], globalThis["props"]?.["prototype"]);
$assert.sameValue(globalThis["props"]?.["prototype"]?.["constructor"], globalThis["props"]);
$verifyProperty(globalThis["props"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["props"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
