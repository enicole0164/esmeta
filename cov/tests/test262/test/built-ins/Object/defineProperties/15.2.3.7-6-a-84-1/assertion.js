...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["foo"]), ['length', 'y'], globalThis["obj"]?.["foo"]);
$verifyProperty(globalThis["obj"]?.["foo"], "y", {
  value: "hello",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["obj2"], globalThis["obj"]?.["foo"]);
