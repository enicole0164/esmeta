...
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['configurable'], globalThis["Con"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "configurable")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"], "configurable", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
