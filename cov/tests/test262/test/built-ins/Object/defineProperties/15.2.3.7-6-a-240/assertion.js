...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["1"]), ['value'], globalThis["arr"]?.["1"]);
$verifyProperty(globalThis["arr"]?.["1"], "value", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["obj1"], globalThis["arr"]?.["1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['value'], globalThis["obj2"]);
$verifyProperty(globalThis["obj2"], "value", {
  value: 36.0,
  writable: true,
  enumerable: true,
  configurable: true,
