...
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["value"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["value"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["value"]), ['valueOf'], globalThis["Con"]?.["prototype"]?.["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]), true);
$assert.callable(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]);
$assert.constructable(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]);
$verifyProperty(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["value"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["value"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["value"]), true);
$assert.notCallable(globalThis["child"]?.["value"]);
$assert.notConstructable(globalThis["child"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["value"]), ['toString'], globalThis["child"]?.["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["value"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["value"]?.["toString"]), true);
$assert.callable(globalThis["child"]?.["value"]?.["toString"]);
$assert.constructable(globalThis["child"]?.["value"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["value"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["child"]?.["value"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["value"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["value"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["child"]?.["value"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["child"]?.["value"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["value"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["child"]?.["value"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["child"]?.["value"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["child"]?.["value"]?.["toString"]);
$verifyProperty(globalThis["child"]?.["value"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["value"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["child"]?.["value"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["value"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["value"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["valueOfAccessed"], false);
