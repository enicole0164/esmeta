...
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['writable'], globalThis["Con"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "writable")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"], "writable", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
