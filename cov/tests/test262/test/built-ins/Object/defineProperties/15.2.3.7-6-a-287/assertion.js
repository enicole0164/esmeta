...
$assert.sameValue($Object_getPrototypeOf(globalThis["set_func"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_func"]), true);
$assert.callable(globalThis["set_func"]);
$assert.constructable(globalThis["set_func"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_func"]), ['length', 'name', 'prototype'], globalThis["set_func"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["set_func"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_func"]?.["prototype"]), true);
$assert.notCallable(globalThis["set_func"]?.["prototype"]);
$assert.notConstructable(globalThis["set_func"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_func"]?.["prototype"]), ['constructor'], globalThis["set_func"]?.["prototype"]);
$assert.sameValue(globalThis["set_func"]?.["prototype"]?.["constructor"], globalThis["set_func"]);
$verifyProperty(globalThis["set_func"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_func"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["set_func"], "name", {
  value: "set_func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_func"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
