...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["value"]), ['length'], globalThis["desc"]?.["value"]);
...
$assert.sameValue(globalThis["obj"]?.["foo"], globalThis["desc"]?.["value"]);
$verifyProperty(globalThis["obj"], "foo", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["obj1"], globalThis["desc"]?.["value"]);
