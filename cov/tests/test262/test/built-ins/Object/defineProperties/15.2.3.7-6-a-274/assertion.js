...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['length', 'property', 'verifySetFun'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get, "name", {
  value: "get_fun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set, "name", {
  value: "set_fun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"], "property", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arr"], "verifySetFun", {
  value: 37.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["get_fun"], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.get);
...
$assert.sameValue(globalThis["set_fun"], Object.getOwnPropertyDescriptor(globalThis["arr"], "property")?.set);
