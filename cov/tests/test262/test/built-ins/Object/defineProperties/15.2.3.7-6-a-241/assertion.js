...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['1', 'length', 'setVerifyHelpProp'], globalThis["arr"]);
...
$assert.sameValue(globalThis["set_fun"], Object.getOwnPropertyDescriptor(globalThis["arr"], "1")?.set);
