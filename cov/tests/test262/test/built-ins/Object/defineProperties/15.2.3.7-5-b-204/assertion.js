...
$assert.compareArray($Reflect_ownKeys(globalThis["func"]), ['length', 'name', 'prototype', 'get'], globalThis["func"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["func"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func"]?.["get"]), true);
$assert.callable(globalThis["func"]?.["get"]);
$assert.constructable(globalThis["func"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func"]?.["get"]), ['length', 'name', 'prototype'], globalThis["func"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["func"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["func"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["func"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func"]?.["get"]?.["prototype"]), ['constructor'], globalThis["func"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["func"]?.["get"]?.["prototype"]?.["constructor"], globalThis["func"]?.["get"]);
$verifyProperty(globalThis["func"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["func"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["func"]?.["get"]);
