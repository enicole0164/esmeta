...
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["set"]), true);
$assert.callable(globalThis["Con"]?.["prototype"]?.["set"]);
$assert.constructable(globalThis["Con"]?.["prototype"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["set"]), ['length', 'name', 'prototype'], globalThis["Con"]?.["prototype"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]), ['constructor'], globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"]?.["constructor"], globalThis["Con"]?.["prototype"]?.["set"]);
$verifyProperty(globalThis["Con"]?.["prototype"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
