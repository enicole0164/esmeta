...
$assert.sameValue(globalThis["get_Func2"], globalThis["desc"]?.["get"]);
...
$assert.sameValue(globalThis["verifyEnumerable"], false);
$assert.sameValue(globalThis["verifyValue"], true);
