...
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["get"]), true);
$assert.callable(globalThis["Con"]?.["prototype"]?.["get"]);
$assert.constructable(globalThis["Con"]?.["prototype"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["get"]), ['length', 'name', 'prototype'], globalThis["Con"]?.["prototype"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]), ['constructor'], globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"]?.["constructor"], globalThis["Con"]?.["prototype"]?.["get"]);
$verifyProperty(globalThis["Con"]?.["prototype"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["get"], "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
