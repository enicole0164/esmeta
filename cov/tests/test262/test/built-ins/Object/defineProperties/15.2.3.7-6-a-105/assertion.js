...
$assert.sameValue(globalThis["p"], "property");
...
$assert.sameValue(globalThis["verifyConfigurable"], false);
$assert.sameValue(globalThis["verifyEnumerable"], true);
$assert.sameValue(globalThis["verifyGet"], true);
$assert.sameValue(globalThis["verifySet"], true);
