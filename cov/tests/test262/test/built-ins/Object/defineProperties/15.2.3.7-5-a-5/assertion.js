...
$assert.compareArray($Reflect_ownKeys(globalThis["props"]), ['prop'], globalThis["props"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["props"], "prop")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["props"], "prop", {
  set: undefined,
  enumerable: true,
  configurable: false,
});
