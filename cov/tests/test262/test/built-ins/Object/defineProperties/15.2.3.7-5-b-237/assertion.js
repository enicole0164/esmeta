...
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['set'], globalThis["Con"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "set")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"], "set", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]), true);
$assert.notCallable(globalThis["desc"]);
$assert.notConstructable(globalThis["desc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["desc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["get"]), true);
$assert.callable(globalThis["desc"]?.["get"]);
$assert.constructable(globalThis["desc"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["get"]), ['length', 'name', 'prototype'], globalThis["desc"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["desc"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["get"]?.["prototype"]), ['constructor'], globalThis["desc"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["desc"]?.["get"]?.["prototype"]?.["constructor"], globalThis["desc"]?.["get"]);
$verifyProperty(globalThis["desc"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc"]?.["get"], "name", {
  value: "fun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['set', 'get'], globalThis["descObj"]);
$assert.sameValue(globalThis["descObj"]?.["get"], globalThis["desc"]?.["get"]);
$verifyProperty(globalThis["descObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"], "set", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["fun"], globalThis["desc"]?.["get"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['prop'], globalThis["obj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.get, globalThis["desc"]?.["get"]);
$verifyProperty(globalThis["obj"], "prop", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
