...
$assert.sameValue(globalThis["set_func1"], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
$assert.sameValue($Object_getPrototypeOf(globalThis["set_func2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_func2"]), true);
$assert.callable(globalThis["set_func2"]);
$assert.constructable(globalThis["set_func2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_func2"]), ['length', 'name', 'prototype'], globalThis["set_func2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["set_func2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_func2"]?.["prototype"]), true);
$assert.notCallable(globalThis["set_func2"]?.["prototype"]);
$assert.notConstructable(globalThis["set_func2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_func2"]?.["prototype"]), ['constructor'], globalThis["set_func2"]?.["prototype"]);
$assert.sameValue(globalThis["set_func2"]?.["prototype"]?.["constructor"], globalThis["set_func2"]);
$verifyProperty(globalThis["set_func2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_func2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["set_func2"], "name", {
  value: "set_func2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_func2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
