...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['length', 'get'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["get"]), true);
$assert.callable(globalThis["arr"]?.["get"]);
$assert.constructable(globalThis["arr"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["get"]), ['length', 'name', 'prototype'], globalThis["arr"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["arr"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["arr"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["get"]?.["prototype"]), ['constructor'], globalThis["arr"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["arr"]?.["get"]?.["prototype"]?.["constructor"], globalThis["arr"]?.["get"]);
$verifyProperty(globalThis["arr"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arr"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["arr"]?.["get"]);
