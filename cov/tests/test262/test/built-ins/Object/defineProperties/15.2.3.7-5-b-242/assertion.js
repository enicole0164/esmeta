...
$assert.sameValue(globalThis["data"], "booleanData");
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]), Boolean.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['prop'], globalThis["descObj"]);
