...
$assert.sameValue(globalThis["data"], "funData");
$assert.sameValue($Object_getPrototypeOf(globalThis["descFun"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descFun"]), true);
$assert.callable(globalThis["descFun"]);
$assert.constructable(globalThis["descFun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descFun"]), ['length', 'name', 'prototype', 'prop'], globalThis["descFun"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descFun"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descFun"]?.["prop"]), true);
$assert.notCallable(globalThis["descFun"]?.["prop"]);
$assert.notConstructable(globalThis["descFun"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descFun"]?.["prop"]), ['set'], globalThis["descFun"]?.["prop"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descFun"]?.["prop"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descFun"]?.["prop"]?.["set"]), true);
$assert.callable(globalThis["descFun"]?.["prop"]?.["set"]);
$assert.constructable(globalThis["descFun"]?.["prop"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descFun"]?.["prop"]?.["set"]), ['length', 'name', 'prototype'], globalThis["descFun"]?.["prop"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]), ['constructor'], globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"]?.["constructor"], globalThis["descFun"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["descFun"]?.["prop"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descFun"]?.["prop"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descFun"]?.["prop"]?.["set"], "name", {
  value: "setFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descFun"]?.["prop"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descFun"]?.["prop"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descFun"], "prop", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["descFun"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descFun"]?.["prototype"]), true);
$assert.notCallable(globalThis["descFun"]?.["prototype"]);
$assert.notConstructable(globalThis["descFun"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descFun"]?.["prototype"]), ['constructor'], globalThis["descFun"]?.["prototype"]);
$assert.sameValue(globalThis["descFun"]?.["prototype"]?.["constructor"], globalThis["descFun"]);
$verifyProperty(globalThis["descFun"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descFun"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descFun"], "name", {
  value: "descFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descFun"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["descFun"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["obj"], "prop", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["setFun"], globalThis["descFun"]?.["prop"]?.["set"]);
