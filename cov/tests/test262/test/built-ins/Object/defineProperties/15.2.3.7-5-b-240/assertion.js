...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['length', 'prop'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["prop"]), true);
$assert.notCallable(globalThis["arr"]?.["prop"]);
$assert.notConstructable(globalThis["arr"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["prop"]), ['set'], globalThis["arr"]?.["prop"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["prop"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["prop"]?.["set"]), true);
$assert.callable(globalThis["arr"]?.["prop"]?.["set"]);
$assert.constructable(globalThis["arr"]?.["prop"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["prop"]?.["set"]), ['length', 'name', 'prototype'], globalThis["arr"]?.["prop"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]), ['constructor'], globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"]?.["constructor"], globalThis["arr"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["arr"]?.["prop"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["prop"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arr"]?.["prop"]?.["set"], "name", {
  value: "setFun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["prop"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["prop"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arr"], "prop", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["data"], "arrData");
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["arr"]?.["prop"]?.["set"]);
$verifyProperty(globalThis["obj"], "prop", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["setFun"], globalThis["arr"]?.["prop"]?.["set"]);
