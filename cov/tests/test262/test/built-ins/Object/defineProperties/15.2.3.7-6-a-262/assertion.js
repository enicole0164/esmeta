...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', 'length', 'setVerifyHelpProp'], globalThis["arr"]);
$verifyProperty(globalThis["arr"], "setVerifyHelpProp", {
  value: 36.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set, "name", {
  value: "set_fun",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["get_fun"], Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.get);
...
$assert.sameValue(globalThis["set_fun"], Object.getOwnPropertyDescriptor(globalThis["arr"], "0")?.set);
