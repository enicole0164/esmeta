...
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]), ['value'], globalThis["obj1"]);
$verifyProperty(globalThis["obj1"], "value", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["props"]), ['message', 'description', 'name', 'prop'], globalThis["props"]);
...
$assert.sameValue(globalThis["props"]?.["name"], globalThis["obj1"]);
$verifyProperty(globalThis["props"], "name", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["props"]?.["message"], globalThis["obj1"]);
$verifyProperty(globalThis["props"], "message", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["props"]?.["description"], globalThis["obj1"]);
$verifyProperty(globalThis["props"], "description", {
  writable: true,
  enumerable: true,
  configurable: true,
});
