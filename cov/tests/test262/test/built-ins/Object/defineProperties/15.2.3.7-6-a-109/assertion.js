...
$assert.sameValue($Object_getPrototypeOf(globalThis["get_func1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get_func1"]), true);
$assert.callable(globalThis["get_func1"]);
$assert.constructable(globalThis["get_func1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get_func1"]), ['length', 'name', 'prototype'], globalThis["get_func1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["get_func1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get_func1"]?.["prototype"]), true);
$assert.notCallable(globalThis["get_func1"]?.["prototype"]);
$assert.notConstructable(globalThis["get_func1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get_func1"]?.["prototype"]), ['constructor'], globalThis["get_func1"]?.["prototype"]);
$assert.sameValue(globalThis["get_func1"]?.["prototype"]?.["constructor"], globalThis["get_func1"]);
$verifyProperty(globalThis["get_func1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get_func1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["get_func1"], "name", {
  value: "get_func1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get_func1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["get_func2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get_func2"]), true);
$assert.callable(globalThis["get_func2"]);
$assert.constructable(globalThis["get_func2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get_func2"]), ['length', 'name', 'prototype'], globalThis["get_func2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["get_func2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get_func2"]?.["prototype"]), true);
$assert.notCallable(globalThis["get_func2"]?.["prototype"]);
$assert.notConstructable(globalThis["get_func2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get_func2"]?.["prototype"]), ['constructor'], globalThis["get_func2"]?.["prototype"]);
$assert.sameValue(globalThis["get_func2"]?.["prototype"]?.["constructor"], globalThis["get_func2"]);
$verifyProperty(globalThis["get_func2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get_func2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["get_func2"], "name", {
  value: "get_func2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get_func2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['foo', 'setVerifyHelpProp'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "setVerifyHelpProp", {
  value: 20.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.get, globalThis["get_func2"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set, "name", {
  value: "set_func2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "foo", {
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["set_func1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_func1"]), true);
$assert.callable(globalThis["set_func1"]);
$assert.constructable(globalThis["set_func1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_func1"]), ['length', 'name', 'prototype'], globalThis["set_func1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["set_func1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["set_func1"]?.["prototype"]), true);
$assert.notCallable(globalThis["set_func1"]?.["prototype"]);
$assert.notConstructable(globalThis["set_func1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set_func1"]?.["prototype"]), ['constructor'], globalThis["set_func1"]?.["prototype"]);
$assert.sameValue(globalThis["set_func1"]?.["prototype"]?.["constructor"], globalThis["set_func1"]);
$verifyProperty(globalThis["set_func1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_func1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["set_func1"], "name", {
  value: "set_func1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["set_func1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["set_func2"], Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set);
