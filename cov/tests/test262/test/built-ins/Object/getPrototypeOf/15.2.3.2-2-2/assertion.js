...
$assert.sameValue($Object_getPrototypeOf(globalThis["base"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["base"]?.["prototype"]), true);
$assert.notCallable(globalThis["base"]?.["prototype"]);
$assert.notConstructable(globalThis["base"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["base"]?.["prototype"]), ['constructor'], globalThis["base"]?.["prototype"]);
$assert.sameValue(globalThis["base"]?.["prototype"]?.["constructor"], globalThis["base"]);
$verifyProperty(globalThis["base"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["d"])), globalThis["base"]?.["prototype"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["d"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["d"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["d"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["d"])), [], $Object_getPrototypeOf(globalThis["d"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["d"]), [], globalThis["d"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["derived"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["derived"]), true);
$assert.callable(globalThis["derived"]);
$assert.constructable(globalThis["derived"]);
$assert.compareArray($Reflect_ownKeys(globalThis["derived"]), ['length', 'name', 'prototype'], globalThis["derived"]);
$assert.sameValue(globalThis["derived"]?.["prototype"], $Object_getPrototypeOf(globalThis["d"]));
$verifyProperty(globalThis["derived"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["derived"], "name", {
  value: "derived",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["derived"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["x"], $Object_getPrototypeOf(globalThis["d"]));
