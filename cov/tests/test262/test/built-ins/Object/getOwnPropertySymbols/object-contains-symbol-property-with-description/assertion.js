...
$assert.sameValue($Object_getPrototypeOf(globalThis["syms"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["syms"]), true);
$assert.notCallable(globalThis["syms"]);
$assert.notConstructable(globalThis["syms"]);
$assert.compareArray($Reflect_ownKeys(globalThis["syms"]), ['0', 'length'], globalThis["syms"]);
$verifyProperty(globalThis["syms"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["syms"]?.["0"], globalThis["sym"]);
$verifyProperty(globalThis["syms"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
