...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['set', 'enumerable', 'configurable'], globalThis["desc"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["fun"]);
$verifyProperty(globalThis["obj"], "property", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["propDefined"], true);
$assert.sameValue(globalThis["propDeleted"], false);
