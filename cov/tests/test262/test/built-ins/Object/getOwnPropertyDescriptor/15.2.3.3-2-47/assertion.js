...
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['toString'], globalThis["Con"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["toString"]), true);
$assert.callable(globalThis["Con"]?.["prototype"]?.["toString"]);
$assert.constructable(globalThis["Con"]?.["prototype"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["Con"]?.["prototype"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["Con"]?.["prototype"]?.["toString"]);
$verifyProperty(globalThis["Con"]?.["prototype"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["toString"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["child"]), ['valueOf'], globalThis["child"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["valueOf"]), true);
$assert.callable(globalThis["child"]?.["valueOf"]);
$assert.constructable(globalThis["child"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["child"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["child"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["child"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["child"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["child"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["child"]?.["valueOf"]);
$verifyProperty(globalThis["child"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["child"]?.["valueOf"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["desc"]);
$verifyProperty(globalThis["desc"], "value", {
  value: "length2",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['10', 'test'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "test", {
  value: "length2",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "10", {
  value: "length1",
  writable: true,
  enumerable: true,
  configurable: true,
