...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['abc'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "abc", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["ownProp"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ownProp"]), true);
$assert.notCallable(globalThis["ownProp"]);
$assert.notConstructable(globalThis["ownProp"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ownProp"]), ['toString', 'valueOf'], globalThis["ownProp"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ownProp"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ownProp"]?.["toString"]), true);
$assert.callable(globalThis["ownProp"]?.["toString"]);
$assert.constructable(globalThis["ownProp"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ownProp"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["ownProp"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ownProp"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ownProp"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["ownProp"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["ownProp"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ownProp"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["ownProp"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["ownProp"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["ownProp"]?.["toString"]);
$verifyProperty(globalThis["ownProp"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ownProp"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ownProp"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ownProp"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ownProp"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["ownProp"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ownProp"]?.["valueOf"]), true);
$assert.callable(globalThis["ownProp"]?.["valueOf"]);
$assert.constructable(globalThis["ownProp"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ownProp"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["ownProp"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ownProp"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ownProp"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["ownProp"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["ownProp"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ownProp"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["ownProp"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["ownProp"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["ownProp"]?.["valueOf"]);
$verifyProperty(globalThis["ownProp"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ownProp"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ownProp"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ownProp"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ownProp"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
