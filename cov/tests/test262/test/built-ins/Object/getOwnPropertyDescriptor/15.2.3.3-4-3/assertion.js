...
$assert.compareArray($Reflect_ownKeys(globalThis["d"]), ['get'], globalThis["d"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d"]?.["get"]), true);
$assert.callable(globalThis["d"]?.["get"]);
$assert.constructable(globalThis["d"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d"]?.["get"]), ['length', 'name', 'prototype'], globalThis["d"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["d"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["d"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d"]?.["get"]?.["prototype"]), ['constructor'], globalThis["d"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["d"]?.["get"]?.["prototype"]?.["constructor"], globalThis["d"]?.["get"]);
$verifyProperty(globalThis["d"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["d"]?.["get"], "name", {
  value: "getter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["desc"]?.["get"], globalThis["d"]?.["get"]);
...
$assert.sameValue(globalThis["getter"], globalThis["d"]?.["get"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "foo")?.get, globalThis["d"]?.["get"]);
