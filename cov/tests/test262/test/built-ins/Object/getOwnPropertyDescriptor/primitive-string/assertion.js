...
$assert.sameValue($Object_getPrototypeOf(globalThis["indexDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["indexDesc"]), true);
$assert.notCallable(globalThis["indexDesc"]);
$assert.notConstructable(globalThis["indexDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["indexDesc"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["indexDesc"]);
$verifyProperty(globalThis["indexDesc"], "value", {
  value: "f",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["indexDesc"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["indexDesc"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["indexDesc"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["lengthDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["lengthDesc"]), true);
$assert.notCallable(globalThis["lengthDesc"]);
$assert.notConstructable(globalThis["lengthDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["lengthDesc"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["lengthDesc"]);
$verifyProperty(globalThis["lengthDesc"], "value", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["lengthDesc"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["lengthDesc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["lengthDesc"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
