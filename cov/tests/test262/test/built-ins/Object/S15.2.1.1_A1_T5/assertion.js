...
$assert.sameValue($Object_getPrototypeOf(globalThis["n__obj"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["n__obj"]), true);
$assert.notCallable(globalThis["n__obj"]);
$assert.notConstructable(globalThis["n__obj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["n__obj"]), [], globalThis["n__obj"]);
