...
$assert.sameValue($Object_getPrototypeOf(globalThis["entries"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["entries"]), true);
$assert.notCallable(globalThis["entries"]);
$assert.notConstructable(globalThis["entries"]);
$assert.compareArray($Reflect_ownKeys(globalThis["entries"]), ['0', '1', '2', '3', 'length'], globalThis["entries"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["entries"]?.["2"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["entries"]?.["2"]), true);
$assert.notCallable(globalThis["entries"]?.["2"]);
$assert.notConstructable(globalThis["entries"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["entries"]?.["2"]), ['0', '1', 'length'], globalThis["entries"]?.["2"]);
$verifyProperty(globalThis["entries"]?.["2"], "1", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"]?.["2"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["entries"]?.["2"], "0", {
  value: "x",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"], "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"], "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["entries"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["entries"]?.["1"]), true);
$assert.notCallable(globalThis["entries"]?.["1"]);
$assert.notConstructable(globalThis["entries"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["entries"]?.["1"]), ['0', '1', 'length'], globalThis["entries"]?.["1"]);
$verifyProperty(globalThis["entries"]?.["1"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["entries"]?.["1"], "0", {
  value: "y",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["entries"]?.["3"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["entries"]?.["3"]), true);
$assert.notCallable(globalThis["entries"]?.["3"]);
$assert.notConstructable(globalThis["entries"]?.["3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["entries"]?.["3"]), ['0', '1', 'length'], globalThis["entries"]?.["3"]);
$verifyProperty(globalThis["entries"]?.["3"], "1", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"]?.["3"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["entries"]?.["3"], "0", {
  value: "y",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"], "3", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["entries"]?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["entries"]?.["0"]), true);
$assert.notCallable(globalThis["entries"]?.["0"]);
$assert.notConstructable(globalThis["entries"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["entries"]?.["0"]), ['0', '1', 'length'], globalThis["entries"]?.["0"]);
$verifyProperty(globalThis["entries"]?.["0"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"]?.["0"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["entries"]?.["0"], "0", {
  value: "z",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["entries"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['z', 'y', 'x'], globalThis["result"]);
$verifyProperty(globalThis["result"], "x", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"], "y", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"], "z", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
