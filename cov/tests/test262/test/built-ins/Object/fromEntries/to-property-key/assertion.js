...
$assert.sameValue($Object_getPrototypeOf(globalThis["key"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key"]), true);
$assert.notCallable(globalThis["key"]);
$assert.notConstructable(globalThis["key"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key"]), [Symbol.toPrimitive], globalThis["key"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["key"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["key"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["key"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["key"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["key"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["key"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key"]?.[Symbol.toPrimitive], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['key'], globalThis["result"]);
$verifyProperty(globalThis["result"], "key", {
  value: "value",
  writable: true,
  enumerable: true,
  configurable: true,
