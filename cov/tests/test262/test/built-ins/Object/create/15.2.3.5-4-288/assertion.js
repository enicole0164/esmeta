...
$assert.sameValue($Object_getPrototypeOf(globalThis["errObj"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errObj"]), true);
$assert.notCallable(globalThis["errObj"]);
$assert.notConstructable(globalThis["errObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]), ['message', 'set'], globalThis["errObj"]);
$verifyProperty(globalThis["errObj"], "message", {
  value: "error",
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["errObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errObj"]?.["set"]), true);
$assert.callable(globalThis["errObj"]?.["set"]);
$assert.constructable(globalThis["errObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["errObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["errObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["errObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["errObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["errObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["errObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["errObj"]?.["set"]);
$verifyProperty(globalThis["errObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["errObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["errObj"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["errObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["errObj"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.set, globalThis["errObj"]?.["set"]);
