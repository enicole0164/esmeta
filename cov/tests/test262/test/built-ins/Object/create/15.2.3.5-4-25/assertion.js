...
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]), ['prop'], globalThis["ConstructFun"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "prop")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"], "prop", {
  set: undefined,
  enumerable: true,
  configurable: false,
});
