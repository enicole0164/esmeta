...
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]), ['length', 'callee', 'enumerable', Symbol.iterator], globalThis["argObj"]);
...
$verifyProperty(globalThis["argObj"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
