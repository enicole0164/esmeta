...
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["prop"]), true);
$assert.notCallable(globalThis["ConstructFun"]?.["prototype"]?.["prop"]);
$assert.notConstructable(globalThis["ConstructFun"]?.["prototype"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["prop"]), ['value'], globalThis["ConstructFun"]?.["prototype"]?.["prop"]);
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["prop"], "value", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
