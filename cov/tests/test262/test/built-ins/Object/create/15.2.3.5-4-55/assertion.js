...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "enumerable")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
