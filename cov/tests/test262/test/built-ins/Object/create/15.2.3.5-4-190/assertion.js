...
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]), ['value', 'writable'], globalThis["ConstructFun"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "writable")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
