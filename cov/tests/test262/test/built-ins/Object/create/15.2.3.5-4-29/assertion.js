...
$assert.sameValue($Object_getPrototypeOf(globalThis["newObj"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newObj"]?.["prop"]), true);
$assert.notCallable(globalThis["newObj"]?.["prop"]);
$assert.notConstructable(globalThis["newObj"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newObj"]?.["prop"]), [], globalThis["newObj"]?.["prop"]);
...
$assert.sameValue(globalThis["props"]?.["prop"]?.["value"], globalThis["newObj"]?.["prop"]);
