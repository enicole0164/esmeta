...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "value")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
