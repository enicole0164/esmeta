...
$assert.compareArray($Reflect_ownKeys(globalThis["newObj"]), [], globalThis["newObj"]);
$assert.sameValue(globalThis["proto"], globalThis["ConstructFun"]?.["prototype"]);
$assert.sameValue(globalThis["result1"], true);
$assert.sameValue(globalThis["result2"], false);
