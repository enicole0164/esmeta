...
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["prop"]), true);
$assert.notCallable(globalThis["child"]?.["prop"]);
$assert.notConstructable(globalThis["child"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["prop"]), ['value'], globalThis["child"]?.["prop"]);
$verifyProperty(globalThis["child"]?.["prop"], "value", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
