...
$assert.compareArray($Reflect_ownKeys(globalThis["numObj"]), ['get'], globalThis["numObj"]);
$assert.sameValue(globalThis["numObj"]?.["get"], Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get);
$verifyProperty(globalThis["numObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
