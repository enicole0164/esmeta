...
$assert.sameValue($Object_getPrototypeOf(globalThis["getFunc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getFunc"]), true);
$assert.callable(globalThis["getFunc"]);
$assert.constructable(globalThis["getFunc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getFunc"]), ['length', 'name', 'prototype'], globalThis["getFunc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getFunc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getFunc"]?.["prototype"]), true);
$assert.notCallable(globalThis["getFunc"]?.["prototype"]);
$assert.notConstructable(globalThis["getFunc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getFunc"]?.["prototype"]), ['constructor'], globalThis["getFunc"]?.["prototype"]);
$assert.sameValue(globalThis["getFunc"]?.["prototype"]?.["constructor"], globalThis["getFunc"]);
$verifyProperty(globalThis["getFunc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getFunc"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getFunc"], "name", {
  value: "getFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getFunc"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["newObj"]), ['0', '1', '2'], globalThis["newObj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.get, globalThis["getFunc"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set, "name", {
  value: "setFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newObj"], "1", {
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["newObj"], "2", {
  value: 200.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["newObj"], "0", {
  value: 100.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["newObj"], "1")?.set);
