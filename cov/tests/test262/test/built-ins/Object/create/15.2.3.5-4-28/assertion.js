...
$assert.sameValue($Object_getPrototypeOf(globalThis["props"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["props"]?.["prop"]), true);
$assert.notCallable(globalThis["props"]?.["prop"]);
$assert.notConstructable(globalThis["props"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["props"]?.["prop"]), ['value', 'enumerable'], globalThis["props"]?.["prop"]);
$verifyProperty(globalThis["props"]?.["prop"], "value", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["props"]?.["prop"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
