...
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["set"]), true);
$assert.callable(globalThis["child"]?.["set"]);
$assert.constructable(globalThis["child"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["set"]), ['length', 'name', 'prototype'], globalThis["child"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["child"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["child"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["set"]?.["prototype"]), ['constructor'], globalThis["child"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["child"]?.["set"]?.["prototype"]?.["constructor"], globalThis["child"]?.["set"]);
$verifyProperty(globalThis["child"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["child"]?.["set"], "name", {
  value: "value",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.set, globalThis["child"]?.["set"]);
