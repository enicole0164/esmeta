...
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["get"]), true);
$assert.callable(globalThis["descObj"]?.["get"]);
$assert.constructable(globalThis["descObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["descObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["descObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["descObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["descObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["descObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["descObj"]?.["get"]);
$verifyProperty(globalThis["descObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descObj"]?.["get"], "name", {
  value: "value",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["descObj"]?.["get"]);
