...
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]), ['length', 'set'], globalThis["arrObj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrObj"]?.["set"]), true);
$assert.callable(globalThis["arrObj"]?.["set"]);
$assert.constructable(globalThis["arrObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["arrObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arrObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["arrObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["arrObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["arrObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["arrObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["arrObj"]?.["set"]);
$verifyProperty(globalThis["arrObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arrObj"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.set, globalThis["arrObj"]?.["set"]);
