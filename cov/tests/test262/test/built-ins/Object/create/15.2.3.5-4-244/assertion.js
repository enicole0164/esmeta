...
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]), ['length', 'name', 'prototype', 'get'], globalThis["funObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["funObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funObj"]?.["get"]), true);
$assert.callable(globalThis["funObj"]?.["get"]);
$assert.constructable(globalThis["funObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["funObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["funObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["funObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["funObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["funObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["funObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["funObj"]?.["get"]);
$verifyProperty(globalThis["funObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["funObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["funObj"]?.["get"]);
