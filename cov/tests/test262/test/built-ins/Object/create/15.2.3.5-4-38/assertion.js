...
$assert.sameValue($Object_getPrototypeOf(globalThis["argObj"]?.["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argObj"]?.["prop"]), true);
$assert.notCallable(globalThis["argObj"]?.["prop"]);
$assert.notConstructable(globalThis["argObj"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]?.["prop"]), ['value', 'enumerable'], globalThis["argObj"]?.["prop"]);
$verifyProperty(globalThis["argObj"]?.["prop"], "value", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["argObj"]?.["prop"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
