...
$assert.compareArray($Reflect_ownKeys(globalThis["boolObj"]), ['get'], globalThis["boolObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["boolObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boolObj"]?.["get"]), true);
$assert.callable(globalThis["boolObj"]?.["get"]);
$assert.constructable(globalThis["boolObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boolObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["boolObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["boolObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boolObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["boolObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["boolObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boolObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["boolObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["boolObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["boolObj"]?.["get"]);
$verifyProperty(globalThis["boolObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boolObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["boolObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boolObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boolObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["boolObj"]?.["get"]);
