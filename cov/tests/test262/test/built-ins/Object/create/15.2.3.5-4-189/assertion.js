...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "writable")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
