...
$assert.sameValue($Object_getPrototypeOf(globalThis["fun"]), globalThis["Func"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["fun"]), true);
$assert.notCallable(globalThis["fun"]);
$assert.notConstructable(globalThis["fun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fun"]), ['writable'], globalThis["fun"]);
$verifyProperty(globalThis["fun"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
