...
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["get"]), true);
$assert.callable(globalThis["ConstructFun"]?.["prototype"]?.["get"]);
$assert.constructable(globalThis["ConstructFun"]?.["prototype"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["get"]), ['length', 'name', 'prototype'], globalThis["ConstructFun"]?.["prototype"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]), ['constructor'], globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"]?.["constructor"], globalThis["ConstructFun"]?.["prototype"]?.["get"]);
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["get"], "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
