...
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]), true);
$assert.callable(globalThis["descObj"]);
$assert.constructable(globalThis["descObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['length', 'name', 'prototype', 'enumerable'], globalThis["descObj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descObj"]?.["prototype"]), true);
$assert.notCallable(globalThis["descObj"]?.["prototype"]);
$assert.notConstructable(globalThis["descObj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]?.["prototype"]), ['constructor'], globalThis["descObj"]?.["prototype"]);
$assert.sameValue(globalThis["descObj"]?.["prototype"]?.["constructor"], globalThis["descObj"]);
$verifyProperty(globalThis["descObj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descObj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$verifyProperty(globalThis["descObj"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
