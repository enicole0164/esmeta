...
$assert.sameValue($Object_getPrototypeOf(globalThis["booleanObj"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["booleanObj"]), true);
$assert.notCallable(globalThis["booleanObj"]);
$assert.notConstructable(globalThis["booleanObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["booleanObj"]), ['writable'], globalThis["booleanObj"]);
$verifyProperty(globalThis["booleanObj"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
