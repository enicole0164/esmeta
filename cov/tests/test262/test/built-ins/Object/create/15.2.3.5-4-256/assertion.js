...
$assert.sameValue($Object_getPrototypeOf(globalThis["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get"]), true);
$assert.callable(globalThis["get"]);
$assert.constructable(globalThis["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get"]), ['length', 'name', 'prototype'], globalThis["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["get"]?.["prototype"]);
$assert.notConstructable(globalThis["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["get"]?.["prototype"]), ['constructor'], globalThis["get"]?.["prototype"]);
$assert.sameValue(globalThis["get"]?.["prototype"]?.["constructor"], globalThis["get"]);
$verifyProperty(globalThis["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["get"]);
