...
$assert.sameValue($Object_getPrototypeOf(globalThis["argObj"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argObj"]), true);
$assert.notCallable(globalThis["argObj"]);
$assert.notConstructable(globalThis["argObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]), ['length', 'callee', 'prop', Symbol.iterator], globalThis["argObj"]);
$assert.sameValue(globalThis["argObj"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["argObj"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["argObj"], "prop")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"], "prop", {
  set: undefined,
  enumerable: true,
  configurable: false,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["argObj"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["argObj"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["argObj"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["argObj"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: true,
