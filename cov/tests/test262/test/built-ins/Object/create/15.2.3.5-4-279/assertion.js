...
$assert.sameValue($Object_getPrototypeOf(globalThis["funObj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funObj"]), true);
$assert.callable(globalThis["funObj"]);
$assert.constructable(globalThis["funObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]), ['length', 'name', 'prototype', 'set'], globalThis["funObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["funObj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funObj"]?.["prototype"]), true);
$assert.notCallable(globalThis["funObj"]?.["prototype"]);
$assert.notConstructable(globalThis["funObj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]?.["prototype"]), ['constructor'], globalThis["funObj"]?.["prototype"]);
$assert.sameValue(globalThis["funObj"]?.["prototype"]?.["constructor"], globalThis["funObj"]);
$verifyProperty(globalThis["funObj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["funObj"], "name", {
  value: "funObj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["funObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funObj"]?.["set"]), true);
$assert.callable(globalThis["funObj"]?.["set"]);
$assert.constructable(globalThis["funObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["funObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["funObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["funObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["funObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["funObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["funObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["funObj"]?.["set"]);
$verifyProperty(globalThis["funObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["funObj"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funObj"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.set, globalThis["funObj"]?.["set"]);
