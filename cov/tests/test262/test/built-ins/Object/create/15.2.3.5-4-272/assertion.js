...
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['set'], globalThis["descObj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "set")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
