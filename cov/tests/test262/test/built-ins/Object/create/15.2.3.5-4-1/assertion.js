...
$assert.sameValue(globalThis["base"], $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d"]), globalThis["b"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["d"]), ['x', 'y'], globalThis["d"]);
$verifyProperty(globalThis["d"], "x", {
  value: true,
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["d"], "y", {
  value: "str",
  writable: false,
  enumerable: false,
  configurable: false,
...
$assert.compareArray($Reflect_ownKeys(globalThis["prop"]), [], globalThis["prop"]);
