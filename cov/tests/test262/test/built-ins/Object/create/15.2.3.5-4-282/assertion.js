...
$assert.sameValue($Object_getPrototypeOf(globalThis["boolObj"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boolObj"]), true);
$assert.notCallable(globalThis["boolObj"]);
$assert.notConstructable(globalThis["boolObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boolObj"]), ['set'], globalThis["boolObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["boolObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boolObj"]?.["set"]), true);
$assert.callable(globalThis["boolObj"]?.["set"]);
$assert.constructable(globalThis["boolObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boolObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["boolObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["boolObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boolObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["boolObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["boolObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boolObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["boolObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["boolObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["boolObj"]?.["set"]);
$verifyProperty(globalThis["boolObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boolObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["boolObj"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boolObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boolObj"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.set, globalThis["boolObj"]?.["set"]);
