...
$assert.sameValue(globalThis["index"], 2.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["newObj"]), ['prop1', 'prop2'], globalThis["newObj"]);
$verifyProperty(globalThis["newObj"], "prop1", {
  value: 12.0,
  writable: false,
  enumerable: true,
  configurable: false,
});
$verifyProperty(globalThis["newObj"], "prop2", {
  value: true,
  writable: false,
  enumerable: true,
  configurable: false,
});
$assert.sameValue(globalThis["p"], "prop2");
...
$assert.sameValue($Object_getPrototypeOf(globalThis["props"]?.["prop1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["props"]?.["prop1"]), true);
$assert.notCallable(globalThis["props"]?.["prop1"]);
$assert.notConstructable(globalThis["props"]?.["prop1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["props"]?.["prop1"]), ['value', 'enumerable'], globalThis["props"]?.["prop1"]);
$verifyProperty(globalThis["props"]?.["prop1"], "value", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["props"]?.["prop1"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["props"]?.["prop2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["props"]?.["prop2"]), true);
$assert.notCallable(globalThis["props"]?.["prop2"]);
$assert.notConstructable(globalThis["props"]?.["prop2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["props"]?.["prop2"]), ['value', 'enumerable'], globalThis["props"]?.["prop2"]);
$verifyProperty(globalThis["props"]?.["prop2"], "value", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["props"]?.["prop2"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["q"], "prop2");
...
$assert.compareArray($Reflect_ownKeys(globalThis["tempArray"]), ['0', '1', 'length'], globalThis["tempArray"]);
