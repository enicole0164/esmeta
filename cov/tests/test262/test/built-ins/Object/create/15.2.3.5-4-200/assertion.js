...
$assert.sameValue($Object_getPrototypeOf(globalThis["errorObj"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errorObj"]), true);
$assert.notCallable(globalThis["errorObj"]);
$assert.notConstructable(globalThis["errorObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errorObj"]), ['writable'], globalThis["errorObj"]);
$verifyProperty(globalThis["errorObj"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
