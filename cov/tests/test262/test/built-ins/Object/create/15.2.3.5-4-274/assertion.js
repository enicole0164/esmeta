...
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["set"]), true);
$assert.callable(globalThis["ConstructFun"]?.["prototype"]?.["set"]);
$assert.constructable(globalThis["ConstructFun"]?.["prototype"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["set"]), ['length', 'name', 'prototype'], globalThis["ConstructFun"]?.["prototype"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]), ['constructor'], globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"]?.["constructor"], globalThis["ConstructFun"]?.["prototype"]?.["set"]);
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
