...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrayObj"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrayObj"]), true);
$assert.notCallable(globalThis["arrayObj"]);
$assert.notConstructable(globalThis["arrayObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrayObj"]), ['0', '1', '2', 'length', 'get'], globalThis["arrayObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arrayObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrayObj"]?.["get"]), true);
$assert.callable(globalThis["arrayObj"]?.["get"]);
$assert.constructable(globalThis["arrayObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrayObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["arrayObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arrayObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrayObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["arrayObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["arrayObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrayObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["arrayObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["arrayObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["arrayObj"]?.["get"]);
$verifyProperty(globalThis["arrayObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrayObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arrayObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrayObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrayObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrayObj"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrayObj"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arrayObj"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrayObj"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["arrayObj"]?.["get"]);
