...
$assert.sameValue($Object_getPrototypeOf(globalThis["descObj"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["descObj"]), ['length', 'enumerable'], globalThis["descObj"]);
