...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["descObj"], "get")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
