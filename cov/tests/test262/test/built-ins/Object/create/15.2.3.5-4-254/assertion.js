...
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]), ['length', 'callee', 'get', Symbol.iterator], globalThis["argObj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["argObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argObj"]?.["get"]), true);
$assert.callable(globalThis["argObj"]?.["get"]);
$assert.constructable(globalThis["argObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["argObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["argObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["argObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["argObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["argObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["argObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["argObj"]?.["get"]);
$verifyProperty(globalThis["argObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["argObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["argObj"]?.["get"]);
