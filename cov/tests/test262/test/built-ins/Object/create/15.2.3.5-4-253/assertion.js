...
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]), ['message', 'get'], globalThis["errObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["errObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errObj"]?.["get"]), true);
$assert.callable(globalThis["errObj"]?.["get"]);
$assert.constructable(globalThis["errObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["errObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["errObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["errObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["errObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["errObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["errObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["errObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["errObj"]?.["get"]);
$verifyProperty(globalThis["errObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["errObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["errObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["errObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["errObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newObj"], "prop")?.get, globalThis["errObj"]?.["get"]);
