...
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]), ['length', 'callee', 'writable', Symbol.iterator], globalThis["argObj"]);
...
$verifyProperty(globalThis["argObj"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
