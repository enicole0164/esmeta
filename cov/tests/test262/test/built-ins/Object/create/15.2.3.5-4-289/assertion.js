...
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]), ['length', 'callee', 'set', Symbol.iterator], globalThis["argObj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["argObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argObj"]?.["set"]), true);
$assert.callable(globalThis["argObj"]?.["set"]);
$assert.constructable(globalThis["argObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["argObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["argObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["argObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["argObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["argObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["argObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["argObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["argObj"]?.["set"]);
$verifyProperty(globalThis["argObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["argObj"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["argObj"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["newobj"], "prop")?.set, globalThis["argObj"]?.["set"]);
