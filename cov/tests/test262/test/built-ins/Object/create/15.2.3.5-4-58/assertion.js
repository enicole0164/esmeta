...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "enumerable")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
