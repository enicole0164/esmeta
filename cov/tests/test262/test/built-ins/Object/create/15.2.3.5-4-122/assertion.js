...
$assert.compareArray($Reflect_ownKeys(globalThis["argObj"]), ['length', 'callee', 'configurable', Symbol.iterator], globalThis["argObj"]);
...
$verifyProperty(globalThis["argObj"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
