...
$assert.compareArray($Reflect_ownKeys(globalThis["F"]?.["prototype"]), ['constructor', 'a', 'b'], globalThis["F"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["F"]?.["prototype"]?.["b"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["F"]?.["prototype"]?.["b"]), true);
$assert.notCallable(globalThis["F"]?.["prototype"]?.["b"]);
$assert.notConstructable(globalThis["F"]?.["prototype"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["F"]?.["prototype"]?.["b"]), [], globalThis["F"]?.["prototype"]?.["b"]);
$verifyProperty(globalThis["F"]?.["prototype"], "b", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["F"]?.["prototype"]?.["a"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["F"]?.["prototype"]?.["a"]), true);
$assert.notCallable(globalThis["F"]?.["prototype"]?.["a"]);
$assert.notConstructable(globalThis["F"]?.["prototype"]?.["a"]);
$assert.compareArray($Reflect_ownKeys(globalThis["F"]?.["prototype"]?.["a"]), [], globalThis["F"]?.["prototype"]?.["a"]);
$verifyProperty(globalThis["F"]?.["prototype"], "a", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["bValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bValue"]), true);
$assert.notCallable(globalThis["bValue"]);
$assert.notConstructable(globalThis["bValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bValue"]), [], globalThis["bValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]), globalThis["F"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["f"]), true);
$assert.notCallable(globalThis["f"]);
$assert.notConstructable(globalThis["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), ['b', 'c'], globalThis["f"]);
$assert.sameValue(globalThis["f"]?.["b"], globalThis["bValue"]);
$verifyProperty(globalThis["f"], "b", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["c"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["c"]), true);
$assert.notCallable(globalThis["f"]?.["c"]);
$assert.notConstructable(globalThis["f"]?.["c"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["c"]), [], globalThis["f"]?.["c"]);
$verifyProperty(globalThis["f"], "c", {
  writable: false,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['b', 'c'], globalThis["result"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["b"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["b"]), true);
$assert.notCallable(globalThis["result"]?.["b"]);
$assert.notConstructable(globalThis["result"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["b"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["result"]?.["b"]);
$assert.sameValue(globalThis["result"]?.["b"]?.["value"], globalThis["bValue"]);
$verifyProperty(globalThis["result"]?.["b"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["b"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["b"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["b"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"], "b", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["c"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["c"]), true);
$assert.notCallable(globalThis["result"]?.["c"]);
$assert.notConstructable(globalThis["result"]?.["c"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["c"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["result"]?.["c"]);
$assert.sameValue(globalThis["result"]?.["c"]?.["value"], globalThis["f"]?.["c"]);
$verifyProperty(globalThis["result"]?.["c"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["c"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["c"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["c"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"], "c", {
  writable: true,
  enumerable: true,
  configurable: true,
});
