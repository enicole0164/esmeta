...
$verifyProperty(globalThis["obj"], "key", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["key"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["key"]), true);
$assert.notCallable(globalThis["result"]?.["key"]);
$assert.notConstructable(globalThis["result"]?.["key"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["key"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["result"]?.["key"]);
$assert.sameValue(globalThis["result"]?.["key"]?.["value"], globalThis["obj"]?.["key"]);
$verifyProperty(globalThis["result"]?.["key"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["key"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["key"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"]?.["key"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["symValue"], globalThis["obj"]?.["key"]);
