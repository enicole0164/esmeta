...
$assert.sameValue($Object_getPrototypeOf(globalThis["falseResult"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["falseResult"]), [], globalThis["falseResult"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["trueResult"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["trueResult"]), [], globalThis["trueResult"]);
