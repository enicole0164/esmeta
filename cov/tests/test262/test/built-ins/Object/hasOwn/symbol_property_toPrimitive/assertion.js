...
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]), [Symbol.toPrimitive], globalThis["wrapper"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["wrapper"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["wrapper"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["wrapper"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["wrapper"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["wrapper"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["wrapper"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
