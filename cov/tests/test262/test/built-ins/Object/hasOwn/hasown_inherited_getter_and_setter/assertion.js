...
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.get);
...
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.set);
