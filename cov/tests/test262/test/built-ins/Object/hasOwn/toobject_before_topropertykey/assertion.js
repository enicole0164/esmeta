...
$assert.sameValue(globalThis["callCount1"], 0.0);
$assert.sameValue(globalThis["callCount2"], 0.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["coercibleKey1"]), ['toString', 'valueOf'], globalThis["coercibleKey1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["coercibleKey2"]), [Symbol.toPrimitive], globalThis["coercibleKey2"]);
