...
$assert.sameValue($Object_getPrototypeOf(globalThis["testArgs2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testArgs2"]), true);
$assert.callable(globalThis["testArgs2"]);
$assert.constructable(globalThis["testArgs2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testArgs2"]), ['length', 'name', 'prototype'], globalThis["testArgs2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testArgs2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testArgs2"]?.["prototype"]), true);
$assert.notCallable(globalThis["testArgs2"]?.["prototype"]);
$assert.notConstructable(globalThis["testArgs2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testArgs2"]?.["prototype"]), ['constructor'], globalThis["testArgs2"]?.["prototype"]);
$assert.sameValue(globalThis["testArgs2"]?.["prototype"]?.["constructor"], globalThis["testArgs2"]);
$verifyProperty(globalThis["testArgs2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testArgs2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testArgs2"], "name", {
  value: "testArgs2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testArgs2"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["testArgs3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testArgs3"]), true);
$assert.callable(globalThis["testArgs3"]);
$assert.constructable(globalThis["testArgs3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testArgs3"]), ['length', 'name', 'prototype'], globalThis["testArgs3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testArgs3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testArgs3"]?.["prototype"]), true);
$assert.notCallable(globalThis["testArgs3"]?.["prototype"]);
$assert.notConstructable(globalThis["testArgs3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testArgs3"]?.["prototype"]), ['constructor'], globalThis["testArgs3"]?.["prototype"]);
$assert.sameValue(globalThis["testArgs3"]?.["prototype"]?.["constructor"], globalThis["testArgs3"]);
$verifyProperty(globalThis["testArgs3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testArgs3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testArgs3"], "name", {
  value: "testArgs3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testArgs3"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["testArgs4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testArgs4"]), true);
$assert.callable(globalThis["testArgs4"]);
$assert.constructable(globalThis["testArgs4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testArgs4"]), ['length', 'name', 'prototype'], globalThis["testArgs4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testArgs4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testArgs4"]?.["prototype"]), true);
$assert.notCallable(globalThis["testArgs4"]?.["prototype"]);
$assert.notConstructable(globalThis["testArgs4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testArgs4"]?.["prototype"]), ['constructor'], globalThis["testArgs4"]?.["prototype"]);
$assert.sameValue(globalThis["testArgs4"]?.["prototype"]?.["constructor"], globalThis["testArgs4"]);
$verifyProperty(globalThis["testArgs4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testArgs4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testArgs4"], "name", {
  value: "testArgs4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testArgs4"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
