...
$assert.sameValue($Object_getPrototypeOf(globalThis["keysAfter"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["keysAfter"]), true);
$assert.notCallable(globalThis["keysAfter"]);
$assert.notConstructable(globalThis["keysAfter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["keysAfter"]), ['0', 'length'], globalThis["keysAfter"]);
$verifyProperty(globalThis["keysAfter"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["keysAfter"], "0", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["keysBefore"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["keysBefore"]), true);
$assert.notCallable(globalThis["keysBefore"]);
$assert.notConstructable(globalThis["keysBefore"]);
$assert.compareArray($Reflect_ownKeys(globalThis["keysBefore"]), ['0', 'length'], globalThis["keysBefore"]);
$verifyProperty(globalThis["keysBefore"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["keysBefore"], "0", {
  value: "x",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["literal"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["literal"]), true);
$assert.notCallable(globalThis["literal"]);
$assert.notConstructable(globalThis["literal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["literal"]), ['a'], globalThis["literal"]);
$verifyProperty(globalThis["literal"], "a", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
