...
$assert.sameValue($Object_getPrototypeOf(globalThis["denseArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["denseArray"]), true);
$assert.notCallable(globalThis["denseArray"]);
$assert.notConstructable(globalThis["denseArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["denseArray"]), ['0', '1', '2', 'length'], globalThis["denseArray"]);
$verifyProperty(globalThis["denseArray"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["denseArray"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["denseArray"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["denseArray"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
