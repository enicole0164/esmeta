...
$assert.sameValue(globalThis["index"], "3");
$assert.sameValue(globalThis["p"], "5");
...
$assert.compareArray($Reflect_ownKeys(globalThis["returnedArray"]), ['0', '1', '2', '3', 'length'], globalThis["returnedArray"]);
...
$verifyProperty(globalThis["returnedArray"], "3", {
  value: "5",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["sparseArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sparseArray"]), true);
$assert.notCallable(globalThis["sparseArray"]);
$assert.notConstructable(globalThis["sparseArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sparseArray"]), ['0', '1', '3', '5', 'length'], globalThis["sparseArray"]);
$verifyProperty(globalThis["sparseArray"], "length", {
  value: 6.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sparseArray"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["sparseArray"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["sparseArray"], "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["sparseArray"], "5", {
  value: 6.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["tempArray"]), ['0', '1', '2', '3', 'length'], globalThis["tempArray"]);
...
$verifyProperty(globalThis["tempArray"], "3", {
  value: "5",
  writable: true,
  enumerable: true,
  configurable: true,
