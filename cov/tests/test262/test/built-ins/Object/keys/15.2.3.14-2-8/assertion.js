...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['prop1', 'prop2', 'prop3', 'prop4'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop4")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "prop4", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["prop2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["prop2"]), true);
$assert.callable(globalThis["obj"]?.["prop2"]);
$assert.constructable(globalThis["obj"]?.["prop2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["prop2"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["prop2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["prop2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["prop2"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["prop2"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["prop2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["prop2"]?.["prototype"]), ['constructor'], globalThis["obj"]?.["prop2"]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.["prop2"]?.["prototype"]?.["constructor"], globalThis["obj"]?.["prop2"]);
$verifyProperty(globalThis["obj"]?.["prop2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["prop2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["prop2"], "name", {
  value: "prop2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["prop2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
