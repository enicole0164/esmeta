...
$assert.sameValue(globalThis["index"], 3.0);
$assert.sameValue(globalThis["initValue"], 6.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '2', '4', '5', '10000', 'length'], globalThis["obj"]);
