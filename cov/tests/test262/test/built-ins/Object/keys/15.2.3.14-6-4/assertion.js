...
$assert.sameValue(globalThis["index"], "2");
$assert.sameValue(globalThis["p"], "2");
$assert.sameValue($Object_getPrototypeOf(globalThis["returnedArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["returnedArray"]), true);
$assert.notCallable(globalThis["returnedArray"]);
$assert.notConstructable(globalThis["returnedArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["returnedArray"]), ['0', '1', '2', 'length'], globalThis["returnedArray"]);
$verifyProperty(globalThis["returnedArray"], "1", {
  value: "1",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["returnedArray"], "2", {
  value: "2",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["returnedArray"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["returnedArray"], "0", {
  value: "0",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["tempArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["tempArray"]), true);
$assert.notCallable(globalThis["tempArray"]);
$assert.notConstructable(globalThis["tempArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["tempArray"]), ['0', '1', '2', 'length'], globalThis["tempArray"]);
$verifyProperty(globalThis["tempArray"], "1", {
  value: "1",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["tempArray"], "2", {
  value: "2",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["tempArray"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["tempArray"], "0", {
  value: "0",
  writable: true,
  enumerable: true,
  configurable: true,
