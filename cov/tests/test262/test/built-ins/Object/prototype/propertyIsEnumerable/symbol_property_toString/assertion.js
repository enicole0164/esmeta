...
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]), true);
$assert.notCallable(globalThis["wrapper"]);
$assert.notConstructable(globalThis["wrapper"]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]), ['toString', 'valueOf'], globalThis["wrapper"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]?.["toString"]), true);
$assert.callable(globalThis["wrapper"]?.["toString"]);
$assert.constructable(globalThis["wrapper"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["wrapper"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["wrapper"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["wrapper"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["wrapper"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["wrapper"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["wrapper"]?.["toString"]);
$verifyProperty(globalThis["wrapper"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["wrapper"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]?.["valueOf"]), true);
$assert.callable(globalThis["wrapper"]?.["valueOf"]);
$assert.constructable(globalThis["wrapper"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["wrapper"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["wrapper"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["wrapper"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["wrapper"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["wrapper"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["wrapper"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["wrapper"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["wrapper"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["wrapper"]?.["valueOf"]);
$verifyProperty(globalThis["wrapper"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["wrapper"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["wrapper"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
