...
$assert.sameValue(globalThis["accum"], "the_property");
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['the_property'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "the_property", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["prop"], "the_property");
