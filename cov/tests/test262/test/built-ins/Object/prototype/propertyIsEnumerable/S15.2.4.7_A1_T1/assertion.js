...
$assert.sameValue($Object_getPrototypeOf(globalThis["AVISFACTORY"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["AVISFACTORY"]), true);
$assert.callable(globalThis["AVISFACTORY"]);
$assert.constructable(globalThis["AVISFACTORY"]);
$assert.compareArray($Reflect_ownKeys(globalThis["AVISFACTORY"]), ['length', 'name', 'prototype'], globalThis["AVISFACTORY"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["AVISFACTORY"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["AVISFACTORY"]?.["prototype"]), true);
$assert.notCallable(globalThis["AVISFACTORY"]?.["prototype"]);
$assert.notConstructable(globalThis["AVISFACTORY"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["AVISFACTORY"]?.["prototype"]), ['rootprop'], globalThis["AVISFACTORY"]?.["prototype"]);
$verifyProperty(globalThis["AVISFACTORY"]?.["prototype"], "rootprop", {
  value: "avis",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["AVISFACTORY"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["AVISFACTORY"], "name", {
  value: "AVISFACTORY",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["AVISFACTORY"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["proto"], globalThis["AVISFACTORY"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["seagull"]), globalThis["AVISFACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["seagull"]), true);
$assert.notCallable(globalThis["seagull"]);
$assert.notConstructable(globalThis["seagull"]);
$assert.compareArray($Reflect_ownKeys(globalThis["seagull"]), ['name'], globalThis["seagull"]);
$verifyProperty(globalThis["seagull"], "name", {
  value: "seagull",
  writable: true,
  enumerable: true,
  configurable: true,
