...
$assert.sameValue(custom1, 0n);
$assert.sameValue($Object_getPrototypeOf(custom2), BigInt.prototype);
$assert.sameValue(Object.isExtensible(custom2), true);
$assert.notCallable(custom2);
$assert.notConstructable(custom2);
$assert.compareArray($Reflect_ownKeys(custom2), [], custom2);
