...
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]), [Symbol.toStringTag], globalThis["custom"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]?.[Symbol.toStringTag]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["custom"]?.[Symbol.toStringTag]), true);
$assert.notCallable(globalThis["custom"]?.[Symbol.toStringTag]);
$assert.notConstructable(globalThis["custom"]?.[Symbol.toStringTag]);
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]?.[Symbol.toStringTag]), ['toString'], globalThis["custom"]?.[Symbol.toStringTag]);
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]), true);
$assert.callable(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]);
$assert.constructable(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]), ['length', 'name', 'prototype'], globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]), ['constructor'], globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"]?.["constructor"], globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]);
$verifyProperty(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["custom"]?.[Symbol.toStringTag]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["custom"]?.[Symbol.toStringTag], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["custom"], Symbol.toStringTag, {
  writable: true,
  enumerable: true,
  configurable: true,
});
