...
$assert.compareArray($Reflect_ownKeys(globalThis["target"]), ['attr'], globalThis["target"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "attr")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"], "attr", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
