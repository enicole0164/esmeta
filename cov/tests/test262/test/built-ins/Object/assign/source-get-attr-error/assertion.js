...
$assert.compareArray($Reflect_ownKeys(globalThis["source"]), ['attr'], globalThis["source"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get, "name", {
  value: "get attr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["source"], "attr")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["source"], "attr", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
