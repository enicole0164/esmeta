...
$assert.sameValue($Object_getPrototypeOf(globalThis["n_obj"]), Number.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["n_obj"]), [], globalThis["n_obj"]);
$assert.sameValue(globalThis["num"], Infinity);
