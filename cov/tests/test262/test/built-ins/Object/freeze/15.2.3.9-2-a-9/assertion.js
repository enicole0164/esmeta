...
$assert.sameValue(Object.isExtensible(globalThis["funObj"]), false);
$assert.callable(globalThis["funObj"]);
$assert.constructable(globalThis["funObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]), ['length', 'name', 'prototype', 'foo'], globalThis["funObj"]);
$verifyProperty(globalThis["funObj"], "foo", {
  value: 10.0,
  writable: false,
  enumerable: true,
  configurable: false,
