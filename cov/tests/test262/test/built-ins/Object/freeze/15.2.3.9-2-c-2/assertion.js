...
$assert.sameValue(globalThis["get_func"], globalThis["desc"]?.["get"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.get, globalThis["desc"]?.["get"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo")?.set, globalThis["desc"]?.["set"]);
$verifyProperty(globalThis["obj"], "foo", {
  enumerable: true,
  configurable: false,
});
$assert.sameValue(globalThis["set_func"], globalThis["desc"]?.["set"]);
$assert.sameValue(globalThis["set_funcCalled"], true);
