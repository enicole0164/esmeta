...
$assert.compareArray($Reflect_ownKeys(globalThis["desc1"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["desc1"]);
$verifyProperty(globalThis["desc1"], "value", {
  value: 10.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc1"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["get_func"], globalThis["desc2"]?.["get"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['foo1', 'foo2'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "foo1", {
  value: 10.0,
  writable: false,
  enumerable: true,
  configurable: false,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.get, globalThis["desc2"]?.["get"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "foo2")?.set, globalThis["desc2"]?.["set"]);
$verifyProperty(globalThis["obj"], "foo2", {
  enumerable: true,
  configurable: false,
});
$assert.sameValue(globalThis["resultSetFun"], true);
$assert.sameValue(globalThis["set_func"], globalThis["desc2"]?.["set"]);
