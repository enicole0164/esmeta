...
$assert.sameValue($Object_getPrototypeOf(globalThis["n_obj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["n_obj"]), true);
$assert.callable(globalThis["n_obj"]);
$assert.constructable(globalThis["n_obj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["n_obj"]), ['length', 'name', 'prototype'], globalThis["n_obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["n_obj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["n_obj"]?.["prototype"]), true);
$assert.notCallable(globalThis["n_obj"]?.["prototype"]);
$assert.notConstructable(globalThis["n_obj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["n_obj"]?.["prototype"]), ['constructor'], globalThis["n_obj"]?.["prototype"]);
$assert.sameValue(globalThis["n_obj"]?.["prototype"]?.["constructor"], globalThis["n_obj"]);
$verifyProperty(globalThis["n_obj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["n_obj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["n_obj"], "name", {
  value: "func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["n_obj"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
