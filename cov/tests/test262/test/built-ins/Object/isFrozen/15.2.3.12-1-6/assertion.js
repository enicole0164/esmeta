...
$assert.sameValue($Object_getPrototypeOf(globalThis["sparseArr"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sparseArr"]), false);
$assert.notCallable(globalThis["sparseArr"]);
$assert.notConstructable(globalThis["sparseArr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sparseArr"]), ['0', '1', '10000', 'length'], globalThis["sparseArr"]);
$verifyProperty(globalThis["sparseArr"], "1", {
  value: 1.0,
  writable: false,
  enumerable: true,
  configurable: false,
});
$verifyProperty(globalThis["sparseArr"], "length", {
  value: 10001.0,
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sparseArr"], "10000", {
  value: 10000.0,
  writable: false,
  enumerable: true,
  configurable: false,
});
$verifyProperty(globalThis["sparseArr"], "0", {
  value: 0.0,
  writable: false,
  enumerable: true,
  configurable: false,
