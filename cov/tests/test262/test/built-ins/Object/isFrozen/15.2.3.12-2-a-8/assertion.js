...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "foo")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
