...
$assert.sameValue($Object_getPrototypeOf(globalThis["n_obj"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["n_obj"]), true);
$assert.notCallable(globalThis["n_obj"]);
$assert.notConstructable(globalThis["n_obj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["n_obj"]), ['flag'], globalThis["n_obj"]);
$verifyProperty(globalThis["n_obj"], "flag", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["obj"], globalThis["n_obj"]);
