...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'verifySetFunc', 'prop'], globalThis["obj"]);
