...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc2"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc2"]?.["get"]), true);
$assert.callable(globalThis["desc2"]?.["get"]);
$assert.constructable(globalThis["desc2"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc2"]?.["get"]), ['length', 'name', 'prototype'], globalThis["desc2"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc2"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc2"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc2"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["desc2"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc2"]?.["get"]?.["prototype"]), ['constructor'], globalThis["desc2"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["desc2"]?.["get"]?.["prototype"]?.["constructor"], globalThis["desc2"]?.["get"]);
$verifyProperty(globalThis["desc2"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc2"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc2"]?.["get"], "name", {
  value: "getFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc2"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["getFunc"], globalThis["desc2"]?.["get"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.get, globalThis["desc2"]?.["get"]);
