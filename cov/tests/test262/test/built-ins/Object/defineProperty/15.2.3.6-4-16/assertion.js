...
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]), ['value'], globalThis["d1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['value', 'writable'], globalThis["desc"]);
