...
$assert.sameValue($Object_getPrototypeOf(globalThis["numObj"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["numObj"]?.["set"]), true);
$assert.callable(globalThis["numObj"]?.["set"]);
$assert.constructable(globalThis["numObj"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["numObj"]?.["set"]), ['length', 'name', 'prototype'], globalThis["numObj"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["numObj"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["numObj"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["numObj"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["numObj"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["numObj"]?.["set"]?.["prototype"]), ['constructor'], globalThis["numObj"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["numObj"]?.["set"]?.["prototype"]?.["constructor"], globalThis["numObj"]?.["set"]);
$verifyProperty(globalThis["numObj"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["numObj"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["numObj"]?.["set"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["numObj"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.set, globalThis["numObj"]?.["set"]);
