...
$assert.sameValue(globalThis["desc"]?.["value"], Object.getOwnPropertyDescriptor);
...
$assert.sameValue(globalThis["isConfigurable"], true);
$assert.sameValue(globalThis["isEnumerable"], false);
$assert.sameValue(globalThis["isWritable"], true);
$assert.sameValue(globalThis["prop"], undefined);
$assert.sameValue(globalThis["propertyAreCorrect"], true);
$assert.sameValue(globalThis["temp"], Object.getOwnPropertyDescriptor);
