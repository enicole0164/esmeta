...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'verifySetFunction', 'prop'], globalThis["obj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.get, globalThis["getFunc"]);
...
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set);
