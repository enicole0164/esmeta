...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrObj"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrObj"]?.["0"]), true);
$assert.notCallable(globalThis["arrObj"]?.["0"]);
$assert.notConstructable(globalThis["arrObj"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]?.["0"]), ['length'], globalThis["arrObj"]?.["0"]);
$verifyProperty(globalThis["arrObj"]?.["0"], "length", {
  value: 10.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["obj1"], globalThis["arrObj"]?.["0"]);
