...
$assert.sameValue($Object_getPrototypeOf(globalThis["attributes"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["attributes"]?.["get"]), true);
$assert.callable(globalThis["attributes"]?.["get"]);
$assert.constructable(globalThis["attributes"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["attributes"]?.["get"]), ['length', 'name', 'prototype'], globalThis["attributes"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["attributes"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["attributes"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["attributes"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["attributes"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["attributes"]?.["get"]?.["prototype"]), ['constructor'], globalThis["attributes"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["attributes"]?.["get"]?.["prototype"]?.["constructor"], globalThis["attributes"]?.["get"]);
$verifyProperty(globalThis["attributes"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["attributes"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["attributes"]?.["get"], "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["attributes"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["attributes"]?.["get"]);
