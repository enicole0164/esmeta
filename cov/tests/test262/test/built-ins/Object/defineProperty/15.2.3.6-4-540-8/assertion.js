...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', 'length', 'callee', 'verifySetFunction', Symbol.iterator], globalThis["obj"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.get, globalThis["getFunc"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set, "name", {
  value: "setFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set);
