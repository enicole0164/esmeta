...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["get"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["get"]), true);
$assert.notCallable(globalThis["desc"]?.["get"]);
$assert.notConstructable(globalThis["desc"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["get"]), ['a'], globalThis["desc"]?.["get"]);
$verifyProperty(globalThis["desc"]?.["get"], "a", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
