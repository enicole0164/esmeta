...
$assert.sameValue(globalThis["p1"], undefined);
$assert.sameValue(globalThis["p2"], undefined);
$assert.sameValue(globalThis["result1"], false);
$assert.sameValue(globalThis["result2"], false);
$assert.sameValue(globalThis["setFunc"], globalThis["desc1"]?.["set"]);
$assert.sameValue(globalThis["verifySetFunc"], "data");
