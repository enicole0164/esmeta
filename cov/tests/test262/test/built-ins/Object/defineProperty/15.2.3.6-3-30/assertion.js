...
$assert.sameValue($Object_getPrototypeOf(globalThis["attr"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["attr"]), true);
$assert.notCallable(globalThis["attr"]);
$assert.notConstructable(globalThis["attr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["attr"]), ['enumerable'], globalThis["attr"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "enumerable")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["attr"], "enumerable", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
