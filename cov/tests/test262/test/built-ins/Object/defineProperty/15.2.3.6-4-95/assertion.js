...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["foo"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["foo"]), true);
$assert.notCallable(globalThis["obj"]?.["foo"]);
$assert.notConstructable(globalThis["obj"]?.["foo"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["foo"]), ['length'], globalThis["obj"]?.["foo"]);
...
$assert.sameValue(globalThis["obj1"], globalThis["obj"]?.["foo"]);
