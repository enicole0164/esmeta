...
$assert.compareArray($Reflect_ownKeys(globalThis["attr"]), ['writable'], globalThis["attr"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "writable")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["attr"], "writable", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
