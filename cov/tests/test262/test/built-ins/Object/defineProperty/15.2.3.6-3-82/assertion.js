...
$assert.sameValue(globalThis["afterDeleted"], false);
...
$assert.sameValue(globalThis["beforeDeleted"], true);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "configurable")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
