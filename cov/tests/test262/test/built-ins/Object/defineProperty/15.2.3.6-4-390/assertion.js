...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["value"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["value"]), true);
$assert.callable(globalThis["desc"]?.["value"]);
$assert.constructable(globalThis["desc"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["value"]), ['length', 'name', 'prototype'], globalThis["desc"]?.["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["value"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["value"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc"]?.["value"]?.["prototype"]);
$assert.notConstructable(globalThis["desc"]?.["value"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["value"]?.["prototype"]), ['constructor'], globalThis["desc"]?.["value"]?.["prototype"]);
$assert.sameValue(globalThis["desc"]?.["value"]?.["prototype"]?.["constructor"], globalThis["desc"]?.["value"]);
$verifyProperty(globalThis["desc"]?.["value"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"]?.["value"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc"]?.["value"], "name", {
  value: "funObj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"]?.["value"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["funObj"], globalThis["desc"]?.["value"]);
...
$assert.sameValue(globalThis["obj"]?.["prop"], globalThis["desc"]?.["value"]);
