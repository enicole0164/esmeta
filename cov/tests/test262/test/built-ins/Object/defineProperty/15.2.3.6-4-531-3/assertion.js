...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'callee', 'verifySetFunction', 'verifySetFunction1', Symbol.iterator], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "verifySetFunction1", {
  value: "data1",
  writable: true,
  enumerable: true,
  configurable: true,
