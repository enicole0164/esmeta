...
$assert.compareArray($Reflect_ownKeys(globalThis["propDesc"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["propDesc"]);
$verifyProperty(globalThis["propDesc"], "value", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["propDesc"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
