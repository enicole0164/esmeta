...
$assert.compareArray($Reflect_ownKeys(globalThis["funObj"]), ['length', 'name', 'prototype', 'configurable'], globalThis["funObj"]);
...
$verifyProperty(globalThis["funObj"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
