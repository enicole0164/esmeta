...
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]), ['toString'], globalThis["ConstructFun"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["toString"]), true);
$assert.callable(globalThis["ConstructFun"]?.["prototype"]?.["toString"]);
$assert.constructable(globalThis["ConstructFun"]?.["prototype"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["ConstructFun"]?.["prototype"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["ConstructFun"]?.["prototype"]?.["toString"]);
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['test'], globalThis["obj"]);
