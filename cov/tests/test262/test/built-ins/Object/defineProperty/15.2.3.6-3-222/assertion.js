...
$assert.sameValue($Object_getPrototypeOf(globalThis["numObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["numObj"]?.["get"]), true);
$assert.callable(globalThis["numObj"]?.["get"]);
$assert.constructable(globalThis["numObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["numObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["numObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["numObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["numObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["numObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["numObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["numObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["numObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["numObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["numObj"]?.["get"]);
$verifyProperty(globalThis["numObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["numObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["numObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["numObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["numObj"]?.["get"]);
