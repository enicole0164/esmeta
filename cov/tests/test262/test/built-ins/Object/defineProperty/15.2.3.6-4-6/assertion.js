...
$assert.sameValue($Object_getPrototypeOf(globalThis["d1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d1"]), true);
$assert.notCallable(globalThis["d1"]);
$assert.notConstructable(globalThis["d1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["d1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d1"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d1"]?.["get"]), true);
$assert.callable(globalThis["d1"]?.["get"]);
$assert.constructable(globalThis["d1"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]?.["get"]), ['length', 'name', 'prototype'], globalThis["d1"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d1"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d1"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["d1"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["d1"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]?.["get"]?.["prototype"]), ['constructor'], globalThis["d1"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["d1"]?.["get"]?.["prototype"]?.["constructor"], globalThis["d1"]?.["get"]);
$verifyProperty(globalThis["d1"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d1"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["d1"]?.["get"], "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d1"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d1"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d1"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d1"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d1"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["d2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d2"]), true);
$assert.notCallable(globalThis["d2"]);
$assert.notConstructable(globalThis["d2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d2"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["d2"]);
$assert.sameValue(globalThis["d2"]?.["get"], globalThis["d1"]?.["get"]);
$verifyProperty(globalThis["d2"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d2"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d2"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d2"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['get', 'enumerable', 'configurable'], globalThis["desc"]);
$assert.sameValue(globalThis["desc"]?.["get"], globalThis["d1"]?.["get"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['foo'], globalThis["o"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "foo")?.get, globalThis["d1"]?.["get"]);
$verifyProperty(globalThis["o"], "foo", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["sameAccessorDescriptorValues"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sameAccessorDescriptorValues"]), true);
$assert.callable(globalThis["sameAccessorDescriptorValues"]);
$assert.constructable(globalThis["sameAccessorDescriptorValues"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sameAccessorDescriptorValues"]), ['length', 'name', 'prototype'], globalThis["sameAccessorDescriptorValues"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["sameAccessorDescriptorValues"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sameAccessorDescriptorValues"]?.["prototype"]), true);
$assert.notCallable(globalThis["sameAccessorDescriptorValues"]?.["prototype"]);
$assert.notConstructable(globalThis["sameAccessorDescriptorValues"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sameAccessorDescriptorValues"]?.["prototype"]), ['constructor'], globalThis["sameAccessorDescriptorValues"]?.["prototype"]);
$assert.sameValue(globalThis["sameAccessorDescriptorValues"]?.["prototype"]?.["constructor"], globalThis["sameAccessorDescriptorValues"]);
$verifyProperty(globalThis["sameAccessorDescriptorValues"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sameAccessorDescriptorValues"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sameAccessorDescriptorValues"], "name", {
  value: "sameAccessorDescriptorValues",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sameAccessorDescriptorValues"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
