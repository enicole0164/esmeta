...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["ConstructFun"]?.["prototype"], "foo")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
