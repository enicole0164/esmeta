...
$assert.compareArray($Reflect_ownKeys(globalThis["fooDescrip"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["fooDescrip"]);
$verifyProperty(globalThis["fooDescrip"], "value", {
  value: "hello",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
