...
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]), ['length', 'property', 'setVerifyHelpProp'], globalThis["arrObj"]);
$verifyProperty(globalThis["arrObj"], "setVerifyHelpProp", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get, "name", {
  value: "getFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set, "name", {
  value: "setFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"], "property", {
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue(globalThis["getFunc"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.get);
...
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "property")?.set);
