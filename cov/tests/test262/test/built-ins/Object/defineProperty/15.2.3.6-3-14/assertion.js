...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["set"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["set"]), true);
$assert.notCallable(globalThis["desc"]?.["set"]);
$assert.notConstructable(globalThis["desc"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["set"]), ['a'], globalThis["desc"]?.["set"]);
$verifyProperty(globalThis["desc"]?.["set"], "a", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
