...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["value"]), true);
$assert.notCallable(globalThis["desc"]?.["value"]);
$assert.notConstructable(globalThis["desc"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["value"]), ['testproperty'], globalThis["desc"]?.["value"]);
$verifyProperty(globalThis["desc"]?.["value"], "testproperty", {
  value: 100.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["tempObj"], globalThis["desc"]?.["value"]);
