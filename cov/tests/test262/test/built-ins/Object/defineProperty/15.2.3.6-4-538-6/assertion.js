...
$assert.compareArray($Reflect_ownKeys(globalThis["desc2"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["desc2"]);
$verifyProperty(globalThis["desc2"], "value", {
  value: 1001.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc2"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'callee', 'verifySetFunc', Symbol.iterator], globalThis["obj"]);
