...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', 'length', 'callee', 'verifySetFunc', Symbol.iterator], globalThis["obj"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.get, globalThis["desc1"]?.["get"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "0")?.set, globalThis["desc1"]?.["set"]);
