...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc2"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc2"]?.["set"]), true);
$assert.callable(globalThis["desc2"]?.["set"]);
$assert.constructable(globalThis["desc2"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc2"]?.["set"]), ['length', 'name', 'prototype'], globalThis["desc2"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc2"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc2"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc2"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["desc2"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc2"]?.["set"]?.["prototype"]), ['constructor'], globalThis["desc2"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["desc2"]?.["set"]?.["prototype"]?.["constructor"], globalThis["desc2"]?.["set"]);
$verifyProperty(globalThis["desc2"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc2"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc2"]?.["set"], "name", {
  value: "setFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc2"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["desc2"]?.["set"]);
$verifyProperty(globalThis["obj"], "prop", {
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["propertyDefineCorrect"], true);
$assert.sameValue(globalThis["setFunc"], globalThis["desc2"]?.["set"]);
$assert.sameValue(globalThis["verifySetFunc"], "overrideData");
