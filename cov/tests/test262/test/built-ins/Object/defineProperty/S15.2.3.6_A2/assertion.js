...
$assert.sameValue($Object_getPrototypeOf(globalThis["derived"]), globalThis["base"]);
$assert.sameValue(Object.isExtensible(globalThis["derived"]), true);
$assert.notCallable(globalThis["derived"]);
$assert.notConstructable(globalThis["derived"]);
$assert.compareArray($Reflect_ownKeys(globalThis["derived"]), [], globalThis["derived"]);
$assert.sameValue(globalThis["getter"], Object.getOwnPropertyDescriptor(globalThis["base"], "foo")?.get);
