...
$assert.sameValue($Object_getPrototypeOf(globalThis["setFunc1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setFunc1"]), true);
$assert.callable(globalThis["setFunc1"]);
$assert.constructable(globalThis["setFunc1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setFunc1"]), ['length', 'name', 'prototype'], globalThis["setFunc1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["setFunc1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setFunc1"]?.["prototype"]), true);
$assert.notCallable(globalThis["setFunc1"]?.["prototype"]);
$assert.notConstructable(globalThis["setFunc1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setFunc1"]?.["prototype"]), ['constructor'], globalThis["setFunc1"]?.["prototype"]);
$assert.sameValue(globalThis["setFunc1"]?.["prototype"]?.["constructor"], globalThis["setFunc1"]);
$verifyProperty(globalThis["setFunc1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setFunc1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setFunc1"], "name", {
  value: "setFunc1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setFunc1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["setFunc2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setFunc2"]), true);
$assert.callable(globalThis["setFunc2"]);
$assert.constructable(globalThis["setFunc2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setFunc2"]), ['length', 'name', 'prototype'], globalThis["setFunc2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["setFunc2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setFunc2"]?.["prototype"]), true);
$assert.notCallable(globalThis["setFunc2"]?.["prototype"]);
$assert.notConstructable(globalThis["setFunc2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setFunc2"]?.["prototype"]), ['constructor'], globalThis["setFunc2"]?.["prototype"]);
$assert.sameValue(globalThis["setFunc2"]?.["prototype"]?.["constructor"], globalThis["setFunc2"]);
$verifyProperty(globalThis["setFunc2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setFunc2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setFunc2"], "name", {
  value: "setFunc2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setFunc2"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
