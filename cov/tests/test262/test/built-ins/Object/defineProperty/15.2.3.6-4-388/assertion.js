...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["value"]), Number.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["value"]), [], globalThis["desc"]?.["value"]);
...
$assert.sameValue(globalThis["numObj"], globalThis["desc"]?.["value"]);
