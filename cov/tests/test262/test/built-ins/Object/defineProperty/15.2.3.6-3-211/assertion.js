...
$assert.compareArray($Reflect_ownKeys(globalThis["attributes"]), ['get'], globalThis["attributes"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "get")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["attributes"], "get", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
