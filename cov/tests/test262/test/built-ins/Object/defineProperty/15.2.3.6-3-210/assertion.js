...
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["get"]), true);
$assert.callable(globalThis["child"]?.["get"]);
$assert.constructable(globalThis["child"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["get"]), ['length', 'name', 'prototype'], globalThis["child"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["child"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["child"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["get"]?.["prototype"]), ['constructor'], globalThis["child"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["child"]?.["get"]?.["prototype"]?.["constructor"], globalThis["child"]?.["get"]);
$verifyProperty(globalThis["child"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["child"]?.["get"], "name", {
  value: "value",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["child"]?.["get"]);
