...
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]), ['set'], globalThis["d1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d1"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d1"]?.["set"]), true);
$assert.callable(globalThis["d1"]?.["set"]);
$assert.constructable(globalThis["d1"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]?.["set"]), ['length', 'name', 'prototype'], globalThis["d1"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["d1"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["d1"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["d1"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["d1"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]?.["set"]?.["prototype"]), ['constructor'], globalThis["d1"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["d1"]?.["set"]?.["prototype"]?.["constructor"], globalThis["d1"]?.["set"]);
$verifyProperty(globalThis["d1"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d1"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["d1"]?.["set"], "name", {
  value: "setter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["d1"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["d2"]?.["set"], globalThis["d1"]?.["set"]);
...
$assert.sameValue(globalThis["getter"], undefined);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "foo")?.set, globalThis["d1"]?.["set"]);
$verifyProperty(globalThis["o"], "foo", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["setter"], globalThis["d1"]?.["set"]);
