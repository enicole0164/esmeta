...
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]), ['get'], globalThis["d1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['set'], globalThis["desc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["set"]), true);
$assert.callable(globalThis["desc"]?.["set"]);
$assert.constructable(globalThis["desc"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["set"]), ['length', 'name', 'prototype'], globalThis["desc"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["desc"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["set"]?.["prototype"]), ['constructor'], globalThis["desc"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["desc"]?.["set"]?.["prototype"]?.["constructor"], globalThis["desc"]?.["set"]);
$verifyProperty(globalThis["desc"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc"]?.["set"], "name", {
  value: "setter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["getter"], globalThis["d1"]?.["get"]);
...
$assert.sameValue(globalThis["setter"], globalThis["desc"]?.["set"]);
