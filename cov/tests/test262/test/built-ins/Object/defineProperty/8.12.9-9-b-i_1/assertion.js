...
$assert.sameValue($Object_getPrototypeOf(globalThis["fooDescrip"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fooDescrip"]), true);
$assert.notCallable(globalThis["fooDescrip"]);
$assert.notConstructable(globalThis["fooDescrip"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fooDescrip"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["fooDescrip"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fooDescrip"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fooDescrip"]?.["get"]), true);
$assert.callable(globalThis["fooDescrip"]?.["get"]);
$assert.constructable(globalThis["fooDescrip"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fooDescrip"]?.["get"]), ['length', 'name', 'prototype'], globalThis["fooDescrip"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fooDescrip"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fooDescrip"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["fooDescrip"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["fooDescrip"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fooDescrip"]?.["get"]?.["prototype"]), ['constructor'], globalThis["fooDescrip"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["fooDescrip"]?.["get"]?.["prototype"]?.["constructor"], globalThis["fooDescrip"]?.["get"]);
$verifyProperty(globalThis["fooDescrip"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fooDescrip"]?.["get"], "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["fooDescrip"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(Object.isExtensible(globalThis["o"]), false);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "foo")?.get, globalThis["fooDescrip"]?.["get"]);
