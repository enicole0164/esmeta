...
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]), ['length', 'get'], globalThis["arrObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arrObj"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrObj"]?.["get"]), true);
$assert.callable(globalThis["arrObj"]?.["get"]);
$assert.constructable(globalThis["arrObj"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]?.["get"]), ['length', 'name', 'prototype'], globalThis["arrObj"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arrObj"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrObj"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["arrObj"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["arrObj"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]?.["get"]?.["prototype"]), ['constructor'], globalThis["arrObj"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["arrObj"]?.["get"]?.["prototype"]?.["constructor"], globalThis["arrObj"]?.["get"]);
$verifyProperty(globalThis["arrObj"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arrObj"]?.["get"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["arrObj"]?.["get"]);
