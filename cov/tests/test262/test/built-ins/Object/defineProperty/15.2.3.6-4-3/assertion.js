...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "foo")?.get, globalThis["desc"]?.["get"]);
$verifyProperty(globalThis["o"], "foo", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["propDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["propDesc"]), true);
$assert.notCallable(globalThis["propDesc"]);
$assert.notConstructable(globalThis["propDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["propDesc"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["propDesc"]);
$assert.sameValue(globalThis["propDesc"]?.["get"], globalThis["desc"]?.["get"]);
$verifyProperty(globalThis["propDesc"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["propDesc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["propDesc"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["propDesc"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
