...
$assert.sameValue(globalThis["getFunc"], globalThis["desc"]?.["get"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["desc"]?.["set"]);
...
$assert.sameValue(globalThis["setFunc"], globalThis["desc"]?.["set"]);
