...
$assert.sameValue($Object_getPrototypeOf(globalThis["attributes"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["attributes"]), true);
$assert.notCallable(globalThis["attributes"]);
$assert.notConstructable(globalThis["attributes"]);
$assert.compareArray($Reflect_ownKeys(globalThis["attributes"]), ['set'], globalThis["attributes"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attributes"], "set")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["attributes"], "set", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["data"], "ownAccessorProperty");
