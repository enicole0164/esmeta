...
$assert.sameValue($Object_getPrototypeOf(globalThis["attr"]?.["configurable"]), SyntaxError.prototype);
$assert.sameValue(Object.isExtensible(globalThis["attr"]?.["configurable"]), true);
$assert.notCallable(globalThis["attr"]?.["configurable"]);
$assert.notConstructable(globalThis["attr"]?.["configurable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["attr"]?.["configurable"]), [], globalThis["attr"]?.["configurable"]);
