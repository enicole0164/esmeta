...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrObj"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrObj"]?.["1"]), true);
$assert.notCallable(globalThis["arrObj"]?.["1"]);
$assert.notConstructable(globalThis["arrObj"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]?.["1"]), ['length'], globalThis["arrObj"]?.["1"]);
$verifyProperty(globalThis["arrObj"]?.["1"], "length", {
  value: 10.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["obj"], globalThis["arrObj"]?.["1"]);
