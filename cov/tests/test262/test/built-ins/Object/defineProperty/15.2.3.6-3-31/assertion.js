...
$assert.compareArray($Reflect_ownKeys(globalThis["child"]), ['enumerable'], globalThis["child"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "enumerable")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"], "enumerable", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue(globalThis["prop"], undefined);
