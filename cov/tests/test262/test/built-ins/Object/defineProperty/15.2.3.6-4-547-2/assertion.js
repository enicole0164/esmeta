...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc1"]), true);
$assert.notCallable(globalThis["desc1"]);
$assert.notConstructable(globalThis["desc1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc1"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["desc1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc1"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc1"]?.["get"]), true);
$assert.callable(globalThis["desc1"]?.["get"]);
$assert.constructable(globalThis["desc1"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc1"]?.["get"]), ['length', 'name', 'prototype'], globalThis["desc1"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc1"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc1"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc1"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["desc1"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc1"]?.["get"]?.["prototype"]), ['constructor'], globalThis["desc1"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["desc1"]?.["get"]?.["prototype"]?.["constructor"], globalThis["desc1"]?.["get"]);
$verifyProperty(globalThis["desc1"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc1"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc1"]?.["get"], "name", {
  value: "getFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc1"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc1"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc1"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc1"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["desc1"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc1"]?.["set"]), true);
$assert.callable(globalThis["desc1"]?.["set"]);
$assert.constructable(globalThis["desc1"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc1"]?.["set"]), ['length', 'name', 'prototype'], globalThis["desc1"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["desc1"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc1"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["desc1"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["desc1"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc1"]?.["set"]?.["prototype"]), ['constructor'], globalThis["desc1"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["desc1"]?.["set"]?.["prototype"]?.["constructor"], globalThis["desc1"]?.["set"]);
$verifyProperty(globalThis["desc1"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc1"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["desc1"]?.["set"], "name", {
  value: "setFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc1"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["desc1"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["desc2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["desc2"]), true);
$assert.notCallable(globalThis["desc2"]);
$assert.notConstructable(globalThis["desc2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc2"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["desc2"]);
$assert.sameValue(globalThis["desc2"]?.["get"], globalThis["desc1"]?.["get"]);
$verifyProperty(globalThis["desc2"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc2"], "enumerable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["desc2"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["desc2"]?.["set"], globalThis["desc1"]?.["set"]);
$verifyProperty(globalThis["desc2"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["getFunc"], globalThis["desc1"]?.["get"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'callee', 'verifySetFunc', 'prop', Symbol.iterator], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "verifySetFunc", {
  value: "data",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.get, globalThis["desc1"]?.["get"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "prop")?.set, globalThis["desc1"]?.["set"]);
$verifyProperty(globalThis["obj"], "prop", {
  enumerable: true,
  configurable: false,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["obj"], "callee", {
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue(globalThis["obj"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["obj"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["setFunc"], globalThis["desc1"]?.["set"]);
