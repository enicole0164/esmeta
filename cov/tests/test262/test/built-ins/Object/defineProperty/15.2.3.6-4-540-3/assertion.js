...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'callee', 'verifySetFunction', 'property', Symbol.iterator], globalThis["obj"]);
...
$verifyProperty(globalThis["obj"], "verifySetFunction", {
  value: "data",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.get, globalThis["getFunc"]);
...
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.set);
