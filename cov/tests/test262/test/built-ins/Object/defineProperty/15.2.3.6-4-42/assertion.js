...
$assert.sameValue($Object_getPrototypeOf(globalThis["desc"]), Error.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['foo'], globalThis["desc"]);
$verifyProperty(globalThis["desc"], "foo", {
  value: 12.0,
  writable: false,
  enumerable: false,
  configurable: false,
