...
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]), ['1', 'length', 'setVerifyHelpProp'], globalThis["arrObj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get, "name", {
  value: "getFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set, "name", {
  value: "setFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrObj"], "1", {
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue(globalThis["getFunc"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.get);
...
$assert.sameValue(globalThis["setFunc"], Object.getOwnPropertyDescriptor(globalThis["arrObj"], "1")?.set);
