...
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]), ['valueOf'], globalThis["ConstructFun"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]), true);
$assert.callable(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]);
$assert.constructable(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]);
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ConstructFun"]?.["prototype"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["arrObj"]), ['length'], globalThis["arrObj"]);
