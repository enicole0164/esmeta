...
$assert.compareArray($Reflect_ownKeys(globalThis["d1"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["d1"]);
$verifyProperty(globalThis["d1"], "value", {
  value: 101.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d1"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["d2"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["d2"]);
$verifyProperty(globalThis["d2"], "value", {
  value: 101.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["d2"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]), ['value', 'enumerable', 'writable', 'configurable'], globalThis["desc"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["sameDataDescriptorValues"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sameDataDescriptorValues"]), true);
$assert.callable(globalThis["sameDataDescriptorValues"]);
$assert.constructable(globalThis["sameDataDescriptorValues"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sameDataDescriptorValues"]), ['length', 'name', 'prototype'], globalThis["sameDataDescriptorValues"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["sameDataDescriptorValues"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sameDataDescriptorValues"]?.["prototype"]), true);
$assert.notCallable(globalThis["sameDataDescriptorValues"]?.["prototype"]);
$assert.notConstructable(globalThis["sameDataDescriptorValues"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sameDataDescriptorValues"]?.["prototype"]), ['constructor'], globalThis["sameDataDescriptorValues"]?.["prototype"]);
$assert.sameValue(globalThis["sameDataDescriptorValues"]?.["prototype"]?.["constructor"], globalThis["sameDataDescriptorValues"]);
$verifyProperty(globalThis["sameDataDescriptorValues"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sameDataDescriptorValues"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sameDataDescriptorValues"], "name", {
  value: "sameDataDescriptorValues",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sameDataDescriptorValues"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
