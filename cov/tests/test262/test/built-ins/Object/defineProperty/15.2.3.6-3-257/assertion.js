...
$assert.compareArray($Reflect_ownKeys(globalThis["errObj"]), ['set'], globalThis["errObj"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "property")?.set, globalThis["errObj"]?.["set"]);
