...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["attr"], "value")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
