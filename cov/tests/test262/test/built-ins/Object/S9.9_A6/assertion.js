...
$assert.sameValue($Object_getPrototypeOf(globalThis["MyObject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyObject"]), true);
$assert.callable(globalThis["MyObject"]);
$assert.constructable(globalThis["MyObject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyObject"]), ['length', 'name', 'prototype'], globalThis["MyObject"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["MyObject"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyObject"]?.["prototype"]), true);
$assert.notCallable(globalThis["MyObject"]?.["prototype"]);
$assert.notConstructable(globalThis["MyObject"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyObject"]?.["prototype"]), ['constructor'], globalThis["MyObject"]?.["prototype"]);
$assert.sameValue(globalThis["MyObject"]?.["prototype"]?.["constructor"], globalThis["MyObject"]);
$verifyProperty(globalThis["MyObject"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyObject"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["MyObject"], "name", {
  value: "MyObject",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyObject"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]), globalThis["MyObject"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['value', 'valueOf'], globalThis["x"]);
$verifyProperty(globalThis["x"], "value", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["y"], globalThis["x"]);
