...
$assert.sameValue($Object_getPrototypeOf(globalThis["newProto"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newProto"]), true);
$assert.notCallable(globalThis["newProto"]);
$assert.notConstructable(globalThis["newProto"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newProto"]), ['test262prop'], globalThis["newProto"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["newProto"]?.["test262prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newProto"]?.["test262prop"]), true);
$assert.notCallable(globalThis["newProto"]?.["test262prop"]);
$assert.notConstructable(globalThis["newProto"]?.["test262prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newProto"]?.["test262prop"]), [], globalThis["newProto"]?.["test262prop"]);
$verifyProperty(globalThis["newProto"], "test262prop", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), globalThis["newProto"]);
...
$assert.sameValue(globalThis["propValue"], globalThis["newProto"]?.["test262prop"]);
$assert.sameValue(globalThis["result"], globalThis["obj"]);
