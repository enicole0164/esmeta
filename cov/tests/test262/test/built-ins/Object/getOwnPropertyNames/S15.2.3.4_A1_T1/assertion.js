...
$assert.sameValue(globalThis["len"], 3.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["names"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["names"]), true);
$assert.notCallable(globalThis["names"]);
$assert.notConstructable(globalThis["names"]);
$assert.compareArray($Reflect_ownKeys(globalThis["names"]), ['0', '1', '2', 'length'], globalThis["names"]);
$verifyProperty(globalThis["names"], "1", {
  value: "name",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["names"], "2", {
  value: "prototype",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["names"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["names"], "0", {
  value: "length",
  writable: true,
  enumerable: true,
  configurable: true,
