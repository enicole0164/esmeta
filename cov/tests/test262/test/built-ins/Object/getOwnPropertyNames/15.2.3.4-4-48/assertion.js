...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', '1', '2', 'length', 'ownProperty'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "ownProperty")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"], "ownProperty", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["p"], "4");
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['0', '1', '2', '3', '4', 'length'], globalThis["result"]);
