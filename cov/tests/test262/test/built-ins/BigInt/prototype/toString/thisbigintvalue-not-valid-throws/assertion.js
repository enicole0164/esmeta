...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['valueOf', 'toString', Symbol.toPrimitive], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["toString"]), true);
$assert.callable(globalThis["obj"]?.["toString"]);
$assert.constructable(globalThis["obj"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["obj"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["obj"]?.["toString"]);
$verifyProperty(globalThis["obj"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["obj"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["obj"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["obj"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["obj"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["obj"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["valueOf"]), true);
$assert.callable(globalThis["obj"]?.["valueOf"]);
$assert.constructable(globalThis["obj"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["obj"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["obj"]?.["valueOf"]);
$verifyProperty(globalThis["obj"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["toString"], BigInt.prototype.toString);
