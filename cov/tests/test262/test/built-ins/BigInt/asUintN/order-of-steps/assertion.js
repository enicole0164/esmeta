...
$assert.sameValue($Object_getPrototypeOf(globalThis["bigint"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bigint"]), true);
$assert.notCallable(globalThis["bigint"]);
$assert.notConstructable(globalThis["bigint"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bigint"]), ['valueOf'], globalThis["bigint"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["bigint"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bigint"]?.["valueOf"]), true);
$assert.callable(globalThis["bigint"]?.["valueOf"]);
$assert.notConstructable(globalThis["bigint"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bigint"]?.["valueOf"]), ['length', 'name'], globalThis["bigint"]?.["valueOf"]);
$verifyProperty(globalThis["bigint"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bigint"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bigint"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["bits"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bits"]), true);
$assert.notCallable(globalThis["bits"]);
$assert.notConstructable(globalThis["bits"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bits"]), ['valueOf'], globalThis["bits"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["bits"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bits"]?.["valueOf"]), true);
$assert.callable(globalThis["bits"]?.["valueOf"]);
$assert.notConstructable(globalThis["bits"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bits"]?.["valueOf"]), ['length', 'name'], globalThis["bits"]?.["valueOf"]);
$verifyProperty(globalThis["bits"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bits"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bits"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
