...
$assert.compareArray($Reflect_ownKeys(o), ['valueOf', 'toString'], o);
$assert.sameValue($Object_getPrototypeOf(o?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(o?.["toString"]), true);
$assert.callable(o?.["toString"]);
$assert.constructable(o?.["toString"]);
$assert.compareArray($Reflect_ownKeys(o?.["toString"]), ['length', 'name', 'prototype'], o?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(o?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(o?.["toString"]?.["prototype"]), true);
$assert.notCallable(o?.["toString"]?.["prototype"]);
$assert.notConstructable(o?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(o?.["toString"]?.["prototype"]), ['constructor'], o?.["toString"]?.["prototype"]);
$assert.sameValue(o?.["toString"]?.["prototype"]?.["constructor"], o?.["toString"]);
$verifyProperty(o?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(o?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o, "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(o?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(o?.["valueOf"]), true);
$assert.callable(o?.["valueOf"]);
$assert.constructable(o?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(o?.["valueOf"]), ['length', 'name', 'prototype'], o?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(o?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(o?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(o?.["valueOf"]?.["prototype"]);
$assert.notConstructable(o?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(o?.["valueOf"]?.["prototype"]), ['constructor'], o?.["valueOf"]?.["prototype"]);
$assert.sameValue(o?.["valueOf"]?.["prototype"]?.["constructor"], o?.["valueOf"]);
$verifyProperty(o?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(o?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o, "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
