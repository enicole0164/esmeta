...
$assert.sameValue($Object_getPrototypeOf(globalThis["dynaString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["dynaString"]), true);
$assert.callable(globalThis["dynaString"]);
$assert.constructable(globalThis["dynaString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dynaString"]), ['length', 'name', 'prototype'], globalThis["dynaString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["dynaString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["dynaString"]?.["prototype"]), true);
$assert.notCallable(globalThis["dynaString"]?.["prototype"]);
$assert.notConstructable(globalThis["dynaString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dynaString"]?.["prototype"]), ['constructor'], globalThis["dynaString"]?.["prototype"]);
$assert.sameValue(globalThis["dynaString"]?.["prototype"]?.["constructor"], globalThis["dynaString"]);
$verifyProperty(globalThis["dynaString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["dynaString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["dynaString"], "name", {
  value: "dynaString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["dynaString"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
