...
$assert.sameValue($Object_getPrototypeOf(globalThis["poisoned"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisoned"]), true);
$assert.notCallable(globalThis["poisoned"]);
$assert.notConstructable(globalThis["poisoned"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisoned"]), ['valueOf'], globalThis["poisoned"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["poisoned"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisoned"]?.["valueOf"]), true);
$assert.callable(globalThis["poisoned"]?.["valueOf"]);
$assert.notConstructable(globalThis["poisoned"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisoned"]?.["valueOf"]), ['length', 'name'], globalThis["poisoned"]?.["valueOf"]);
$verifyProperty(globalThis["poisoned"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisoned"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisoned"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
