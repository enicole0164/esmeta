...
$assert.compareArray($Reflect_ownKeys(globalThis["s1"]), ['x', 'toString'], globalThis["s1"]);
$assert.sameValue(globalThis["s1"]?.["toString"], Number.prototype.toString);
$verifyProperty(globalThis["s1"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["s2"]), ['x', 'myToString'], globalThis["s2"]);
...
$assert.sameValue(globalThis["s2"]?.["myToString"], Number.prototype.toString);
$verifyProperty(globalThis["s2"], "myToString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
