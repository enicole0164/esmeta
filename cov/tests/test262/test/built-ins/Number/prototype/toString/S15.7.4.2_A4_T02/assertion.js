...
$assert.sameValue($Object_getPrototypeOf(globalThis["s1"]), Boolean.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["s1"]), ['toString'], globalThis["s1"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["s2"]), Boolean.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["s2"]), ['myToString'], globalThis["s2"]);
