...
$assert.sameValue($Object_getPrototypeOf(globalThis["fd1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fd1"]), true);
$assert.notCallable(globalThis["fd1"]);
$assert.notConstructable(globalThis["fd1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fd1"]), ['valueOf'], globalThis["fd1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fd1"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fd1"]?.["valueOf"]), true);
$assert.callable(globalThis["fd1"]?.["valueOf"]);
$assert.constructable(globalThis["fd1"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fd1"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["fd1"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fd1"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fd1"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["fd1"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["fd1"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fd1"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["fd1"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["fd1"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["fd1"]?.["valueOf"]);
$verifyProperty(globalThis["fd1"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fd1"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fd1"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fd1"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fd1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fd2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fd2"]), true);
$assert.notCallable(globalThis["fd2"]);
$assert.notConstructable(globalThis["fd2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fd2"]), ['toString'], globalThis["fd2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fd2"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fd2"]?.["toString"]), true);
$assert.callable(globalThis["fd2"]?.["toString"]);
$assert.constructable(globalThis["fd2"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fd2"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["fd2"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fd2"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fd2"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["fd2"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["fd2"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fd2"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["fd2"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["fd2"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["fd2"]?.["toString"]);
$verifyProperty(globalThis["fd2"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fd2"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fd2"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fd2"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fd2"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
