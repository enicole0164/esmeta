...
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]), ['valueOf'], globalThis["p1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p1"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p1"]?.["valueOf"]), true);
$assert.callable(globalThis["p1"]?.["valueOf"]);
$assert.constructable(globalThis["p1"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["p1"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p1"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p1"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["p1"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["p1"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p1"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["p1"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["p1"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["p1"]?.["valueOf"]);
$verifyProperty(globalThis["p1"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["p1"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]), ['toString'], globalThis["p2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p2"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p2"]?.["toString"]), true);
$assert.callable(globalThis["p2"]?.["toString"]);
$assert.constructable(globalThis["p2"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["p2"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p2"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p2"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["p2"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["p2"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p2"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["p2"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["p2"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["p2"]?.["toString"]);
$verifyProperty(globalThis["p2"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["p2"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p2"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
