...
$assert.sameValue($Object_getPrototypeOf(globalThis["n"]), Number.prototype);
$assert.sameValue(Object.isExtensible(globalThis["n"]), true);
$assert.notCallable(globalThis["n"]);
$assert.notConstructable(globalThis["n"]);
$assert.compareArray($Reflect_ownKeys(globalThis["n"]), [], globalThis["n"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["p"]), ['valueOf'], globalThis["p"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p"]?.["valueOf"]), true);
$assert.callable(globalThis["p"]?.["valueOf"]);
$assert.constructable(globalThis["p"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["p"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["p"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["p"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["p"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["p"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["p"]?.["valueOf"]);
$verifyProperty(globalThis["p"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["p"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
