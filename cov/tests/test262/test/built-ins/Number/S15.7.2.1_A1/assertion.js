...
$assert.sameValue($Object_getPrototypeOf(globalThis["x3"]), Number.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["x4"]), Number.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["x7"]), Number.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["x8"]), Number.prototype);
