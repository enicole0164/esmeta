...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]), WeakSet.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), [], globalThis["a"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["b"]), WeakSet.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["c"]), WeakSet.prototype);
