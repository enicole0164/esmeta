...
$assert.sameValue($Object_getPrototypeOf(globalThis["weakset"]), WeakSet.prototype);
$assert.sameValue(Object.isExtensible(globalThis["weakset"]), true);
$assert.notCallable(globalThis["weakset"]);
$assert.notConstructable(globalThis["weakset"]);
$assert.compareArray($Reflect_ownKeys(globalThis["weakset"]), [], globalThis["weakset"]);
