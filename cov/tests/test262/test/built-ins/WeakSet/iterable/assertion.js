...
$assert.sameValue(globalThis["add"], WeakSet.prototype.add);
$assert.sameValue($Object_getPrototypeOf(globalThis["added"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["added"]), true);
$assert.notCallable(globalThis["added"]);
$assert.notConstructable(globalThis["added"]);
$assert.compareArray($Reflect_ownKeys(globalThis["added"]), ['0', '1', 'length'], globalThis["added"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["added"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["added"]?.["1"]), true);
$assert.notCallable(globalThis["added"]?.["1"]);
$assert.notConstructable(globalThis["added"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["added"]?.["1"]), [], globalThis["added"]?.["1"]);
$verifyProperty(globalThis["added"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["added"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["added"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["added"]?.["0"]), true);
$assert.notCallable(globalThis["added"]?.["0"]);
$assert.notConstructable(globalThis["added"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["added"]?.["0"]), [], globalThis["added"]?.["0"]);
$verifyProperty(globalThis["added"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["first"], globalThis["added"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["s"]), WeakSet.prototype);
...
$assert.sameValue(globalThis["second"], globalThis["added"]?.["1"]);
