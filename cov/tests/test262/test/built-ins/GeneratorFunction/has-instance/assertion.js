...
$assert.sameValue($Object_getPrototypeOf(globalThis["gDecl"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gDecl"]), true);
$assert.callable(globalThis["gDecl"]);
$assert.notConstructable(globalThis["gDecl"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gDecl"]), ['length', 'name', 'prototype'], globalThis["gDecl"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gDecl"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gDecl"]?.["prototype"]), true);
$assert.notCallable(globalThis["gDecl"]?.["prototype"]);
$assert.notConstructable(globalThis["gDecl"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gDecl"]?.["prototype"]), [], globalThis["gDecl"]?.["prototype"]);
$verifyProperty(globalThis["gDecl"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["gDecl"], "name", {
  value: "gDecl",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["gDecl"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["gExpr"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gExpr"]), true);
$assert.callable(globalThis["gExpr"]);
$assert.notConstructable(globalThis["gExpr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gExpr"]), ['length', 'name', 'prototype'], globalThis["gExpr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gExpr"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gExpr"]?.["prototype"]), true);
$assert.notCallable(globalThis["gExpr"]?.["prototype"]);
$assert.notConstructable(globalThis["gExpr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gExpr"]?.["prototype"]), [], globalThis["gExpr"]?.["prototype"]);
$verifyProperty(globalThis["gExpr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["gExpr"], "name", {
  value: "gExpr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["gExpr"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
