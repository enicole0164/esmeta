...
$assert.sameValue(globalThis["AsyncGeneratorFunction"], AsyncGeneratorFunction);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["agDecl"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["agDecl"]), true);
$assert.callable(globalThis["agDecl"]);
$assert.notConstructable(globalThis["agDecl"]);
$assert.compareArray($Reflect_ownKeys(globalThis["agDecl"]), ['length', 'name', 'prototype'], globalThis["agDecl"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["agDecl"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["agDecl"]?.["prototype"]), true);
$assert.notCallable(globalThis["agDecl"]?.["prototype"]);
$assert.notConstructable(globalThis["agDecl"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["agDecl"]?.["prototype"]), [], globalThis["agDecl"]?.["prototype"]);
$verifyProperty(globalThis["agDecl"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["agDecl"], "name", {
  value: "agDecl",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["agDecl"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["agExpr"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["agExpr"]), true);
$assert.callable(globalThis["agExpr"]);
$assert.notConstructable(globalThis["agExpr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["agExpr"]), ['length', 'name', 'prototype'], globalThis["agExpr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["agExpr"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["agExpr"]?.["prototype"]), true);
$assert.notCallable(globalThis["agExpr"]?.["prototype"]);
$assert.notConstructable(globalThis["agExpr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["agExpr"]?.["prototype"]), [], globalThis["agExpr"]?.["prototype"]);
$verifyProperty(globalThis["agExpr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["agExpr"], "name", {
  value: "agExpr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["agExpr"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
