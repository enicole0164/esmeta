...
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["instance"]), true);
$assert.callable(globalThis["instance"]);
$assert.notConstructable(globalThis["instance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]), ['length', 'name', 'prototype'], globalThis["instance"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["instance"]?.["prototype"]), true);
$assert.notCallable(globalThis["instance"]?.["prototype"]);
$assert.notConstructable(globalThis["instance"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]?.["prototype"]), [], globalThis["instance"]?.["prototype"]);
$verifyProperty(globalThis["instance"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
