...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['length', 'NaN'], globalThis["x"]);
$verifyProperty(globalThis["x"], "NaN", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), ['length', 'Infinity'], globalThis["y"]);
$verifyProperty(globalThis["y"], "Infinity", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), ['length', '-Infinity'], globalThis["z"]);
$verifyProperty(globalThis["z"], "-Infinity", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
