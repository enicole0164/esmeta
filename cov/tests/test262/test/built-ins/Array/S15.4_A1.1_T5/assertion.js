...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['length', 'null'], globalThis["x"]);
$verifyProperty(globalThis["x"], "null", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), ['length', 'undefined'], globalThis["y"]);
$verifyProperty(globalThis["y"], "undefined", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
