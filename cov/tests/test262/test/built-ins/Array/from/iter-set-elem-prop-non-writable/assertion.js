...
$assert.sameValue($Object_getPrototypeOf(globalThis["items"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["items"]), true);
$assert.callable(globalThis["items"]);
$assert.notConstructable(globalThis["items"]);
$assert.compareArray($Reflect_ownKeys(globalThis["items"]), ['length', 'name', 'prototype'], globalThis["items"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["items"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["items"]?.["prototype"]), true);
$assert.notCallable(globalThis["items"]?.["prototype"]);
$assert.notConstructable(globalThis["items"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["items"]?.["prototype"]), [], globalThis["items"]?.["prototype"]);
$verifyProperty(globalThis["items"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["items"], "name", {
  value: "items",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["res"]), globalThis["A"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["res"]), true);
$assert.notCallable(globalThis["res"]);
$assert.notConstructable(globalThis["res"]);
$assert.compareArray($Reflect_ownKeys(globalThis["res"]), ['length'], globalThis["res"]);
$verifyProperty(globalThis["res"], "length", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
