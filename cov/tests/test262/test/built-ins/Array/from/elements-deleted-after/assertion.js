...
$assert.sameValue(globalThis["arrayIndex"], 2.0);
...
$assert.sameValue(globalThis["j"], 3.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["originalArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["originalArray"]), true);
$assert.notCallable(globalThis["originalArray"]);
$assert.notConstructable(globalThis["originalArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["originalArray"]), ['0', '1', '2', '3', '4', '5', 'length'], globalThis["originalArray"]);
$verifyProperty(globalThis["originalArray"], "4", {
  value: -8.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["originalArray"], "2", {
  value: -2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["originalArray"], "length", {
  value: 6.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["originalArray"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["originalArray"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["originalArray"], "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["originalArray"], "5", {
  value: 16.0,
  writable: true,
  enumerable: true,
  configurable: true,
