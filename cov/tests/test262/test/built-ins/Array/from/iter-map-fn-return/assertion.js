...
$assert.sameValue($Object_getPrototypeOf(globalThis["firstReturnVal"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["firstReturnVal"]), true);
$assert.notCallable(globalThis["firstReturnVal"]);
$assert.notConstructable(globalThis["firstReturnVal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["firstReturnVal"]), [], globalThis["firstReturnVal"]);
...
$assert.sameValue(globalThis["nextNextReturnVal"], null);
...
$assert.sameValue(globalThis["nextReturnVal"], null);
...
$assert.sameValue(globalThis["result"]?.["0"], globalThis["firstReturnVal"]);
$verifyProperty(globalThis["result"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["secondReturnVal"], globalThis["result"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVals"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVals"]), true);
$assert.notCallable(globalThis["thisVals"]);
$assert.notConstructable(globalThis["thisVals"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVals"]), ['length'], globalThis["thisVals"]);
$verifyProperty(globalThis["thisVals"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
