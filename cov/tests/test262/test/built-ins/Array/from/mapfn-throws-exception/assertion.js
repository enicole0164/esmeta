...
$assert.sameValue($Object_getPrototypeOf(globalThis["mapFnThrows"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mapFnThrows"]), true);
$assert.callable(globalThis["mapFnThrows"]);
$assert.constructable(globalThis["mapFnThrows"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mapFnThrows"]), ['length', 'name', 'prototype'], globalThis["mapFnThrows"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["mapFnThrows"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mapFnThrows"]?.["prototype"]), true);
$assert.notCallable(globalThis["mapFnThrows"]?.["prototype"]);
$assert.notConstructable(globalThis["mapFnThrows"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mapFnThrows"]?.["prototype"]), ['constructor'], globalThis["mapFnThrows"]?.["prototype"]);
$assert.sameValue(globalThis["mapFnThrows"]?.["prototype"]?.["constructor"], globalThis["mapFnThrows"]);
$verifyProperty(globalThis["mapFnThrows"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["mapFnThrows"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["mapFnThrows"], "name", {
  value: "mapFnThrows",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["mapFnThrows"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
