...
$assert.sameValue($Object_getPrototypeOf(globalThis["calls"]?.["1"]?.["thisArg"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["calls"]?.["1"]?.["thisArg"]), true);
$assert.notCallable(globalThis["calls"]?.["1"]?.["thisArg"]);
$assert.notConstructable(globalThis["calls"]?.["1"]?.["thisArg"]);
$assert.compareArray($Reflect_ownKeys(globalThis["calls"]?.["1"]?.["thisArg"]), [], globalThis["calls"]?.["1"]?.["thisArg"]);
...
$assert.sameValue(globalThis["calls"]?.["2"]?.["thisArg"], globalThis["calls"]?.["1"]?.["thisArg"]);
...
$assert.sameValue(globalThis["calls"]?.["0"]?.["thisArg"], globalThis["calls"]?.["1"]?.["thisArg"]);
...
$assert.sameValue(globalThis["thisArg"], globalThis["calls"]?.["1"]?.["thisArg"]);
