...
$assert.sameValue(globalThis["closeCount"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["constructorSetsIndex0ConfigurableFalse"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["constructorSetsIndex0ConfigurableFalse"]), true);
$assert.callable(globalThis["constructorSetsIndex0ConfigurableFalse"]);
$assert.constructable(globalThis["constructorSetsIndex0ConfigurableFalse"]);
$assert.compareArray($Reflect_ownKeys(globalThis["constructorSetsIndex0ConfigurableFalse"]), ['length', 'name', 'prototype'], globalThis["constructorSetsIndex0ConfigurableFalse"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]), true);
$assert.notCallable(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]);
$assert.notConstructable(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]), ['constructor'], globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]);
$assert.sameValue(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"]?.["constructor"], globalThis["constructorSetsIndex0ConfigurableFalse"]);
$verifyProperty(globalThis["constructorSetsIndex0ConfigurableFalse"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["constructorSetsIndex0ConfigurableFalse"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["constructorSetsIndex0ConfigurableFalse"], "name", {
  value: "constructorSetsIndex0ConfigurableFalse",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["constructorSetsIndex0ConfigurableFalse"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
