...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]), Number.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["array"]), ['0', '1', '3', 'length'], globalThis["array"]);
