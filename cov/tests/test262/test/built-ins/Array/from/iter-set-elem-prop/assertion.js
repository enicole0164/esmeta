...
$assert.sameValue($Object_getPrototypeOf(globalThis["firstIterResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["firstIterResult"]), true);
$assert.notCallable(globalThis["firstIterResult"]);
$assert.notConstructable(globalThis["firstIterResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["firstIterResult"]), ['done', 'value'], globalThis["firstIterResult"]);
$verifyProperty(globalThis["firstIterResult"], "done", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["firstIterResult"]?.["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["firstIterResult"]?.["value"]), true);
$assert.notCallable(globalThis["firstIterResult"]?.["value"]);
$assert.notConstructable(globalThis["firstIterResult"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["firstIterResult"]?.["value"]), [], globalThis["firstIterResult"]?.["value"]);
$verifyProperty(globalThis["firstIterResult"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["nextIterResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nextIterResult"]), true);
$assert.notCallable(globalThis["nextIterResult"]);
$assert.notConstructable(globalThis["nextIterResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nextIterResult"]), ['done', 'value'], globalThis["nextIterResult"]);
$verifyProperty(globalThis["nextIterResult"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["nextIterResult"]?.["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nextIterResult"]?.["value"]), true);
$assert.notCallable(globalThis["nextIterResult"]?.["value"]);
$assert.notConstructable(globalThis["nextIterResult"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nextIterResult"]?.["value"]), [], globalThis["nextIterResult"]?.["value"]);
$verifyProperty(globalThis["nextIterResult"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["nextNextIterResult"], globalThis["nextIterResult"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['0', '1', 'length'], globalThis["result"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["1"]), true);
$assert.notCallable(globalThis["result"]?.["1"]);
$assert.notConstructable(globalThis["result"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["1"]), [], globalThis["result"]?.["1"]);
...
$assert.sameValue(globalThis["result"]?.["0"], globalThis["firstIterResult"]?.["value"]);
$verifyProperty(globalThis["result"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["secondIterResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["secondIterResult"]), true);
$assert.notCallable(globalThis["secondIterResult"]);
$assert.notConstructable(globalThis["secondIterResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["secondIterResult"]), ['done', 'value'], globalThis["secondIterResult"]);
$verifyProperty(globalThis["secondIterResult"], "done", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["secondIterResult"]?.["value"], globalThis["result"]?.["1"]);
$verifyProperty(globalThis["secondIterResult"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thirdIterResult"], globalThis["nextIterResult"]);
