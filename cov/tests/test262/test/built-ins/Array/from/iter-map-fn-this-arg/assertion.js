...
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]), true);
$assert.notCallable(globalThis["thisVal"]);
$assert.notConstructable(globalThis["thisVal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]), [], globalThis["thisVal"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["thisVals"]), ['0', '1', 'length'], globalThis["thisVals"]);
$assert.sameValue(globalThis["thisVals"]?.["1"], globalThis["thisVal"]);
$verifyProperty(globalThis["thisVals"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["thisVals"]?.["0"], globalThis["thisVal"]);
$verifyProperty(globalThis["thisVals"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
