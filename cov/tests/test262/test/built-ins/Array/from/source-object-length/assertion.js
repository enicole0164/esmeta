...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['0', '1', '2', '3', 'length'], globalThis["a"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["array"]), ['0', '1', '2', '3', 'length'], globalThis["array"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["expectedArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["expectedArray"]), true);
$assert.notCallable(globalThis["expectedArray"]);
$assert.notConstructable(globalThis["expectedArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["expectedArray"]), ['0', '1', '3', 'length'], globalThis["expectedArray"]);
$verifyProperty(globalThis["expectedArray"], "1", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["expectedArray"], "3", {
  value: 16.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["expectedArray"], "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["expectedArray"], "0", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["j"], 4.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', '3', 'length'], globalThis["obj"]);
