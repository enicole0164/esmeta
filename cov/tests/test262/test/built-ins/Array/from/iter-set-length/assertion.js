...
$assert.sameValue($Object_getPrototypeOf(globalThis["lastIterResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["lastIterResult"]), true);
$assert.notCallable(globalThis["lastIterResult"]);
$assert.notConstructable(globalThis["lastIterResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["lastIterResult"]), ['done'], globalThis["lastIterResult"]);
$verifyProperty(globalThis["lastIterResult"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["nextIterResult"], globalThis["lastIterResult"]);
