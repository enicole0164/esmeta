...
$assert.sameValue($Object_getPrototypeOf(globalThis["args"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["args"]), ['0', '1', 'length'], globalThis["args"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["args"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["args"]?.["1"]), true);
$assert.notCallable(globalThis["args"]?.["1"]);
$assert.notConstructable(globalThis["args"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["args"]?.["1"]), ['0', '1', 'length', 'callee', Symbol.iterator], globalThis["args"]?.["1"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["args"]?.["1"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["args"]?.["1"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["args"]?.["1"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["args"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["args"]?.["1"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["args"]?.["1"]?.["0"]), true);
$assert.notCallable(globalThis["args"]?.["1"]?.["0"]);
$assert.notConstructable(globalThis["args"]?.["1"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["args"]?.["1"]?.["0"]), [], globalThis["args"]?.["1"]?.["0"]);
$verifyProperty(globalThis["args"]?.["1"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["args"]?.["1"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["args"]?.["1"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["args"]?.["1"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["args"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["args"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["args"]?.["0"]), true);
$assert.notCallable(globalThis["args"]?.["0"]);
$assert.notConstructable(globalThis["args"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["args"]?.["0"]), ['0', '1', 'length', 'callee', Symbol.iterator], globalThis["args"]?.["0"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["args"]?.["0"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["args"]?.["0"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["args"]?.["0"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["args"]?.["0"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["args"]?.["0"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["args"]?.["0"]?.["0"]), true);
$assert.notCallable(globalThis["args"]?.["0"]?.["0"]);
$assert.notConstructable(globalThis["args"]?.["0"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["args"]?.["0"]?.["0"]), [], globalThis["args"]?.["0"]?.["0"]);
$verifyProperty(globalThis["args"]?.["0"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["args"]?.["0"], "1", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["args"]?.["0"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["args"]?.["0"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["args"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["firstResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["firstResult"]), true);
$assert.notCallable(globalThis["firstResult"]);
$assert.notConstructable(globalThis["firstResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["firstResult"]), ['done', 'value'], globalThis["firstResult"]);
$verifyProperty(globalThis["firstResult"], "done", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["firstResult"]?.["value"], globalThis["args"]?.["0"]?.["0"]);
$verifyProperty(globalThis["firstResult"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["items"]), [Symbol.iterator], globalThis["items"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["items"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["items"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["items"]?.[Symbol.iterator]);
$assert.constructable(globalThis["items"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["items"]?.[Symbol.iterator]), ['length', 'name', 'prototype'], globalThis["items"]?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(globalThis["items"]?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["items"]?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(globalThis["items"]?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(globalThis["items"]?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["items"]?.[Symbol.iterator]?.["prototype"]), ['constructor'], globalThis["items"]?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(globalThis["items"]?.[Symbol.iterator]?.["prototype"]?.["constructor"], globalThis["items"]?.[Symbol.iterator]);
$verifyProperty(globalThis["items"]?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["items"]?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["items"]?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["items"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["items"], Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["nextNextResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nextNextResult"]), true);
$assert.notCallable(globalThis["nextNextResult"]);
$assert.notConstructable(globalThis["nextNextResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nextNextResult"]), ['done'], globalThis["nextNextResult"]);
$verifyProperty(globalThis["nextNextResult"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["nextResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["nextResult"]), true);
$assert.notCallable(globalThis["nextResult"]);
$assert.notConstructable(globalThis["nextResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["nextResult"]), ['done'], globalThis["nextResult"]);
$verifyProperty(globalThis["nextResult"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["secondResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["secondResult"]), true);
$assert.notCallable(globalThis["secondResult"]);
$assert.notConstructable(globalThis["secondResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["secondResult"]), ['done', 'value'], globalThis["secondResult"]);
$verifyProperty(globalThis["secondResult"], "done", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["secondResult"]?.["value"], globalThis["args"]?.["1"]?.["0"]);
$verifyProperty(globalThis["secondResult"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
