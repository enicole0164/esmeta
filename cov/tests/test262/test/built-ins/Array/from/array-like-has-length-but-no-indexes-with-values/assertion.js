...
$assert.sameValue(length, 5.0);
$assert.sameValue($Object_getPrototypeOf(newlyCreatedAndMappedArray), Array.prototype);
$assert.sameValue(Object.isExtensible(newlyCreatedAndMappedArray), true);
$assert.notCallable(newlyCreatedAndMappedArray);
$assert.notConstructable(newlyCreatedAndMappedArray);
$assert.compareArray($Reflect_ownKeys(newlyCreatedAndMappedArray), ['0', '1', '2', '3', '4', 'length'], newlyCreatedAndMappedArray);
$verifyProperty(newlyCreatedAndMappedArray, "4", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedAndMappedArray, "2", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedAndMappedArray, "length", {
  value: 5.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(newlyCreatedAndMappedArray, "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedAndMappedArray, "3", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedAndMappedArray, "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(newlyCreatedArray), Array.prototype);
$assert.sameValue(Object.isExtensible(newlyCreatedArray), true);
$assert.notCallable(newlyCreatedArray);
$assert.notConstructable(newlyCreatedArray);
$assert.compareArray($Reflect_ownKeys(newlyCreatedArray), ['0', '1', '2', '3', '4', 'length'], newlyCreatedArray);
$verifyProperty(newlyCreatedArray, "4", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedArray, "2", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedArray, "length", {
  value: 5.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(newlyCreatedArray, "1", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedArray, "3", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(newlyCreatedArray, "0", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
