...
$assert.sameValue($Object_getPrototypeOf(globalThis["a2"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["a2"]), ['0', '1', '2', '3', 'length'], globalThis["a2"]);
$verifyProperty(globalThis["a2"], "2", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["a2"], "1", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a2"], "3", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["a3"]), Array.prototype);
