...
$assert.sameValue($Object_getPrototypeOf(globalThis["T1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["T1"]), true);
$assert.callable(globalThis["T1"]);
$assert.constructable(globalThis["T1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["T1"]), ['length', 'name', 'prototype'], globalThis["T1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["T1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["T1"]?.["prototype"]), true);
$assert.notCallable(globalThis["T1"]?.["prototype"]);
$assert.notConstructable(globalThis["T1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["T1"]?.["prototype"]), ['constructor'], globalThis["T1"]?.["prototype"]);
$assert.sameValue(globalThis["T1"]?.["prototype"]?.["constructor"], globalThis["T1"]);
$verifyProperty(globalThis["T1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["T1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["T1"], "name", {
  value: "T1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["T1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["T2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["T2"]), true);
$assert.callable(globalThis["T2"]);
$assert.constructable(globalThis["T2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["T2"]), ['length', 'name', 'prototype'], globalThis["T2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["T2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["T2"]?.["prototype"]), true);
$assert.notCallable(globalThis["T2"]?.["prototype"]);
$assert.notConstructable(globalThis["T2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["T2"]?.["prototype"]), ['constructor'], globalThis["T2"]?.["prototype"]);
$assert.sameValue(globalThis["T2"]?.["prototype"]?.["constructor"], globalThis["T2"]);
$verifyProperty(globalThis["T2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["T2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["T2"], "name", {
  value: "T2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["T2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
