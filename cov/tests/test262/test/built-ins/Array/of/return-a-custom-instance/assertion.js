...
$assert.sameValue($Object_getPrototypeOf(globalThis["Coop"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Coop"]), true);
$assert.callable(globalThis["Coop"]);
$assert.constructable(globalThis["Coop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Coop"]), ['length', 'name', 'prototype'], globalThis["Coop"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Coop"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Coop"]?.["prototype"]), true);
$assert.notCallable(globalThis["Coop"]?.["prototype"]);
$assert.notConstructable(globalThis["Coop"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Coop"]?.["prototype"]), ['constructor'], globalThis["Coop"]?.["prototype"]);
$assert.sameValue(globalThis["Coop"]?.["prototype"]?.["constructor"], globalThis["Coop"]);
$verifyProperty(globalThis["Coop"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Coop"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Coop"], "name", {
  value: "Coop",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Coop"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["coop"]), globalThis["Coop"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["coop"]), true);
$assert.notCallable(globalThis["coop"]);
$assert.notConstructable(globalThis["coop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["coop"]), ['0', '1', '2', 'length'], globalThis["coop"]);
$verifyProperty(globalThis["coop"], "1", {
  value: "Rick",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["coop"], "2", {
  value: "Leo",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["coop"], "0", {
  value: "Mike",
  writable: true,
  enumerable: true,
  configurable: true,
