...
$assert.sameValue($Object_getPrototypeOf(globalThis["Custom"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Custom"]), true);
$assert.callable(globalThis["Custom"]);
$assert.constructable(globalThis["Custom"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Custom"]), ['length', 'name', 'prototype'], globalThis["Custom"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Custom"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Custom"]?.["prototype"]), true);
$assert.notCallable(globalThis["Custom"]?.["prototype"]);
$assert.notConstructable(globalThis["Custom"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Custom"]?.["prototype"]), ['0', 'constructor'], globalThis["Custom"]?.["prototype"]);
$assert.sameValue(globalThis["Custom"]?.["prototype"]?.["constructor"], globalThis["Custom"]);
$verifyProperty(globalThis["Custom"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Custom"]?.["prototype"], "0")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Custom"]?.["prototype"], "0", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Custom"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Custom"], "name", {
  value: "Custom",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Custom"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]), globalThis["Custom"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["custom"]), true);
$assert.notCallable(globalThis["custom"]);
$assert.notConstructable(globalThis["custom"]);
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]), ['0', 'length'], globalThis["custom"]);
$verifyProperty(globalThis["custom"], "length", {
  value: 1.0,
  writable: true,
  enumerable: true,
...
$verifyProperty(globalThis["custom"], "0", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
