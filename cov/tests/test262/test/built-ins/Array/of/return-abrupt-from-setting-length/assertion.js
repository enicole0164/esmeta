...
$assert.sameValue($Object_getPrototypeOf(globalThis["T"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["T"]), true);
$assert.callable(globalThis["T"]);
$assert.constructable(globalThis["T"]);
$assert.compareArray($Reflect_ownKeys(globalThis["T"]), ['length', 'name', 'prototype'], globalThis["T"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["T"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["T"]?.["prototype"]), true);
$assert.notCallable(globalThis["T"]?.["prototype"]);
$assert.notConstructable(globalThis["T"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["T"]?.["prototype"]), ['constructor'], globalThis["T"]?.["prototype"]);
$assert.sameValue(globalThis["T"]?.["prototype"]?.["constructor"], globalThis["T"]);
$verifyProperty(globalThis["T"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["T"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["T"], "name", {
  value: "T",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["T"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
