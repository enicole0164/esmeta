...
$assert.sameValue($Object_getPrototypeOf(globalThis["Pack"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Pack"]), true);
$assert.callable(globalThis["Pack"]);
$assert.constructable(globalThis["Pack"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Pack"]), ['length', 'name', 'prototype'], globalThis["Pack"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Pack"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Pack"]?.["prototype"]), true);
$assert.notCallable(globalThis["Pack"]?.["prototype"]);
$assert.notConstructable(globalThis["Pack"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Pack"]?.["prototype"]), ['constructor'], globalThis["Pack"]?.["prototype"]);
$assert.sameValue(globalThis["Pack"]?.["prototype"]?.["constructor"], globalThis["Pack"]);
$verifyProperty(globalThis["Pack"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Pack"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Pack"], "name", {
  value: "Pack",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Pack"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["_this_"]), globalThis["Pack"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["_this_"]), true);
$assert.notCallable(globalThis["_this_"]);
$assert.notConstructable(globalThis["_this_"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_this_"]), ['0', '1', '2', '3', 'length'], globalThis["_this_"]);
$verifyProperty(globalThis["_this_"], "2", {
  value: "cigarettes",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["_this_"], "length")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["_this_"], "length", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["_this_"], "1", {
  value: "cards",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["_this_"], "3", {
  value: "lies",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["_this_"], "0", {
  value: "wolves",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["hits"], 1.0);
$assert.sameValue(globalThis["result"], globalThis["_this_"]);
$assert.sameValue(globalThis["value"], 4.0);
