...
$assert.sameValue(globalThis["Con"]?.["prototype"], Array.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]), Array.prototype);
...
$assert.sameValue(globalThis["proto"], Array.prototype);
