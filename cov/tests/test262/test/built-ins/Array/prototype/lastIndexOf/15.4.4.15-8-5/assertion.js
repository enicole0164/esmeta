...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["2"]), true);
$assert.notCallable(globalThis["a"]?.["2"]);
$assert.notConstructable(globalThis["a"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["2"]), ['toString'], globalThis["a"]?.["2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["2"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["2"]?.["toString"]), true);
$assert.callable(globalThis["a"]?.["2"]?.["toString"]);
$assert.constructable(globalThis["a"]?.["2"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["2"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["a"]?.["2"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["2"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["2"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["a"]?.["2"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["a"]?.["2"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["2"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["a"]?.["2"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["a"]?.["2"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["a"]?.["2"]?.["toString"]);
$verifyProperty(globalThis["a"]?.["2"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["2"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["2"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["2"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["2"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["8"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["8"]), true);
$assert.notCallable(globalThis["a"]?.["8"]);
$assert.notConstructable(globalThis["a"]?.["8"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["8"]), ['toString'], globalThis["a"]?.["8"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["8"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["8"]?.["toString"]), true);
$assert.callable(globalThis["a"]?.["8"]?.["toString"]);
$assert.constructable(globalThis["a"]?.["8"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["8"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["a"]?.["8"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["8"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["8"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["a"]?.["8"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["a"]?.["8"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["8"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["a"]?.["8"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["a"]?.["8"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["a"]?.["8"]?.["toString"]);
$verifyProperty(globalThis["a"]?.["8"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["8"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["8"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["8"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["8"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["0"]), true);
$assert.notCallable(globalThis["a"]?.["0"]);
$assert.notConstructable(globalThis["a"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["0"]), ['toString'], globalThis["a"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["0"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["0"]?.["toString"]), true);
$assert.callable(globalThis["a"]?.["0"]?.["toString"]);
$assert.constructable(globalThis["a"]?.["0"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["0"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["a"]?.["0"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["0"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["0"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["a"]?.["0"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["a"]?.["0"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["0"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["a"]?.["0"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["a"]?.["0"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["a"]?.["0"]?.["toString"]);
$verifyProperty(globalThis["a"]?.["0"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["0"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["0"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["0"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["0"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["a"]?.["1"], globalThis["a"]?.["2"]);
...
$assert.sameValue(globalThis["obj1"], globalThis["a"]?.["2"]);
$assert.sameValue(globalThis["obj2"], globalThis["a"]?.["0"]);
$assert.sameValue(globalThis["obj3"], globalThis["a"]?.["2"]);
