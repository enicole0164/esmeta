...
$assert.compareArray($Reflect_ownKeys(globalThis["arrayLike"]), ['length', '9007199254740988'], globalThis["arrayLike"]);
...
$assert.sameValue(globalThis["el"], globalThis["arrayLike"]?.["9007199254740988"]);
$assert.sameValue(globalThis["elIndex"], 9.007199254740988E15);
$assert.sameValue(globalThis["fromIndex"], 9.00719925474099E15);
$assert.sameValue(globalThis["res"], 9.007199254740988E15);
