...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), ['0', 'length'], globalThis["f"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["f"], "0")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"], "0", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
