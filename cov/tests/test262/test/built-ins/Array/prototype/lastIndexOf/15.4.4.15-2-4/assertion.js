...
$assert.sameValue($Object_getPrototypeOf(globalThis["targetObj"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["targetObj"]), true);
$assert.notCallable(globalThis["targetObj"]);
$assert.notConstructable(globalThis["targetObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["targetObj"]), [], globalThis["targetObj"]);
