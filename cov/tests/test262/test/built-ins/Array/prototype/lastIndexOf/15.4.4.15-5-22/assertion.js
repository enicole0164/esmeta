...
$assert.sameValue($Object_getPrototypeOf(globalThis["targetObj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["targetObj"]), true);
$assert.callable(globalThis["targetObj"]);
$assert.constructable(globalThis["targetObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["targetObj"]), ['length', 'name', 'prototype'], globalThis["targetObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["targetObj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["targetObj"]?.["prototype"]), true);
$assert.notCallable(globalThis["targetObj"]?.["prototype"]);
$assert.notConstructable(globalThis["targetObj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["targetObj"]?.["prototype"]), ['constructor'], globalThis["targetObj"]?.["prototype"]);
$assert.sameValue(globalThis["targetObj"]?.["prototype"]?.["constructor"], globalThis["targetObj"]);
$verifyProperty(globalThis["targetObj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["targetObj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["targetObj"], "name", {
  value: "targetObj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["targetObj"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
