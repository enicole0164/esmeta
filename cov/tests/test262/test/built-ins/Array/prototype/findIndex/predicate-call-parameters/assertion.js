...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['0', '1', '2', 'length', 'callee', Symbol.iterator], globalThis["result"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["result"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["result"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["result"], "callee", {
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["result"]?.["2"], globalThis["arr"]);
...
$assert.sameValue(globalThis["result"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["result"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]), ['0', '1', '2', 'length', 'callee', Symbol.iterator], globalThis["results"]?.["1"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["results"]?.["1"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["results"]?.["1"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["results"]?.["1"], "callee", {
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["results"]?.["1"]?.["2"], globalThis["arr"]);
$verifyProperty(globalThis["results"]?.["1"], "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["results"]?.["1"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["results"]?.["1"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["results"]?.["2"], globalThis["result"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["0"]), ['0', '1', '2', 'length', 'callee', Symbol.iterator], globalThis["results"]?.["0"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["results"]?.["0"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["results"]?.["0"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["results"]?.["0"], "callee", {
  enumerable: false,
  configurable: false,
});
$assert.sameValue(globalThis["results"]?.["0"]?.["2"], globalThis["arr"]);
$verifyProperty(globalThis["results"]?.["0"], "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["results"]?.["0"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["results"]?.["0"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
