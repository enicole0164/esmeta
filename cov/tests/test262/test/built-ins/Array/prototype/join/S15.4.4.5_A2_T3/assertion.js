...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', '2', 'join', 'length'], globalThis["obj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["length"]), Number.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["length"]), [], globalThis["obj"]?.["length"]);
...
$assert.sameValue(globalThis["x"], globalThis["obj"]?.["length"]);
