...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['join', 'length'], globalThis["obj"]);
...
$assert.sameValue(globalThis["obj"]?.["join"], Array.prototype.join);
$verifyProperty(globalThis["obj"], "join", {
  writable: true,
  enumerable: true,
  configurable: true,
});
