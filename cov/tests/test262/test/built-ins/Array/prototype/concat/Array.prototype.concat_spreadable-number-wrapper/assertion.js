...
$assert.sameValue($Object_getPrototypeOf(globalThis["num"]), Number.prototype);
$assert.sameValue(Object.isExtensible(globalThis["num"]), true);
$assert.notCallable(globalThis["num"]);
$assert.notConstructable(globalThis["num"]);
$assert.compareArray($Reflect_ownKeys(globalThis["num"]), ['0', '1', '2', 'length', Symbol.isConcatSpreadable], globalThis["num"]);
$verifyProperty(globalThis["num"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["num"], "length", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["num"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["num"], Symbol.isConcatSpreadable, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["num"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
