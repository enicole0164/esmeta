...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', '1', '2', '3', '4', '5', '6', 'length', 'getClass'], globalThis["arr"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["0"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["0"]), ['concat'], globalThis["arr"]?.["0"]);
$assert.sameValue(globalThis["arr"]?.["0"]?.["concat"], Array.prototype.concat);
$verifyProperty(globalThis["arr"]?.["0"], "concat", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["1"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["1"]), [], globalThis["arr"]?.["1"]);
...
$assert.sameValue(globalThis["x"], globalThis["arr"]?.["0"]);
$assert.sameValue(globalThis["y"], globalThis["arr"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["z"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), ['0', '1', 'length'], globalThis["z"]);
$verifyProperty(globalThis["z"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
