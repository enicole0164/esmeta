...
$assert.compareArray($Reflect_ownKeys(globalThis["spreadableHasPoisonedIndex"]), ['0', 'length', Symbol.isConcatSpreadable], globalThis["spreadableHasPoisonedIndex"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get, "name", {
  value: "get 0",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spreadableHasPoisonedIndex"], "0")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spreadableHasPoisonedIndex"], "0", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
