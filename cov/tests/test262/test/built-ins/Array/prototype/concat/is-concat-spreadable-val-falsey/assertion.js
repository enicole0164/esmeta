...
$assert.compareArray($Reflect_ownKeys(globalThis["item"]), ['0', '1', 'length', Symbol.isConcatSpreadable], globalThis["item"]);
...
$assert.sameValue(globalThis["result"]?.["0"], globalThis["item"]);
