...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'constructor'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "constructor")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "constructor", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['0', 'length'], globalThis["result"]);
...
$assert.sameValue(globalThis["result"]?.["0"], globalThis["obj"]);
