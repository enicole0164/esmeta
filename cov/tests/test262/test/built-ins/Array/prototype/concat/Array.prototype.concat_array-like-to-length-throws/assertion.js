...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['0', '1', '2', 'length'], globalThis["obj2"]);
$verifyProperty(globalThis["obj2"], "1", {
  value: "1",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj2"], "2", {
  value: "2",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["obj2"], "0", {
  value: "0",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["spreadableWithBrokenLength"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spreadableWithBrokenLength"]), true);
$assert.notCallable(globalThis["spreadableWithBrokenLength"]);
$assert.notConstructable(globalThis["spreadableWithBrokenLength"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spreadableWithBrokenLength"]), ['1', '3', '5', 'length', Symbol.isConcatSpreadable], globalThis["spreadableWithBrokenLength"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spreadableWithBrokenLength"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spreadableWithBrokenLength"]?.["length"]), true);
$assert.notCallable(globalThis["spreadableWithBrokenLength"]?.["length"]);
$assert.notConstructable(globalThis["spreadableWithBrokenLength"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spreadableWithBrokenLength"]?.["length"]), ['valueOf', 'toString'], globalThis["spreadableWithBrokenLength"]?.["length"]);
$verifyProperty(globalThis["spreadableWithBrokenLength"]?.["length"], "toString", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["spreadableWithBrokenLength"]?.["length"], "valueOf", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["spreadableWithBrokenLength"], "length", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["spreadableWithBrokenLength"], "1", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["spreadableWithBrokenLength"], Symbol.isConcatSpreadable, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["spreadableWithBrokenLength"], "3", {
  value: "B",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["spreadableWithBrokenLength"], "5", {
  value: "C",
  writable: true,
  enumerable: true,
  configurable: true,
