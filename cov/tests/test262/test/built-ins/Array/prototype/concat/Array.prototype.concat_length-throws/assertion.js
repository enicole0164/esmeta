...
$assert.sameValue($Object_getPrototypeOf(globalThis["spreadablePoisonedLengthGetter"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spreadablePoisonedLengthGetter"]), true);
$assert.notCallable(globalThis["spreadablePoisonedLengthGetter"]);
$assert.notConstructable(globalThis["spreadablePoisonedLengthGetter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spreadablePoisonedLengthGetter"]), ['length', Symbol.isConcatSpreadable], globalThis["spreadablePoisonedLengthGetter"]);
$verifyProperty(globalThis["spreadablePoisonedLengthGetter"], Symbol.isConcatSpreadable, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spreadablePoisonedLengthGetter"], "length")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spreadablePoisonedLengthGetter"], "length", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
