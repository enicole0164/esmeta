...
$assert.sameValue($Object_getPrototypeOf(globalThis["bool"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bool"]), true);
$assert.notCallable(globalThis["bool"]);
$assert.notConstructable(globalThis["bool"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bool"]), ['0', '1', '2', 'length', Symbol.isConcatSpreadable], globalThis["bool"]);
$verifyProperty(globalThis["bool"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bool"], "length", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bool"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bool"], Symbol.isConcatSpreadable, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bool"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
