...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', '1', '2', '3', '4', 'length', 'getClass'], globalThis["arr"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), ['0', '1', 'length'], globalThis["y"]);
$verifyProperty(globalThis["y"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), ['0', '1', '2', 'length'], globalThis["z"]);
