...
$assert.compareArray($Reflect_ownKeys(globalThis["item"]), [Symbol.isConcatSpreadable], globalThis["item"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["item"]?.[Symbol.isConcatSpreadable]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["item"]?.[Symbol.isConcatSpreadable]), true);
$assert.notCallable(globalThis["item"]?.[Symbol.isConcatSpreadable]);
$assert.notConstructable(globalThis["item"]?.[Symbol.isConcatSpreadable]);
$assert.compareArray($Reflect_ownKeys(globalThis["item"]?.[Symbol.isConcatSpreadable]), [], globalThis["item"]?.[Symbol.isConcatSpreadable]);
$verifyProperty(globalThis["item"], Symbol.isConcatSpreadable, {
  writable: true,
  enumerable: true,
  configurable: true,
});
