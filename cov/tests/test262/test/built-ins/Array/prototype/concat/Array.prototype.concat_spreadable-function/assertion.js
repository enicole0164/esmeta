...
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]), ['0', '1', '2', 'length', 'name', 'prototype', Symbol.isConcatSpreadable], globalThis["fn"]);
...
$verifyProperty(globalThis["fn"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["fn"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["fn"], Symbol.isConcatSpreadable, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
