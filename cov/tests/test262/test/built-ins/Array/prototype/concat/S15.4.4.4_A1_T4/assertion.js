...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['1', 'length', 'getClass'], globalThis["arr"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['1', 'length'], globalThis["x"]);
