...
$assert.sameValue($Object_getPrototypeOf(globalThis["objWithPoisonedLengthToString"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objWithPoisonedLengthToString"]), true);
$assert.notCallable(globalThis["objWithPoisonedLengthToString"]);
$assert.notConstructable(globalThis["objWithPoisonedLengthToString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objWithPoisonedLengthToString"]), ['1', '3', '5', 'length', Symbol.isConcatSpreadable], globalThis["objWithPoisonedLengthToString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["objWithPoisonedLengthToString"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objWithPoisonedLengthToString"]?.["length"]), true);
$assert.notCallable(globalThis["objWithPoisonedLengthToString"]?.["length"]);
$assert.notConstructable(globalThis["objWithPoisonedLengthToString"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objWithPoisonedLengthToString"]?.["length"]), ['toString', 'valueOf'], globalThis["objWithPoisonedLengthToString"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]), true);
$assert.callable(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]);
$assert.constructable(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]);
$verifyProperty(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"]?.["length"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"]?.["length"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"]?.["length"], "valueOf", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"], "length", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"], "1", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"], Symbol.isConcatSpreadable, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"], "3", {
  value: "B",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objWithPoisonedLengthToString"], "5", {
  value: "C",
  writable: true,
  enumerable: true,
  configurable: true,
