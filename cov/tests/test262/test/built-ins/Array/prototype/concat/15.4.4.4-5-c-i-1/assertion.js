...
$assert.sameValue($Object_getPrototypeOf(globalThis["newArrayFromConcat"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newArrayFromConcat"]), true);
$assert.notCallable(globalThis["newArrayFromConcat"]);
$assert.notConstructable(globalThis["newArrayFromConcat"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newArrayFromConcat"]), ['length'], globalThis["newArrayFromConcat"]);
$verifyProperty(globalThis["newArrayFromConcat"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
