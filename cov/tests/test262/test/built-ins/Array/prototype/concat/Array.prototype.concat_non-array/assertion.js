...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['0', '1', '2', '3', 'length'], globalThis["result"]);
...
$assert.sameValue(NonArray, $Object_getPrototypeOf(globalThis["obj"])?.["constructor"]);
