...
$assert.sameValue($Object_getPrototypeOf(globalThis["oldArr"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["oldArr"]), true);
$assert.notCallable(globalThis["oldArr"]);
$assert.notConstructable(globalThis["oldArr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["oldArr"]), ['0', 'length'], globalThis["oldArr"]);
$verifyProperty(globalThis["oldArr"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["oldArr"], "0", {
  value: 101.0,
  writable: true,
  enumerable: true,
  configurable: true,
