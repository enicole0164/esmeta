...
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["length"]), true);
$assert.notCallable(globalThis["arr"]?.["length"]);
$assert.notConstructable(globalThis["arr"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["length"]), [Symbol.toPrimitive], globalThis["arr"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive]);
$assert.notConstructable(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive]), ['length', 'name'], globalThis["arr"]?.["length"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["length"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["length"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
