...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["actual"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["actual"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["actual"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["actual"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["actual"])), ['constructor'], $Object_getPrototypeOf(globalThis["actual"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["actual"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["actual"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["actual"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["actual"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["actual"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["actual"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["actual"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["actual"]));
$verifyProperty($Object_getPrototypeOf(globalThis["actual"])?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["actual"])?.["constructor"], "name", {
  value: "ctor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["actual"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["actual"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["actual"]), [], globalThis["actual"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', '1', 'length', 'constructor'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["1"]), true);
$assert.notCallable(globalThis["arr"]?.["1"]);
$assert.notConstructable(globalThis["arr"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["1"]), ['0', '1', 'length'], globalThis["arr"]?.["1"]);
$verifyProperty(globalThis["arr"]?.["1"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arr"]?.["1"], "0", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get, "name", {
  value: "get [Symbol.species]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"]?.["constructor"], Symbol.species)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["0"]), ['0', '1', 'length'], globalThis["arr"]?.["0"]);
$verifyProperty(globalThis["arr"]?.["0"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["called"], 1.0);
$assert.sameValue(globalThis["ctor"], $Object_getPrototypeOf(globalThis["actual"])?.["constructor"]);
$assert.sameValue(globalThis["ctorCalled"], 1.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["mapperFn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mapperFn"]), true);
$assert.callable(globalThis["mapperFn"]);
$assert.constructable(globalThis["mapperFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mapperFn"]), ['length', 'name', 'prototype'], globalThis["mapperFn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["mapperFn"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mapperFn"]?.["prototype"]), true);
$assert.notCallable(globalThis["mapperFn"]?.["prototype"]);
$assert.notConstructable(globalThis["mapperFn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mapperFn"]?.["prototype"]), ['constructor'], globalThis["mapperFn"]?.["prototype"]);
$assert.sameValue(globalThis["mapperFn"]?.["prototype"]?.["constructor"], globalThis["mapperFn"]);
$verifyProperty(globalThis["mapperFn"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["mapperFn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["mapperFn"], "name", {
  value: "mapperFn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["mapperFn"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
