...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["1"]), ['0', 'length'], globalThis["result"]?.["1"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["2"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["2"]), true);
$assert.notCallable(globalThis["result"]?.["2"]);
$assert.notConstructable(globalThis["result"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["2"]), ['0', 'length'], globalThis["result"]?.["2"]);
$verifyProperty(globalThis["result"]?.["2"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["result"]?.["2"], "0", {
  value: 6.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["0"]), ['0', 'length'], globalThis["result"]?.["0"]);
