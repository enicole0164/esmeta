...
$assert.sameValue($Object_getPrototypeOf(globalThis["objBoolean"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objBoolean"]), true);
$assert.notCallable(globalThis["objBoolean"]);
$assert.notConstructable(globalThis["objBoolean"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objBoolean"]), [], globalThis["objBoolean"]);
