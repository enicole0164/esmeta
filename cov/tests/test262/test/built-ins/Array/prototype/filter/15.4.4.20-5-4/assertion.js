...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["f"])), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["f"])), ['constructor', 'res'], $Object_getPrototypeOf(globalThis["f"]));
$verifyProperty($Object_getPrototypeOf(globalThis["f"]), "res", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["f"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["f"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["f"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["f"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["f"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["f"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["f"]));
$verifyProperty($Object_getPrototypeOf(globalThis["f"])?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["f"])?.["constructor"], "name", {
  value: "foo",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["f"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["f"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["foo"], $Object_getPrototypeOf(globalThis["f"])?.["constructor"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["resArr"]), ['0', 'length'], globalThis["resArr"]);
...
$verifyProperty(globalThis["resArr"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
