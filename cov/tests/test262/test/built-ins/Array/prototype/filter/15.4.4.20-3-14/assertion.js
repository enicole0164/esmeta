...
$assert.sameValue(globalThis["accessed2"], false);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["newArr2"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newArr2"]), true);
$assert.notCallable(globalThis["newArr2"]);
$assert.notConstructable(globalThis["newArr2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newArr2"]), ['length'], globalThis["newArr2"]);
$verifyProperty(globalThis["newArr2"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['0', 'length'], globalThis["obj2"]);
