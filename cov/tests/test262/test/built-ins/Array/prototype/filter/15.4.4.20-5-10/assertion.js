...
$assert.sameValue($Object_getPrototypeOf(globalThis["objArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objArray"]), true);
$assert.notCallable(globalThis["objArray"]);
$assert.notConstructable(globalThis["objArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objArray"]), ['length'], globalThis["objArray"]);
$verifyProperty(globalThis["objArray"], "length", {
  value: 10.0,
  writable: true,
  enumerable: false,
  configurable: false,
