...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['0', 'length', 'constructor'], globalThis["a"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["constructor"]?.[Symbol.species]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["constructor"]?.[Symbol.species]), true);
$assert.callable(globalThis["a"]?.["constructor"]?.[Symbol.species]);
$assert.constructable(globalThis["a"]?.["constructor"]?.[Symbol.species]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["constructor"]?.[Symbol.species]), ['length', 'name', 'prototype'], globalThis["a"]?.["constructor"]?.[Symbol.species]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]), true);
$assert.notCallable(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]);
$assert.notConstructable(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]), ['constructor'], globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]);
$assert.sameValue(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"]?.["constructor"], globalThis["a"]?.["constructor"]?.[Symbol.species]);
$verifyProperty(globalThis["a"]?.["constructor"]?.[Symbol.species]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["constructor"]?.[Symbol.species], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["constructor"]?.[Symbol.species], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["constructor"]?.[Symbol.species], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["r"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["r"]), true);
$assert.notCallable(globalThis["r"]);
$assert.notConstructable(globalThis["r"]);
$assert.compareArray($Reflect_ownKeys(globalThis["r"]), ['length'], globalThis["r"]);
$verifyProperty(globalThis["r"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
