...
$assert.sameValue($Object_getPrototypeOf(globalThis["newArr"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newArr"]), true);
$assert.notCallable(globalThis["newArr"]);
$assert.notConstructable(globalThis["newArr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newArr"]), ['0', '1', 'length'], globalThis["newArr"]);
$verifyProperty(globalThis["newArr"], "1", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["newArr"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["newArr"], "0", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
