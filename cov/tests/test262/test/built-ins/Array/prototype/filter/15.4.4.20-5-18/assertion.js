...
$assert.sameValue($Object_getPrototypeOf(globalThis["objError"]), RangeError.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objError"]), true);
$assert.notCallable(globalThis["objError"]);
$assert.notConstructable(globalThis["objError"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objError"]), [], globalThis["objError"]);
