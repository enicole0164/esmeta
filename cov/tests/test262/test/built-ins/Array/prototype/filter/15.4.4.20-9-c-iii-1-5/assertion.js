...
$assert.sameValue(globalThis["called"], 5.0);
$assert.sameValue(globalThis["lastToIdx"], 5.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["newArr"]), ['0', '1', '2', '3', '4', 'length'], globalThis["newArr"]);
