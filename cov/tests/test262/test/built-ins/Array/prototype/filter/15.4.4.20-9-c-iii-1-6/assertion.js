...
$assert.sameValue(globalThis["called"], 4.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["newArr"]), ['0', '1', '2', '3', 'length'], globalThis["newArr"]);
...
$verifyProperty(globalThis["newArr"], "3", {
  value: 14.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["toIndex"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["toIndex"]), true);
$assert.notCallable(globalThis["toIndex"]);
$assert.notConstructable(globalThis["toIndex"]);
$assert.compareArray($Reflect_ownKeys(globalThis["toIndex"]), ['0', '1', '2', '3', 'length'], globalThis["toIndex"]);
$verifyProperty(globalThis["toIndex"], "2", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["toIndex"], "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["toIndex"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["toIndex"], "3", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["toIndex"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
