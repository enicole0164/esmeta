...
$assert.sameValue($Object_getPrototypeOf(globalThis["objNumber"]), Number.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objNumber"]), true);
$assert.notCallable(globalThis["objNumber"]);
$assert.notConstructable(globalThis["objNumber"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objNumber"]), [], globalThis["objNumber"]);
