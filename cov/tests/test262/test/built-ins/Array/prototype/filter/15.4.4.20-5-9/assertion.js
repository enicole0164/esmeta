...
$assert.sameValue($Object_getPrototypeOf(globalThis["objFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objFunction"]), true);
$assert.callable(globalThis["objFunction"]);
$assert.constructable(globalThis["objFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objFunction"]), ['length', 'name', 'prototype'], globalThis["objFunction"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["objFunction"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objFunction"]?.["prototype"]), true);
$assert.notCallable(globalThis["objFunction"]?.["prototype"]);
$assert.notConstructable(globalThis["objFunction"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objFunction"]?.["prototype"]), ['constructor'], globalThis["objFunction"]?.["prototype"]);
$assert.sameValue(globalThis["objFunction"]?.["prototype"]?.["constructor"], globalThis["objFunction"]);
$verifyProperty(globalThis["objFunction"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objFunction"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["objFunction"], "name", {
  value: "objFunction",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objFunction"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
