...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["constructor"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["constructor"]), true);
$assert.notCallable(globalThis["a"]?.["constructor"]);
$assert.notConstructable(globalThis["a"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["constructor"]), [Symbol.species], globalThis["a"]?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a"]?.["constructor"], Symbol.species)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["constructor"], Symbol.species, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["cb"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cb"]), true);
$assert.callable(globalThis["cb"]);
$assert.constructable(globalThis["cb"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cb"]), ['length', 'name', 'prototype'], globalThis["cb"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cb"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cb"]?.["prototype"]), true);
$assert.notCallable(globalThis["cb"]?.["prototype"]);
$assert.notConstructable(globalThis["cb"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cb"]?.["prototype"]), ['constructor'], globalThis["cb"]?.["prototype"]);
$assert.sameValue(globalThis["cb"]?.["prototype"]?.["constructor"], globalThis["cb"]);
$verifyProperty(globalThis["cb"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cb"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["cb"], "name", {
  value: "cb",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cb"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
