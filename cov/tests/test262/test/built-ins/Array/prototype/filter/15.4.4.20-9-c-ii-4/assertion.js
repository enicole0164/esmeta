...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', '1', '2', '3', '4', '5', 'length'], globalThis["arr"]);
...
$assert.sameValue(globalThis["called"], 6.0);
$assert.sameValue(globalThis["lastIdx"], 6.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["newArr"]), ['0', '1', '2', '3', '4', '5', 'length'], globalThis["newArr"]);
$verifyProperty(globalThis["newArr"], "4", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
