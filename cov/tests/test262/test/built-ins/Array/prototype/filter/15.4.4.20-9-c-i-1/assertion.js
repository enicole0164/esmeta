...
$assert.sameValue($Object_getPrototypeOf(globalThis["kValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["kValue"]), true);
$assert.notCallable(globalThis["kValue"]);
$assert.notConstructable(globalThis["kValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["kValue"]), [], globalThis["kValue"]);
...
$assert.sameValue(globalThis["newArr"]?.["0"], globalThis["kValue"]);
...
$assert.sameValue(globalThis["obj"]?.["5"], globalThis["kValue"]);
