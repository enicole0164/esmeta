...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', '2', '3', '4', 'slice', 'length'], globalThis["obj"]);
...
$assert.sameValue(globalThis["obj"]?.["slice"], Array.prototype.slice);
$verifyProperty(globalThis["obj"], "slice", {
  writable: true,
  enumerable: true,
  configurable: true,
});
