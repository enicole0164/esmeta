...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["1"]), ['0', 'length'], globalThis["a"]?.["1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["actual"]), ['0', '1', 'length'], globalThis["actual"]);
