...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["0"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["0"]), ['0', 'length'], globalThis["a"]?.["0"]);
$verifyProperty(globalThis["a"]?.["0"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["0"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["actual"]), ['length'], globalThis["actual"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["getArgumentsObject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getArgumentsObject"]), true);
$assert.callable(globalThis["getArgumentsObject"]);
$assert.constructable(globalThis["getArgumentsObject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getArgumentsObject"]), ['length', 'name', 'prototype'], globalThis["getArgumentsObject"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getArgumentsObject"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getArgumentsObject"]?.["prototype"]), true);
$assert.notCallable(globalThis["getArgumentsObject"]?.["prototype"]);
$assert.notConstructable(globalThis["getArgumentsObject"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getArgumentsObject"]?.["prototype"]), ['constructor'], globalThis["getArgumentsObject"]?.["prototype"]);
$assert.sameValue(globalThis["getArgumentsObject"]?.["prototype"]?.["constructor"], globalThis["getArgumentsObject"]);
$verifyProperty(globalThis["getArgumentsObject"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getArgumentsObject"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getArgumentsObject"], "name", {
  value: "getArgumentsObject",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getArgumentsObject"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
