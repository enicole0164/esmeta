...
$assert.sameValue($Object_getPrototypeOf(globalThis["start"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["start"]), true);
$assert.notCallable(globalThis["start"]);
$assert.notConstructable(globalThis["start"]);
$assert.compareArray($Reflect_ownKeys(globalThis["start"]), ['valueOf'], globalThis["start"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["start"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["start"]?.["valueOf"]), true);
$assert.callable(globalThis["start"]?.["valueOf"]);
$assert.constructable(globalThis["start"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["start"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["start"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["start"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["start"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["start"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["start"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["start"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["start"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["start"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["start"]?.["valueOf"]);
$verifyProperty(globalThis["start"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["start"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["start"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["start"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["start"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
