...
$assert.sameValue($Object_getPrototypeOf(globalThis["end"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["end"]), true);
$assert.notCallable(globalThis["end"]);
$assert.notConstructable(globalThis["end"]);
$assert.compareArray($Reflect_ownKeys(globalThis["end"]), ['valueOf'], globalThis["end"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["end"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["end"]?.["valueOf"]), true);
$assert.callable(globalThis["end"]?.["valueOf"]);
$assert.constructable(globalThis["end"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["end"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["end"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["end"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["end"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["end"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["end"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["end"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["end"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["end"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["end"]?.["valueOf"]);
$verifyProperty(globalThis["end"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["end"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["end"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["end"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["end"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
