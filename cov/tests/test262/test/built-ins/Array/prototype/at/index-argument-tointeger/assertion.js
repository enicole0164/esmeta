...
$assert.compareArray($Reflect_ownKeys(a), ['0', '1', '2', '3', 'length'], a);
$verifyProperty(a, "2", {
  value: 2.0,
  writable: true,
  enumerable: true,
...
$assert.sameValue($Object_getPrototypeOf(index), Object.prototype);
$assert.sameValue(Object.isExtensible(index), true);
$assert.notCallable(index);
$assert.notConstructable(index);
$assert.compareArray($Reflect_ownKeys(index), ['valueOf'], index);
$assert.sameValue($Object_getPrototypeOf(index?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(index?.["valueOf"]), true);
$assert.callable(index?.["valueOf"]);
$assert.notConstructable(index?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(index?.["valueOf"]), ['length', 'name'], index?.["valueOf"]);
$verifyProperty(index?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(index?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(index, "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(valueOfCallCount, 1.0);
