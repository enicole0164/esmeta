...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', 'shift', 'length'], globalThis["obj"]);
$assert.sameValue(globalThis["obj"]?.["shift"], Array.prototype.shift);
$verifyProperty(globalThis["obj"], "shift", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["shift"], undefined);
