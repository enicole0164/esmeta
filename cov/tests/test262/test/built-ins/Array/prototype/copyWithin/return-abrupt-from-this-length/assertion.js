...
$assert.sameValue($Object_getPrototypeOf(globalThis["o1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o1"]), true);
$assert.notCallable(globalThis["o1"]);
$assert.notConstructable(globalThis["o1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o1"]), ['length'], globalThis["o1"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o1"], "length")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o1"], "length", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["o2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o2"]), true);
$assert.notCallable(globalThis["o2"]);
$assert.notConstructable(globalThis["o2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o2"]), ['length'], globalThis["o2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o2"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o2"]?.["length"]), true);
$assert.notCallable(globalThis["o2"]?.["length"]);
$assert.notConstructable(globalThis["o2"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o2"]?.["length"]), ['valueOf'], globalThis["o2"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o2"]?.["length"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o2"]?.["length"]?.["valueOf"]), true);
$assert.callable(globalThis["o2"]?.["length"]?.["valueOf"]);
$assert.constructable(globalThis["o2"]?.["length"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o2"]?.["length"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["o2"]?.["length"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["o2"]?.["length"]?.["valueOf"]);
$verifyProperty(globalThis["o2"]?.["length"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o2"]?.["length"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o2"]?.["length"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o2"]?.["length"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o2"]?.["length"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["o2"], "length", {
  writable: true,
  enumerable: true,
  configurable: true,
});
