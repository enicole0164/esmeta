...
$assert.compareArray($Reflect_ownKeys(globalThis["o1"]), ['valueOf'], globalThis["o1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o1"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o1"]?.["valueOf"]), true);
$assert.callable(globalThis["o1"]?.["valueOf"]);
$assert.constructable(globalThis["o1"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o1"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["o1"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o1"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o1"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["o1"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["o1"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o1"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["o1"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["o1"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["o1"]?.["valueOf"]);
$verifyProperty(globalThis["o1"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o1"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o1"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o1"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
