...
$assert.sameValue(globalThis["callCnt"], 0.0);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["f"])), Array.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["f"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["f"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["f"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["f"])), ['0', '1', '2', 'length'], $Object_getPrototypeOf(globalThis["f"]));
$verifyProperty($Object_getPrototypeOf(globalThis["f"]), "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["f"]), "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty($Object_getPrototypeOf(globalThis["f"]), "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.notCallable(globalThis["f"]);
$assert.notConstructable(globalThis["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), ['length'], globalThis["f"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["length"]), true);
$assert.notCallable(globalThis["f"]?.["length"]);
$assert.notConstructable(globalThis["f"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]), ['toString'], globalThis["f"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["length"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["length"]?.["toString"]), true);
$assert.callable(globalThis["f"]?.["length"]?.["toString"]);
$assert.constructable(globalThis["f"]?.["length"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["f"]?.["length"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["length"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["length"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["f"]?.["length"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["f"]?.["length"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["f"]?.["length"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["f"]?.["length"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["f"]?.["length"]?.["toString"]);
$verifyProperty(globalThis["f"]?.["length"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["length"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f"]?.["length"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["length"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["length"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["foo"]?.["prototype"], $Object_getPrototypeOf(globalThis["f"]));
...
$assert.sameValue(globalThis["o"], globalThis["f"]?.["length"]);
