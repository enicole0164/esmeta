...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]), ['valueOf'], globalThis["f"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["length"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["length"]?.["valueOf"]), true);
$assert.callable(globalThis["f"]?.["length"]?.["valueOf"]);
$assert.constructable(globalThis["f"]?.["length"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["f"]?.["length"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["f"]?.["length"]?.["valueOf"]);
$verifyProperty(globalThis["f"]?.["length"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["length"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f"]?.["length"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["length"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["length"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
