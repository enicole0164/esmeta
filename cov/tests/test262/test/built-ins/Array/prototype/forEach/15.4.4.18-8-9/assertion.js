...
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["length"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["length"]), ['0', 'length'], globalThis["f"]?.["length"]);
$verifyProperty(globalThis["f"]?.["length"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f"]?.["length"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
