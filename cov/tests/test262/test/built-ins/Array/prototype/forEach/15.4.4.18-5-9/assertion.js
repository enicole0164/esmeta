...
$assert.sameValue($Object_getPrototypeOf(globalThis["objString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objString"]), true);
$assert.callable(globalThis["objString"]);
$assert.constructable(globalThis["objString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objString"]), ['length', 'name', 'prototype'], globalThis["objString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["objString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objString"]?.["prototype"]), true);
$assert.notCallable(globalThis["objString"]?.["prototype"]);
$assert.notConstructable(globalThis["objString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objString"]?.["prototype"]), ['constructor'], globalThis["objString"]?.["prototype"]);
$assert.sameValue(globalThis["objString"]?.["prototype"]?.["constructor"], globalThis["objString"]);
$verifyProperty(globalThis["objString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["objString"], "name", {
  value: "objString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["objString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
