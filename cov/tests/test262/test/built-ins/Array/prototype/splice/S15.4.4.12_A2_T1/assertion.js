...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', '2', 'length', 'splice'], globalThis["obj"]);
$assert.sameValue(globalThis["obj"]?.["splice"], Array.prototype.splice);
$verifyProperty(globalThis["obj"], "splice", {
  writable: true,
  enumerable: true,
  configurable: true,
});
