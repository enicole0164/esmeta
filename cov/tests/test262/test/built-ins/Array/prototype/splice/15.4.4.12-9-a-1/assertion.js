...
$assert.sameValue($Object_getPrototypeOf(globalThis["newArrObj"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newArrObj"]), true);
$assert.notCallable(globalThis["newArrObj"]);
$assert.notConstructable(globalThis["newArrObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newArrObj"]), ['0', 'length'], globalThis["newArrObj"]);
$verifyProperty(globalThis["newArrObj"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["newArrObj"], "0", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
