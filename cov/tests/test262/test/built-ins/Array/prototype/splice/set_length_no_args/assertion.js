...
$assert.sameValue(globalThis["getCallCount"], 1.0);
$assert.sameValue(globalThis["lengthValue"], 0.0);
...
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "length")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "length")?.get);
...
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "length")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "length")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "length")?.set);
...
$assert.sameValue(globalThis["setCallCount"], 1.0);
