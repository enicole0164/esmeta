...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["f"])), ['0', '1', '2', '3', 'length'], $Object_getPrototypeOf(globalThis["f"]));
...
$verifyProperty($Object_getPrototypeOf(globalThis["f"]), "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), [], globalThis["f"]);
