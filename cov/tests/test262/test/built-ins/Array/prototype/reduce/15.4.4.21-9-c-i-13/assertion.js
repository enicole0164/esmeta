...
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['0', '1', '2'], globalThis["Con"]?.["prototype"]);
...
$verifyProperty(globalThis["Con"]?.["prototype"], "2", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["initialValue"], 0.0);
$assert.sameValue(globalThis["proto"], globalThis["Con"]?.["prototype"]);
$assert.sameValue(globalThis["testResult"], true);
