...
$assert.sameValue($Object_getPrototypeOf(globalThis["fromIndex"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fromIndex"]), true);
$assert.notCallable(globalThis["fromIndex"]);
$assert.notConstructable(globalThis["fromIndex"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fromIndex"]), ['toString', 'valueOf'], globalThis["fromIndex"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fromIndex"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fromIndex"]?.["toString"]), true);
$assert.callable(globalThis["fromIndex"]?.["toString"]);
$assert.constructable(globalThis["fromIndex"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fromIndex"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["fromIndex"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fromIndex"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fromIndex"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["fromIndex"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["fromIndex"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fromIndex"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["fromIndex"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["fromIndex"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["fromIndex"]?.["toString"]);
$verifyProperty(globalThis["fromIndex"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fromIndex"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fromIndex"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fromIndex"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fromIndex"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fromIndex"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fromIndex"]?.["valueOf"]), true);
$assert.callable(globalThis["fromIndex"]?.["valueOf"]);
$assert.constructable(globalThis["fromIndex"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fromIndex"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["fromIndex"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fromIndex"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fromIndex"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["fromIndex"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["fromIndex"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fromIndex"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["fromIndex"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["fromIndex"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["fromIndex"]?.["valueOf"]);
$verifyProperty(globalThis["fromIndex"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fromIndex"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fromIndex"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fromIndex"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fromIndex"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
