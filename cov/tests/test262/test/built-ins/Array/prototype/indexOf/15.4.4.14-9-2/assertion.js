...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["4"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["4"]), true);
$assert.notCallable(globalThis["a"]?.["4"]);
$assert.notConstructable(globalThis["a"]?.["4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["4"]), ['toString'], globalThis["a"]?.["4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["4"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["4"]?.["toString"]), true);
$assert.callable(globalThis["a"]?.["4"]?.["toString"]);
$assert.constructable(globalThis["a"]?.["4"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["4"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["a"]?.["4"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["4"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["4"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["a"]?.["4"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["a"]?.["4"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["4"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["a"]?.["4"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["a"]?.["4"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["a"]?.["4"]?.["toString"]);
$verifyProperty(globalThis["a"]?.["4"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["4"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["4"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["4"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["4"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["obj"], globalThis["a"]?.["4"]);
