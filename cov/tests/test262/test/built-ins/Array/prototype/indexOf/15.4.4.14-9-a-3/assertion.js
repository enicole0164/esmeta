...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['4', 'length'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["4"]), true);
$assert.callable(globalThis["arr"]?.["4"]);
$assert.constructable(globalThis["arr"]?.["4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["4"]), ['length', 'name', 'prototype'], globalThis["arr"]?.["4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["4"]?.["prototype"]), true);
$assert.notCallable(globalThis["arr"]?.["4"]?.["prototype"]);
$assert.notConstructable(globalThis["arr"]?.["4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["4"]?.["prototype"]), ['constructor'], globalThis["arr"]?.["4"]?.["prototype"]);
$assert.sameValue(globalThis["arr"]?.["4"]?.["prototype"]?.["constructor"], globalThis["arr"]?.["4"]);
$verifyProperty(globalThis["arr"]?.["4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arr"]?.["4"], "name", {
  value: "targetObj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["fromIndex"]), ['valueOf'], globalThis["fromIndex"]);
...
$assert.sameValue(globalThis["targetObj"], globalThis["arr"]?.["4"]);
