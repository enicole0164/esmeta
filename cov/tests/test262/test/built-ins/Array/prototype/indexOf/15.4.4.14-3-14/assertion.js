...
$assert.compareArray($Reflect_ownKeys(globalThis["objOne"]), ['0', '1', 'length'], globalThis["objOne"]);
...
$verifyProperty(globalThis["objOne"], "0", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["objThree"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objThree"]), true);
$assert.notCallable(globalThis["objThree"]);
$assert.notConstructable(globalThis["objThree"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objThree"]), ['0', '1', 'length'], globalThis["objThree"]);
$verifyProperty(globalThis["objThree"], "1", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objThree"], "length", {
  value: "-Infinity",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objThree"], "0", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["objTwo"]), ['0', '1', 'length'], globalThis["objTwo"]);
$verifyProperty(globalThis["objTwo"], "1", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["objTwo"], "0", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
