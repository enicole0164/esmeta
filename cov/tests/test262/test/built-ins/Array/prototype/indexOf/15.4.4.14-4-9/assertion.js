...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '100', 'length'], globalThis["obj"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["0"]), true);
$assert.notCallable(globalThis["obj"]?.["0"]);
$assert.notConstructable(globalThis["obj"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["0"]), ['length'], globalThis["obj"]?.["0"]);
$verifyProperty(globalThis["obj"]?.["0"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
...
$assert.sameValue(globalThis["obj"]?.["100"], globalThis["obj"]?.["0"]);
$verifyProperty(globalThis["obj"], "100", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["targetObj"], globalThis["obj"]?.["0"]);
