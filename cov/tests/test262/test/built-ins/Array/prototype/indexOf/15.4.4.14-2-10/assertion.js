...
$assert.sameValue($Object_getPrototypeOf(globalThis["childOne"]), globalThis["Con"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["childOne"]), true);
$assert.notCallable(globalThis["childOne"]);
$assert.notConstructable(globalThis["childOne"]);
$assert.compareArray($Reflect_ownKeys(globalThis["childOne"]), ['1'], globalThis["childOne"]);
$verifyProperty(globalThis["childOne"], "1", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["childTwo"]), globalThis["Con"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["childTwo"]), true);
$assert.notCallable(globalThis["childTwo"]);
$assert.notConstructable(globalThis["childTwo"]);
$assert.compareArray($Reflect_ownKeys(globalThis["childTwo"]), ['2'], globalThis["childTwo"]);
$verifyProperty(globalThis["childTwo"], "2", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
