...
$assert.compareArray($Reflect_ownKeys(globalThis["arrayLike"]), ['length', '9007199254740990'], globalThis["arrayLike"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arrayLike"]?.["9007199254740990"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrayLike"]?.["9007199254740990"]), true);
$assert.notCallable(globalThis["arrayLike"]?.["9007199254740990"]);
$assert.notConstructable(globalThis["arrayLike"]?.["9007199254740990"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrayLike"]?.["9007199254740990"]), [], globalThis["arrayLike"]?.["9007199254740990"]);
...
$assert.sameValue(globalThis["el"], globalThis["arrayLike"]?.["9007199254740990"]);
$assert.sameValue(globalThis["elIndex"], 9.00719925474099E15);
$assert.sameValue(globalThis["fromIndex"], 9.007199254740988E15);
$assert.sameValue(globalThis["res"], 9.00719925474099E15);
