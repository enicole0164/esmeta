...
$assert.sameValue(globalThis["concat"], Array.prototype.concat);
$assert.sameValue(globalThis["copyWithin"], Array.prototype.copyWithin);
$assert.sameValue(globalThis["entries"], Array.prototype.entries);
$assert.sameValue(globalThis["every"], Array.prototype.every);
$assert.sameValue(globalThis["fill"], Array.prototype.fill);
$assert.sameValue(globalThis["filter"], Array.prototype.filter);
$assert.sameValue(globalThis["find"], Array.prototype.find);
$assert.sameValue(globalThis["findIndex"], Array.prototype.findIndex);
$assert.sameValue(globalThis["flat"], Array.prototype.flat);
$assert.sameValue(globalThis["flatMap"], Array.prototype.flatMap);
$assert.sameValue(globalThis["forEach"], Array.prototype.forEach);
$assert.sameValue(globalThis["includes"], Array.prototype.includes);
$assert.sameValue($Object_getPrototypeOf(globalThis["index"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["index"]), true);
$assert.notCallable(globalThis["index"]);
$assert.notConstructable(globalThis["index"]);
$assert.compareArray($Reflect_ownKeys(globalThis["index"]), ['valueOf'], globalThis["index"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get, "name", {
  value: "get valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["index"], "valueOf")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["index"], "valueOf", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["indexOf"], Array.prototype.indexOf);
$assert.sameValue(globalThis["iterator"], Array.prototype.values);
$assert.sameValue(globalThis["join"], Array.prototype.join);
$assert.sameValue(globalThis["keys"], Array.prototype.keys);
$assert.sameValue(globalThis["lastIndexOf"], Array.prototype.lastIndexOf);
$assert.sameValue(globalThis["map"], Array.prototype.map);
$assert.sameValue(globalThis["pop"], Array.prototype.pop);
$assert.sameValue(globalThis["push"], Array.prototype.push);
$assert.sameValue(globalThis["reduce"], Array.prototype.reduce);
$assert.sameValue(globalThis["reduceRight"], Array.prototype.reduceRight);
$assert.sameValue(globalThis["reverse"], Array.prototype.reverse);
...
$assert.compareArray($Reflect_ownKeys(globalThis["separator"]), ['toString'], globalThis["separator"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get, "name", {
  value: "get toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["separator"], "toString")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["shift"], Array.prototype.shift);
$assert.sameValue(globalThis["slice"], Array.prototype.slice);
$assert.sameValue(globalThis["some"], Array.prototype.some);
$assert.sameValue(globalThis["sort"], Array.prototype.sort);
$assert.sameValue(globalThis["splice"], Array.prototype.splice);
$assert.sameValue(globalThis["toLocaleString"], Array.prototype.toLocaleString);
$assert.sameValue(globalThis["toString"], Array.prototype.toString);
$assert.sameValue(globalThis["unshift"], Array.prototype.unshift);
$assert.sameValue(globalThis["values"], Array.prototype.values);
