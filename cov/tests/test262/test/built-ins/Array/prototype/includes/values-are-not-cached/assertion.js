...
$assert.sameValue($Object_getPrototypeOf(globalThis["getCleanObj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getCleanObj"]), true);
$assert.callable(globalThis["getCleanObj"]);
$assert.constructable(globalThis["getCleanObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getCleanObj"]), ['length', 'name', 'prototype'], globalThis["getCleanObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getCleanObj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getCleanObj"]?.["prototype"]), true);
$assert.notCallable(globalThis["getCleanObj"]?.["prototype"]);
$assert.notConstructable(globalThis["getCleanObj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getCleanObj"]?.["prototype"]), ['constructor'], globalThis["getCleanObj"]?.["prototype"]);
$assert.sameValue(globalThis["getCleanObj"]?.["prototype"]?.["constructor"], globalThis["getCleanObj"]);
$verifyProperty(globalThis["getCleanObj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getCleanObj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getCleanObj"], "name", {
  value: "getCleanObj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getCleanObj"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
