...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['valueOf'], globalThis["obj"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["sample"]), ['0', '1', 'length'], globalThis["sample"]);
$verifyProperty(globalThis["sample"], "1", {
  value: 43.0,
  writable: true,
  enumerable: true,
  configurable: true,
