...
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]), ['length'], globalThis["obj1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["length"]), true);
$assert.notCallable(globalThis["obj1"]?.["length"]);
$assert.notConstructable(globalThis["obj1"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["length"]), ['valueOf'], globalThis["obj1"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["length"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["length"]?.["valueOf"]), true);
$assert.callable(globalThis["obj1"]?.["length"]?.["valueOf"]);
$assert.constructable(globalThis["obj1"]?.["length"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["length"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["obj1"]?.["length"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["obj1"]?.["length"]?.["valueOf"]);
$verifyProperty(globalThis["obj1"]?.["length"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["length"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj1"]?.["length"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["length"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["length"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj1"], "length", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['length'], globalThis["obj2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["length"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["length"]), true);
$assert.notCallable(globalThis["obj2"]?.["length"]);
$assert.notConstructable(globalThis["obj2"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["length"]), ['toString'], globalThis["obj2"]?.["length"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["length"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["length"]?.["toString"]), true);
$assert.callable(globalThis["obj2"]?.["length"]?.["toString"]);
$assert.constructable(globalThis["obj2"]?.["length"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["length"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["obj2"]?.["length"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["obj2"]?.["length"]?.["toString"]);
$verifyProperty(globalThis["obj2"]?.["length"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["length"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj2"]?.["length"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["length"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["length"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj2"], "length", {
  writable: true,
  enumerable: true,
  configurable: true,
});
