...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', '2', 'reverse', 'length'], globalThis["obj"]);
...
$assert.sameValue(globalThis["obj"]?.["reverse"], Array.prototype.reverse);
$verifyProperty(globalThis["obj"], "reverse", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["reverse"], globalThis["obj"]);
