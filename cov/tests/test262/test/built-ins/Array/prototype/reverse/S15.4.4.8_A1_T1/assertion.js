...
$assert.sameValue($Object_getPrototypeOf(globalThis["reverse"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["reverse"]), true);
$assert.notCallable(globalThis["reverse"]);
$assert.notConstructable(globalThis["reverse"]);
$assert.compareArray($Reflect_ownKeys(globalThis["reverse"]), ['0', '1', 'length'], globalThis["reverse"]);
$verifyProperty(globalThis["reverse"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["reverse"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["reverse"], "0", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["x"], globalThis["reverse"]);
