...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['8', 'length'], globalThis["arr"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "length")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
