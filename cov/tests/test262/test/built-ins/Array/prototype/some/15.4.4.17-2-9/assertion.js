...
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]), true);
$assert.callable(globalThis["Con"]);
$assert.constructable(globalThis["Con"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]), ['length', 'name', 'prototype'], globalThis["Con"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['length'], globalThis["Con"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "length")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"], "length", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Con"], "name", {
  value: "Con",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["callbackfn1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callbackfn1"]), true);
$assert.callable(globalThis["callbackfn1"]);
$assert.constructable(globalThis["callbackfn1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callbackfn1"]), ['length', 'name', 'prototype'], globalThis["callbackfn1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["callbackfn1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callbackfn1"]?.["prototype"]), true);
$assert.notCallable(globalThis["callbackfn1"]?.["prototype"]);
$assert.notConstructable(globalThis["callbackfn1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callbackfn1"]?.["prototype"]), ['constructor'], globalThis["callbackfn1"]?.["prototype"]);
$assert.sameValue(globalThis["callbackfn1"]?.["prototype"]?.["constructor"], globalThis["callbackfn1"]);
$verifyProperty(globalThis["callbackfn1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callbackfn1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["callbackfn1"], "name", {
  value: "callbackfn1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callbackfn1"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["callbackfn2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callbackfn2"]), true);
$assert.callable(globalThis["callbackfn2"]);
$assert.constructable(globalThis["callbackfn2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callbackfn2"]), ['length', 'name', 'prototype'], globalThis["callbackfn2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["callbackfn2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callbackfn2"]?.["prototype"]), true);
$assert.notCallable(globalThis["callbackfn2"]?.["prototype"]);
$assert.notConstructable(globalThis["callbackfn2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callbackfn2"]?.["prototype"]), ['constructor'], globalThis["callbackfn2"]?.["prototype"]);
$assert.sameValue(globalThis["callbackfn2"]?.["prototype"]?.["constructor"], globalThis["callbackfn2"]);
$verifyProperty(globalThis["callbackfn2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callbackfn2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["callbackfn2"], "name", {
  value: "callbackfn2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callbackfn2"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]), globalThis["Con"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["child"]), ['0', '1', '2', 'length'], globalThis["child"]);
$verifyProperty(globalThis["child"], "1", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["child"], "2", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["child"], "length")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"], "length", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"], "0", {
  value: 9.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["proto"], globalThis["Con"]?.["prototype"]);
