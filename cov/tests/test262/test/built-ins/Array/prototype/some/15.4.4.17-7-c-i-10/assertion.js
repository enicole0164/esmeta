...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['10', 'length'], globalThis["arr"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "10")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
