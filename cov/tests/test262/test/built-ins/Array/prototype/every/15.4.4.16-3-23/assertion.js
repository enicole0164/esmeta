...
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]), ['valueOf'], globalThis["Con"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["valueOf"]), true);
$assert.callable(globalThis["Con"]?.["prototype"]?.["valueOf"]);
$assert.constructable(globalThis["Con"]?.["prototype"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["Con"]?.["prototype"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["Con"]?.["prototype"]?.["valueOf"]);
$verifyProperty(globalThis["Con"]?.["prototype"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Con"]?.["prototype"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["child"]), ['toString'], globalThis["child"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["toString"]), true);
$assert.callable(globalThis["child"]?.["toString"]);
$assert.constructable(globalThis["child"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["child"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["child"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["child"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["child"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["child"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["child"]?.["toString"]);
$verifyProperty(globalThis["child"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["child"]?.["toString"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', '2', 'length'], globalThis["obj"]);
...
$verifyProperty(globalThis["obj"], "2", {
  value: 9.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["obj"]?.["length"], globalThis["child"]);
$verifyProperty(globalThis["obj"], "length", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "0", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["toStringAccessed"], false);
$assert.sameValue(globalThis["valueOfAccessed"], true);
