...
$assert.compareArray($Reflect_ownKeys(globalThis["objOne"]), ['0', 'length'], globalThis["objOne"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["objThree"]), ['0', 'length'], globalThis["objThree"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["objTwo"]), ['0', 'length'], globalThis["objTwo"]);
