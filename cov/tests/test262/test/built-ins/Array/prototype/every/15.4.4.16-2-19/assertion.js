...
$assert.compareArray($Reflect_ownKeys(globalThis["fun"]), ['0', '1', '2', 'length', 'name', 'prototype'], globalThis["fun"]);
...
$verifyProperty(globalThis["fun"], "2", {
  value: 9.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["fun"], "1", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["fun"], "0", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
