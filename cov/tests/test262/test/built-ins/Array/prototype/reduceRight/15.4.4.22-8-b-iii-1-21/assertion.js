...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Con"]?.["prototype"], "2")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
