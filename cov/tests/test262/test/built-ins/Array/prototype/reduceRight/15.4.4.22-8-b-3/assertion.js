...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['1', '2', 'length'], globalThis["arr"]);
...
$assert.sameValue(globalThis["firstCalled"], 1.0);
$assert.sameValue(globalThis["secondCalled"], 1.0);
