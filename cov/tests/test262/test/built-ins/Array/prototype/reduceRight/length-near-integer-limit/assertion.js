...
$assert.sameValue($Object_getPrototypeOf(globalThis["accumulator"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["accumulator"]), true);
$assert.callable(globalThis["accumulator"]);
$assert.constructable(globalThis["accumulator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["accumulator"]), ['length', 'name', 'prototype'], globalThis["accumulator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["accumulator"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["accumulator"]?.["prototype"]), true);
$assert.notCallable(globalThis["accumulator"]?.["prototype"]);
$assert.notConstructable(globalThis["accumulator"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["accumulator"]?.["prototype"]), ['constructor'], globalThis["accumulator"]?.["prototype"]);
$assert.sameValue(globalThis["accumulator"]?.["prototype"]?.["constructor"], globalThis["accumulator"]);
$verifyProperty(globalThis["accumulator"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["accumulator"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["accumulator"], "name", {
  value: "accumulator",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["accumulator"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["arrayLike"]), ['length', '9007199254740990', '9007199254740988'], globalThis["arrayLike"]);
