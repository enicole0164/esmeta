...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '4', 'length'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "4")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
