...
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["4"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["4"]), true);
$assert.notCallable(globalThis["arr"]?.["4"]);
$assert.notConstructable(globalThis["arr"]?.["4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["4"]), [], globalThis["arr"]?.["4"]);
...
$assert.sameValue(globalThis["bParCorrect"], false);
...
$assert.sameValue(globalThis["initialValue"], 5.5);
