...
$assert.sameValue(globalThis["callCnt"], 2.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["resArr"]), ['1', '2', 'length'], globalThis["resArr"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["srcArr"]), ['1', '2', '1000', 'length'], globalThis["srcArr"]);
...
$verifyProperty(globalThis["srcArr"], "1000", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
