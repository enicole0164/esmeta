...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['8', 'length'], globalThis["obj"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["testResult"]), ['8', 'length'], globalThis["testResult"]);
$verifyProperty(globalThis["testResult"], "8", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
