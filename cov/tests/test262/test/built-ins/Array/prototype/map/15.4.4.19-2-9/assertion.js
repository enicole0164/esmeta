...
$assert.sameValue($Object_getPrototypeOf(globalThis["testResult"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testResult"]), true);
$assert.notCallable(globalThis["testResult"]);
$assert.notConstructable(globalThis["testResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testResult"]), ['0', '1', 'length'], globalThis["testResult"]);
$verifyProperty(globalThis["testResult"], "1", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["testResult"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testResult"], "0", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
