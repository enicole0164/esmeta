...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', '1', 'length', 'name', 'prototype'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["prototype"]), ['constructor'], globalThis["obj"]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.["prototype"]?.["constructor"], globalThis["obj"]);
$verifyProperty(globalThis["obj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
