...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["f"])), ['constructor'], $Object_getPrototypeOf(globalThis["f"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), ['res'], globalThis["f"]);
$verifyProperty(globalThis["f"], "res", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
