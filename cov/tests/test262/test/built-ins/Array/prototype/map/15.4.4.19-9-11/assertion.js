...
$assert.sameValue($Object_getPrototypeOf(globalThis["Foo"]?.["prototype"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["Foo"]?.["prototype"]), ['0', '1', '2', 'length'], globalThis["Foo"]?.["prototype"]);
$verifyProperty(globalThis["Foo"]?.["prototype"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["Foo"]?.["prototype"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["Foo"]?.["prototype"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Foo"]?.["prototype"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]), globalThis["Foo"]?.["prototype"]);
