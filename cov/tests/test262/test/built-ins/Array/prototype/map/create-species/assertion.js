...
$assert.sameValue($Object_getPrototypeOf(globalThis["Ctor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Ctor"]), true);
$assert.callable(globalThis["Ctor"]);
$assert.constructable(globalThis["Ctor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Ctor"]), ['length', 'name', 'prototype'], globalThis["Ctor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Ctor"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Ctor"]?.["prototype"]), true);
$assert.notCallable(globalThis["Ctor"]?.["prototype"]);
$assert.notConstructable(globalThis["Ctor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Ctor"]?.["prototype"]), ['constructor'], globalThis["Ctor"]?.["prototype"]);
$assert.sameValue(globalThis["Ctor"]?.["prototype"]?.["constructor"], globalThis["Ctor"]);
$verifyProperty(globalThis["Ctor"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Ctor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Ctor"], "name", {
  value: "Ctor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Ctor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['0', '1', '2', '3', '4', 'length', 'constructor'], globalThis["a"]);
...
$assert.sameValue(globalThis["a"]?.["constructor"]?.[Symbol.species], globalThis["Ctor"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]), ['0', '1', '2', '3', '4', 'length'], globalThis["instance"]);
$verifyProperty(globalThis["instance"], "4", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["instance"], "2", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["instance"], "length", {
  value: 5.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["instance"], "1", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["instance"], "3", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["instance"], "0", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["result"], globalThis["instance"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisValue"]), globalThis["Ctor"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["thisValue"]), true);
$assert.notCallable(globalThis["thisValue"]);
$assert.notConstructable(globalThis["thisValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisValue"]), [], globalThis["thisValue"]);
