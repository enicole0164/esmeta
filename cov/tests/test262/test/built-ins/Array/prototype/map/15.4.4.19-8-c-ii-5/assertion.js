...
$assert.sameValue($Object_getPrototypeOf(globalThis["kIndex"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["kIndex"]), true);
$assert.notCallable(globalThis["kIndex"]);
$assert.notConstructable(globalThis["kIndex"]);
$assert.compareArray($Reflect_ownKeys(globalThis["kIndex"]), ['0', '1', '2', '3', 'length'], globalThis["kIndex"]);
$verifyProperty(globalThis["kIndex"], "2", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["kIndex"], "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["kIndex"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["kIndex"], "3", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["kIndex"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["testResult"]), ['0', '1', '2', '3', 'length'], globalThis["testResult"]);
...
$verifyProperty(globalThis["testResult"], "3", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
