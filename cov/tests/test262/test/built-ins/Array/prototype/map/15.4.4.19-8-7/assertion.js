...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['srcArr'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["srcArr"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["srcArr"]), true);
$assert.notCallable(globalThis["obj"]?.["srcArr"]);
$assert.notConstructable(globalThis["obj"]?.["srcArr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["srcArr"]), ['0', '1', '2', '3', '4', 'length'], globalThis["obj"]?.["srcArr"]);
$verifyProperty(globalThis["obj"]?.["srcArr"], "4", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["srcArr"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["srcArr"], "length", {
  value: 5.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["srcArr"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["srcArr"], "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["srcArr"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "srcArr", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["resArr"]), ['0', '1', '2', '3', '4', 'length'], globalThis["resArr"]);
