...
$assert.sameValue(globalThis["callCnt"], 5.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["srcArr"]), ['0', '1', '2', '3', '4', 'length', 'i', 'true'], globalThis["srcArr"]);
...
$verifyProperty(globalThis["srcArr"], "true", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["srcArr"], "i", {
  value: 10.0,
  writable: true,
  enumerable: true,
  configurable: true,
