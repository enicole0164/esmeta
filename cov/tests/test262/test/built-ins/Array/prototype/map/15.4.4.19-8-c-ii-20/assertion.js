...
$assert.sameValue($Object_getPrototypeOf(globalThis["thisArg"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisArg"]), true);
$assert.notCallable(globalThis["thisArg"]);
$assert.notConstructable(globalThis["thisArg"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisArg"]), ['threshold'], globalThis["thisArg"]);
$verifyProperty(globalThis["thisArg"], "threshold", {
  value: 10.0,
  writable: true,
  enumerable: true,
  configurable: true,
