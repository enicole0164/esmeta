...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['0', '1', '2', 'length', 'getClass'], globalThis["x"]);
$assert.sameValue(globalThis["x"]?.["getClass"], Object.prototype.toString);
$verifyProperty(globalThis["x"], "getClass", {
  writable: true,
  enumerable: true,
  configurable: true,
});
