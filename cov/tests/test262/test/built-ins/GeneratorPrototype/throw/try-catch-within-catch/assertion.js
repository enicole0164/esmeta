...
$assert.sameValue($Object_getPrototypeOf(globalThis["exception"]), globalThis["Test262Error"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["exception"]), true);
$assert.notCallable(globalThis["exception"]);
$assert.notConstructable(globalThis["exception"]);
$assert.compareArray($Reflect_ownKeys(globalThis["exception"]), ['message'], globalThis["exception"]);
$verifyProperty(globalThis["exception"], "message", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
