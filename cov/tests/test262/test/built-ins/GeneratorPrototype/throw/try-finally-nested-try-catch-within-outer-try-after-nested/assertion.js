...
$assert.sameValue($Object_getPrototypeOf(globalThis["exception"]), Error.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["exception"]), [], globalThis["exception"]);
