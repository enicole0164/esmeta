...
$assert.sameValue($Object_getPrototypeOf(globalThis["withVal"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withVal"]), true);
$assert.callable(globalThis["withVal"]);
$assert.notConstructable(globalThis["withVal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withVal"]), ['length', 'name', 'prototype'], globalThis["withVal"]);
$assert.sameValue(globalThis["withVal"]?.["prototype"], $Object_getPrototypeOf(globalThis["iter"]));
$verifyProperty(globalThis["withVal"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["withVal"], "name", {
  value: "withVal",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withVal"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["withoutVal"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withoutVal"]), true);
$assert.callable(globalThis["withoutVal"]);
$assert.notConstructable(globalThis["withoutVal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withoutVal"]), ['length', 'name', 'prototype'], globalThis["withoutVal"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["withoutVal"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withoutVal"]?.["prototype"]), true);
$assert.notCallable(globalThis["withoutVal"]?.["prototype"]);
$assert.notConstructable(globalThis["withoutVal"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withoutVal"]?.["prototype"]), [], globalThis["withoutVal"]?.["prototype"]);
$verifyProperty(globalThis["withoutVal"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["withoutVal"], "name", {
  value: "withoutVal",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withoutVal"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
