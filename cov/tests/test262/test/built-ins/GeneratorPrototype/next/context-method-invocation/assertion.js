...
$assert.sameValue($Object_getPrototypeOf(globalThis["context"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["context"]), true);
$assert.notCallable(globalThis["context"]);
$assert.notConstructable(globalThis["context"]);
$assert.compareArray($Reflect_ownKeys(globalThis["context"]), ['g'], globalThis["context"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["context"]?.["g"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["context"]?.["g"]), true);
$assert.callable(globalThis["context"]?.["g"]);
$assert.notConstructable(globalThis["context"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["context"]?.["g"]), ['length', 'name', 'prototype'], globalThis["context"]?.["g"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["context"]?.["g"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["context"]?.["g"]?.["prototype"]), true);
$assert.notCallable(globalThis["context"]?.["g"]?.["prototype"]);
$assert.notConstructable(globalThis["context"]?.["g"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["context"]?.["g"]?.["prototype"]), [], globalThis["context"]?.["g"]?.["prototype"]);
$verifyProperty(globalThis["context"]?.["g"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["context"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["context"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["context"], "g", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["g"], globalThis["context"]?.["g"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iter"]), globalThis["context"]?.["g"]?.["prototype"]);
...
$assert.sameValue(globalThis["obj"], globalThis["context"]);
