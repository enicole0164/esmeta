...
$assert.sameValue(globalThis["AsyncFunction"], AsyncFunction);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]), ['length', 'name'], globalThis["instance"]);
