...
$assert.sameValue($Object_getPrototypeOf(globalThis["l0"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["l0"]), true);
$assert.callable(globalThis["l0"]);
$assert.notConstructable(globalThis["l0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["l0"]), ['name'], globalThis["l0"]);
$verifyProperty(globalThis["l0"], "name", {
  value: "l0",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["l1"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["l1"]), true);
$assert.callable(globalThis["l1"]);
$assert.notConstructable(globalThis["l1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["l1"]), ['length', 'name'], globalThis["l1"]);
$verifyProperty(globalThis["l1"], "name", {
  value: "l1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["l1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["l2"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["l2"]), true);
$assert.callable(globalThis["l2"]);
$assert.notConstructable(globalThis["l2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["l2"]), ['length', 'name'], globalThis["l2"]);
$verifyProperty(globalThis["l2"], "name", {
  value: "l2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["l2"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
