...
$assert.sameValue($Object_getPrototypeOf(globalThis["gNonStrict"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gNonStrict"]), true);
$assert.callable(globalThis["gNonStrict"]);
$assert.constructable(globalThis["gNonStrict"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gNonStrict"]), ['length', 'name', 'prototype'], globalThis["gNonStrict"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gNonStrict"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gNonStrict"]?.["prototype"]), true);
$assert.notCallable(globalThis["gNonStrict"]?.["prototype"]);
$assert.notConstructable(globalThis["gNonStrict"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gNonStrict"]?.["prototype"]), ['constructor'], globalThis["gNonStrict"]?.["prototype"]);
$assert.sameValue(globalThis["gNonStrict"]?.["prototype"]?.["constructor"], globalThis["gNonStrict"]);
$verifyProperty(globalThis["gNonStrict"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["gNonStrict"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["gNonStrict"], "name", {
  value: "gNonStrict",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["gNonStrict"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
