...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["x"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["x"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["x"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["x"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["x"])), ['constructor'], $Object_getPrototypeOf(globalThis["x"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["x"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["x"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["x"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["x"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["x"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["x"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["x"]));
$verifyProperty($Object_getPrototypeOf(globalThis["x"])?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["x"])?.["constructor"], "name", {
  value: "f1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["x"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["x"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
