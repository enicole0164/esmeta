...
$assert.sameValue(globalThis["FunctionPrototype"], Function.prototype);
...
$assert.sameValue(globalThis["descriptor"]?.["get"], ThrowTypeError);
...
$assert.sameValue(globalThis["descriptor"]?.["set"], ThrowTypeError);
