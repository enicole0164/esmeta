...
$assert.sameValue($Object_getPrototypeOf(globalThis["BC"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BC"]), true);
$assert.callable(globalThis["BC"]);
$assert.constructable(globalThis["BC"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BC"]), ['length', 'name', 'prototype'], globalThis["BC"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["BC"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BC"]?.["prototype"]), true);
$assert.notCallable(globalThis["BC"]?.["prototype"]);
$assert.notConstructable(globalThis["BC"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BC"]?.["prototype"]), ['constructor'], globalThis["BC"]?.["prototype"]);
$assert.sameValue(globalThis["BC"]?.["prototype"]?.["constructor"], globalThis["BC"]);
$verifyProperty(globalThis["BC"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BC"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["BC"], "name", {
  value: "BC",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BC"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["bc"]), globalThis["BC"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["bc"]), true);
$assert.notCallable(globalThis["bc"]);
$assert.notConstructable(globalThis["bc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bc"]), [], globalThis["bc"]);
