...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['41', 'length', 'prop'], globalThis["a"]);
$verifyProperty(globalThis["a"], "prop", {
  value: "verifyPropertyExist",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a"], "41", {
  value: 41.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["bac"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bac"]), true);
$assert.callable(globalThis["bac"]);
$assert.constructable(globalThis["bac"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bac"]), ['length', 'name'], globalThis["bac"]);
$verifyProperty(globalThis["bac"], "name", {
  value: "bound Array",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bac"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
