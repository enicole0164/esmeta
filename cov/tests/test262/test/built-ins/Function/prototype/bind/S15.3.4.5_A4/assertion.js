...
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]), ['length', 'name', 'prototype', 'apply'], globalThis["foo"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]?.["apply"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["foo"]?.["apply"]), true);
$assert.callable(globalThis["foo"]?.["apply"]);
$assert.constructable(globalThis["foo"]?.["apply"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]?.["apply"]), ['length', 'name', 'prototype'], globalThis["foo"]?.["apply"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]?.["apply"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["foo"]?.["apply"]?.["prototype"]), true);
$assert.notCallable(globalThis["foo"]?.["apply"]?.["prototype"]);
$assert.notConstructable(globalThis["foo"]?.["apply"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]?.["apply"]?.["prototype"]), ['constructor'], globalThis["foo"]?.["apply"]?.["prototype"]);
$assert.sameValue(globalThis["foo"]?.["apply"]?.["prototype"]?.["constructor"], globalThis["foo"]?.["apply"]);
$verifyProperty(globalThis["foo"]?.["apply"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["foo"]?.["apply"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["foo"]?.["apply"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["foo"]?.["apply"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["foo"], "apply", {
  writable: true,
  enumerable: true,
  configurable: true,
});
