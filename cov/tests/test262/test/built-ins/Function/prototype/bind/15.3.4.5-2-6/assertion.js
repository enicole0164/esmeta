...
$assert.sameValue($Object_getPrototypeOf(globalThis["boc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boc"]), true);
$assert.callable(globalThis["boc"]);
$assert.constructable(globalThis["boc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boc"]), ['length', 'name'], globalThis["boc"]);
$verifyProperty(globalThis["boc"], "name", {
  value: "bound Object",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["boc"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]), Number.prototype);
