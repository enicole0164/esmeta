...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), ['bind'], globalThis["f"]);
$assert.sameValue(globalThis["f"]?.["bind"], Function.prototype.bind);
$verifyProperty(globalThis["f"], "bind", {
  writable: true,
  enumerable: true,
  configurable: true,
});
