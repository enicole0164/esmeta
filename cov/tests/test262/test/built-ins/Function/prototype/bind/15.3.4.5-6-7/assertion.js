...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]), true);
$assert.callable(globalThis["obj"]);
$assert.constructable(globalThis["obj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['length', 'name', 'property'], globalThis["obj"]);
