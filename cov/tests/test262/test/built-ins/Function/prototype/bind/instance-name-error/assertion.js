...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "name")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
