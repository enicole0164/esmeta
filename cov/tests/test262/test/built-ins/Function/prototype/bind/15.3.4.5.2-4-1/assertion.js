...
$assert.compareArray($Reflect_ownKeys(globalThis["NewFunc"]), ['length', 'name'], globalThis["NewFunc"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["newInstance"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newInstance"]), true);
$assert.notCallable(globalThis["newInstance"]);
$assert.notConstructable(globalThis["newInstance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newInstance"]), ['returnValue', 'returnVerifyResult'], globalThis["newInstance"]);
$verifyProperty(globalThis["newInstance"], "returnValue", {
  value: "abc",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["newInstance"], "returnVerifyResult", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
