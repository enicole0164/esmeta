...
$assert.sameValue(globalThis["b"], true);
$assert.sameValue($Object_getPrototypeOf(globalThis["bbc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bbc"]), true);
$assert.callable(globalThis["bbc"]);
$assert.constructable(globalThis["bbc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bbc"]), ['length', 'name'], globalThis["bbc"]);
$verifyProperty(globalThis["bbc"], "name", {
  value: "bound Boolean",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bbc"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
