...
$assert.sameValue($Object_getPrototypeOf(globalThis["bsc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bsc"]), true);
$assert.callable(globalThis["bsc"]);
$assert.constructable(globalThis["bsc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bsc"]), ['length', 'name'], globalThis["bsc"]);
$verifyProperty(globalThis["bsc"], "name", {
  value: "bound String",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bsc"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["s"], "hello world");
