...
$assert.sameValue($Object_getPrototypeOf(globalThis["bnc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bnc"]), true);
$assert.callable(globalThis["bnc"]);
$assert.constructable(globalThis["bnc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bnc"]), ['length', 'name'], globalThis["bnc"]);
$verifyProperty(globalThis["bnc"], "name", {
  value: "bound Number",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bnc"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["n"], 42.0);
