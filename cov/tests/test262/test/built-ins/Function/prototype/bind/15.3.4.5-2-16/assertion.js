...
$assert.sameValue($Object_getPrototypeOf(globalThis["testFunc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testFunc"]), true);
$assert.callable(globalThis["testFunc"]);
$assert.constructable(globalThis["testFunc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testFunc"]), ['length', 'name', 'prototype'], globalThis["testFunc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testFunc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testFunc"]?.["prototype"]), true);
$assert.notCallable(globalThis["testFunc"]?.["prototype"]);
$assert.notConstructable(globalThis["testFunc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testFunc"]?.["prototype"]), ['constructor'], globalThis["testFunc"]?.["prototype"]);
$assert.sameValue(globalThis["testFunc"]?.["prototype"]?.["constructor"], globalThis["testFunc"]);
$verifyProperty(globalThis["testFunc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testFunc"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testFunc"], "name", {
  value: "testFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testFunc"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
