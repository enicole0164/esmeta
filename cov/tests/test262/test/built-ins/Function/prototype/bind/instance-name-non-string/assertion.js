...
$assert.sameValue($Object_getPrototypeOf(globalThis["target"]?.["name"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target"]?.["name"]), true);
$assert.notCallable(globalThis["target"]?.["name"]);
$assert.notConstructable(globalThis["target"]?.["name"]);
$assert.compareArray($Reflect_ownKeys(globalThis["target"]?.["name"]), [], globalThis["target"]?.["name"]);
