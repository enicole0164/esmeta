...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['shifted'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["shifted"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["shifted"]), true);
$assert.notCallable(globalThis["obj"]?.["shifted"]);
$assert.notConstructable(globalThis["obj"]?.["shifted"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["shifted"]), ['0', '1', '2', 'length'], globalThis["obj"]?.["shifted"]);
$verifyProperty(globalThis["obj"]?.["shifted"], "1", {
  value: "inch",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["shifted"], "2", {
  value: "nails",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["shifted"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["shifted"], "0", {
  value: "nine",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "shifted", {
  writable: true,
  enumerable: true,
  configurable: true,
});
