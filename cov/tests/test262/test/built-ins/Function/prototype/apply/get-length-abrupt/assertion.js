...
$assert.compareArray($Reflect_ownKeys(globalThis["arrayLike"]), ['length'], globalThis["arrayLike"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get, "name", {
  value: "get length",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "length")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
