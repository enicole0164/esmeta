...
$assert.compareArray($Reflect_ownKeys(globalThis["arrayLike"]), ['0', '1', 'length'], globalThis["arrayLike"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get, "name", {
  value: "get 1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arrayLike"], "1")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrayLike"], "1", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
...
$verifyProperty(globalThis["arrayLike"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
