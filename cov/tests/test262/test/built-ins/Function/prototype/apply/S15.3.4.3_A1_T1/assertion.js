...
$assert.sameValue($Object_getPrototypeOf(globalThis["FACTORY"]?.["prototype"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FACTORY"]?.["prototype"]), true);
$assert.callable(globalThis["FACTORY"]?.["prototype"]);
$assert.constructable(globalThis["FACTORY"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FACTORY"]?.["prototype"]), ['length', 'name', 'prototype'], globalThis["FACTORY"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["FACTORY"]?.["prototype"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FACTORY"]?.["prototype"]?.["prototype"]), true);
$assert.notCallable(globalThis["FACTORY"]?.["prototype"]?.["prototype"]);
$assert.notConstructable(globalThis["FACTORY"]?.["prototype"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FACTORY"]?.["prototype"]?.["prototype"]), ['constructor'], globalThis["FACTORY"]?.["prototype"]?.["prototype"]);
$assert.sameValue(globalThis["FACTORY"]?.["prototype"]?.["prototype"]?.["constructor"], globalThis["FACTORY"]?.["prototype"]);
$verifyProperty(globalThis["FACTORY"]?.["prototype"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["proto"], globalThis["FACTORY"]?.["prototype"]);
