...
$assert.sameValue($Object_getPrototypeOf(globalThis["newfunc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newfunc"]), true);
$assert.callable(globalThis["newfunc"]);
$assert.constructable(globalThis["newfunc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newfunc"]), ['length', 'name', 'prototype'], globalThis["newfunc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["newfunc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newfunc"]?.["prototype"]), true);
$assert.notCallable(globalThis["newfunc"]?.["prototype"]);
$assert.notConstructable(globalThis["newfunc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newfunc"]?.["prototype"]), ['constructor'], globalThis["newfunc"]?.["prototype"]);
$assert.sameValue(globalThis["newfunc"]?.["prototype"]?.["constructor"], globalThis["newfunc"]);
$verifyProperty(globalThis["newfunc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newfunc"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["newfunc"], "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newfunc"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
