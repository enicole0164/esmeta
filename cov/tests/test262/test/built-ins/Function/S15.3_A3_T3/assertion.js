...
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]?.["prototype"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["g"]?.["prototype"]), ['constructor'], globalThis["g"]?.["prototype"]);
$assert.sameValue(globalThis["g"]?.["prototype"]?.["constructor"], globalThis["g"]);
$verifyProperty(globalThis["g"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["planet"], "mars");
