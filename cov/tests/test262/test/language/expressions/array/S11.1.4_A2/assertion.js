...
$assert.compareArray($Reflect_ownKeys(globalThis["array"]), ['0', '1', '2', 'length'], globalThis["array"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["array"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["array"]?.["1"]), true);
$assert.notCallable(globalThis["array"]?.["1"]);
$assert.notConstructable(globalThis["array"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["array"]?.["1"]), ['0', 'length'], globalThis["array"]?.["1"]);
$verifyProperty(globalThis["array"]?.["1"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["array"]?.["1"], "0", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["array"]?.["2"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["array"]?.["2"]), true);
$assert.notCallable(globalThis["array"]?.["2"]);
$assert.notConstructable(globalThis["array"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["array"]?.["2"]), ['length'], globalThis["array"]?.["2"]);
$verifyProperty(globalThis["array"]?.["2"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["array"]?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["array"]?.["0"]), true);
$assert.notCallable(globalThis["array"]?.["0"]);
$assert.notConstructable(globalThis["array"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["array"]?.["0"]), ['0', '1', 'length'], globalThis["array"]?.["0"]);
$verifyProperty(globalThis["array"]?.["0"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["array"]?.["0"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["array"]?.["0"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["subarray"], globalThis["array"]?.["2"]);
