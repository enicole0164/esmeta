...
$assert.sameValue($Object_getPrototypeOf(globalThis["retVal"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["retVal"]), true);
$assert.notCallable(globalThis["retVal"]);
$assert.notConstructable(globalThis["retVal"]);
$assert.compareArray($Reflect_ownKeys(globalThis["retVal"]), ['length', 'callee', Symbol.iterator], globalThis["retVal"]);
$assert.sameValue(globalThis["retVal"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["retVal"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["retVal"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["retVal"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["retVal"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["retVal"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), [Symbol.toPrimitive], globalThis["y"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["y"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["y"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["y"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["y"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["y"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["y"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
