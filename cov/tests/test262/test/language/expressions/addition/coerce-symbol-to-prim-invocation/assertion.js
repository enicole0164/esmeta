...
$assert.sameValue($Object_getPrototypeOf(globalThis["left"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["left"]), true);
$assert.notCallable(globalThis["left"]);
$assert.notConstructable(globalThis["left"]);
$assert.compareArray($Reflect_ownKeys(globalThis["left"]), [Symbol.toPrimitive], globalThis["left"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["left"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["left"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["left"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["left"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["left"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["left"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["left"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["left"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["left"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["left"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["left"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["left"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["leftArgs"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["leftArgs"]), true);
$assert.notCallable(globalThis["leftArgs"]);
$assert.notConstructable(globalThis["leftArgs"]);
$assert.compareArray($Reflect_ownKeys(globalThis["leftArgs"]), ['0', 'length', 'callee', Symbol.iterator], globalThis["leftArgs"]);
$assert.sameValue(globalThis["leftArgs"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["leftArgs"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["leftArgs"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["leftArgs"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["leftArgs"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["leftArgs"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["leftArgs"], "0", {
  value: "default",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["leftThisVal"], globalThis["left"]);
$assert.sameValue(globalThis["log"], "leftright");
$assert.sameValue($Object_getPrototypeOf(globalThis["right"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["right"]), true);
$assert.notCallable(globalThis["right"]);
$assert.notConstructable(globalThis["right"]);
$assert.compareArray($Reflect_ownKeys(globalThis["right"]), [Symbol.toPrimitive], globalThis["right"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["right"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["right"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["right"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["right"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["right"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["right"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["right"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["right"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["right"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["right"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["right"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["right"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["rightArgs"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rightArgs"]), true);
$assert.notCallable(globalThis["rightArgs"]);
$assert.notConstructable(globalThis["rightArgs"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rightArgs"]), ['0', 'length', 'callee', Symbol.iterator], globalThis["rightArgs"]);
$assert.sameValue(globalThis["rightArgs"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["rightArgs"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["rightArgs"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["rightArgs"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["rightArgs"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["rightArgs"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rightArgs"], "0", {
  value: "default",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["rightThisVal"], globalThis["right"]);
