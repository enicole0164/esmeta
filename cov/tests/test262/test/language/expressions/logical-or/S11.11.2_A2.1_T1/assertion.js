...
$assert.sameValue($Object_getPrototypeOf(globalThis["objectx"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objectx"]), true);
$assert.notCallable(globalThis["objectx"]);
$assert.notConstructable(globalThis["objectx"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objectx"]), ['prop'], globalThis["objectx"]);
$verifyProperty(globalThis["objectx"], "prop", {
  value: 1.1,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["objecty"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objecty"]), true);
$assert.notCallable(globalThis["objecty"]);
$assert.notConstructable(globalThis["objecty"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objecty"]), ['prop'], globalThis["objecty"]);
$verifyProperty(globalThis["objecty"], "prop", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]), Boolean.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), [], globalThis["y"]);
