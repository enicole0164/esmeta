...
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIterable"]), ['next', 'throw', 'return', Symbol.asyncIterator], globalThis["asyncIterable"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get, "name", {
  value: "get throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "throw")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncIterable"], "throw", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIterable"]?.["next"]?.["prototype"]), ['constructor'], globalThis["asyncIterable"]?.["next"]?.["prototype"]);
$assert.sameValue(globalThis["asyncIterable"]?.["next"]?.["prototype"]?.["constructor"], globalThis["asyncIterable"]?.["next"]);
$verifyProperty(globalThis["asyncIterable"]?.["next"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get, "name", {
  value: "get return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["asyncIterable"], "return")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncIterable"], "return", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
