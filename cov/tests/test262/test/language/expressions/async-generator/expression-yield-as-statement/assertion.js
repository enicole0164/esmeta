...
$assert.sameValue($Object_getPrototypeOf(globalThis["iter1"]), globalThis["g1"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["iter1"]), true);
$assert.notCallable(globalThis["iter1"]);
$assert.notConstructable(globalThis["iter1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iter1"]), [], globalThis["iter1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iter2"]), globalThis["g2"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["iter2"]), true);
$assert.notCallable(globalThis["iter2"]);
$assert.notConstructable(globalThis["iter2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iter2"]), [], globalThis["iter2"]);
