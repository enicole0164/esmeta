...
$assert.sameValue($Object_getPrototypeOf(ref), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(ref), true);
$assert.callable(ref);
$assert.notConstructable(ref);
$assert.compareArray($Reflect_ownKeys(ref), ['length', 'name', 'prototype'], ref);
$assert.sameValue($Object_getPrototypeOf(ref?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(ref?.["prototype"]), [], ref?.["prototype"]);
