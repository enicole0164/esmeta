...
$assert.sameValue($Object_getPrototypeOf(globalThis["callAsync"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["callAsync"]), ['length', 'name'], globalThis["callAsync"]);
