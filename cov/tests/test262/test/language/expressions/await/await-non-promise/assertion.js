...
$assert.sameValue($Object_getPrototypeOf(globalThis["pushAwaitSync"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["pushAwaitSync"]), true);
$assert.callable(globalThis["pushAwaitSync"]);
$assert.constructable(globalThis["pushAwaitSync"]);
$assert.compareArray($Reflect_ownKeys(globalThis["pushAwaitSync"]), ['length', 'name', 'prototype'], globalThis["pushAwaitSync"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["pushAwaitSync"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["pushAwaitSync"]?.["prototype"]), true);
$assert.notCallable(globalThis["pushAwaitSync"]?.["prototype"]);
$assert.notConstructable(globalThis["pushAwaitSync"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["pushAwaitSync"]?.["prototype"]), ['constructor'], globalThis["pushAwaitSync"]?.["prototype"]);
$assert.sameValue(globalThis["pushAwaitSync"]?.["prototype"]?.["constructor"], globalThis["pushAwaitSync"]);
$verifyProperty(globalThis["pushAwaitSync"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["pushAwaitSync"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["pushAwaitSync"], "name", {
  value: "pushAwaitSync",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["pushAwaitSync"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
