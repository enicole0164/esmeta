...
$assert.sameValue($Object_getPrototypeOf(globalThis["callAsync"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callAsync"]), true);
$assert.callable(globalThis["callAsync"]);
$assert.notConstructable(globalThis["callAsync"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callAsync"]), ['length', 'name', 'prototype'], globalThis["callAsync"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["callAsync"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["callAsync"]?.["prototype"]), true);
$assert.notCallable(globalThis["callAsync"]?.["prototype"]);
$assert.notConstructable(globalThis["callAsync"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["callAsync"]?.["prototype"]), [], globalThis["callAsync"]?.["prototype"]);
$verifyProperty(globalThis["callAsync"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["callAsync"], "name", {
  value: "callAsync",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["callAsync"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["checkAssertions"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["checkAssertions"]), true);
$assert.callable(globalThis["checkAssertions"]);
$assert.constructable(globalThis["checkAssertions"]);
$assert.compareArray($Reflect_ownKeys(globalThis["checkAssertions"]), ['length', 'name', 'prototype'], globalThis["checkAssertions"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["checkAssertions"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["checkAssertions"]?.["prototype"]), true);
$assert.notCallable(globalThis["checkAssertions"]?.["prototype"]);
$assert.notConstructable(globalThis["checkAssertions"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["checkAssertions"]?.["prototype"]), ['constructor'], globalThis["checkAssertions"]?.["prototype"]);
$assert.sameValue(globalThis["checkAssertions"]?.["prototype"]?.["constructor"], globalThis["checkAssertions"]);
$verifyProperty(globalThis["checkAssertions"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["checkAssertions"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["pushAwait"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["pushAwait"]), true);
$assert.callable(globalThis["pushAwait"]);
$assert.notConstructable(globalThis["pushAwait"]);
$assert.compareArray($Reflect_ownKeys(globalThis["pushAwait"]), ['length', 'name'], globalThis["pushAwait"]);
$verifyProperty(globalThis["pushAwait"], "name", {
  value: "pushAwait",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["pushAwait"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(actual), ['0', '1', '2', '3', 'length'], actual);
...
$assert.compareArray($Reflect_ownKeys(expected), ['0', '1', '2', '3', 'length'], expected);
...
$assert.sameValue(iterations, 2.0);
