...
$assert.compareArray($Reflect_ownKeys(actual), ['0', '1', '2', '3', '4', '5', 'length'], actual);
...
$assert.compareArray($Reflect_ownKeys(expected), ['0', '1', '2', '3', '4', '5', 'length'], expected);
...
$assert.sameValue($Object_getPrototypeOf(patched), Object.prototype);
...
$assert.sameValue(thenCallCount, 2.0);
