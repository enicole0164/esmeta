...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["bar"])), ['constructor'], $Object_getPrototypeOf(globalThis["bar"]));
...
$assert.sameValue(globalThis["count"], 2.0);
