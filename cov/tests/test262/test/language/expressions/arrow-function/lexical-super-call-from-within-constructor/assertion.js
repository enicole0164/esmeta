...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])));
...
$assert.compareArray($Reflect_ownKeys(globalThis["b"]), ['af'], globalThis["b"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["b"]?.["af"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["b"]?.["af"]), true);
$assert.callable(globalThis["b"]?.["af"]);
$assert.notConstructable(globalThis["b"]?.["af"]);
$assert.compareArray($Reflect_ownKeys(globalThis["b"]?.["af"]), ['length', 'name'], globalThis["b"]?.["af"]);
$verifyProperty(globalThis["b"]?.["af"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["b"]?.["af"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["b"], "af", {
  writable: true,
  enumerable: true,
  configurable: true,
});
