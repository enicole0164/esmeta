...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))), ['constructor', 'increment'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"]);
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"]), ['length', 'name'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"]);
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"], "name", {
  value: "increment",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["increment"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])), "increment", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"], "name", {
  value: "A",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["bar"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["bar"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["bar"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["bar"])), ['constructor', 'incrementer'], $Object_getPrototypeOf(globalThis["bar"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["bar"])?.["incrementer"]);
$verifyProperty($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"], "name", {
  value: "incrementer",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["bar"])?.["incrementer"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["bar"]), "incrementer", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["bar"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["bar"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["bar"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["bar"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["bar"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["bar"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["bar"]));
$verifyProperty($Object_getPrototypeOf(globalThis["bar"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["bar"])?.["constructor"], "name", {
  value: "B",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["bar"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["bar"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["bar"]), true);
$assert.notCallable(globalThis["bar"]);
$assert.notConstructable(globalThis["bar"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bar"]), [], globalThis["bar"]);
$assert.sameValue(globalThis["count"], 1.0);
$assert.sameValue(A, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"]))?.["constructor"]);
$assert.sameValue(B, $Object_getPrototypeOf(globalThis["bar"])?.["constructor"]);
