...
$assert.compareArray($Reflect_ownKeys(globalThis["f"]), ['af'], globalThis["f"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f"]?.["af"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f"]?.["af"]), true);
$assert.callable(globalThis["f"]?.["af"]);
$assert.notConstructable(globalThis["f"]?.["af"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f"]?.["af"]), ['length', 'name'], globalThis["f"]?.["af"]);
$verifyProperty(globalThis["f"]?.["af"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"]?.["af"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f"], "af", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["usurper"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["usurper"]), true);
$assert.notCallable(globalThis["usurper"]);
$assert.notConstructable(globalThis["usurper"]);
$assert.compareArray($Reflect_ownKeys(globalThis["usurper"]), [], globalThis["usurper"]);
