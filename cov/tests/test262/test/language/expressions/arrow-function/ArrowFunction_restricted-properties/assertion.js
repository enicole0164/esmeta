...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrowFn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrowFn"]), true);
$assert.callable(globalThis["arrowFn"]);
$assert.notConstructable(globalThis["arrowFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrowFn"]), ['length', 'name'], globalThis["arrowFn"]);
$verifyProperty(globalThis["arrowFn"], "name", {
  value: "arrowFn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arrowFn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
