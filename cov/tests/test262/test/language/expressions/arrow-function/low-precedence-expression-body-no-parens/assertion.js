...
$assert.sameValue($Object_getPrototypeOf(globalThis["square"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["square"]), true);
$assert.callable(globalThis["square"]);
$assert.notConstructable(globalThis["square"]);
$assert.compareArray($Reflect_ownKeys(globalThis["square"]), ['length', 'name'], globalThis["square"]);
$verifyProperty(globalThis["square"], "name", {
  value: "square",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["square"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
