...
$assert.sameValue($Object_getPrototypeOf(globalThis["keyMaker"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["keyMaker"]), true);
$assert.callable(globalThis["keyMaker"]);
$assert.notConstructable(globalThis["keyMaker"]);
$assert.compareArray($Reflect_ownKeys(globalThis["keyMaker"]), ['length', 'name'], globalThis["keyMaker"]);
$verifyProperty(globalThis["keyMaker"], "name", {
  value: "keyMaker",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["keyMaker"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
