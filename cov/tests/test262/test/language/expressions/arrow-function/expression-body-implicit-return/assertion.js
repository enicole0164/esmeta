...
$assert.sameValue($Object_getPrototypeOf(globalThis["plusOne"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["plusOne"]), true);
$assert.callable(globalThis["plusOne"]);
$assert.notConstructable(globalThis["plusOne"]);
$assert.compareArray($Reflect_ownKeys(globalThis["plusOne"]), ['length', 'name'], globalThis["plusOne"]);
$verifyProperty(globalThis["plusOne"], "name", {
  value: "plusOne",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["plusOne"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
