...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["result"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["result"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["result"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["result"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["result"])), ['constructor'], $Object_getPrototypeOf(globalThis["result"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["result"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["result"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["result"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["result"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["result"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["result"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["result"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["result"]));
$verifyProperty($Object_getPrototypeOf(globalThis["result"])?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["result"])?.["constructor"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["result"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["result"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['foo'], globalThis["result"]);
$verifyProperty(globalThis["result"], "foo", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
