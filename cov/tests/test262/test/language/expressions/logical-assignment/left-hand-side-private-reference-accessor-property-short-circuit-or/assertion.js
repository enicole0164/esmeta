...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'compoundAssignment'], C?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(o), ['setterWasCalled'], o);
$verifyProperty(o, "setterWasCalled", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
