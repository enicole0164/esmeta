...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'compoundAssignment', 'fieldValue'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["fieldValue"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["fieldValue"]), true);
$assert.callable(C?.["prototype"]?.["fieldValue"]);
$assert.notConstructable(C?.["prototype"]?.["fieldValue"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["fieldValue"]), ['length', 'name'], C?.["prototype"]?.["fieldValue"]);
$verifyProperty(C?.["prototype"]?.["fieldValue"], "name", {
  value: "fieldValue",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["fieldValue"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "fieldValue", {
  writable: true,
  enumerable: false,
  configurable: true,
});
