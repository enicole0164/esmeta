...
$assert.sameValue($Object_getPrototypeOf(globalThis["doNotCall"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["doNotCall"]), true);
$assert.callable(globalThis["doNotCall"]);
$assert.constructable(globalThis["doNotCall"]);
$assert.compareArray($Reflect_ownKeys(globalThis["doNotCall"]), ['length', 'name', 'prototype'], globalThis["doNotCall"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["doNotCall"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["doNotCall"]?.["prototype"]), true);
$assert.notCallable(globalThis["doNotCall"]?.["prototype"]);
$assert.notConstructable(globalThis["doNotCall"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["doNotCall"]?.["prototype"]), ['constructor'], globalThis["doNotCall"]?.["prototype"]);
$assert.sameValue(globalThis["doNotCall"]?.["prototype"]?.["constructor"], globalThis["doNotCall"]);
$verifyProperty(globalThis["doNotCall"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["doNotCall"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["doNotCall"], "name", {
  value: "doNotCall",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["doNotCall"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'compoundAssignment', 'getPrivateMethodFunctionObject'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["compoundAssignment"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["compoundAssignment"]), true);
$assert.callable(C?.["prototype"]?.["compoundAssignment"]);
$assert.notConstructable(C?.["prototype"]?.["compoundAssignment"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["compoundAssignment"]), ['length', 'name'], C?.["prototype"]?.["compoundAssignment"]);
$verifyProperty(C?.["prototype"]?.["compoundAssignment"], "name", {
  value: "compoundAssignment",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["compoundAssignment"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "compoundAssignment", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["getPrivateMethodFunctionObject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["getPrivateMethodFunctionObject"]), true);
$assert.callable(C?.["prototype"]?.["getPrivateMethodFunctionObject"]);
$assert.notConstructable(C?.["prototype"]?.["getPrivateMethodFunctionObject"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["getPrivateMethodFunctionObject"]), ['length', 'name'], C?.["prototype"]?.["getPrivateMethodFunctionObject"]);
$verifyProperty(C?.["prototype"]?.["getPrivateMethodFunctionObject"], "name", {
  value: "getPrivateMethodFunctionObject",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["getPrivateMethodFunctionObject"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "getPrivateMethodFunctionObject", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(o), C?.["prototype"]);
$assert.sameValue(Object.isExtensible(o), true);
$assert.notCallable(o);
$assert.notConstructable(o);
$assert.compareArray($Reflect_ownKeys(o), [], o);
