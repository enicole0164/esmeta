...
$assert.sameValue($Object_getPrototypeOf(globalThis["f_arg"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f_arg"]), true);
$assert.callable(globalThis["f_arg"]);
$assert.constructable(globalThis["f_arg"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f_arg"]), ['length', 'name', 'prototype'], globalThis["f_arg"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f_arg"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f_arg"]?.["prototype"]), true);
$assert.notCallable(globalThis["f_arg"]?.["prototype"]);
$assert.notConstructable(globalThis["f_arg"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f_arg"]?.["prototype"]), ['constructor'], globalThis["f_arg"]?.["prototype"]);
$assert.sameValue(globalThis["f_arg"]?.["prototype"]?.["constructor"], globalThis["f_arg"]);
$verifyProperty(globalThis["f_arg"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f_arg"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f_arg"], "name", {
  value: "f_arg",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f_arg"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
