...
$assert.sameValue($Object_getPrototypeOf(globalThis["elements"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["elements"]), true);
$assert.notCallable(globalThis["elements"]);
$assert.notConstructable(globalThis["elements"]);
$assert.compareArray($Reflect_ownKeys(globalThis["elements"]), ['0', '1', 'length'], globalThis["elements"]);
$verifyProperty(globalThis["elements"], "1", {
  value: "x = 2;",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["elements"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["elements"], "0", {
  value: "x = 1;",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["nextCount"], 3.0);
$assert.sameValue(globalThis["x"], "global");
