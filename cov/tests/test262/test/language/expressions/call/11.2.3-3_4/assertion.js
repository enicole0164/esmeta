...
$assert.sameValue(globalThis["fooCalled"], true);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['bar', 'barGetter'], globalThis["o"]);
$verifyProperty(globalThis["o"], "barGetter", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "bar")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "bar", {
  enumerable: false,
  configurable: false,
});
