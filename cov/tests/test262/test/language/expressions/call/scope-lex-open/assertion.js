...
$assert.sameValue(globalThis["n"], "outside");
...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeInside"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeInside"]), true);
$assert.callable(globalThis["probeInside"]);
$assert.constructable(globalThis["probeInside"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeInside"]), ['length', 'name', 'prototype'], globalThis["probeInside"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeInside"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeInside"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeInside"]?.["prototype"]);
$assert.notConstructable(globalThis["probeInside"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeInside"]?.["prototype"]), ['constructor'], globalThis["probeInside"]?.["prototype"]);
$assert.sameValue(globalThis["probeInside"]?.["prototype"]?.["constructor"], globalThis["probeInside"]);
$verifyProperty(globalThis["probeInside"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeInside"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeInside"], "name", {
  value: "probeInside",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeInside"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
