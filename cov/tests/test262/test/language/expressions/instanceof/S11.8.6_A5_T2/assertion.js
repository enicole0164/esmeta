...
$assert.sameValue($Object_getPrototypeOf(globalThis["__t__err"]), TypeError.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__t__err"]), true);
$assert.notCallable(globalThis["__t__err"]);
$assert.notConstructable(globalThis["__t__err"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__t__err"]), [], globalThis["__t__err"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["err__t__"]), TypeError.prototype);
$assert.sameValue(Object.isExtensible(globalThis["err__t__"]), true);
$assert.notCallable(globalThis["err__t__"]);
$assert.notConstructable(globalThis["err__t__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err__t__"]), ['message'], globalThis["err__t__"]);
$verifyProperty(globalThis["err__t__"], "message", {
  value: "failed",
  writable: true,
  enumerable: false,
  configurable: true,
