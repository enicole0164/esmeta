...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["instance"])), ['constructor', 'name'], $Object_getPrototypeOf(globalThis["instance"]));
$verifyProperty($Object_getPrototypeOf(globalThis["instance"]), "name", {
  value: "fairy",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"])?.["constructor"], globalThis["FACTORY"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]), ['prop'], globalThis["instance"]);
$verifyProperty(globalThis["instance"], "prop", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
