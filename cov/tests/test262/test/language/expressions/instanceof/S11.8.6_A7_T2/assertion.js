...
$assert.sameValue($Object_getPrototypeOf(globalThis["__arr"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__arr"]), true);
$assert.notCallable(globalThis["__arr"]);
$assert.notConstructable(globalThis["__arr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__arr"]), ['length'], globalThis["__arr"]);
$verifyProperty(globalThis["__arr"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
