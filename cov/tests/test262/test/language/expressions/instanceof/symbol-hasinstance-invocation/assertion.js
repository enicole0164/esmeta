...
$assert.sameValue($Object_getPrototypeOf(globalThis["F"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["F"]), [Symbol.hasInstance], globalThis["F"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["F"]?.[Symbol.hasInstance]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["F"]?.[Symbol.hasInstance]), true);
$assert.callable(globalThis["F"]?.[Symbol.hasInstance]);
$assert.constructable(globalThis["F"]?.[Symbol.hasInstance]);
$assert.compareArray($Reflect_ownKeys(globalThis["F"]?.[Symbol.hasInstance]), ['length', 'name', 'prototype'], globalThis["F"]?.[Symbol.hasInstance]);
$assert.sameValue($Object_getPrototypeOf(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]), true);
$assert.notCallable(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]);
$assert.notConstructable(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]), ['constructor'], globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]);
$assert.sameValue(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"]?.["constructor"], globalThis["F"]?.[Symbol.hasInstance]);
$verifyProperty(globalThis["F"]?.[Symbol.hasInstance]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["F"]?.[Symbol.hasInstance], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["F"]?.[Symbol.hasInstance], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["F"]?.[Symbol.hasInstance], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["F"], Symbol.hasInstance, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["thisValue"], globalThis["F"]);
