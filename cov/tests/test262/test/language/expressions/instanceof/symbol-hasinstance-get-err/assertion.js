...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["F"], Symbol.hasInstance)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
