...
$assert.sameValue($Object_getPrototypeOf(globalThis["FAKEFACTORY"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FAKEFACTORY"]), true);
$assert.callable(globalThis["FAKEFACTORY"]);
$assert.constructable(globalThis["FAKEFACTORY"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FAKEFACTORY"]), ['length', 'name', 'prototype'], globalThis["FAKEFACTORY"]);
$assert.sameValue(globalThis["FAKEFACTORY"]?.["prototype"], Object.prototype);
$verifyProperty(globalThis["FAKEFACTORY"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["FAKEFACTORY"], "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FAKEFACTORY"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["fakeinstance"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fakeinstance"]), true);
$assert.notCallable(globalThis["fakeinstance"]);
$assert.notConstructable(globalThis["fakeinstance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fakeinstance"]), [], globalThis["fakeinstance"]);
