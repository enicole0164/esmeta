...
$assert.sameValue($Object_getPrototypeOf(globalThis["MyFunct"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyFunct"]), true);
$assert.callable(globalThis["MyFunct"]);
$assert.constructable(globalThis["MyFunct"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyFunct"]), ['length', 'name', 'prototype'], globalThis["MyFunct"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["MyFunct"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyFunct"]?.["prototype"]), true);
$assert.notCallable(globalThis["MyFunct"]?.["prototype"]);
$assert.notConstructable(globalThis["MyFunct"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyFunct"]?.["prototype"]), ['constructor'], globalThis["MyFunct"]?.["prototype"]);
$assert.sameValue(globalThis["MyFunct"]?.["prototype"]?.["constructor"], globalThis["MyFunct"]);
$verifyProperty(globalThis["MyFunct"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyFunct"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["MyFunct"], "name", {
  value: "MyFunct",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyFunct"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__my__funct"]), globalThis["MyFunct"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__my__funct"]), true);
$assert.notCallable(globalThis["__my__funct"]);
$assert.notConstructable(globalThis["__my__funct"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__my__funct"]), [], globalThis["__my__funct"]);
