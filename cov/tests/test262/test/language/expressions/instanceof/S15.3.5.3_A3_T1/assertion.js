...
$assert.compareArray($Reflect_ownKeys(globalThis["FACTORY"]?.["prototype"]), ['constructor', 'type'], globalThis["FACTORY"]?.["prototype"]);
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "type", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"]), globalThis["FACTORY"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]), ['name'], globalThis["instance"]);
$verifyProperty(globalThis["instance"], "name", {
  value: "root",
  writable: true,
  enumerable: true,
  configurable: true,
