...
$assert.sameValue($Object_getPrototypeOf(globalThis["DummyError"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["DummyError"]), true);
$assert.callable(globalThis["DummyError"]);
$assert.constructable(globalThis["DummyError"]);
$assert.compareArray($Reflect_ownKeys(globalThis["DummyError"]), ['length', 'name', 'prototype'], globalThis["DummyError"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["DummyError"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["DummyError"]?.["prototype"]), true);
$assert.notCallable(globalThis["DummyError"]?.["prototype"]);
$assert.notConstructable(globalThis["DummyError"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["DummyError"]?.["prototype"]), ['constructor'], globalThis["DummyError"]?.["prototype"]);
$assert.sameValue(globalThis["DummyError"]?.["prototype"]?.["constructor"], globalThis["DummyError"]);
$verifyProperty(globalThis["DummyError"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["DummyError"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["DummyError"], "name", {
  value: "DummyError",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["DummyError"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["getterCalled"], true);
