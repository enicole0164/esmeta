...
$assert.sameValue($Object_getPrototypeOf(globalThis["__err"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__err"]), true);
$assert.notCallable(globalThis["__err"]);
$assert.notConstructable(globalThis["__err"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__err"]), [], globalThis["__err"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["err__"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["err__"]), true);
$assert.notCallable(globalThis["err__"]);
$assert.notConstructable(globalThis["err__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err__"]), ['message'], globalThis["err__"]);
$verifyProperty(globalThis["err__"], "message", {
  value: "failed",
  writable: true,
  enumerable: false,
  configurable: true,
