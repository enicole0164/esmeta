...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'compoundAssignment', 'setterCalledWithValue'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["setterCalledWithValue"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["setterCalledWithValue"]), true);
$assert.callable(C?.["prototype"]?.["setterCalledWithValue"]);
$assert.notConstructable(C?.["prototype"]?.["setterCalledWithValue"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["setterCalledWithValue"]), ['length', 'name'], C?.["prototype"]?.["setterCalledWithValue"]);
$verifyProperty(C?.["prototype"]?.["setterCalledWithValue"], "name", {
  value: "setterCalledWithValue",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["setterCalledWithValue"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "setterCalledWithValue", {
  writable: true,
  enumerable: false,
  configurable: true,
});
