...
$assert.compareArray($Reflect_ownKeys(globalThis["base"]), [''], globalThis["base"]);
$verifyProperty(globalThis["base"], "", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["expr"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["expr"]), true);
$assert.callable(globalThis["expr"]);
$assert.constructable(globalThis["expr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["expr"]), ['length', 'name', 'prototype'], globalThis["expr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["expr"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["expr"]?.["prototype"]), true);
$assert.notCallable(globalThis["expr"]?.["prototype"]);
$assert.notConstructable(globalThis["expr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["expr"]?.["prototype"]), ['constructor'], globalThis["expr"]?.["prototype"]);
$assert.sameValue(globalThis["expr"]?.["prototype"]?.["constructor"], globalThis["expr"]);
$verifyProperty(globalThis["expr"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["expr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["expr"], "name", {
  value: "expr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["expr"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["prop"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["prop"]), true);
$assert.notCallable(globalThis["prop"]);
$assert.notConstructable(globalThis["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["prop"]), ['toString'], globalThis["prop"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["prop"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["prop"]?.["toString"]), true);
$assert.callable(globalThis["prop"]?.["toString"]);
$assert.constructable(globalThis["prop"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["prop"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["prop"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["prop"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["prop"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["prop"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["prop"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["prop"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["prop"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["prop"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["prop"]?.["toString"]);
$verifyProperty(globalThis["prop"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["prop"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["prop"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["prop"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["prop"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["propKeyEvaluated"], true);
