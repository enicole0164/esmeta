...
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x"]?.["0"]), true);
$assert.notCallable(globalThis["x"]?.["0"]);
$assert.notConstructable(globalThis["x"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x"]?.["0"]), ['z'], globalThis["x"]?.["0"]);
$verifyProperty(globalThis["x"]?.["0"], "z", {
  value: 0n,
  writable: true,
  enumerable: true,
  configurable: true,
