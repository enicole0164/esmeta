...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['valueOf'], globalThis["obj2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["valueOf"]), true);
$assert.callable(globalThis["obj2"]?.["valueOf"]);
$assert.constructable(globalThis["obj2"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["obj2"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj2"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["obj2"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["obj2"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["obj2"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["obj2"]?.["valueOf"]);
$verifyProperty(globalThis["obj2"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj2"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
