...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['m'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get, "name", {
  value: "get m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "m")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "m", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
