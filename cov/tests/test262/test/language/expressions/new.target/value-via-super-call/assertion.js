...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])));
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]?.["constructor"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])), "name", {
  value: "Base",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["baseNewTarget"])), true);
$assert.callable($Object_getPrototypeOf(globalThis["baseNewTarget"]));
$assert.constructable($Object_getPrototypeOf(globalThis["baseNewTarget"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["baseNewTarget"])), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["baseNewTarget"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"]))?.["prototype"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]), ['constructor'], $Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["baseNewTarget"]));
$verifyProperty($Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["baseNewTarget"]), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["baseNewTarget"]), "name", {
  value: "Parent",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["baseNewTarget"]), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["baseNewTarget"]), true);
$assert.callable(globalThis["baseNewTarget"]);
$assert.constructable(globalThis["baseNewTarget"]);
$assert.compareArray($Reflect_ownKeys(globalThis["baseNewTarget"]), ['length', 'name', 'prototype'], globalThis["baseNewTarget"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["baseNewTarget"]?.["prototype"]), $Object_getPrototypeOf(globalThis["baseNewTarget"])?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["baseNewTarget"]?.["prototype"]), true);
$assert.notCallable(globalThis["baseNewTarget"]?.["prototype"]);
$assert.notConstructable(globalThis["baseNewTarget"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["baseNewTarget"]?.["prototype"]), ['constructor'], globalThis["baseNewTarget"]?.["prototype"]);
$assert.sameValue(globalThis["baseNewTarget"]?.["prototype"]?.["constructor"], globalThis["baseNewTarget"]);
$verifyProperty(globalThis["baseNewTarget"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["baseNewTarget"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["baseNewTarget"], "name", {
  value: "Child",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["baseNewTarget"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["parentNewTarget"], globalThis["baseNewTarget"]);
$assert.sameValue(Base, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["baseNewTarget"])));
$assert.sameValue(Child, globalThis["baseNewTarget"]);
$assert.sameValue(Parent, $Object_getPrototypeOf(globalThis["baseNewTarget"]));
