...
$assert.sameValue(globalThis["newTarget"], undefined);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(Child)), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(Child)), true);
$assert.callable($Object_getPrototypeOf(Child));
$assert.constructable($Object_getPrototypeOf(Child));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(Child)), ['length', 'name', 'prototype'], $Object_getPrototypeOf(Child));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(Child)?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(Child)?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(Child)?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(Child)?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(Child)?.["prototype"]), ['constructor', 'attr'], $Object_getPrototypeOf(Child)?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get, "name", {
  value: "get attr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Child)?.["prototype"], "attr")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Child)?.["prototype"], "attr", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Child)?.["prototype"]?.["constructor"], $Object_getPrototypeOf(Child));
$verifyProperty($Object_getPrototypeOf(Child)?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Child), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(Child), "name", {
  value: "Parent",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Child), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(Child), true);
$assert.callable(Child);
$assert.constructable(Child);
$assert.compareArray($Reflect_ownKeys(Child), ['length', 'name', 'prototype'], Child);
$assert.sameValue($Object_getPrototypeOf(Child?.["prototype"]), $Object_getPrototypeOf(Child)?.["prototype"]);
$assert.sameValue(Object.isExtensible(Child?.["prototype"]), true);
$assert.notCallable(Child?.["prototype"]);
$assert.notConstructable(Child?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Child?.["prototype"]), ['constructor'], Child?.["prototype"]);
$assert.sameValue(Child?.["prototype"]?.["constructor"], Child);
$verifyProperty(Child?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Child, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Child, "name", {
  value: "Child",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Child, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Parent, $Object_getPrototypeOf(Child));
