...
$assert.sameValue($Object_getPrototypeOf(globalThis["newTarget"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newTarget"]), true);
$assert.callable(globalThis["newTarget"]);
$assert.constructable(globalThis["newTarget"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newTarget"]), ['length', 'name', 'prototype'], globalThis["newTarget"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["newTarget"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["newTarget"]?.["prototype"]), true);
$assert.notCallable(globalThis["newTarget"]?.["prototype"]);
$assert.notConstructable(globalThis["newTarget"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["newTarget"]?.["prototype"]), ['constructor'], globalThis["newTarget"]?.["prototype"]);
$assert.sameValue(globalThis["newTarget"]?.["prototype"]?.["constructor"], globalThis["newTarget"]);
$verifyProperty(globalThis["newTarget"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newTarget"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["newTarget"], "name", {
  value: "withMLC",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["newTarget"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["withLineBreaks"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withLineBreaks"]), true);
$assert.callable(globalThis["withLineBreaks"]);
$assert.constructable(globalThis["withLineBreaks"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withLineBreaks"]), ['length', 'name', 'prototype'], globalThis["withLineBreaks"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["withLineBreaks"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withLineBreaks"]?.["prototype"]), true);
$assert.notCallable(globalThis["withLineBreaks"]?.["prototype"]);
$assert.notConstructable(globalThis["withLineBreaks"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withLineBreaks"]?.["prototype"]), ['constructor'], globalThis["withLineBreaks"]?.["prototype"]);
$assert.sameValue(globalThis["withLineBreaks"]?.["prototype"]?.["constructor"], globalThis["withLineBreaks"]);
$verifyProperty(globalThis["withLineBreaks"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withLineBreaks"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["withLineBreaks"], "name", {
  value: "withLineBreaks",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withLineBreaks"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["withMLC"], globalThis["newTarget"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["withSLDC"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withSLDC"]), true);
$assert.callable(globalThis["withSLDC"]);
$assert.constructable(globalThis["withSLDC"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withSLDC"]), ['length', 'name', 'prototype'], globalThis["withSLDC"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["withSLDC"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withSLDC"]?.["prototype"]), true);
$assert.notCallable(globalThis["withSLDC"]?.["prototype"]);
$assert.notConstructable(globalThis["withSLDC"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withSLDC"]?.["prototype"]), ['constructor'], globalThis["withSLDC"]?.["prototype"]);
$assert.sameValue(globalThis["withSLDC"]?.["prototype"]?.["constructor"], globalThis["withSLDC"]);
$verifyProperty(globalThis["withSLDC"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withSLDC"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["withSLDC"], "name", {
  value: "withSLDC",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withSLDC"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["withSpaces"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withSpaces"]), true);
$assert.callable(globalThis["withSpaces"]);
$assert.constructable(globalThis["withSpaces"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withSpaces"]), ['length', 'name', 'prototype'], globalThis["withSpaces"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["withSpaces"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["withSpaces"]?.["prototype"]), true);
$assert.notCallable(globalThis["withSpaces"]?.["prototype"]);
$assert.notConstructable(globalThis["withSpaces"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["withSpaces"]?.["prototype"]), ['constructor'], globalThis["withSpaces"]?.["prototype"]);
$assert.sameValue(globalThis["withSpaces"]?.["prototype"]?.["constructor"], globalThis["withSpaces"]);
$verifyProperty(globalThis["withSpaces"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withSpaces"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["withSpaces"], "name", {
  value: "withSpaces",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["withSpaces"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
