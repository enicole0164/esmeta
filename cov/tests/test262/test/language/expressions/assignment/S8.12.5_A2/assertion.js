...
$assert.sameValue($Object_getPrototypeOf(globalThis["_map"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_map"]), true);
$assert.notCallable(globalThis["_map"]);
$assert.notConstructable(globalThis["_map"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_map"]), ['1', 'two'], globalThis["_map"]);
$verifyProperty(globalThis["_map"], "1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["_map"], "two", {
  value: "duo",
  writable: true,
  enumerable: true,
  configurable: true,
