...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrow"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrow"]), true);
$assert.callable(globalThis["arrow"]);
$assert.notConstructable(globalThis["arrow"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrow"]), ['length'], globalThis["arrow"]);
$verifyProperty(globalThis["arrow"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
