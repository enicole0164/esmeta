...
$assert.compareArray($Reflect_ownKeys(globalThis["keys"]), ['0', '1', 'length'], globalThis["keys"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), ['y', 'z'], globalThis["z"]);
$verifyProperty(globalThis["z"], "y", {
  value: 39.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["z"], "z", {
  value: "cheeseburger",
  writable: true,
  enumerable: true,
  configurable: true,
