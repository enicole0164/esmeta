...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["x"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["x"]), ['y'], globalThis["result"]?.["x"]);
$verifyProperty(globalThis["result"]?.["x"], "y", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
