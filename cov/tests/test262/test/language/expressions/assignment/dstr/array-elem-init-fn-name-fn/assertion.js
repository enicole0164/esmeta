...
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"]), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["xFn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xFn"]), true);
$assert.callable(globalThis["xFn"]);
$assert.constructable(globalThis["xFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xFn"]), ['length', 'name', 'prototype'], globalThis["xFn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["xFn"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xFn"]?.["prototype"]), true);
$assert.notCallable(globalThis["xFn"]?.["prototype"]);
$assert.notConstructable(globalThis["xFn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xFn"]?.["prototype"]), ['constructor'], globalThis["xFn"]?.["prototype"]);
$assert.sameValue(globalThis["xFn"]?.["prototype"]?.["constructor"], globalThis["xFn"]);
$verifyProperty(globalThis["xFn"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xFn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["xFn"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xFn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
