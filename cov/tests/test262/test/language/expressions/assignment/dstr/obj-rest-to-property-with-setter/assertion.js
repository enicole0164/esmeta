...
$assert.sameValue(globalThis["executedGetter"], false);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['x', 'y'], globalThis["result"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["settedValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["settedValue"]), true);
$assert.notCallable(globalThis["settedValue"]);
$assert.notConstructable(globalThis["settedValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["settedValue"]), ['x', 'y'], globalThis["settedValue"]);
$verifyProperty(globalThis["settedValue"], "x", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["settedValue"], "y", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["src"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["src"]), true);
$assert.notCallable(globalThis["src"]);
$assert.notConstructable(globalThis["src"]);
$assert.compareArray($Reflect_ownKeys(globalThis["src"]), ['y'], globalThis["src"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get, "name", {
  value: "get y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set, "name", {
  value: "set y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["src"], "y")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["src"], "y", {
  enumerable: true,
  configurable: true,
});
