...
$assert.sameValue($Object_getPrototypeOf(globalThis["setValue"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setValue"]), true);
$assert.notCallable(globalThis["setValue"]);
$assert.notConstructable(globalThis["setValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setValue"]), ['0', '1', '2', 'length'], globalThis["setValue"]);
$verifyProperty(globalThis["setValue"], "1", {
  value: 45.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["setValue"], "2", {
  value: 99.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["setValue"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setValue"], "0", {
  value: 23.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['y'], globalThis["x"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get, "name", {
  value: "get y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set, "name", {
  value: "set y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["x"], "y")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["x"], "y", {
  enumerable: true,
  configurable: true,
});
