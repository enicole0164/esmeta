...
$assert.sameValue(globalThis["a"], "foo");
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['foo', 'bar', 'baz'], globalThis["result"]);
...
$verifyProperty(globalThis["result"], "baz", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
