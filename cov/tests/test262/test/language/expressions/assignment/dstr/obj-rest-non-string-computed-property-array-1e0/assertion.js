...
$assert.sameValue($Object_getPrototypeOf(globalThis["b"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["b"]), ['0', 'length'], globalThis["b"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["rest"]), [], globalThis["rest"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['1', 'bar'], globalThis["result"]);
$assert.sameValue(globalThis["result"]?.["1"], globalThis["b"]);
$verifyProperty(globalThis["result"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["result"], "bar", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
