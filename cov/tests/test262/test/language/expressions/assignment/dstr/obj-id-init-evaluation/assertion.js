...
$assert.sameValue(globalThis["flag1"], true);
$assert.sameValue(globalThis["flag2"], false);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['y'], globalThis["result"]);
