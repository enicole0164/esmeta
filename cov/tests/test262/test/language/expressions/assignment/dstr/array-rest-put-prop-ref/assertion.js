...
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]?.["y"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x"]?.["y"]), true);
$assert.notCallable(globalThis["x"]?.["y"]);
$assert.notConstructable(globalThis["x"]?.["y"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x"]?.["y"]), ['0', '1', '2', 'length'], globalThis["x"]?.["y"]);
$verifyProperty(globalThis["x"]?.["y"], "1", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["x"]?.["y"], "2", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["x"]?.["y"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["x"]?.["y"], "0", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
