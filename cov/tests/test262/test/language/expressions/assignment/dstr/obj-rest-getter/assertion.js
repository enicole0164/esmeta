...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['v'], globalThis["result"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get, "name", {
  value: "get v",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["result"], "v")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["result"], "v", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
