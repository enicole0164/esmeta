...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['ab'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["ab"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["ab"]), true);
$assert.notCallable(globalThis["obj"]?.["ab"]);
$assert.notConstructable(globalThis["obj"]?.["ab"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["ab"]), ['length'], globalThis["obj"]?.["ab"]);
$verifyProperty(globalThis["obj"]?.["ab"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"], "ab", {
  writable: true,
  enumerable: true,
  configurable: true,
});
