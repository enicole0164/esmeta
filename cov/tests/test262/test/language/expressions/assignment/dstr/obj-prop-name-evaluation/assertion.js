...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['x', 'xy', 'y'], globalThis["result"]);
$verifyProperty(globalThis["result"], "xy", {
  value: 23.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["xy"], undefined);
