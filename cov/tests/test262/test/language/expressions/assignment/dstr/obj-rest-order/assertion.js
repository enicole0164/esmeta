...
$assert.sameValue($Object_getPrototypeOf(globalThis["rest"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rest"]), true);
$assert.notCallable(globalThis["rest"]);
$assert.notConstructable(globalThis["rest"]);
$verifyProperty(globalThis["rest"], "1", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["rest"], "a", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["rest"], "z", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["result"], globalThis["o"]);
