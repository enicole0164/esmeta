...
$assert.sameValue($Object_getPrototypeOf(globalThis["gen"]), GeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["gen"]), ['length', 'prototype'], globalThis["gen"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gen"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["xGen"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xGen"]), true);
$assert.callable(globalThis["xGen"]);
$assert.notConstructable(globalThis["xGen"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xGen"]), ['length', 'name', 'prototype'], globalThis["xGen"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["xGen"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xGen"]?.["prototype"]), true);
$assert.notCallable(globalThis["xGen"]?.["prototype"]);
$assert.notConstructable(globalThis["xGen"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xGen"]?.["prototype"]), [], globalThis["xGen"]?.["prototype"]);
$verifyProperty(globalThis["xGen"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["xGen"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xGen"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
