...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['x'], globalThis["result"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["x"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["x"]), true);
$assert.notCallable(globalThis["result"]?.["x"]);
$assert.notConstructable(globalThis["result"]?.["x"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["x"]), ['0', 'length'], globalThis["result"]?.["x"]);
$verifyProperty(globalThis["result"]?.["x"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["result"]?.["x"], "0", {
  value: 321.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["y"], 321.0);
