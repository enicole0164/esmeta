...
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]?.["prop"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x"]?.["prop"]), true);
$assert.notCallable(globalThis["x"]?.["prop"]);
$assert.notConstructable(globalThis["x"]?.["prop"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x"]?.["prop"]), ['0', '1', '2', 'length'], globalThis["x"]?.["prop"]);
$verifyProperty(globalThis["x"]?.["prop"], "1", {
  value: 44.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["x"]?.["prop"], "2", {
  value: 55.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["x"]?.["prop"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["x"]?.["prop"], "0", {
  value: 33.0,
  writable: true,
  enumerable: true,
  configurable: true,
