...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["0"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["0"]), ['x'], globalThis["result"]?.["0"]);
$verifyProperty(globalThis["result"]?.["0"], "x", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
