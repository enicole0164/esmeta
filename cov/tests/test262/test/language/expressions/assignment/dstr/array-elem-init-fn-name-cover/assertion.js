...
$assert.sameValue($Object_getPrototypeOf(globalThis["cover"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cover"]), true);
$assert.callable(globalThis["cover"]);
$assert.constructable(globalThis["cover"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cover"]), ['length', 'prototype'], globalThis["cover"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cover"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cover"]?.["prototype"]), true);
$assert.notCallable(globalThis["cover"]?.["prototype"]);
$assert.notConstructable(globalThis["cover"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cover"]?.["prototype"]), ['constructor'], globalThis["cover"]?.["prototype"]);
$assert.sameValue(globalThis["cover"]?.["prototype"]?.["constructor"], globalThis["cover"]);
$verifyProperty(globalThis["cover"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cover"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["cover"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["xCover"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCover"]), true);
$assert.callable(globalThis["xCover"]);
$assert.constructable(globalThis["xCover"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCover"]), ['length', 'name', 'prototype'], globalThis["xCover"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["xCover"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCover"]?.["prototype"]), true);
$assert.notCallable(globalThis["xCover"]?.["prototype"]);
$assert.notConstructable(globalThis["xCover"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCover"]?.["prototype"]), ['constructor'], globalThis["xCover"]?.["prototype"]);
$assert.sameValue(globalThis["xCover"]?.["prototype"]?.["constructor"], globalThis["xCover"]);
$verifyProperty(globalThis["xCover"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCover"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["xCover"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCover"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
