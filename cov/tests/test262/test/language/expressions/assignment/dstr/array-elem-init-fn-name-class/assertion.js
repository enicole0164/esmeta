...
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]), ['length', 'prototype'], globalThis["cls"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]?.["prototype"]), ['constructor'], globalThis["cls"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['length'], globalThis["result"]);
...
$assert.sameValue(globalThis["vals"], globalThis["result"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["xCls"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCls"]), true);
$assert.callable(globalThis["xCls"]);
$assert.constructable(globalThis["xCls"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCls"]), ['length', 'name', 'prototype'], globalThis["xCls"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["xCls"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCls"]?.["prototype"]), true);
$assert.notCallable(globalThis["xCls"]?.["prototype"]);
$assert.notConstructable(globalThis["xCls"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCls"]?.["prototype"]), ['constructor'], globalThis["xCls"]?.["prototype"]);
$assert.sameValue(globalThis["xCls"]?.["prototype"]?.["constructor"], globalThis["xCls"]);
$verifyProperty(globalThis["xCls"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCls"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["xCls"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCls"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["xCls2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCls2"]), true);
$assert.callable(globalThis["xCls2"]);
$assert.constructable(globalThis["xCls2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCls2"]), ['length', 'name', 'prototype'], globalThis["xCls2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["xCls2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCls2"]?.["prototype"]), true);
$assert.notCallable(globalThis["xCls2"]?.["prototype"]);
$assert.notConstructable(globalThis["xCls2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCls2"]?.["prototype"]), ['constructor'], globalThis["xCls2"]?.["prototype"]);
$assert.sameValue(globalThis["xCls2"]?.["prototype"]?.["constructor"], globalThis["xCls2"]);
$verifyProperty(globalThis["xCls2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCls2"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["xCls2"]?.["name"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["xCls2"]?.["name"]), true);
$assert.callable(globalThis["xCls2"]?.["name"]);
$assert.notConstructable(globalThis["xCls2"]?.["name"]);
$assert.compareArray($Reflect_ownKeys(globalThis["xCls2"]?.["name"]), ['length', 'name'], globalThis["xCls2"]?.["name"]);
$verifyProperty(globalThis["xCls2"]?.["name"], "name", {
  value: "name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCls2"]?.["name"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCls2"], "name", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["xCls2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
