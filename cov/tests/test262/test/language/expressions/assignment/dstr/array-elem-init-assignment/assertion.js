...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['0', '1', '3', 'length'], globalThis["result"]);
...
$assert.sameValue(globalThis["v2"], 2.0);
$assert.sameValue(globalThis["vHole"], 12.0);
$assert.sameValue(globalThis["vNull"], null);
$assert.sameValue(globalThis["vOob"], 14.0);
$assert.sameValue(globalThis["vUndefined"], 13.0);
