...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['attr'], globalThis["o"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["attr"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["attr"]), true);
$assert.callable(globalThis["o"]?.["attr"]);
$assert.constructable(globalThis["o"]?.["attr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["attr"]), ['length', 'prototype'], globalThis["o"]?.["attr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["attr"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["attr"]?.["prototype"]), true);
$assert.notCallable(globalThis["o"]?.["attr"]?.["prototype"]);
$assert.notConstructable(globalThis["o"]?.["attr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["attr"]?.["prototype"]), ['constructor'], globalThis["o"]?.["attr"]?.["prototype"]);
$assert.sameValue(globalThis["o"]?.["attr"]?.["prototype"]?.["constructor"], globalThis["o"]?.["attr"]);
$verifyProperty(globalThis["o"]?.["attr"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["attr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o"]?.["attr"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "attr", {
  writable: true,
  enumerable: true,
  configurable: true,
});
