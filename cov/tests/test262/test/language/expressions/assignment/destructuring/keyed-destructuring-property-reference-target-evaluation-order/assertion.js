...
$assert.compareArray($Reflect_ownKeys(globalThis["log"]), ['0', '1', '2', '3', '4', '5', '6', '7', 'length'], globalThis["log"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["source"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["source"]), true);
$assert.callable(globalThis["source"]);
$assert.constructable(globalThis["source"]);
$assert.compareArray($Reflect_ownKeys(globalThis["source"]), ['length', 'name', 'prototype'], globalThis["source"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["source"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["source"]?.["prototype"]), true);
$assert.notCallable(globalThis["source"]?.["prototype"]);
$assert.notConstructable(globalThis["source"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["source"]?.["prototype"]), ['constructor'], globalThis["source"]?.["prototype"]);
$assert.sameValue(globalThis["source"]?.["prototype"]?.["constructor"], globalThis["source"]);
$verifyProperty(globalThis["source"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["source"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["source"], "name", {
  value: "source",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["source"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["sourceKey"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sourceKey"]), true);
$assert.callable(globalThis["sourceKey"]);
$assert.constructable(globalThis["sourceKey"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sourceKey"]), ['length', 'name', 'prototype'], globalThis["sourceKey"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["sourceKey"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sourceKey"]?.["prototype"]), true);
$assert.notCallable(globalThis["sourceKey"]?.["prototype"]);
$assert.notConstructable(globalThis["sourceKey"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sourceKey"]?.["prototype"]), ['constructor'], globalThis["sourceKey"]?.["prototype"]);
$assert.sameValue(globalThis["sourceKey"]?.["prototype"]?.["constructor"], globalThis["sourceKey"]);
$verifyProperty(globalThis["sourceKey"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sourceKey"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sourceKey"], "name", {
  value: "sourceKey",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sourceKey"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["target"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target"]), true);
$assert.callable(globalThis["target"]);
$assert.constructable(globalThis["target"]);
$assert.compareArray($Reflect_ownKeys(globalThis["target"]), ['length', 'name', 'prototype'], globalThis["target"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["target"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target"]?.["prototype"]), true);
$assert.notCallable(globalThis["target"]?.["prototype"]);
$assert.notConstructable(globalThis["target"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["target"]?.["prototype"]), ['constructor'], globalThis["target"]?.["prototype"]);
$assert.sameValue(globalThis["target"]?.["prototype"]?.["constructor"], globalThis["target"]);
$verifyProperty(globalThis["target"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["target"], "name", {
  value: "target",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["targetKey"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["targetKey"]), true);
$assert.callable(globalThis["targetKey"]);
$assert.constructable(globalThis["targetKey"]);
$assert.compareArray($Reflect_ownKeys(globalThis["targetKey"]), ['length', 'name', 'prototype'], globalThis["targetKey"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["targetKey"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["targetKey"]?.["prototype"]), true);
$assert.notCallable(globalThis["targetKey"]?.["prototype"]);
$assert.notConstructable(globalThis["targetKey"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["targetKey"]?.["prototype"]), ['constructor'], globalThis["targetKey"]?.["prototype"]);
$assert.sameValue(globalThis["targetKey"]?.["prototype"]?.["constructor"], globalThis["targetKey"]);
$verifyProperty(globalThis["targetKey"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["targetKey"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["targetKey"], "name", {
  value: "targetKey",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["targetKey"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
