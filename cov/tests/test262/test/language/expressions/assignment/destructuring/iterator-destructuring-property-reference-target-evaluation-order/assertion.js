...
$assert.compareArray($Reflect_ownKeys(globalThis["target"]), ['q'], globalThis["target"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set, "name", {
  value: "set q",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target"], "q")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target"], "q", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
