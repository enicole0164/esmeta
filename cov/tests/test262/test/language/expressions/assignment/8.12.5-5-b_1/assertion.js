...
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]), true);
$assert.notCallable(globalThis["descArray"]);
$assert.notConstructable(globalThis["descArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]), ['0', '1', 'length'], globalThis["descArray"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]), true);
$assert.notCallable(globalThis["descArray"]?.["1"]);
$assert.notConstructable(globalThis["descArray"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["descArray"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]?.["get"]), true);
$assert.callable(globalThis["descArray"]?.["1"]?.["get"]);
$assert.constructable(globalThis["descArray"]?.["1"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]?.["get"]), ['length', 'name', 'prototype'], globalThis["descArray"]?.["1"]?.["get"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]), true);
$assert.notCallable(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]);
$assert.notConstructable(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]), ['constructor'], globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]);
$assert.sameValue(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"]?.["constructor"], globalThis["descArray"]?.["1"]?.["get"]);
$verifyProperty(globalThis["descArray"]?.["1"]?.["get"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["get"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["get"], "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]?.["set"]), true);
$assert.callable(globalThis["descArray"]?.["1"]?.["set"]);
$assert.constructable(globalThis["descArray"]?.["1"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]?.["set"]), ['length', 'name', 'prototype'], globalThis["descArray"]?.["1"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]), ['constructor'], globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"]?.["constructor"], globalThis["descArray"]?.["1"]?.["set"]);
$verifyProperty(globalThis["descArray"]?.["1"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["set"], "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["set"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["0"]), true);
$assert.notCallable(globalThis["descArray"]?.["0"]);
$assert.notConstructable(globalThis["descArray"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["0"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["descArray"]?.["0"]);
$assert.sameValue(globalThis["descArray"]?.["0"]?.["get"], globalThis["descArray"]?.["1"]?.["get"]);
$verifyProperty(globalThis["descArray"]?.["0"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["0"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["0"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["descArray"]?.["0"]?.["set"], globalThis["descArray"]?.["1"]?.["set"]);
$verifyProperty(globalThis["descArray"]?.["0"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["i"], "configurable");
$assert.sameValue(globalThis["j"], "1");
$assert.sameValue(globalThis["newDesc"], globalThis["descArray"]?.["1"]);
$assert.sameValue(globalThis["origDesc"], globalThis["descArray"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["tempObj"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["tempObj"]), true);
$assert.notCallable(globalThis["tempObj"]);
$assert.notConstructable(globalThis["tempObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["tempObj"]), ['reduce'], globalThis["tempObj"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["tempObj"], "reduce")?.get, globalThis["descArray"]?.["1"]?.["get"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["tempObj"], "reduce")?.set, globalThis["descArray"]?.["1"]?.["set"]);
$verifyProperty(globalThis["tempObj"], "reduce", {
  enumerable: false,
  configurable: false,
});
