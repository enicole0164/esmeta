...
$assert.compareArray($Reflect_ownKeys(globalThis["__map"]), ['1', '3', 'two'], globalThis["__map"]);
$verifyProperty(globalThis["__map"], "1", {
  value: "one",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__map"], "two", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__map"], "3", {
  value: "tre",
  writable: true,
  enumerable: true,
  configurable: true,
