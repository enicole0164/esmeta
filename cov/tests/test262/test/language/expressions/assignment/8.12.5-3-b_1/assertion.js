...
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["descArray"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]?.["value"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]?.["value"]), true);
$assert.callable(globalThis["descArray"]?.["1"]?.["value"]);
$assert.constructable(globalThis["descArray"]?.["1"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]?.["value"]), ['length', 'name', 'prototype'], globalThis["descArray"]?.["1"]?.["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]), true);
$assert.notCallable(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]);
$assert.notConstructable(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]), ['constructor'], globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]);
$assert.sameValue(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"]?.["constructor"], globalThis["descArray"]?.["1"]?.["value"]);
$verifyProperty(globalThis["descArray"]?.["1"]?.["value"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["value"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["value"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"]?.["value"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["1"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["descArray"]?.["0"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["descArray"]?.["0"]);
$assert.sameValue(globalThis["descArray"]?.["0"]?.["value"], Array.prototype.reduce);
$verifyProperty(globalThis["descArray"]?.["0"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descArray"]?.["0"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
