...
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]?.["prototype"]), ['constructor', 'bar'], globalThis["foo"]?.["prototype"]);
$verifyProperty(globalThis["foo"]?.["prototype"], "bar", {
  value: "unwritable",
  writable: false,
  enumerable: false,
  configurable: false,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]), globalThis["foo"]?.["prototype"]);
