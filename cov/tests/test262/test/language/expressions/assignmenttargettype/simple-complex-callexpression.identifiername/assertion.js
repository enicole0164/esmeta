...
$assert.sameValue($Object_getPrototypeOf(f), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(o), ['v', 'f', 'IdentifierName'], o);
$verifyProperty(o, "IdentifierName", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(o?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(o?.["f"]), true);
$assert.callable(o?.["f"]);
$assert.notConstructable(o?.["f"]);
$assert.compareArray($Reflect_ownKeys(o?.["f"]), ['length', 'name'], o?.["f"]);
$verifyProperty(o?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
