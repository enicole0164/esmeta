...
$assert.sameValue(Object.isExtensible(globalThis["a"]), false);
$assert.notCallable(globalThis["a"]);
$assert.notConstructable(globalThis["a"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['y'], globalThis["a"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get, "name", {
  value: "get y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a"], "y")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a"], "y", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
