...
$assert.sameValue($Object_getPrototypeOf(globalThis["MyObjectVar"]), globalThis["MyFunction"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["MyObjectVar"]), true);
$assert.notCallable(globalThis["MyObjectVar"]);
$assert.notConstructable(globalThis["MyObjectVar"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyObjectVar"]), [], globalThis["MyObjectVar"]);
