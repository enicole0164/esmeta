...
$assert.sameValue(globalThis["BLUE_NUM"], 1.0);
$assert.sameValue(globalThis["BLUE_STR"], "1");
...
$assert.sameValue(globalThis["YELLOW_NUM"], 2.0);
$assert.sameValue(globalThis["YELLOW_STR"], "2");
$assert.sameValue($Object_getPrototypeOf(globalThis["__color__map"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__color__map"]), true);
$assert.notCallable(globalThis["__color__map"]);
$assert.notConstructable(globalThis["__color__map"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__color__map"]), ['red', 'BLUE_NUM', 'green', 'YELLOW_STR'], globalThis["__color__map"]);
$verifyProperty(globalThis["__color__map"], "YELLOW_STR", {
  value: 1.677696E7,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__color__map"], "red", {
  value: 1.671168E7,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__color__map"], "green", {
  value: 65280.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__color__map"], "BLUE_NUM", {
  value: 255.0,
  writable: true,
  enumerable: true,
  configurable: true,
