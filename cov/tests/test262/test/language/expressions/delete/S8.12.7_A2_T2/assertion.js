...
$assert.sameValue($Object_getPrototypeOf(globalThis["Palette"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Palette"]), true);
$assert.callable(globalThis["Palette"]);
$assert.constructable(globalThis["Palette"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Palette"]), ['length', 'name', 'prototype'], globalThis["Palette"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Palette"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Palette"]?.["prototype"]), true);
$assert.notCallable(globalThis["Palette"]?.["prototype"]);
$assert.notConstructable(globalThis["Palette"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Palette"]?.["prototype"]), ['red', 'green'], globalThis["Palette"]?.["prototype"]);
$verifyProperty(globalThis["Palette"]?.["prototype"], "red", {
  value: 1.671168E7,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["Palette"]?.["prototype"], "green", {
  value: 65280.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["Palette"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Palette"], "name", {
  value: "Palette",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Palette"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__palette"]), globalThis["Palette"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__palette"]), true);
$assert.notCallable(globalThis["__palette"]);
$assert.notConstructable(globalThis["__palette"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__palette"]), [], globalThis["__palette"]);
