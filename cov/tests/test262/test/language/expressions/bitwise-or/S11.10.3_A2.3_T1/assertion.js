...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['valueOf'], globalThis["x"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x"]?.["valueOf"]), true);
$assert.callable(globalThis["x"]?.["valueOf"]);
$assert.constructable(globalThis["x"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["x"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["x"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["x"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["x"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["x"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["x"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["x"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["x"]?.["valueOf"]);
$verifyProperty(globalThis["x"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["x"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["x"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["x"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["x"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]), true);
$assert.notCallable(globalThis["y"]);
$assert.notConstructable(globalThis["y"]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), ['valueOf'], globalThis["y"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]?.["valueOf"]), true);
$assert.callable(globalThis["y"]?.["valueOf"]);
$assert.constructable(globalThis["y"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["y"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["y"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["y"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["y"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["y"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["y"]?.["valueOf"]);
$verifyProperty(globalThis["y"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["y"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
