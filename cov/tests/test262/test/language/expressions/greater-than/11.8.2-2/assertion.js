...
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]), ['valueOf'], globalThis["obj1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["valueOf"]), true);
$assert.callable(globalThis["obj1"]?.["valueOf"]);
$assert.constructable(globalThis["obj1"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["obj1"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj1"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["obj1"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["obj1"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["obj1"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["obj1"]?.["valueOf"]);
$verifyProperty(globalThis["obj1"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj1"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
