...
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]), ['toString'], globalThis["obj1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["toString"]), true);
$assert.callable(globalThis["obj1"]?.["toString"]);
$assert.constructable(globalThis["obj1"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["obj1"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj1"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["obj1"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["obj1"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["obj1"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["obj1"]?.["toString"]);
$verifyProperty(globalThis["obj1"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj1"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['toString'], globalThis["obj2"]);
