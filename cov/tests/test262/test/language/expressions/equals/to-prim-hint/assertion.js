...
$assert.compareArray($Reflect_ownKeys(obj), [Symbol.toPrimitive], obj);
$assert.sameValue($Object_getPrototypeOf(obj?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(obj?.[Symbol.toPrimitive]), true);
$assert.callable(obj?.[Symbol.toPrimitive]);
$assert.notConstructable(obj?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(obj?.[Symbol.toPrimitive]), ['length', 'name'], obj?.[Symbol.toPrimitive]);
$verifyProperty(obj?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(obj?.[Symbol.toPrimitive], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(obj, Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
