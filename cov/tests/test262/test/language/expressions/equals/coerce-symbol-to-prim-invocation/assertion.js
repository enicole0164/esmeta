...
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]), [Symbol.toPrimitive], globalThis["thisVal"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["thisVal"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["thisVal"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["thisVal"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["thisVal"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["thisVal"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["thisVal"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisVal"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["y"], globalThis["thisVal"]);
