...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["y"], Symbol.toPrimitive)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
