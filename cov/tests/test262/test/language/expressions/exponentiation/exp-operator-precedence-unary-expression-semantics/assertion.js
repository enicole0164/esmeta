...
$assert.sameValue($Object_getPrototypeOf(globalThis["capture"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["capture"]), true);
$assert.notCallable(globalThis["capture"]);
$assert.notConstructable(globalThis["capture"]);
$assert.compareArray($Reflect_ownKeys(globalThis["capture"]), ['0', '1', '2', '3', 'length'], globalThis["capture"]);
$verifyProperty(globalThis["capture"], "2", {
  value: "rightValue",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["capture"], "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["capture"], "1", {
  value: "right",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["capture"], "3", {
  value: "leftValue",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["capture"], "0", {
  value: "left",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["leftValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["leftValue"]), true);
$assert.notCallable(globalThis["leftValue"]);
$assert.notConstructable(globalThis["leftValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["leftValue"]), ['valueOf'], globalThis["leftValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["leftValue"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["leftValue"]?.["valueOf"]), true);
$assert.callable(globalThis["leftValue"]?.["valueOf"]);
$assert.notConstructable(globalThis["leftValue"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["leftValue"]?.["valueOf"]), ['length', 'name'], globalThis["leftValue"]?.["valueOf"]);
$verifyProperty(globalThis["leftValue"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["leftValue"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["leftValue"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["n"], 2.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["rightValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rightValue"]), true);
$assert.notCallable(globalThis["rightValue"]);
$assert.notConstructable(globalThis["rightValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rightValue"]), ['valueOf'], globalThis["rightValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["rightValue"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rightValue"]?.["valueOf"]), true);
$assert.callable(globalThis["rightValue"]?.["valueOf"]);
$assert.notConstructable(globalThis["rightValue"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rightValue"]?.["valueOf"]), ['length', 'name'], globalThis["rightValue"]?.["valueOf"]);
$verifyProperty(globalThis["rightValue"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rightValue"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rightValue"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["s"], "2");
