...
$assert.sameValue($Object_getPrototypeOf(globalThis["bases"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bases"]), true);
$assert.notCallable(globalThis["bases"]);
$assert.notConstructable(globalThis["bases"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bases"]), ['0', '1', '2', '3', '4', '5', '6', '7', '8', 'length'], globalThis["bases"]);
$verifyProperty(globalThis["bases"], "4", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "2", {
  value: -1.0E-15,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "7", {
  value: Infinity,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "length", {
  value: 9.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["bases"], "8", {
  value: NaN,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "0", {
  value: -Infinity,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "6", {
  value: 1.7976931348623157E308,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "1", {
  value: -1.7976931348623157E308,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "3", {
  value: -0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["bases"], "5", {
  value: 1.0E-15,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["exponent"], -0.0);
$assert.sameValue(globalThis["i"], 9.0);
