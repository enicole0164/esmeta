...
$assert.sameValue(globalThis["base"], NaN);
$assert.sameValue($Object_getPrototypeOf(globalThis["exponents"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["exponents"]), true);
$assert.notCallable(globalThis["exponents"]);
$assert.notConstructable(globalThis["exponents"]);
$assert.compareArray($Reflect_ownKeys(globalThis["exponents"]), ['0', '1', '2', '3', '4', '5', '6', 'length'], globalThis["exponents"]);
$verifyProperty(globalThis["exponents"], "4", {
  value: 1.7976931348623157E308,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["exponents"], "2", {
  value: -1.0E-15,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["exponents"], "length", {
  value: 7.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["exponents"], "0", {
  value: -Infinity,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["exponents"], "6", {
  value: NaN,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["exponents"], "1", {
  value: -1.7976931348623157E308,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["exponents"], "3", {
  value: 1.0E-15,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["exponents"], "5", {
  value: Infinity,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["i"], 7.0);
