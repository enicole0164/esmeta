...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["viaCall"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["viaCall"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["viaCall"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["viaCall"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["viaCall"])), ['constructor', 'getThis', 'This'], $Object_getPrototypeOf(globalThis["viaCall"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"]);
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"], "name", {
  value: "getThis",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"])?.["getThis"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"]), "getThis", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get, "name", {
  value: "get This",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["viaCall"]), "This")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"]), "This", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["viaCall"]));
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"], "name", {
  value: "Parent",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["viaCall"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["viaCall"]), true);
$assert.notCallable(globalThis["viaCall"]);
$assert.notConstructable(globalThis["viaCall"]);
$assert.compareArray($Reflect_ownKeys(globalThis["viaCall"]), ['constructor', 'method'], globalThis["viaCall"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["viaCall"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["viaCall"]?.["method"]), true);
$assert.callable(globalThis["viaCall"]?.["method"]);
$assert.notConstructable(globalThis["viaCall"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["viaCall"]?.["method"]), ['length', 'name'], globalThis["viaCall"]?.["method"]);
$verifyProperty(globalThis["viaCall"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["viaCall"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["viaCall"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["viaCall"]?.["constructor"]), $Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]);
$assert.sameValue(Object.isExtensible(globalThis["viaCall"]?.["constructor"]), true);
$assert.callable(globalThis["viaCall"]?.["constructor"]);
$assert.constructable(globalThis["viaCall"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["viaCall"]?.["constructor"]), ['length', 'name', 'prototype'], globalThis["viaCall"]?.["constructor"]);
$assert.sameValue(globalThis["viaCall"]?.["constructor"]?.["prototype"], globalThis["viaCall"]);
$verifyProperty(globalThis["viaCall"]?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["viaCall"]?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["viaCall"]?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["viaCall"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["viaMember"], globalThis["viaCall"]);
$assert.sameValue(C, globalThis["viaCall"]?.["constructor"]);
$assert.sameValue(Parent, $Object_getPrototypeOf(globalThis["viaCall"])?.["constructor"]);
