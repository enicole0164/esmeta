...
$assert.compareArray($Reflect_ownKeys(globalThis["calls"]), ['0', '1', '2', '3', 'length'], globalThis["calls"]);
...
$verifyProperty(globalThis["calls"], "3", {
  value: "Symbol(foo)",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "1")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "1", {
  set: undefined,
  enumerable: true,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get, "name", {
  value: "get a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "a")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "a", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get, "name", {
  value: "get z",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "z")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(Test262ChildClass)), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(Test262ChildClass)), true);
$assert.callable($Object_getPrototypeOf(Test262ChildClass));
$assert.constructable($Object_getPrototypeOf(Test262ChildClass));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(Test262ChildClass)), ['length', 'name', 'prototype'], $Object_getPrototypeOf(Test262ChildClass));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(Test262ChildClass)?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(Test262ChildClass)?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(Test262ChildClass)?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(Test262ChildClass)?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(Test262ChildClass)?.["prototype"]), ['constructor'], $Object_getPrototypeOf(Test262ChildClass)?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Test262ChildClass)?.["prototype"]?.["constructor"], $Object_getPrototypeOf(Test262ChildClass));
$verifyProperty($Object_getPrototypeOf(Test262ChildClass)?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Test262ChildClass), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(Test262ChildClass), "name", {
  value: "Test262ParentClass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Test262ChildClass), "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(Test262ChildClass), true);
$assert.callable(Test262ChildClass);
$assert.constructable(Test262ChildClass);
$assert.compareArray($Reflect_ownKeys(Test262ChildClass), ['length', 'name', 'prototype'], Test262ChildClass);
$assert.sameValue($Object_getPrototypeOf(Test262ChildClass?.["prototype"]), $Object_getPrototypeOf(Test262ChildClass)?.["prototype"]);
$assert.sameValue(Object.isExtensible(Test262ChildClass?.["prototype"]), true);
$assert.notCallable(Test262ChildClass?.["prototype"]);
$assert.notConstructable(Test262ChildClass?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Test262ChildClass?.["prototype"]), ['constructor'], Test262ChildClass?.["prototype"]);
$assert.sameValue(Test262ChildClass?.["prototype"]?.["constructor"], Test262ChildClass);
$verifyProperty(Test262ChildClass?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Test262ChildClass, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Test262ChildClass, "name", {
  value: "Test262ChildClass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Test262ChildClass, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Test262ParentClass, $Object_getPrototypeOf(Test262ChildClass));
