...
$assert.compareArray($Reflect_ownKeys(X?.["prototype"]), ['constructor', 'method'], X?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(X?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(X?.["prototype"]?.["method"]), true);
$assert.callable(X?.["prototype"]?.["method"]);
$assert.notConstructable(X?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(X?.["prototype"]?.["method"]), ['length', 'name'], X?.["prototype"]?.["method"]);
$verifyProperty(X?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(X?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(X?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Y), X);
$assert.sameValue(Object.isExtensible(Y), true);
$assert.callable(Y);
$assert.constructable(Y);
$assert.compareArray($Reflect_ownKeys(Y), ['length', 'name', 'prototype'], Y);
$assert.sameValue($Object_getPrototypeOf(Y?.["prototype"]), X?.["prototype"]);
$assert.sameValue(Object.isExtensible(Y?.["prototype"]), true);
$assert.notCallable(Y?.["prototype"]);
$assert.notConstructable(Y?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Y?.["prototype"]), ['constructor', 'method'], Y?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Y?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Y?.["prototype"]?.["method"]), true);
$assert.callable(Y?.["prototype"]?.["method"]);
$assert.notConstructable(Y?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(Y?.["prototype"]?.["method"]), ['length', 'name'], Y?.["prototype"]?.["method"]);
$verifyProperty(Y?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Y?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Y?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Y?.["prototype"]?.["constructor"], Y);
$verifyProperty(Y?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Y, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Y, "name", {
  value: "Y",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(y), Y?.["prototype"]);
$assert.sameValue(Object.isExtensible(y), true);
$assert.notCallable(y);
$assert.notConstructable(y);
$assert.compareArray($Reflect_ownKeys(y), [], y);
