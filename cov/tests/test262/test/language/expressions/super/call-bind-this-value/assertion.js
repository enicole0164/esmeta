...
$assert.sameValue($Object_getPrototypeOf(globalThis["boundThisValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["boundThisValue"]), true);
$assert.notCallable(globalThis["boundThisValue"]);
$assert.notConstructable(globalThis["boundThisValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["boundThisValue"]), [], globalThis["boundThisValue"]);
$assert.sameValue(globalThis["customThisValue"], globalThis["boundThisValue"]);
