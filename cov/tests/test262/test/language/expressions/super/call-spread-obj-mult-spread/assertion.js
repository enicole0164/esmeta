...
$assert.compareArray($Reflect_ownKeys(o), ['a', 'b'], o);
$verifyProperty(o, "b", {
  value: 3.0,
  writable: true,
  enumerable: true,
...
$assert.sameValue($Object_getPrototypeOf(o2), Object.prototype);
$assert.sameValue(Object.isExtensible(o2), true);
$assert.notCallable(o2);
$assert.notConstructable(o2);
$assert.compareArray($Reflect_ownKeys(o2), ['c', 'd'], o2);
$verifyProperty(o2, "d", {
  value: 5.0,
  writable: true,
  enumerable: true,
