...
$assert.compareArray($Reflect_ownKeys(globalThis["A"]), ['fromA', 'fromB'], globalThis["A"]);
$verifyProperty(globalThis["A"], "fromB", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["A"], "fromA", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["B"]), globalThis["A"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["B"]), ['fromB'], globalThis["B"]);
$verifyProperty(globalThis["B"], "fromB", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), globalThis["B"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['fromA', 'fromB', 'method'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "fromB", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["obj"], "fromA", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
