...
$assert.sameValue($Object_getPrototypeOf(globalThis["source"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["source"]), ['0', '1', '2', 'length'], globalThis["source"]);
$verifyProperty(globalThis["source"], "1", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["source"], "2", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["source"], "0", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["target"], globalThis["source"]);
