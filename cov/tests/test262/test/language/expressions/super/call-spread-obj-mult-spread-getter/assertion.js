...
$assert.sameValue(getterCallCount, 2.0);
$assert.sameValue($Object_getPrototypeOf(o), Object.prototype);
$assert.sameValue(Object.isExtensible(o), true);
$assert.notCallable(o);
$assert.notConstructable(o);
$assert.compareArray($Reflect_ownKeys(o), ['a'], o);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(o, "a")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(o, "a")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(o, "a")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(o, "a")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(o, "a")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(o, "a")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(o, "a")?.get, "name", {
  value: "get a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(o, "a")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
