...
$assert.sameValue($Object_getPrototypeOf(globalThis["badToString"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["badToString"]), true);
$assert.notCallable(globalThis["badToString"]);
$assert.notConstructable(globalThis["badToString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["badToString"]), ['toString'], globalThis["badToString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["badToString"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["badToString"]?.["toString"]), true);
$assert.callable(globalThis["badToString"]?.["toString"]);
$assert.constructable(globalThis["badToString"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["badToString"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["badToString"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["badToString"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["badToString"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["badToString"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["badToString"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["badToString"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["badToString"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["badToString"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["badToString"]?.["toString"]);
$verifyProperty(globalThis["badToString"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["badToString"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["badToString"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["badToString"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["badToString"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
