...
$assert.sameValue($Object_getPrototypeOf(globalThis["Parent"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Parent"]), true);
$assert.callable(globalThis["Parent"]);
$assert.constructable(globalThis["Parent"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Parent"]), ['length', 'name', 'prototype'], globalThis["Parent"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Parent"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Parent"]?.["prototype"]), true);
$assert.notCallable(globalThis["Parent"]?.["prototype"]);
$assert.notConstructable(globalThis["Parent"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Parent"]?.["prototype"]), ['constructor'], globalThis["Parent"]?.["prototype"]);
$assert.sameValue(globalThis["Parent"]?.["prototype"]?.["constructor"], globalThis["Parent"]);
$verifyProperty(globalThis["Parent"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Parent"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Parent"], "name", {
  value: "Parent",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Parent"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Child), globalThis["Parent"]);
...
$assert.sameValue($Object_getPrototypeOf(Child?.["prototype"]), globalThis["Parent"]?.["prototype"]);
