...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["obj"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['getThis', 'This'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]);
$assert.constructable($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["obj"])?.["getThis"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]), ['constructor'], $Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["obj"])?.["getThis"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["getThis"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["getThis"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["getThis"], "name", {
  value: "getThis",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["getThis"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "getThis", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get, "name", {
  value: "get This",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["obj"]), "This")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "This", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['method'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["method"]), true);
$assert.callable(globalThis["obj"]?.["method"]);
$assert.notConstructable(globalThis["obj"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["method"]), ['length', 'name'], globalThis["obj"]?.["method"]);
$verifyProperty(globalThis["obj"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "method", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["parent"], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue(globalThis["viaCall"], globalThis["obj"]);
$assert.sameValue(globalThis["viaMember"], globalThis["obj"]);
