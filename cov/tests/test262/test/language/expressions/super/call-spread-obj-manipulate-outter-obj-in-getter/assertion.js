...
$assert.sameValue($Object_getPrototypeOf(globalThis["cthulhu"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cthulhu"]), true);
$assert.notCallable(globalThis["cthulhu"]);
$assert.notConstructable(globalThis["cthulhu"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cthulhu"]), ['x'], globalThis["cthulhu"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get, "name", {
  value: "get x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["cthulhu"], "x")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cthulhu"], "x", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['b', 'c'], globalThis["o"]);
$verifyProperty(globalThis["o"], "b", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["o"], "c", {
  value: "ni",
  writable: true,
  enumerable: true,
  configurable: true,
