...
$assert.sameValue(globalThis["fromA"], "a");
$assert.sameValue(globalThis["fromB"], "b");
...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['constructor', 'fromA', 'fromB'], A?.["prototype"]);
$verifyProperty(A?.["prototype"], "fromB", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "fromA", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(B?.["prototype"]), ['constructor', 'fromB'], B?.["prototype"]);
$verifyProperty(B?.["prototype"], "fromB", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'method', 'fromA', 'fromB'], C?.["prototype"]);
$verifyProperty(C?.["prototype"], "fromB", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(C?.["prototype"], "fromA", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
