...
$assert.sameValue($Object_getPrototypeOf(globalThis["customThisValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["customThisValue"]), true);
$assert.notCallable(globalThis["customThisValue"]);
$assert.notConstructable(globalThis["customThisValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["customThisValue"]), [], globalThis["customThisValue"]);
$assert.sameValue(globalThis["value"], globalThis["customThisValue"]);
