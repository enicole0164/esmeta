...
$assert.sameValue($Object_getPrototypeOf(globalThis["Robin"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Robin"]), true);
$assert.callable(globalThis["Robin"]);
$assert.constructable(globalThis["Robin"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Robin"]), ['length', 'name', 'prototype'], globalThis["Robin"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Robin"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Robin"]?.["prototype"]), true);
$assert.notCallable(globalThis["Robin"]?.["prototype"]);
$assert.notConstructable(globalThis["Robin"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Robin"]?.["prototype"]), ['phylum'], globalThis["Robin"]?.["prototype"]);
$verifyProperty(globalThis["Robin"]?.["prototype"], "phylum", {
  value: "avis",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["Robin"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Robin"], "name", {
  value: "Robin",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Robin"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__my__robin"]), globalThis["Robin"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__my__robin"]), true);
$assert.notCallable(globalThis["__my__robin"]);
$assert.notConstructable(globalThis["__my__robin"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__my__robin"]), ['name'], globalThis["__my__robin"]);
$verifyProperty(globalThis["__my__robin"], "name", {
  value: "robin",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["__proto"], globalThis["Robin"]?.["prototype"]);
