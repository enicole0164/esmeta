...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'isNameIn'], C);
$assert.sameValue($Object_getPrototypeOf(C?.["isNameIn"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(C?.["isNameIn"]), true);
$assert.callable(C?.["isNameIn"]);
$assert.notConstructable(C?.["isNameIn"]);
$assert.compareArray($Reflect_ownKeys(C?.["isNameIn"]), ['length', 'name', 'prototype'], C?.["isNameIn"]);
$assert.sameValue($Object_getPrototypeOf(C?.["isNameIn"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["isNameIn"]?.["prototype"]), true);
$assert.notCallable(C?.["isNameIn"]?.["prototype"]);
$assert.notConstructable(C?.["isNameIn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["isNameIn"]?.["prototype"]), [], C?.["isNameIn"]?.["prototype"]);
$verifyProperty(C?.["isNameIn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C?.["isNameIn"], "name", {
  value: "isNameIn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["isNameIn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "isNameIn", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(iter1), C?.["isNameIn"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(iter2), C?.["isNameIn"]?.["prototype"]);
