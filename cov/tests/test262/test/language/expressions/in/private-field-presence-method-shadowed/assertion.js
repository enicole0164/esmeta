...
$assert.sameValue($Object_getPrototypeOf(Child), Function.prototype);
$assert.sameValue(Object.isExtensible(Child), true);
$assert.callable(Child);
$assert.constructable(Child);
$assert.compareArray($Reflect_ownKeys(Child), ['length', 'name', 'prototype', 'isNameIn'], Child);
$assert.sameValue($Object_getPrototypeOf(Child?.["isNameIn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Child?.["isNameIn"]), true);
$assert.callable(Child?.["isNameIn"]);
$assert.notConstructable(Child?.["isNameIn"]);
$assert.compareArray($Reflect_ownKeys(Child?.["isNameIn"]), ['length', 'name'], Child?.["isNameIn"]);
$verifyProperty(Child?.["isNameIn"], "name", {
  value: "isNameIn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Child?.["isNameIn"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Child, "isNameIn", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Child?.["prototype"]), Object.prototype);
...
$assert.sameValue($Object_getPrototypeOf(Parent), Function.prototype);
$assert.sameValue(Object.isExtensible(Parent), true);
$assert.callable(Parent);
$assert.constructable(Parent);
$assert.compareArray($Reflect_ownKeys(Parent), ['length', 'name', 'prototype', 'init'], Parent);
$assert.sameValue($Object_getPrototypeOf(Parent?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Parent?.["prototype"]), true);
$assert.notCallable(Parent?.["prototype"]);
$assert.notConstructable(Parent?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Parent?.["prototype"]), ['constructor'], Parent?.["prototype"]);
$assert.sameValue(Parent?.["prototype"]?.["constructor"], Parent);
$verifyProperty(Parent?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Parent, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Parent, "name", {
  value: "Parent",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Parent, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Parent?.["init"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Parent?.["init"]), true);
$assert.callable(Parent?.["init"]);
$assert.notConstructable(Parent?.["init"]);
$assert.compareArray($Reflect_ownKeys(Parent?.["init"]), ['length', 'name'], Parent?.["init"]);
$verifyProperty(Parent?.["init"], "name", {
  value: "init",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Parent?.["init"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Parent, "init", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(childCount, 0.0);
$assert.sameValue(parentCount, 0.0);
