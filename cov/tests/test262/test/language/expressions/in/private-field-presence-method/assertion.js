...
$assert.sameValue($Object_getPrototypeOf(Class), Function.prototype);
$assert.sameValue(Object.isExtensible(Class), true);
$assert.callable(Class);
$assert.constructable(Class);
$assert.compareArray($Reflect_ownKeys(Class), ['length', 'name', 'prototype', 'isNameIn'], Class);
$assert.sameValue($Object_getPrototypeOf(Class?.["isNameIn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Class?.["isNameIn"]), true);
$assert.callable(Class?.["isNameIn"]);
$assert.notConstructable(Class?.["isNameIn"]);
$assert.compareArray($Reflect_ownKeys(Class?.["isNameIn"]), ['length', 'name'], Class?.["isNameIn"]);
$verifyProperty(Class?.["isNameIn"], "name", {
  value: "isNameIn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Class?.["isNameIn"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Class, "isNameIn", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Class?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Class?.["prototype"]), true);
$assert.notCallable(Class?.["prototype"]);
$assert.notConstructable(Class?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Class?.["prototype"]), ['constructor'], Class?.["prototype"]);
$assert.sameValue(Class?.["prototype"]?.["constructor"], Class);
$verifyProperty(Class?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Class, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
...
$verifyProperty(Class, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(count, 0.0);
