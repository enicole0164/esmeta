...
$assert.sameValue($Object_getPrototypeOf(globalThis["isNameIn"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["isNameIn"]), true);
$assert.callable(globalThis["isNameIn"]);
$assert.notConstructable(globalThis["isNameIn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["isNameIn"]), ['length', 'name', 'prototype'], globalThis["isNameIn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["isNameIn"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["isNameIn"]?.["prototype"]), true);
$assert.notCallable(globalThis["isNameIn"]?.["prototype"]);
$assert.notConstructable(globalThis["isNameIn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["isNameIn"]?.["prototype"]), [], globalThis["isNameIn"]?.["prototype"]);
$verifyProperty(globalThis["isNameIn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["isNameIn"], "name", {
  value: "isNameIn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["isNameIn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(iter1), globalThis["isNameIn"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(iter1), true);
$assert.notCallable(iter1);
$assert.notConstructable(iter1);
$assert.compareArray($Reflect_ownKeys(iter1), [], iter1);
$assert.sameValue($Object_getPrototypeOf(iter2), globalThis["isNameIn"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(iter2), true);
$assert.notCallable(iter2);
$assert.notConstructable(iter2);
$assert.compareArray($Reflect_ownKeys(iter2), [], iter2);
