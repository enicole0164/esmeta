...
$assert.sameValue($Object_getPrototypeOf(C?.["isNameIn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["isNameIn"]), true);
$assert.callable(C?.["isNameIn"]);
$assert.notConstructable(C?.["isNameIn"]);
$assert.compareArray($Reflect_ownKeys(C?.["isNameIn"]), ['length', 'name'], C?.["isNameIn"]);
...
$assert.sameValue($Object_getPrototypeOf(value), Object.prototype);
$assert.sameValue(Object.isExtensible(value), true);
$assert.notCallable(value);
$assert.notConstructable(value);
$assert.compareArray($Reflect_ownKeys(value), [], value);
