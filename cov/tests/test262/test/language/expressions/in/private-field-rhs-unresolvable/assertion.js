...
$assert.sameValue($Object_getPrototypeOf(caught), ReferenceError.prototype);
$assert.notCallable(caught);
$assert.notConstructable(caught);
$assert.compareArray($Reflect_ownKeys(caught), [], caught);
