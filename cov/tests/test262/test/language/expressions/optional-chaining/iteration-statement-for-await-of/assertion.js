...
$assert.compareArray($Reflect_ownKeys(obj), ['iterable'], obj);
$assert.sameValue($Object_getPrototypeOf(obj?.["iterable"]), Object.prototype);
$assert.sameValue(Object.isExtensible(obj?.["iterable"]), true);
$assert.notCallable(obj?.["iterable"]);
$assert.notConstructable(obj?.["iterable"]);
$assert.compareArray($Reflect_ownKeys(obj?.["iterable"]), [Symbol.asyncIterator], obj?.["iterable"]);
$assert.sameValue($Object_getPrototypeOf(obj?.["iterable"]?.[Symbol.asyncIterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(obj?.["iterable"]?.[Symbol.asyncIterator]), true);
$assert.callable(obj?.["iterable"]?.[Symbol.asyncIterator]);
$assert.notConstructable(obj?.["iterable"]?.[Symbol.asyncIterator]);
$assert.compareArray($Reflect_ownKeys(obj?.["iterable"]?.[Symbol.asyncIterator]), ['length', 'name'], obj?.["iterable"]?.[Symbol.asyncIterator]);
$verifyProperty(obj?.["iterable"]?.[Symbol.asyncIterator], "name", {
  value: "[Symbol.asyncIterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(obj?.["iterable"]?.[Symbol.asyncIterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(obj?.["iterable"], Symbol.asyncIterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj, "iterable", {
  writable: true,
  enumerable: true,
  configurable: true,
});
