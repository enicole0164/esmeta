...
$assert.compareArray($Reflect_ownKeys(Base?.["prototype"]), ['constructor', 'method'], Base?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Base?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Base?.["prototype"]?.["method"]), true);
$assert.callable(Base?.["prototype"]?.["method"]);
$assert.notConstructable(Base?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(Base?.["prototype"]?.["method"]), ['length', 'name'], Base?.["prototype"]?.["method"]);
$verifyProperty(Base?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Base?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Base?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Foo), Base);
$assert.sameValue(Object.isExtensible(Foo), true);
$assert.callable(Foo);
$assert.constructable(Foo);
$assert.compareArray($Reflect_ownKeys(Foo), ['length', 'name', 'prototype'], Foo);
$assert.sameValue($Object_getPrototypeOf(Foo?.["prototype"]), Base?.["prototype"]);
$assert.sameValue(Object.isExtensible(Foo?.["prototype"]), true);
$assert.notCallable(Foo?.["prototype"]);
$assert.notConstructable(Foo?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Foo?.["prototype"]), ['constructor', 'method'], Foo?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Foo?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Foo?.["prototype"]?.["method"]), true);
$assert.callable(Foo?.["prototype"]?.["method"]);
$assert.notConstructable(Foo?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(Foo?.["prototype"]?.["method"]), ['length', 'name'], Foo?.["prototype"]?.["method"]);
$verifyProperty(Foo?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Foo?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Foo?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Foo?.["prototype"]?.["constructor"], Foo);
$verifyProperty(Foo?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Foo, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(context), Foo?.["prototype"]);
$assert.sameValue(Object.isExtensible(context), true);
$assert.notCallable(context);
$assert.notConstructable(context);
$assert.compareArray($Reflect_ownKeys(context), [], context);
$assert.sameValue(foo, context);
