...
$assert.sameValue($Object_getPrototypeOf(c), Object.prototype);
$assert.sameValue(Object.isExtensible(c), true);
$assert.notCallable(c);
$assert.notConstructable(c);
$assert.compareArray($Reflect_ownKeys(c), ['d', 'e'], c);
$assert.sameValue($Object_getPrototypeOf(c?.["d"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(c?.["d"]), true);
$assert.notCallable(c?.["d"]);
$assert.notConstructable(c?.["d"]);
$assert.compareArray($Reflect_ownKeys(c?.["d"]), [], c?.["d"]);
$verifyProperty(c, "d", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(c?.["e"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(c?.["e"]), true);
$assert.notCallable(c?.["e"]);
$assert.notConstructable(c?.["e"]);
$assert.compareArray($Reflect_ownKeys(c?.["e"]), [], c?.["e"]);
$verifyProperty(c, "e", {
  writable: true,
  enumerable: true,
  configurable: true,
