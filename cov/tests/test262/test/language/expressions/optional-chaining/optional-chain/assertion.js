...
$assert.sameValue($Object_getPrototypeOf(arr), Array.prototype);
$assert.sameValue(Object.isExtensible(arr), true);
$assert.notCallable(arr);
$assert.notConstructable(arr);
$assert.compareArray($Reflect_ownKeys(arr), ['0', '1', 'length'], arr);
...
$assert.callable(fn);
$assert.notConstructable(fn);
$assert.compareArray($Reflect_ownKeys(fn), ['length', 'name'], fn);
...
$assert.compareArray($Reflect_ownKeys(obj), ['a', 'b', 'c', 'arr'], obj);
$assert.sameValue($Object_getPrototypeOf(obj?.["b"]), Object.prototype);
$assert.sameValue(Object.isExtensible(obj?.["b"]), true);
$assert.notCallable(obj?.["b"]);
$assert.notConstructable(obj?.["b"]);
$assert.compareArray($Reflect_ownKeys(obj?.["b"]), ['val'], obj?.["b"]);
$verifyProperty(obj?.["b"], "val", {
  value: 13.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(obj?.["arr"]), Array.prototype);
$assert.sameValue(Object.isExtensible(obj?.["arr"]), true);
$assert.notCallable(obj?.["arr"]);
$assert.notConstructable(obj?.["arr"]);
$assert.compareArray($Reflect_ownKeys(obj?.["arr"]), ['0', '1', 'length'], obj?.["arr"]);
$verifyProperty(obj?.["arr"], "1", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj?.["arr"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(obj?.["arr"], "0", {
  value: 11.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj, "arr", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(obj?.["c"]), Function.prototype);
$assert.sameValue(Object.isExtensible(obj?.["c"]), true);
$assert.callable(obj?.["c"]);
$assert.notConstructable(obj?.["c"]);
$assert.compareArray($Reflect_ownKeys(obj?.["c"]), ['length', 'name'], obj?.["c"]);
$verifyProperty(obj?.["c"], "name", {
  value: "c",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(obj?.["c"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
