...
$assert.compareArray($Reflect_ownKeys(obj), ['inner'], obj);
$assert.sameValue($Object_getPrototypeOf(obj?.["inner"]), Object.prototype);
$assert.sameValue(Object.isExtensible(obj?.["inner"]), true);
$assert.notCallable(obj?.["inner"]);
$assert.notConstructable(obj?.["inner"]);
$assert.compareArray($Reflect_ownKeys(obj?.["inner"]), ['a', 'b'], obj?.["inner"]);
$verifyProperty(obj?.["inner"], "b", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj?.["inner"], "a", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj, "inner", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(str, "ab");
