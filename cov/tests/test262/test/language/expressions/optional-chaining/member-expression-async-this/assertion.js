...
$assert.sameValue($Object_getPrototypeOf(globalThis["thisFn"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thisFn"]), true);
$assert.callable(globalThis["thisFn"]);
$assert.notConstructable(globalThis["thisFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thisFn"]), ['length', 'name'], globalThis["thisFn"]);
$verifyProperty(globalThis["thisFn"], "name", {
  value: "thisFn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["thisFn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
