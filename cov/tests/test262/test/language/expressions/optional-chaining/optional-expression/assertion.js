...
$assert.sameValue($Object_getPrototypeOf(obj?.["a"]), Object.prototype);
$assert.sameValue(Object.isExtensible(obj?.["a"]), true);
$assert.notCallable(obj?.["a"]);
$assert.notConstructable(obj?.["a"]);
$assert.compareArray($Reflect_ownKeys(obj?.["a"]), ['b'], obj?.["a"]);
$verifyProperty(obj?.["a"], "b", {
  value: 22.0,
  writable: true,
  enumerable: true,
  configurable: true,
