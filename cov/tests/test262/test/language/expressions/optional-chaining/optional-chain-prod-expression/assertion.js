...
$assert.compareArray($Reflect_ownKeys(arr), ['0', '1', 'length', 'true', '1.1'], arr);
$verifyProperty(arr, "true", {
  value: "prop",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(obj), ['a', 'undefined', '$', 'NaN', 'null', 'x', 'true'], obj);
$verifyProperty(obj, "true", {
  value: 44.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj, "null", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(obj, "NaN", {
  value: 41.0,
  writable: true,
  enumerable: true,
  configurable: true,
