...
$assert.compareArray($Reflect_ownKeys(a), ['b', '_b'], a);
$assert.sameValue($Object_getPrototypeOf(a?.["b"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["b"]), true);
$assert.callable(a?.["b"]);
$assert.notConstructable(a?.["b"]);
$assert.compareArray($Reflect_ownKeys(a?.["b"]), ['length', 'name'], a?.["b"]);
$verifyProperty(a?.["b"], "name", {
  value: "b",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["b"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(a?.["_b"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["_b"]), true);
$assert.notCallable(a?.["_b"]);
$assert.notConstructable(a?.["_b"]);
$assert.compareArray($Reflect_ownKeys(a?.["_b"]), ['c'], a?.["_b"]);
$verifyProperty(a?.["_b"], "c", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
