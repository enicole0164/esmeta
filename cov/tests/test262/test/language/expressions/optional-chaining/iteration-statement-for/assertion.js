...
$assert.sameValue(count, 1.0);
$assert.sameValue(count2, 0.0);
...
$assert.compareArray($Reflect_ownKeys(obj), ['a'], obj);
...
$assert.sameValue(obj2, undefined);
$assert.sameValue($Object_getPrototypeOf(obj3), Object.prototype);
$assert.sameValue(Object.isExtensible(obj3), true);
$assert.notCallable(obj3);
$assert.notConstructable(obj3);
$assert.compareArray($Reflect_ownKeys(obj3), ['a'], obj3);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(obj3, "a")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(obj3, "a")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(obj3, "a")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(obj3, "a")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(obj3, "a")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(obj3, "a")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(obj3, "a")?.get, "name", {
  value: "get a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(obj3, "a")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(obj3, "a", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(touched, 0.0);
