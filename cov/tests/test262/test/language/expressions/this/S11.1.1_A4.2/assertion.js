...
$assert.sameValue($Object_getPrototypeOf(globalThis["MyFunction"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyFunction"]), true);
$assert.callable(globalThis["MyFunction"]);
$assert.constructable(globalThis["MyFunction"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyFunction"]), ['length', 'name', 'prototype'], globalThis["MyFunction"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["MyFunction"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["MyFunction"]?.["prototype"]), true);
$assert.notCallable(globalThis["MyFunction"]?.["prototype"]);
$assert.notConstructable(globalThis["MyFunction"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyFunction"]?.["prototype"]), ['constructor'], globalThis["MyFunction"]?.["prototype"]);
$assert.sameValue(globalThis["MyFunction"]?.["prototype"]?.["constructor"], globalThis["MyFunction"]);
$verifyProperty(globalThis["MyFunction"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyFunction"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["MyFunction"], "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["MyFunction"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["MyObject"]), globalThis["MyFunction"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["MyObject"]), true);
$assert.notCallable(globalThis["MyObject"]);
$assert.notConstructable(globalThis["MyObject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["MyObject"]), ['THIS'], globalThis["MyObject"]);
$assert.sameValue(globalThis["MyObject"]?.["THIS"], globalThis["MyObject"]);
$verifyProperty(globalThis["MyObject"], "THIS", {
  writable: true,
  enumerable: true,
  configurable: true,
});
