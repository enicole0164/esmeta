...
$assert.sameValue($Object_getPrototypeOf(globalThis["SetEvalThis"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SetEvalThis"]), true);
$assert.callable(globalThis["SetEvalThis"]);
$assert.constructable(globalThis["SetEvalThis"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SetEvalThis"]), ['length', 'name', 'prototype'], globalThis["SetEvalThis"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SetEvalThis"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SetEvalThis"]?.["prototype"]), true);
$assert.notCallable(globalThis["SetEvalThis"]?.["prototype"]);
$assert.notConstructable(globalThis["SetEvalThis"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SetEvalThis"]?.["prototype"]), ['constructor'], globalThis["SetEvalThis"]?.["prototype"]);
$assert.sameValue(globalThis["SetEvalThis"]?.["prototype"]?.["constructor"], globalThis["SetEvalThis"]);
$verifyProperty(globalThis["SetEvalThis"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SetEvalThis"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SetEvalThis"], "name", {
  value: "SetEvalThis",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SetEvalThis"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["SetThis"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SetThis"]), true);
$assert.callable(globalThis["SetThis"]);
$assert.constructable(globalThis["SetThis"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SetThis"]), ['length', 'name', 'prototype'], globalThis["SetThis"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SetThis"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SetThis"]?.["prototype"]), true);
$assert.notCallable(globalThis["SetThis"]?.["prototype"]);
$assert.notConstructable(globalThis["SetThis"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SetThis"]?.["prototype"]), ['constructor'], globalThis["SetThis"]?.["prototype"]);
$assert.sameValue(globalThis["SetThis"]?.["prototype"]?.["constructor"], globalThis["SetThis"]);
$verifyProperty(globalThis["SetThis"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SetThis"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SetThis"], "name", {
  value: "SetThis",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SetThis"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
