...
$assert.sameValue($Object_getPrototypeOf(ref), Function.prototype);
$assert.sameValue(Object.isExtensible(ref), true);
$assert.callable(ref);
$assert.constructable(ref);
$assert.compareArray($Reflect_ownKeys(ref), ['length', 'name', 'prototype'], ref);
$assert.sameValue($Object_getPrototypeOf(ref?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(ref?.["prototype"]), true);
$assert.notCallable(ref?.["prototype"]);
$assert.notConstructable(ref?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(ref?.["prototype"]), ['constructor'], ref?.["prototype"]);
$assert.sameValue(ref?.["prototype"]?.["constructor"], ref);
$verifyProperty(ref?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(ref, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(ref, "name", {
  value: "BindingIdentifier",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(ref, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
