...
$assert.sameValue(globalThis["f"], null);
$assert.sameValue($Object_getPrototypeOf(globalThis["func"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func"]), true);
$assert.callable(globalThis["func"]);
$assert.constructable(globalThis["func"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func"]), ['length', 'name', 'prototype'], globalThis["func"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["func"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func"]?.["prototype"]), true);
$assert.notCallable(globalThis["func"]?.["prototype"]);
$assert.notConstructable(globalThis["func"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func"]?.["prototype"]), ['constructor'], globalThis["func"]?.["prototype"]);
$assert.sameValue(globalThis["func"]?.["prototype"]?.["constructor"], globalThis["func"]);
$verifyProperty(globalThis["func"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["func"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeBefore"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeBefore"]), true);
$assert.callable(globalThis["probeBefore"]);
$assert.constructable(globalThis["probeBefore"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeBefore"]), ['length', 'name', 'prototype'], globalThis["probeBefore"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeBefore"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeBefore"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeBefore"]?.["prototype"]);
$assert.notConstructable(globalThis["probeBefore"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeBefore"]?.["prototype"]), ['constructor'], globalThis["probeBefore"]?.["prototype"]);
$assert.sameValue(globalThis["probeBefore"]?.["prototype"]?.["constructor"], globalThis["probeBefore"]);
$verifyProperty(globalThis["probeBefore"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeBefore"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeBefore"], "name", {
  value: "probeBefore",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeBefore"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeBody"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeBody"]), true);
$assert.callable(globalThis["probeBody"]);
$assert.constructable(globalThis["probeBody"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeBody"]), ['length', 'name', 'prototype'], globalThis["probeBody"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeBody"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeBody"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeBody"]?.["prototype"]);
$assert.notConstructable(globalThis["probeBody"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeBody"]?.["prototype"]), ['constructor'], globalThis["probeBody"]?.["prototype"]);
$assert.sameValue(globalThis["probeBody"]?.["prototype"]?.["constructor"], globalThis["probeBody"]);
$verifyProperty(globalThis["probeBody"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeBody"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeBody"], "name", {
  value: "probeBody",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeBody"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeParams"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeParams"]), true);
$assert.callable(globalThis["probeParams"]);
$assert.constructable(globalThis["probeParams"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeParams"]), ['length', 'name', 'prototype'], globalThis["probeParams"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeParams"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeParams"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeParams"]?.["prototype"]);
$assert.notConstructable(globalThis["probeParams"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeParams"]?.["prototype"]), ['constructor'], globalThis["probeParams"]?.["prototype"]);
$assert.sameValue(globalThis["probeParams"]?.["prototype"]?.["constructor"], globalThis["probeParams"]);
$verifyProperty(globalThis["probeParams"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeParams"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeParams"], "name", {
  value: "probeParams",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeParams"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["setBefore"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setBefore"]), true);
$assert.callable(globalThis["setBefore"]);
$assert.constructable(globalThis["setBefore"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setBefore"]), ['length', 'name', 'prototype'], globalThis["setBefore"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["setBefore"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setBefore"]?.["prototype"]), true);
$assert.notCallable(globalThis["setBefore"]?.["prototype"]);
$assert.notConstructable(globalThis["setBefore"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setBefore"]?.["prototype"]), ['constructor'], globalThis["setBefore"]?.["prototype"]);
$assert.sameValue(globalThis["setBefore"]?.["prototype"]?.["constructor"], globalThis["setBefore"]);
$verifyProperty(globalThis["setBefore"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setBefore"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setBefore"], "name", {
  value: "setBefore",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setBefore"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["setBody"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setBody"]), true);
$assert.callable(globalThis["setBody"]);
$assert.constructable(globalThis["setBody"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setBody"]), ['length', 'name', 'prototype'], globalThis["setBody"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["setBody"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setBody"]?.["prototype"]), true);
$assert.notCallable(globalThis["setBody"]?.["prototype"]);
$assert.notConstructable(globalThis["setBody"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setBody"]?.["prototype"]), ['constructor'], globalThis["setBody"]?.["prototype"]);
$assert.sameValue(globalThis["setBody"]?.["prototype"]?.["constructor"], globalThis["setBody"]);
$verifyProperty(globalThis["setBody"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setBody"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setBody"], "name", {
  value: "setBody",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setBody"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["setParams"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setParams"]), true);
$assert.callable(globalThis["setParams"]);
$assert.constructable(globalThis["setParams"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setParams"]), ['length', 'name', 'prototype'], globalThis["setParams"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["setParams"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setParams"]?.["prototype"]), true);
$assert.notCallable(globalThis["setParams"]?.["prototype"]);
$assert.notConstructable(globalThis["setParams"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setParams"]?.["prototype"]), ['constructor'], globalThis["setParams"]?.["prototype"]);
$assert.sameValue(globalThis["setParams"]?.["prototype"]?.["constructor"], globalThis["setParams"]);
$verifyProperty(globalThis["setParams"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setParams"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["setParams"], "name", {
  value: "setParams",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["setParams"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
