...
$assert.sameValue($Object_getPrototypeOf(globalThis["f1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f1"]), true);
$assert.callable(globalThis["f1"]);
$assert.constructable(globalThis["f1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]), ['name', 'prototype'], globalThis["f1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f1"]?.["prototype"]), true);
$assert.notCallable(globalThis["f1"]?.["prototype"]);
$assert.notConstructable(globalThis["f1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]?.["prototype"]), ['constructor'], globalThis["f1"]?.["prototype"]);
$assert.sameValue(globalThis["f1"]?.["prototype"]?.["constructor"], globalThis["f1"]);
$verifyProperty(globalThis["f1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f1"], "name", {
  value: "f1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["f2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f2"]), true);
$assert.callable(globalThis["f2"]);
$assert.constructable(globalThis["f2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f2"]), ['name', 'prototype'], globalThis["f2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f2"]?.["prototype"]), true);
$assert.notCallable(globalThis["f2"]?.["prototype"]);
$assert.notConstructable(globalThis["f2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f2"]?.["prototype"]), ['constructor'], globalThis["f2"]?.["prototype"]);
$assert.sameValue(globalThis["f2"]?.["prototype"]?.["constructor"], globalThis["f2"]);
$verifyProperty(globalThis["f2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f2"], "name", {
  value: "f2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["f3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f3"]), true);
$assert.callable(globalThis["f3"]);
$assert.constructable(globalThis["f3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f3"]), ['name', 'prototype'], globalThis["f3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f3"]?.["prototype"]), true);
$assert.notCallable(globalThis["f3"]?.["prototype"]);
$assert.notConstructable(globalThis["f3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f3"]?.["prototype"]), ['constructor'], globalThis["f3"]?.["prototype"]);
$assert.sameValue(globalThis["f3"]?.["prototype"]?.["constructor"], globalThis["f3"]);
$verifyProperty(globalThis["f3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f3"], "name", {
  value: "f3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["f4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f4"]), true);
$assert.callable(globalThis["f4"]);
$assert.constructable(globalThis["f4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f4"]), ['name', 'prototype'], globalThis["f4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f4"]?.["prototype"]), true);
$assert.notCallable(globalThis["f4"]?.["prototype"]);
$assert.notConstructable(globalThis["f4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f4"]?.["prototype"]), ['constructor'], globalThis["f4"]?.["prototype"]);
$assert.sameValue(globalThis["f4"]?.["prototype"]?.["constructor"], globalThis["f4"]);
$verifyProperty(globalThis["f4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f4"], "name", {
  value: "f4",
  writable: false,
  enumerable: false,
  configurable: true,
