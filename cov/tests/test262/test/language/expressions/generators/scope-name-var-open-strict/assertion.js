...
$assert.sameValue($Object_getPrototypeOf(globalThis["func"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func"]), true);
$assert.callable(globalThis["func"]);
$assert.notConstructable(globalThis["func"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func"]), ['length', 'name', 'prototype'], globalThis["func"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["func"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["func"]?.["prototype"]), [], globalThis["func"]?.["prototype"]);
...
$assert.sameValue(globalThis["g"], null);
