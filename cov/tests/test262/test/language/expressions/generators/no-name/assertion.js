...
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["0"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["0"]), true);
$assert.callable(globalThis["a"]?.["0"]);
$assert.notConstructable(globalThis["a"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["0"]), ['length', 'name', 'prototype'], globalThis["a"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["0"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["0"]?.["prototype"]), true);
$assert.notCallable(globalThis["a"]?.["0"]?.["prototype"]);
$assert.notConstructable(globalThis["a"]?.["0"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["0"]?.["prototype"]), [], globalThis["a"]?.["0"]?.["prototype"]);
$verifyProperty(globalThis["a"]?.["0"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["0"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["f"], globalThis["a"]?.["0"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]), globalThis["a"]?.["0"]?.["prototype"]);
