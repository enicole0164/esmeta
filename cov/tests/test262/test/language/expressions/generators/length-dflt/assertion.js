...
$assert.sameValue($Object_getPrototypeOf(globalThis["f1"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f1"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]?.["prototype"]), [], globalThis["f1"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f2"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f2"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f2"]?.["prototype"]), [], globalThis["f2"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f3"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f3"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f3"]?.["prototype"]), [], globalThis["f3"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["f4"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f4"]), true);
$assert.callable(globalThis["f4"]);
$assert.notConstructable(globalThis["f4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f4"]), ['name', 'prototype'], globalThis["f4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f4"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f4"]?.["prototype"]), [], globalThis["f4"]?.["prototype"]);
