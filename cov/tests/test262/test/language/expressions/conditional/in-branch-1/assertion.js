...
$assert.sameValue($Object_getPrototypeOf(globalThis["cond1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cond1"]), true);
$assert.callable(globalThis["cond1"]);
$assert.constructable(globalThis["cond1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cond1"]), ['length', 'name', 'prototype'], globalThis["cond1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cond1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cond1"]?.["prototype"]), true);
$assert.notCallable(globalThis["cond1"]?.["prototype"]);
$assert.notConstructable(globalThis["cond1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cond1"]?.["prototype"]), ['constructor'], globalThis["cond1"]?.["prototype"]);
$assert.sameValue(globalThis["cond1"]?.["prototype"]?.["constructor"], globalThis["cond1"]);
$verifyProperty(globalThis["cond1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cond1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["cond1"], "name", {
  value: "cond1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cond1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["cond1Count"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["cond2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cond2"]), true);
$assert.callable(globalThis["cond2"]);
$assert.constructable(globalThis["cond2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cond2"]), ['length', 'name', 'prototype'], globalThis["cond2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cond2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cond2"]?.["prototype"]), true);
$assert.notCallable(globalThis["cond2"]?.["prototype"]);
$assert.notConstructable(globalThis["cond2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cond2"]?.["prototype"]), ['constructor'], globalThis["cond2"]?.["prototype"]);
$assert.sameValue(globalThis["cond2"]?.["prototype"]?.["constructor"], globalThis["cond2"]);
$verifyProperty(globalThis["cond2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cond2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["cond2"], "name", {
  value: "cond2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cond2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["cond2Count"], 0.0);
