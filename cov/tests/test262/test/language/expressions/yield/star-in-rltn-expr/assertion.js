...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterResult"]), true);
$assert.notCallable(globalThis["iterResult"]);
$assert.notConstructable(globalThis["iterResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterResult"]), ['value', 'done'], globalThis["iterResult"]);
$verifyProperty(globalThis["iterResult"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterResult"], "value", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['hit'], $Object_getPrototypeOf(globalThis["obj"]));
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "hit", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["value"], undefined);
