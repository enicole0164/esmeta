...
$assert.compareArray($Reflect_ownKeys(globalThis["args"]), ['0', 'length', 'callee', Symbol.iterator], globalThis["args"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterable"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterable"]), true);
$assert.notCallable(globalThis["spyIterable"]);
$assert.notConstructable(globalThis["spyIterable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterable"]), [Symbol.iterator], globalThis["spyIterable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterable"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterable"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["spyIterable"]?.[Symbol.iterator]);
$assert.constructable(globalThis["spyIterable"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterable"]?.[Symbol.iterator]), ['length', 'name', 'prototype'], globalThis["spyIterable"]?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]), ['constructor'], globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"]?.["constructor"], globalThis["spyIterable"]?.[Symbol.iterator]);
$verifyProperty(globalThis["spyIterable"]?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterable"]?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["spyIterable"]?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterable"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterable"], Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]), true);
$assert.notCallable(globalThis["spyIterator"]);
$assert.notConstructable(globalThis["spyIterator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]), ['next', 'return'], globalThis["spyIterator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]?.["next"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]?.["next"]), true);
$assert.callable(globalThis["spyIterator"]?.["next"]);
$assert.constructable(globalThis["spyIterator"]?.["next"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]?.["next"]), ['length', 'name', 'prototype'], globalThis["spyIterator"]?.["next"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]?.["next"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]?.["next"]?.["prototype"]), true);
$assert.notCallable(globalThis["spyIterator"]?.["next"]?.["prototype"]);
$assert.notConstructable(globalThis["spyIterator"]?.["next"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]?.["next"]?.["prototype"]), ['constructor'], globalThis["spyIterator"]?.["next"]?.["prototype"]);
$assert.sameValue(globalThis["spyIterator"]?.["next"]?.["prototype"]?.["constructor"], globalThis["spyIterator"]?.["next"]);
$verifyProperty(globalThis["spyIterator"]?.["next"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"]?.["next"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["spyIterator"]?.["next"], "name", {
  value: "next",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"]?.["next"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"], "next", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]?.["return"]), true);
$assert.callable(globalThis["spyIterator"]?.["return"]);
$assert.constructable(globalThis["spyIterator"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]?.["return"]), ['length', 'name', 'prototype'], globalThis["spyIterator"]?.["return"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]?.["return"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]?.["return"]?.["prototype"]), true);
$assert.notCallable(globalThis["spyIterator"]?.["return"]?.["prototype"]);
$assert.notConstructable(globalThis["spyIterator"]?.["return"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]?.["return"]?.["prototype"]), ['constructor'], globalThis["spyIterator"]?.["return"]?.["prototype"]);
$assert.sameValue(globalThis["spyIterator"]?.["return"]?.["prototype"]?.["constructor"], globalThis["spyIterator"]?.["return"]);
$verifyProperty(globalThis["spyIterator"]?.["return"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"]?.["return"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["spyIterator"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"]?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"], "return", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["thisValue"], globalThis["spyIterator"]);
