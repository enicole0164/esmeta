...
$assert.sameValue(globalThis["idx"], 3.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]), ['next'], globalThis["iterable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]?.["next"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterable"]?.["next"]), true);
$assert.callable(globalThis["iterable"]?.["next"]);
$assert.constructable(globalThis["iterable"]?.["next"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]?.["next"]), ['length', 'name', 'prototype'], globalThis["iterable"]?.["next"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]?.["next"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterable"]?.["next"]?.["prototype"]), true);
$assert.notCallable(globalThis["iterable"]?.["next"]?.["prototype"]);
$assert.notConstructable(globalThis["iterable"]?.["next"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]?.["next"]?.["prototype"]), ['constructor'], globalThis["iterable"]?.["next"]?.["prototype"]);
$assert.sameValue(globalThis["iterable"]?.["next"]?.["prototype"]?.["constructor"], globalThis["iterable"]?.["next"]);
$verifyProperty(globalThis["iterable"]?.["next"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterable"]?.["next"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["iterable"]?.["next"], "name", {
  value: "next",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterable"]?.["next"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterable"], "next", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["iterator"]), [Symbol.iterator], globalThis["iterator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterator"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterator"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["iterator"]?.[Symbol.iterator]);
$assert.constructable(globalThis["iterator"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterator"]?.[Symbol.iterator]), ['length', 'name', 'prototype'], globalThis["iterator"]?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]), ['constructor'], globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"]?.["constructor"], globalThis["iterator"]?.[Symbol.iterator]);
$verifyProperty(globalThis["iterator"]?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterator"]?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["iterator"]?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterator"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterator"], Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["results"]), true);
$assert.notCallable(globalThis["results"]);
$assert.notConstructable(globalThis["results"]);
$assert.compareArray($Reflect_ownKeys(globalThis["results"]), ['0', '1', '2', 'length'], globalThis["results"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]?.["1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["results"]?.["1"]), true);
$assert.notCallable(globalThis["results"]?.["1"]);
$assert.notConstructable(globalThis["results"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["1"]), ['value'], globalThis["results"]?.["1"]);
$verifyProperty(globalThis["results"]?.["1"], "value", {
  value: 8.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]?.["2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["results"]?.["2"]), true);
$assert.notCallable(globalThis["results"]?.["2"]);
$assert.notConstructable(globalThis["results"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["2"]), ['value', 'done'], globalThis["results"]?.["2"]);
$verifyProperty(globalThis["results"]?.["2"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"]?.["2"], "value", {
  value: 34.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"], "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["results"]?.["0"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["results"]?.["0"]), true);
$assert.notCallable(globalThis["results"]?.["0"]);
$assert.notConstructable(globalThis["results"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["results"]?.["0"]), ['value'], globalThis["results"]?.["0"]);
$verifyProperty(globalThis["results"]?.["0"], "value", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["results"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
