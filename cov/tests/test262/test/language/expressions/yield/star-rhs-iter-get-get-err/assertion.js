...
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedIter"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedIter"]), true);
$assert.notCallable(globalThis["poisonedIter"]);
$assert.notConstructable(globalThis["poisonedIter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedIter"]), [Symbol.iterator], globalThis["poisonedIter"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedIter"], Symbol.iterator)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedIter"], Symbol.iterator, {
  set: undefined,
  enumerable: false,
  configurable: false,
});
