...
$assert.sameValue($Object_getPrototypeOf(globalThis["generator"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["generator"]), true);
$assert.callable(globalThis["generator"]);
$assert.notConstructable(globalThis["generator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["generator"]), ['length', 'name', 'prototype'], globalThis["generator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["generator"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["generator"]?.["prototype"]), true);
$assert.notCallable(globalThis["generator"]?.["prototype"]);
$assert.notConstructable(globalThis["generator"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["generator"]?.["prototype"]), [], globalThis["generator"]?.["prototype"]);
$verifyProperty(globalThis["generator"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["generator"], "name", {
  value: "generator",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["generator"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]), ['next', 'throw', 'return', Symbol.iterator], globalThis["iterable"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get, "name", {
  value: "get throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterable"], "throw")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterable"], "throw", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get, "name", {
  value: "get return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterable"], "return")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterable"], "return", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["iterator"]), globalThis["generator"]?.["prototype"]);
...
$assert.sameValue(globalThis["returnGets"], 1.0);
$assert.sameValue(globalThis["throwGets"], 1.0);
