...
$assert.sameValue($Object_getPrototypeOf(globalThis["args"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["args"]), true);
$assert.notCallable(globalThis["args"]);
$assert.notConstructable(globalThis["args"]);
$assert.compareArray($Reflect_ownKeys(globalThis["args"]), ['length', 'callee', Symbol.iterator], globalThis["args"]);
$assert.sameValue(globalThis["args"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["args"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["args"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["args"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["args"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["args"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["caught"]), TypeError.prototype);
$assert.notCallable(globalThis["caught"]);
$assert.notConstructable(globalThis["caught"]);
$assert.compareArray($Reflect_ownKeys(globalThis["caught"]), [], globalThis["caught"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedReturn"]), ['next', 'return', 'throw'], globalThis["poisonedReturn"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedReturn"]?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedReturn"]?.["return"]), true);
$assert.callable(globalThis["poisonedReturn"]?.["return"]);
$assert.constructable(globalThis["poisonedReturn"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedReturn"]?.["return"]), ['length', 'name', 'prototype'], globalThis["poisonedReturn"]?.["return"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedReturn"]?.["return"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedReturn"]?.["return"]?.["prototype"]), true);
$assert.notCallable(globalThis["poisonedReturn"]?.["return"]?.["prototype"]);
$assert.notConstructable(globalThis["poisonedReturn"]?.["return"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedReturn"]?.["return"]?.["prototype"]), ['constructor'], globalThis["poisonedReturn"]?.["return"]?.["prototype"]);
$assert.sameValue(globalThis["poisonedReturn"]?.["return"]?.["prototype"]?.["constructor"], globalThis["poisonedReturn"]?.["return"]);
$verifyProperty(globalThis["poisonedReturn"]?.["return"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedReturn"]?.["return"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["poisonedReturn"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedReturn"]?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["thisValue"], globalThis["poisonedReturn"]);
$assert.sameValue(globalThis["throwCount"], 1.0);
