...
$assert.sameValue($Object_getPrototypeOf(globalThis["g1"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g1"]), true);
$assert.callable(globalThis["g1"]);
$assert.notConstructable(globalThis["g1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g1"]), ['length', 'name', 'prototype'], globalThis["g1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g1"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g1"]?.["prototype"]), true);
$assert.notCallable(globalThis["g1"]?.["prototype"]);
$assert.notConstructable(globalThis["g1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g1"]?.["prototype"]), [], globalThis["g1"]?.["prototype"]);
$verifyProperty(globalThis["g1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["g1"], "name", {
  value: "g1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["g2"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g2"]), true);
$assert.callable(globalThis["g2"]);
$assert.notConstructable(globalThis["g2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g2"]), ['length', 'name', 'prototype'], globalThis["g2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g2"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g2"]?.["prototype"]), true);
$assert.notCallable(globalThis["g2"]?.["prototype"]);
$assert.notConstructable(globalThis["g2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g2"]?.["prototype"]), [], globalThis["g2"]?.["prototype"]);
$verifyProperty(globalThis["g2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["g2"], "name", {
  value: "g2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["g3"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g3"]), true);
$assert.callable(globalThis["g3"]);
$assert.notConstructable(globalThis["g3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g3"]), ['length', 'name', 'prototype'], globalThis["g3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g3"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g3"]?.["prototype"]), true);
$assert.notCallable(globalThis["g3"]?.["prototype"]);
$assert.notConstructable(globalThis["g3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g3"]?.["prototype"]), [], globalThis["g3"]?.["prototype"]);
$verifyProperty(globalThis["g3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["g3"], "name", {
  value: "g3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["g4"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g4"]), true);
$assert.callable(globalThis["g4"]);
$assert.notConstructable(globalThis["g4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g4"]), ['length', 'name', 'prototype'], globalThis["g4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g4"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g4"]?.["prototype"]), true);
$assert.notCallable(globalThis["g4"]?.["prototype"]);
$assert.notConstructable(globalThis["g4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g4"]?.["prototype"]), [], globalThis["g4"]?.["prototype"]);
$verifyProperty(globalThis["g4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["g4"], "name", {
  value: "g4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["g5"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g5"]), true);
$assert.callable(globalThis["g5"]);
$assert.notConstructable(globalThis["g5"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g5"]), ['length', 'name', 'prototype'], globalThis["g5"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g5"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g5"]?.["prototype"]), true);
$assert.notCallable(globalThis["g5"]?.["prototype"]);
$assert.notConstructable(globalThis["g5"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g5"]?.["prototype"]), [], globalThis["g5"]?.["prototype"]);
$verifyProperty(globalThis["g5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["g5"], "name", {
  value: "g5",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g5"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["iter"]), globalThis["g5"]?.["prototype"]);
