...
$assert.sameValue(globalThis["hitCatch"], false);
$assert.sameValue(globalThis["hitFinally"], true);
$assert.sameValue(globalThis["hitNextStatement"], false);
...
$assert.sameValue(globalThis["throwCount"], 0.0);
