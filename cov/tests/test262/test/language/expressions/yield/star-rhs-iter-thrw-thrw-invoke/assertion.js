...
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]), ['next', 'throw'], globalThis["spyIterator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]?.["throw"]), true);
$assert.callable(globalThis["spyIterator"]?.["throw"]);
$assert.constructable(globalThis["spyIterator"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]?.["throw"]), ['length', 'name', 'prototype'], globalThis["spyIterator"]?.["throw"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyIterator"]?.["throw"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyIterator"]?.["throw"]?.["prototype"]), true);
$assert.notCallable(globalThis["spyIterator"]?.["throw"]?.["prototype"]);
$assert.notConstructable(globalThis["spyIterator"]?.["throw"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyIterator"]?.["throw"]?.["prototype"]), ['constructor'], globalThis["spyIterator"]?.["throw"]?.["prototype"]);
$assert.sameValue(globalThis["spyIterator"]?.["throw"]?.["prototype"]?.["constructor"], globalThis["spyIterator"]?.["throw"]);
$verifyProperty(globalThis["spyIterator"]?.["throw"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"]?.["throw"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["spyIterator"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyIterator"], "throw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
