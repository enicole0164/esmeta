...
$assert.sameValue($Object_getPrototypeOf(globalThis["__map"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__map"]), true);
$assert.notCallable(globalThis["__map"]);
$assert.notConstructable(globalThis["__map"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__map"]), ['5', '6', 'shape'], globalThis["__map"]);
$verifyProperty(globalThis["__map"], "5", {
  value: "five",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__map"], "shape", {
  value: "cube",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__map"], "6", {
  value: "six",
  writable: true,
  enumerable: true,
  configurable: true,
