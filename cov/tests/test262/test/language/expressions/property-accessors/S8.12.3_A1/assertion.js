...
$assert.compareArray($Reflect_ownKeys(globalThis["FooObj"]?.["prototype"]), ['constructor', 'propFoo'], globalThis["FooObj"]?.["prototype"]);
$verifyProperty(globalThis["FooObj"]?.["prototype"], "propFoo", {
  value: "some",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]), globalThis["FooObj"]?.["prototype"]);
