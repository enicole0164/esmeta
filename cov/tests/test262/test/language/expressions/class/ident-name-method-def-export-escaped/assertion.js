...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'export'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["export"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["export"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["export"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["export"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["export"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["export"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["export"], "name", {
  value: "export",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["export"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "export", {
  writable: true,
  enumerable: false,
  configurable: true,
});
