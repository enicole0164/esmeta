...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'enum'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["enum"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["enum"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["enum"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["enum"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["enum"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["enum"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["enum"], "name", {
  value: "enum",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["enum"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "enum", {
  writable: true,
  enumerable: false,
  configurable: true,
});
