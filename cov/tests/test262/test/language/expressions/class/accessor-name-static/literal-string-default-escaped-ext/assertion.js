...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'default'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get, "name", {
  value: "get default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set, "name", {
  value: "set default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "default")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "default", {
  enumerable: false,
  configurable: true,
});
