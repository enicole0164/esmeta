...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['2', 'length', 'name', 'prototype'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get, "name", {
  value: "get 2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set, "name", {
  value: "set 2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "2")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "2", {
  enumerable: false,
  configurable: true,
});
