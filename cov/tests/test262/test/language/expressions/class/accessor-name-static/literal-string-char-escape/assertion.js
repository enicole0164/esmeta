...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'character	escape'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get, "name", {
  value: "get character	escape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set, "name", {
  value: "set character	escape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "character	escape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "character	escape", {
  enumerable: false,
  configurable: true,
});
