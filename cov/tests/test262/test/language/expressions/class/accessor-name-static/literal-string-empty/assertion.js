...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set, "name", {
  value: "set ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
