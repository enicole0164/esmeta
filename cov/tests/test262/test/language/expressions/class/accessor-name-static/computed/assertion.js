...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'string'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get, "name", {
  value: "get string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set, "name", {
  value: "set string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "string")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "string", {
  enumerable: false,
  configurable: true,
});
