...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'lineContinuation'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get, "name", {
  value: "get lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set, "name", {
  value: "set lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "lineContinuation")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "lineContinuation", {
  enumerable: false,
  configurable: true,
});
