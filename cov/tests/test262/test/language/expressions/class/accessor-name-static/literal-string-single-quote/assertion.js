...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'singleQuote'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get, "name", {
  value: "get singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set, "name", {
  value: "set singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "singleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "singleQuote", {
  enumerable: false,
  configurable: true,
});
