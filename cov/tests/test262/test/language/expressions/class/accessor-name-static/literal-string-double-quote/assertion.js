...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'doubleQuote'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get, "name", {
  value: "get doubleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set, "name", {
  value: "set doubleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "doubleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "doubleQuote", {
  enumerable: false,
  configurable: true,
});
