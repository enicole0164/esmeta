...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'hexEscape'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get, "name", {
  value: "get hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set, "name", {
  value: "set hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "hexEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "hexEscape", {
  enumerable: false,
  configurable: true,
});
