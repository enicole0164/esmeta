...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'unicodeEscape'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get, "name", {
  value: "get unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set, "name", {
  value: "set unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "unicodeEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "unicodeEscape", {
  enumerable: false,
  configurable: true,
});
