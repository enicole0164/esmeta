...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['1000000000', 'length', 'name', 'prototype'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get, "name", {
  value: "get 1000000000",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set, "name", {
  value: "set 1000000000",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "1000000000")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "1000000000", {
  enumerable: false,
  configurable: true,
});
