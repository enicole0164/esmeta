...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'delete'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["delete"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["delete"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["delete"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["delete"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["delete"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["delete"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["delete"], "name", {
  value: "delete",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["delete"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "delete", {
  writable: true,
  enumerable: false,
  configurable: true,
});
