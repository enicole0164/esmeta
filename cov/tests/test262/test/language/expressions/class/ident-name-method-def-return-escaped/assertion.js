...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'return'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["return"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["return"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["return"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["return"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "return", {
  writable: true,
  enumerable: false,
  configurable: true,
});
