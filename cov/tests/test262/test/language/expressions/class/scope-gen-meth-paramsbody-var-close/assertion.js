...
$assert.sameValue($Object_getPrototypeOf(globalThis["probe"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probe"]), true);
$assert.callable(globalThis["probe"]);
$assert.constructable(globalThis["probe"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probe"]), ['length', 'name', 'prototype'], globalThis["probe"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probe"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probe"]?.["prototype"]), true);
$assert.notCallable(globalThis["probe"]?.["prototype"]);
$assert.notConstructable(globalThis["probe"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probe"]?.["prototype"]), ['constructor'], globalThis["probe"]?.["prototype"]);
$assert.sameValue(globalThis["probe"]?.["prototype"]?.["constructor"], globalThis["probe"]);
$verifyProperty(globalThis["probe"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probe"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probe"], "name", {
  value: "probe",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probe"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
