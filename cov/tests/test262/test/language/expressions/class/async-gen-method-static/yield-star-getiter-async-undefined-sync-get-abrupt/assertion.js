...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get, "name", {
  value: "get [Symbol.asyncIterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], Symbol.asyncIterator)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["reason"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["reason"]), true);
$assert.notCallable(globalThis["reason"]);
$assert.notConstructable(globalThis["reason"]);
$assert.compareArray($Reflect_ownKeys(globalThis["reason"]), [], globalThis["reason"]);
