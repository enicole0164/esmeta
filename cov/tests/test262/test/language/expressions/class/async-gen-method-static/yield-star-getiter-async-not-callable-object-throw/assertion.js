...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.asyncIterator]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.asyncIterator]), true);
$assert.notCallable(globalThis["obj"]?.[Symbol.asyncIterator]);
$assert.notConstructable(globalThis["obj"]?.[Symbol.asyncIterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.asyncIterator]), [], globalThis["obj"]?.[Symbol.asyncIterator]);
