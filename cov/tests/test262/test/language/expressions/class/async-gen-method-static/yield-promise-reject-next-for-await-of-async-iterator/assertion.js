...
$assert.sameValue($Object_getPrototypeOf(globalThis["readFile"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["readFile"]), true);
$assert.callable(globalThis["readFile"]);
$assert.notConstructable(globalThis["readFile"]);
$assert.compareArray($Reflect_ownKeys(globalThis["readFile"]), ['length', 'name', 'prototype'], globalThis["readFile"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["readFile"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["readFile"]?.["prototype"]), true);
$assert.notCallable(globalThis["readFile"]?.["prototype"]);
$assert.notConstructable(globalThis["readFile"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["readFile"]?.["prototype"]), [], globalThis["readFile"]?.["prototype"]);
$verifyProperty(globalThis["readFile"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["readFile"], "name", {
  value: "readFile",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["readFile"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(error), Error.prototype);
$assert.sameValue(Object.isExtensible(error), true);
$assert.notCallable(error);
$assert.notConstructable(error);
$assert.compareArray($Reflect_ownKeys(error), [], error);
