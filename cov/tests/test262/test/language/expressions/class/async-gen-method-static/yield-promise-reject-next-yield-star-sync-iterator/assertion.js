...
$assert.sameValue($Object_getPrototypeOf(iterable), Array.prototype);
$assert.sameValue(Object.isExtensible(iterable), true);
$assert.notCallable(iterable);
$assert.notConstructable(iterable);
$assert.compareArray($Reflect_ownKeys(iterable), ['0', '1', 'length'], iterable);
$verifyProperty(iterable, "1", {
  value: "unreachable",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(iterable, "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(iterable?.["0"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(iterable?.["0"]), true);
$assert.notCallable(iterable?.["0"]);
$assert.notConstructable(iterable?.["0"]);
$assert.compareArray($Reflect_ownKeys(iterable?.["0"]), [], iterable?.["0"]);
$verifyProperty(iterable, "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
