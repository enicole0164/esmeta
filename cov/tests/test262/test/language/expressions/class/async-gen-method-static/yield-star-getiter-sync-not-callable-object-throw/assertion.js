...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.iterator]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.iterator]), true);
$assert.notCallable(globalThis["obj"]?.[Symbol.iterator]);
$assert.notConstructable(globalThis["obj"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.iterator]), [], globalThis["obj"]?.[Symbol.iterator]);
