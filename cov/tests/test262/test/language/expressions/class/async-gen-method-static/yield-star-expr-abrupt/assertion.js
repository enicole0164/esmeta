...
$assert.sameValue($Object_getPrototypeOf(globalThis["abrupt"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["abrupt"]), true);
$assert.callable(globalThis["abrupt"]);
$assert.constructable(globalThis["abrupt"]);
$assert.compareArray($Reflect_ownKeys(globalThis["abrupt"]), ['length', 'name', 'prototype'], globalThis["abrupt"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["abrupt"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["abrupt"]?.["prototype"]), true);
$assert.notCallable(globalThis["abrupt"]?.["prototype"]);
$assert.notConstructable(globalThis["abrupt"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["abrupt"]?.["prototype"]), ['constructor'], globalThis["abrupt"]?.["prototype"]);
$assert.sameValue(globalThis["abrupt"]?.["prototype"]?.["constructor"], globalThis["abrupt"]);
$verifyProperty(globalThis["abrupt"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["abrupt"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["abrupt"], "name", {
  value: "abrupt",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["abrupt"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
