...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'void'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["void"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["void"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["void"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["void"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["void"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["void"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["void"], "name", {
  value: "void",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["void"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "void", {
  writable: true,
  enumerable: false,
  configurable: true,
});
