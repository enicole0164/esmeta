...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'false'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set, "name", {
  value: "set false",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "false")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "false", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
