...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'a'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set, "name", {
  value: "set a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "a")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "a", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
