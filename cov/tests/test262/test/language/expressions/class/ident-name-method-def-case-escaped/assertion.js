...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'case'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["case"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["case"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["case"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["case"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["case"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["case"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["case"], "name", {
  value: "case",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["case"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "case", {
  writable: true,
  enumerable: false,
  configurable: true,
});
