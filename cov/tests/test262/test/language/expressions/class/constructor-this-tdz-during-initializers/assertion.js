...
$assert.constructable($Object_getPrototypeOf(globalThis["C"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["C"])), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["C"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["C"])?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["C"])?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["C"])?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["C"])?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["C"])?.["prototype"]), ['constructor'], $Object_getPrototypeOf(globalThis["C"])?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"])?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["C"]));
$verifyProperty($Object_getPrototypeOf(globalThis["C"])?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["C"]), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]), $Object_getPrototypeOf(globalThis["C"])?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["instance"]), globalThis["C"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["instance"]), ['field'], globalThis["instance"]);
$assert.sameValue(globalThis["instance"]?.["field"], globalThis["instance"]);
$verifyProperty(globalThis["instance"], "field", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeCtorThis"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeCtorThis"]), true);
$assert.callable(globalThis["probeCtorThis"]);
$assert.notConstructable(globalThis["probeCtorThis"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeCtorThis"]), ['length', 'name'], globalThis["probeCtorThis"]);
$verifyProperty(globalThis["probeCtorThis"], "name", {
  value: "probeCtorThis",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeCtorThis"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["thisDuringCtor"], globalThis["instance"]);
$assert.sameValue(globalThis["thisDuringField"], globalThis["instance"]);
$assert.sameValue(globalThis["thisFromProbe"], globalThis["instance"]);
$assert.sameValue(Base, $Object_getPrototypeOf(globalThis["C"]));
