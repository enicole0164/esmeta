...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'interface'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["interface"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["interface"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["interface"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["interface"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["interface"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["interface"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["interface"], "name", {
  value: "interface",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["interface"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "interface", {
  writable: true,
  enumerable: false,
  configurable: true,
});
