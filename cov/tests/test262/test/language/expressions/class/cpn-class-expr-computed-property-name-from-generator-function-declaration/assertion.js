...
$assert.sameValue($Object_getPrototypeOf(C?.["[object Generator]"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["[object Generator]"]), true);
$assert.callable(C?.["[object Generator]"]);
$assert.notConstructable(C?.["[object Generator]"]);
$assert.compareArray($Reflect_ownKeys(C?.["[object Generator]"]), ['length', 'name'], C?.["[object Generator]"]);
$verifyProperty(C?.["[object Generator]"], "name", {
  value: "[object Generator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["[object Generator]"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["[object Generator]"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["[object Generator]"]), true);
$assert.callable(C?.["prototype"]?.["[object Generator]"]);
$assert.notConstructable(C?.["prototype"]?.["[object Generator]"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["[object Generator]"]), ['length', 'name'], C?.["prototype"]?.["[object Generator]"]);
$verifyProperty(C?.["prototype"]?.["[object Generator]"], "name", {
  value: "[object Generator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["[object Generator]"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
