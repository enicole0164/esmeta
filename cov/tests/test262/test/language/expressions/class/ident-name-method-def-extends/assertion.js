...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'extends'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["extends"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["extends"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["extends"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["extends"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["extends"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["extends"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["extends"], "name", {
  value: "extends",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["extends"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "extends", {
  writable: true,
  enumerable: false,
  configurable: true,
});
