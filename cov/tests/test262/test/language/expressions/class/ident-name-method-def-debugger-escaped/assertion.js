...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'debugger'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["debugger"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["debugger"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["debugger"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["debugger"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["debugger"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["debugger"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["debugger"], "name", {
  value: "debugger",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["debugger"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "debugger", {
  writable: true,
  enumerable: false,
  configurable: true,
});
