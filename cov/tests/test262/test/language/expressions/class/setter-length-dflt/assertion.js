...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set), ['name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set, "name", {
  value: "set m",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["set"], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "m")?.set);
