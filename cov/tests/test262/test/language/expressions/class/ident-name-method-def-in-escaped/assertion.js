...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'in'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["in"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["in"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["in"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["in"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["in"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["in"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["in"], "name", {
  value: "in",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["in"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "in", {
  writable: true,
  enumerable: false,
  configurable: true,
});
