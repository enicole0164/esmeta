...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'function'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["function"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["function"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["function"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["function"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["function"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["function"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["function"], "name", {
  value: "function",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["function"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "function", {
  writable: true,
  enumerable: false,
  configurable: true,
});
