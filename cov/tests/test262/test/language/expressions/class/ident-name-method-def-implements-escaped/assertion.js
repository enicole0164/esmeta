...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'implements'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["implements"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["implements"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["implements"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["implements"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["implements"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["implements"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["implements"], "name", {
  value: "implements",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["implements"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "implements", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), globalThis["C"]?.["prototype"]);
