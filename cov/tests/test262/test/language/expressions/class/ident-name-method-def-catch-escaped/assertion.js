...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'catch'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["catch"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["catch"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["catch"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["catch"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["catch"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["catch"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["catch"], "name", {
  value: "catch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["catch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "catch", {
  writable: true,
  enumerable: false,
  configurable: true,
});
