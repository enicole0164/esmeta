...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'for'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["for"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["for"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["for"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["for"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["for"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["for"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["for"], "name", {
  value: "for",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["for"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "for", {
  writable: true,
  enumerable: false,
  configurable: true,
});
