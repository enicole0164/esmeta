...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["default"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["default"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["default"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["default"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["default"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["default"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["default"], "name", {
  value: "default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["default"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
