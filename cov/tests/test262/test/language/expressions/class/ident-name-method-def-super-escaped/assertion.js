...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'super'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["super"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["super"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["super"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["super"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["super"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["super"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["super"], "name", {
  value: "super",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["super"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "super", {
  writable: true,
  enumerable: false,
  configurable: true,
});
