...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'class'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["class"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["class"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["class"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["class"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["class"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["class"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["class"], "name", {
  value: "class",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["class"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "class", {
  writable: true,
  enumerable: false,
  configurable: true,
});
