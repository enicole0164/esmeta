...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'this'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["this"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["this"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["this"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["this"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["this"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["this"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["this"], "name", {
  value: "this",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["this"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "this", {
  writable: true,
  enumerable: false,
  configurable: true,
});
