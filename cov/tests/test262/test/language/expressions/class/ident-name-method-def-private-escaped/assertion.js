...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'private'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["private"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["private"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["private"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["private"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["private"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["private"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["private"], "name", {
  value: "private",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["private"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "private", {
  writable: true,
  enumerable: false,
  configurable: true,
});
