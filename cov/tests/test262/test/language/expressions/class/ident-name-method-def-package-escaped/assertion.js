...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'package'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["package"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["package"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["package"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["package"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["package"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["package"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["package"], "name", {
  value: "package",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["package"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "package", {
  writable: true,
  enumerable: false,
  configurable: true,
});
