...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'finally'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["finally"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["finally"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["finally"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["finally"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["finally"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["finally"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["finally"], "name", {
  value: "finally",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["finally"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "finally", {
  writable: true,
  enumerable: false,
  configurable: true,
});
