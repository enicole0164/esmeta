...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'unicodeEscape'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get, "name", {
  value: "get unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set, "name", {
  value: "set unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "unicodeEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "unicodeEscape", {
  enumerable: false,
  configurable: true,
});
