...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['16', 'constructor'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get, "name", {
  value: "get 16",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set, "name", {
  value: "set 16",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "16")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "16", {
  enumerable: false,
  configurable: true,
});
