...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', '1e-7'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get, "name", {
  value: "get 1e-7",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set, "name", {
  value: "set 1e-7",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "1e-7")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "1e-7", {
  enumerable: false,
  configurable: true,
});
