...
$assert.sameValue(Object.isExtensible(globalThis["badKey"]), true);
$assert.notCallable(globalThis["badKey"]);
$assert.notConstructable(globalThis["badKey"]);
$assert.compareArray($Reflect_ownKeys(globalThis["badKey"]), [], globalThis["badKey"]);
