...
$assert.sameValue(globalThis["falseCount"], 0.0);
$assert.sameValue(globalThis["nanCount"], 0.0);
$assert.sameValue(globalThis["nullCount"], 0.0);
...
$assert.sameValue(globalThis["objCount"], 0.0);
$assert.sameValue(globalThis["ref"], globalThis["C"]?.["prototype"]?.["method"]);
$assert.sameValue(globalThis["stringCount"], 0.0);
$assert.sameValue(globalThis["zeroCount"], 0.0);
