...
$assert.compareArray($Reflect_ownKeys(C), ['1', 'length', 'name', 'prototype'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "1")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "1")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "1")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "1")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "1")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "1")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1")?.get, "name", {
  value: "get 1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "1")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "1")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "1")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "1")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "1")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "1")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1")?.set, "name", {
  value: "set 1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['1', 'constructor'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get, "name", {
  value: "get 1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set, "name", {
  value: "set 1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "1")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
