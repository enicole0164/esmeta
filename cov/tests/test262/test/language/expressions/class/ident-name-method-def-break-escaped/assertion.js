...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'break'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["break"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["break"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["break"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["break"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["break"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["break"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["break"], "name", {
  value: "break",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["break"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "break", {
  writable: true,
  enumerable: false,
  configurable: true,
});
