...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'let'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["let"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["let"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["let"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["let"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["let"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["let"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["let"], "name", {
  value: "let",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["let"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "let", {
  writable: true,
  enumerable: false,
  configurable: true,
});
