...
$assert.sameValue($Object_getPrototypeOf(C?.["null"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["null"]), true);
$assert.callable(C?.["null"]);
$assert.notConstructable(C?.["null"]);
$assert.compareArray($Reflect_ownKeys(C?.["null"]), ['length', 'name'], C?.["null"]);
$verifyProperty(C?.["null"], "name", {
  value: "null",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["null"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["null"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["null"]), true);
$assert.callable(C?.["prototype"]?.["null"]);
$assert.notConstructable(C?.["prototype"]?.["null"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["null"]), ['length', 'name'], C?.["prototype"]?.["null"]);
$verifyProperty(C?.["prototype"]?.["null"], "name", {
  value: "null",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["null"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
