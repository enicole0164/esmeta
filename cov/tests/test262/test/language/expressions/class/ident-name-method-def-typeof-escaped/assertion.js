...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'typeof'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["typeof"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["typeof"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["typeof"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["typeof"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["typeof"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["typeof"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["typeof"], "name", {
  value: "typeof",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["typeof"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "typeof", {
  writable: true,
  enumerable: false,
  configurable: true,
});
