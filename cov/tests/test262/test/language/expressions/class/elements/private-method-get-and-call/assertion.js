...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'getPrivateMethod'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["getPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["getPrivateMethod"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["getPrivateMethod"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["getPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["getPrivateMethod"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["getPrivateMethod"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["getPrivateMethod"], "name", {
  value: "getPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["getPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "getPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(o1), Object.prototype);
$assert.sameValue(Object.isExtensible(o1), true);
$assert.notCallable(o1);
$assert.notConstructable(o1);
$assert.compareArray($Reflect_ownKeys(o1), ['_v'], o1);
$verifyProperty(o1, "_v", {
  value: "test262",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(o2), ['_v'], o2);
$verifyProperty(o2, "_v", {
  value: "foo",
  writable: true,
  enumerable: true,
  configurable: true,
