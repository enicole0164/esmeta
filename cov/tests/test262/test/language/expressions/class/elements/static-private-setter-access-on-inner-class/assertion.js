...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'Inner', '_v'], globalThis["C"]);
...
$verifyProperty(globalThis["C"], "_v", {
  value: "Test262",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["Inner"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["Inner"]), true);
$assert.callable(globalThis["C"]?.["Inner"]);
$assert.constructable(globalThis["C"]?.["Inner"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["Inner"]), ['length', 'name', 'prototype', 'access'], globalThis["C"]?.["Inner"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["Inner"]?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["Inner"]?.["access"]), true);
$assert.callable(globalThis["C"]?.["Inner"]?.["access"]);
$assert.notConstructable(globalThis["C"]?.["Inner"]?.["access"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["Inner"]?.["access"]), ['length', 'name'], globalThis["C"]?.["Inner"]?.["access"]);
$verifyProperty(globalThis["C"]?.["Inner"]?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["Inner"]?.["access"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["Inner"], "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["Inner"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["Inner"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["Inner"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["Inner"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["Inner"]?.["prototype"]), ['constructor'], globalThis["C"]?.["Inner"]?.["prototype"]);
$assert.sameValue(globalThis["C"]?.["Inner"]?.["prototype"]?.["constructor"], globalThis["C"]?.["Inner"]);
$verifyProperty(globalThis["C"]?.["Inner"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["Inner"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["Inner"], "name", {
  value: "Inner",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["Inner"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "Inner", {
  writable: true,
  enumerable: true,
  configurable: true,
});
