...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'checkPrivateGetter'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["checkPrivateGetter"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"], "name", {
  value: "checkPrivateGetter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["checkPrivateGetter"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "checkPrivateGetter", {
  writable: true,
  enumerable: false,
  configurable: true,
});
