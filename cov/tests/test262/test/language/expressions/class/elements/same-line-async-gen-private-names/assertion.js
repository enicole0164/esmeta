...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'x', 'y', 'm'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["x"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["x"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["x"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["x"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["x"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "x", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["y"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["y"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["y"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["y"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["y"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["y"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["y"], "name", {
  value: "y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["y"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "y", {
  writable: true,
  enumerable: false,
  configurable: true,
});
