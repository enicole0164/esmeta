...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["constructor"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["constructor"]), true);
$assert.callable(globalThis["C"]?.["constructor"]);
$assert.notConstructable(globalThis["C"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["constructor"]), ['length', 'name', 'prototype'], globalThis["C"]?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["constructor"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["constructor"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["constructor"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["constructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["constructor"]?.["prototype"]), [], globalThis["C"]?.["constructor"]?.["prototype"]);
$verifyProperty(globalThis["C"]?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["constructor"], "name", {
  value: "constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
