...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'f'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["f"]), true);
$assert.callable(globalThis["C"]?.["f"]);
$assert.notConstructable(globalThis["C"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["f"]), ['length', 'name'], globalThis["C"]?.["f"]);
$verifyProperty(globalThis["C"]?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(D), globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(D?.["prototype"]), globalThis["C"]?.["prototype"]);
