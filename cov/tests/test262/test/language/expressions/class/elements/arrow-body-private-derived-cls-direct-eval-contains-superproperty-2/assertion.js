...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]), globalThis["A"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]), globalThis["A"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'x'], globalThis["C"]?.["prototype"]);
