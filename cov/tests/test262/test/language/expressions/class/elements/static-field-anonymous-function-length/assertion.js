...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'accessPrivateField', 'field'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["accessPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["accessPrivateField"]), true);
$assert.callable(globalThis["C"]?.["accessPrivateField"]);
$assert.notConstructable(globalThis["C"]?.["accessPrivateField"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["accessPrivateField"]), ['length', 'name'], globalThis["C"]?.["accessPrivateField"]);
$verifyProperty(globalThis["C"]?.["accessPrivateField"], "name", {
  value: "accessPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["accessPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "accessPrivateField", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["field"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["field"]), true);
$assert.callable(globalThis["C"]?.["field"]);
$assert.constructable(globalThis["C"]?.["field"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["field"]), ['length', 'name', 'prototype'], globalThis["C"]?.["field"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["field"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["field"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["field"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["field"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["field"]?.["prototype"]), ['constructor'], globalThis["C"]?.["field"]?.["prototype"]);
$assert.sameValue(globalThis["C"]?.["field"]?.["prototype"]?.["constructor"], globalThis["C"]?.["field"]);
$verifyProperty(globalThis["C"]?.["field"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["field"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["field"], "name", {
  value: "field",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["field"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "field", {
  writable: true,
  enumerable: true,
  configurable: true,
});
