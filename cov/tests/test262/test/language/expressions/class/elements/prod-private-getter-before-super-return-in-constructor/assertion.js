...
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]), ['constructor', 'f'], D?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(D?.["prototype"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(D?.["prototype"]?.["f"]), true);
$assert.callable(D?.["prototype"]?.["f"]);
$assert.notConstructable(D?.["prototype"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]?.["f"]), ['length', 'name'], D?.["prototype"]?.["f"]);
$verifyProperty(D?.["prototype"]?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"], "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
