...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', '$', '_', 'o', '℘', 'ZW_‌_NJ', 'ZW_‍_J', 'm'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["m"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["m"]), true);
$assert.callable(globalThis["C"]?.["m"]);
$assert.notConstructable(globalThis["C"]?.["m"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["m"]), ['length', 'name', 'prototype'], globalThis["C"]?.["m"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["m"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["m"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["m"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["m"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["m"]?.["prototype"]), [], globalThis["C"]?.["m"]?.["prototype"]);
$verifyProperty(globalThis["C"]?.["m"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["m"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["m"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
