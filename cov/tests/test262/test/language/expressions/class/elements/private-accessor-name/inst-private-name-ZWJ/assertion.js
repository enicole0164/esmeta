...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'getPrivateReference', 'setPrivateReference'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["getPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["getPrivateReference"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["getPrivateReference"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["getPrivateReference"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["getPrivateReference"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["getPrivateReference"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["getPrivateReference"], "name", {
  value: "getPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["getPrivateReference"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "getPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["setPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["setPrivateReference"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["setPrivateReference"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["setPrivateReference"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["setPrivateReference"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["setPrivateReference"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["setPrivateReference"], "name", {
  value: "setPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["setPrivateReference"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "setPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["inst"]), globalThis["C"]?.["prototype"]);
