...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'checkPrivateSetter'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["checkPrivateSetter"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"], "name", {
  value: "checkPrivateSetter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["checkPrivateSetter"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "checkPrivateSetter", {
  writable: true,
  enumerable: false,
  configurable: true,
});
