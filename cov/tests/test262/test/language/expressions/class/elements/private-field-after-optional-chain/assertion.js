...
$assert.compareArray($Reflect_ownKeys(o), ['c'], o);
$assert.sameValue($Object_getPrototypeOf(o?.["c"]), Object.prototype);
$assert.sameValue(Object.isExtensible(o?.["c"]), true);
$assert.notCallable(o?.["c"]);
$assert.notConstructable(o?.["c"]);
$assert.compareArray($Reflect_ownKeys(o?.["c"]), [], o?.["c"]);
$verifyProperty(o, "c", {
  writable: true,
  enumerable: true,
  configurable: true,
