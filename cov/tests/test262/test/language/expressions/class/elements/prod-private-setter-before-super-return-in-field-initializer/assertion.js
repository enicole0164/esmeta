...
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]), ['constructor', 'g'], D?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(D?.["prototype"]?.["g"]), Function.prototype);
$assert.sameValue(Object.isExtensible(D?.["prototype"]?.["g"]), true);
$assert.callable(D?.["prototype"]?.["g"]);
$assert.notConstructable(D?.["prototype"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]?.["g"]), ['length', 'name'], D?.["prototype"]?.["g"]);
$verifyProperty(D?.["prototype"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"], "g", {
  writable: true,
  enumerable: false,
  configurable: true,
});
