...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.[Symbol.toPrimitive]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.[Symbol.toPrimitive]), true);
$assert.notCallable(globalThis["obj"]?.[Symbol.toPrimitive]);
$assert.notConstructable(globalThis["obj"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.[Symbol.toPrimitive]), [], globalThis["obj"]?.[Symbol.toPrimitive]);
