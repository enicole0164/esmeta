...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'constructor'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get, "name", {
  value: "get constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set, "name", {
  value: "set constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "constructor")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "constructor", {
  enumerable: false,
  configurable: true,
});
