...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'methodAccess', 'B'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["methodAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["methodAccess"]), true);
$assert.callable(globalThis["C"]?.["methodAccess"]);
$assert.notConstructable(globalThis["C"]?.["methodAccess"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["methodAccess"]), ['length', 'name'], globalThis["C"]?.["methodAccess"]);
$verifyProperty(globalThis["C"]?.["methodAccess"], "name", {
  value: "methodAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["methodAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "methodAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["B"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["B"]), true);
$assert.callable(globalThis["C"]?.["B"]);
$assert.constructable(globalThis["C"]?.["B"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]), ['length', 'name', 'prototype', 'fieldAccess'], globalThis["C"]?.["B"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["B"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["B"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["B"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["B"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]?.["prototype"]), ['constructor'], globalThis["C"]?.["B"]?.["prototype"]);
$assert.sameValue(globalThis["C"]?.["B"]?.["prototype"]?.["constructor"], globalThis["C"]?.["B"]);
$verifyProperty(globalThis["C"]?.["B"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["B"], "name", {
  value: "B",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["B"]?.["fieldAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["B"]?.["fieldAccess"]), true);
$assert.callable(globalThis["C"]?.["B"]?.["fieldAccess"]);
$assert.notConstructable(globalThis["C"]?.["B"]?.["fieldAccess"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]?.["fieldAccess"]), ['length', 'name'], globalThis["C"]?.["B"]?.["fieldAccess"]);
$verifyProperty(globalThis["C"]?.["B"]?.["fieldAccess"], "name", {
  value: "fieldAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"]?.["fieldAccess"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"], "fieldAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "B", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(b), globalThis["C"]?.["B"]?.["prototype"]);
