...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'getPrivateMethod'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["getPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["getPrivateMethod"]), true);
$assert.callable(globalThis["C"]?.["getPrivateMethod"]);
$assert.notConstructable(globalThis["C"]?.["getPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["getPrivateMethod"]), ['length', 'name'], globalThis["C"]?.["getPrivateMethod"]);
$verifyProperty(globalThis["C"]?.["getPrivateMethod"], "name", {
  value: "getPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["getPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "getPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
