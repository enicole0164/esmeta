...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'fieldAccess', 'B'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["fieldAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["fieldAccess"]), true);
$assert.callable(globalThis["C"]?.["fieldAccess"]);
$assert.notConstructable(globalThis["C"]?.["fieldAccess"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["fieldAccess"]), ['length', 'name'], globalThis["C"]?.["fieldAccess"]);
$verifyProperty(globalThis["C"]?.["fieldAccess"], "name", {
  value: "fieldAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["fieldAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "fieldAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
