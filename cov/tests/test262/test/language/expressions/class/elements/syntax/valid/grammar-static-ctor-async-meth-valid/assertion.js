...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["constructor"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["constructor"]), ['length', 'name'], globalThis["C"]?.["constructor"]);
