...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'getPrivateReference', 'setPrivateReference'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["setPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["setPrivateReference"]), true);
$assert.callable(globalThis["C"]?.["setPrivateReference"]);
$assert.notConstructable(globalThis["C"]?.["setPrivateReference"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["setPrivateReference"]), ['length', 'name'], globalThis["C"]?.["setPrivateReference"]);
$verifyProperty(globalThis["C"]?.["setPrivateReference"], "name", {
  value: "setPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["setPrivateReference"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "setPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["getPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["getPrivateReference"]), true);
$assert.callable(globalThis["C"]?.["getPrivateReference"]);
$assert.notConstructable(globalThis["C"]?.["getPrivateReference"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["getPrivateReference"]), ['length', 'name'], globalThis["C"]?.["getPrivateReference"]);
$verifyProperty(globalThis["C"]?.["getPrivateReference"], "name", {
  value: "getPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["getPrivateReference"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "getPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
