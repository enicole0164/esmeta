...
$assert.sameValue(globalThis["className"], "C");
...
$assert.compareArray($Reflect_ownKeys(globalThis["expr"]), ['length', 'name', 'prototype', 'f'], globalThis["expr"]);
$verifyProperty(globalThis["expr"], "f", {
  value: "C",
  writable: true,
  enumerable: true,
  configurable: true,
