...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'access'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["access"]), true);
$assert.callable(globalThis["C"]?.["access"]);
$assert.notConstructable(globalThis["C"]?.["access"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["access"]), ['length', 'name'], globalThis["C"]?.["access"]);
$verifyProperty(globalThis["C"]?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["access"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'instanceAccess'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["instanceAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["instanceAccess"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["instanceAccess"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["instanceAccess"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["instanceAccess"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["instanceAccess"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["instanceAccess"], "name", {
  value: "instanceAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["instanceAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "instanceAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
