...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'g'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["g"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["g"]), true);
$assert.callable(globalThis["C"]?.["g"]);
$assert.notConstructable(globalThis["C"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["g"]), ['length', 'name'], globalThis["C"]?.["g"]);
$verifyProperty(globalThis["C"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "g", {
  writable: true,
  enumerable: false,
  configurable: true,
});
