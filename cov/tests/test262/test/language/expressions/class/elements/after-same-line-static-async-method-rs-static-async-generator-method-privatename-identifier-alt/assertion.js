...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["m"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["m"]), ['length', 'name'], globalThis["C"]?.["m"]);
