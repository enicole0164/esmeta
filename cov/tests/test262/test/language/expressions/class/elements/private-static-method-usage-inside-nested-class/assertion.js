...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'B'], globalThis["C"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]), ['length', 'name', 'prototype', 'methodAccess'], globalThis["C"]?.["B"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["B"]?.["methodAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["B"]?.["methodAccess"]), true);
$assert.callable(globalThis["C"]?.["B"]?.["methodAccess"]);
$assert.notConstructable(globalThis["C"]?.["B"]?.["methodAccess"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]?.["methodAccess"]), ['length', 'name'], globalThis["C"]?.["B"]?.["methodAccess"]);
$verifyProperty(globalThis["C"]?.["B"]?.["methodAccess"], "name", {
  value: "methodAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"]?.["methodAccess"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"], "methodAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
