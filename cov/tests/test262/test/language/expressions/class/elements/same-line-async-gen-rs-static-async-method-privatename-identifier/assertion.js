...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["_"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["_"]), true);
$assert.callable(globalThis["C"]?.["_"]);
$assert.notConstructable(globalThis["C"]?.["_"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["_"]), ['length', 'name'], globalThis["C"]?.["_"]);
$verifyProperty(globalThis["C"]?.["_"], "name", {
  value: "_",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["_"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["ZW_‌_NJ"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["ZW_‌_NJ"]), true);
$assert.callable(globalThis["C"]?.["ZW_‌_NJ"]);
$assert.notConstructable(globalThis["C"]?.["ZW_‌_NJ"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["ZW_‌_NJ"]), ['length', 'name'], globalThis["C"]?.["ZW_‌_NJ"]);
$verifyProperty(globalThis["C"]?.["ZW_‌_NJ"], "name", {
  value: "ZW_‌_NJ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["ZW_‌_NJ"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["ZW_‍_J"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["ZW_‍_J"]), true);
$assert.callable(globalThis["C"]?.["ZW_‍_J"]);
$assert.notConstructable(globalThis["C"]?.["ZW_‍_J"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["ZW_‍_J"]), ['length', 'name'], globalThis["C"]?.["ZW_‍_J"]);
$verifyProperty(globalThis["C"]?.["ZW_‍_J"], "name", {
  value: "ZW_‍_J",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["ZW_‍_J"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["o"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["o"]), true);
$assert.callable(globalThis["C"]?.["o"]);
$assert.notConstructable(globalThis["C"]?.["o"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["o"]), ['length', 'name'], globalThis["C"]?.["o"]);
$verifyProperty(globalThis["C"]?.["o"], "name", {
  value: "o",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["o"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["℘"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["℘"]), true);
$assert.callable(globalThis["C"]?.["℘"]);
