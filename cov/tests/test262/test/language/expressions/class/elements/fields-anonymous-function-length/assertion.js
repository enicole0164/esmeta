...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'accessPrivateField'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["accessPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["accessPrivateField"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["accessPrivateField"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["accessPrivateField"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["accessPrivateField"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["accessPrivateField"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["accessPrivateField"], "name", {
  value: "accessPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["accessPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "accessPrivateField", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(c), ['field'], c);
$assert.sameValue($Object_getPrototypeOf(c?.["field"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["field"]), true);
$assert.callable(c?.["field"]);
$assert.constructable(c?.["field"]);
$assert.compareArray($Reflect_ownKeys(c?.["field"]), ['length', 'name', 'prototype'], c?.["field"]);
$assert.sameValue($Object_getPrototypeOf(c?.["field"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(c?.["field"]?.["prototype"]), true);
$assert.notCallable(c?.["field"]?.["prototype"]);
$assert.notConstructable(c?.["field"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(c?.["field"]?.["prototype"]), ['constructor'], c?.["field"]?.["prototype"]);
$assert.sameValue(c?.["field"]?.["prototype"]?.["constructor"], c?.["field"]);
$verifyProperty(c?.["field"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["field"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(c?.["field"], "name", {
  value: "field",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["field"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c, "field", {
  writable: true,
  enumerable: true,
  configurable: true,
});
