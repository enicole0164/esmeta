...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]), ['length', 'name', 'prototype', 'access'], globalThis["C"]?.["B"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["B"]?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["B"]?.["access"]), true);
$assert.callable(globalThis["C"]?.["B"]?.["access"]);
$assert.notConstructable(globalThis["C"]?.["B"]?.["access"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["B"]?.["access"]), ['length', 'name'], globalThis["C"]?.["B"]?.["access"]);
$verifyProperty(globalThis["C"]?.["B"]?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"]?.["access"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["B"], "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(b), ['_v'], b);
$verifyProperty(b, "_v", {
  value: "inner class",
  writable: true,
  enumerable: true,
