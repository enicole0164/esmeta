...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'x', 'y'], globalThis["C"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["y"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["y"]), true);
$assert.callable(globalThis["C"]?.["y"]);
$assert.notConstructable(globalThis["C"]?.["y"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["y"]), ['length', 'name'], globalThis["C"]?.["y"]);
$verifyProperty(globalThis["C"]?.["y"], "name", {
  value: "y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["y"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "y", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["x"]), true);
$assert.callable(globalThis["C"]?.["x"]);
$assert.notConstructable(globalThis["C"]?.["x"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["x"]), ['length', 'name'], globalThis["C"]?.["x"]);
$verifyProperty(globalThis["C"]?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "x", {
  writable: true,
  enumerable: false,
  configurable: true,
});
