...
$assert.sameValue($Object_getPrototypeOf(c), globalThis["C"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(c), true);
$assert.notCallable(c);
$assert.notConstructable(c);
$assert.compareArray($Reflect_ownKeys(c), ['B_withoutPrivateField', 'B_withPrivateField'], c);
$assert.sameValue($Object_getPrototypeOf(c?.["B_withPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["B_withPrivateField"]), true);
$assert.callable(c?.["B_withPrivateField"]);
$assert.constructable(c?.["B_withPrivateField"]);
$assert.compareArray($Reflect_ownKeys(c?.["B_withPrivateField"]), ['length', 'name', 'prototype'], c?.["B_withPrivateField"]);
$assert.sameValue($Object_getPrototypeOf(c?.["B_withPrivateField"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(c?.["B_withPrivateField"]?.["prototype"]), true);
$assert.notCallable(c?.["B_withPrivateField"]?.["prototype"]);
$assert.notConstructable(c?.["B_withPrivateField"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(c?.["B_withPrivateField"]?.["prototype"]), ['constructor', 'method'], c?.["B_withPrivateField"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(c?.["B_withPrivateField"]?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["B_withPrivateField"]?.["prototype"]?.["method"]), true);
$assert.callable(c?.["B_withPrivateField"]?.["prototype"]?.["method"]);
$assert.notConstructable(c?.["B_withPrivateField"]?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(c?.["B_withPrivateField"]?.["prototype"]?.["method"]), ['length', 'name'], c?.["B_withPrivateField"]?.["prototype"]?.["method"]);
$verifyProperty(c?.["B_withPrivateField"]?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withPrivateField"]?.["prototype"]?.["method"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withPrivateField"]?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(c?.["B_withPrivateField"]?.["prototype"]?.["constructor"], c?.["B_withPrivateField"]);
$verifyProperty(c?.["B_withPrivateField"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withPrivateField"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(c?.["B_withPrivateField"], "name", {
  value: "B_withPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c, "B_withPrivateField", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(c?.["B_withoutPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["B_withoutPrivateField"]), true);
$assert.callable(c?.["B_withoutPrivateField"]);
$assert.constructable(c?.["B_withoutPrivateField"]);
$assert.compareArray($Reflect_ownKeys(c?.["B_withoutPrivateField"]), ['length', 'name', 'prototype'], c?.["B_withoutPrivateField"]);
$assert.sameValue($Object_getPrototypeOf(c?.["B_withoutPrivateField"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(c?.["B_withoutPrivateField"]?.["prototype"]), true);
$assert.notCallable(c?.["B_withoutPrivateField"]?.["prototype"]);
$assert.notConstructable(c?.["B_withoutPrivateField"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(c?.["B_withoutPrivateField"]?.["prototype"]), ['constructor', 'method'], c?.["B_withoutPrivateField"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"]), true);
$assert.callable(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"]);
$assert.notConstructable(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"]), ['length', 'name'], c?.["B_withoutPrivateField"]?.["prototype"]?.["method"]);
$verifyProperty(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withoutPrivateField"]?.["prototype"]?.["method"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withoutPrivateField"]?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(c?.["B_withoutPrivateField"]?.["prototype"]?.["constructor"], c?.["B_withoutPrivateField"]);
$verifyProperty(c?.["B_withoutPrivateField"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withoutPrivateField"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(c?.["B_withoutPrivateField"], "name", {
  value: "B_withoutPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B_withoutPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c, "B_withoutPrivateField", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(innerB1), c?.["B_withoutPrivateField"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(innerB1), true);
$assert.notCallable(innerB1);
$assert.notConstructable(innerB1);
$assert.compareArray($Reflect_ownKeys(innerB1), [], innerB1);
$assert.sameValue($Object_getPrototypeOf(innerB2), c?.["B_withPrivateField"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(innerB2), true);
$assert.notCallable(innerB2);
$assert.notConstructable(innerB2);
$assert.compareArray($Reflect_ownKeys(innerB2), [], innerB2);
