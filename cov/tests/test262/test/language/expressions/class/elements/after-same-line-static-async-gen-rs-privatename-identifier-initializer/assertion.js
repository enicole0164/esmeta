...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'm'], globalThis["C"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', '$', '_', 'o', '℘', 'ZW_‌_NJ', 'ZW_‍_J'], globalThis["C"]?.["prototype"]);
