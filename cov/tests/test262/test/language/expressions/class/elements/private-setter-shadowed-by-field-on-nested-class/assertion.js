...
$assert.compareArray($Reflect_ownKeys(c), ['B', '_v'], c);
...
$assert.compareArray($Reflect_ownKeys(c?.["B"]?.["prototype"]), ['constructor', 'method', 'm'], c?.["B"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get, "name", {
  value: "get m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(c?.["B"]?.["prototype"], "m")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["B"]?.["prototype"], "m", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
