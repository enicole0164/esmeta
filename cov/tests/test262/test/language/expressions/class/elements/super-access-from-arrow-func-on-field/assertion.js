...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'staticFunc', 'staticProp'], globalThis["C"]);
$verifyProperty(globalThis["C"], "staticProp", {
  value: "static test262",
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["staticFunc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["staticFunc"]), true);
$assert.callable(globalThis["C"]?.["staticFunc"]);
$assert.notConstructable(globalThis["C"]?.["staticFunc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["staticFunc"]), ['length', 'name'], globalThis["C"]?.["staticFunc"]);
$verifyProperty(globalThis["C"]?.["staticFunc"], "name", {
  value: "staticFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["staticFunc"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "staticFunc", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(c), ['func', 'prop'], c);
$verifyProperty(c, "prop", {
  value: "test262",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(c?.["func"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["func"]), true);
$assert.callable(c?.["func"]);
$assert.notConstructable(c?.["func"]);
$assert.compareArray($Reflect_ownKeys(c?.["func"]), ['length', 'name'], c?.["func"]);
$verifyProperty(c?.["func"], "name", {
  value: "func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["func"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c, "func", {
  writable: true,
  enumerable: true,
  configurable: true,
});
