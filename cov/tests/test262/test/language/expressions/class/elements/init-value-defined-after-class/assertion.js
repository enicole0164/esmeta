...
$assert.sameValue($Object_getPrototypeOf(globalThis["c1"]), globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["c2"]), globalThis["C"]?.["prototype"]);
