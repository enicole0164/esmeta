...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["c"]), globalThis["C"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["c"]), true);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["err"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["err"]), true);
$assert.callable(globalThis["err"]);
$assert.constructable(globalThis["err"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err"]), ['length', 'name', 'prototype'], globalThis["err"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["err"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["err"]?.["prototype"]), true);
$assert.notCallable(globalThis["err"]?.["prototype"]);
$assert.notConstructable(globalThis["err"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err"]?.["prototype"]), ['constructor'], globalThis["err"]?.["prototype"]);
$assert.sameValue(globalThis["err"]?.["prototype"]?.["constructor"], globalThis["err"]);
$verifyProperty(globalThis["err"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["err"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["err"], "name", {
  value: "err",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["err"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]), true);
$assert.notCallable(globalThis["obj1"]);
$assert.notConstructable(globalThis["obj1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]), ['toString', 'valueOf', Symbol.toPrimitive], globalThis["obj1"]);
$assert.sameValue(globalThis["obj1"]?.["toString"], globalThis["err"]);
$verifyProperty(globalThis["obj1"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["obj1"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["obj1"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["obj1"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["obj1"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["obj1"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj1"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj1"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["obj1"]?.["valueOf"], globalThis["err"]);
$verifyProperty(globalThis["obj1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]), true);
$assert.notCallable(globalThis["obj2"]);
$assert.notConstructable(globalThis["obj2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]), ['toString', 'valueOf'], globalThis["obj2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["toString"]), true);
$assert.callable(globalThis["obj2"]?.["toString"]);
$assert.constructable(globalThis["obj2"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["obj2"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj2"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj2"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj2"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["obj2"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj2"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["obj2"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["obj2"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["obj2"]?.["toString"]);
$verifyProperty(globalThis["obj2"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj2"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj2"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["obj2"]?.["valueOf"], globalThis["err"]);
$verifyProperty(globalThis["obj2"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj3"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj3"]), true);
$assert.notCallable(globalThis["obj3"]);
$assert.notConstructable(globalThis["obj3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj3"]), ['toString', 'valueOf'], globalThis["obj3"]);
$verifyProperty(globalThis["obj3"], "toString", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj3"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj3"]?.["valueOf"]), true);
$assert.callable(globalThis["obj3"]?.["valueOf"]);
$assert.constructable(globalThis["obj3"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj3"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["obj3"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj3"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj3"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj3"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["obj3"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj3"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["obj3"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["obj3"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["obj3"]?.["valueOf"]);
$verifyProperty(globalThis["obj3"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj3"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj3"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj3"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj3"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
