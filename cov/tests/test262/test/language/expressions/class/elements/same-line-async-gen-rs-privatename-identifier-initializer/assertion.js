...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', '$', '_', 'o', '℘', 'ZW_‌_NJ', 'ZW_‍_J', 'm'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["ZW_‍_J"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["ZW_‍_J"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["ZW_‍_J"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["ZW_‍_J"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["ZW_‍_J"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["ZW_‍_J"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["ZW_‍_J"], "name", {
  value: "ZW_‍_J",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["ZW_‍_J"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "ZW_‍_J", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["_"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["_"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["_"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["_"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["_"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["_"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["_"], "name", {
  value: "_",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["_"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "_", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"], "name", {
  value: "ZW_‌_NJ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["ZW_‌_NJ"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "ZW_‌_NJ", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["$"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["$"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["$"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["$"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["$"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["$"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["$"], "name", {
  value: "$",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["$"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["o"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["o"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["o"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["o"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["o"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["o"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["o"], "name", {
  value: "o",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["o"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "o", {
  writable: true,
  enumerable: false,
  configurable: true,
});
