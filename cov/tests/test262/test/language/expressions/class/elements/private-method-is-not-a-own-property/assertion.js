...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'checkPrivateMethod'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["checkPrivateMethod"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"], "name", {
  value: "checkPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["checkPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "checkPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
