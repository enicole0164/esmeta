...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'var'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["var"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["var"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["var"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["var"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["var"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["var"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["var"], "name", {
  value: "var",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["var"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "var", {
  writable: true,
  enumerable: false,
  configurable: true,
});
