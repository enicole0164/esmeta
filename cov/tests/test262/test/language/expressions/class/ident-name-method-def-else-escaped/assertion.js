...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'else'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["else"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["else"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["else"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["else"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["else"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["else"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["else"], "name", {
  value: "else",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["else"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "else", {
  writable: true,
  enumerable: false,
  configurable: true,
});
