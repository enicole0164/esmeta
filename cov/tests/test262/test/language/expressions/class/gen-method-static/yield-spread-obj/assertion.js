...
$assert.sameValue($Object_getPrototypeOf(globalThis["item"]?.["value"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["item"]?.["value"]), ['x', 'y'], globalThis["item"]?.["value"]);
$verifyProperty(globalThis["item"]?.["value"], "x", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["item"]?.["value"], "y", {
  value: 39.0,
  writable: true,
  enumerable: true,
  configurable: true,
