...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["gen"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["gen"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["item"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["item"]), ['value', 'done'], globalThis["item"]);
$verifyProperty(globalThis["item"], "done", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["item"]?.["value"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["item"]?.["value"]), true);
$assert.notCallable(globalThis["item"]?.["value"]);
$assert.notConstructable(globalThis["item"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["item"]?.["value"]), ['0', '1', '2', 'length'], globalThis["item"]?.["value"]);
$verifyProperty(globalThis["item"]?.["value"], "1", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["item"]?.["value"], "2", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["item"]?.["value"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["item"]?.["value"], "0", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["item"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["value"], globalThis["item"]?.["value"]);
