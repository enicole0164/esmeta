...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["method"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["method"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["method"]);
