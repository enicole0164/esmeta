...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'method'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["method"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["method"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["method"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["method"]), ['length', 'name', 'prototype'], globalThis["C"]?.["prototype"]?.["method"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["method"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["method"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["prototype"]?.["method"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["method"]?.["prototype"]), [], globalThis["C"]?.["prototype"]?.["method"]?.["prototype"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["method"], globalThis["C"]?.["prototype"]?.["method"]);
