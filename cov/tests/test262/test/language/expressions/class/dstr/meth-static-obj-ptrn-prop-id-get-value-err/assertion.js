...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["method"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["method"]), ['length', 'name'], globalThis["C"]?.["method"]);
