...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'method'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["method"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["method"]), true);
$assert.callable(globalThis["C"]?.["method"]);
$assert.notConstructable(globalThis["C"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["method"]), ['length', 'name', 'prototype'], globalThis["C"]?.["method"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["method"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["method"]?.["prototype"]), true);
$assert.notCallable(globalThis["C"]?.["method"]?.["prototype"]);
$assert.notConstructable(globalThis["C"]?.["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["method"]?.["prototype"]), [], globalThis["C"]?.["method"]?.["prototype"]);
$verifyProperty(globalThis["C"]?.["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["method"], globalThis["C"]?.["method"]);
