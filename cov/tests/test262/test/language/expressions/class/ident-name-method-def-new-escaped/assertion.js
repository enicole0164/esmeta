...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'new'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["new"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["new"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["new"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["new"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["new"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["new"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["new"], "name", {
  value: "new",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["new"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "new", {
  writable: true,
  enumerable: false,
  configurable: true,
});
