...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'try'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["try"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["try"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["try"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["try"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["try"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["try"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["try"], "name", {
  value: "try",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["try"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "try", {
  writable: true,
  enumerable: false,
  configurable: true,
});
