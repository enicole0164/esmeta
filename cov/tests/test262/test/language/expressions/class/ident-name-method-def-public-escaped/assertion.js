...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'public'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["public"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["public"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["public"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["public"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["public"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["public"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["public"], "name", {
  value: "public",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["public"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "public", {
  writable: true,
  enumerable: false,
  configurable: true,
});
