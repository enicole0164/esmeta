...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c1)), ['constructor', 'access'], $Object_getPrototypeOf(c1));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c1)?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c1)?.["access"]), true);
$assert.callable($Object_getPrototypeOf(c1)?.["access"]);
$assert.notConstructable($Object_getPrototypeOf(c1)?.["access"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c1)?.["access"]), ['length', 'name'], $Object_getPrototypeOf(c1)?.["access"]);
$verifyProperty($Object_getPrototypeOf(c1)?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c1)?.["access"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c1), "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(c1), ['_v'], c1);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c2)), ['constructor', 'access'], $Object_getPrototypeOf(c2));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c2)?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c2)?.["access"]), true);
$assert.callable($Object_getPrototypeOf(c2)?.["access"]);
$assert.notConstructable($Object_getPrototypeOf(c2)?.["access"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c2)?.["access"]), ['length', 'name'], $Object_getPrototypeOf(c2)?.["access"]);
$verifyProperty($Object_getPrototypeOf(c2)?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c2)?.["access"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c2), "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(c2), ['_v'], c2);
