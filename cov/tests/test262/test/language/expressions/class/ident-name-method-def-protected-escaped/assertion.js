...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'protected'], globalThis["C"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["protected"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["protected"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["protected"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["protected"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["protected"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["protected"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["protected"], "name", {
  value: "protected",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["protected"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "protected", {
  writable: true,
  enumerable: false,
  configurable: true,
});
