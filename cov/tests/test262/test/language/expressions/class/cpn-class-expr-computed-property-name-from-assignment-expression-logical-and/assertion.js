...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["0"]), true);
$assert.callable(C?.["prototype"]?.["0"]);
$assert.notConstructable(C?.["prototype"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["0"]), ['length', 'name'], C?.["prototype"]?.["0"]);
$verifyProperty(C?.["prototype"]?.["0"], "name", {
  value: "0",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["0"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["0"]), true);
$assert.callable(C?.["0"]);
$assert.notConstructable(C?.["0"]);
$assert.compareArray($Reflect_ownKeys(C?.["0"]), ['length', 'name'], C?.["0"]);
$verifyProperty(C?.["0"], "name", {
  value: "0",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["0"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
