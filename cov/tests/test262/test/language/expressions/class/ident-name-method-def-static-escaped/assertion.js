...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'static'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["static"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["static"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["static"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["static"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["static"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["static"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["static"], "name", {
  value: "static",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["static"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "static", {
  writable: true,
  enumerable: false,
  configurable: true,
});
