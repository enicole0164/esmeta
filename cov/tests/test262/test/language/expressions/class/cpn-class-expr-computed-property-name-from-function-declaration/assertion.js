...
$assert.sameValue($Object_getPrototypeOf(C?.["undefined"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["undefined"]), true);
$assert.callable(C?.["undefined"]);
$assert.notConstructable(C?.["undefined"]);
$assert.compareArray($Reflect_ownKeys(C?.["undefined"]), ['length', 'name'], C?.["undefined"]);
$verifyProperty(C?.["undefined"], "name", {
  value: "undefined",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["undefined"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["undefined"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["undefined"]), true);
$assert.callable(C?.["prototype"]?.["undefined"]);
$assert.notConstructable(C?.["prototype"]?.["undefined"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["undefined"]), ['length', 'name'], C?.["prototype"]?.["undefined"]);
$verifyProperty(C?.["prototype"]?.["undefined"], "name", {
  value: "undefined",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["undefined"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
