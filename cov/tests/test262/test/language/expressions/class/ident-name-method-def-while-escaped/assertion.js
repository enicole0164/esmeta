...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'while'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["while"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["while"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["while"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["while"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["while"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["while"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["while"], "name", {
  value: "while",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["while"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "while", {
  writable: true,
  enumerable: false,
  configurable: true,
});
