...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'instanceof'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["instanceof"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["instanceof"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["instanceof"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["instanceof"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["instanceof"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["instanceof"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["instanceof"], "name", {
  value: "instanceof",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["instanceof"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "instanceof", {
  writable: true,
  enumerable: false,
  configurable: true,
});
