...
$assert.sameValue($Object_getPrototypeOf(globalThis["BaseClass"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BaseClass"]), true);
$assert.callable(globalThis["BaseClass"]);
$assert.constructable(globalThis["BaseClass"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BaseClass"]), ['length', 'name', 'prototype'], globalThis["BaseClass"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["BaseClass"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["BaseClass"]?.["prototype"]), true);
$assert.notCallable(globalThis["BaseClass"]?.["prototype"]);
$assert.notConstructable(globalThis["BaseClass"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["BaseClass"]?.["prototype"]), ['constructor'], globalThis["BaseClass"]?.["prototype"]);
$assert.sameValue(globalThis["BaseClass"]?.["prototype"]?.["constructor"], globalThis["BaseClass"]);
$verifyProperty(globalThis["BaseClass"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BaseClass"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["BaseClass"], "name", {
  value: "BaseClass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["BaseClass"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["SubClass"]), globalThis["BaseClass"]);
$assert.sameValue(Object.isExtensible(globalThis["SubClass"]), true);
$assert.callable(globalThis["SubClass"]);
$assert.constructable(globalThis["SubClass"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SubClass"]), ['length', 'name', 'prototype'], globalThis["SubClass"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SubClass"]?.["prototype"]), globalThis["BaseClass"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["SubClass"]?.["prototype"]), true);
$assert.notCallable(globalThis["SubClass"]?.["prototype"]);
$assert.notConstructable(globalThis["SubClass"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SubClass"]?.["prototype"]), ['constructor'], globalThis["SubClass"]?.["prototype"]);
$assert.sameValue(globalThis["SubClass"]?.["prototype"]?.["constructor"], globalThis["SubClass"]);
$verifyProperty(globalThis["SubClass"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SubClass"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SubClass"], "name", {
  value: "SubClass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SubClass"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
