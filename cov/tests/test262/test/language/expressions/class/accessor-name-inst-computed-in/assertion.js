...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'false'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set, "name", {
  value: "set false",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"]?.["prototype"], "false")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "false", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.notCallable(globalThis["empty"]);
$assert.notConstructable(globalThis["empty"]);
$assert.compareArray($Reflect_ownKeys(globalThis["empty"]), [], globalThis["empty"]);
$assert.sameValue(globalThis["value"], "via set");
