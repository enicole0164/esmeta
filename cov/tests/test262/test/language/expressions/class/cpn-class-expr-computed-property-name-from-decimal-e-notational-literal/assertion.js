...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["10"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["10"]), true);
$assert.callable(C?.["prototype"]?.["10"]);
$assert.notConstructable(C?.["prototype"]?.["10"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["10"]), ['length', 'name'], C?.["prototype"]?.["10"]);
$verifyProperty(C?.["prototype"]?.["10"], "name", {
  value: "10",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["10"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["10"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["10"]), true);
$assert.callable(C?.["10"]);
$assert.notConstructable(C?.["10"]);
$assert.compareArray($Reflect_ownKeys(C?.["10"]), ['length', 'name'], C?.["10"]);
$verifyProperty(C?.["10"], "name", {
  value: "10",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["10"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
