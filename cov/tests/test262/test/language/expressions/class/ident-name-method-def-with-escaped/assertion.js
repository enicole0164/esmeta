...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'with'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["with"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["with"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["with"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["with"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["with"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["with"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["with"], "name", {
  value: "with",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["with"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "with", {
  writable: true,
  enumerable: false,
  configurable: true,
});
