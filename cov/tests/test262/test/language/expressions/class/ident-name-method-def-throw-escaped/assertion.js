...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'throw'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["throw"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["throw"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["throw"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["throw"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "throw", {
  writable: true,
  enumerable: false,
  configurable: true,
});
