...
$assert.sameValue($Object_getPrototypeOf(Subclass), AggregateError);
...
$assert.sameValue($Object_getPrototypeOf(Subclass?.["prototype"]), AggregateError.prototype);
...
$assert.notCallable(sub);
$assert.notConstructable(sub);
$assert.compareArray($Reflect_ownKeys(sub), ['errors'], sub);
$assert.sameValue($Object_getPrototypeOf(sub?.["errors"]), Array.prototype);
$assert.sameValue(Object.isExtensible(sub?.["errors"]), true);
$assert.notCallable(sub?.["errors"]);
$assert.notConstructable(sub?.["errors"]);
$assert.compareArray($Reflect_ownKeys(sub?.["errors"]), ['length'], sub?.["errors"]);
$verifyProperty(sub?.["errors"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(sub, "errors", {
  writable: true,
  enumerable: false,
  configurable: true,
});
