...
$assert.sameValue($Object_getPrototypeOf(Subclass), Function);
...
$assert.sameValue($Object_getPrototypeOf(Subclass?.["prototype"]), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(sub), Subclass?.["prototype"]);
$assert.sameValue(Object.isExtensible(sub), true);
$assert.callable(sub);
$assert.constructable(sub);
$assert.compareArray($Reflect_ownKeys(sub), ['length', 'name', 'prototype'], sub);
$assert.sameValue($Object_getPrototypeOf(sub?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(sub?.["prototype"]), true);
$assert.notCallable(sub?.["prototype"]);
$assert.notConstructable(sub?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(sub?.["prototype"]), ['constructor'], sub?.["prototype"]);
$assert.sameValue(sub?.["prototype"]?.["constructor"], sub);
$verifyProperty(sub?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(sub, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(sub, "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(sub, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
