...
$assert.sameValue($Object_getPrototypeOf(Subclass), Array);
...
$assert.sameValue($Object_getPrototypeOf(Subclass?.["prototype"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(sub), ['length'], sub);
