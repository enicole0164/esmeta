...
$assert.sameValue($Object_getPrototypeOf(Subclass), ReferenceError);
...
$assert.sameValue($Object_getPrototypeOf(Subclass?.["prototype"]), ReferenceError.prototype);
...
$assert.compareArray($Reflect_ownKeys(sub), [], sub);
