...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'import'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["import"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["import"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["import"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["import"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["import"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["import"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["import"], "name", {
  value: "import",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["import"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "import", {
  writable: true,
  enumerable: false,
  configurable: true,
});
