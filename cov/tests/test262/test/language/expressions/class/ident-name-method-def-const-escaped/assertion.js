...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'const'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["const"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["const"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["const"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["const"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["const"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["const"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["const"], "name", {
  value: "const",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["const"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "const", {
  writable: true,
  enumerable: false,
  configurable: true,
});
