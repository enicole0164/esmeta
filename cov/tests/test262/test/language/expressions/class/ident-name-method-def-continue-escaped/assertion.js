...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'continue'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["continue"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["continue"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["continue"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["continue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["continue"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["continue"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["continue"], "name", {
  value: "continue",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["continue"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "continue", {
  writable: true,
  enumerable: false,
  configurable: true,
});
