...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'if'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["if"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["if"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["if"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["if"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["if"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["if"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["if"], "name", {
  value: "if",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["if"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "if", {
  writable: true,
  enumerable: false,
  configurable: true,
});
