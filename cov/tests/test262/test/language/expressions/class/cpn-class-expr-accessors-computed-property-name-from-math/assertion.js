...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', '2.999232'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "2.999232")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "2.999232")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "2.999232")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "2.999232")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "2.999232")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "2.999232")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2.999232")?.get, "name", {
  value: "get 2.999232",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2.999232")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "2.999232")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "2.999232")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "2.999232")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "2.999232")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "2.999232")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "2.999232")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2.999232")?.set, "name", {
  value: "set 2.999232",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2.999232")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "2.999232", {
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', '2.999232'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get, "name", {
  value: "get 2.999232",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set, "name", {
  value: "set 2.999232",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "2.999232")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "2.999232", {
  enumerable: false,
  configurable: true,
});
