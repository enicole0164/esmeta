...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'do'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["do"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["do"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["do"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["do"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["do"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["do"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["do"], "name", {
  value: "do",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["do"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "do", {
  writable: true,
  enumerable: false,
  configurable: true,
});
