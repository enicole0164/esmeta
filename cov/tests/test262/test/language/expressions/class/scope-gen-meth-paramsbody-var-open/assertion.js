...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["m"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["m"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.sameValue(globalThis["x"], "outside");
