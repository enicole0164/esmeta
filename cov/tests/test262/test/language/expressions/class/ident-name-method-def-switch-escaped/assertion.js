...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]), ['constructor', 'switch'], globalThis["C"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C"]?.["prototype"]?.["switch"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C"]?.["prototype"]?.["switch"]), true);
$assert.callable(globalThis["C"]?.["prototype"]?.["switch"]);
$assert.notConstructable(globalThis["C"]?.["prototype"]?.["switch"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C"]?.["prototype"]?.["switch"]), ['length', 'name'], globalThis["C"]?.["prototype"]?.["switch"]);
$verifyProperty(globalThis["C"]?.["prototype"]?.["switch"], "name", {
  value: "switch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"]?.["switch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"]?.["prototype"], "switch", {
  writable: true,
  enumerable: false,
  configurable: true,
});
