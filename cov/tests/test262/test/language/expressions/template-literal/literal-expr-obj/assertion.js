...
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]), ['toString'], globalThis["custom"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["custom"]?.["toString"]), true);
$assert.callable(globalThis["custom"]?.["toString"]);
$assert.constructable(globalThis["custom"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["custom"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["custom"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["custom"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["custom"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["custom"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["custom"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["custom"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["custom"]?.["toString"]);
$verifyProperty(globalThis["custom"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["custom"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["custom"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["custom"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["custom"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["plain"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["plain"]), true);
$assert.notCallable(globalThis["plain"]);
$assert.notConstructable(globalThis["plain"]);
$assert.compareArray($Reflect_ownKeys(globalThis["plain"]), [], globalThis["plain"]);
