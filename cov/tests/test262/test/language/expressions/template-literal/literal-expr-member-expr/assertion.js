...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['number', 'string'], globalThis["object"]);
$verifyProperty(globalThis["object"], "number", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["object"], "string", {
  value: "stringValue",
  writable: true,
  enumerable: true,
  configurable: true,
