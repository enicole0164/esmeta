...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['fn'], globalThis["object"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["fn"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["fn"]), true);
$assert.callable(globalThis["object"]?.["fn"]);
$assert.constructable(globalThis["object"]?.["fn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["fn"]), ['length', 'name', 'prototype'], globalThis["object"]?.["fn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["fn"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["fn"]?.["prototype"]), true);
$assert.notCallable(globalThis["object"]?.["fn"]?.["prototype"]);
$assert.notConstructable(globalThis["object"]?.["fn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["fn"]?.["prototype"]), ['constructor'], globalThis["object"]?.["fn"]?.["prototype"]);
$assert.sameValue(globalThis["object"]?.["fn"]?.["prototype"]?.["constructor"], globalThis["object"]?.["fn"]);
$verifyProperty(globalThis["object"]?.["fn"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["fn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["object"]?.["fn"], "name", {
  value: "fn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["fn"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "fn", {
  writable: true,
  enumerable: true,
  configurable: true,
});
