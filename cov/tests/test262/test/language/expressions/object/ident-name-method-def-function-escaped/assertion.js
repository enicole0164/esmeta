...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['function'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["function"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["function"]), true);
$assert.callable(globalThis["obj"]?.["function"]);
$assert.notConstructable(globalThis["obj"]?.["function"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["function"]), ['length', 'name'], globalThis["obj"]?.["function"]);
$verifyProperty(globalThis["obj"]?.["function"], "name", {
  value: "function",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["function"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "function", {
  writable: true,
  enumerable: true,
  configurable: true,
});
