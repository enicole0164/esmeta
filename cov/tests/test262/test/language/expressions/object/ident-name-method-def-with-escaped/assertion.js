...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['with'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["with"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["with"]), true);
$assert.callable(globalThis["obj"]?.["with"]);
$assert.notConstructable(globalThis["obj"]?.["with"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["with"]), ['length', 'name'], globalThis["obj"]?.["with"]);
$verifyProperty(globalThis["obj"]?.["with"], "name", {
  value: "with",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["with"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "with", {
  writable: true,
  enumerable: true,
  configurable: true,
});
