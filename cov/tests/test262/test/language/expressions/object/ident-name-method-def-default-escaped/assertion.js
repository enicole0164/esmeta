...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["default"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["default"]), true);
$assert.callable(globalThis["obj"]?.["default"]);
$assert.notConstructable(globalThis["obj"]?.["default"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["default"]), ['length', 'name'], globalThis["obj"]?.["default"]);
$verifyProperty(globalThis["obj"]?.["default"], "name", {
  value: "default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["default"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
