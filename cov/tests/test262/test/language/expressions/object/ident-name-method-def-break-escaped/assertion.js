...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['break'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["break"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["break"]), true);
$assert.callable(globalThis["obj"]?.["break"]);
$assert.notConstructable(globalThis["obj"]?.["break"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["break"]), ['length', 'name'], globalThis["obj"]?.["break"]);
$verifyProperty(globalThis["obj"]?.["break"], "name", {
  value: "break",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["break"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "break", {
  writable: true,
  enumerable: true,
  configurable: true,
});
