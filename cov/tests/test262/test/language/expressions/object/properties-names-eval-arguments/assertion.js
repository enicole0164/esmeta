...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['eval', 'arguments'], globalThis["o"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["eval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["eval"]), true);
$assert.callable(globalThis["o"]?.["eval"]);
$assert.notConstructable(globalThis["o"]?.["eval"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["eval"]), ['length', 'name'], globalThis["o"]?.["eval"]);
$verifyProperty(globalThis["o"]?.["eval"], "name", {
  value: "eval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["eval"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "eval", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["arguments"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["arguments"]), true);
$assert.callable(globalThis["o"]?.["arguments"]);
$assert.notConstructable(globalThis["o"]?.["arguments"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["arguments"]), ['length', 'name'], globalThis["o"]?.["arguments"]);
$verifyProperty(globalThis["o"]?.["arguments"], "name", {
  value: "arguments",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["arguments"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "arguments", {
  writable: true,
  enumerable: true,
  configurable: true,
});
