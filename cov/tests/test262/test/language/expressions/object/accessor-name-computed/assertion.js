...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['string'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get, "name", {
  value: "get string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set, "name", {
  value: "set string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "string")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "string", {
  enumerable: true,
  configurable: true,
});
