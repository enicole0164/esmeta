...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['hexEscape'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get, "name", {
  value: "get hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set, "name", {
  value: "set hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "hexEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "hexEscape", {
  enumerable: true,
  configurable: true,
});
