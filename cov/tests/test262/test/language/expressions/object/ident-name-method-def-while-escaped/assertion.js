...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['while'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["while"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["while"]), true);
$assert.callable(globalThis["obj"]?.["while"]);
$assert.notConstructable(globalThis["obj"]?.["while"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["while"]), ['length', 'name'], globalThis["obj"]?.["while"]);
$verifyProperty(globalThis["obj"]?.["while"], "name", {
  value: "while",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["while"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "while", {
  writable: true,
  enumerable: true,
  configurable: true,
});
