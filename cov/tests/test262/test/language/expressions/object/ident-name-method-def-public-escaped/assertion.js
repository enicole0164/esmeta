...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['public'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["public"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["public"]), true);
$assert.callable(globalThis["obj"]?.["public"]);
$assert.notConstructable(globalThis["obj"]?.["public"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["public"]), ['length', 'name'], globalThis["obj"]?.["public"]);
$verifyProperty(globalThis["obj"]?.["public"], "name", {
  value: "public",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["public"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "public", {
  writable: true,
  enumerable: true,
  configurable: true,
});
