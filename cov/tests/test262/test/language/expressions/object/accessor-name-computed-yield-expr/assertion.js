...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['first', 'second'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get, "name", {
  value: "get first",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "first")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "first", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set, "name", {
  value: "set second",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "second")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "second", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
