...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['const'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["const"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["const"]), true);
$assert.callable(globalThis["obj"]?.["const"]);
$assert.notConstructable(globalThis["obj"]?.["const"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["const"]), ['length', 'name'], globalThis["obj"]?.["const"]);
$verifyProperty(globalThis["obj"]?.["const"], "name", {
  value: "const",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["const"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "const", {
  writable: true,
  enumerable: true,
  configurable: true,
});
