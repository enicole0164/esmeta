...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["method"]), AsyncGeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["method"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["method"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["method"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["method"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["method"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["method"]?.["prototype"]), [], globalThis["obj"]?.["method"]?.["prototype"]);
$verifyProperty(globalThis["obj"]?.["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
