...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['var'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["var"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["var"]), true);
$assert.callable(globalThis["obj"]?.["var"]);
$assert.notConstructable(globalThis["obj"]?.["var"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["var"]), ['length', 'name'], globalThis["obj"]?.["var"]);
$verifyProperty(globalThis["obj"]?.["var"], "name", {
  value: "var",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["var"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "var", {
  writable: true,
  enumerable: true,
  configurable: true,
});
