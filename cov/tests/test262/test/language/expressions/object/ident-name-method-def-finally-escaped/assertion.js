...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['finally'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["finally"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["finally"]), true);
$assert.callable(globalThis["obj"]?.["finally"]);
$assert.notConstructable(globalThis["obj"]?.["finally"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["finally"]), ['length', 'name'], globalThis["obj"]?.["finally"]);
$verifyProperty(globalThis["obj"]?.["finally"], "name", {
  value: "finally",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["finally"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "finally", {
  writable: true,
  enumerable: true,
  configurable: true,
});
