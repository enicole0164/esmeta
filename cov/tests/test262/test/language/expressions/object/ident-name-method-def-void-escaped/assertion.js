...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['void'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["void"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["void"]), true);
$assert.callable(globalThis["obj"]?.["void"]);
$assert.notConstructable(globalThis["obj"]?.["void"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["void"]), ['length', 'name'], globalThis["obj"]?.["void"]);
$verifyProperty(globalThis["obj"]?.["void"], "name", {
  value: "void",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["void"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "void", {
  writable: true,
  enumerable: true,
  configurable: true,
});
