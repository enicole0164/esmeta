...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['singleQuote'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get, "name", {
  value: "get singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set, "name", {
  value: "set singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "singleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "singleQuote", {
  enumerable: true,
  configurable: true,
});
