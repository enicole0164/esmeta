...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['extends'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["extends"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["extends"]), true);
$assert.callable(globalThis["obj"]?.["extends"]);
$assert.notConstructable(globalThis["obj"]?.["extends"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["extends"]), ['length', 'name'], globalThis["obj"]?.["extends"]);
$verifyProperty(globalThis["obj"]?.["extends"], "name", {
  value: "extends",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["extends"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "extends", {
  writable: true,
  enumerable: true,
  configurable: true,
});
