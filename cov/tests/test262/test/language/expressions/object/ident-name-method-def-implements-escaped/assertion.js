...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['implements'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["implements"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["implements"]), true);
$assert.callable(globalThis["obj"]?.["implements"]);
$assert.notConstructable(globalThis["obj"]?.["implements"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["implements"]), ['length', 'name'], globalThis["obj"]?.["implements"]);
$verifyProperty(globalThis["obj"]?.["implements"], "name", {
  value: "implements",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["implements"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "implements", {
  writable: true,
  enumerable: true,
  configurable: true,
});
