...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['switch'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["switch"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["switch"]), true);
$assert.callable(globalThis["obj"]?.["switch"]);
$assert.notConstructable(globalThis["obj"]?.["switch"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["switch"]), ['length', 'name'], globalThis["obj"]?.["switch"]);
$verifyProperty(globalThis["obj"]?.["switch"], "name", {
  value: "switch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["switch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "switch", {
  writable: true,
  enumerable: true,
  configurable: true,
});
