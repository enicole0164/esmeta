...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['lineContinuation'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get, "name", {
  value: "get lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set, "name", {
  value: "set lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "lineContinuation")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "lineContinuation", {
  enumerable: true,
  configurable: true,
});
