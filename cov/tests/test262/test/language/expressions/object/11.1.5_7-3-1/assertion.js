...
$assert.notConstructable(globalThis["desc"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["desc"]?.["set"]), ['length', 'name'], globalThis["desc"]?.["set"]);
...
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["o"], "foo")?.set, globalThis["desc"]?.["set"]);
