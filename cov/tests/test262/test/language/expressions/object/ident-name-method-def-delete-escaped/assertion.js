...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['delete'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["delete"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["delete"]), true);
$assert.callable(globalThis["obj"]?.["delete"]);
$assert.notConstructable(globalThis["obj"]?.["delete"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["delete"]), ['length', 'name'], globalThis["obj"]?.["delete"]);
$verifyProperty(globalThis["obj"]?.["delete"], "name", {
  value: "delete",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["delete"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "delete", {
  writable: true,
  enumerable: true,
  configurable: true,
});
