...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['continue'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["continue"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["continue"]), true);
$assert.callable(globalThis["obj"]?.["continue"]);
$assert.notConstructable(globalThis["obj"]?.["continue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["continue"]), ['length', 'name'], globalThis["obj"]?.["continue"]);
$verifyProperty(globalThis["obj"]?.["continue"], "name", {
  value: "continue",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["continue"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "continue", {
  writable: true,
  enumerable: true,
  configurable: true,
});
