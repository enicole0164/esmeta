...
$assert.sameValue($Object_getPrototypeOf(globalThis["method"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["method"]), ['length', 'name'], globalThis["method"]);
