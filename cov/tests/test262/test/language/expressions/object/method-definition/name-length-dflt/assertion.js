...
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]), ['name'], globalThis["f1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f2"]), ['name'], globalThis["f2"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f3"]), ['name'], globalThis["f3"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["f4"]), ['name'], globalThis["f4"]);
