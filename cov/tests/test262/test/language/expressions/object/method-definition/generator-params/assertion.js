...
$assert.sameValue($Object_getPrototypeOf(globalThis["arg1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arg1"]), true);
$assert.notCallable(globalThis["arg1"]);
$assert.notConstructable(globalThis["arg1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arg1"]), [], globalThis["arg1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arg2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arg2"]), true);
$assert.notCallable(globalThis["arg2"]);
$assert.notConstructable(globalThis["arg2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arg2"]), [], globalThis["arg2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arg3"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arg3"]), true);
$assert.notCallable(globalThis["arg3"]);
$assert.notConstructable(globalThis["arg3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arg3"]), [], globalThis["arg3"]);
...
$assert.sameValue(globalThis["value1"], globalThis["arg1"]);
$assert.sameValue(globalThis["value2"], globalThis["arg2"]);
$assert.sameValue(globalThis["value3"], globalThis["arg3"]);
