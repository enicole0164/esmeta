...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["g"])), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["g"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["g"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["g"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["g"])), [], $Object_getPrototypeOf(globalThis["g"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["g"]), [], globalThis["g"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["foo"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["foo"]), true);
$assert.callable(globalThis["obj"]?.["foo"]);
$assert.notConstructable(globalThis["obj"]?.["foo"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["foo"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["foo"]);
$assert.sameValue(globalThis["obj"]?.["foo"]?.["prototype"], $Object_getPrototypeOf(globalThis["g"]));
$verifyProperty(globalThis["obj"]?.["foo"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["foo"], "name", {
  value: "foo",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["foo"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
