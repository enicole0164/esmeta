...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["foo"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["foo"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["foo"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["foo"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["foo"]?.["prototype"]), [], globalThis["obj"]?.["foo"]?.["prototype"]);
