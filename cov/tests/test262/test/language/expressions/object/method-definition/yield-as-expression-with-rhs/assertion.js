...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["iter"])), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['g1', 'g2', 'g3', 'g4', 'g5'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g5"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g5"]), true);
$assert.callable(globalThis["obj"]?.["g5"]);
$assert.notConstructable(globalThis["obj"]?.["g5"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g5"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["g5"]);
$assert.sameValue(globalThis["obj"]?.["g5"]?.["prototype"], $Object_getPrototypeOf(globalThis["iter"]));
$verifyProperty(globalThis["obj"]?.["g5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["g5"], "name", {
  value: "g5",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["g5"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "g5", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g1"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g1"]), true);
$assert.callable(globalThis["obj"]?.["g1"]);
$assert.notConstructable(globalThis["obj"]?.["g1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g1"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["g1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g1"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g1"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["g1"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["g1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g1"]?.["prototype"]), [], globalThis["obj"]?.["g1"]?.["prototype"]);
$verifyProperty(globalThis["obj"]?.["g1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["g1"], "name", {
  value: "g1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["g1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "g1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g4"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g4"]), true);
$assert.callable(globalThis["obj"]?.["g4"]);
$assert.notConstructable(globalThis["obj"]?.["g4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g4"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["g4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g4"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g4"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["g4"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["g4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g4"]?.["prototype"]), [], globalThis["obj"]?.["g4"]?.["prototype"]);
$verifyProperty(globalThis["obj"]?.["g4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["g4"], "name", {
  value: "g4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["g4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "g4", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g2"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g2"]), true);
$assert.callable(globalThis["obj"]?.["g2"]);
$assert.notConstructable(globalThis["obj"]?.["g2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g2"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["g2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g2"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g2"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["g2"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["g2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g2"]?.["prototype"]), [], globalThis["obj"]?.["g2"]?.["prototype"]);
$verifyProperty(globalThis["obj"]?.["g2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["g2"], "name", {
  value: "g2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["g2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "g2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g3"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g3"]), true);
$assert.callable(globalThis["obj"]?.["g3"]);
$assert.notConstructable(globalThis["obj"]?.["g3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g3"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["g3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g3"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g3"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["g3"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["g3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g3"]?.["prototype"]), [], globalThis["obj"]?.["g3"]?.["prototype"]);
$verifyProperty(globalThis["obj"]?.["g3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["g3"], "name", {
  value: "g3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["g3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "g3", {
  writable: true,
  enumerable: true,
  configurable: true,
});
