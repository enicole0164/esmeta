...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['yield'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["yield"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["yield"]), true);
$assert.callable(globalThis["obj"]?.["yield"]);
$assert.notConstructable(globalThis["obj"]?.["yield"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["yield"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["yield"]);
$assert.sameValue(globalThis["obj"]?.["yield"]?.["prototype"], $Object_getPrototypeOf(globalThis["iter"]));
$verifyProperty(globalThis["obj"]?.["yield"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["yield"], "name", {
  value: "yield",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["yield"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "yield", {
  writable: true,
  enumerable: true,
  configurable: true,
});
