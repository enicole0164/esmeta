...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["child"])), ['method'], $Object_getPrototypeOf(globalThis["child"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])?.["method"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["child"]), ['method'], globalThis["child"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"]?.["method"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["child"]?.["method"]), true);
$assert.callable(globalThis["child"]?.["method"]);
$assert.notConstructable(globalThis["child"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["child"]?.["method"]), ['length', 'name'], globalThis["child"]?.["method"]);
$verifyProperty(globalThis["child"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["child"], "method", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["sup"], $Object_getPrototypeOf(globalThis["child"]));
