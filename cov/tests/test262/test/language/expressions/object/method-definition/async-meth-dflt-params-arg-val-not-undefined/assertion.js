...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['method'], globalThis["__obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]?.["method"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]?.["method"]), true);
$assert.callable(globalThis["__obj"]?.["method"]);
$assert.notConstructable(globalThis["__obj"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]?.["method"]), ['length', 'name'], globalThis["__obj"]?.["method"]);
$verifyProperty(globalThis["__obj"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__obj"], "method", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["ref"], globalThis["__obj"]?.["method"]);
