...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['g'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g"]), true);
$assert.callable(globalThis["obj"]?.["g"]);
$assert.notConstructable(globalThis["obj"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["g"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["g"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["g"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["g"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["g"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["g"]?.["prototype"]), [], globalThis["obj"]?.["g"]?.["prototype"]);
$verifyProperty(globalThis["obj"]?.["g"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "g", {
  writable: true,
  enumerable: true,
  configurable: true,
});
