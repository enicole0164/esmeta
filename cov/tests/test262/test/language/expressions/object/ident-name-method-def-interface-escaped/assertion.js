...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['interface'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["interface"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["interface"]), true);
$assert.callable(globalThis["obj"]?.["interface"]);
$assert.notConstructable(globalThis["obj"]?.["interface"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["interface"]), ['length', 'name'], globalThis["obj"]?.["interface"]);
$verifyProperty(globalThis["obj"]?.["interface"], "name", {
  value: "interface",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["interface"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "interface", {
  writable: true,
  enumerable: true,
  configurable: true,
});
