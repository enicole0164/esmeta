...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['in'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["in"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["in"]), true);
$assert.callable(globalThis["obj"]?.["in"]);
$assert.notConstructable(globalThis["obj"]?.["in"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["in"]), ['length', 'name'], globalThis["obj"]?.["in"]);
$verifyProperty(globalThis["obj"]?.["in"], "name", {
  value: "in",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["in"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "in", {
  writable: true,
  enumerable: true,
  configurable: true,
});
