...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['false'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set, "name", {
  value: "set false",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "false")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "false", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
