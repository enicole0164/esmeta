...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['try'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["try"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["try"]), true);
$assert.callable(globalThis["obj"]?.["try"]);
$assert.notConstructable(globalThis["obj"]?.["try"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["try"]), ['length', 'name'], globalThis["obj"]?.["try"]);
$verifyProperty(globalThis["obj"]?.["try"], "name", {
  value: "try",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["try"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "try", {
  writable: true,
  enumerable: true,
  configurable: true,
});
