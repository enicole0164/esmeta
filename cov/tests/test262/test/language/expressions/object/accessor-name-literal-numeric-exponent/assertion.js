...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['1000000000'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get, "name", {
  value: "get 1000000000",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set, "name", {
  value: "set 1000000000",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "1000000000")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "1000000000", {
  enumerable: true,
  configurable: true,
});
