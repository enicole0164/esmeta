...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['new'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["new"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["new"]), true);
$assert.callable(globalThis["obj"]?.["new"]);
$assert.notConstructable(globalThis["obj"]?.["new"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["new"]), ['length', 'name'], globalThis["obj"]?.["new"]);
$verifyProperty(globalThis["obj"]?.["new"], "name", {
  value: "new",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["new"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "new", {
  writable: true,
  enumerable: true,
  configurable: true,
});
