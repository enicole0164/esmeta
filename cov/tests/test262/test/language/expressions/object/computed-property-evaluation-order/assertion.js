...
$assert.sameValue(globalThis["counter"], 6.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['1', '3', '5'], globalThis["o"]);
...
$verifyProperty(globalThis["o"], "5", {
  value: 6.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["o"], "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
