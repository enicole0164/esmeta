...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['export'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["export"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["export"]), true);
$assert.callable(globalThis["obj"]?.["export"]);
$assert.notConstructable(globalThis["obj"]?.["export"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["export"]), ['length', 'name'], globalThis["obj"]?.["export"]);
$verifyProperty(globalThis["obj"]?.["export"], "name", {
  value: "export",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["export"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "export", {
  writable: true,
  enumerable: true,
  configurable: true,
});
