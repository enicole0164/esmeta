...
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["xId"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["xId"]), true);
$assert.callable(globalThis["o"]?.["xId"]);
$assert.notConstructable(globalThis["o"]?.["xId"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["xId"]), ['length', 'name', 'prototype'], globalThis["o"]?.["xId"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["xId"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["xId"]?.["prototype"]), [], globalThis["o"]?.["xId"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["id"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["id"]), true);
$assert.callable(globalThis["o"]?.["id"]);
$assert.notConstructable(globalThis["o"]?.["id"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["id"]), ['length', 'prototype'], globalThis["o"]?.["id"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["id"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["id"]?.["prototype"]), [], globalThis["o"]?.["id"]?.["prototype"]);
