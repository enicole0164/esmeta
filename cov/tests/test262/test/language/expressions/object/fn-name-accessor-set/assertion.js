...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set), ['length'], Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
