...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["object"])), ['_x', 'x'], $Object_getPrototypeOf(globalThis["object"]));
$verifyProperty($Object_getPrototypeOf(globalThis["object"]), "_x", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set, "name", {
  value: "set x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["object"]), "x")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["object"]), "x", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['x', '_x'], globalThis["object"]);
$verifyProperty(globalThis["object"], "_x", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set, "name", {
  value: "set x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["object"], "x")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "x", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
