...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['class'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["class"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["class"]), true);
$assert.callable(globalThis["obj"]?.["class"]);
$assert.notConstructable(globalThis["obj"]?.["class"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["class"]), ['length', 'name'], globalThis["obj"]?.["class"]);
$verifyProperty(globalThis["obj"]?.["class"], "name", {
  value: "class",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["class"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "class", {
  writable: true,
  enumerable: true,
  configurable: true,
});
