...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['protected'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["protected"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["protected"]), true);
$assert.callable(globalThis["obj"]?.["protected"]);
$assert.notConstructable(globalThis["obj"]?.["protected"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["protected"]), ['length', 'name'], globalThis["obj"]?.["protected"]);
$verifyProperty(globalThis["obj"]?.["protected"], "name", {
  value: "protected",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["protected"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "protected", {
  writable: true,
  enumerable: true,
  configurable: true,
});
