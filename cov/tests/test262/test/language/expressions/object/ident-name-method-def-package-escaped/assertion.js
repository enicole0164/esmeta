...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['package'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["package"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["package"]), true);
$assert.callable(globalThis["obj"]?.["package"]);
$assert.notConstructable(globalThis["obj"]?.["package"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["package"]), ['length', 'name'], globalThis["obj"]?.["package"]);
$verifyProperty(globalThis["obj"]?.["package"], "name", {
  value: "package",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["package"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "package", {
  writable: true,
  enumerable: true,
  configurable: true,
});
