...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['super'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["super"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["super"]), true);
$assert.callable(globalThis["obj"]?.["super"]);
$assert.notConstructable(globalThis["obj"]?.["super"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["super"]), ['length', 'name'], globalThis["obj"]?.["super"]);
$verifyProperty(globalThis["obj"]?.["super"], "name", {
  value: "super",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["super"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "super", {
  writable: true,
  enumerable: true,
  configurable: true,
});
