...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['for'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["for"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["for"]), true);
$assert.callable(globalThis["obj"]?.["for"]);
$assert.notConstructable(globalThis["obj"]?.["for"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["for"]), ['length', 'name'], globalThis["obj"]?.["for"]);
$verifyProperty(globalThis["obj"]?.["for"], "name", {
  value: "for",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["for"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "for", {
  writable: true,
  enumerable: true,
  configurable: true,
});
