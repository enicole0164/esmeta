...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['method'], globalThis["object"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["method"]), true);
$assert.callable(globalThis["object"]?.["method"]);
$assert.notConstructable(globalThis["object"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["method"]), ['length', 'name'], globalThis["object"]?.["method"]);
$verifyProperty(globalThis["object"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["method"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "method", {
  writable: true,
  enumerable: true,
  configurable: true,
});
