...
$assert.compareArray($Reflect_ownKeys(o), ['1'], o);
$assert.sameValue($Object_getPrototypeOf(o?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(o?.["1"]), true);
$assert.callable(o?.["1"]);
$assert.notConstructable(o?.["1"]);
$assert.compareArray($Reflect_ownKeys(o?.["1"]), ['length', 'name'], o?.["1"]);
$verifyProperty(o?.["1"], "name", {
  value: "1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(o?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
