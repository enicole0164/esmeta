...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['unicodeEscape'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get, "name", {
  value: "get unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set, "name", {
  value: "set unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "unicodeEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "unicodeEscape", {
  enumerable: true,
  configurable: true,
});
