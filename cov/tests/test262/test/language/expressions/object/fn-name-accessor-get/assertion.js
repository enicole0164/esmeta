...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get), ['length'], Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["o"], "id")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
