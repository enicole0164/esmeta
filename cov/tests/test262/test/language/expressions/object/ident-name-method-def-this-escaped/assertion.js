...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['this'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["this"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["this"]), true);
$assert.callable(globalThis["obj"]?.["this"]);
$assert.notConstructable(globalThis["obj"]?.["this"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["this"]), ['length', 'name'], globalThis["obj"]?.["this"]);
$verifyProperty(globalThis["obj"]?.["this"], "name", {
  value: "this",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["this"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "this", {
  writable: true,
  enumerable: true,
  configurable: true,
});
