...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['debugger'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["debugger"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["debugger"]), true);
$assert.callable(globalThis["obj"]?.["debugger"]);
$assert.notConstructable(globalThis["obj"]?.["debugger"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["debugger"]), ['length', 'name'], globalThis["obj"]?.["debugger"]);
$verifyProperty(globalThis["obj"]?.["debugger"], "name", {
  value: "debugger",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["debugger"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "debugger", {
  writable: true,
  enumerable: true,
  configurable: true,
});
