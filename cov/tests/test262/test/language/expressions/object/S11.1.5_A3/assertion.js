...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['0', '1', 'o'], globalThis["object"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["o"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["o"]), true);
$assert.notCallable(globalThis["object"]?.["o"]);
$assert.notConstructable(globalThis["object"]?.["o"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["o"]), [], globalThis["object"]?.["o"]);
$verifyProperty(globalThis["object"], "o", {
  writable: true,
  enumerable: true,
  configurable: true,
});
