...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['doubleQuote'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get, "name", {
  value: "get doubleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set, "name", {
  value: "set doubleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "doubleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "doubleQuote", {
  enumerable: true,
  configurable: true,
});
