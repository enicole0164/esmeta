...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['throw'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["throw"]), true);
$assert.callable(globalThis["obj"]?.["throw"]);
$assert.notConstructable(globalThis["obj"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["throw"]), ['length', 'name'], globalThis["obj"]?.["throw"]);
$verifyProperty(globalThis["obj"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "throw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
