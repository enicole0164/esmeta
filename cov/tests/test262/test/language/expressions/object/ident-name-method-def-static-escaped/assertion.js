...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['static'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["static"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["static"]), true);
$assert.callable(globalThis["obj"]?.["static"]);
$assert.notConstructable(globalThis["obj"]?.["static"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["static"]), ['length', 'name'], globalThis["obj"]?.["static"]);
$verifyProperty(globalThis["obj"]?.["static"], "name", {
  value: "static",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["static"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "static", {
  writable: true,
  enumerable: true,
  configurable: true,
});
