...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['8'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get, "name", {
  value: "get 8",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set, "name", {
  value: "set 8",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "8")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "8", {
  enumerable: true,
  configurable: true,
});
