...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['default'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get, "name", {
  value: "get default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set, "name", {
  value: "set default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "default")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "default", {
  enumerable: true,
  configurable: true,
});
