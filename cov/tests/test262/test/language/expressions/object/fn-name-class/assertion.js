...
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["xId"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["xId"]), true);
$assert.callable(globalThis["o"]?.["xId"]);
$assert.constructable(globalThis["o"]?.["xId"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["xId"]), ['length', 'name', 'prototype'], globalThis["o"]?.["xId"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["xId"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["xId"]?.["prototype"]), true);
$assert.notCallable(globalThis["o"]?.["xId"]?.["prototype"]);
$assert.notConstructable(globalThis["o"]?.["xId"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["xId"]?.["prototype"]), ['constructor'], globalThis["o"]?.["xId"]?.["prototype"]);
$assert.sameValue(globalThis["o"]?.["xId"]?.["prototype"]?.["constructor"], globalThis["o"]?.["xId"]);
$verifyProperty(globalThis["o"]?.["xId"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["xId"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o"]?.["xId"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["xId"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "xId", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["id"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["id"]), true);
$assert.callable(globalThis["o"]?.["id"]);
$assert.constructable(globalThis["o"]?.["id"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["id"]), ['length', 'prototype'], globalThis["o"]?.["id"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["id"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["id"]?.["prototype"]), true);
$assert.notCallable(globalThis["o"]?.["id"]?.["prototype"]);
$assert.notConstructable(globalThis["o"]?.["id"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["id"]?.["prototype"]), ['constructor'], globalThis["o"]?.["id"]?.["prototype"]);
$assert.sameValue(globalThis["o"]?.["id"]?.["prototype"]?.["constructor"], globalThis["o"]?.["id"]);
$verifyProperty(globalThis["o"]?.["id"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["id"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o"]?.["id"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"], "id", {
  writable: true,
  enumerable: true,
  configurable: true,
});
