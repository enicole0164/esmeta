...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['let'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["let"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["let"]), true);
$assert.callable(globalThis["obj"]?.["let"]);
$assert.notConstructable(globalThis["obj"]?.["let"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["let"]), ['length', 'name'], globalThis["obj"]?.["let"]);
$verifyProperty(globalThis["obj"]?.["let"], "name", {
  value: "let",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["let"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "let", {
  writable: true,
  enumerable: true,
  configurable: true,
});
