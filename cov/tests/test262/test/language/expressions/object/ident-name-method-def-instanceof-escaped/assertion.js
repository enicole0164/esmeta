...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['instanceof'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["instanceof"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["instanceof"]), true);
$assert.callable(globalThis["obj"]?.["instanceof"]);
$assert.notConstructable(globalThis["obj"]?.["instanceof"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["instanceof"]), ['length', 'name'], globalThis["obj"]?.["instanceof"]);
$verifyProperty(globalThis["obj"]?.["instanceof"], "name", {
  value: "instanceof",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["instanceof"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "instanceof", {
  writable: true,
  enumerable: true,
  configurable: true,
});
