...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['typeof'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["typeof"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["typeof"]), true);
$assert.callable(globalThis["obj"]?.["typeof"]);
$assert.notConstructable(globalThis["obj"]?.["typeof"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["typeof"]), ['length', 'name'], globalThis["obj"]?.["typeof"]);
$verifyProperty(globalThis["obj"]?.["typeof"], "name", {
  value: "typeof",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["typeof"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "typeof", {
  writable: true,
  enumerable: true,
  configurable: true,
});
