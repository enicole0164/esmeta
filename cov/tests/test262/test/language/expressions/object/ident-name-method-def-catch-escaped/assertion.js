...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['catch'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["catch"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["catch"]), true);
$assert.callable(globalThis["obj"]?.["catch"]);
$assert.notConstructable(globalThis["obj"]?.["catch"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["catch"]), ['length', 'name'], globalThis["obj"]?.["catch"]);
$verifyProperty(globalThis["obj"]?.["catch"], "name", {
  value: "catch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["catch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "catch", {
  writable: true,
  enumerable: true,
  configurable: true,
});
