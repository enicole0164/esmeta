...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['do'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["do"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["do"]), true);
$assert.callable(globalThis["obj"]?.["do"]);
$assert.notConstructable(globalThis["obj"]?.["do"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["do"]), ['length', 'name'], globalThis["obj"]?.["do"]);
$verifyProperty(globalThis["obj"]?.["do"], "name", {
  value: "do",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["do"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "do", {
  writable: true,
  enumerable: true,
  configurable: true,
});
