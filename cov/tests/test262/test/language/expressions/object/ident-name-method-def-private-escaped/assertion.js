...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['private'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["private"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["private"]), true);
$assert.callable(globalThis["obj"]?.["private"]);
$assert.notConstructable(globalThis["obj"]?.["private"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["private"]), ['length', 'name'], globalThis["obj"]?.["private"]);
$verifyProperty(globalThis["obj"]?.["private"], "name", {
  value: "private",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["private"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "private", {
  writable: true,
  enumerable: true,
  configurable: true,
});
