...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['if'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["if"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["if"]), true);
$assert.callable(globalThis["obj"]?.["if"]);
$assert.notConstructable(globalThis["obj"]?.["if"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["if"]), ['length', 'name'], globalThis["obj"]?.["if"]);
$verifyProperty(globalThis["obj"]?.["if"], "name", {
  value: "if",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["if"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "if", {
  writable: true,
  enumerable: true,
  configurable: true,
});
