...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['case'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["case"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["case"]), true);
$assert.callable(globalThis["obj"]?.["case"]);
$assert.notConstructable(globalThis["obj"]?.["case"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["case"]), ['length', 'name'], globalThis["obj"]?.["case"]);
$verifyProperty(globalThis["obj"]?.["case"], "name", {
  value: "case",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["case"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "case", {
  writable: true,
  enumerable: true,
  configurable: true,
});
