...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["object"])), ['method'], $Object_getPrototypeOf(globalThis["object"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["object"])?.["method"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["object"])?.["method"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["object"])?.["method"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["object"])?.["method"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["object"])?.["method"]);
$verifyProperty($Object_getPrototypeOf(globalThis["object"])?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["object"])?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["object"]), "method", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['g'], globalThis["object"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["g"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["g"]), true);
$assert.callable(globalThis["object"]?.["g"]);
$assert.notConstructable(globalThis["object"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["g"]), ['length', 'name', 'prototype'], globalThis["object"]?.["g"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["g"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["g"]?.["prototype"]), true);
$assert.notCallable(globalThis["object"]?.["g"]?.["prototype"]);
$assert.notConstructable(globalThis["object"]?.["g"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["g"]?.["prototype"]), [], globalThis["object"]?.["g"]?.["prototype"]);
$verifyProperty(globalThis["object"]?.["g"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["object"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "g", {
  writable: true,
  enumerable: true,
  configurable: true,
});
