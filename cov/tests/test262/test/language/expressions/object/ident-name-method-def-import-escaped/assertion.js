...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['import'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["import"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["import"]), true);
$assert.callable(globalThis["obj"]?.["import"]);
$assert.notConstructable(globalThis["obj"]?.["import"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["import"]), ['length', 'name'], globalThis["obj"]?.["import"]);
$verifyProperty(globalThis["obj"]?.["import"], "name", {
  value: "import",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["import"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "import", {
  writable: true,
  enumerable: true,
  configurable: true,
});
