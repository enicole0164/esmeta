...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['enum'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["enum"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["enum"]), true);
$assert.callable(globalThis["obj"]?.["enum"]);
$assert.notConstructable(globalThis["obj"]?.["enum"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["enum"]), ['length', 'name'], globalThis["obj"]?.["enum"]);
$verifyProperty(globalThis["obj"]?.["enum"], "name", {
  value: "enum",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["enum"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "enum", {
  writable: true,
  enumerable: true,
  configurable: true,
});
