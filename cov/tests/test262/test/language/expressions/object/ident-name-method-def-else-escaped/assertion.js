...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['else'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["else"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["else"]), true);
$assert.callable(globalThis["obj"]?.["else"]);
$assert.notConstructable(globalThis["obj"]?.["else"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["else"]), ['length', 'name'], globalThis["obj"]?.["else"]);
$verifyProperty(globalThis["obj"]?.["else"], "name", {
  value: "else",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["else"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "else", {
  writable: true,
  enumerable: true,
  configurable: true,
});
