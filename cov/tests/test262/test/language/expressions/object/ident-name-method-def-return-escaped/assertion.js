...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['return'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["return"]), true);
$assert.callable(globalThis["obj"]?.["return"]);
$assert.notConstructable(globalThis["obj"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["return"]), ['length', 'name'], globalThis["obj"]?.["return"]);
$verifyProperty(globalThis["obj"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "return", {
  writable: true,
  enumerable: true,
  configurable: true,
});
