...
$assert.notConstructable(globalThis["obj"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["toString"]), ['length', 'name'], globalThis["obj"]?.["toString"]);
...
$assert.notConstructable(globalThis["obj"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["valueOf"]), ['length', 'name'], globalThis["obj"]?.["valueOf"]);
...
$assert.sameValue(globalThis["x"], globalThis["obj"]);
