...
$assert.sameValue($Object_getPrototypeOf(globalThis["morePoison"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["morePoison"]), true);
$assert.callable(globalThis["morePoison"]);
$assert.constructable(globalThis["morePoison"]);
$assert.compareArray($Reflect_ownKeys(globalThis["morePoison"]), ['length', 'name', 'prototype'], globalThis["morePoison"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["morePoison"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["morePoison"]?.["prototype"]), true);
$assert.notCallable(globalThis["morePoison"]?.["prototype"]);
$assert.notConstructable(globalThis["morePoison"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["morePoison"]?.["prototype"]), ['constructor'], globalThis["morePoison"]?.["prototype"]);
$assert.sameValue(globalThis["morePoison"]?.["prototype"]?.["constructor"], globalThis["morePoison"]);
$verifyProperty(globalThis["morePoison"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["morePoison"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["morePoison"], "name", {
  value: "morePoison",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["morePoison"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["poison"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poison"]), true);
$assert.callable(globalThis["poison"]);
$assert.constructable(globalThis["poison"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poison"]), ['length', 'name', 'prototype'], globalThis["poison"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["poison"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poison"]?.["prototype"]), true);
$assert.notCallable(globalThis["poison"]?.["prototype"]);
$assert.notConstructable(globalThis["poison"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poison"]?.["prototype"]), ['constructor'], globalThis["poison"]?.["prototype"]);
$assert.sameValue(globalThis["poison"]?.["prototype"]?.["constructor"], globalThis["poison"]);
$verifyProperty(globalThis["poison"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poison"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["poison"], "name", {
  value: "poison",
  writable: false,
  enumerable: false,
  configurable: true,
