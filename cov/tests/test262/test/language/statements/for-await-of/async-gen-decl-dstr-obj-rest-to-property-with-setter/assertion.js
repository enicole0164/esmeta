...
$assert.sameValue($Object_getPrototypeOf(settedValue), Object.prototype);
$assert.sameValue(Object.isExtensible(settedValue), true);
$assert.notCallable(settedValue);
$assert.notConstructable(settedValue);
$assert.compareArray($Reflect_ownKeys(settedValue), ['x', 'y'], settedValue);
$verifyProperty(settedValue, "x", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(settedValue, "y", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(src), Object.prototype);
$assert.sameValue(Object.isExtensible(src), true);
$assert.notCallable(src);
$assert.notConstructable(src);
$assert.compareArray($Reflect_ownKeys(src), ['y'], src);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(src, "y")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(src, "y")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(src, "y")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(src, "y")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(src, "y")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(src, "y")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(src, "y")?.get, "name", {
  value: "get y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(src, "y")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(src, "y")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(src, "y")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(src, "y")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(src, "y")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(src, "y")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(src, "y")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(src, "y")?.set, "name", {
  value: "set y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(src, "y")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
