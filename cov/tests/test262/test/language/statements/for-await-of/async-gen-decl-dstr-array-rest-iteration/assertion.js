...
$assert.sameValue(count, 3.0);
$assert.sameValue($Object_getPrototypeOf(g), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(g), true);
$assert.callable(g);
$assert.notConstructable(g);
$assert.compareArray($Reflect_ownKeys(g), ['length', 'name', 'prototype'], g);
$assert.sameValue($Object_getPrototypeOf(g?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(g?.["prototype"]), true);
$assert.notCallable(g?.["prototype"]);
$assert.notConstructable(g?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(g?.["prototype"]), [], g?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(x), ['0', '1', 'length'], x);
$verifyProperty(x, "1", {
  value: undefined,
  writable: true,
  enumerable: true,
