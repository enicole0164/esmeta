...
$assert.sameValue($Object_getPrototypeOf(value), Array.prototype);
$assert.sameValue(Object.isExtensible(value), true);
$assert.notCallable(value);
$assert.notConstructable(value);
$assert.compareArray($Reflect_ownKeys(value), ['0', 'length'], value);
...
$assert.sameValue($Object_getPrototypeOf(value?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(value?.["0"]), true);
$assert.notCallable(value?.["0"]);
$assert.notConstructable(value?.["0"]);
$assert.compareArray($Reflect_ownKeys(value?.["0"]), ['0', 'length'], value?.["0"]);
$verifyProperty(value?.["0"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(value?.["0"], "0", {
  value: 22.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(value, "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(x), ['prop'], x);
$verifyProperty(x, "prop", {
  value: 22.0,
  writable: true,
  enumerable: true,
  configurable: true,
