...
$assert.sameValue($Object_getPrototypeOf(gen), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(gen), true);
$assert.callable(gen);
$assert.notConstructable(gen);
$assert.compareArray($Reflect_ownKeys(gen), ['length', 'prototype'], gen);
$assert.sameValue($Object_getPrototypeOf(gen?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(gen?.["prototype"]), true);
$assert.notCallable(gen?.["prototype"]);
$assert.notConstructable(gen?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(gen?.["prototype"]), [], gen?.["prototype"]);
$verifyProperty(gen, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(gen, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(xGen), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(xGen), true);
$assert.callable(xGen);
$assert.notConstructable(xGen);
$assert.compareArray($Reflect_ownKeys(xGen), ['length', 'name', 'prototype'], xGen);
$assert.sameValue($Object_getPrototypeOf(xGen?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(xGen?.["prototype"]), true);
$assert.notCallable(xGen?.["prototype"]);
$assert.notConstructable(xGen?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(xGen?.["prototype"]), [], xGen?.["prototype"]);
$verifyProperty(xGen, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(xGen, "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xGen, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
