...
$assert.compareArray($Reflect_ownKeys(o), ['x', 'y', 'z'], o);
$verifyProperty(o, "x", {
  value: 42.0,
  writable: true,
  enumerable: true,
...
$assert.sameValue(x, 42.0);
$assert.sameValue(y, undefined);
$assert.sameValue($Object_getPrototypeOf(z), Object.prototype);
$assert.sameValue(Object.isExtensible(z), true);
$assert.notCallable(z);
$assert.notConstructable(z);
$assert.compareArray($Reflect_ownKeys(z), ['y', 'z'], z);
$verifyProperty(z, "y", {
  value: 39.0,
  writable: true,
  enumerable: true,
