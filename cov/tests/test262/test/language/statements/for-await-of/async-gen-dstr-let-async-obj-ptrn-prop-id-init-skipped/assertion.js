...
$assert.sameValue($Object_getPrototypeOf(globalThis["counter"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["counter"]), true);
$assert.callable(globalThis["counter"]);
$assert.constructable(globalThis["counter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["counter"]), ['length', 'name', 'prototype'], globalThis["counter"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["counter"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["counter"]?.["prototype"]), true);
$assert.notCallable(globalThis["counter"]?.["prototype"]);
$assert.notConstructable(globalThis["counter"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["counter"]?.["prototype"]), ['constructor'], globalThis["counter"]?.["prototype"]);
$assert.sameValue(globalThis["counter"]?.["prototype"]?.["constructor"], globalThis["counter"]);
$verifyProperty(globalThis["counter"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["counter"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["counter"], "name", {
  value: "counter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["counter"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["initCount"], 0.0);
