...
$assert.sameValue($Object_getPrototypeOf(globalThis["toAsyncIterator"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["toAsyncIterator"]), true);
$assert.callable(globalThis["toAsyncIterator"]);
$assert.constructable(globalThis["toAsyncIterator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["toAsyncIterator"]), ['length', 'name', 'prototype'], globalThis["toAsyncIterator"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["toAsyncIterator"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["toAsyncIterator"]?.["prototype"]), true);
$assert.notCallable(globalThis["toAsyncIterator"]?.["prototype"]);
$assert.notConstructable(globalThis["toAsyncIterator"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["toAsyncIterator"]?.["prototype"]), ['constructor'], globalThis["toAsyncIterator"]?.["prototype"]);
$assert.sameValue(globalThis["toAsyncIterator"]?.["prototype"]?.["constructor"], globalThis["toAsyncIterator"]);
$verifyProperty(globalThis["toAsyncIterator"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["toAsyncIterator"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["toAsyncIterator"], "name", {
  value: "toAsyncIterator",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["toAsyncIterator"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
