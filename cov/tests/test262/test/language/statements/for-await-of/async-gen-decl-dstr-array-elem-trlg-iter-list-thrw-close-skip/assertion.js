...
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"]), AsyncGeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]), ['length', 'name', 'prototype'], globalThis["fn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fn"]?.["prototype"]), true);
$assert.notCallable(globalThis["fn"]?.["prototype"]);
$assert.notConstructable(globalThis["fn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]?.["prototype"]), [], globalThis["fn"]?.["prototype"]);
$verifyProperty(globalThis["fn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(iter), globalThis["fn"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(iter), true);
$assert.notCallable(iter);
$assert.notConstructable(iter);
$assert.compareArray($Reflect_ownKeys(iter), [], iter);
$assert.sameValue(iterCount, 0.0);
$assert.sameValue($Object_getPrototypeOf(iterable), Object.prototype);
$assert.sameValue(Object.isExtensible(iterable), true);
$assert.notCallable(iterable);
$assert.notConstructable(iterable);
$assert.compareArray($Reflect_ownKeys(iterable), [Symbol.iterator], iterable);
$assert.sameValue($Object_getPrototypeOf(iterable?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(iterable?.[Symbol.iterator]), true);
$assert.callable(iterable?.[Symbol.iterator]);
$assert.constructable(iterable?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(iterable?.[Symbol.iterator]), ['length', 'name', 'prototype'], iterable?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(iterable?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(iterable?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(iterable?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(iterable?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(iterable?.[Symbol.iterator]?.["prototype"]), ['constructor'], iterable?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(iterable?.[Symbol.iterator]?.["prototype"]?.["constructor"], iterable?.[Symbol.iterator]);
$verifyProperty(iterable?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterable?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(iterable?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterable?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterable, Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(iterator), Object.prototype);
$assert.sameValue(Object.isExtensible(iterator), true);
$assert.notCallable(iterator);
$assert.notConstructable(iterator);
$assert.compareArray($Reflect_ownKeys(iterator), ['next', 'return'], iterator);
$assert.sameValue($Object_getPrototypeOf(iterator?.["next"]), Function.prototype);
$assert.sameValue(Object.isExtensible(iterator?.["next"]), true);
$assert.callable(iterator?.["next"]);
$assert.notConstructable(iterator?.["next"]);
$assert.compareArray($Reflect_ownKeys(iterator?.["next"]), ['length', 'name'], iterator?.["next"]);
$verifyProperty(iterator?.["next"], "name", {
  value: "next",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterator?.["next"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterator, "next", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(iterator?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(iterator?.["return"]), true);
$assert.callable(iterator?.["return"]);
$assert.notConstructable(iterator?.["return"]);
$assert.compareArray($Reflect_ownKeys(iterator?.["return"]), ['length', 'name'], iterator?.["return"]);
$verifyProperty(iterator?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterator?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterator, "return", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(nextCount, 1.0);
$assert.sameValue(returnCount, 0.0);
$assert.sameValue($Object_getPrototypeOf(thrower), Function.prototype);
$assert.sameValue(Object.isExtensible(thrower), true);
$assert.callable(thrower);
$assert.constructable(thrower);
$assert.compareArray($Reflect_ownKeys(thrower), ['length', 'name', 'prototype'], thrower);
$assert.sameValue($Object_getPrototypeOf(thrower?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(thrower?.["prototype"]), true);
$assert.notCallable(thrower?.["prototype"]);
$assert.notConstructable(thrower?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(thrower?.["prototype"]), ['constructor'], thrower?.["prototype"]);
$assert.sameValue(thrower?.["prototype"]?.["constructor"], thrower);
$verifyProperty(thrower?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(thrower, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(thrower, "name", {
  value: "thrower",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(thrower, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
