...
$assert.sameValue($Object_getPrototypeOf(fnexp), Function.prototype);
$assert.sameValue(Object.isExtensible(fnexp), true);
$assert.callable(fnexp);
$assert.constructable(fnexp);
$assert.compareArray($Reflect_ownKeys(fnexp), ['length', 'prototype'], fnexp);
$assert.sameValue($Object_getPrototypeOf(fnexp?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(fnexp?.["prototype"]), true);
$assert.notCallable(fnexp?.["prototype"]);
$assert.notConstructable(fnexp?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(fnexp?.["prototype"]), ['constructor'], fnexp?.["prototype"]);
$assert.sameValue(fnexp?.["prototype"]?.["constructor"], fnexp);
$verifyProperty(fnexp?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(fnexp, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(fnexp, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(xFnexp), Function.prototype);
$assert.sameValue(Object.isExtensible(xFnexp), true);
$assert.callable(xFnexp);
$assert.constructable(xFnexp);
$assert.compareArray($Reflect_ownKeys(xFnexp), ['length', 'name', 'prototype'], xFnexp);
$assert.sameValue($Object_getPrototypeOf(xFnexp?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(xFnexp?.["prototype"]), true);
$assert.notCallable(xFnexp?.["prototype"]);
$assert.notConstructable(xFnexp?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(xFnexp?.["prototype"]), ['constructor'], xFnexp?.["prototype"]);
$assert.sameValue(xFnexp?.["prototype"]?.["constructor"], xFnexp);
$verifyProperty(xFnexp?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xFnexp, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(xFnexp, "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xFnexp, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
