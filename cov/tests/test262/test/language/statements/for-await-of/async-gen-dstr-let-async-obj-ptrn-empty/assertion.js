...
$assert.sameValue(globalThis["accessCount"], 0.0);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["asyncIter"])), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["asyncIter"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["asyncIter"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["asyncIter"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["asyncIter"])), [], $Object_getPrototypeOf(globalThis["asyncIter"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIter"]), [], globalThis["asyncIter"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['attr'], globalThis["obj"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["obj"], "attr")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "attr", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
