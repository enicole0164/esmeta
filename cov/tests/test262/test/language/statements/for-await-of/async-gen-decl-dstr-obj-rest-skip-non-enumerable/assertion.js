...
$assert.compareArray($Reflect_ownKeys(obj), ['a', 'b', 'x'], obj);
...
$assert.sameValue($Object_getPrototypeOf(rest), Object.prototype);
$assert.sameValue(Object.isExtensible(rest), true);
$assert.notCallable(rest);
$assert.notConstructable(rest);
$assert.compareArray($Reflect_ownKeys(rest), [], rest);
