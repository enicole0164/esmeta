...
$assert.sameValue($Object_getPrototypeOf(globalThis["values"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["values"]), true);
$assert.notCallable(globalThis["values"]);
$assert.notConstructable(globalThis["values"]);
$assert.compareArray($Reflect_ownKeys(globalThis["values"]), ['0', '1', '2', '3', '4', 'length'], globalThis["values"]);
$verifyProperty(globalThis["values"], "4", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["values"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["values"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["values"], "3", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["values"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
