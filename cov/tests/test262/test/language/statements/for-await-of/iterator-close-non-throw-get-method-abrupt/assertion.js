...
$assert.sameValue($Object_getPrototypeOf(asyncIterable), Object.prototype);
$assert.sameValue(Object.isExtensible(asyncIterable), true);
$assert.notCallable(asyncIterable);
$assert.notConstructable(asyncIterable);
$assert.compareArray($Reflect_ownKeys(asyncIterable), [Symbol.asyncIterator], asyncIterable);
$assert.sameValue($Object_getPrototypeOf(asyncIterable?.[Symbol.asyncIterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(asyncIterable?.[Symbol.asyncIterator]), true);
$assert.callable(asyncIterable?.[Symbol.asyncIterator]);
$assert.constructable(asyncIterable?.[Symbol.asyncIterator]);
$assert.compareArray($Reflect_ownKeys(asyncIterable?.[Symbol.asyncIterator]), ['length', 'name', 'prototype'], asyncIterable?.[Symbol.asyncIterator]);
$assert.sameValue($Object_getPrototypeOf(asyncIterable?.[Symbol.asyncIterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(asyncIterable?.[Symbol.asyncIterator]?.["prototype"]), true);
$assert.notCallable(asyncIterable?.[Symbol.asyncIterator]?.["prototype"]);
$assert.notConstructable(asyncIterable?.[Symbol.asyncIterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(asyncIterable?.[Symbol.asyncIterator]?.["prototype"]), ['constructor'], asyncIterable?.[Symbol.asyncIterator]?.["prototype"]);
$assert.sameValue(asyncIterable?.[Symbol.asyncIterator]?.["prototype"]?.["constructor"], asyncIterable?.[Symbol.asyncIterator]);
$verifyProperty(asyncIterable?.[Symbol.asyncIterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(asyncIterable?.[Symbol.asyncIterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(asyncIterable?.[Symbol.asyncIterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(asyncIterable?.[Symbol.asyncIterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(asyncIterable, Symbol.asyncIterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(innerError), Object.prototype);
$assert.sameValue(Object.isExtensible(innerError), true);
$assert.notCallable(innerError);
$assert.notConstructable(innerError);
$assert.compareArray($Reflect_ownKeys(innerError), ['name'], innerError);
$verifyProperty(innerError, "name", {
  value: "inner error",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(iterationCount, 1.0);
