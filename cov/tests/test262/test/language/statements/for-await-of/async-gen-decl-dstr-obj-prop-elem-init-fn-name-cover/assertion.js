...
$assert.sameValue($Object_getPrototypeOf(cover), Function.prototype);
$assert.sameValue(Object.isExtensible(cover), true);
$assert.callable(cover);
$assert.constructable(cover);
$assert.compareArray($Reflect_ownKeys(cover), ['length', 'prototype'], cover);
$assert.sameValue($Object_getPrototypeOf(cover?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(cover?.["prototype"]), true);
$assert.notCallable(cover?.["prototype"]);
$assert.notConstructable(cover?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(cover?.["prototype"]), ['constructor'], cover?.["prototype"]);
$assert.sameValue(cover?.["prototype"]?.["constructor"], cover);
$verifyProperty(cover?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(cover, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(cover, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(xCover), Function.prototype);
$assert.sameValue(Object.isExtensible(xCover), true);
$assert.callable(xCover);
$assert.constructable(xCover);
$assert.compareArray($Reflect_ownKeys(xCover), ['length', 'name', 'prototype'], xCover);
$assert.sameValue($Object_getPrototypeOf(xCover?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(xCover?.["prototype"]), true);
$assert.notCallable(xCover?.["prototype"]);
$assert.notConstructable(xCover?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(xCover?.["prototype"]), ['constructor'], xCover?.["prototype"]);
$assert.sameValue(xCover?.["prototype"]?.["constructor"], xCover);
$verifyProperty(xCover?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCover, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(xCover, "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCover, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
