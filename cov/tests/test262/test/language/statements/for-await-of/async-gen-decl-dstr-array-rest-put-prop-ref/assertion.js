...
$assert.sameValue($Object_getPrototypeOf(x?.["y"]), Array.prototype);
$assert.sameValue(Object.isExtensible(x?.["y"]), true);
$assert.notCallable(x?.["y"]);
$assert.notConstructable(x?.["y"]);
$assert.compareArray($Reflect_ownKeys(x?.["y"]), ['0', '1', '2', 'length'], x?.["y"]);
$verifyProperty(x?.["y"], "1", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(x?.["y"], "2", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(x?.["y"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(x?.["y"], "0", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
