...
$assert.sameValue($Object_getPrototypeOf(y), Array.prototype);
$assert.sameValue(Object.isExtensible(y), true);
$assert.notCallable(y);
$assert.notConstructable(y);
$assert.compareArray($Reflect_ownKeys(y), ['length'], y);
$verifyProperty(y, "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
