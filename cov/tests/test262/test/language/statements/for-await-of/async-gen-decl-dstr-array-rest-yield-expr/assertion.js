...
$assert.sameValue($Object_getPrototypeOf(x?.["prop"]), Array.prototype);
$assert.sameValue(Object.isExtensible(x?.["prop"]), true);
$assert.notCallable(x?.["prop"]);
$assert.notConstructable(x?.["prop"]);
$assert.compareArray($Reflect_ownKeys(x?.["prop"]), ['0', '1', '2', 'length'], x?.["prop"]);
$verifyProperty(x?.["prop"], "1", {
  value: 44.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(x?.["prop"], "2", {
  value: 55.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(x?.["prop"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(x?.["prop"], "0", {
  value: 33.0,
  writable: true,
  enumerable: true,
  configurable: true,
