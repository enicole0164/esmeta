...
$assert.sameValue($Object_getPrototypeOf(arrow), Function.prototype);
$assert.sameValue(Object.isExtensible(arrow), true);
$assert.callable(arrow);
$assert.notConstructable(arrow);
$assert.compareArray($Reflect_ownKeys(arrow), ['length'], arrow);
$verifyProperty(arrow, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
