...
$assert.sameValue($Object_getPrototypeOf(setValue), Array.prototype);
$assert.sameValue(Object.isExtensible(setValue), true);
$assert.notCallable(setValue);
$assert.notConstructable(setValue);
$assert.compareArray($Reflect_ownKeys(setValue), ['0', '1', '2', 'length'], setValue);
$verifyProperty(setValue, "1", {
  value: 45.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(setValue, "2", {
  value: 99.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(setValue, "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(setValue, "0", {
  value: 23.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(x), ['y'], x);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(x, "y")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(x, "y")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(x, "y")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(x, "y")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(x, "y")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(x, "y")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(x, "y")?.get, "name", {
  value: "get y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(x, "y")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(x, "y")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(x, "y")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(x, "y")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(x, "y")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(x, "y")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(x, "y")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(x, "y")?.set, "name", {
  value: "set y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(x, "y")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
