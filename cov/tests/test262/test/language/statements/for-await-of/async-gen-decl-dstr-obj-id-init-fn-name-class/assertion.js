...
$assert.sameValue($Object_getPrototypeOf(cls), Function.prototype);
$assert.sameValue(Object.isExtensible(cls), true);
$assert.callable(cls);
$assert.constructable(cls);
$assert.compareArray($Reflect_ownKeys(cls), ['length', 'prototype'], cls);
$assert.sameValue($Object_getPrototypeOf(cls?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(cls?.["prototype"]), true);
$assert.notCallable(cls?.["prototype"]);
$assert.notConstructable(cls?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(cls?.["prototype"]), ['constructor'], cls?.["prototype"]);
$assert.sameValue(cls?.["prototype"]?.["constructor"], cls);
$verifyProperty(cls?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(cls, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(cls, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(xCls), Function.prototype);
$assert.sameValue(Object.isExtensible(xCls), true);
$assert.callable(xCls);
$assert.constructable(xCls);
$assert.compareArray($Reflect_ownKeys(xCls), ['length', 'name', 'prototype'], xCls);
$assert.sameValue($Object_getPrototypeOf(xCls?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(xCls?.["prototype"]), true);
$assert.notCallable(xCls?.["prototype"]);
$assert.notConstructable(xCls?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(xCls?.["prototype"]), ['constructor'], xCls?.["prototype"]);
$assert.sameValue(xCls?.["prototype"]?.["constructor"], xCls);
$verifyProperty(xCls?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCls, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(xCls, "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCls, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(xCls2), Function.prototype);
$assert.sameValue(Object.isExtensible(xCls2), true);
$assert.callable(xCls2);
$assert.constructable(xCls2);
$assert.compareArray($Reflect_ownKeys(xCls2), ['length', 'name', 'prototype'], xCls2);
$assert.sameValue($Object_getPrototypeOf(xCls2?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(xCls2?.["prototype"]), true);
$assert.notCallable(xCls2?.["prototype"]);
$assert.notConstructable(xCls2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(xCls2?.["prototype"]), ['constructor'], xCls2?.["prototype"]);
$assert.sameValue(xCls2?.["prototype"]?.["constructor"], xCls2);
$verifyProperty(xCls2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCls2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(xCls2?.["name"]), Function.prototype);
$assert.sameValue(Object.isExtensible(xCls2?.["name"]), true);
$assert.callable(xCls2?.["name"]);
$assert.notConstructable(xCls2?.["name"]);
$assert.compareArray($Reflect_ownKeys(xCls2?.["name"]), ['length', 'name'], xCls2?.["name"]);
$verifyProperty(xCls2?.["name"], "name", {
  value: "name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCls2?.["name"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCls2, "name", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xCls2, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
