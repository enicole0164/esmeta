...
$assert.sameValue($Object_getPrototypeOf(obj), Object.prototype);
$assert.sameValue(Object.isExtensible(obj), true);
$assert.notCallable(obj);
$assert.notConstructable(obj);
$assert.compareArray($Reflect_ownKeys(obj), ['ab'], obj);
$assert.sameValue($Object_getPrototypeOf(obj?.["ab"]), Array.prototype);
$assert.sameValue(Object.isExtensible(obj?.["ab"]), true);
$assert.notCallable(obj?.["ab"]);
$assert.notConstructable(obj?.["ab"]);
$assert.compareArray($Reflect_ownKeys(obj?.["ab"]), ['length'], obj?.["ab"]);
$verifyProperty(obj?.["ab"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(obj, "ab", {
  writable: true,
  enumerable: true,
  configurable: true,
});
