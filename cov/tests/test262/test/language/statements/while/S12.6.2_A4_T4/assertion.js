...
$assert.sameValue(globalThis["__in__do__IN__before__break"], "get");
$assert.sameValue(globalThis["__in__do__after__break"], "Satisfaction");
$assert.sameValue(globalThis["__in__do__before__break"], "can't");
