...
$assert.sameValue($Object_getPrototypeOf(Test262), Function.prototype);
$assert.sameValue(Object.isExtensible(Test262), true);
$assert.callable(Test262);
$assert.constructable(Test262);
$assert.compareArray($Reflect_ownKeys(Test262), ['length', 'prototype'], Test262);
$assert.sameValue($Object_getPrototypeOf(Test262?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Test262?.["prototype"]), true);
$assert.notCallable(Test262?.["prototype"]);
$assert.notConstructable(Test262?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Test262?.["prototype"]), ['constructor'], Test262?.["prototype"]);
$assert.sameValue(Test262?.["prototype"]?.["constructor"], Test262);
$verifyProperty(Test262?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Test262, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Test262, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
