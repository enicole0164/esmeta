...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'break'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["break"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["break"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["break"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["break"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["break"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["break"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["break"], "name", {
  value: "break",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["break"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "break", {
  writable: true,
  enumerable: false,
  configurable: true,
});
