...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'import'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["import"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["import"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["import"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["import"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["import"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["import"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["import"], "name", {
  value: "import",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["import"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "import", {
  writable: true,
  enumerable: false,
  configurable: true,
});
