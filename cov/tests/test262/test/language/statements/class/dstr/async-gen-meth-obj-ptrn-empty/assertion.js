...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["method"]), AsyncGeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["method"]), ['length', 'name', 'prototype'], C?.["prototype"]?.["method"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["method"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["method"]?.["prototype"]), true);
$assert.notCallable(C?.["prototype"]?.["method"]?.["prototype"]);
$assert.notConstructable(C?.["prototype"]?.["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["method"]?.["prototype"]), [], C?.["prototype"]?.["method"]?.["prototype"]);
$verifyProperty(C?.["prototype"]?.["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
