...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])), ['constructor', 'method'], $Object_getPrototypeOf(globalThis["c"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["method"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["method"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["method"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["method"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["method"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["c"])?.["method"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["method"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["method"]?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["c"])?.["method"]?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["method"]?.["prototype"]), [], $Object_getPrototypeOf(globalThis["c"])?.["method"]?.["prototype"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["method"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(globalThis["initEvalCount"], 0.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["poisonedProperty"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["poisonedProperty"]), true);
$assert.notCallable(globalThis["poisonedProperty"]);
$assert.notConstructable(globalThis["poisonedProperty"]);
$assert.compareArray($Reflect_ownKeys(globalThis["poisonedProperty"]), ['poisoned'], globalThis["poisonedProperty"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["poisonedProperty"], "poisoned")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["poisonedProperty"], "poisoned", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
