...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["method"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["method"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["method"]);
