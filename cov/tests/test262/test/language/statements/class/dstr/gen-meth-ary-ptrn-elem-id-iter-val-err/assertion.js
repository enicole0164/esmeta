...
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g"]), true);
$assert.notCallable(globalThis["g"]);
$assert.notConstructable(globalThis["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g"]), [Symbol.iterator], globalThis["g"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["g"]?.[Symbol.iterator]);
$assert.constructable(globalThis["g"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["g"]?.[Symbol.iterator]), ['length', 'name', 'prototype'], globalThis["g"]?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["g"]?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(globalThis["g"]?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(globalThis["g"]?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g"]?.[Symbol.iterator]?.["prototype"]), ['constructor'], globalThis["g"]?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(globalThis["g"]?.[Symbol.iterator]?.["prototype"]?.["constructor"], globalThis["g"]?.[Symbol.iterator]);
$verifyProperty(globalThis["g"]?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g"]?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["g"]?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["g"], Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
