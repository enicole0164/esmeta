...
$assert.sameValue($Object_getPrototypeOf(C?.["method"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(C?.["method"]), true);
$assert.callable(C?.["method"]);
$assert.notConstructable(C?.["method"]);
$assert.compareArray($Reflect_ownKeys(C?.["method"]), ['length', 'name', 'prototype'], C?.["method"]);
$assert.sameValue($Object_getPrototypeOf(C?.["method"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["method"]?.["prototype"]), true);
$assert.notCallable(C?.["method"]?.["prototype"]);
$assert.notConstructable(C?.["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["method"]?.["prototype"]), [], C?.["method"]?.["prototype"]);
$verifyProperty(C?.["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["method"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
