...
$assert.sameValue($Object_getPrototypeOf(globalThis["method"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["method"]), true);
$assert.callable(globalThis["method"]);
$assert.notConstructable(globalThis["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["method"]), ['length', 'name', 'prototype'], globalThis["method"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["method"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["method"]?.["prototype"]), true);
$assert.notCallable(globalThis["method"]?.["prototype"]);
$assert.notConstructable(globalThis["method"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["method"]?.["prototype"]), [], globalThis["method"]?.["prototype"]);
$verifyProperty(globalThis["method"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'method'], C?.["prototype"]);
$assert.sameValue(C?.["prototype"]?.["method"], globalThis["method"]);
$verifyProperty(C?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
