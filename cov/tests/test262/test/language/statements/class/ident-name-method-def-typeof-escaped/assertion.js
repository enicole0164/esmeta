...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'typeof'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["typeof"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["typeof"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["typeof"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["typeof"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["typeof"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["typeof"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["typeof"], "name", {
  value: "typeof",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["typeof"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "typeof", {
  writable: true,
  enumerable: false,
  configurable: true,
});
