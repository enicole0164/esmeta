...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["a"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["a"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["a"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["a"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["a"])), ['constructor', 'dontDoThis'], $Object_getPrototypeOf(globalThis["a"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"]);
$verifyProperty($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"], "name", {
  value: "dontDoThis",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a"])?.["dontDoThis"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a"]), "dontDoThis", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["a"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["a"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["a"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["a"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["a"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["a"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["a"]));
$verifyProperty($Object_getPrototypeOf(globalThis["a"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a"])?.["constructor"], "name", {
  value: "A",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['makeBugs'], globalThis["a"]);
$verifyProperty(globalThis["a"], "makeBugs", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(A, $Object_getPrototypeOf(globalThis["a"])?.["constructor"]);
