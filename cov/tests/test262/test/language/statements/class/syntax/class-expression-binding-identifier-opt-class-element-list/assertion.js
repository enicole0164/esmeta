...
$assert.compareArray($Reflect_ownKeys(globalThis["A"]), ['length', 'name', 'prototype', 'method'], globalThis["A"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["A"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["A"]?.["method"]), true);
$assert.callable(globalThis["A"]?.["method"]);
$assert.notConstructable(globalThis["A"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["A"]?.["method"]), ['length', 'name'], globalThis["A"]?.["method"]);
$verifyProperty(globalThis["A"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["A"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["A"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["A"]?.["prototype"]), ['constructor', 'method'], globalThis["A"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["A"]?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["A"]?.["prototype"]?.["method"]), true);
$assert.callable(globalThis["A"]?.["prototype"]?.["method"]);
$assert.notConstructable(globalThis["A"]?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["A"]?.["prototype"]?.["method"]), ['length', 'name'], globalThis["A"]?.["prototype"]?.["method"]);
$verifyProperty(globalThis["A"]?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["A"]?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["A"]?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
