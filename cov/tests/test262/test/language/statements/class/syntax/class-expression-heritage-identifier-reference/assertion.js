...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["B"])), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["B"])), true);
$assert.callable($Object_getPrototypeOf(globalThis["B"]));
$assert.constructable($Object_getPrototypeOf(globalThis["B"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["B"])), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["B"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["B"])?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["B"])?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["B"])?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["B"])?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["B"])?.["prototype"]), ['constructor'], $Object_getPrototypeOf(globalThis["B"])?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["B"])?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["B"]));
$verifyProperty($Object_getPrototypeOf(globalThis["B"])?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["B"]), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["B"]), "name", {
  value: "A",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["B"]), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["B"]), ['length', 'name', 'prototype'], globalThis["B"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["B"]?.["prototype"]), $Object_getPrototypeOf(globalThis["B"])?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["B"]?.["prototype"]), true);
$assert.notCallable(globalThis["B"]?.["prototype"]);
$assert.notConstructable(globalThis["B"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["B"]?.["prototype"]), ['constructor'], globalThis["B"]?.["prototype"]);
$assert.sameValue(globalThis["B"]?.["prototype"]?.["constructor"], globalThis["B"]);
$verifyProperty(globalThis["B"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["B"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue(A, $Object_getPrototypeOf(globalThis["B"]));
