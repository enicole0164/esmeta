...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['1', 'constructor'], A?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["1"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["1"]), true);
$assert.callable(A?.["prototype"]?.["1"]);
$assert.notConstructable(A?.["prototype"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["1"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["1"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["1"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["1"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["1"]?.["prototype"]), [], A?.["prototype"]?.["1"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["1"], "name", {
  value: "1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "1", {
  writable: true,
  enumerable: false,
  configurable: true,
});
