...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'with'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["with"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["with"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["with"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["with"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["with"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["with"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["with"], "name", {
  value: "with",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["with"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "with", {
  writable: true,
  enumerable: false,
  configurable: true,
});
