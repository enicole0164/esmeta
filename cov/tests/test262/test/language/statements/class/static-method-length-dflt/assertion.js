...
$assert.compareArray($Reflect_ownKeys(C1), ['length', 'name', 'prototype', 'm'], C1);
$assert.sameValue(C1?.["m"], globalThis["m1"]);
$verifyProperty(C1, "m", {
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C2), ['length', 'name', 'prototype', 'm'], C2);
$assert.sameValue(C2?.["m"], globalThis["m2"]);
$verifyProperty(C2, "m", {
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C3), ['length', 'name', 'prototype', 'm'], C3);
$assert.sameValue(C3?.["m"], globalThis["m3"]);
$verifyProperty(C3, "m", {
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C3?.["prototype"]), ['constructor'], C3?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(C4), ['length', 'name', 'prototype', 'm'], C4);
$assert.sameValue(C4?.["m"], globalThis["m4"]);
$verifyProperty(C4, "m", {
  writable: true,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C4?.["prototype"]), ['constructor'], C4?.["prototype"]);
