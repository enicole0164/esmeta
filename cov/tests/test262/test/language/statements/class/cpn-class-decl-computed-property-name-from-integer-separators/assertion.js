...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["12345678"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["12345678"]), true);
$assert.callable(C?.["prototype"]?.["12345678"]);
$assert.notConstructable(C?.["prototype"]?.["12345678"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["12345678"]), ['length', 'name'], C?.["prototype"]?.["12345678"]);
$verifyProperty(C?.["prototype"]?.["12345678"], "name", {
  value: "12345678",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["12345678"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["12345678"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["12345678"]), true);
$assert.callable(C?.["12345678"]);
$assert.notConstructable(C?.["12345678"]);
$assert.compareArray($Reflect_ownKeys(C?.["12345678"]), ['length', 'name'], C?.["12345678"]);
$verifyProperty(C?.["12345678"], "name", {
  value: "12345678",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["12345678"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
