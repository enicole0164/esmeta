...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["m"]), GeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["m"]), ['length', 'name', 'prototype'], C?.["prototype"]?.["m"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["m"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["m"]?.["prototype"]), true);
$assert.notCallable(C?.["prototype"]?.["m"]?.["prototype"]);
$assert.notConstructable(C?.["prototype"]?.["m"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["m"]?.["prototype"]), [], C?.["prototype"]?.["m"]?.["prototype"]);
$verifyProperty(C?.["prototype"]?.["m"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
