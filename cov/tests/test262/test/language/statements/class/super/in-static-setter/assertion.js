...
$assert.compareArray($Reflect_ownKeys(B), ['length', 'name', 'prototype', 'method', 'x'], B);
$assert.sameValue($Object_getPrototypeOf(B?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(B?.["method"]), true);
$assert.callable(B?.["method"]);
$assert.notConstructable(B?.["method"]);
$assert.compareArray($Reflect_ownKeys(B?.["method"]), ['length', 'name'], B?.["method"]);
$verifyProperty(B?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B, "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(B, "x")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(B, "x")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(B, "x")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(B, "x")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(B, "x")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(B, "x")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(B, "x")?.get, "name", {
  value: "get x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(B, "x")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'x'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "x")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "x")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "x")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "x")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "x")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "x")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "x")?.set, "name", {
  value: "set x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "x")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
