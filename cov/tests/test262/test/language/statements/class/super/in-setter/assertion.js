...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set, "name", {
  value: "set y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
