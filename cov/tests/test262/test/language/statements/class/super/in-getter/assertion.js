...
$assert.compareArray($Reflect_ownKeys(B?.["prototype"]), ['constructor', 'method', 'x'], B?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(B?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(B?.["prototype"]?.["method"]), true);
$assert.callable(B?.["prototype"]?.["method"]);
$assert.notConstructable(B?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(B?.["prototype"]?.["method"]), ['length', 'name'], B?.["prototype"]?.["method"]);
$verifyProperty(B?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get, "name", {
  value: "get x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(B?.["prototype"], "x")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["prototype"], "x", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'y'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get, "name", {
  value: "get y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "y")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "y", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
