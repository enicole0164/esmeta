...
$assert.compareArray($Reflect_ownKeys(C), ['4', 'length', 'name', 'prototype'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['4', 'constructor'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get, "name", {
  value: "get 4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set, "name", {
  value: "set 4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "4")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "4", {
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "4")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "4")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "4")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "4")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "4")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "4")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "4")?.get, "name", {
  value: "get 4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "4")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "4")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "4")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "4")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "4")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "4")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "4")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "4")?.set, "name", {
  value: "set 4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "4")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
