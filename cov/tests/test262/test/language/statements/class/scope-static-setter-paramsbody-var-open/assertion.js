...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'a'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "a")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "a")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "a")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "a")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "a")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "a")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "a")?.set, "name", {
  value: "set a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "a")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
