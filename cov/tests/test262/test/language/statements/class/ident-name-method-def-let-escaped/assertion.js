...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'let'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["let"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["let"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["let"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["let"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["let"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["let"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["let"], "name", {
  value: "let",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["let"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "let", {
  writable: true,
  enumerable: false,
  configurable: true,
});
