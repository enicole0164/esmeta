...
$assert.compareArray($Reflect_ownKeys(globalThis["Parent"]), ['length', 'name', 'prototype', 'test262'], globalThis["Parent"]);
...
$verifyProperty(globalThis["Parent"], "test262", {
  value: "test262",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["value"], "test262");
$assert.sameValue($Object_getPrototypeOf(C), globalThis["Parent"]);
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]), globalThis["Parent"]?.["prototype"]);
