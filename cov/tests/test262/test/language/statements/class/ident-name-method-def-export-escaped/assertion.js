...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'export'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["export"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["export"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["export"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["export"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["export"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["export"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["export"], "name", {
  value: "export",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["export"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "export", {
  writable: true,
  enumerable: false,
  configurable: true,
});
