...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'function'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["function"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["function"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["function"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["function"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["function"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["function"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["function"], "name", {
  value: "function",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["function"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "function", {
  writable: true,
  enumerable: false,
  configurable: true,
});
