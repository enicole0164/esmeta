...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'getPrivateReference', 'setPrivateReference'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["setPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["setPrivateReference"]), true);
$assert.callable(C?.["setPrivateReference"]);
$assert.notConstructable(C?.["setPrivateReference"]);
$assert.compareArray($Reflect_ownKeys(C?.["setPrivateReference"]), ['length', 'name'], C?.["setPrivateReference"]);
$verifyProperty(C?.["setPrivateReference"], "name", {
  value: "setPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["setPrivateReference"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "setPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(C?.["getPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["getPrivateReference"]), true);
$assert.callable(C?.["getPrivateReference"]);
$assert.notConstructable(C?.["getPrivateReference"]);
$assert.compareArray($Reflect_ownKeys(C?.["getPrivateReference"]), ['length', 'name'], C?.["getPrivateReference"]);
$verifyProperty(C?.["getPrivateReference"], "name", {
  value: "getPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["getPrivateReference"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "getPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
