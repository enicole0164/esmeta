...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'setAccess'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["setAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["setAccess"]), true);
$assert.callable(C?.["prototype"]?.["setAccess"]);
$assert.notConstructable(C?.["prototype"]?.["setAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["setAccess"]), ['length', 'name'], C?.["prototype"]?.["setAccess"]);
$verifyProperty(C?.["prototype"]?.["setAccess"], "name", {
  value: "setAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["setAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "setAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
