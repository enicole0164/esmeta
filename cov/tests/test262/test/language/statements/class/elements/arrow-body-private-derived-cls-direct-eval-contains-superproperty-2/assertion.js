...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'x'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["x"]), true);
$assert.callable(C?.["prototype"]?.["x"]);
$assert.notConstructable(C?.["prototype"]?.["x"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["x"]), ['length', 'name'], C?.["prototype"]?.["x"]);
$verifyProperty(C?.["prototype"]?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
