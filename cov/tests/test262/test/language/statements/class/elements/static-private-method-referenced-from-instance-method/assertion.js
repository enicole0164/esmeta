...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'g'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["g"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["g"]), true);
$assert.callable(C?.["prototype"]?.["g"]);
$assert.notConstructable(C?.["prototype"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["g"]), ['length', 'name'], C?.["prototype"]?.["g"]);
$verifyProperty(C?.["prototype"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "g", {
  writable: true,
  enumerable: false,
  configurable: true,
});
