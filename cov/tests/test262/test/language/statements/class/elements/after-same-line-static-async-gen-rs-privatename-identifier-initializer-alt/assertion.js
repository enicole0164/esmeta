...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])), ['constructor', '$', '_', 'o', '℘', 'ZW_‌_NJ', 'ZW_‍_J'], $Object_getPrototypeOf(globalThis["c"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"], "name", {
  value: "ZW_‍_J",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["ZW_‍_J"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "ZW_‍_J", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["_"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["_"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["_"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["_"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["_"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["_"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["_"], "name", {
  value: "_",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["_"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "_", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"], "name", {
  value: "ZW_‌_NJ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["ZW_‌_NJ"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "ZW_‌_NJ", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["$"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["$"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["$"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["$"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["$"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["$"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["$"], "name", {
  value: "$",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["$"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "$", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]), ['length', 'name', 'prototype', 'm'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]?.["prototype"]), [], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"]?.["prototype"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["m"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["o"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["o"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["o"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["o"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["o"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["o"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["o"], "name", {
  value: "o",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["o"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "o", {
  writable: true,
  enumerable: false,
  configurable: true,
});
