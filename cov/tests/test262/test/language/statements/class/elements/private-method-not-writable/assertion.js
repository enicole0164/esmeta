...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'assign'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["assign"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["assign"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["assign"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["assign"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["assign"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["assign"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["assign"], "name", {
  value: "assign",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["assign"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "assign", {
  writable: true,
  enumerable: false,
  configurable: true,
});
