...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(C)?.["prototype"]), ['constructor', 'superAccess'], $Object_getPrototypeOf(C)?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"]), true);
$assert.callable($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"]);
$assert.notConstructable($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"]), ['length', 'name'], $Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"]);
$verifyProperty($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"], "name", {
  value: "superAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(C)?.["prototype"]?.["superAccess"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(C)?.["prototype"], "superAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'access'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["access"]), true);
$assert.callable(C?.["prototype"]?.["access"]);
$assert.notConstructable(C?.["prototype"]?.["access"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["access"]), ['length', 'name'], C?.["prototype"]?.["access"]);
$verifyProperty(C?.["prototype"]?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["access"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(s), $Object_getPrototypeOf(C)?.["prototype"]);
$assert.sameValue(Object.isExtensible(s), true);
$assert.notCallable(s);
$assert.notConstructable(s);
$assert.compareArray($Reflect_ownKeys(s), ['_v'], s);
$verifyProperty(s, "_v", {
  value: "super class",
  writable: true,
  enumerable: true,
