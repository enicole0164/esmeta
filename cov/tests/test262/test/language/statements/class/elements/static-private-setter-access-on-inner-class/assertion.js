...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'Inner', '_v'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["Inner"]), ['length', 'name', 'prototype', 'access'], C?.["Inner"]);
$assert.sameValue($Object_getPrototypeOf(C?.["Inner"]?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["Inner"]?.["access"]), true);
$assert.callable(C?.["Inner"]?.["access"]);
$assert.notConstructable(C?.["Inner"]?.["access"]);
$assert.compareArray($Reflect_ownKeys(C?.["Inner"]?.["access"]), ['length', 'name'], C?.["Inner"]?.["access"]);
$verifyProperty(C?.["Inner"]?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["Inner"]?.["access"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["Inner"], "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["Inner"]?.["prototype"]), ['constructor'], C?.["Inner"]?.["prototype"]);
