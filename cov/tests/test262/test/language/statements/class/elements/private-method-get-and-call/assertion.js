...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'getPrivateMethod'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["getPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["getPrivateMethod"]), true);
$assert.callable(C?.["prototype"]?.["getPrivateMethod"]);
$assert.notConstructable(C?.["prototype"]?.["getPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["getPrivateMethod"]), ['length', 'name'], C?.["prototype"]?.["getPrivateMethod"]);
$verifyProperty(C?.["prototype"]?.["getPrivateMethod"], "name", {
  value: "getPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["getPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "getPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
