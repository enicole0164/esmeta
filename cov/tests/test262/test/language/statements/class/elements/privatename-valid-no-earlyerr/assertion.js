...
$assert.sameValue($Object_getPrototypeOf(globalThis["innerclass"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["innerclass"]), true);
$assert.callable(globalThis["innerclass"]);
$assert.constructable(globalThis["innerclass"]);
$assert.compareArray($Reflect_ownKeys(globalThis["innerclass"]), ['length', 'name', 'prototype'], globalThis["innerclass"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["innerclass"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["innerclass"]?.["prototype"]), true);
$assert.notCallable(globalThis["innerclass"]?.["prototype"]);
$assert.notConstructable(globalThis["innerclass"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["innerclass"]?.["prototype"]), ['constructor', 'g'], globalThis["innerclass"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["innerclass"]?.["prototype"]?.["g"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["innerclass"]?.["prototype"]?.["g"]), true);
$assert.callable(globalThis["innerclass"]?.["prototype"]?.["g"]);
$assert.notConstructable(globalThis["innerclass"]?.["prototype"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["innerclass"]?.["prototype"]?.["g"]), ['length', 'name'], globalThis["innerclass"]?.["prototype"]?.["g"]);
$verifyProperty(globalThis["innerclass"]?.["prototype"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["innerclass"]?.["prototype"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["innerclass"]?.["prototype"], "g", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["innerclass"]?.["prototype"]?.["constructor"], globalThis["innerclass"]);
$verifyProperty(globalThis["innerclass"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["innerclass"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["innerclass"], "name", {
  value: "inner",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["innerclass"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["test"], 42.0);
...
$assert.compareArray($Reflect_ownKeys(outer?.["prototype"]), ['constructor', 'f'], outer?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(outer?.["prototype"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(outer?.["prototype"]?.["f"]), true);
$assert.callable(outer?.["prototype"]?.["f"]);
$assert.notConstructable(outer?.["prototype"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(outer?.["prototype"]?.["f"]), ['length', 'name'], outer?.["prototype"]?.["f"]);
$verifyProperty(outer?.["prototype"]?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(outer?.["prototype"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(outer?.["prototype"], "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
