...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c1"])), ['constructor', 'f'], $Object_getPrototypeOf(globalThis["c1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c1"])?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c1"])?.["f"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c1"])?.["f"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c1"])?.["f"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c1"])?.["f"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c1"])?.["f"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c1"])?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c1"])?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c1"]), "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["c2"]), $Object_getPrototypeOf(globalThis["c1"]));
...
$assert.sameValue(C, $Object_getPrototypeOf(globalThis["c1"])?.["constructor"]);
