...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'methodAccess', 'B'], C);
$assert.sameValue($Object_getPrototypeOf(C?.["methodAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["methodAccess"]), true);
$assert.callable(C?.["methodAccess"]);
$assert.notConstructable(C?.["methodAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["methodAccess"]), ['length', 'name'], C?.["methodAccess"]);
$verifyProperty(C?.["methodAccess"], "name", {
  value: "methodAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["methodAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "methodAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["B"]), ['length', 'name', 'prototype', 'fieldAccess'], C?.["B"]);
...
$assert.compareArray($Reflect_ownKeys(C?.["B"]?.["prototype"]), ['constructor'], C?.["B"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(C?.["B"]?.["fieldAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["B"]?.["fieldAccess"]), true);
$assert.callable(C?.["B"]?.["fieldAccess"]);
$assert.notConstructable(C?.["B"]?.["fieldAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["B"]?.["fieldAccess"]), ['length', 'name'], C?.["B"]?.["fieldAccess"]);
$verifyProperty(C?.["B"]?.["fieldAccess"], "name", {
  value: "fieldAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["B"]?.["fieldAccess"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["B"], "fieldAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(b), C?.["B"]?.["prototype"]);
