...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]), ['length', 'name', 'prototype', 'x', 'y', 'm'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"], "name", {
  value: "y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["y"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "y", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "x", {
  writable: true,
  enumerable: false,
  configurable: true,
});
