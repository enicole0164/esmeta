...
$assert.compareArray($Reflect_ownKeys(globalThis["c1"]), ['constructor'], globalThis["c1"]);
$verifyProperty(globalThis["c1"], "constructor", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["x"], "constructor");
