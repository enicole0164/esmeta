...
$assert.sameValue($Object_getPrototypeOf(B), A);
...
$assert.sameValue($Object_getPrototypeOf(B?.["prototype"]), A?.["prototype"]);
$assert.sameValue(Object.isExtensible(B?.["prototype"]), true);
$assert.notCallable(B?.["prototype"]);
$assert.notConstructable(B?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(B?.["prototype"]), ['constructor', 'setAccess'], B?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(B?.["prototype"]?.["setAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(B?.["prototype"]?.["setAccess"]), true);
$assert.callable(B?.["prototype"]?.["setAccess"]);
$assert.notConstructable(B?.["prototype"]?.["setAccess"]);
$assert.compareArray($Reflect_ownKeys(B?.["prototype"]?.["setAccess"]), ['length', 'name'], B?.["prototype"]?.["setAccess"]);
$verifyProperty(B?.["prototype"]?.["setAccess"], "name", {
  value: "setAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["prototype"]?.["setAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["prototype"], "setAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]), ['constructor', 'setAccess'], D?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(D?.["prototype"]?.["setAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(D?.["prototype"]?.["setAccess"]), true);
$assert.callable(D?.["prototype"]?.["setAccess"]);
$assert.notConstructable(D?.["prototype"]?.["setAccess"]);
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]?.["setAccess"]), ['length', 'name'], D?.["prototype"]?.["setAccess"]);
$verifyProperty(D?.["prototype"]?.["setAccess"], "name", {
  value: "setAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"]?.["setAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"], "setAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(b), B?.["prototype"]);
$assert.sameValue(Object.isExtensible(b), true);
...
$assert.compareArray($Reflect_ownKeys(c), ['Inner'], c);
$assert.sameValue($Object_getPrototypeOf(c?.["Inner"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["Inner"]), true);
$assert.callable(c?.["Inner"]);
$assert.constructable(c?.["Inner"]);
$assert.compareArray($Reflect_ownKeys(c?.["Inner"]), ['length', 'name', 'prototype'], c?.["Inner"]);
$assert.sameValue($Object_getPrototypeOf(c?.["Inner"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(c?.["Inner"]?.["prototype"]), true);
$assert.notCallable(c?.["Inner"]?.["prototype"]);
$assert.notConstructable(c?.["Inner"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(c?.["Inner"]?.["prototype"]), ['constructor', 'setAccess'], c?.["Inner"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(c?.["Inner"]?.["prototype"]?.["setAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(c?.["Inner"]?.["prototype"]?.["setAccess"]), true);
$assert.callable(c?.["Inner"]?.["prototype"]?.["setAccess"]);
$assert.notConstructable(c?.["Inner"]?.["prototype"]?.["setAccess"]);
$assert.compareArray($Reflect_ownKeys(c?.["Inner"]?.["prototype"]?.["setAccess"]), ['length', 'name'], c?.["Inner"]?.["prototype"]?.["setAccess"]);
$verifyProperty(c?.["Inner"]?.["prototype"]?.["setAccess"], "name", {
  value: "setAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["Inner"]?.["prototype"]?.["setAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["Inner"]?.["prototype"], "setAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(c?.["Inner"]?.["prototype"]?.["constructor"], c?.["Inner"]);
$verifyProperty(c?.["Inner"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["Inner"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(c?.["Inner"], "name", {
  value: "Inner",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c?.["Inner"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(c, "Inner", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(d), D?.["prototype"]);
$assert.sameValue(Object.isExtensible(d), true);
$assert.notCallable(d);
$assert.notConstructable(d);
$assert.compareArray($Reflect_ownKeys(d), ['Inner'], d);
$assert.sameValue($Object_getPrototypeOf(d?.["Inner"]), Function.prototype);
$assert.sameValue(Object.isExtensible(d?.["Inner"]), true);
$assert.callable(d?.["Inner"]);
$assert.constructable(d?.["Inner"]);
$assert.compareArray($Reflect_ownKeys(d?.["Inner"]), ['length', 'name', 'prototype'], d?.["Inner"]);
$assert.sameValue($Object_getPrototypeOf(d?.["Inner"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(d?.["Inner"]?.["prototype"]), true);
$assert.notCallable(d?.["Inner"]?.["prototype"]);
$assert.notConstructable(d?.["Inner"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(d?.["Inner"]?.["prototype"]), ['constructor'], d?.["Inner"]?.["prototype"]);
$assert.sameValue(d?.["Inner"]?.["prototype"]?.["constructor"], d?.["Inner"]);
$verifyProperty(d?.["Inner"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(d?.["Inner"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(d?.["Inner"], "name", {
  value: "Inner",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(d?.["Inner"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(d, "Inner", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(innerC), c?.["Inner"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(innerC), true);
$assert.notCallable(innerC);
$assert.notConstructable(innerC);
$assert.compareArray($Reflect_ownKeys(innerC), [], innerC);
