...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c1)), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c1)), true);
$assert.notCallable($Object_getPrototypeOf(c1));
$assert.notConstructable($Object_getPrototypeOf(c1));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c1)), ['constructor', 'getPrivateMethod'], $Object_getPrototypeOf(c1));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c1)?.["getPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c1)?.["getPrivateMethod"]), true);
$assert.callable($Object_getPrototypeOf(c1)?.["getPrivateMethod"]);
$assert.notConstructable($Object_getPrototypeOf(c1)?.["getPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c1)?.["getPrivateMethod"]), ['length', 'name'], $Object_getPrototypeOf(c1)?.["getPrivateMethod"]);
$verifyProperty($Object_getPrototypeOf(c1)?.["getPrivateMethod"], "name", {
  value: "getPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c1)?.["getPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c1), "getPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c1)?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c1)?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(c1)?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(c1)?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c1)?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(c1)?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(c1)?.["constructor"]?.["prototype"], $Object_getPrototypeOf(c1));
$verifyProperty($Object_getPrototypeOf(c1)?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(c1)?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c1)?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c1), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(c1), true);
$assert.notCallable(c1);
$assert.notConstructable(c1);
$assert.compareArray($Reflect_ownKeys(c1), [], c1);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c2)), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c2)), true);
$assert.notCallable($Object_getPrototypeOf(c2));
$assert.notConstructable($Object_getPrototypeOf(c2));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c2)), ['constructor', 'getPrivateMethod'], $Object_getPrototypeOf(c2));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c2)?.["getPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c2)?.["getPrivateMethod"]), true);
$assert.callable($Object_getPrototypeOf(c2)?.["getPrivateMethod"]);
$assert.notConstructable($Object_getPrototypeOf(c2)?.["getPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c2)?.["getPrivateMethod"]), ['length', 'name'], $Object_getPrototypeOf(c2)?.["getPrivateMethod"]);
$verifyProperty($Object_getPrototypeOf(c2)?.["getPrivateMethod"], "name", {
  value: "getPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c2)?.["getPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c2), "getPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(c2)?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(c2)?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(c2)?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(c2)?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(c2)?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(c2)?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(c2)?.["constructor"]?.["prototype"], $Object_getPrototypeOf(c2));
$verifyProperty($Object_getPrototypeOf(c2)?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(c2)?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c2)?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(c2), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(c2), true);
$assert.notCallable(c2);
$assert.notConstructable(c2);
$assert.compareArray($Reflect_ownKeys(c2), [], c2);
$assert.sameValue($Object_getPrototypeOf(createAndInstantiateClass), Function.prototype);
$assert.sameValue(Object.isExtensible(createAndInstantiateClass), true);
$assert.callable(createAndInstantiateClass);
$assert.constructable(createAndInstantiateClass);
$assert.compareArray($Reflect_ownKeys(createAndInstantiateClass), ['length', 'name', 'prototype'], createAndInstantiateClass);
$assert.sameValue($Object_getPrototypeOf(createAndInstantiateClass?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(createAndInstantiateClass?.["prototype"]), true);
$assert.notCallable(createAndInstantiateClass?.["prototype"]);
$assert.notConstructable(createAndInstantiateClass?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(createAndInstantiateClass?.["prototype"]), ['constructor'], createAndInstantiateClass?.["prototype"]);
$assert.sameValue(createAndInstantiateClass?.["prototype"]?.["constructor"], createAndInstantiateClass);
$verifyProperty(createAndInstantiateClass?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(createAndInstantiateClass, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(createAndInstantiateClass, "name", {
  value: "createAndInstantiateClass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(createAndInstantiateClass, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
