...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]), ['length', 'name', 'prototype', '$', '_', 'o', '℘', 'ZW_‌_NJ', 'ZW_‍_J', 'm'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"], "name", {
  value: "_",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["_"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"], "name", {
  value: "ZW_‌_NJ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‌_NJ"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"], "name", {
  value: "ZW_‍_J",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["ZW_‍_J"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"], "name", {
  value: "o",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["o"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["℘"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["℘"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["℘"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["℘"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["℘"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]?.["℘"]);
