...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(Base)), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(Base)), true);
$assert.callable($Object_getPrototypeOf(Base));
$assert.constructable($Object_getPrototypeOf(Base));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(Base)), ['length', 'name', 'prototype'], $Object_getPrototypeOf(Base));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(Base)?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(Base)?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(Base)?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(Base)?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(Base)?.["prototype"]), ['constructor', 'f'], $Object_getPrototypeOf(Base)?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set, "name", {
  value: "set f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(Base)?.["prototype"], "f")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Base)?.["prototype"], "f", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Base)?.["prototype"]?.["constructor"], $Object_getPrototypeOf(Base));
$verifyProperty($Object_getPrototypeOf(Base)?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Base), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(Base), "name", {
  value: "Super",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(Base), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Base?.["prototype"]), $Object_getPrototypeOf(Base)?.["prototype"]);
...
$assert.sameValue(Super, $Object_getPrototypeOf(Base));
$assert.sameValue($Object_getPrototypeOf(o), Base?.["prototype"]);
