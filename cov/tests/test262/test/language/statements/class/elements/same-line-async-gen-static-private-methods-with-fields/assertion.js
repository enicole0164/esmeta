...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]), ['length', 'name', 'prototype', 'x', 'y'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]);
