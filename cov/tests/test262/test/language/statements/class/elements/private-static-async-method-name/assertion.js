...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'getPrivateMethod'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["getPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["getPrivateMethod"]), true);
$assert.callable(C?.["getPrivateMethod"]);
$assert.notConstructable(C?.["getPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys(C?.["getPrivateMethod"]), ['length', 'name'], C?.["getPrivateMethod"]);
$verifyProperty(C?.["getPrivateMethod"], "name", {
  value: "getPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["getPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "getPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
