...
$assert.sameValue($Object_getPrototypeOf(Test), Function.prototype);
$assert.sameValue(Object.isExtensible(Test), true);
$assert.callable(Test);
$assert.constructable(Test);
$assert.compareArray($Reflect_ownKeys(Test), ['length', 'name', 'prototype'], Test);
$assert.sameValue($Object_getPrototypeOf(Test?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Test?.["prototype"]), true);
$assert.notCallable(Test?.["prototype"]);
$assert.notConstructable(Test?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Test?.["prototype"]), ['constructor', 'g'], Test?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get, "name", {
  value: "get g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(Test?.["prototype"], "g")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Test?.["prototype"], "g", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Test?.["prototype"]?.["constructor"], Test);
$verifyProperty(Test?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Test, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Test, "name", {
  value: "Test",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Test, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(t), Test?.["prototype"]);
$assert.sameValue(Object.isExtensible(t), false);
$assert.notCallable(t);
$assert.notConstructable(t);
$assert.compareArray($Reflect_ownKeys(t), ['f'], t);
