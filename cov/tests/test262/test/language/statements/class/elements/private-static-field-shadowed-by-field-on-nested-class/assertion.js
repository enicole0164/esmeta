...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'fieldAccess', 'B'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["fieldAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["fieldAccess"]), true);
$assert.callable(C?.["fieldAccess"]);
$assert.notConstructable(C?.["fieldAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["fieldAccess"]), ['length', 'name'], C?.["fieldAccess"]);
$verifyProperty(C?.["fieldAccess"], "name", {
  value: "fieldAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["fieldAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "fieldAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
