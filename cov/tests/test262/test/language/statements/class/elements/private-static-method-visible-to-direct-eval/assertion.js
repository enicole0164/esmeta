...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'accessWithEval'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["accessWithEval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["accessWithEval"]), true);
$assert.callable(C?.["accessWithEval"]);
$assert.notConstructable(C?.["accessWithEval"]);
$assert.compareArray($Reflect_ownKeys(C?.["accessWithEval"]), ['length', 'name'], C?.["accessWithEval"]);
$verifyProperty(C?.["accessWithEval"], "name", {
  value: "accessWithEval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["accessWithEval"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "accessWithEval", {
  writable: true,
  enumerable: false,
  configurable: true,
});
