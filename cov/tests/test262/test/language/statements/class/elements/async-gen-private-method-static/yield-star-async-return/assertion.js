...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "gen")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "gen")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "gen")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "gen")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "gen")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "gen")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "gen")?.get, "name", {
  value: "get gen",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "gen")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
