...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'B'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["B"]), ['length', 'name', 'prototype', 'methodAccess'], C?.["B"]);
$assert.sameValue($Object_getPrototypeOf(C?.["B"]?.["methodAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["B"]?.["methodAccess"]), true);
$assert.callable(C?.["B"]?.["methodAccess"]);
$assert.notConstructable(C?.["B"]?.["methodAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["B"]?.["methodAccess"]), ['length', 'name'], C?.["B"]?.["methodAccess"]);
$verifyProperty(C?.["B"]?.["methodAccess"], "name", {
  value: "methodAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["B"]?.["methodAccess"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["B"], "methodAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
