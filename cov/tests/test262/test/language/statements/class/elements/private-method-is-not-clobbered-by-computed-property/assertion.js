...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'checkPrivateMethod'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["checkPrivateMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["checkPrivateMethod"]), true);
$assert.callable(C?.["prototype"]?.["checkPrivateMethod"]);
$assert.notConstructable(C?.["prototype"]?.["checkPrivateMethod"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["checkPrivateMethod"]), ['length', 'name'], C?.["prototype"]?.["checkPrivateMethod"]);
$verifyProperty(C?.["prototype"]?.["checkPrivateMethod"], "name", {
  value: "checkPrivateMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["checkPrivateMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "checkPrivateMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
