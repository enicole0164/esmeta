...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])), ['constructor', 'x', 'y'], $Object_getPrototypeOf(globalThis["c"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["x"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["x"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["x"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["x"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["x"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["y"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["y"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["y"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["y"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["y"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["y"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["y"], "name", {
  value: "y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["y"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "y", {
  writable: true,
  enumerable: false,
  configurable: true,
});
