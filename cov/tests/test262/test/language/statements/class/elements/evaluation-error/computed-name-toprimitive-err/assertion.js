...
$assert.sameValue($Object_getPrototypeOf(globalThis["evaluate"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["evaluate"]), true);
$assert.callable(globalThis["evaluate"]);
$assert.constructable(globalThis["evaluate"]);
$assert.compareArray($Reflect_ownKeys(globalThis["evaluate"]), ['length', 'name', 'prototype'], globalThis["evaluate"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["evaluate"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["evaluate"]?.["prototype"]), true);
$assert.notCallable(globalThis["evaluate"]?.["prototype"]);
$assert.notConstructable(globalThis["evaluate"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["evaluate"]?.["prototype"]), ['constructor'], globalThis["evaluate"]?.["prototype"]);
$assert.sameValue(globalThis["evaluate"]?.["prototype"]?.["constructor"], globalThis["evaluate"]);
$verifyProperty(globalThis["evaluate"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["evaluate"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["evaluate"], "name", {
  value: "evaluate",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["evaluate"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), [Symbol.toPrimitive], globalThis["obj"]);
