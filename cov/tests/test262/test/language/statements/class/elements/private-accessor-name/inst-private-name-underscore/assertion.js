...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["inst"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["inst"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["inst"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["inst"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["inst"])), ['constructor', 'getPrivateReference', 'setPrivateReference'], $Object_getPrototypeOf(globalThis["inst"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"]);
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"], "name", {
  value: "getPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["getPrivateReference"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"]), "getPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["inst"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["inst"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["inst"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["inst"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["inst"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["inst"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["inst"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["inst"]));
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"]);
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"], "name", {
  value: "setPrivateReference",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"])?.["setPrivateReference"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["inst"]), "setPrivateReference", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["inst"]), true);
$assert.notCallable(globalThis["inst"]);
$assert.notConstructable(globalThis["inst"]);
$assert.compareArray($Reflect_ownKeys(globalThis["inst"]), [], globalThis["inst"]);
$assert.sameValue(globalThis["stringSet"], "set string");
$assert.sameValue(C, $Object_getPrototypeOf(globalThis["inst"])?.["constructor"]);
