...
$assert.sameValue($Object_getPrototypeOf(C?.["constructor"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(C?.["constructor"]), true);
$assert.callable(C?.["constructor"]);
$assert.notConstructable(C?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(C?.["constructor"]), ['length', 'name', 'prototype'], C?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(C?.["constructor"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["constructor"]?.["prototype"]), true);
$assert.notCallable(C?.["constructor"]?.["prototype"]);
$assert.notConstructable(C?.["constructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["constructor"]?.["prototype"]), [], C?.["constructor"]?.["prototype"]);
$verifyProperty(C?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C?.["constructor"], "name", {
  value: "constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
