...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))), ['constructor', 'x'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"]);
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"]), ['length', 'name'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"]);
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])), "x", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"], "name", {
  value: "A",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["b"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["b"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["b"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["b"])), ['constructor', 'x'], $Object_getPrototypeOf(globalThis["b"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["b"])?.["x"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["b"])?.["x"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["b"])?.["x"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["b"])?.["x"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["b"])?.["x"]);
$verifyProperty($Object_getPrototypeOf(globalThis["b"])?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b"])?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b"]), "x", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["b"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["b"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["b"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["b"]));
$verifyProperty($Object_getPrototypeOf(globalThis["b"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b"])?.["constructor"], "name", {
  value: "B",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["b"]), true);
$assert.notCallable(globalThis["b"]);
$assert.notConstructable(globalThis["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["b"]), [], globalThis["b"]);
$assert.sameValue(A, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"]))?.["constructor"]);
$assert.sameValue(B, $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
