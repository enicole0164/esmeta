...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'accessPrivateField'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["accessPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["accessPrivateField"]), true);
$assert.callable(C?.["prototype"]?.["accessPrivateField"]);
$assert.notConstructable(C?.["prototype"]?.["accessPrivateField"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["accessPrivateField"]), ['length', 'name'], C?.["prototype"]?.["accessPrivateField"]);
$verifyProperty(C?.["prototype"]?.["accessPrivateField"], "name", {
  value: "accessPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["accessPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "accessPrivateField", {
  writable: true,
  enumerable: false,
  configurable: true,
});
