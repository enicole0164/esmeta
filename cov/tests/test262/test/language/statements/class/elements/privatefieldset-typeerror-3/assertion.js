...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["Inner"])), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["Inner"])), true);
$assert.callable($Object_getPrototypeOf(globalThis["Inner"]));
$assert.constructable($Object_getPrototypeOf(globalThis["Inner"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["Inner"])), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["Inner"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]), ['constructor', 'innerclass', 'value'], $Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"]);
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"], "name", {
  value: "innerclass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["innerclass"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"], "innerclass", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"]);
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"], "name", {
  value: "value",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["value"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"], "value", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["Inner"]));
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"]), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"]), "name", {
  value: "Outer",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["Inner"]), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["Inner"]), true);
$assert.callable(globalThis["Inner"]);
$assert.constructable(globalThis["Inner"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Inner"]), ['length', 'name', 'prototype'], globalThis["Inner"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Inner"]?.["prototype"]), $Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["Inner"]?.["prototype"]), true);
$assert.notCallable(globalThis["Inner"]?.["prototype"]);
$assert.notConstructable(globalThis["Inner"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Inner"]?.["prototype"]), ['constructor', 'f'], globalThis["Inner"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Inner"]?.["prototype"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Inner"]?.["prototype"]?.["f"]), true);
$assert.callable(globalThis["Inner"]?.["prototype"]?.["f"]);
$assert.notConstructable(globalThis["Inner"]?.["prototype"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Inner"]?.["prototype"]?.["f"]), ['length', 'name'], globalThis["Inner"]?.["prototype"]?.["f"]);
$verifyProperty(globalThis["Inner"]?.["prototype"]?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Inner"]?.["prototype"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Inner"]?.["prototype"], "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["Inner"]?.["prototype"]?.["constructor"], globalThis["Inner"]);
$verifyProperty(globalThis["Inner"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Inner"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Inner"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Inner"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["i"]), globalThis["Inner"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["i"]), true);
$assert.notCallable(globalThis["i"]);
$assert.notConstructable(globalThis["i"]);
$assert.compareArray($Reflect_ownKeys(globalThis["i"]), [], globalThis["i"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["outer"]), $Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["outer"]), true);
$assert.notCallable(globalThis["outer"]);
$assert.notConstructable(globalThis["outer"]);
$assert.compareArray($Reflect_ownKeys(globalThis["outer"]), [], globalThis["outer"]);
$assert.sameValue(Outer, $Object_getPrototypeOf(globalThis["Inner"]));
