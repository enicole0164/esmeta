...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'getAccess'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["getAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["getAccess"]), true);
$assert.callable(C?.["prototype"]?.["getAccess"]);
$assert.notConstructable(C?.["prototype"]?.["getAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["getAccess"]), ['length', 'name'], C?.["prototype"]?.["getAccess"]);
$verifyProperty(C?.["prototype"]?.["getAccess"], "name", {
  value: "getAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["getAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "getAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]), ['constructor', 'getAccess'], D?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(D?.["prototype"]?.["getAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(D?.["prototype"]?.["getAccess"]), true);
$assert.callable(D?.["prototype"]?.["getAccess"]);
$assert.notConstructable(D?.["prototype"]?.["getAccess"]);
$assert.compareArray($Reflect_ownKeys(D?.["prototype"]?.["getAccess"]), ['length', 'name'], D?.["prototype"]?.["getAccess"]);
$verifyProperty(D?.["prototype"]?.["getAccess"], "name", {
  value: "getAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"]?.["getAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D?.["prototype"], "getAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(b), ['Inner'], b);
$assert.sameValue($Object_getPrototypeOf(b?.["Inner"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["Inner"]), true);
$assert.callable(b?.["Inner"]);
$assert.constructable(b?.["Inner"]);
$assert.compareArray($Reflect_ownKeys(b?.["Inner"]), ['length', 'name', 'prototype'], b?.["Inner"]);
$assert.sameValue($Object_getPrototypeOf(b?.["Inner"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(b?.["Inner"]?.["prototype"]), true);
$assert.notCallable(b?.["Inner"]?.["prototype"]);
$assert.notConstructable(b?.["Inner"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(b?.["Inner"]?.["prototype"]), ['constructor', 'getAccess'], b?.["Inner"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(b?.["Inner"]?.["prototype"]?.["getAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["Inner"]?.["prototype"]?.["getAccess"]), true);
$assert.callable(b?.["Inner"]?.["prototype"]?.["getAccess"]);
$assert.notConstructable(b?.["Inner"]?.["prototype"]?.["getAccess"]);
$assert.compareArray($Reflect_ownKeys(b?.["Inner"]?.["prototype"]?.["getAccess"]), ['length', 'name'], b?.["Inner"]?.["prototype"]?.["getAccess"]);
$verifyProperty(b?.["Inner"]?.["prototype"]?.["getAccess"], "name", {
  value: "getAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["Inner"]?.["prototype"]?.["getAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["Inner"]?.["prototype"], "getAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(b?.["Inner"]?.["prototype"]?.["constructor"], b?.["Inner"]);
$verifyProperty(b?.["Inner"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["Inner"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(b?.["Inner"], "name", {
  value: "Inner",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["Inner"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b, "Inner", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(innerB), b?.["Inner"]?.["prototype"]);
