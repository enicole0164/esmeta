...
$assert.sameValue($Object_getPrototypeOf(globalThis["C1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C1"]), true);
$assert.callable(globalThis["C1"]);
$assert.constructable(globalThis["C1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C1"]), ['length', 'name', 'prototype'], globalThis["C1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C1"]?.["prototype"]), true);
$assert.notCallable(globalThis["C1"]?.["prototype"]);
$assert.notConstructable(globalThis["C1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C1"]?.["prototype"]), ['constructor', 'f'], globalThis["C1"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C1"]?.["prototype"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C1"]?.["prototype"]?.["f"]), true);
$assert.callable(globalThis["C1"]?.["prototype"]?.["f"]);
$assert.notConstructable(globalThis["C1"]?.["prototype"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C1"]?.["prototype"]?.["f"]), ['length', 'name'], globalThis["C1"]?.["prototype"]?.["f"]);
$verifyProperty(globalThis["C1"]?.["prototype"]?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C1"]?.["prototype"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C1"]?.["prototype"], "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["C1"]?.["prototype"]?.["constructor"], globalThis["C1"]);
$verifyProperty(globalThis["C1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C1"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["C2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C2"]), true);
$assert.callable(globalThis["C2"]);
$assert.constructable(globalThis["C2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C2"]), ['length', 'name', 'prototype'], globalThis["C2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C2"]?.["prototype"]), true);
$assert.notCallable(globalThis["C2"]?.["prototype"]);
$assert.notConstructable(globalThis["C2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C2"]?.["prototype"]), ['constructor', 'f'], globalThis["C2"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C2"]?.["prototype"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C2"]?.["prototype"]?.["f"]), true);
$assert.callable(globalThis["C2"]?.["prototype"]?.["f"]);
$assert.notConstructable(globalThis["C2"]?.["prototype"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C2"]?.["prototype"]?.["f"]), ['length', 'name'], globalThis["C2"]?.["prototype"]?.["f"]);
$verifyProperty(globalThis["C2"]?.["prototype"]?.["f"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"]?.["prototype"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"]?.["prototype"], "f", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["C2"]?.["prototype"]?.["constructor"], globalThis["C2"]);
$verifyProperty(globalThis["C2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["C2"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["c1"]), globalThis["C1"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["c1"]), true);
$assert.notCallable(globalThis["c1"]);
$assert.notConstructable(globalThis["c1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["c1"]), [], globalThis["c1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["c2"]), globalThis["C2"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["c2"]), true);
$assert.notCallable(globalThis["c2"]);
$assert.notConstructable(globalThis["c2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["c2"]), [], globalThis["c2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["classfactory"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["classfactory"]), true);
$assert.callable(globalThis["classfactory"]);
$assert.constructable(globalThis["classfactory"]);
$assert.compareArray($Reflect_ownKeys(globalThis["classfactory"]), ['length', 'name', 'prototype'], globalThis["classfactory"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["classfactory"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["classfactory"]?.["prototype"]), true);
$assert.notCallable(globalThis["classfactory"]?.["prototype"]);
$assert.notConstructable(globalThis["classfactory"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["classfactory"]?.["prototype"]), ['constructor'], globalThis["classfactory"]?.["prototype"]);
$assert.sameValue(globalThis["classfactory"]?.["prototype"]?.["constructor"], globalThis["classfactory"]);
$verifyProperty(globalThis["classfactory"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["classfactory"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["classfactory"], "name", {
  value: "classfactory",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["classfactory"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
