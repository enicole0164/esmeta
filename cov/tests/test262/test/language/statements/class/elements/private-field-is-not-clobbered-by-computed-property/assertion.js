...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'checkPrivateField'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["checkPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["checkPrivateField"]), true);
$assert.callable(C?.["prototype"]?.["checkPrivateField"]);
$assert.notConstructable(C?.["prototype"]?.["checkPrivateField"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["checkPrivateField"]), ['length', 'name'], C?.["prototype"]?.["checkPrivateField"]);
$verifyProperty(C?.["prototype"]?.["checkPrivateField"], "name", {
  value: "checkPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["checkPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "checkPrivateField", {
  writable: true,
  enumerable: false,
  configurable: true,
});
