...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['constructor', 'method'], A?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["method"]), true);
$assert.callable(A?.["prototype"]?.["method"]);
$assert.notConstructable(A?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["method"]), ['length', 'name'], A?.["prototype"]?.["method"]);
$verifyProperty(A?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
