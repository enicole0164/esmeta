...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'setWithEval', '_v'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["setWithEval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["setWithEval"]), true);
$assert.callable(C?.["setWithEval"]);
$assert.notConstructable(C?.["setWithEval"]);
$assert.compareArray($Reflect_ownKeys(C?.["setWithEval"]), ['length', 'name'], C?.["setWithEval"]);
$verifyProperty(C?.["setWithEval"], "name", {
  value: "setWithEval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["setWithEval"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "setWithEval", {
  writable: true,
  enumerable: false,
  configurable: true,
});
