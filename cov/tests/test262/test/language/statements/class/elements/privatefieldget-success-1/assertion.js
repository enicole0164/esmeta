...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]), ['constructor', 'innerclass'], $Object_getPrototypeOf(globalThis["Inner"])?.["prototype"]);
...
$assert.sameValue(globalThis["value"], 42.0);
