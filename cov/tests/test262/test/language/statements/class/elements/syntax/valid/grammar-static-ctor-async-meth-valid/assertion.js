...
$assert.sameValue($Object_getPrototypeOf(C?.["constructor"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(C?.["constructor"]), ['length', 'name'], C?.["constructor"]);
