...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'accessPrivateField', 'field'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["accessPrivateField"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["accessPrivateField"]), true);
$assert.callable(C?.["accessPrivateField"]);
$assert.notConstructable(C?.["accessPrivateField"]);
$assert.compareArray($Reflect_ownKeys(C?.["accessPrivateField"]), ['length', 'name'], C?.["accessPrivateField"]);
$verifyProperty(C?.["accessPrivateField"], "name", {
  value: "accessPrivateField",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["accessPrivateField"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "accessPrivateField", {
  writable: true,
  enumerable: false,
  configurable: true,
});
