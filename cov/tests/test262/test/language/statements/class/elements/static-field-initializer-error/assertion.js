...
$assert.sameValue($Object_getPrototypeOf(globalThis["initThrows"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["initThrows"]), true);
$assert.callable(globalThis["initThrows"]);
$assert.constructable(globalThis["initThrows"]);
$assert.compareArray($Reflect_ownKeys(globalThis["initThrows"]), ['length', 'name', 'prototype'], globalThis["initThrows"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["initThrows"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["initThrows"]?.["prototype"]), true);
$assert.notCallable(globalThis["initThrows"]?.["prototype"]);
$assert.notConstructable(globalThis["initThrows"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["initThrows"]?.["prototype"]), ['constructor'], globalThis["initThrows"]?.["prototype"]);
$assert.sameValue(globalThis["initThrows"]?.["prototype"]?.["constructor"], globalThis["initThrows"]);
$verifyProperty(globalThis["initThrows"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["initThrows"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["initThrows"], "name", {
  value: "initThrows",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["initThrows"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
