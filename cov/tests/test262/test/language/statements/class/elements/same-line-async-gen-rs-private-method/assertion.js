...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])), ['constructor', '$', '_', 'o', '℘', 'ZW_‌_NJ', 'ZW_‍_J', 'm'], $Object_getPrototypeOf(globalThis["c"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["m"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["m"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c"])?.["m"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["m"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["m"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["c"])?.["m"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["m"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c"])?.["m"]?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["c"])?.["m"]?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["c"])?.["m"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["m"]?.["prototype"]), [], $Object_getPrototypeOf(globalThis["c"])?.["m"]?.["prototype"]);
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["m"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["m"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["m"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
