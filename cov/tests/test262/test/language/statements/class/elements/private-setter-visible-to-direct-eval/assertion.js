...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'setWithEval'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["setWithEval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["setWithEval"]), true);
$assert.callable(C?.["prototype"]?.["setWithEval"]);
$assert.notConstructable(C?.["prototype"]?.["setWithEval"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["setWithEval"]), ['length', 'name'], C?.["prototype"]?.["setWithEval"]);
$verifyProperty(C?.["prototype"]?.["setWithEval"], "name", {
  value: "setWithEval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["setWithEval"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "setWithEval", {
  writable: true,
  enumerable: false,
  configurable: true,
});
