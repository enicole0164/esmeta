...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'access'], C);
$assert.sameValue($Object_getPrototypeOf(C?.["access"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["access"]), true);
$assert.callable(C?.["access"]);
$assert.notConstructable(C?.["access"]);
$assert.compareArray($Reflect_ownKeys(C?.["access"]), ['length', 'name'], C?.["access"]);
$verifyProperty(C?.["access"], "name", {
  value: "access",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["access"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "access", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'instanceAccess'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["instanceAccess"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["instanceAccess"]), true);
$assert.callable(C?.["prototype"]?.["instanceAccess"]);
$assert.notConstructable(C?.["prototype"]?.["instanceAccess"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["instanceAccess"]), ['length', 'name'], C?.["prototype"]?.["instanceAccess"]);
$verifyProperty(C?.["prototype"]?.["instanceAccess"], "name", {
  value: "instanceAccess",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["instanceAccess"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "instanceAccess", {
  writable: true,
  enumerable: false,
  configurable: true,
});
