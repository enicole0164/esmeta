...
$assert.sameValue($Object_getPrototypeOf(globalThis["Inner"]), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["Inner"]?.["prototype"]), Object.prototype);
...
$assert.sameValue($Object_getPrototypeOf(Outer), Function.prototype);
$assert.sameValue(Object.isExtensible(Outer), true);
$assert.callable(Outer);
$assert.constructable(Outer);
$assert.compareArray($Reflect_ownKeys(Outer), ['length', 'name', 'prototype'], Outer);
$assert.sameValue($Object_getPrototypeOf(Outer?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Outer?.["prototype"]), true);
$assert.notCallable(Outer?.["prototype"]);
$assert.notConstructable(Outer?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Outer?.["prototype"]), ['constructor', 'innerclass'], Outer?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Outer?.["prototype"]?.["innerclass"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Outer?.["prototype"]?.["innerclass"]), true);
$assert.callable(Outer?.["prototype"]?.["innerclass"]);
$assert.notConstructable(Outer?.["prototype"]?.["innerclass"]);
$assert.compareArray($Reflect_ownKeys(Outer?.["prototype"]?.["innerclass"]), ['length', 'name'], Outer?.["prototype"]?.["innerclass"]);
$verifyProperty(Outer?.["prototype"]?.["innerclass"], "name", {
  value: "innerclass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Outer?.["prototype"]?.["innerclass"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Outer?.["prototype"], "innerclass", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Outer?.["prototype"]?.["constructor"], Outer);
$verifyProperty(Outer?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Outer, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Outer, "name", {
  value: "Outer",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Outer, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
