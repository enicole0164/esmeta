...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c1"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c1"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["c1"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["c1"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c1"])), ['constructor'], $Object_getPrototypeOf(globalThis["c1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c1"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c1"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c1"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["c1"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c1"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["c1"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["c1"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["c1"]));
$verifyProperty($Object_getPrototypeOf(globalThis["c1"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c1"])?.["constructor"], "name", {
  value: "C1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c1"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c1"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c2"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c2"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["c2"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["c2"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c2"])), ['constructor'], $Object_getPrototypeOf(globalThis["c2"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c2"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["c2"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["c2"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["c2"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c2"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["c2"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["c2"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["c2"]));
$verifyProperty($Object_getPrototypeOf(globalThis["c2"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c2"])?.["constructor"], "name", {
  value: "C2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c2"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c2"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(C1, $Object_getPrototypeOf(globalThis["c1"])?.["constructor"]);
$assert.sameValue(C2, $Object_getPrototypeOf(globalThis["c2"])?.["constructor"]);
