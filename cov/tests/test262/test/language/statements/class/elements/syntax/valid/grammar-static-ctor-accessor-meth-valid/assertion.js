...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'constructor'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "constructor")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "constructor")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "constructor")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "constructor")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "constructor")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "constructor")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "constructor")?.get, "name", {
  value: "get constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "constructor")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "constructor")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "constructor")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "constructor")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "constructor")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "constructor")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "constructor")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "constructor")?.set, "name", {
  value: "set constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "constructor")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "constructor", {
  enumerable: false,
  configurable: true,
});
