...
$assert.sameValue($Object_getPrototypeOf(globalThis["abruptCompletion"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["abruptCompletion"]), true);
$assert.callable(globalThis["abruptCompletion"]);
$assert.constructable(globalThis["abruptCompletion"]);
$assert.compareArray($Reflect_ownKeys(globalThis["abruptCompletion"]), ['length', 'name', 'prototype'], globalThis["abruptCompletion"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["abruptCompletion"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["abruptCompletion"]?.["prototype"]), true);
$assert.notCallable(globalThis["abruptCompletion"]?.["prototype"]);
$assert.notConstructable(globalThis["abruptCompletion"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["abruptCompletion"]?.["prototype"]), ['constructor'], globalThis["abruptCompletion"]?.["prototype"]);
$assert.sameValue(globalThis["abruptCompletion"]?.["prototype"]?.["constructor"], globalThis["abruptCompletion"]);
$verifyProperty(globalThis["abruptCompletion"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["abruptCompletion"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["abruptCompletion"], "name", {
  value: "abruptCompletion",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["abruptCompletion"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["sideEffect"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sideEffect"]), true);
$assert.callable(globalThis["sideEffect"]);
$assert.constructable(globalThis["sideEffect"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sideEffect"]), ['length', 'name', 'prototype'], globalThis["sideEffect"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["sideEffect"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["sideEffect"]?.["prototype"]), true);
$assert.notCallable(globalThis["sideEffect"]?.["prototype"]);
$assert.notConstructable(globalThis["sideEffect"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sideEffect"]?.["prototype"]), ['constructor'], globalThis["sideEffect"]?.["prototype"]);
$assert.sameValue(globalThis["sideEffect"]?.["prototype"]?.["constructor"], globalThis["sideEffect"]);
$verifyProperty(globalThis["sideEffect"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sideEffect"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sideEffect"], "name", {
  value: "sideEffect",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["sideEffect"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
