...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'getWithEval'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["getWithEval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["getWithEval"]), true);
$assert.callable(C?.["prototype"]?.["getWithEval"]);
$assert.notConstructable(C?.["prototype"]?.["getWithEval"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["getWithEval"]), ['length', 'name'], C?.["prototype"]?.["getWithEval"]);
$verifyProperty(C?.["prototype"]?.["getWithEval"], "name", {
  value: "getWithEval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["getWithEval"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "getWithEval", {
  writable: true,
  enumerable: false,
  configurable: true,
});
