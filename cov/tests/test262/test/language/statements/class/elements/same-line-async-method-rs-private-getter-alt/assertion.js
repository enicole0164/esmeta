...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["m"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["m"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["c"])?.["m"]);
