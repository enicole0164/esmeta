...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'do'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["do"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["do"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["do"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["do"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["do"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["do"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["do"], "name", {
  value: "do",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["do"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "do", {
  writable: true,
  enumerable: false,
  configurable: true,
});
