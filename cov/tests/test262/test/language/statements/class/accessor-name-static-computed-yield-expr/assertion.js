...
$assert.compareArray($Reflect_ownKeys(globalThis["C"]), ['length', 'name', 'prototype', 'first', 'second'], globalThis["C"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get, "name", {
  value: "get first",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "first")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "first", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set, "name", {
  value: "set second",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C"], "second")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C"], "second", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
