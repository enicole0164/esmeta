...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'catch'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["catch"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["catch"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["catch"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["catch"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["catch"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["catch"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["catch"], "name", {
  value: "catch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["catch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "catch", {
  writable: true,
  enumerable: false,
  configurable: true,
});
