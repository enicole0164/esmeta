...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'if'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["if"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["if"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["if"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["if"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["if"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["if"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["if"], "name", {
  value: "if",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["if"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "if", {
  writable: true,
  enumerable: false,
  configurable: true,
});
