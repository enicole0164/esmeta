...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'else'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["else"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["else"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["else"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["else"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["else"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["else"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["else"], "name", {
  value: "else",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["else"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "else", {
  writable: true,
  enumerable: false,
  configurable: true,
});
