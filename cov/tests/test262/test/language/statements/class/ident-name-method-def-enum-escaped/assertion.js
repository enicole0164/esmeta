...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'enum'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["enum"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["enum"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["enum"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["enum"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["enum"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["enum"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["enum"], "name", {
  value: "enum",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["enum"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "enum", {
  writable: true,
  enumerable: false,
  configurable: true,
});
