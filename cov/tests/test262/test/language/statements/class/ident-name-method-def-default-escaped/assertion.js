...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'default'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["default"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["default"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["default"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["default"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["default"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["default"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["default"], "name", {
  value: "default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["default"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "default", {
  writable: true,
  enumerable: false,
  configurable: true,
});
