...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["D"])), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["D"])), true);
$assert.callable($Object_getPrototypeOf(globalThis["D"]));
$assert.constructable($Object_getPrototypeOf(globalThis["D"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["D"])), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["D"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["D"])?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["D"])?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["D"])?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["D"])?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["D"])?.["prototype"]), ['constructor'], $Object_getPrototypeOf(globalThis["D"])?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["D"])?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["D"]));
$verifyProperty($Object_getPrototypeOf(globalThis["D"])?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["D"]), "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["D"]), "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["D"]), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.callable(globalThis["D"]);
$assert.constructable(globalThis["D"]);
$assert.compareArray($Reflect_ownKeys(globalThis["D"]), ['length', 'name', 'prototype'], globalThis["D"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["D"]?.["prototype"]), $Object_getPrototypeOf(globalThis["D"])?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["D"]?.["prototype"]), true);
$assert.notCallable(globalThis["D"]?.["prototype"]);
$assert.notConstructable(globalThis["D"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["D"]?.["prototype"]), ['constructor'], globalThis["D"]?.["prototype"]);
$assert.sameValue(globalThis["D"]?.["prototype"]?.["constructor"], globalThis["D"]);
$verifyProperty(globalThis["D"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["D"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["D"], "name", {
  value: "D",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["D"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
