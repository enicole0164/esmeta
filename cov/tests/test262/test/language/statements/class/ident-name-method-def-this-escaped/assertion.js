...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'this'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["this"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["this"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["this"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["this"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["this"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["this"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["this"], "name", {
  value: "this",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["this"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
