...
$assert.sameValue($Object_getPrototypeOf(globalThis["ref"]), AsyncFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["ref"]), ['length', 'name'], globalThis["ref"]);
