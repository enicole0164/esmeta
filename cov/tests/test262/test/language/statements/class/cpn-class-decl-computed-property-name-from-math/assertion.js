...
$assert.sameValue($Object_getPrototypeOf(C?.["2.999232"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["2.999232"]), true);
$assert.callable(C?.["2.999232"]);
$assert.notConstructable(C?.["2.999232"]);
$assert.compareArray($Reflect_ownKeys(C?.["2.999232"]), ['length', 'name'], C?.["2.999232"]);
$verifyProperty(C?.["2.999232"], "name", {
  value: "2.999232",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["2.999232"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["2.999232"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["2.999232"]), true);
$assert.callable(C?.["prototype"]?.["2.999232"]);
$assert.notConstructable(C?.["prototype"]?.["2.999232"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["2.999232"]), ['length', 'name'], C?.["prototype"]?.["2.999232"]);
$verifyProperty(C?.["prototype"]?.["2.999232"], "name", {
  value: "2.999232",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["2.999232"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
