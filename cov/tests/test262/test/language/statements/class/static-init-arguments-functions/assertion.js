...
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncFn"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["asyncFn"]), true);
$assert.notCallable(globalThis["asyncFn"]);
$assert.notConstructable(globalThis["asyncFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["asyncFn"]), ['0', 'length', 'callee', Symbol.iterator], globalThis["asyncFn"]);
$assert.sameValue(globalThis["asyncFn"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["asyncFn"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["asyncFn"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["asyncFn"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["asyncFn"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["asyncFn"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncFn"], "0", {
  value: "async function",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["asyncFnParam"], globalThis["asyncFn"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fn"]), true);
$assert.notCallable(globalThis["fn"]);
$assert.notConstructable(globalThis["fn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]), ['0', 'length', 'callee', Symbol.iterator], globalThis["fn"]);
$assert.sameValue(globalThis["fn"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["fn"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["fn"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["fn"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["fn"], "callee", {
  enumerable: false,
  configurable: false,
});
...
$verifyProperty(globalThis["fn"], "0", {
  value: "function",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["fnParam"], globalThis["fn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gen"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gen"]), true);
$assert.notCallable(globalThis["gen"]);
$assert.notConstructable(globalThis["gen"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gen"]), ['0', 'length', 'callee', Symbol.iterator], globalThis["gen"]);
$assert.sameValue(globalThis["gen"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["gen"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["gen"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["gen"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["gen"], "callee", {
  enumerable: false,
  configurable: false,
});
...
$verifyProperty(globalThis["gen"], "0", {
  value: "generator function",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["genParam"], globalThis["gen"]);
