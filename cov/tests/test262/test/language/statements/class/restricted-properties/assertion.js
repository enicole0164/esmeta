...
$assert.sameValue($Object_getPrototypeOf(BaseClass), Function.prototype);
$assert.sameValue(Object.isExtensible(BaseClass), true);
$assert.callable(BaseClass);
$assert.constructable(BaseClass);
$assert.compareArray($Reflect_ownKeys(BaseClass), ['length', 'name', 'prototype'], BaseClass);
$assert.sameValue($Object_getPrototypeOf(BaseClass?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(BaseClass?.["prototype"]), true);
$assert.notCallable(BaseClass?.["prototype"]);
$assert.notConstructable(BaseClass?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(BaseClass?.["prototype"]), ['constructor'], BaseClass?.["prototype"]);
$assert.sameValue(BaseClass?.["prototype"]?.["constructor"], BaseClass);
$verifyProperty(BaseClass?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(BaseClass, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(BaseClass, "name", {
  value: "BaseClass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(BaseClass, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(SubClass), BaseClass);
...
$assert.sameValue($Object_getPrototypeOf(SubClass?.["prototype"]), BaseClass?.["prototype"]);
