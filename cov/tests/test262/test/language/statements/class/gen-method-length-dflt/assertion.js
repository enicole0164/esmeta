...
$assert.sameValue($Object_getPrototypeOf(globalThis["m1"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m1"]), true);
$assert.callable(globalThis["m1"]);
$assert.notConstructable(globalThis["m1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m1"]), ['name', 'prototype'], globalThis["m1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m1"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m1"]?.["prototype"]), true);
$assert.notCallable(globalThis["m1"]?.["prototype"]);
$assert.notConstructable(globalThis["m1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m1"]?.["prototype"]), [], globalThis["m1"]?.["prototype"]);
$verifyProperty(globalThis["m1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["m1"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["m2"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m2"]), true);
$assert.callable(globalThis["m2"]);
$assert.notConstructable(globalThis["m2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m2"]), ['name', 'prototype'], globalThis["m2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m2"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m2"]?.["prototype"]), true);
$assert.notCallable(globalThis["m2"]?.["prototype"]);
$assert.notConstructable(globalThis["m2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m2"]?.["prototype"]), [], globalThis["m2"]?.["prototype"]);
$verifyProperty(globalThis["m2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["m2"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["m3"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m3"]), true);
$assert.callable(globalThis["m3"]);
$assert.notConstructable(globalThis["m3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m3"]), ['name', 'prototype'], globalThis["m3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m3"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m3"]?.["prototype"]), true);
$assert.notCallable(globalThis["m3"]?.["prototype"]);
$assert.notConstructable(globalThis["m3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m3"]?.["prototype"]), [], globalThis["m3"]?.["prototype"]);
$verifyProperty(globalThis["m3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["m3"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["m4"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m4"]), true);
$assert.callable(globalThis["m4"]);
$assert.notConstructable(globalThis["m4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m4"]), ['name', 'prototype'], globalThis["m4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["m4"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m4"]?.["prototype"]), true);
$assert.notCallable(globalThis["m4"]?.["prototype"]);
$assert.notConstructable(globalThis["m4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m4"]?.["prototype"]), [], globalThis["m4"]?.["prototype"]);
$verifyProperty(globalThis["m4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["m4"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C1), ['length', 'name', 'prototype'], C1);
...
$assert.compareArray($Reflect_ownKeys(C1?.["prototype"]), ['constructor', 'm'], C1?.["prototype"]);
$assert.sameValue(C1?.["prototype"]?.["m"], globalThis["m1"]);
$verifyProperty(C1?.["prototype"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C2), ['length', 'name', 'prototype'], C2);
...
$assert.compareArray($Reflect_ownKeys(C2?.["prototype"]), ['constructor', 'm'], C2?.["prototype"]);
$assert.sameValue(C2?.["prototype"]?.["m"], globalThis["m2"]);
$verifyProperty(C2?.["prototype"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(C3), Function.prototype);
$assert.sameValue(Object.isExtensible(C3), true);
$assert.callable(C3);
$assert.constructable(C3);
$assert.compareArray($Reflect_ownKeys(C3), ['length', 'name', 'prototype'], C3);
$assert.sameValue($Object_getPrototypeOf(C3?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(C3?.["prototype"]), true);
$assert.notCallable(C3?.["prototype"]);
$assert.notConstructable(C3?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C3?.["prototype"]), ['constructor', 'm'], C3?.["prototype"]);
$assert.sameValue(C3?.["prototype"]?.["m"], globalThis["m3"]);
$verifyProperty(C3?.["prototype"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(C3?.["prototype"]?.["constructor"], C3);
$verifyProperty(C3?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C3, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C3, "name", {
  value: "C3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C3, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(C4), Function.prototype);
$assert.sameValue(Object.isExtensible(C4), true);
$assert.callable(C4);
$assert.constructable(C4);
$assert.compareArray($Reflect_ownKeys(C4), ['length', 'name', 'prototype'], C4);
$assert.sameValue($Object_getPrototypeOf(C4?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(C4?.["prototype"]), true);
$assert.notCallable(C4?.["prototype"]);
$assert.notConstructable(C4?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C4?.["prototype"]), ['constructor', 'm'], C4?.["prototype"]);
$assert.sameValue(C4?.["prototype"]?.["m"], globalThis["m4"]);
$verifyProperty(C4?.["prototype"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(C4?.["prototype"]?.["constructor"], C4);
$verifyProperty(C4?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C4, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C4, "name", {
  value: "C4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C4, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
