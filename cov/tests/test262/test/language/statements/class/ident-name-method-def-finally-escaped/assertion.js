...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'finally'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["finally"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["finally"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["finally"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["finally"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["finally"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["finally"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["finally"], "name", {
  value: "finally",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["finally"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "finally", {
  writable: true,
  enumerable: false,
  configurable: true,
});
