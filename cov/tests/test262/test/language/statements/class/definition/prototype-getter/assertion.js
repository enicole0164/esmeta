...
$assert.sameValue($Object_getPrototypeOf(globalThis["Base"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Base"]), true);
$assert.callable(globalThis["Base"]);
$assert.constructable(globalThis["Base"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Base"]), ['length', 'name', 'prototype'], globalThis["Base"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Base"], "prototype", {
  set: undefined,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Base"], "name", {
  value: "bound ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Base"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C), globalThis["Base"]);
