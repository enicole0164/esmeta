...
$assert.sameValue($Object_getPrototypeOf(globalThis["assertAccessorDescriptor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assertAccessorDescriptor"]), true);
$assert.callable(globalThis["assertAccessorDescriptor"]);
$assert.constructable(globalThis["assertAccessorDescriptor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assertAccessorDescriptor"]), ['length', 'name', 'prototype'], globalThis["assertAccessorDescriptor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assertAccessorDescriptor"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assertAccessorDescriptor"]?.["prototype"]), true);
$assert.notCallable(globalThis["assertAccessorDescriptor"]?.["prototype"]);
$assert.notConstructable(globalThis["assertAccessorDescriptor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assertAccessorDescriptor"]?.["prototype"]), ['constructor'], globalThis["assertAccessorDescriptor"]?.["prototype"]);
$assert.sameValue(globalThis["assertAccessorDescriptor"]?.["prototype"]?.["constructor"], globalThis["assertAccessorDescriptor"]);
$verifyProperty(globalThis["assertAccessorDescriptor"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assertAccessorDescriptor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assertAccessorDescriptor"], "name", {
  value: "assertAccessorDescriptor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assertAccessorDescriptor"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])), ['constructor', 'x'], $Object_getPrototypeOf(globalThis["c"]));
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get, "name", {
  value: "get x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set, "name", {
  value: "set x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"]), "x")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"]), "x", {
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["c"])?.["constructor"]), ['length', 'name', 'prototype', 'staticX', '_x'], $Object_getPrototypeOf(globalThis["c"])?.["constructor"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get, "name", {
  value: "get staticX",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set, "name", {
  value: "set staticX",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "staticX", {
  enumerable: false,
  configurable: true,
});
...
$verifyProperty($Object_getPrototypeOf(globalThis["c"])?.["constructor"], "_x", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["c"]), ['_x'], globalThis["c"]);
$verifyProperty(globalThis["c"], "_x", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
