...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["eval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["eval"]), true);
$assert.callable(C?.["prototype"]?.["eval"]);
$assert.notConstructable(C?.["prototype"]?.["eval"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["eval"]), ['length', 'name'], C?.["prototype"]?.["eval"]);
$verifyProperty(C?.["prototype"]?.["eval"], "name", {
  value: "eval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["eval"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["arguments"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["arguments"]), true);
$assert.callable(C?.["prototype"]?.["arguments"]);
$assert.notConstructable(C?.["prototype"]?.["arguments"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["arguments"]), ['length', 'name'], C?.["prototype"]?.["arguments"]);
$verifyProperty(C?.["prototype"]?.["arguments"], "name", {
  value: "arguments",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["arguments"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["arguments"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["arguments"]), true);
$assert.callable(C?.["arguments"]);
$assert.notConstructable(C?.["arguments"]);
$assert.compareArray($Reflect_ownKeys(C?.["arguments"]), ['length', 'name'], C?.["arguments"]);
$verifyProperty(C?.["arguments"], "name", {
  value: "arguments",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["arguments"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["eval"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["eval"]), true);
$assert.callable(C?.["eval"]);
$assert.notConstructable(C?.["eval"]);
$assert.compareArray($Reflect_ownKeys(C?.["eval"]), ['length', 'name'], C?.["eval"]);
$verifyProperty(C?.["eval"], "name", {
  value: "eval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["eval"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
