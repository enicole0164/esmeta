...
$assert.sameValue(globalThis["x"], 4.0);
...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'eval', 'arguments'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'eval', 'arguments'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set, "name", {
  value: "set eval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "eval")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "eval", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set, "name", {
  value: "set arguments",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "arguments")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "arguments", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "arguments")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "arguments")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "arguments")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "arguments")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "arguments")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "arguments")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "arguments")?.set, "name", {
  value: "set arguments",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "arguments")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "arguments", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "eval")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "eval")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "eval")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "eval")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "eval")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "eval")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "eval")?.set, "name", {
  value: "set eval",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "eval")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "eval", {
  get: undefined,
  enumerable: false,
  configurable: true,
});
