...
$assert.sameValue($Object_getPrototypeOf(globalThis["B"]?.["prototype"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["B"]?.["prototype"]), ['constructor', 'm'], globalThis["B"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set, "name", {
  value: "set m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["B"]?.["prototype"], "m")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["B"]?.["prototype"], "m", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(C), globalThis["B"]);
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]), globalThis["B"]?.["prototype"]);
