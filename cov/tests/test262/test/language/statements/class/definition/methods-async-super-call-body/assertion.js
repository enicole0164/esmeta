...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))), ['constructor', 'method'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"]);
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"]), ['length', 'name'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"]);
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])), "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"], "name", {
  value: "A",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["child"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["child"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["child"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["child"])), ['constructor', 'method'], $Object_getPrototypeOf(globalThis["child"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])?.["method"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["child"])?.["method"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["child"])?.["method"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["child"])?.["method"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["child"])?.["method"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["child"])?.["method"]);
$verifyProperty($Object_getPrototypeOf(globalThis["child"])?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["child"])?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["child"]), "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["child"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["child"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["child"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["child"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["child"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["child"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["child"]));
$verifyProperty($Object_getPrototypeOf(globalThis["child"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["child"])?.["constructor"], "name", {
  value: "B",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["child"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["child"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(A, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["child"]))?.["constructor"]);
$assert.sameValue(B, $Object_getPrototypeOf(globalThis["child"])?.["constructor"]);
