...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['constructor', 'g'], A?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g"]), true);
$assert.callable(A?.["prototype"]?.["g"]);
$assert.notConstructable(A?.["prototype"]?.["g"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["g"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["g"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["g"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g"]?.["prototype"]), [], A?.["prototype"]?.["g"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["g"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["g"], "name", {
  value: "g",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["g"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "g", {
  writable: true,
  enumerable: false,
  configurable: true,
});
