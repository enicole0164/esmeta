...
$assert.sameValue($Object_getPrototypeOf(globalThis["setter"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["setter"]), true);
$assert.callable(globalThis["setter"]);
$assert.notConstructable(globalThis["setter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["setter"]), ['length'], globalThis["setter"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(A, "id")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(A, "id")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(A, "id")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(A, "id")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(A, "id")?.set), ['length'], Object.getOwnPropertyDescriptor(A, "id")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(A, "id")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set), ['length'], Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
