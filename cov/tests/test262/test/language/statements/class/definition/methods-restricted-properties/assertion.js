...
$assert.sameValue($Object_getPrototypeOf(globalThis["accessor"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["accessor"]), true);
$assert.notCallable(globalThis["accessor"]);
$assert.notConstructable(globalThis["accessor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["accessor"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["accessor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["accessor"]?.["get"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["accessor"]?.["get"]), true);
$assert.callable(globalThis["accessor"]?.["get"]);
$assert.notConstructable(globalThis["accessor"]?.["get"]);
$assert.compareArray($Reflect_ownKeys(globalThis["accessor"]?.["get"]), ['length', 'name'], globalThis["accessor"]?.["get"]);
$verifyProperty(globalThis["accessor"]?.["get"], "name", {
  value: "get accessor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["accessor"]?.["get"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["accessor"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["accessor"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["accessor"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["accessor"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["accessor"]?.["set"]), true);
$assert.callable(globalThis["accessor"]?.["set"]);
$assert.notConstructable(globalThis["accessor"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["accessor"]?.["set"]), ['length', 'name'], globalThis["accessor"]?.["set"]);
$verifyProperty(globalThis["accessor"]?.["set"], "name", {
  value: "set accessor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["accessor"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["accessor"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["instance"])), ['constructor', 'method', 'accessor'], $Object_getPrototypeOf(globalThis["instance"]));
...
$assert.sameValue(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["instance"]), "accessor")?.get, globalThis["accessor"]?.["get"]);
$assert.sameValue(Object.getOwnPropertyDescriptor($Object_getPrototypeOf(globalThis["instance"]), "accessor")?.set, globalThis["accessor"]?.["set"]);
...
$assert.sameValue(Class, $Object_getPrototypeOf(globalThis["instance"])?.["constructor"]);
