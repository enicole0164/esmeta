...
$assert.sameValue($Object_getPrototypeOf(Foo), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(Foo?.["prototype"]), Object.prototype);
...
$assert.sameValue($Object_getPrototypeOf(Foo?.["prototype"]?.["method"]), AsyncFunction.prototype);
