...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "prototype")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
