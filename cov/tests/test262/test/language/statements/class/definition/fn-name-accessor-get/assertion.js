...
$assert.sameValue($Object_getPrototypeOf(globalThis["getter"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getter"]), true);
$assert.callable(globalThis["getter"]);
$assert.notConstructable(globalThis["getter"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getter"]), ['length'], globalThis["getter"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(A, "id")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(A, "id")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(A, "id")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(A, "id")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(A, "id")?.get), ['length'], Object.getOwnPropertyDescriptor(A, "id")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(A, "id")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get), ['length'], Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(A?.["prototype"], "id")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
