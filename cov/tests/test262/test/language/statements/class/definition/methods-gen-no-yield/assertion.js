...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['constructor', 'foo'], A?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["foo"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["foo"]), true);
$assert.callable(A?.["prototype"]?.["foo"]);
$assert.notConstructable(A?.["prototype"]?.["foo"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["foo"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["foo"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["foo"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["foo"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["foo"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["foo"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["foo"]?.["prototype"]), [], A?.["prototype"]?.["foo"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["foo"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["foo"], "name", {
  value: "foo",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["foo"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "foo", {
  writable: true,
  enumerable: false,
  configurable: true,
});
