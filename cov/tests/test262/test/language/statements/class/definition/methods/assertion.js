...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'staticMethod', 'staticMethod2'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'method', 'method2'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["method2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["method2"]), true);
$assert.callable(C?.["prototype"]?.["method2"]);
$assert.notConstructable(C?.["prototype"]?.["method2"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["method2"]), ['length', 'name'], C?.["prototype"]?.["method2"]);
$verifyProperty(C?.["prototype"]?.["method2"], "name", {
  value: "method2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["method2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "method2", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["method"]), true);
$assert.callable(C?.["prototype"]?.["method"]);
$assert.notConstructable(C?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["method"]), ['length', 'name'], C?.["prototype"]?.["method"]);
$verifyProperty(C?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["staticMethod2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["staticMethod2"]), true);
$assert.callable(C?.["staticMethod2"]);
$assert.notConstructable(C?.["staticMethod2"]);
$assert.compareArray($Reflect_ownKeys(C?.["staticMethod2"]), ['length', 'name'], C?.["staticMethod2"]);
$verifyProperty(C?.["staticMethod2"], "name", {
  value: "staticMethod2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["staticMethod2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "staticMethod2", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(C?.["staticMethod"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["staticMethod"]), true);
$assert.callable(C?.["staticMethod"]);
$assert.notConstructable(C?.["staticMethod"]);
$assert.compareArray($Reflect_ownKeys(C?.["staticMethod"]), ['length', 'name'], C?.["staticMethod"]);
$verifyProperty(C?.["staticMethod"], "name", {
  value: "staticMethod",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["staticMethod"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "staticMethod", {
  writable: true,
  enumerable: false,
  configurable: true,
});
