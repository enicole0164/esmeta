...
$assert.sameValue($Object_getPrototypeOf(globalThis["b"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["b"]), ['prp'], globalThis["b"]);
$verifyProperty(globalThis["b"], "prp", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["s"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["s"]), ['prp'], globalThis["s"]);
$verifyProperty(globalThis["s"], "prp", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["s2"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["s2"]), ['prp'], globalThis["s2"]);
$verifyProperty(globalThis["s2"], "prp", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["s3"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["s3"]), true);
$assert.notCallable(globalThis["s3"]);
$assert.notConstructable(globalThis["s3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["s3"]), ['prp'], globalThis["s3"]);
$verifyProperty(globalThis["s3"], "prp", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(BadSubclass)), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(BadSubclass)), true);
$assert.callable($Object_getPrototypeOf(BadSubclass));
$assert.constructable($Object_getPrototypeOf(BadSubclass));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(BadSubclass)), ['length', 'name', 'prototype'], $Object_getPrototypeOf(BadSubclass));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(BadSubclass)?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(BadSubclass)?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(BadSubclass)?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(BadSubclass)?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(BadSubclass)?.["prototype"]), ['constructor'], $Object_getPrototypeOf(BadSubclass)?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(BadSubclass)?.["prototype"]?.["constructor"], $Object_getPrototypeOf(BadSubclass));
$verifyProperty($Object_getPrototypeOf(BadSubclass)?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(BadSubclass), "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(BadSubclass), "name", {
  value: "Base",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(BadSubclass), "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(BadSubclass), true);
$assert.callable(BadSubclass);
$assert.constructable(BadSubclass);
$assert.compareArray($Reflect_ownKeys(BadSubclass), ['length', 'name', 'prototype'], BadSubclass);
$assert.sameValue($Object_getPrototypeOf(BadSubclass?.["prototype"]), $Object_getPrototypeOf(BadSubclass)?.["prototype"]);
$assert.sameValue(Object.isExtensible(BadSubclass?.["prototype"]), true);
$assert.notCallable(BadSubclass?.["prototype"]);
$assert.notConstructable(BadSubclass?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(BadSubclass?.["prototype"]), ['constructor'], BadSubclass?.["prototype"]);
$assert.sameValue(BadSubclass?.["prototype"]?.["constructor"], BadSubclass);
$verifyProperty(BadSubclass?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(BadSubclass, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(BadSubclass, "name", {
  value: "BadSubclass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(BadSubclass, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Base, $Object_getPrototypeOf(BadSubclass));
$assert.sameValue($Object_getPrototypeOf(Subclass), $Object_getPrototypeOf(BadSubclass));
$assert.sameValue(Object.isExtensible(Subclass), true);
$assert.callable(Subclass);
$assert.constructable(Subclass);
$assert.compareArray($Reflect_ownKeys(Subclass), ['length', 'name', 'prototype'], Subclass);
$assert.sameValue($Object_getPrototypeOf(Subclass?.["prototype"]), $Object_getPrototypeOf(BadSubclass)?.["prototype"]);
$assert.sameValue(Object.isExtensible(Subclass?.["prototype"]), true);
$assert.notCallable(Subclass?.["prototype"]);
$assert.notConstructable(Subclass?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Subclass?.["prototype"]), ['constructor'], Subclass?.["prototype"]);
$assert.sameValue(Subclass?.["prototype"]?.["constructor"], Subclass);
$verifyProperty(Subclass?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Subclass, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Subclass, "name", {
  value: "Subclass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Subclass, "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Subclass2), $Object_getPrototypeOf(BadSubclass));
$assert.sameValue(Object.isExtensible(Subclass2), true);
$assert.callable(Subclass2);
$assert.constructable(Subclass2);
$assert.compareArray($Reflect_ownKeys(Subclass2), ['length', 'name', 'prototype'], Subclass2);
$assert.sameValue($Object_getPrototypeOf(Subclass2?.["prototype"]), $Object_getPrototypeOf(BadSubclass)?.["prototype"]);
$assert.sameValue(Object.isExtensible(Subclass2?.["prototype"]), true);
$assert.notCallable(Subclass2?.["prototype"]);
$assert.notConstructable(Subclass2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Subclass2?.["prototype"]), ['constructor'], Subclass2?.["prototype"]);
$assert.sameValue(Subclass2?.["prototype"]?.["constructor"], Subclass2);
$verifyProperty(Subclass2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Subclass2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Subclass2, "name", {
  value: "Subclass2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Subclass2, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
