...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['constructor', 'yield'], A?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["yield"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["yield"]), true);
$assert.callable(A?.["prototype"]?.["yield"]);
$assert.notConstructable(A?.["prototype"]?.["yield"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["yield"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["yield"]);
$assert.sameValue(A?.["prototype"]?.["yield"]?.["prototype"], $Object_getPrototypeOf(globalThis["iter"]));
$verifyProperty(A?.["prototype"]?.["yield"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["yield"], "name", {
  value: "yield",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["yield"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "yield", {
  writable: true,
  enumerable: false,
  configurable: true,
});
