...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"], "name", {
  value: "Base",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["s"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["s"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["s"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["s"])), ['constructor'], $Object_getPrototypeOf(globalThis["s"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["s"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["s"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["s"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["s"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["s"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["s"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["s"]));
$verifyProperty($Object_getPrototypeOf(globalThis["s"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["s"])?.["constructor"], "name", {
  value: "Subclass",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["s"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["s"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["s"]), ['foobar'], globalThis["s"]);
$verifyProperty(globalThis["s"], "foobar", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["s1"]), $Object_getPrototypeOf(globalThis["s"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["s1"]), ['foobar'], globalThis["s1"]);
$verifyProperty(globalThis["s1"], "foobar", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["s2"]), $Object_getPrototypeOf(globalThis["s"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["s2"]), ['foobar'], globalThis["s2"]);
$verifyProperty(globalThis["s2"], "foobar", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["ss2"])), $Object_getPrototypeOf(globalThis["s"]));
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["ss2"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["ss2"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["ss2"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["ss2"])), ['constructor'], $Object_getPrototypeOf(globalThis["ss2"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]), $Object_getPrototypeOf(globalThis["s"])?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["ss2"]));
$verifyProperty($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"], "name", {
  value: "Subclass2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["ss2"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["ss2"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["ss2"]), true);
$assert.notCallable(globalThis["ss2"]);
$assert.notConstructable(globalThis["ss2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ss2"]), ['foobar'], globalThis["ss2"]);
$verifyProperty(globalThis["ss2"], "foobar", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["ss3"])), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])));
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["ss3"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["ss3"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["ss3"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["ss3"])), ['constructor'], $Object_getPrototypeOf(globalThis["ss3"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["ss3"]));
$verifyProperty($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"], "name", {
  value: "Subclass3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["ss3"])?.["constructor"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["ss3"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["ss3"]), true);
$assert.notCallable(globalThis["ss3"]);
$assert.notConstructable(globalThis["ss3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ss3"]), ['foobar'], globalThis["ss3"]);
$verifyProperty(globalThis["ss3"], "foobar", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Base, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"]))?.["constructor"]);
$assert.sameValue(Subclass, $Object_getPrototypeOf(globalThis["s"])?.["constructor"]);
$assert.sameValue(Subclass2, $Object_getPrototypeOf(globalThis["ss2"])?.["constructor"]);
$assert.sameValue(Subclass3, $Object_getPrototypeOf(globalThis["ss3"])?.["constructor"]);
