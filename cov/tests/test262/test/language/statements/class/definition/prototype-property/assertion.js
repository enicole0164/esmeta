...
$assert.sameValue($Object_getPrototypeOf(globalThis["descr"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descr"]), true);
$assert.notCallable(globalThis["descr"]);
$assert.notConstructable(globalThis["descr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descr"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["descr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descr"]?.["value"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descr"]?.["value"]), true);
$assert.notCallable(globalThis["descr"]?.["value"]);
$assert.notConstructable(globalThis["descr"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descr"]?.["value"]), ['constructor'], globalThis["descr"]?.["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["descr"]?.["value"]?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descr"]?.["value"]?.["constructor"]), true);
$assert.callable(globalThis["descr"]?.["value"]?.["constructor"]);
$assert.constructable(globalThis["descr"]?.["value"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descr"]?.["value"]?.["constructor"]), ['length', 'name', 'prototype'], globalThis["descr"]?.["value"]?.["constructor"]);
$assert.sameValue(globalThis["descr"]?.["value"]?.["constructor"]?.["prototype"], globalThis["descr"]?.["value"]);
$verifyProperty(globalThis["descr"]?.["value"]?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["descr"]?.["value"]?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descr"]?.["value"]?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descr"]?.["value"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["descr"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descr"], "writable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descr"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descr"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(C, globalThis["descr"]?.["value"]?.["constructor"]);
