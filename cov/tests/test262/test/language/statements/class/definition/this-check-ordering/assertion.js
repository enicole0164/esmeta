...
$assert.sameValue(globalThis["baseCalled"], 1.0);
...
$assert.sameValue(globalThis["fCalled"], 1.0);
...
$assert.sameValue($Object_getPrototypeOf(Subclass1), Base);
$assert.sameValue(Object.isExtensible(Subclass1), true);
$assert.callable(Subclass1);
$assert.constructable(Subclass1);
$assert.compareArray($Reflect_ownKeys(Subclass1), ['length', 'name', 'prototype'], Subclass1);
$assert.sameValue($Object_getPrototypeOf(Subclass1?.["prototype"]), Base?.["prototype"]);
$assert.sameValue(Object.isExtensible(Subclass1?.["prototype"]), true);
$assert.notCallable(Subclass1?.["prototype"]);
$assert.notConstructable(Subclass1?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Subclass1?.["prototype"]), ['constructor'], Subclass1?.["prototype"]);
$assert.sameValue(Subclass1?.["prototype"]?.["constructor"], Subclass1);
$verifyProperty(Subclass1?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Subclass1, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Subclass1, "name", {
  value: "Subclass1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Subclass1, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
