...
$assert.sameValue(globalThis["attr"], "name");
$assert.sameValue(globalThis["isDefined"], true);
...
$assert.sameValue($Object_getPrototypeOf(A?.["name"]), Function.prototype);
$assert.sameValue(Object.isExtensible(A?.["name"]), true);
$assert.callable(A?.["name"]);
$assert.notConstructable(A?.["name"]);
$assert.compareArray($Reflect_ownKeys(A?.["name"]), ['length', 'name'], A?.["name"]);
$verifyProperty(A?.["name"], "name", {
  value: "name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["name"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(B?.["name"]), Function.prototype);
$assert.sameValue(Object.isExtensible(B?.["name"]), true);
$assert.callable(B?.["name"]);
$assert.notConstructable(B?.["name"]);
$assert.compareArray($Reflect_ownKeys(B?.["name"]), ['length', 'name'], B?.["name"]);
$verifyProperty(B?.["name"], "name", {
  value: "name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(B?.["name"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "name")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "name")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "name")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "name")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "name")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "name")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "name")?.get, "name", {
  value: "get name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "name")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(D, "name")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(D, "name")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(D, "name")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(D, "name")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(D, "name")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(D, "name")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(D, "name")?.set, "name", {
  value: "set name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(D, "name")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(E?.["name"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(E?.["name"]), true);
$assert.callable(E?.["name"]);
$assert.notConstructable(E?.["name"]);
$assert.compareArray($Reflect_ownKeys(E?.["name"]), ['length', 'name', 'prototype'], E?.["name"]);
$assert.sameValue($Object_getPrototypeOf(E?.["name"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(E?.["name"]?.["prototype"]), true);
$assert.notCallable(E?.["name"]?.["prototype"]);
$assert.notConstructable(E?.["name"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(E?.["name"]?.["prototype"]), [], E?.["name"]?.["prototype"]);
$verifyProperty(E?.["name"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(E?.["name"], "name", {
  value: "name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(E?.["name"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
