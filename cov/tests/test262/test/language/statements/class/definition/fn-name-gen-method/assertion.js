...
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["id"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["id"]), true);
$assert.callable(A?.["prototype"]?.["id"]);
$assert.notConstructable(A?.["prototype"]?.["id"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["id"]), ['length', 'prototype'], A?.["prototype"]?.["id"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["id"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["id"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["id"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["id"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["id"]?.["prototype"]), [], A?.["prototype"]?.["id"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["id"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["id"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "id", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(A?.["id"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["id"]), true);
$assert.callable(A?.["id"]);
$assert.notConstructable(A?.["id"]);
$assert.compareArray($Reflect_ownKeys(A?.["id"]), ['length', 'prototype'], A?.["id"]);
$assert.sameValue($Object_getPrototypeOf(A?.["id"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["id"]?.["prototype"]), true);
$assert.notCallable(A?.["id"]?.["prototype"]);
$assert.notConstructable(A?.["id"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["id"]?.["prototype"]), [], A?.["id"]?.["prototype"]);
$verifyProperty(A?.["id"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["id"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
