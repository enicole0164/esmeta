...
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["id"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["id"]), ['length'], A?.["prototype"]?.["id"]);
...
$assert.sameValue($Object_getPrototypeOf(A?.["id"]), Function.prototype);
$assert.sameValue(Object.isExtensible(A?.["id"]), true);
$assert.callable(A?.["id"]);
$assert.notConstructable(A?.["id"]);
$assert.compareArray($Reflect_ownKeys(A?.["id"]), ['length'], A?.["id"]);
