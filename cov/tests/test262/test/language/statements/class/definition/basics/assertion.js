...
$assert.sameValue($Object_getPrototypeOf(globalThis["E"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["E"]), true);
$assert.callable(globalThis["E"]);
$assert.constructable(globalThis["E"]);
$assert.compareArray($Reflect_ownKeys(globalThis["E"]), ['length', 'name', 'prototype'], globalThis["E"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["E"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["E"]?.["prototype"]), true);
$assert.notCallable(globalThis["E"]?.["prototype"]);
$assert.notConstructable(globalThis["E"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["E"]?.["prototype"]), ['constructor'], globalThis["E"]?.["prototype"]);
$assert.sameValue(globalThis["E"]?.["prototype"]?.["constructor"], globalThis["E"]);
$verifyProperty(globalThis["E"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["E"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["E"], "name", {
  value: "E",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["E"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(D2), Function.prototype);
$assert.sameValue(Object.isExtensible(D2), true);
$assert.callable(D2);
$assert.constructable(D2);
$assert.compareArray($Reflect_ownKeys(D2), ['length', 'name', 'prototype'], D2);
$assert.sameValue($Object_getPrototypeOf(D2?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(D2?.["prototype"]), true);
$assert.notCallable(D2?.["prototype"]);
$assert.notConstructable(D2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(D2?.["prototype"]), ['constructor'], D2?.["prototype"]);
$assert.sameValue(D2?.["prototype"]?.["constructor"], D2);
$verifyProperty(D2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(D2, "name", {
  value: "D2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(D2, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
