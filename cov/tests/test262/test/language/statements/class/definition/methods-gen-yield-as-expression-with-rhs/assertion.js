...
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]), ['constructor', 'g1', 'g2', 'g3', 'g4', 'g5'], A?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g5"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g5"]), true);
$assert.callable(A?.["prototype"]?.["g5"]);
$assert.notConstructable(A?.["prototype"]?.["g5"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g5"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["g5"]);
$assert.sameValue(A?.["prototype"]?.["g5"]?.["prototype"], $Object_getPrototypeOf(globalThis["iter"]));
$verifyProperty(A?.["prototype"]?.["g5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["g5"], "name", {
  value: "g5",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["g5"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "g5", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g1"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g1"]), true);
$assert.callable(A?.["prototype"]?.["g1"]);
$assert.notConstructable(A?.["prototype"]?.["g1"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g1"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["g1"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g1"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g1"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["g1"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["g1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g1"]?.["prototype"]), [], A?.["prototype"]?.["g1"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["g1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["g1"], "name", {
  value: "g1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["g1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "g1", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g4"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g4"]), true);
$assert.callable(A?.["prototype"]?.["g4"]);
$assert.notConstructable(A?.["prototype"]?.["g4"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g4"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["g4"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g4"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g4"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["g4"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["g4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g4"]?.["prototype"]), [], A?.["prototype"]?.["g4"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["g4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["g4"], "name", {
  value: "g4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["g4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "g4", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g3"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g3"]), true);
$assert.callable(A?.["prototype"]?.["g3"]);
$assert.notConstructable(A?.["prototype"]?.["g3"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g3"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["g3"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g3"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g3"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["g3"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["g3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g3"]?.["prototype"]), [], A?.["prototype"]?.["g3"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["g3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["g3"], "name", {
  value: "g3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["g3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "g3", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g2"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g2"]), true);
$assert.callable(A?.["prototype"]?.["g2"]);
$assert.notConstructable(A?.["prototype"]?.["g2"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g2"]), ['length', 'name', 'prototype'], A?.["prototype"]?.["g2"]);
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]?.["g2"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(A?.["prototype"]?.["g2"]?.["prototype"]), true);
$assert.notCallable(A?.["prototype"]?.["g2"]?.["prototype"]);
$assert.notConstructable(A?.["prototype"]?.["g2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A?.["prototype"]?.["g2"]?.["prototype"]), [], A?.["prototype"]?.["g2"]?.["prototype"]);
$verifyProperty(A?.["prototype"]?.["g2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A?.["prototype"]?.["g2"], "name", {
  value: "g2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"]?.["g2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A?.["prototype"], "g2", {
  writable: true,
  enumerable: false,
  configurable: true,
});
