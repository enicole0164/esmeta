...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["cls"])), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["cls"])), true);
$assert.callable($Object_getPrototypeOf(globalThis["cls"]));
$assert.constructable($Object_getPrototypeOf(globalThis["cls"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["cls"])), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["cls"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["cls"])?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["cls"])?.["prototype"]), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["cls"])?.["prototype"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["cls"])?.["prototype"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["cls"])?.["prototype"]), ['constructor'], $Object_getPrototypeOf(globalThis["cls"])?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"])?.["prototype"]?.["constructor"], $Object_getPrototypeOf(globalThis["cls"]));
$verifyProperty($Object_getPrototypeOf(globalThis["cls"])?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["cls"]), "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["cls"]), "name", {
  value: "setHeritage",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["cls"]), "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["cls"]), true);
$assert.callable(globalThis["cls"]);
$assert.constructable(globalThis["cls"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]), ['length', 'name', 'prototype'], globalThis["cls"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"]?.["prototype"]), $Object_getPrototypeOf(globalThis["cls"])?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["cls"]?.["prototype"]), true);
$assert.notCallable(globalThis["cls"]?.["prototype"]);
$assert.notConstructable(globalThis["cls"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]?.["prototype"]), ['constructor', 'method'], globalThis["cls"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"]?.["prototype"]?.["method"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cls"]?.["prototype"]?.["method"]), true);
$assert.callable(globalThis["cls"]?.["prototype"]?.["method"]);
$assert.notConstructable(globalThis["cls"]?.["prototype"]?.["method"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]?.["prototype"]?.["method"]), ['length', 'name'], globalThis["cls"]?.["prototype"]?.["method"]);
$verifyProperty(globalThis["cls"]?.["prototype"]?.["method"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"]?.["prototype"]?.["method"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"]?.["prototype"], "method", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["cls"]?.["prototype"]?.["constructor"], globalThis["cls"]);
$verifyProperty(globalThis["cls"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["cls"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeHeritage"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeHeritage"]), true);
$assert.callable(globalThis["probeHeritage"]);
$assert.constructable(globalThis["probeHeritage"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeHeritage"]), ['length', 'name', 'prototype'], globalThis["probeHeritage"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeHeritage"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeHeritage"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeHeritage"]?.["prototype"]);
$assert.notConstructable(globalThis["probeHeritage"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeHeritage"]?.["prototype"]), ['constructor'], globalThis["probeHeritage"]?.["prototype"]);
$assert.sameValue(globalThis["probeHeritage"]?.["prototype"]?.["constructor"], globalThis["probeHeritage"]);
$verifyProperty(globalThis["probeHeritage"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeHeritage"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeHeritage"], "name", {
  value: "probeHeritage",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeHeritage"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["setHeritage"], $Object_getPrototypeOf(globalThis["cls"]));
