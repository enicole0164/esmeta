...
$assert.compareArray($Reflect_ownKeys(globalThis["C2"]?.["prototype"]), ['constructor', 'm', 'x'], globalThis["C2"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["C2"]?.["prototype"]?.["m"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["C2"]?.["prototype"]?.["m"]), true);
$assert.callable(globalThis["C2"]?.["prototype"]?.["m"]);
$assert.notConstructable(globalThis["C2"]?.["prototype"]?.["m"]);
$assert.compareArray($Reflect_ownKeys(globalThis["C2"]?.["prototype"]?.["m"]), ['length', 'name'], globalThis["C2"]?.["prototype"]?.["m"]);
$verifyProperty(globalThis["C2"]?.["prototype"]?.["m"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"]?.["prototype"]?.["m"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"]?.["prototype"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get, "name", {
  value: "get x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set, "name", {
  value: "set x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["C2"]?.["prototype"], "x")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["C2"]?.["prototype"], "x", {
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(C, globalThis["C2"]);
