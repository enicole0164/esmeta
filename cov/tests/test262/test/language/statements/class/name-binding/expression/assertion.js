...
$assert.sameValue($Object_getPrototypeOf(globalThis["Cc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Cc"]), true);
$assert.callable(globalThis["Cc"]);
$assert.constructable(globalThis["Cc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Cc"]), ['length', 'name', 'prototype'], globalThis["Cc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Cc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Cc"]?.["prototype"]), true);
$assert.notCallable(globalThis["Cc"]?.["prototype"]);
$assert.notConstructable(globalThis["Cc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Cc"]?.["prototype"]), ['constructor', 'm', 'x'], globalThis["Cc"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Cc"]?.["prototype"]?.["m"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Cc"]?.["prototype"]?.["m"]), true);
$assert.callable(globalThis["Cc"]?.["prototype"]?.["m"]);
$assert.notConstructable(globalThis["Cc"]?.["prototype"]?.["m"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Cc"]?.["prototype"]?.["m"]), ['length', 'name'], globalThis["Cc"]?.["prototype"]?.["m"]);
$verifyProperty(globalThis["Cc"]?.["prototype"]?.["m"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Cc"]?.["prototype"]?.["m"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Cc"]?.["prototype"], "m", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get, "name", {
  value: "get x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set, "name", {
  value: "set x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Cc"]?.["prototype"], "x")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Cc"]?.["prototype"], "x", {
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["Cc"]?.["prototype"]?.["constructor"], globalThis["Cc"]);
$verifyProperty(globalThis["Cc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Cc"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Cc"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Cc"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["Cgx"], globalThis["Cc"]);
$assert.sameValue(globalThis["Cm"], globalThis["Cc"]);
$assert.sameValue(globalThis["Csx"], globalThis["Cc"]);
$assert.sameValue(globalThis["Cv"], globalThis["Cc"]);
