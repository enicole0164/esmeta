...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])), Object.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])?.["constructor"]), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["constructCounts"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["constructCounts"]), true);
$assert.notCallable(globalThis["constructCounts"]);
$assert.notConstructable(globalThis["constructCounts"]);
$assert.compareArray($Reflect_ownKeys(globalThis["constructCounts"]), ['base', 'subclass', 'subclass2'], globalThis["constructCounts"]);
$verifyProperty(globalThis["constructCounts"], "base", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["constructCounts"], "subclass2", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["constructCounts"], "subclass", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])), $Object_getPrototypeOf(globalThis["b"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])?.["constructor"]), $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s2"])), $Object_getPrototypeOf(globalThis["b"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s2"])?.["constructor"]), $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["s2"]), [], globalThis["s2"]);
$assert.sameValue(Base, $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
