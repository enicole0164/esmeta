...
$assert.compareArray($Reflect_ownKeys(globalThis["args"]), ['0', '1', '2', 'length', 'callee', Symbol.iterator], globalThis["args"]);
...
$verifyProperty(globalThis["args"], "2", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"], "name", {
  value: "Base",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["that"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["that"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["that"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["that"])), ['constructor'], $Object_getPrototypeOf(globalThis["that"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["that"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["that"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["that"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["that"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["that"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["that"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["that"]));
$verifyProperty($Object_getPrototypeOf(globalThis["that"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["that"])?.["constructor"], "name", {
  value: "Derived",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["that"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["that"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["that"]), true);
$assert.notCallable(globalThis["that"]);
$assert.notConstructable(globalThis["that"]);
$assert.compareArray($Reflect_ownKeys(globalThis["that"]), [], globalThis["that"]);
$assert.sameValue(Base, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["that"]))?.["constructor"]);
$assert.sameValue(Derived, $Object_getPrototypeOf(globalThis["that"])?.["constructor"]);
