...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'switch'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["switch"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["switch"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["switch"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["switch"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["switch"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["switch"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["switch"], "name", {
  value: "switch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["switch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "switch", {
  writable: true,
  enumerable: false,
  configurable: true,
});
