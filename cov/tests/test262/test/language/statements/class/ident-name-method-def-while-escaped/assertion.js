...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'while'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["while"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["while"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["while"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["while"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["while"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["while"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["while"], "name", {
  value: "while",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["while"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "while", {
  writable: true,
  enumerable: false,
  configurable: true,
});
