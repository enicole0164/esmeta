...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'private'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["private"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["private"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["private"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["private"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["private"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["private"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["private"], "name", {
  value: "private",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["private"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "private", {
  writable: true,
  enumerable: false,
  configurable: true,
});
