...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'super'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["super"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["super"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["super"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["super"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["super"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["super"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["super"], "name", {
  value: "super",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["super"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "super", {
  writable: true,
  enumerable: false,
  configurable: true,
});
