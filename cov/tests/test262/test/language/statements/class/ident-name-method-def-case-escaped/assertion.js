...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'case'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["case"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["case"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["case"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["case"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["case"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["case"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["case"], "name", {
  value: "case",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["case"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "case", {
  writable: true,
  enumerable: false,
  configurable: true,
});
