...
$assert.sameValue($Object_getPrototypeOf(C?.["1.1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["1.1"]), true);
$assert.callable(C?.["1.1"]);
$assert.notConstructable(C?.["1.1"]);
$assert.compareArray($Reflect_ownKeys(C?.["1.1"]), ['length', 'name'], C?.["1.1"]);
$verifyProperty(C?.["1.1"], "name", {
  value: "1.1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["1.1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["1.1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["1.1"]), true);
$assert.callable(C?.["prototype"]?.["1.1"]);
$assert.notConstructable(C?.["prototype"]?.["1.1"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["1.1"]), ['length', 'name'], C?.["prototype"]?.["1.1"]);
$verifyProperty(C?.["prototype"]?.["1.1"], "name", {
  value: "1.1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["1.1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
