...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'public'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["public"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["public"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["public"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["public"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["public"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["public"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["public"], "name", {
  value: "public",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["public"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "public", {
  writable: true,
  enumerable: false,
  configurable: true,
});
