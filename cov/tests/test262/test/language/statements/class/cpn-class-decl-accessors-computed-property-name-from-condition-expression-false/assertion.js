...
$assert.compareArray($Reflect_ownKeys(C), ['2', 'length', 'name', 'prototype'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "2")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "2")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "2")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "2")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "2")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "2")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2")?.get, "name", {
  value: "get 2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "2")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "2")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "2")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "2")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "2")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "2")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2")?.set, "name", {
  value: "set 2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "2")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['2', 'constructor'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set, "name", {
  value: "set 2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "2")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
