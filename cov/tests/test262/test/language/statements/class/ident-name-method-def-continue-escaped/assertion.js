...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'continue'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["continue"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["continue"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["continue"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["continue"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["continue"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["continue"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["continue"], "name", {
  value: "continue",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["continue"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "continue", {
  writable: true,
  enumerable: false,
  configurable: true,
});
