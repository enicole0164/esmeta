...
$assert.compareArray($Reflect_ownKeys(C), ['10', 'length', 'name', 'prototype'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['10', 'constructor'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get, "name", {
  value: "get 10",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set, "name", {
  value: "set 10",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "10")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "10", {
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "10")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "10")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "10")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "10")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "10")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "10")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "10")?.get, "name", {
  value: "get 10",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "10")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "10")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "10")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "10")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "10")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "10")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "10")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "10")?.set, "name", {
  value: "set 10",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "10")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
