...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'default'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get, "name", {
  value: "get default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set, "name", {
  value: "set default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "default")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "default", {
  enumerable: false,
  configurable: true,
});
