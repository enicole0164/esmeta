...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['8', 'constructor'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get, "name", {
  value: "get 8",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set, "name", {
  value: "set 8",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "8")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "8", {
  enumerable: false,
  configurable: true,
});
