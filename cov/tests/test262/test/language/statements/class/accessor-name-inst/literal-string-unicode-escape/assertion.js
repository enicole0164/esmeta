...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'unicodeEscape'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get, "name", {
  value: "get unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set, "name", {
  value: "set unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "unicodeEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "unicodeEscape", {
  enumerable: false,
  configurable: true,
});
