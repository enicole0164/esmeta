...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'hexEscape'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get, "name", {
  value: "get hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set, "name", {
  value: "set hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "hexEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "hexEscape", {
  enumerable: false,
  configurable: true,
});
