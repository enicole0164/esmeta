...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'singleQuote'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get, "name", {
  value: "get singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set, "name", {
  value: "set singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "singleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "singleQuote", {
  enumerable: false,
  configurable: true,
});
