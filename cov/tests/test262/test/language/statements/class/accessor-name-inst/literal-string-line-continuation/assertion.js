...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'lineContinuation'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get, "name", {
  value: "get lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set, "name", {
  value: "set lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "lineContinuation")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "lineContinuation", {
  enumerable: false,
  configurable: true,
});
