...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'string'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get, "name", {
  value: "get string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set, "name", {
  value: "set string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "string")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "string", {
  enumerable: false,
  configurable: true,
});
