...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get, "name", {
  value: "get ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set, "name", {
  value: "set ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
