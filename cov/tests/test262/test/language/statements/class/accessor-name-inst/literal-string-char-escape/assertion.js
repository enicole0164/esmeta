...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'character	escape'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get, "name", {
  value: "get character	escape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set, "name", {
  value: "set character	escape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "character	escape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "character	escape", {
  enumerable: false,
  configurable: true,
});
