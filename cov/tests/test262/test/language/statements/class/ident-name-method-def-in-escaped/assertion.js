...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'in'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["in"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["in"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["in"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["in"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["in"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["in"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["in"], "name", {
  value: "in",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["in"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "in", {
  writable: true,
  enumerable: false,
  configurable: true,
});
