...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'package'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["package"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["package"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["package"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["package"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["package"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["package"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["package"], "name", {
  value: "package",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["package"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "package", {
  writable: true,
  enumerable: false,
  configurable: true,
});
