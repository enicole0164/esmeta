...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'throw'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["throw"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["throw"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["throw"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["throw"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["throw"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "throw", {
  writable: true,
  enumerable: false,
  configurable: true,
});
