...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'var'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["var"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["var"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["var"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["var"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["var"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["var"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["var"], "name", {
  value: "var",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["var"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "var", {
  writable: true,
  enumerable: false,
  configurable: true,
});
