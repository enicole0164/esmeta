...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'extends'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["extends"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["extends"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["extends"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["extends"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["extends"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["extends"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["extends"], "name", {
  value: "extends",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["extends"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "extends", {
  writable: true,
  enumerable: false,
  configurable: true,
});
