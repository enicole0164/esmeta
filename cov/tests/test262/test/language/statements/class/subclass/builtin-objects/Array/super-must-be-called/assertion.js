...
$assert.sameValue($Object_getPrototypeOf(A), Array);
...
$assert.sameValue($Object_getPrototypeOf(A?.["prototype"]), Array.prototype);
...
$assert.sameValue($Object_getPrototypeOf(A2), Array);
$assert.sameValue(Object.isExtensible(A2), true);
$assert.callable(A2);
$assert.constructable(A2);
$assert.compareArray($Reflect_ownKeys(A2), ['length', 'name', 'prototype'], A2);
$assert.sameValue($Object_getPrototypeOf(A2?.["prototype"]), Array.prototype);
$assert.sameValue(Object.isExtensible(A2?.["prototype"]), true);
$assert.notCallable(A2?.["prototype"]);
$assert.notConstructable(A2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(A2?.["prototype"]), ['constructor'], A2?.["prototype"]);
$assert.sameValue(A2?.["prototype"]?.["constructor"], A2);
$verifyProperty(A2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(A2, "name", {
  value: "A2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(A2, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
