...
$assert.sameValue($Object_getPrototypeOf(Obj), Object);
$assert.sameValue(Object.isExtensible(Obj), true);
$assert.callable(Obj);
$assert.constructable(Obj);
$assert.compareArray($Reflect_ownKeys(Obj), ['length', 'name', 'prototype'], Obj);
$assert.sameValue($Object_getPrototypeOf(Obj?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Obj?.["prototype"]), true);
$assert.notCallable(Obj?.["prototype"]);
$assert.notConstructable(Obj?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Obj?.["prototype"]), ['constructor'], Obj?.["prototype"]);
$assert.sameValue(Obj?.["prototype"]?.["constructor"], Obj);
$verifyProperty(Obj?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Obj, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Obj, "name", {
  value: "Obj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Obj, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Obj2), Object);
$assert.sameValue(Object.isExtensible(Obj2), true);
$assert.callable(Obj2);
$assert.constructable(Obj2);
$assert.compareArray($Reflect_ownKeys(Obj2), ['length', 'name', 'prototype'], Obj2);
$assert.sameValue($Object_getPrototypeOf(Obj2?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Obj2?.["prototype"]), true);
$assert.notCallable(Obj2?.["prototype"]);
$assert.notConstructable(Obj2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Obj2?.["prototype"]), ['constructor'], Obj2?.["prototype"]);
$assert.sameValue(Obj2?.["prototype"]?.["constructor"], Obj2);
$verifyProperty(Obj2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Obj2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Obj2, "name", {
  value: "Obj2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Obj2, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
