...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["instance"])?.["constructor"]), globalThis["A"]);
...
$assert.sameValue(globalThis["invoked"], true);
$assert.sameValue(globalThis["savedArg"], 1.0);
$assert.sameValue(C, $Object_getPrototypeOf(globalThis["instance"])?.["constructor"]);
