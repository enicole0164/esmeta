...
$assert.sameValue($Object_getPrototypeOf(WS1), WeakSet);
$assert.sameValue(Object.isExtensible(WS1), true);
$assert.callable(WS1);
$assert.constructable(WS1);
$assert.compareArray($Reflect_ownKeys(WS1), ['length', 'name', 'prototype'], WS1);
$assert.sameValue($Object_getPrototypeOf(WS1?.["prototype"]), WeakSet.prototype);
$assert.sameValue(Object.isExtensible(WS1?.["prototype"]), true);
$assert.notCallable(WS1?.["prototype"]);
$assert.notConstructable(WS1?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(WS1?.["prototype"]), ['constructor'], WS1?.["prototype"]);
$assert.sameValue(WS1?.["prototype"]?.["constructor"], WS1);
$verifyProperty(WS1?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(WS1, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(WS1, "name", {
  value: "WS1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(WS1, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(WS2), WeakSet);
$assert.sameValue(Object.isExtensible(WS2), true);
$assert.callable(WS2);
$assert.constructable(WS2);
$assert.compareArray($Reflect_ownKeys(WS2), ['length', 'name', 'prototype'], WS2);
$assert.sameValue($Object_getPrototypeOf(WS2?.["prototype"]), WeakSet.prototype);
$assert.sameValue(Object.isExtensible(WS2?.["prototype"]), true);
$assert.notCallable(WS2?.["prototype"]);
$assert.notConstructable(WS2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(WS2?.["prototype"]), ['constructor'], WS2?.["prototype"]);
$assert.sameValue(WS2?.["prototype"]?.["constructor"], WS2);
$verifyProperty(WS2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(WS2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(WS2, "name", {
  value: "WS2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(WS2, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
