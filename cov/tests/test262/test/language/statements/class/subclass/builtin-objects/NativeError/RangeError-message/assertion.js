...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])), RangeError.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), RangeError);
