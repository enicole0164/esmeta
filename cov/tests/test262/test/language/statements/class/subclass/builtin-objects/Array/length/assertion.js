...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["arr"])), Array.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["arr"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["arr"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["arr"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["arr"])), ['constructor'], $Object_getPrototypeOf(globalThis["arr"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["arr"])?.["constructor"]), Array);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["arr"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["arr"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["arr"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["arr"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["arr"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["arr"]));
$verifyProperty($Object_getPrototypeOf(globalThis["arr"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["arr"])?.["constructor"], "name", {
  value: "Ar",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["arr"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["arr"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["arrDesc"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrDesc"]), true);
$assert.notCallable(globalThis["arrDesc"]);
$assert.notConstructable(globalThis["arrDesc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrDesc"]), ['value', 'writable', 'enumerable', 'configurable'], globalThis["arrDesc"]);
$verifyProperty(globalThis["arrDesc"], "value", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrDesc"], "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrDesc"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrDesc"], "configurable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(Ar, $Object_getPrototypeOf(globalThis["arr"])?.["constructor"]);
