...
$assert.compareArray($Reflect_ownKeys(globalThis["bound"]), ['length', 'name', 'prototype'], globalThis["bound"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["bound"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bound"]?.["prototype"]), true);
$assert.notCallable(globalThis["bound"]?.["prototype"]);
$assert.notConstructable(globalThis["bound"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bound"]?.["prototype"]), [], globalThis["bound"]?.["prototype"]);
$verifyProperty(globalThis["bound"], "prototype", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(C), globalThis["bound"]);
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]), globalThis["bound"]?.["prototype"]);
