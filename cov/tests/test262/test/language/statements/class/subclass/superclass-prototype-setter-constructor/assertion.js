...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set, "name", {
  value: "set constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "constructor")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]), globalThis["Base"]?.["prototype"]);
