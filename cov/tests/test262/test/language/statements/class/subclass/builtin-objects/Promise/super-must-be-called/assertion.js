...
$assert.sameValue($Object_getPrototypeOf(Prom1), Promise);
$assert.sameValue(Object.isExtensible(Prom1), true);
$assert.callable(Prom1);
$assert.constructable(Prom1);
$assert.compareArray($Reflect_ownKeys(Prom1), ['length', 'name', 'prototype'], Prom1);
$assert.sameValue($Object_getPrototypeOf(Prom1?.["prototype"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(Prom1?.["prototype"]), true);
$assert.notCallable(Prom1?.["prototype"]);
$assert.notConstructable(Prom1?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Prom1?.["prototype"]), ['constructor'], Prom1?.["prototype"]);
$assert.sameValue(Prom1?.["prototype"]?.["constructor"], Prom1);
$verifyProperty(Prom1?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Prom1, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Prom1, "name", {
  value: "Prom1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Prom1, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Prom2), Promise);
$assert.sameValue(Object.isExtensible(Prom2), true);
$assert.callable(Prom2);
$assert.constructable(Prom2);
$assert.compareArray($Reflect_ownKeys(Prom2), ['length', 'name', 'prototype'], Prom2);
$assert.sameValue($Object_getPrototypeOf(Prom2?.["prototype"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(Prom2?.["prototype"]), true);
$assert.notCallable(Prom2?.["prototype"]);
$assert.notConstructable(Prom2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Prom2?.["prototype"]), ['constructor'], Prom2?.["prototype"]);
$assert.sameValue(Prom2?.["prototype"]?.["constructor"], Prom2);
$verifyProperty(Prom2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Prom2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Prom2, "name", {
  value: "Prom2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Prom2, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
