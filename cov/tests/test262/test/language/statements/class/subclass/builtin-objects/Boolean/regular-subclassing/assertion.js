...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b1"])), Boolean.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["b1"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["b1"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["b1"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["b1"])), ['constructor'], $Object_getPrototypeOf(globalThis["b1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b1"])?.["constructor"]), Boolean);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["b1"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["b1"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["b1"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["b1"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["b1"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["b1"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["b1"]));
$verifyProperty($Object_getPrototypeOf(globalThis["b1"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b1"])?.["constructor"], "name", {
  value: "Bln",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b1"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["b1"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["b1"]), true);
$assert.notCallable(globalThis["b1"]);
$assert.notConstructable(globalThis["b1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["b1"]), [], globalThis["b1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["b2"]), $Object_getPrototypeOf(globalThis["b1"]));
$assert.sameValue(Object.isExtensible(globalThis["b2"]), true);
$assert.notCallable(globalThis["b2"]);
$assert.notConstructable(globalThis["b2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["b2"]), [], globalThis["b2"]);
$assert.sameValue(Bln, $Object_getPrototypeOf(globalThis["b1"])?.["constructor"]);
