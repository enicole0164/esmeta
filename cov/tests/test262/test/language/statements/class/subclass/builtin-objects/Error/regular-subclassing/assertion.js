...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err"])), Error.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["err"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["err"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["err"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["err"])), ['constructor'], $Object_getPrototypeOf(globalThis["err"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err"])?.["constructor"]), Error);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["err"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["err"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["err"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["err"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["err"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["err"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["err"]));
$verifyProperty($Object_getPrototypeOf(globalThis["err"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err"])?.["constructor"], "name", {
  value: "CustomError",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(CustomError, $Object_getPrototypeOf(globalThis["err"])?.["constructor"]);
