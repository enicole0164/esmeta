...
$assert.sameValue($Object_getPrototypeOf(M1), Map);
...
$assert.sameValue($Object_getPrototypeOf(M1?.["prototype"]), Map.prototype);
...
$assert.sameValue($Object_getPrototypeOf(M2), Map);
...
$assert.sameValue($Object_getPrototypeOf(M2?.["prototype"]), Map.prototype);
