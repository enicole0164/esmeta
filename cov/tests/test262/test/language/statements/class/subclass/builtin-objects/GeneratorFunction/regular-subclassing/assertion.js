...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["gfn"])), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["gfn"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["gfn"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["gfn"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["gfn"])), ['constructor'], $Object_getPrototypeOf(globalThis["gfn"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]), GeneratorFunction);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["gfn"]));
$verifyProperty($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"], "name", {
  value: "Gfn",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["gfn"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["gfn"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["gfn"]), true);
$assert.callable(globalThis["gfn"]);
$assert.notConstructable(globalThis["gfn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gfn"]), ['length', 'name', 'prototype'], globalThis["gfn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["gfn"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["gfn"]?.["prototype"]), true);
$assert.notCallable(globalThis["gfn"]?.["prototype"]);
$assert.notConstructable(globalThis["gfn"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["gfn"]?.["prototype"]), [], globalThis["gfn"]?.["prototype"]);
$verifyProperty(globalThis["gfn"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["gfn"], "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["gfn"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["iter"]), globalThis["gfn"]?.["prototype"]);
...
$assert.sameValue(Gfn, $Object_getPrototypeOf(globalThis["gfn"])?.["constructor"]);
