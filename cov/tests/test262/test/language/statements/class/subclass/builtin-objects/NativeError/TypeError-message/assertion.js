...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])), TypeError.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), TypeError);
