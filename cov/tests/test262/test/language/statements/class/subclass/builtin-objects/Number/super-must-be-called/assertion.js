...
$assert.sameValue($Object_getPrototypeOf(N), Number);
$assert.sameValue(Object.isExtensible(N), true);
$assert.callable(N);
$assert.constructable(N);
$assert.compareArray($Reflect_ownKeys(N), ['length', 'name', 'prototype'], N);
$assert.sameValue($Object_getPrototypeOf(N?.["prototype"]), Number.prototype);
$assert.sameValue(Object.isExtensible(N?.["prototype"]), true);
$assert.notCallable(N?.["prototype"]);
$assert.notConstructable(N?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(N?.["prototype"]), ['constructor'], N?.["prototype"]);
$assert.sameValue(N?.["prototype"]?.["constructor"], N);
$verifyProperty(N?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(N, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(N, "name", {
  value: "N",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(N, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(N2), Number);
$assert.sameValue(Object.isExtensible(N2), true);
$assert.callable(N2);
$assert.constructable(N2);
$assert.compareArray($Reflect_ownKeys(N2), ['length', 'name', 'prototype'], N2);
$assert.sameValue($Object_getPrototypeOf(N2?.["prototype"]), Number.prototype);
$assert.sameValue(Object.isExtensible(N2?.["prototype"]), true);
$assert.notCallable(N2?.["prototype"]);
$assert.notConstructable(N2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(N2?.["prototype"]), ['constructor'], N2?.["prototype"]);
$assert.sameValue(N2?.["prototype"]?.["constructor"], N2);
$verifyProperty(N2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(N2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(N2, "name", {
  value: "N2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(N2, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
