...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["map"])), Map.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["map"])?.["constructor"]), Map);
...
$assert.sameValue(M, $Object_getPrototypeOf(globalThis["map"])?.["constructor"]);
