...
$assert.sameValue($Object_getPrototypeOf(S), Symbol);
$assert.sameValue(Object.isExtensible(S), true);
$assert.callable(S);
$assert.constructable(S);
$assert.compareArray($Reflect_ownKeys(S), ['length', 'name', 'prototype'], S);
$assert.sameValue($Object_getPrototypeOf(S?.["prototype"]), Symbol.prototype);
$assert.sameValue(Object.isExtensible(S?.["prototype"]), true);
$assert.notCallable(S?.["prototype"]);
$assert.notConstructable(S?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(S?.["prototype"]), ['constructor'], S?.["prototype"]);
$assert.sameValue(S?.["prototype"]?.["constructor"], S);
$verifyProperty(S?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(S, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(S, "name", {
  value: "S",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(S, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
