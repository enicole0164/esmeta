...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["sub"])), Array.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["sub"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["sub"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["sub"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["sub"])), ['constructor'], $Object_getPrototypeOf(globalThis["sub"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["sub"])?.["constructor"]), Array);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["sub"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["sub"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["sub"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["sub"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["sub"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["sub"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["sub"]));
$verifyProperty($Object_getPrototypeOf(globalThis["sub"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["sub"])?.["constructor"], "name", {
  value: "Sub",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["sub"])?.["constructor"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["sub"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["sub"]), true);
$assert.notCallable(globalThis["sub"]);
$assert.notConstructable(globalThis["sub"]);
$assert.compareArray($Reflect_ownKeys(globalThis["sub"]), ['0', '1', 'length'], globalThis["sub"]);
$verifyProperty(globalThis["sub"], "1", {
  value: "foo",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["sub"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["sub"], "0", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Sub, $Object_getPrototypeOf(globalThis["sub"])?.["constructor"]);
