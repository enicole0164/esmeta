...
$assert.sameValue(globalThis["calledExecutor"], true);
$assert.sameValue($Object_getPrototypeOf(globalThis["executorArguments"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["executorArguments"]), true);
$assert.notCallable(globalThis["executorArguments"]);
$assert.notConstructable(globalThis["executorArguments"]);
$assert.compareArray($Reflect_ownKeys(globalThis["executorArguments"]), ['0', '1', 'length', 'callee', Symbol.iterator], globalThis["executorArguments"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["executorArguments"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["executorArguments"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["executorArguments"], "callee", {
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["executorArguments"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["executorArguments"]?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["executorArguments"]?.["0"]), true);
$assert.callable(globalThis["executorArguments"]?.["0"]);
$assert.notConstructable(globalThis["executorArguments"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["executorArguments"]?.["0"]), ['length', 'name'], globalThis["executorArguments"]?.["0"]);
$verifyProperty(globalThis["executorArguments"]?.["0"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["executorArguments"]?.["0"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["executorArguments"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["executorArguments"]?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["executorArguments"]?.["1"]), true);
$assert.callable(globalThis["executorArguments"]?.["1"]);
$assert.notConstructable(globalThis["executorArguments"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["executorArguments"]?.["1"]), ['length', 'name'], globalThis["executorArguments"]?.["1"]);
$verifyProperty(globalThis["executorArguments"]?.["1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["executorArguments"]?.["1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["executorArguments"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["executorArguments"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["executorArguments"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["prom1"])), Promise.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["prom1"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["prom1"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["prom1"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["prom1"])), ['constructor'], $Object_getPrototypeOf(globalThis["prom1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]), Promise);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["prom1"]));
$verifyProperty($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"], "name", {
  value: "Prom",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["prom1"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["prom1"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["prom1"]), true);
$assert.notCallable(globalThis["prom1"]);
$assert.notConstructable(globalThis["prom1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["prom1"]), [], globalThis["prom1"]);
$assert.sameValue(Prom, $Object_getPrototypeOf(globalThis["prom1"])?.["constructor"]);
