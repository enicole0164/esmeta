...
$assert.sameValue($Object_getPrototypeOf(S1), Symbol);
$assert.sameValue(Object.isExtensible(S1), true);
$assert.callable(S1);
$assert.constructable(S1);
$assert.compareArray($Reflect_ownKeys(S1), ['length', 'name', 'prototype'], S1);
$assert.sameValue($Object_getPrototypeOf(S1?.["prototype"]), Symbol.prototype);
$assert.sameValue(Object.isExtensible(S1?.["prototype"]), true);
$assert.notCallable(S1?.["prototype"]);
$assert.notConstructable(S1?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(S1?.["prototype"]), ['constructor'], S1?.["prototype"]);
$assert.sameValue(S1?.["prototype"]?.["constructor"], S1);
$verifyProperty(S1?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(S1, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(S1, "name", {
  value: "S1",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(S2), Symbol);
$assert.sameValue(Object.isExtensible(S2), true);
$assert.callable(S2);
$assert.constructable(S2);
$assert.compareArray($Reflect_ownKeys(S2), ['length', 'name', 'prototype'], S2);
$assert.sameValue($Object_getPrototypeOf(S2?.["prototype"]), Symbol.prototype);
$assert.sameValue(Object.isExtensible(S2?.["prototype"]), true);
$assert.notCallable(S2?.["prototype"]);
$assert.notConstructable(S2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(S2?.["prototype"]), ['constructor'], S2?.["prototype"]);
$assert.sameValue(S2?.["prototype"]?.["constructor"], S2);
$verifyProperty(S2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(S2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(S2, "name", {
  value: "S2",
  writable: false,
  enumerable: false,
  configurable: true,
