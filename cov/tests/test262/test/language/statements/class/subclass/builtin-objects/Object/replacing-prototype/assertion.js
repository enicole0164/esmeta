...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'valueOf'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["valueOf"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "valueOf", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]), Object);
...
$assert.sameValue(Obj, $Object_getPrototypeOf(globalThis["obj"])?.["constructor"]);
