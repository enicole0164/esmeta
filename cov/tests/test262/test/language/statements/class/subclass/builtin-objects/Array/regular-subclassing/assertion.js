...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["a1"])), Array.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["a1"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["a1"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["a1"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["a1"])), ['constructor'], $Object_getPrototypeOf(globalThis["a1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["a1"])?.["constructor"]), Array);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["a1"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["a1"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["a1"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["a1"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["a1"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a1"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["a1"]));
$verifyProperty($Object_getPrototypeOf(globalThis["a1"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a1"])?.["constructor"], "name", {
  value: "Sub",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a1"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["a1"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["a1"]), true);
$assert.notCallable(globalThis["a1"]);
$assert.notConstructable(globalThis["a1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a1"]), ['0', '1', '2', 'length'], globalThis["a1"]);
$verifyProperty(globalThis["a1"], "1", {
  value: "foo",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a1"], "2", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["a1"], "0", {
  value: 42.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["a2"]), $Object_getPrototypeOf(globalThis["a1"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["a2"]), ['length'], globalThis["a2"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["a3"]), $Object_getPrototypeOf(globalThis["a1"]));
$assert.sameValue(Object.isExtensible(globalThis["a3"]), true);
$assert.notCallable(globalThis["a3"]);
$assert.notConstructable(globalThis["a3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a3"]), ['length'], globalThis["a3"]);
$verifyProperty(globalThis["a3"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
...
$assert.sameValue(Sub, $Object_getPrototypeOf(globalThis["a1"])?.["constructor"]);
