...
$assert.compareArray($Reflect_ownKeys(globalThis["Base"]?.["prototype"]), ['m'], globalThis["Base"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set, "name", {
  value: "set m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"]?.["prototype"], "m")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Base"]?.["prototype"], "m", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
