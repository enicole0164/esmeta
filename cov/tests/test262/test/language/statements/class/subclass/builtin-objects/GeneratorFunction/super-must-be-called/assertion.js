...
$assert.sameValue(globalThis["GeneratorFunction"], GeneratorFunction);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["fn"])), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["fn"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["fn"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["fn"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["fn"])), ['constructor'], $Object_getPrototypeOf(globalThis["fn"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]), GeneratorFunction);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["fn"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["fn"]));
$verifyProperty($Object_getPrototypeOf(globalThis["fn"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["fn"])?.["constructor"], "name", {
  value: "GFn2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["fn"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["fn"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.sameValue($Object_getPrototypeOf(GFn1), GeneratorFunction);
$assert.sameValue(Object.isExtensible(GFn1), true);
$assert.callable(GFn1);
$assert.constructable(GFn1);
$assert.compareArray($Reflect_ownKeys(GFn1), ['length', 'name', 'prototype'], GFn1);
$assert.sameValue($Object_getPrototypeOf(GFn1?.["prototype"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(GFn1?.["prototype"]), true);
$assert.notCallable(GFn1?.["prototype"]);
$assert.notConstructable(GFn1?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(GFn1?.["prototype"]), ['constructor'], GFn1?.["prototype"]);
$assert.sameValue(GFn1?.["prototype"]?.["constructor"], GFn1);
$verifyProperty(GFn1?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(GFn1, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(GFn1, "name", {
  value: "GFn1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(GFn1, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(GFn2, $Object_getPrototypeOf(globalThis["fn"])?.["constructor"]);
