...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])), Error.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), Error);
