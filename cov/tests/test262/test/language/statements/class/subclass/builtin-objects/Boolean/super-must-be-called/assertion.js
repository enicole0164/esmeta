...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])), Boolean.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["b"])?.["constructor"]), Boolean);
...
$assert.sameValue($Object_getPrototypeOf(Bln), Boolean);
$assert.sameValue(Object.isExtensible(Bln), true);
$assert.callable(Bln);
$assert.constructable(Bln);
$assert.compareArray($Reflect_ownKeys(Bln), ['length', 'name', 'prototype'], Bln);
$assert.sameValue($Object_getPrototypeOf(Bln?.["prototype"]), Boolean.prototype);
$assert.sameValue(Object.isExtensible(Bln?.["prototype"]), true);
$assert.notCallable(Bln?.["prototype"]);
$assert.notConstructable(Bln?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Bln?.["prototype"]), ['constructor'], Bln?.["prototype"]);
$assert.sameValue(Bln?.["prototype"]?.["constructor"], Bln);
$verifyProperty(Bln?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Bln, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Bln, "name", {
  value: "Bln",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Bln, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Bln2, $Object_getPrototypeOf(globalThis["b"])?.["constructor"]);
