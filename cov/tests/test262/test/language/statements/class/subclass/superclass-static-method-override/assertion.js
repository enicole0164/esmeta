...
$assert.compareArray($Reflect_ownKeys(globalThis["Base"]), ['length', 'name', 'prototype', 'staticM'], globalThis["Base"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["Base"], "staticM")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Base"], "staticM", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'staticM'], C);
...
$assert.sameValue($Object_getPrototypeOf(C?.["staticM"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["staticM"]), true);
$assert.callable(C?.["staticM"]);
$assert.notConstructable(C?.["staticM"]);
$assert.compareArray($Reflect_ownKeys(C?.["staticM"]), ['length', 'name'], C?.["staticM"]);
$verifyProperty(C?.["staticM"], "name", {
  value: "staticM",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["staticM"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "staticM", {
  writable: true,
  enumerable: false,
  configurable: true,
});
