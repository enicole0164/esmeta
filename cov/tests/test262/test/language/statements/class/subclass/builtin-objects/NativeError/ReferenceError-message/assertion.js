...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])), ReferenceError.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["err1"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["err1"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["err1"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["err1"])), ['constructor', 'message'], $Object_getPrototypeOf(globalThis["err1"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), ReferenceError);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["err1"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["err1"]));
$verifyProperty($Object_getPrototypeOf(globalThis["err1"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err1"])?.["constructor"], "name", {
  value: "Err",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err1"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err1"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["err1"]), "message", {
  value: "custom-reference-error",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["err1"]), true);
$assert.notCallable(globalThis["err1"]);
$assert.notConstructable(globalThis["err1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err1"]), [], globalThis["err1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["err2"]), $Object_getPrototypeOf(globalThis["err1"]));
$assert.sameValue(Object.isExtensible(globalThis["err2"]), true);
$assert.notCallable(globalThis["err2"]);
$assert.notConstructable(globalThis["err2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["err2"]), [], globalThis["err2"]);
...
$assert.sameValue(Err, $Object_getPrototypeOf(globalThis["err1"])?.["constructor"]);
