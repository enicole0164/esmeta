...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["fn"])), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["fn"])?.["constructor"]), Function);
...
$assert.constructable(globalThis["fn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]), ['length', 'name', 'prototype'], globalThis["fn"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fn"]?.["prototype"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fn"]?.["prototype"]), ['constructor'], globalThis["fn"]?.["prototype"]);
$assert.sameValue(globalThis["fn"]?.["prototype"]?.["constructor"], globalThis["fn"]);
$verifyProperty(globalThis["fn"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Fn), Function);
$assert.sameValue(Object.isExtensible(Fn), true);
$assert.callable(Fn);
$assert.constructable(Fn);
$assert.compareArray($Reflect_ownKeys(Fn), ['length', 'name', 'prototype'], Fn);
$assert.sameValue($Object_getPrototypeOf(Fn?.["prototype"]), Function.prototype);
$assert.sameValue(Object.isExtensible(Fn?.["prototype"]), true);
$assert.notCallable(Fn?.["prototype"]);
$assert.notConstructable(Fn?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Fn?.["prototype"]), ['constructor'], Fn?.["prototype"]);
$assert.sameValue(Fn?.["prototype"]?.["constructor"], Fn);
$verifyProperty(Fn?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Fn, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue(Fn2, $Object_getPrototypeOf(globalThis["fn"])?.["constructor"]);
