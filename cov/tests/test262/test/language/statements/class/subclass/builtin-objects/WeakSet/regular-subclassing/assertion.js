...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["set"])), WeakSet.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["set"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["set"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["set"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["set"])), ['constructor'], $Object_getPrototypeOf(globalThis["set"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["set"])?.["constructor"]), WeakSet);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["set"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["set"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["set"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["set"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["set"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["set"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["set"]));
$verifyProperty($Object_getPrototypeOf(globalThis["set"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["set"])?.["constructor"], "name", {
  value: "WS",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["set"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["set"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["set"]), true);
$assert.notCallable(globalThis["set"]);
$assert.notConstructable(globalThis["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["set"]), [], globalThis["set"]);
$assert.sameValue(WS, $Object_getPrototypeOf(globalThis["set"])?.["constructor"]);
