...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])), URIError.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["err1"])?.["constructor"]), URIError);
