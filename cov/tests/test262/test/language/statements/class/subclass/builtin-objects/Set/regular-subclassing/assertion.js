...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["set"])), Set.prototype);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["set"])?.["constructor"]), Set);
...
$assert.sameValue(S, $Object_getPrototypeOf(globalThis["set"])?.["constructor"]);
