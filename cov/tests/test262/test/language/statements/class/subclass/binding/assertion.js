...
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]), $Object_getPrototypeOf(globalThis["f"]));
$assert.sameValue(Object.isExtensible(globalThis["g"]), true);
$assert.callable(globalThis["g"]);
$assert.constructable(globalThis["g"]);
$assert.compareArray($Reflect_ownKeys(globalThis["g"]), ['length', 'name'], globalThis["g"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])), $Object_getPrototypeOf(globalThis["f"])?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["s"])?.["constructor"]), $Object_getPrototypeOf(globalThis["f"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["s"]), ['x', 'y'], globalThis["s"]);
$verifyProperty(globalThis["s"], "x", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["s"], "y", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["s1"]), ['x', 'y'], globalThis["s1"]);
$verifyProperty(globalThis["s1"], "x", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["s1"], "y", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(Base, $Object_getPrototypeOf(globalThis["f"]));
