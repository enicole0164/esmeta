...
$assert.sameValue($Object_getPrototypeOf(M1), WeakMap);
$assert.sameValue(Object.isExtensible(M1), true);
$assert.callable(M1);
$assert.constructable(M1);
$assert.compareArray($Reflect_ownKeys(M1), ['length', 'name', 'prototype'], M1);
$assert.sameValue($Object_getPrototypeOf(M1?.["prototype"]), WeakMap.prototype);
$assert.sameValue(Object.isExtensible(M1?.["prototype"]), true);
$assert.notCallable(M1?.["prototype"]);
$assert.notConstructable(M1?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(M1?.["prototype"]), ['constructor'], M1?.["prototype"]);
$assert.sameValue(M1?.["prototype"]?.["constructor"], M1);
$verifyProperty(M1?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(M1, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(M1, "name", {
  value: "M1",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(M2), WeakMap);
$assert.sameValue(Object.isExtensible(M2), true);
$assert.callable(M2);
$assert.constructable(M2);
$assert.compareArray($Reflect_ownKeys(M2), ['length', 'name', 'prototype'], M2);
$assert.sameValue($Object_getPrototypeOf(M2?.["prototype"]), WeakMap.prototype);
$assert.sameValue(Object.isExtensible(M2?.["prototype"]), true);
$assert.notCallable(M2?.["prototype"]);
$assert.notConstructable(M2?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(M2?.["prototype"]), ['constructor'], M2?.["prototype"]);
$assert.sameValue(M2?.["prototype"]?.["constructor"], M2);
$verifyProperty(M2?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(M2, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(M2, "name", {
  value: "M2",
  writable: false,
  enumerable: false,
  configurable: true,
