...
$assert.sameValue($Object_getPrototypeOf(S1), String);
...
$assert.sameValue($Object_getPrototypeOf(S1?.["prototype"]), String.prototype);
...
$assert.sameValue($Object_getPrototypeOf(S2), String);
...
$assert.sameValue($Object_getPrototypeOf(S2?.["prototype"]), String.prototype);
