...
$assert.sameValue($Object_getPrototypeOf(S1), Set);
...
$assert.sameValue($Object_getPrototypeOf(S1?.["prototype"]), Set.prototype);
...
$assert.sameValue($Object_getPrototypeOf(S2), Set);
...
$assert.sameValue($Object_getPrototypeOf(S2?.["prototype"]), Set.prototype);
