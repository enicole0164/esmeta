...
$assert.compareArray($Reflect_ownKeys(globalThis["iter"]), ['next', 'return', 'f', Symbol.iterator], globalThis["iter"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["iter"]?.["f"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iter"]?.["f"]), true);
$assert.callable(globalThis["iter"]?.["f"]);
$assert.notConstructable(globalThis["iter"]?.["f"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iter"]?.["f"]), ['length', 'name'], globalThis["iter"]?.["f"]);
$verifyProperty(globalThis["iter"]?.["f"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iter"]?.["f"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iter"], "f", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["o"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["o"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["o"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["o"])), ['constructor'], $Object_getPrototypeOf(globalThis["o"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["o"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["o"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["o"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["o"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["o"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["o"]));
$verifyProperty($Object_getPrototypeOf(globalThis["o"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["o"])?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["o"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["o"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(C, $Object_getPrototypeOf(globalThis["o"])?.["constructor"]);
