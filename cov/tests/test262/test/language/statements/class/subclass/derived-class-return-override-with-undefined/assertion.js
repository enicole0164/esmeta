...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"], "name", {
  value: "Base",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["object"])), ['constructor'], $Object_getPrototypeOf(globalThis["object"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["object"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["object"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["object"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["object"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["object"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["object"]));
$verifyProperty($Object_getPrototypeOf(globalThis["object"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["object"])?.["constructor"], "name", {
  value: "Derived",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["object"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["object"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['prop'], globalThis["object"]);
$verifyProperty(globalThis["object"], "prop", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(Base, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["object"]))?.["constructor"]);
$assert.sameValue(Derived, $Object_getPrototypeOf(globalThis["object"])?.["constructor"]);
