...
$assert.sameValue($Object_getPrototypeOf(globalThis["value"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["value"]), true);
$assert.callable(globalThis["value"]);
$assert.constructable(globalThis["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["value"]), ['length', 'name', 'prototype'], globalThis["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["value"]?.["prototype"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["value"]?.["prototype"]), ['constructor'], globalThis["value"]?.["prototype"]);
$assert.sameValue(globalThis["value"]?.["prototype"]?.["constructor"], globalThis["value"]);
$verifyProperty(globalThis["value"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(C, globalThis["value"]);
