...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'return'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["return"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["return"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["return"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["return"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["return"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "return", {
  writable: true,
  enumerable: false,
  configurable: true,
});
