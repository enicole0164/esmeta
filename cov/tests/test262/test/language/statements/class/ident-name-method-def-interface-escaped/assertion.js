...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'interface'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["interface"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["interface"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["interface"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["interface"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["interface"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["interface"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["interface"], "name", {
  value: "interface",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["interface"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "interface", {
  writable: true,
  enumerable: false,
  configurable: true,
});
