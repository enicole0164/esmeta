...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'const'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["const"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["const"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["const"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["const"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["const"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["const"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["const"], "name", {
  value: "const",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["const"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "const", {
  writable: true,
  enumerable: false,
  configurable: true,
});
