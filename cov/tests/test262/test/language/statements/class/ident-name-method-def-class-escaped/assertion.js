...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'class'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["class"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["class"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["class"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["class"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["class"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["class"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["class"], "name", {
  value: "class",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["class"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "class", {
  writable: true,
  enumerable: false,
  configurable: true,
});
