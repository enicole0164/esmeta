...
$assert.compareArray($Reflect_ownKeys(C), ['12345678', 'length', 'name', 'prototype'], C);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['12345678', 'constructor'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get, "name", {
  value: "get 12345678",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set, "name", {
  value: "set 12345678",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "12345678")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "12345678", {
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "12345678")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "12345678")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "12345678")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "12345678")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "12345678")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "12345678")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "12345678")?.get, "name", {
  value: "get 12345678",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "12345678")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "12345678")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "12345678")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "12345678")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "12345678")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "12345678")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "12345678")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "12345678")?.set, "name", {
  value: "set 12345678",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "12345678")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "12345678", {
  enumerable: false,
  configurable: true,
});
