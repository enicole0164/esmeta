...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'try'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["try"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["try"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["try"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["try"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["try"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["try"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["try"], "name", {
  value: "try",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["try"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "try", {
  writable: true,
  enumerable: false,
  configurable: true,
});
