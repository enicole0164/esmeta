...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'null'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "null")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "null")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "null")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "null")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "null")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "null")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "null")?.get, "name", {
  value: "get null",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "null")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "null")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "null")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "null")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "null")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "null")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "null")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "null")?.set, "name", {
  value: "set null",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "null")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "null", {
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'null'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get, "name", {
  value: "get null",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set, "name", {
  value: "set null",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C?.["prototype"], "null")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "null", {
  enumerable: false,
  configurable: true,
});
