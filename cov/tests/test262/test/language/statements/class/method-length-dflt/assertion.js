...
$assert.sameValue($Object_getPrototypeOf(globalThis["m1"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["m1"]), ['name'], globalThis["m1"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["m2"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["m2"]), ['name'], globalThis["m2"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["m3"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["m3"]), ['name'], globalThis["m3"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["m4"]), Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["m4"]), ['name'], globalThis["m4"]);
