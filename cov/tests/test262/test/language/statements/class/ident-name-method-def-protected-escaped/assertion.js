...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'protected'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["protected"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["protected"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["protected"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["protected"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["protected"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["protected"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["protected"], "name", {
  value: "protected",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["protected"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "protected", {
  writable: true,
  enumerable: false,
  configurable: true,
});
