...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'for'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["for"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["for"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["for"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["for"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["for"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["for"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["for"], "name", {
  value: "for",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["for"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "for", {
  writable: true,
  enumerable: false,
  configurable: true,
});
