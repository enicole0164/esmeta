...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'instanceof'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["instanceof"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"], "name", {
  value: "instanceof",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["instanceof"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "instanceof", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["obj"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["obj"]));
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue(C, $Object_getPrototypeOf(globalThis["obj"])?.["constructor"]);
