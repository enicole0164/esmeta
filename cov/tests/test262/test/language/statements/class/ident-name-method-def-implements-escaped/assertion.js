...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'implements'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["implements"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["implements"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["implements"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["implements"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["implements"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["implements"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["implements"], "name", {
  value: "implements",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["implements"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "implements", {
  writable: true,
  enumerable: false,
  configurable: true,
});
