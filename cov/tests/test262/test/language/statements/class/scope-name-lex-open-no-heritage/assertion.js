...
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"]), Function.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"]?.["prototype"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]?.["prototype"]), ['constructor', 'probe', 'modify'], globalThis["cls"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"]?.["prototype"]?.["modify"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cls"]?.["prototype"]?.["modify"]), true);
$assert.callable(globalThis["cls"]?.["prototype"]?.["modify"]);
$assert.notConstructable(globalThis["cls"]?.["prototype"]?.["modify"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]?.["prototype"]?.["modify"]), ['length', 'name'], globalThis["cls"]?.["prototype"]?.["modify"]);
$verifyProperty(globalThis["cls"]?.["prototype"]?.["modify"], "name", {
  value: "modify",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"]?.["prototype"]?.["modify"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"]?.["prototype"], "modify", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["cls"]?.["prototype"]?.["probe"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["cls"]?.["prototype"]?.["probe"]), true);
$assert.callable(globalThis["cls"]?.["prototype"]?.["probe"]);
$assert.notConstructable(globalThis["cls"]?.["prototype"]?.["probe"]);
$assert.compareArray($Reflect_ownKeys(globalThis["cls"]?.["prototype"]?.["probe"]), ['length', 'name'], globalThis["cls"]?.["prototype"]?.["probe"]);
$verifyProperty(globalThis["cls"]?.["prototype"]?.["probe"], "name", {
  value: "probe",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"]?.["prototype"]?.["probe"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["cls"]?.["prototype"], "probe", {
  writable: true,
  enumerable: false,
  configurable: true,
});
