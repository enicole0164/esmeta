...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'static'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["static"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["static"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["static"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["static"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["static"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["static"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["static"], "name", {
  value: "static",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["static"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "static", {
  writable: true,
  enumerable: false,
  configurable: true,
});
