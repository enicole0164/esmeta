...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'debugger'], $Object_getPrototypeOf(globalThis["obj"]));
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["debugger"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["debugger"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["debugger"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["debugger"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["debugger"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["debugger"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["debugger"], "name", {
  value: "debugger",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["debugger"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "debugger", {
  writable: true,
  enumerable: false,
  configurable: true,
});
