...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'default'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "default")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "default")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "default")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "default")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "default")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "default")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "default")?.get, "name", {
  value: "get default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "default")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "default")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "default")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "default")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "default")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "default")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "default")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "default")?.set, "name", {
  value: "set default",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "default")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "default", {
  enumerable: false,
  configurable: true,
});
