...
$assert.compareArray($Reflect_ownKeys(C), ['16', 'length', 'name', 'prototype'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "16")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "16")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "16")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "16")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "16")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "16")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "16")?.get, "name", {
  value: "get 16",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "16")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "16")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "16")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "16")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "16")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "16")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "16")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "16")?.set, "name", {
  value: "set 16",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "16")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
