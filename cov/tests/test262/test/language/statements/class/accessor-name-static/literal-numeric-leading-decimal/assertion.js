...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', '0.1'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "0.1")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "0.1")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "0.1")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "0.1")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "0.1")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "0.1")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "0.1")?.get, "name", {
  value: "get 0.1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "0.1")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "0.1")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "0.1")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "0.1")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "0.1")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "0.1")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "0.1")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "0.1")?.set, "name", {
  value: "set 0.1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "0.1")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "0.1", {
  enumerable: false,
  configurable: true,
});
