...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', '1e-7'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "1e-7")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "1e-7")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "1e-7")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "1e-7")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "1e-7")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "1e-7")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1e-7")?.get, "name", {
  value: "get 1e-7",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1e-7")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "1e-7")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "1e-7")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "1e-7")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "1e-7")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "1e-7")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "1e-7")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1e-7")?.set, "name", {
  value: "set 1e-7",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "1e-7")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "1e-7", {
  enumerable: false,
  configurable: true,
});
