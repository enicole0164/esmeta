...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'string'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "string")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "string")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "string")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "string")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "string")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "string")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "string")?.get, "name", {
  value: "get string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "string")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "string")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "string")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "string")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "string")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "string")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "string")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "string")?.set, "name", {
  value: "set string",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "string")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "string", {
  enumerable: false,
  configurable: true,
});
