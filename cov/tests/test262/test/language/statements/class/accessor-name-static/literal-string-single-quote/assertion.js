...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'singleQuote'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "singleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get, "name", {
  value: "get singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "singleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "singleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set, "name", {
  value: "set singleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "singleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "singleQuote", {
  enumerable: false,
  configurable: true,
});
