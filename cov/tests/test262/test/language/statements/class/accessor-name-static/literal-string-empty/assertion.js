...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "")?.get, "name", {
  value: "get ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "")?.set, "name", {
  value: "set ",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
