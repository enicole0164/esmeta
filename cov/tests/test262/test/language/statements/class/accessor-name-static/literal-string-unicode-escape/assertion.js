...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'unicodeEscape'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get, "name", {
  value: "get unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set, "name", {
  value: "set unicodeEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "unicodeEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "unicodeEscape", {
  enumerable: false,
  configurable: true,
});
