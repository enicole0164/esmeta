...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'doubleQuote'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get, "name", {
  value: "get doubleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set, "name", {
  value: "set doubleQuote",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "doubleQuote")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "doubleQuote", {
  enumerable: false,
  configurable: true,
});
