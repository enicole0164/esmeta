...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'hexEscape'], C);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "hexEscape")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get, "name", {
  value: "get hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "hexEscape")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "hexEscape")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set, "name", {
  value: "set hexEscape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "hexEscape")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "hexEscape", {
  enumerable: false,
  configurable: true,
});
