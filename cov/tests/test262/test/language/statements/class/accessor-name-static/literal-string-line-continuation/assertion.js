...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'lineContinuation'], C);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get, "name", {
  value: "get lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set, "name", {
  value: "set lineContinuation",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C, "lineContinuation")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C, "lineContinuation", {
  enumerable: false,
  configurable: true,
});
