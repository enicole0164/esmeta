...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["4"]), true);
$assert.callable(C?.["prototype"]?.["4"]);
$assert.notConstructable(C?.["prototype"]?.["4"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["4"]), ['length', 'name'], C?.["prototype"]?.["4"]);
$verifyProperty(C?.["prototype"]?.["4"], "name", {
  value: "4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
