...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'delete'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["delete"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["delete"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["delete"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["delete"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["delete"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["delete"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["delete"], "name", {
  value: "delete",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["delete"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "delete", {
  writable: true,
  enumerable: false,
  configurable: true,
});
