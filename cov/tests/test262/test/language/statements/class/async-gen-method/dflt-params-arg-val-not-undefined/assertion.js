...
$assert.sameValue($Object_getPrototypeOf(globalThis["ref"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ref"]), true);
$assert.callable(globalThis["ref"]);
$assert.notConstructable(globalThis["ref"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ref"]), ['length', 'name', 'prototype'], globalThis["ref"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ref"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ref"]?.["prototype"]), true);
$assert.notCallable(globalThis["ref"]?.["prototype"]);
$assert.notConstructable(globalThis["ref"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ref"]?.["prototype"]), [], globalThis["ref"]?.["prototype"]);
$verifyProperty(globalThis["ref"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["ref"], "name", {
  value: "method",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["ref"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(C?.["prototype"]?.["method"], globalThis["ref"]);
