...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'new'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["new"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["new"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["new"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["new"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["new"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["new"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["new"], "name", {
  value: "new",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["new"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "new", {
  writable: true,
  enumerable: false,
  configurable: true,
});
