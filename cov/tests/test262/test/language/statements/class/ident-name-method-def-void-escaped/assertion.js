...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])), ['constructor', 'void'], $Object_getPrototypeOf(globalThis["obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj"])?.["void"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj"])?.["void"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["obj"])?.["void"]);
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj"])?.["void"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj"])?.["void"]), ['length', 'name'], $Object_getPrototypeOf(globalThis["obj"])?.["void"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["void"], "name", {
  value: "void",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"])?.["void"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["obj"]), "void", {
  writable: true,
  enumerable: false,
  configurable: true,
});
