...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'm'], C);
$assert.sameValue($Object_getPrototypeOf(C?.["m"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(C?.["m"]), true);
$assert.callable(C?.["m"]);
$assert.notConstructable(C?.["m"]);
$assert.compareArray($Reflect_ownKeys(C?.["m"]), ['length', 'name', 'prototype'], C?.["m"]);
$assert.sameValue($Object_getPrototypeOf(C?.["m"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["m"]?.["prototype"]), true);
$assert.notCallable(C?.["m"]?.["prototype"]);
$assert.notConstructable(C?.["m"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["m"]?.["prototype"]), [], C?.["m"]?.["prototype"]);
$verifyProperty(C?.["m"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C?.["m"], "name", {
  value: "m",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["m"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
