...
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIter"]), ['next', 'throw', Symbol.asyncIterator], globalThis["asyncIter"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncIter"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["asyncIter"]?.["throw"]), true);
$assert.callable(globalThis["asyncIter"]?.["throw"]);
$assert.notConstructable(globalThis["asyncIter"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIter"]?.["throw"]), ['length', 'name'], globalThis["asyncIter"]?.["throw"]);
$verifyProperty(globalThis["asyncIter"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncIter"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncIter"], "throw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
