...
$assert.sameValue($Object_getPrototypeOf(globalThis["it"]), AsyncGeneratorFunction.prototype.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["oldPrototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["oldPrototype"]), true);
$assert.notCallable(globalThis["oldPrototype"]);
$assert.notConstructable(globalThis["oldPrototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["oldPrototype"]), [], globalThis["oldPrototype"]);
