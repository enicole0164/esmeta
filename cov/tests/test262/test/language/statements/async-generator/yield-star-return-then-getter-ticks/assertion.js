...
$assert.compareArray($Reflect_ownKeys(globalThis["actual"]), ['0', '1', '2', '3', '4', '5', '6', '7', 'length'], globalThis["actual"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIter"]), ['next', 'return', Symbol.asyncIterator], globalThis["asyncIter"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get, "name", {
  value: "get return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["asyncIter"], "return")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncIter"], "return", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]), ['0', '1', '2', '3', '4', '5', '6', '7', 'length'], globalThis["expected"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["it"]), globalThis["f"]?.["prototype"]);
