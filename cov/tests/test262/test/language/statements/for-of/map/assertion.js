...
$assert.sameValue(globalThis["first"], null);
$assert.sameValue(globalThis["fourth"], null);
$assert.sameValue(globalThis["iterationCount"], 4.0);
...
$assert.sameValue(globalThis["second"], null);
$assert.sameValue(globalThis["third"], null);
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['0', '1', 'length'], globalThis["x"]);
$assert.sameValue(globalThis["x"]?.["1"], globalThis["obj"]);
