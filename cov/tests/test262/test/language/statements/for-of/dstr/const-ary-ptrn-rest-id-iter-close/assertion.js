...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(iter)), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(iter)), true);
$assert.notCallable($Object_getPrototypeOf(iter));
$assert.notConstructable($Object_getPrototypeOf(iter));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(iter)), [], $Object_getPrototypeOf(iter));
