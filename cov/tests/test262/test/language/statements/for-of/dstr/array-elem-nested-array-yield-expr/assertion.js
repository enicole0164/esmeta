...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterationResult"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterationResult"]), true);
$assert.notCallable(globalThis["iterationResult"]);
$assert.notConstructable(globalThis["iterationResult"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterationResult"]), ['value', 'done'], globalThis["iterationResult"]);
$verifyProperty(globalThis["iterationResult"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["iterationResult"], "value", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["value"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["value"]), ['0', 'length'], globalThis["value"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["value"]?.["0"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["value"]?.["0"]), true);
$assert.notCallable(globalThis["value"]?.["0"]);
$assert.notConstructable(globalThis["value"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["value"]?.["0"]), ['0', 'length'], globalThis["value"]?.["0"]);
$verifyProperty(globalThis["value"]?.["0"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["value"]?.["0"], "0", {
  value: 22.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["value"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['prop'], globalThis["x"]);
$verifyProperty(globalThis["x"], "prop", {
  value: 22.0,
  writable: true,
  enumerable: true,
  configurable: true,
