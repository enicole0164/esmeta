...
$assert.compareArray($Reflect_ownKeys(globalThis["array"]), ['0', '1', '2', '3', '4', '6', '7', 'length'], globalThis["array"]);
...
$assert.sameValue(globalThis["i"], 8.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["value"]), ['0', '1', 'length'], globalThis["value"]);
$verifyProperty(globalThis["value"], "1", {
  value: NaN,
  writable: true,
  enumerable: true,
  configurable: true,
