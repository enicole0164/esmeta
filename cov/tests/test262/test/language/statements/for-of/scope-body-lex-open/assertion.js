...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeDecl"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeDecl"]), true);
$assert.callable(globalThis["probeDecl"]);
$assert.constructable(globalThis["probeDecl"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeDecl"]), ['length', 'name', 'prototype'], globalThis["probeDecl"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeDecl"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeDecl"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeDecl"]?.["prototype"]);
$assert.notConstructable(globalThis["probeDecl"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeDecl"]?.["prototype"]), ['constructor'], globalThis["probeDecl"]?.["prototype"]);
$assert.sameValue(globalThis["probeDecl"]?.["prototype"]?.["constructor"], globalThis["probeDecl"]);
$verifyProperty(globalThis["probeDecl"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeDecl"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeDecl"], "name", {
  value: "probeDecl",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeDecl"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeExpr"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeExpr"]), true);
$assert.callable(globalThis["probeExpr"]);
$assert.constructable(globalThis["probeExpr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeExpr"]), ['length', 'name', 'prototype'], globalThis["probeExpr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeExpr"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeExpr"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeExpr"]?.["prototype"]);
$assert.notConstructable(globalThis["probeExpr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeExpr"]?.["prototype"]), ['constructor'], globalThis["probeExpr"]?.["prototype"]);
$assert.sameValue(globalThis["probeExpr"]?.["prototype"]?.["constructor"], globalThis["probeExpr"]);
$verifyProperty(globalThis["probeExpr"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeExpr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeExpr"], "name", {
  value: "probeExpr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeExpr"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
