...
$assert.sameValue($Object_getPrototypeOf(globalThis["CustomError"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["CustomError"]), true);
$assert.callable(globalThis["CustomError"]);
$assert.constructable(globalThis["CustomError"]);
$assert.compareArray($Reflect_ownKeys(globalThis["CustomError"]), ['length', 'name', 'prototype'], globalThis["CustomError"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["CustomError"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["CustomError"]?.["prototype"]), true);
$assert.notCallable(globalThis["CustomError"]?.["prototype"]);
$assert.notConstructable(globalThis["CustomError"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["CustomError"]?.["prototype"]), ['constructor'], globalThis["CustomError"]?.["prototype"]);
$assert.sameValue(globalThis["CustomError"]?.["prototype"]?.["constructor"], globalThis["CustomError"]);
$verifyProperty(globalThis["CustomError"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["CustomError"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["CustomError"], "name", {
  value: "CustomError",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["CustomError"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["error"]), globalThis["CustomError"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["iterator"])), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["iterator"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["iterator"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["iterator"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["iterator"])), [], $Object_getPrototypeOf(globalThis["iterator"]));
...
$assert.sameValue(globalThis["values"]?.["prototype"], $Object_getPrototypeOf(globalThis["iterator"]));
