...
$assert.sameValue(globalThis["iterationCount"], 1.0);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["iterator"], "next")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["loadNextCount"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["next"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["next"]), true);
$assert.callable(globalThis["next"]);
$assert.constructable(globalThis["next"]);
$assert.compareArray($Reflect_ownKeys(globalThis["next"]), ['length', 'name', 'prototype'], globalThis["next"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["next"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["next"]?.["prototype"]), true);
$assert.notCallable(globalThis["next"]?.["prototype"]);
$assert.notConstructable(globalThis["next"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["next"]?.["prototype"]), ['constructor'], globalThis["next"]?.["prototype"]);
$assert.sameValue(globalThis["next"]?.["prototype"]?.["constructor"], globalThis["next"]);
$verifyProperty(globalThis["next"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["next"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["next"], "name", {
  value: "next",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["next"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["x"], 45.0);
