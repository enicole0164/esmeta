...
$assert.compareArray($Reflect_ownKeys(globalThis["array"]), ['0', 'length'], globalThis["array"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["array"], "0")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
