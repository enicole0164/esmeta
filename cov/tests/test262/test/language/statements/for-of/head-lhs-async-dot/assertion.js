...
$assert.sameValue($Object_getPrototypeOf(globalThis["async"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["async"]), true);
$assert.notCallable(globalThis["async"]);
$assert.notConstructable(globalThis["async"]);
$assert.compareArray($Reflect_ownKeys(globalThis["async"]), ['x'], globalThis["async"]);
$verifyProperty(globalThis["async"], "x", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
