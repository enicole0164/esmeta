...
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]), ['0', '1', '2', 'length'], globalThis["expected"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["iterable"])), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["iterable"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["iterable"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["iterable"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["iterable"])), [], $Object_getPrototypeOf(globalThis["iterable"]));
...
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]), [], globalThis["iterable"]);
...
$assert.sameValue(globalThis["values"]?.["prototype"], $Object_getPrototypeOf(globalThis["iterable"]));
...
$assert.sameValue(globalThis["x"], 8.0);
