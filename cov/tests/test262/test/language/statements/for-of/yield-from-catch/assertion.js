...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["controlIterator"])), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["controlIterator"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["controlIterator"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["controlIterator"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["controlIterator"])), [], $Object_getPrototypeOf(globalThis["controlIterator"]));
$assert.sameValue(Object.isExtensible(globalThis["controlIterator"]), true);
$assert.notCallable(globalThis["controlIterator"]);
$assert.notConstructable(globalThis["controlIterator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["controlIterator"]), [], globalThis["controlIterator"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["dataIterator"])), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["dataIterator"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["dataIterator"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["dataIterator"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["dataIterator"])), [], $Object_getPrototypeOf(globalThis["dataIterator"]));
$assert.sameValue(Object.isExtensible(globalThis["dataIterator"]), true);
$assert.notCallable(globalThis["dataIterator"]);
$assert.notConstructable(globalThis["dataIterator"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dataIterator"]), [], globalThis["dataIterator"]);
$assert.sameValue(globalThis["i"], 2.0);
$assert.sameValue(globalThis["j"], 2.0);
$assert.sameValue(globalThis["k"], 2.0);
$assert.sameValue(globalThis["l"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["values"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["values"]), true);
$assert.callable(globalThis["values"]);
$assert.notConstructable(globalThis["values"]);
$assert.compareArray($Reflect_ownKeys(globalThis["values"]), ['length', 'name', 'prototype'], globalThis["values"]);
$assert.sameValue(globalThis["values"]?.["prototype"], $Object_getPrototypeOf(globalThis["dataIterator"]));
$verifyProperty(globalThis["values"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["values"], "name", {
  value: "values",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["values"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
