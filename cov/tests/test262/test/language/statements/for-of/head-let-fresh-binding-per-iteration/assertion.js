...
$assert.sameValue($Object_getPrototypeOf(f), Array.prototype);
$assert.sameValue(Object.isExtensible(f), true);
$assert.notCallable(f);
$assert.notConstructable(f);
$assert.compareArray($Reflect_ownKeys(f), ['0', '1', '2', 'length'], f);
$assert.sameValue($Object_getPrototypeOf(f?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(f?.["1"]), true);
$assert.callable(f?.["1"]);
$assert.constructable(f?.["1"]);
$assert.compareArray($Reflect_ownKeys(f?.["1"]), ['length', 'name', 'prototype'], f?.["1"]);
$assert.sameValue($Object_getPrototypeOf(f?.["1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(f?.["1"]?.["prototype"]), true);
$assert.notCallable(f?.["1"]?.["prototype"]);
$assert.notConstructable(f?.["1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(f?.["1"]?.["prototype"]), ['constructor'], f?.["1"]?.["prototype"]);
$assert.sameValue(f?.["1"]?.["prototype"]?.["constructor"], f?.["1"]);
$verifyProperty(f?.["1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(f?.["1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(f?.["1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(f?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(f?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(f?.["2"]), true);
$assert.callable(f?.["2"]);
$assert.constructable(f?.["2"]);
$assert.compareArray($Reflect_ownKeys(f?.["2"]), ['length', 'name', 'prototype'], f?.["2"]);
$assert.sameValue($Object_getPrototypeOf(f?.["2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(f?.["2"]?.["prototype"]), true);
$assert.notCallable(f?.["2"]?.["prototype"]);
$assert.notConstructable(f?.["2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(f?.["2"]?.["prototype"]), ['constructor'], f?.["2"]?.["prototype"]);
$assert.sameValue(f?.["2"]?.["prototype"]?.["constructor"], f?.["2"]);
$verifyProperty(f?.["2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(f?.["2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(f?.["2"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(f?.["2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(f?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(f?.["0"]), true);
$assert.callable(f?.["0"]);
$assert.constructable(f?.["0"]);
$assert.compareArray($Reflect_ownKeys(f?.["0"]), ['length', 'name', 'prototype'], f?.["0"]);
$assert.sameValue($Object_getPrototypeOf(f?.["0"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(f?.["0"]?.["prototype"]), true);
$assert.notCallable(f?.["0"]?.["prototype"]);
$assert.notConstructable(f?.["0"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(f?.["0"]?.["prototype"]), ['constructor'], f?.["0"]?.["prototype"]);
$assert.sameValue(f?.["0"]?.["prototype"]?.["constructor"], f?.["0"]);
$verifyProperty(f?.["0"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(f?.["0"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(f?.["0"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(f?.["0"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
