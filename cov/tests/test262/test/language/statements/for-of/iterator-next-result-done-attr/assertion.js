...
$assert.compareArray($Reflect_ownKeys(globalThis["firstIterResult"]), ['value', 'done'], globalThis["firstIterResult"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "done")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["i"], 0.0);
...
$assert.sameValue(globalThis["x"], null);
