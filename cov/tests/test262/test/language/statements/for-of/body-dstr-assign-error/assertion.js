...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['attr'], globalThis["x"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set, "name", {
  value: "set attr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["x"], "attr")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["x"], "attr", {
  get: undefined,
  enumerable: true,
  configurable: true,
});
