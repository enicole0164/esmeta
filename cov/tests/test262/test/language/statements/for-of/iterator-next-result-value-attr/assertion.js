...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["firstIterResult"], "value")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["x"], 23.0);
