...
$assert.sameValue(globalThis["expectedInner"], 7.0);
$assert.sameValue(globalThis["expectedOuter"], 7.0);
$assert.sameValue(globalThis["i"], 2.0);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["innerIterable"])), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["innerIterable"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["innerIterable"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["innerIterable"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["innerIterable"])), [], $Object_getPrototypeOf(globalThis["innerIterable"]));
$assert.sameValue(Object.isExtensible(globalThis["innerIterable"]), true);
$assert.notCallable(globalThis["innerIterable"]);
$assert.notConstructable(globalThis["innerIterable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["innerIterable"]), [], globalThis["innerIterable"]);
$assert.sameValue(globalThis["j"], 2.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["outerIterable"]), $Object_getPrototypeOf(globalThis["innerIterable"]));
$assert.sameValue(Object.isExtensible(globalThis["outerIterable"]), true);
$assert.notCallable(globalThis["outerIterable"]);
$assert.notConstructable(globalThis["outerIterable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["outerIterable"]), [], globalThis["outerIterable"]);
...
$assert.sameValue(globalThis["values"]?.["prototype"], $Object_getPrototypeOf(globalThis["innerIterable"]));
...
$assert.sameValue(globalThis["y"], 7.0);
