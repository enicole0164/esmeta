...
$assert.sameValue($Object_getPrototypeOf(globalThis["___"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["___"]), true);
$assert.callable(globalThis["___"]);
$assert.constructable(globalThis["___"]);
$assert.compareArray($Reflect_ownKeys(globalThis["___"]), ['length', 'name', 'prototype'], globalThis["___"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["___"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["___"]?.["prototype"]), true);
$assert.notCallable(globalThis["___"]?.["prototype"]);
$assert.notConstructable(globalThis["___"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["___"]?.["prototype"]), ['constructor'], globalThis["___"]?.["prototype"]);
$assert.sameValue(globalThis["___"]?.["prototype"]?.["constructor"], globalThis["___"]);
$verifyProperty(globalThis["___"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["___"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["___"], "name", {
  value: "probeBody",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["___"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["probeBody"], globalThis["___"]);
...
$assert.sameValue(globalThis["x"], 2.0);
