...
$assert.sameValue(globalThis["i"], "p1");
...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['p1', 'p2'], globalThis["object"]);
$verifyProperty(globalThis["object"], "p2", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["object"], "p1", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
