...
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]?.["prototype"]), [], globalThis["foo"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["g"]), globalThis["foo"]?.["prototype"]);
