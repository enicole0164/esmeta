...
$assert.sameValue($Object_getPrototypeOf(globalThis["ownProperties"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ownProperties"]), true);
$assert.notCallable(globalThis["ownProperties"]);
$assert.notConstructable(globalThis["ownProperties"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ownProperties"]), ['length'], globalThis["ownProperties"]);
$verifyProperty(globalThis["ownProperties"], "length", {
  value: 0.0,
  writable: true,
  enumerable: false,
  configurable: false,
