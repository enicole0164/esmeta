...
$assert.sameValue($Object_getPrototypeOf(globalThis["OUT_FUNC"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["OUT_FUNC"]), true);
$assert.callable(globalThis["OUT_FUNC"]);
$assert.constructable(globalThis["OUT_FUNC"]);
$assert.compareArray($Reflect_ownKeys(globalThis["OUT_FUNC"]), ['length', 'name', 'prototype'], globalThis["OUT_FUNC"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["OUT_FUNC"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["OUT_FUNC"]?.["prototype"]), true);
$assert.notCallable(globalThis["OUT_FUNC"]?.["prototype"]);
$assert.notConstructable(globalThis["OUT_FUNC"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["OUT_FUNC"]?.["prototype"]), ['constructor'], globalThis["OUT_FUNC"]?.["prototype"]);
$assert.sameValue(globalThis["OUT_FUNC"]?.["prototype"]?.["constructor"], globalThis["OUT_FUNC"]);
$verifyProperty(globalThis["OUT_FUNC"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["OUT_FUNC"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["OUT_FUNC"], "name", {
  value: "OUT_FUNC",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["OUT_FUNC"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["y"], 0.0);
