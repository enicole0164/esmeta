...
$assert.sameValue(globalThis["__evaluated"], "abcd");
$assert.sameValue(globalThis["__str"], "abcd");
...
$assert.sameValue($Object_getPrototypeOf(globalThis["hash"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["hash"]), true);
$assert.notCallable(globalThis["hash"]);
$assert.notConstructable(globalThis["hash"]);
$assert.compareArray($Reflect_ownKeys(globalThis["hash"]), ['1', '2', '3', '4'], globalThis["hash"]);
$verifyProperty(globalThis["hash"], "1", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["hash"], "2", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["hash"], "4", {
  value: "d",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["hash"], "3", {
  value: "c",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["ind"], "4");
