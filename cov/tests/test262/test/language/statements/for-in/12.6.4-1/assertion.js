...
$assert.sameValue(globalThis["countProp1"], 1.0);
$assert.sameValue(globalThis["countProp2"], 1.0);
$assert.sameValue(globalThis["countProp3"], 1.0);
...
$assert.sameValue(globalThis["p"], "prop3");
