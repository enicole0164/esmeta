...
$assert.compareArray($Reflect_ownKeys(globalThis["keys"]), ['0', '1', '2', '3', '4', '5', 'length'], globalThis["keys"]);
$verifyProperty(globalThis["keys"], "4", {
  value: "p4",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["keys"], "5", {
  value: "p1",
  writable: true,
  enumerable: true,
  configurable: true,
