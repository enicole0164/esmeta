...
$assert.sameValue(globalThis["key"], "p1");
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["o"])), ['p2'], $Object_getPrototypeOf(globalThis["o"]));
$verifyProperty($Object_getPrototypeOf(globalThis["o"]), "p2", {
  value: "p2",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['p1', 'p2'], globalThis["o"]);
