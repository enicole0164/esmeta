...
$assert.sameValue(globalThis["key"], "p3");
...
$assert.compareArray($Reflect_ownKeys(globalThis["keys"]), ['0', '1', '2', 'length'], globalThis["keys"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['p1', 'p2', 'p3', 'p4'], globalThis["o"]);
