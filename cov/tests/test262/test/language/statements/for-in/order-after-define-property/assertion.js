...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['length', 'a', 'b'], globalThis["arr"]);
$verifyProperty(globalThis["arr"], "b", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["arr"], "a")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["arrKey"], "b");
$assert.sameValue($Object_getPrototypeOf(globalThis["arrKeys"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arrKeys"]), true);
$assert.notCallable(globalThis["arrKeys"]);
$assert.notConstructable(globalThis["arrKeys"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arrKeys"]), ['0', '1', 'length'], globalThis["arrKeys"]);
$verifyProperty(globalThis["arrKeys"], "1", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["arrKeys"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["arrKeys"], "0", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["objKey"], "b");
$assert.sameValue($Object_getPrototypeOf(globalThis["objKeys"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objKeys"]), true);
$assert.notCallable(globalThis["objKeys"]);
$assert.notConstructable(globalThis["objKeys"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objKeys"]), ['0', '1', 'length'], globalThis["objKeys"]);
$verifyProperty(globalThis["objKeys"], "1", {
  value: "b",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["objKeys"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["objKeys"], "0", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
