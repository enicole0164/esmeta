...
$assert.sameValue(globalThis["__arr"], "aa1ab2ac3ad4ba1bb2bc3bd4ca1cb2cc3cd4da1db2dc3dd4");
$assert.sameValue($Object_getPrototypeOf(globalThis["__hash__map"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__hash__map"]), true);
$assert.notCallable(globalThis["__hash__map"]);
$assert.notConstructable(globalThis["__hash__map"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__hash__map"]), ['a', 'b', 'c', 'd'], globalThis["__hash__map"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__hash__map"]?.["b"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__hash__map"]?.["b"]), true);
$assert.notCallable(globalThis["__hash__map"]?.["b"]);
$assert.notConstructable(globalThis["__hash__map"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__hash__map"]?.["b"]), ['ba', 'bb', 'bc', 'bd'], globalThis["__hash__map"]?.["b"]);
$verifyProperty(globalThis["__hash__map"]?.["b"], "bc", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["b"], "bb", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["b"], "ba", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["b"], "bd", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"], "b", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__hash__map"]?.["d"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__hash__map"]?.["d"]), true);
$assert.notCallable(globalThis["__hash__map"]?.["d"]);
$assert.notConstructable(globalThis["__hash__map"]?.["d"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__hash__map"]?.["d"]), ['da', 'db', 'dc', 'dd'], globalThis["__hash__map"]?.["d"]);
$verifyProperty(globalThis["__hash__map"]?.["d"], "dd", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["d"], "db", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["d"], "dc", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["d"], "da", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"], "d", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__hash__map"]?.["a"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__hash__map"]?.["a"]), true);
$assert.notCallable(globalThis["__hash__map"]?.["a"]);
$assert.notConstructable(globalThis["__hash__map"]?.["a"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__hash__map"]?.["a"]), ['aa', 'ab', 'ac', 'ad'], globalThis["__hash__map"]?.["a"]);
$verifyProperty(globalThis["__hash__map"]?.["a"], "ab", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["a"], "ac", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["a"], "ad", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["a"], "aa", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"], "a", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__hash__map"]?.["c"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__hash__map"]?.["c"]), true);
$assert.notCallable(globalThis["__hash__map"]?.["c"]);
$assert.notConstructable(globalThis["__hash__map"]?.["c"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__hash__map"]?.["c"]), ['ca', 'cb', 'cc', 'cd'], globalThis["__hash__map"]?.["c"]);
$verifyProperty(globalThis["__hash__map"]?.["c"], "cb", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["c"], "ca", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["c"], "cc", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"]?.["c"], "cd", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__hash__map"], "c", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["__ind"], "dd");
$assert.sameValue(globalThis["__key"], "d");
