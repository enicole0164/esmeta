...
$assert.compareArray($Reflect_ownKeys(globalThis["FACTORY"]?.["prototype"]), ['feat', 'hint'], globalThis["FACTORY"]?.["prototype"]);
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "feat", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "hint", {
  value: "protohint",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["__accum"], "prop1hinthintedfeat2");
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]), globalThis["FACTORY"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['prop', 'hint'], globalThis["__instance"]);
...
$verifyProperty(globalThis["__instance"], "hint", {
  value: "hinted",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["key"], "feat");
