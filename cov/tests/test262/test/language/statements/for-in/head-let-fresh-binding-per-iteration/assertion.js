...
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]), true);
$assert.notCallable(globalThis["fns"]);
$assert.notConstructable(globalThis["fns"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]), ['a', 'b', 'c'], globalThis["fns"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]?.["b"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]?.["b"]), true);
$assert.callable(globalThis["fns"]?.["b"]);
$assert.constructable(globalThis["fns"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]?.["b"]), ['length', 'name', 'prototype'], globalThis["fns"]?.["b"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]?.["b"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]?.["b"]?.["prototype"]), true);
$assert.notCallable(globalThis["fns"]?.["b"]?.["prototype"]);
$assert.notConstructable(globalThis["fns"]?.["b"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]?.["b"]?.["prototype"]), ['constructor'], globalThis["fns"]?.["b"]?.["prototype"]);
$assert.sameValue(globalThis["fns"]?.["b"]?.["prototype"]?.["constructor"], globalThis["fns"]?.["b"]);
$verifyProperty(globalThis["fns"]?.["b"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"]?.["b"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fns"]?.["b"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"]?.["b"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"], "b", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]?.["a"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]?.["a"]), true);
$assert.callable(globalThis["fns"]?.["a"]);
$assert.constructable(globalThis["fns"]?.["a"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]?.["a"]), ['length', 'name', 'prototype'], globalThis["fns"]?.["a"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]?.["a"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]?.["a"]?.["prototype"]), true);
$assert.notCallable(globalThis["fns"]?.["a"]?.["prototype"]);
$assert.notConstructable(globalThis["fns"]?.["a"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]?.["a"]?.["prototype"]), ['constructor'], globalThis["fns"]?.["a"]?.["prototype"]);
$assert.sameValue(globalThis["fns"]?.["a"]?.["prototype"]?.["constructor"], globalThis["fns"]?.["a"]);
$verifyProperty(globalThis["fns"]?.["a"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"]?.["a"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fns"]?.["a"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"]?.["a"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"], "a", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]?.["c"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]?.["c"]), true);
$assert.callable(globalThis["fns"]?.["c"]);
$assert.constructable(globalThis["fns"]?.["c"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]?.["c"]), ['length', 'name', 'prototype'], globalThis["fns"]?.["c"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fns"]?.["c"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fns"]?.["c"]?.["prototype"]), true);
$assert.notCallable(globalThis["fns"]?.["c"]?.["prototype"]);
$assert.notConstructable(globalThis["fns"]?.["c"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fns"]?.["c"]?.["prototype"]), ['constructor'], globalThis["fns"]?.["c"]?.["prototype"]);
$assert.sameValue(globalThis["fns"]?.["c"]?.["prototype"]?.["constructor"], globalThis["fns"]?.["c"]);
$verifyProperty(globalThis["fns"]?.["c"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"]?.["c"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fns"]?.["c"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"]?.["c"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fns"], "c", {
  writable: true,
  enumerable: true,
  configurable: true,
});
