...
$assert.sameValue($Object_getPrototypeOf(globalThis["__"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__"]), true);
$assert.callable(globalThis["__"]);
$assert.constructable(globalThis["__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__"]), ['length', 'name', 'prototype'], globalThis["__"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__"]?.["prototype"]), true);
$assert.notCallable(globalThis["__"]?.["prototype"]);
$assert.notConstructable(globalThis["__"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__"]?.["prototype"]), ['constructor'], globalThis["__"]?.["prototype"]);
$assert.sameValue(globalThis["__"]?.["prototype"]?.["constructor"], globalThis["__"]);
$verifyProperty(globalThis["__"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__"], "name", {
  value: "probeBody",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["probeBody"], globalThis["__"]);
