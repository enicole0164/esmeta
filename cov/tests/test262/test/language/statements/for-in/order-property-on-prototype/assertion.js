...
$assert.sameValue(globalThis["key"], "p4");
...
$assert.compareArray($Reflect_ownKeys(globalThis["keys"]), ['0', '1', '2', '3', 'length'], globalThis["keys"]);
$verifyProperty(globalThis["keys"], "2", {
  value: "p3",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["keys"], "1", {
  value: "p2",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["keys"], "3", {
  value: "p4",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["o"])), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["o"])), ['p4'], $Object_getPrototypeOf(globalThis["o"]));
$verifyProperty($Object_getPrototypeOf(globalThis["o"]), "p4", {
  value: "p4",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['p1', 'p2', 'p3'], globalThis["o"]);
...
$verifyProperty(globalThis["o"], "p3", {
  value: "p3",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["proto"], $Object_getPrototypeOf(globalThis["o"]));
