...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeFirst"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeFirst"]), true);
$assert.callable(globalThis["probeFirst"]);
$assert.constructable(globalThis["probeFirst"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeFirst"]), ['length', 'name', 'prototype'], globalThis["probeFirst"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeFirst"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeFirst"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeFirst"]?.["prototype"]);
$assert.notConstructable(globalThis["probeFirst"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeFirst"]?.["prototype"]), ['constructor'], globalThis["probeFirst"]?.["prototype"]);
$assert.sameValue(globalThis["probeFirst"]?.["prototype"]?.["constructor"], globalThis["probeFirst"]);
$verifyProperty(globalThis["probeFirst"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeFirst"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeFirst"], "name", {
  value: "probeFirst",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeFirst"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeSecond"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeSecond"]), true);
$assert.callable(globalThis["probeSecond"]);
$assert.constructable(globalThis["probeSecond"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeSecond"]), ['length', 'name', 'prototype'], globalThis["probeSecond"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeSecond"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeSecond"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeSecond"]?.["prototype"]);
$assert.notConstructable(globalThis["probeSecond"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeSecond"]?.["prototype"]), ['constructor'], globalThis["probeSecond"]?.["prototype"]);
$assert.sameValue(globalThis["probeSecond"]?.["prototype"]?.["constructor"], globalThis["probeSecond"]);
$verifyProperty(globalThis["probeSecond"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeSecond"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeSecond"], "name", {
  value: "probeSecond",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeSecond"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
