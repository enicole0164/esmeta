...
$assert.sameValue(globalThis["__in__NotInExpression__"], "checked");
$assert.sameValue(globalThis["__in__NotInExpression__2"], "passed");
$assert.sameValue(globalThis["__in__for"], undefined);
