...
$assert.sameValue(globalThis["__in__deepest__loop"], undefined);
$assert.sameValue(globalThis["__str"], "000000000
100000000
110000000
110000001
111000000
...
$assert.sameValue(globalThis["index0"], 2.0);
$assert.sameValue(globalThis["index1"], 2.0);
$assert.sameValue(globalThis["index2"], 2.0);
$assert.sameValue(globalThis["index3"], 2.0);
$assert.sameValue(globalThis["index4"], 2.0);
$assert.sameValue(globalThis["index5"], 2.0);
$assert.sameValue(globalThis["index6"], 2.0);
$assert.sameValue(globalThis["index7"], 2.0);
$assert.sameValue(globalThis["index8"], 2.0);
