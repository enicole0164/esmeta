...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeIncr"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeIncr"]), true);
$assert.callable(globalThis["probeIncr"]);
$assert.constructable(globalThis["probeIncr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeIncr"]), ['length', 'name', 'prototype'], globalThis["probeIncr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeIncr"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeIncr"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeIncr"]?.["prototype"]);
$assert.notConstructable(globalThis["probeIncr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeIncr"]?.["prototype"]), ['constructor'], globalThis["probeIncr"]?.["prototype"]);
$assert.sameValue(globalThis["probeIncr"]?.["prototype"]?.["constructor"], globalThis["probeIncr"]);
$verifyProperty(globalThis["probeIncr"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeIncr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeIncr"], "name", {
  value: "probeIncr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeIncr"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeTest"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeTest"]), true);
$assert.callable(globalThis["probeTest"]);
$assert.constructable(globalThis["probeTest"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeTest"]), ['length', 'name', 'prototype'], globalThis["probeTest"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeTest"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeTest"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeTest"]?.["prototype"]);
$assert.notConstructable(globalThis["probeTest"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeTest"]?.["prototype"]), ['constructor'], globalThis["probeTest"]?.["prototype"]);
$assert.sameValue(globalThis["probeTest"]?.["prototype"]?.["constructor"], globalThis["probeTest"]);
$verifyProperty(globalThis["probeTest"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeTest"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeTest"], "name", {
  value: "probeTest",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeTest"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["run"], false);
