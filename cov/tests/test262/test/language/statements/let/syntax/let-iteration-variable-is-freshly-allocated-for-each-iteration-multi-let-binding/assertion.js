...
$assert.sameValue($Object_getPrototypeOf(a), Array.prototype);
$assert.sameValue(Object.isExtensible(a), true);
$assert.notCallable(a);
$assert.notConstructable(a);
$assert.compareArray($Reflect_ownKeys(a), ['0', '1', '2', '3', '4', 'length'], a);
$assert.sameValue($Object_getPrototypeOf(a?.["4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["4"]), true);
$assert.callable(a?.["4"]);
$assert.constructable(a?.["4"]);
$assert.compareArray($Reflect_ownKeys(a?.["4"]), ['length', 'name', 'prototype'], a?.["4"]);
$assert.sameValue($Object_getPrototypeOf(a?.["4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["4"]?.["prototype"]), true);
$assert.notCallable(a?.["4"]?.["prototype"]);
$assert.notConstructable(a?.["4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(a?.["4"]?.["prototype"]), ['constructor'], a?.["4"]?.["prototype"]);
$assert.sameValue(a?.["4"]?.["prototype"]?.["constructor"], a?.["4"]);
$verifyProperty(a?.["4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(a?.["4"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(a?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["2"]), true);
$assert.callable(a?.["2"]);
$assert.constructable(a?.["2"]);
$assert.compareArray($Reflect_ownKeys(a?.["2"]), ['length', 'name', 'prototype'], a?.["2"]);
$assert.sameValue($Object_getPrototypeOf(a?.["2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["2"]?.["prototype"]), true);
$assert.notCallable(a?.["2"]?.["prototype"]);
$assert.notConstructable(a?.["2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(a?.["2"]?.["prototype"]), ['constructor'], a?.["2"]?.["prototype"]);
$assert.sameValue(a?.["2"]?.["prototype"]?.["constructor"], a?.["2"]);
$verifyProperty(a?.["2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(a?.["2"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(a?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["1"]), true);
$assert.callable(a?.["1"]);
$assert.constructable(a?.["1"]);
$assert.compareArray($Reflect_ownKeys(a?.["1"]), ['length', 'name', 'prototype'], a?.["1"]);
$assert.sameValue($Object_getPrototypeOf(a?.["1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["1"]?.["prototype"]), true);
$assert.notCallable(a?.["1"]?.["prototype"]);
$assert.notConstructable(a?.["1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(a?.["1"]?.["prototype"]), ['constructor'], a?.["1"]?.["prototype"]);
$assert.sameValue(a?.["1"]?.["prototype"]?.["constructor"], a?.["1"]);
$verifyProperty(a?.["1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(a?.["1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(a?.["3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["3"]), true);
$assert.callable(a?.["3"]);
$assert.constructable(a?.["3"]);
$assert.compareArray($Reflect_ownKeys(a?.["3"]), ['length', 'name', 'prototype'], a?.["3"]);
$assert.sameValue($Object_getPrototypeOf(a?.["3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["3"]?.["prototype"]), true);
$assert.notCallable(a?.["3"]?.["prototype"]);
$assert.notConstructable(a?.["3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(a?.["3"]?.["prototype"]), ['constructor'], a?.["3"]?.["prototype"]);
$assert.sameValue(a?.["3"]?.["prototype"]?.["constructor"], a?.["3"]);
$verifyProperty(a?.["3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(a?.["3"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(a?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["0"]), true);
$assert.callable(a?.["0"]);
$assert.constructable(a?.["0"]);
$assert.compareArray($Reflect_ownKeys(a?.["0"]), ['length', 'name', 'prototype'], a?.["0"]);
$assert.sameValue($Object_getPrototypeOf(a?.["0"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["0"]?.["prototype"]), true);
$assert.notCallable(a?.["0"]?.["prototype"]);
$assert.notConstructable(a?.["0"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(a?.["0"]?.["prototype"]), ['constructor'], a?.["0"]?.["prototype"]);
$assert.sameValue(a?.["0"]?.["prototype"]?.["constructor"], a?.["0"]);
$verifyProperty(a?.["0"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["0"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(a?.["0"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["0"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(b), Array.prototype);
$assert.sameValue(Object.isExtensible(b), true);
$assert.notCallable(b);
$assert.notConstructable(b);
$assert.compareArray($Reflect_ownKeys(b), ['0', '1', '2', '3', '4', 'length'], b);
$assert.sameValue($Object_getPrototypeOf(b?.["4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["4"]), true);
$assert.callable(b?.["4"]);
$assert.constructable(b?.["4"]);
$assert.compareArray($Reflect_ownKeys(b?.["4"]), ['length', 'name', 'prototype'], b?.["4"]);
$assert.sameValue($Object_getPrototypeOf(b?.["4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(b?.["4"]?.["prototype"]), true);
$assert.notCallable(b?.["4"]?.["prototype"]);
$assert.notConstructable(b?.["4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(b?.["4"]?.["prototype"]), ['constructor'], b?.["4"]?.["prototype"]);
$assert.sameValue(b?.["4"]?.["prototype"]?.["constructor"], b?.["4"]);
$verifyProperty(b?.["4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(b?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["2"]), true);
$assert.callable(b?.["2"]);
$assert.constructable(b?.["2"]);
$assert.compareArray($Reflect_ownKeys(b?.["2"]), ['length', 'name', 'prototype'], b?.["2"]);
$assert.sameValue($Object_getPrototypeOf(b?.["2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(b?.["2"]?.["prototype"]), true);
$assert.notCallable(b?.["2"]?.["prototype"]);
$assert.notConstructable(b?.["2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(b?.["2"]?.["prototype"]), ['constructor'], b?.["2"]?.["prototype"]);
$assert.sameValue(b?.["2"]?.["prototype"]?.["constructor"], b?.["2"]);
$verifyProperty(b?.["2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(b?.["2"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(b?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["1"]), true);
$assert.callable(b?.["1"]);
$assert.constructable(b?.["1"]);
$assert.compareArray($Reflect_ownKeys(b?.["1"]), ['length', 'name', 'prototype'], b?.["1"]);
$assert.sameValue($Object_getPrototypeOf(b?.["1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(b?.["1"]?.["prototype"]), true);
$assert.notCallable(b?.["1"]?.["prototype"]);
$assert.notConstructable(b?.["1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(b?.["1"]?.["prototype"]), ['constructor'], b?.["1"]?.["prototype"]);
$assert.sameValue(b?.["1"]?.["prototype"]?.["constructor"], b?.["1"]);
$verifyProperty(b?.["1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(b?.["1"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(b?.["3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["3"]), true);
$assert.callable(b?.["3"]);
$assert.constructable(b?.["3"]);
$assert.compareArray($Reflect_ownKeys(b?.["3"]), ['length', 'name', 'prototype'], b?.["3"]);
$assert.sameValue($Object_getPrototypeOf(b?.["3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(b?.["3"]?.["prototype"]), true);
$assert.notCallable(b?.["3"]?.["prototype"]);
$assert.notConstructable(b?.["3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(b?.["3"]?.["prototype"]), ['constructor'], b?.["3"]?.["prototype"]);
$assert.sameValue(b?.["3"]?.["prototype"]?.["constructor"], b?.["3"]);
$verifyProperty(b?.["3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(b?.["3"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(b?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(b?.["0"]), true);
$assert.callable(b?.["0"]);
$assert.constructable(b?.["0"]);
$assert.compareArray($Reflect_ownKeys(b?.["0"]), ['length', 'name', 'prototype'], b?.["0"]);
$assert.sameValue($Object_getPrototypeOf(b?.["0"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(b?.["0"]?.["prototype"]), true);
$assert.notCallable(b?.["0"]?.["prototype"]);
$assert.notConstructable(b?.["0"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(b?.["0"]?.["prototype"]), ['constructor'], b?.["0"]?.["prototype"]);
$assert.sameValue(b?.["0"]?.["prototype"]?.["constructor"], b?.["0"]);
$verifyProperty(b?.["0"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["0"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(b?.["0"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(b?.["0"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
