...
$assert.compareArray($Reflect_ownKeys(a), ['0', '1', '2', '3', '4', '5', 'length'], a);
...
$assert.sameValue($Object_getPrototypeOf(a?.["5"]), Function.prototype);
$assert.sameValue(Object.isExtensible(a?.["5"]), true);
$assert.callable(a?.["5"]);
$assert.constructable(a?.["5"]);
$assert.compareArray($Reflect_ownKeys(a?.["5"]), ['length', 'name', 'prototype'], a?.["5"]);
$assert.sameValue($Object_getPrototypeOf(a?.["5"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(a?.["5"]?.["prototype"]), true);
$assert.notCallable(a?.["5"]?.["prototype"]);
$assert.notConstructable(a?.["5"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(a?.["5"]?.["prototype"]), ['constructor'], a?.["5"]?.["prototype"]);
$assert.sameValue(a?.["5"]?.["prototype"]?.["constructor"], a?.["5"]);
$verifyProperty(a?.["5"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(a?.["5"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(a?.["5"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
