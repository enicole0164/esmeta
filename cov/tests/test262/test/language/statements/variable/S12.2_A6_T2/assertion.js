...
$assert.sameValue(globalThis["incatch__incatch__var"], undefined);
$assert.sameValue(globalThis["incatch__intry__var"], undefined);
$assert.sameValue(globalThis["intry__incatch__var"], undefined);
$assert.sameValue(globalThis["intry__intry__var"], undefined);
