...
$assert.sameValue($Object_getPrototypeOf(xFn), Function.prototype);
$assert.sameValue(Object.isExtensible(xFn), true);
$assert.callable(xFn);
$assert.constructable(xFn);
$assert.compareArray($Reflect_ownKeys(xFn), ['length', 'name', 'prototype'], xFn);
$assert.sameValue($Object_getPrototypeOf(xFn?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(xFn?.["prototype"]), true);
$assert.notCallable(xFn?.["prototype"]);
$assert.notConstructable(xFn?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(xFn?.["prototype"]), ['constructor'], xFn?.["prototype"]);
$assert.sameValue(xFn?.["prototype"]?.["constructor"], xFn);
$verifyProperty(xFn?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xFn, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(xFn, "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(xFn, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
