...
$assert.sameValue(globalThis["__FRST"], "one");
$assert.sameValue(globalThis["__SCND"], "two");
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]), true);
$assert.callable(globalThis["__instance"]);
$assert.constructable(globalThis["__instance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['length', 'name', 'prototype', 'prop'], globalThis["__instance"]);
$verifyProperty(globalThis["__instance"], "prop", {
  value: "two",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__instance"]?.["prototype"]), true);
$assert.notCallable(globalThis["__instance"]?.["prototype"]);
$assert.notConstructable(globalThis["__instance"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]?.["prototype"]), ['constructor'], globalThis["__instance"]?.["prototype"]);
$assert.sameValue(globalThis["__instance"]?.["prototype"]?.["constructor"], globalThis["__instance"]);
$verifyProperty(globalThis["__instance"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__instance"], "name", {
  value: "__gunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__instance"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
