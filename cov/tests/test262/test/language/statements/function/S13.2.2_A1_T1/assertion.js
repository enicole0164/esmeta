...
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]), true);
$assert.callable(globalThis["__FACTORY"]?.["prototype"]);
$assert.constructable(globalThis["__FACTORY"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['length', 'name', 'prototype', 'type'], globalThis["__FACTORY"]?.["prototype"]);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "type", {
  value: "monster",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]?.["prototype"]), true);
$assert.notCallable(globalThis["__FACTORY"]?.["prototype"]?.["prototype"]);
$assert.notConstructable(globalThis["__FACTORY"]?.["prototype"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]?.["prototype"]), ['constructor'], globalThis["__FACTORY"]?.["prototype"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["prototype"]?.["constructor"], globalThis["__FACTORY"]?.["prototype"]);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "name", {
  value: "__PROTO",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["__MONSTER"], "monster");
$assert.sameValue(globalThis["__PREDATOR"], "predator");
$assert.sameValue(globalThis["__PROTO"], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__monster"]), globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__monster"]), true);
$assert.notCallable(globalThis["__monster"]);
$assert.notConstructable(globalThis["__monster"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__monster"]), [], globalThis["__monster"]);
