...
$assert.sameValue($Object_getPrototypeOf(globalThis["_13_0_12_fun"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_13_0_12_fun"]), true);
$assert.callable(globalThis["_13_0_12_fun"]);
$assert.constructable(globalThis["_13_0_12_fun"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_13_0_12_fun"]), ['length', 'name', 'prototype'], globalThis["_13_0_12_fun"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["_13_0_12_fun"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_13_0_12_fun"]?.["prototype"]), true);
$assert.notCallable(globalThis["_13_0_12_fun"]?.["prototype"]);
$assert.notConstructable(globalThis["_13_0_12_fun"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_13_0_12_fun"]?.["prototype"]), ['constructor'], globalThis["_13_0_12_fun"]?.["prototype"]);
$assert.sameValue(globalThis["_13_0_12_fun"]?.["prototype"]?.["constructor"], globalThis["_13_0_12_fun"]);
$verifyProperty(globalThis["_13_0_12_fun"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["_13_0_12_fun"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["_13_0_12_fun"], "name", {
  value: "anonymous",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["_13_0_12_fun"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
