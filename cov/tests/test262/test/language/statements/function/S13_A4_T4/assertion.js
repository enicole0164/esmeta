...
$assert.sameValue($Object_getPrototypeOf(globalThis["func__"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func__"]), true);
$assert.callable(globalThis["func__"]);
$assert.constructable(globalThis["func__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func__"]), ['length', 'name', 'prototype'], globalThis["func__"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["func__"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["func__"]?.["prototype"]), true);
$assert.notCallable(globalThis["func__"]?.["prototype"]);
$assert.notConstructable(globalThis["func__"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["func__"]?.["prototype"]), ['constructor'], globalThis["func__"]?.["prototype"]);
$assert.sameValue(globalThis["func__"]?.["prototype"]?.["constructor"], globalThis["func__"]);
$verifyProperty(globalThis["func__"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func__"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["func__"], "name", {
  value: "func__",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["func__"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
