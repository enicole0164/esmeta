...
$assert.sameValue($Object_getPrototypeOf(globalThis["__music_box"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__music_box"]), true);
$assert.notCallable(globalThis["__music_box"]);
$assert.notConstructable(globalThis["__music_box"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__music_box"]), ['ziggy'], globalThis["__music_box"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__music_box"]?.["ziggy"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__music_box"]?.["ziggy"]), true);
$assert.callable(globalThis["__music_box"]?.["ziggy"]);
$assert.constructable(globalThis["__music_box"]?.["ziggy"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__music_box"]?.["ziggy"]), ['length', 'name', 'prototype'], globalThis["__music_box"]?.["ziggy"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__music_box"]?.["ziggy"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__music_box"]?.["ziggy"]?.["prototype"]), true);
$assert.notCallable(globalThis["__music_box"]?.["ziggy"]?.["prototype"]);
$assert.notConstructable(globalThis["__music_box"]?.["ziggy"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__music_box"]?.["ziggy"]?.["prototype"]), ['constructor'], globalThis["__music_box"]?.["ziggy"]?.["prototype"]);
$assert.sameValue(globalThis["__music_box"]?.["ziggy"]?.["prototype"]?.["constructor"], globalThis["__music_box"]?.["ziggy"]);
$verifyProperty(globalThis["__music_box"]?.["ziggy"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__music_box"]?.["ziggy"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__music_box"]?.["ziggy"], "name", {
  value: "__ziggy__func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__music_box"]?.["ziggy"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__music_box"], "ziggy", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["__ziggy__func"], globalThis["__music_box"]?.["ziggy"]);
