...
$assert.sameValue($Object_getPrototypeOf(globalThis["ref"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["ref"]), true);
$assert.callable(globalThis["ref"]);
$assert.constructable(globalThis["ref"]);
$assert.compareArray($Reflect_ownKeys(globalThis["ref"]), ['length', 'name', 'prototype'], globalThis["ref"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["ref"]?.["prototype"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["ref"]?.["prototype"]), ['constructor'], globalThis["ref"]?.["prototype"]);
$assert.sameValue(globalThis["ref"]?.["prototype"]?.["constructor"], globalThis["ref"]);
$verifyProperty(globalThis["ref"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
