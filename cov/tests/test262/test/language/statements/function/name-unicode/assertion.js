...
$assert.sameValue($Object_getPrototypeOf(globalThis["funcA"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funcA"]), true);
$assert.callable(globalThis["funcA"]);
$assert.constructable(globalThis["funcA"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funcA"]), ['length', 'name', 'prototype'], globalThis["funcA"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["funcA"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["funcA"]?.["prototype"]), true);
$assert.notCallable(globalThis["funcA"]?.["prototype"]);
$assert.notConstructable(globalThis["funcA"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["funcA"]?.["prototype"]), ['constructor'], globalThis["funcA"]?.["prototype"]);
$assert.sameValue(globalThis["funcA"]?.["prototype"]?.["constructor"], globalThis["funcA"]);
$verifyProperty(globalThis["funcA"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funcA"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["funcA"], "name", {
  value: "__funcA",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["funcA"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
