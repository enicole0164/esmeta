...
$assert.sameValue($Object_getPrototypeOf(globalThis["FACTORY"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FACTORY"]), true);
$assert.callable(globalThis["FACTORY"]);
$assert.constructable(globalThis["FACTORY"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FACTORY"]), ['length', 'name', 'prototype'], globalThis["FACTORY"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["FACTORY"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FACTORY"]?.["prototype"]), true);
$assert.notCallable(globalThis["FACTORY"]?.["prototype"]);
$assert.notConstructable(globalThis["FACTORY"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FACTORY"]?.["prototype"]), ['constructor'], globalThis["FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["FACTORY"]?.["prototype"]?.["constructor"], globalThis["FACTORY"]);
$verifyProperty(globalThis["FACTORY"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FACTORY"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["FACTORY"], "name", {
  value: "FACTORY",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FACTORY"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]), globalThis["FACTORY"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['id', 'func'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "id", {
  value: 5.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["func"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["func"]), true);
$assert.callable(globalThis["obj"]?.["func"]);
$assert.constructable(globalThis["obj"]?.["func"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["func"]), ['length', 'name', 'prototype'], globalThis["obj"]?.["func"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["obj"]?.["func"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj"]?.["func"]?.["prototype"]), true);
$assert.notCallable(globalThis["obj"]?.["func"]?.["prototype"]);
$assert.notConstructable(globalThis["obj"]?.["func"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["func"]?.["prototype"]), ['constructor'], globalThis["obj"]?.["func"]?.["prototype"]);
$assert.sameValue(globalThis["obj"]?.["func"]?.["prototype"]?.["constructor"], globalThis["obj"]?.["func"]);
$verifyProperty(globalThis["obj"]?.["func"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["func"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["obj"]?.["func"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"]?.["func"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "func", {
  writable: true,
  enumerable: true,
  configurable: true,
});
