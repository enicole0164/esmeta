...
$assert.sameValue(globalThis["__CUBE"], "cube");
...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['shape', 'printShape'], globalThis["__FACTORY"]?.["prototype"]);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "shape", {
  value: "cube",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]), true);
$assert.callable(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]);
$assert.constructable(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]), ['length', 'name', 'prototype'], globalThis["__FACTORY"]?.["prototype"]?.["printShape"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]), true);
$assert.notCallable(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]);
$assert.notConstructable(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]), ['constructor'], globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]);
$assert.sameValue(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"]?.["constructor"], globalThis["__FACTORY"]?.["prototype"]?.["printShape"]);
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["printShape"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["printShape"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["printShape"], "name", {
  value: "printShape",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"]?.["printShape"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__FACTORY"]?.["prototype"], "printShape", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__device"]), globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__device"]), true);
$assert.notCallable(globalThis["__device"]);
$assert.notConstructable(globalThis["__device"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__device"]), [], globalThis["__device"]);
