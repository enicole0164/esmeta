...
$assert.sameValue($Object_getPrototypeOf(globalThis["__func"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func"]), true);
$assert.callable(globalThis["__func"]);
$assert.constructable(globalThis["__func"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func"]), ['length', 'name', 'prototype'], globalThis["__func"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func"]?.["prototype"]);
$assert.notConstructable(globalThis["__func"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func"]?.["prototype"]), ['constructor'], globalThis["__func"]?.["prototype"]);
$assert.sameValue(globalThis["__func"]?.["prototype"]?.["constructor"], globalThis["__func"]);
$verifyProperty(globalThis["__func"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func"], "name", {
  value: "__func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__2"]), true);
$assert.callable(globalThis["__func__2"]);
$assert.constructable(globalThis["__func__2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__2"]), ['length', 'name', 'prototype'], globalThis["__func__2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__2"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__2"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__2"]?.["prototype"]), ['constructor'], globalThis["__func__2"]?.["prototype"]);
$assert.sameValue(globalThis["__func__2"]?.["prototype"]?.["constructor"], globalThis["__func__2"]);
$verifyProperty(globalThis["__func__2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__2"], "name", {
  value: "__func__2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__3"]), true);
$assert.callable(globalThis["__func__3"]);
$assert.constructable(globalThis["__func__3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__3"]), ['length', 'name', 'prototype'], globalThis["__func__3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__3"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__3"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__3"]?.["prototype"]), ['constructor'], globalThis["__func__3"]?.["prototype"]);
$assert.sameValue(globalThis["__func__3"]?.["prototype"]?.["constructor"], globalThis["__func__3"]);
$verifyProperty(globalThis["__func__3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__3"], "name", {
  value: "__func__3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__4"]), true);
$assert.callable(globalThis["__func__4"]);
$assert.constructable(globalThis["__func__4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__4"]), ['length', 'name', 'prototype'], globalThis["__func__4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__4"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__4"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__4"]?.["prototype"]), ['constructor'], globalThis["__func__4"]?.["prototype"]);
$assert.sameValue(globalThis["__func__4"]?.["prototype"]?.["constructor"], globalThis["__func__4"]);
$verifyProperty(globalThis["__func__4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__4"], "name", {
  value: "__func__4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__5"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__5"]), true);
$assert.callable(globalThis["__func__5"]);
$assert.constructable(globalThis["__func__5"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__5"]), ['length', 'name', 'prototype'], globalThis["__func__5"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__5"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__5"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__5"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__5"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__5"]?.["prototype"]), ['constructor'], globalThis["__func__5"]?.["prototype"]);
$assert.sameValue(globalThis["__func__5"]?.["prototype"]?.["constructor"], globalThis["__func__5"]);
$verifyProperty(globalThis["__func__5"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__5"], "name", {
  value: "__func__5",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__5"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__6"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__6"]), true);
$assert.callable(globalThis["__func__6"]);
$assert.constructable(globalThis["__func__6"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__6"]), ['length', 'name', 'prototype'], globalThis["__func__6"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__6"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__6"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__6"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__6"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__6"]?.["prototype"]), ['constructor'], globalThis["__func__6"]?.["prototype"]);
$assert.sameValue(globalThis["__func__6"]?.["prototype"]?.["constructor"], globalThis["__func__6"]);
$verifyProperty(globalThis["__func__6"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__6"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__6"], "name", {
  value: "__func__6",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__6"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
