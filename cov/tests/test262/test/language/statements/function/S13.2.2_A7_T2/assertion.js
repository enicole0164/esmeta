...
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj__"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__obj__"]), true);
$assert.notCallable(globalThis["__obj__"]);
$assert.notConstructable(globalThis["__obj__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj__"]), ['second'], globalThis["__obj__"]);
$verifyProperty(globalThis["__obj__"], "second", {
  value: "two",
  writable: true,
  enumerable: true,
  configurable: true,
