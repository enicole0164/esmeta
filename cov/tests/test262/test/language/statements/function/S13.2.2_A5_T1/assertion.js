...
$assert.sameValue(globalThis["__BOTTOM"], 1.1);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__FACTORY"]?.["prototype"]), ['constructor'], globalThis["__FACTORY"]?.["prototype"]);
...
$assert.sameValue(globalThis["__ID"], 12342.0);
$assert.sameValue(globalThis["__LEFT"], 0.5);
$assert.sameValue(globalThis["__RED"], "red");
$assert.sameValue(globalThis["__TOP"], 0.1);
$assert.sameValue(globalThis["__VOLUME"], 8.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__device"]), ['volume', 'id', 'top'], globalThis["__device"]);
$verifyProperty(globalThis["__device"], "id", {
  value: 12342.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__device"], "volume", {
  value: 8.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__device"], "top", {
  value: 0.1,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["bottom"], 1.1);
$assert.sameValue(globalThis["color"], "red");
$assert.sameValue(globalThis["left"], 0.5);
