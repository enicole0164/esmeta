...
$assert.sameValue(globalThis["desc"]?.["value"], Object);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fun"]?.["prototype"]), [], globalThis["fun"]?.["prototype"]);
...
$assert.sameValue(globalThis["verifyWritable"], true);
