...
$assert.sameValue(globalThis["__PLANT"], "flower");
$assert.sameValue(globalThis["__PROTO"], globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(globalThis["__ROSE"], "rose");
$assert.sameValue($Object_getPrototypeOf(globalThis["__rose"]), globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__rose"]), true);
$assert.notCallable(globalThis["__rose"]);
$assert.notConstructable(globalThis["__rose"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__rose"]), [], globalThis["__rose"]);
