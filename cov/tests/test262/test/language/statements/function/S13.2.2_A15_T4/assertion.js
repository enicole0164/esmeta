...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['prop', 'slot'], globalThis["__obj"]);
$verifyProperty(globalThis["__obj"], "prop", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]?.["slot"]), globalThis["__FACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__obj"]?.["slot"]), true);
$assert.notCallable(globalThis["__obj"]?.["slot"]);
$assert.notConstructable(globalThis["__obj"]?.["slot"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]?.["slot"]), ['prop'], globalThis["__obj"]?.["slot"]);
$verifyProperty(globalThis["__obj"]?.["slot"], "prop", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["__obj"], "slot", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["obj"], globalThis["__obj"]);
