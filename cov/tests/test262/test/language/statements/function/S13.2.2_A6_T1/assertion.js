...
$assert.sameValue(globalThis["__BAR"], "barValue");
$assert.sameValue(globalThis["__FOO"], "fooValue");
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"]), globalThis["__func"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['foo'], globalThis["__obj"]);
$verifyProperty(globalThis["__obj"], "foo", {
  value: "fooValue",
  writable: true,
  enumerable: true,
  configurable: true,
