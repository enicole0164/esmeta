...
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__INC"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__INC"]), true);
$assert.callable(globalThis["__func__INC"]);
$assert.constructable(globalThis["__func__INC"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__INC"]), ['length', 'name', 'prototype'], globalThis["__func__INC"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__INC"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__INC"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__INC"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__INC"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__INC"]?.["prototype"]), ['constructor'], globalThis["__func__INC"]?.["prototype"]);
$assert.sameValue(globalThis["__func__INC"]?.["prototype"]?.["constructor"], globalThis["__func__INC"]);
$verifyProperty(globalThis["__func__INC"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__INC"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__INC"], "name", {
  value: "__func__INC",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__INC"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__MULT"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__MULT"]), true);
$assert.callable(globalThis["__func__MULT"]);
$assert.constructable(globalThis["__func__MULT"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__MULT"]), ['length', 'name', 'prototype'], globalThis["__func__MULT"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__func__MULT"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__func__MULT"]?.["prototype"]), true);
$assert.notCallable(globalThis["__func__MULT"]?.["prototype"]);
$assert.notConstructable(globalThis["__func__MULT"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__func__MULT"]?.["prototype"]), ['constructor'], globalThis["__func__MULT"]?.["prototype"]);
$assert.sameValue(globalThis["__func__MULT"]?.["prototype"]?.["constructor"], globalThis["__func__MULT"]);
$verifyProperty(globalThis["__func__MULT"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__MULT"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__func__MULT"], "name", {
  value: "__func__MULT",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__func__MULT"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
