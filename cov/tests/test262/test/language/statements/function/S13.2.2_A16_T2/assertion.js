...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["__obj"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["__obj"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["__obj"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["__obj"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["__obj"])), ['constructor'], $Object_getPrototypeOf(globalThis["__obj"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["__obj"]));
$verifyProperty($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"], "name", {
  value: "__func",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["__obj"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["__obj"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['prop'], globalThis["__obj"]);
