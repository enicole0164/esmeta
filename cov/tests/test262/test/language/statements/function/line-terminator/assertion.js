...
$assert.sameValue($Object_getPrototypeOf(globalThis["w"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["w"]), true);
$assert.callable(globalThis["w"]);
$assert.constructable(globalThis["w"]);
$assert.compareArray($Reflect_ownKeys(globalThis["w"]), ['length', 'name', 'prototype'], globalThis["w"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["w"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["w"]?.["prototype"]), true);
$assert.notCallable(globalThis["w"]?.["prototype"]);
$assert.notConstructable(globalThis["w"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["w"]?.["prototype"]), ['constructor'], globalThis["w"]?.["prototype"]);
$assert.sameValue(globalThis["w"]?.["prototype"]?.["constructor"], globalThis["w"]);
$verifyProperty(globalThis["w"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["w"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["w"], "name", {
  value: "w",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["w"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]), true);
$assert.callable(globalThis["y"]);
$assert.constructable(globalThis["y"]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]), ['length', 'name', 'prototype'], globalThis["y"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["y"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["y"]?.["prototype"]), true);
$assert.notCallable(globalThis["y"]?.["prototype"]);
$assert.notConstructable(globalThis["y"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["y"]?.["prototype"]), ['constructor'], globalThis["y"]?.["prototype"]);
$assert.sameValue(globalThis["y"]?.["prototype"]?.["constructor"], globalThis["y"]);
$verifyProperty(globalThis["y"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["y"], "name", {
  value: "y",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["y"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["z"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["z"]), true);
$assert.callable(globalThis["z"]);
$assert.constructable(globalThis["z"]);
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), ['length', 'name', 'prototype'], globalThis["z"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["z"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["z"]?.["prototype"]), true);
$assert.notCallable(globalThis["z"]?.["prototype"]);
$assert.notConstructable(globalThis["z"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["z"]?.["prototype"]), ['constructor'], globalThis["z"]?.["prototype"]);
$assert.sameValue(globalThis["z"]?.["prototype"]?.["constructor"], globalThis["z"]);
$verifyProperty(globalThis["z"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["z"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["z"], "name", {
  value: "z",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["z"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
