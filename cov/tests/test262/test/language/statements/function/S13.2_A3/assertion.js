...
$assert.sameValue($Object_getPrototypeOf(globalThis["__gunc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__gunc"]), true);
$assert.callable(globalThis["__gunc"]);
$assert.constructable(globalThis["__gunc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__gunc"]), ['length', 'name', 'prototype'], globalThis["__gunc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__gunc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__gunc"]?.["prototype"]), true);
$assert.notCallable(globalThis["__gunc"]?.["prototype"]);
$assert.notConstructable(globalThis["__gunc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__gunc"]?.["prototype"]), ['constructor'], globalThis["__gunc"]?.["prototype"]);
$assert.sameValue(globalThis["__gunc"]?.["prototype"]?.["constructor"], globalThis["__gunc"]);
$verifyProperty(globalThis["__gunc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__gunc"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__gunc"], "name", {
  value: "__gunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__gunc"], "length", {
  value: 3.0,
  writable: false,
  enumerable: false,
  configurable: true,
