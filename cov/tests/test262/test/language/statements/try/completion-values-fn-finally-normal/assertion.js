...
$assert.sameValue($Object_getPrototypeOf(globalThis["count"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["count"]), true);
$assert.notCallable(globalThis["count"]);
$assert.notConstructable(globalThis["count"]);
$assert.compareArray($Reflect_ownKeys(globalThis["count"]), ['catch', 'finally'], globalThis["count"]);
$verifyProperty(globalThis["count"], "catch", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["count"], "finally", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
