...
$assert.sameValue(globalThis["c1"], 1.0);
$assert.sameValue(globalThis["c2"], 1.0);
$assert.sameValue(globalThis["c3"], 1.0);
$assert.sameValue(globalThis["c4"], 1.0);
$assert.sameValue(globalThis["c5"], 1.0);
$assert.sameValue(globalThis["c6"], 1.0);
$assert.sameValue(globalThis["c7"], 1.0);
$assert.sameValue(globalThis["c8"], 1.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction1"]), true);
$assert.callable(globalThis["myFunction1"]);
$assert.constructable(globalThis["myFunction1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction1"]), ['length', 'name', 'prototype'], globalThis["myFunction1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction1"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction1"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction1"]?.["prototype"]), ['constructor'], globalThis["myFunction1"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction1"]?.["prototype"]?.["constructor"], globalThis["myFunction1"]);
$verifyProperty(globalThis["myFunction1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction1"], "name", {
  value: "myFunction1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction2"]), true);
$assert.callable(globalThis["myFunction2"]);
$assert.constructable(globalThis["myFunction2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction2"]), ['length', 'name', 'prototype'], globalThis["myFunction2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction2"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction2"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction2"]?.["prototype"]), ['constructor'], globalThis["myFunction2"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction2"]?.["prototype"]?.["constructor"], globalThis["myFunction2"]);
$verifyProperty(globalThis["myFunction2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction2"], "name", {
  value: "myFunction2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction3"]), true);
$assert.callable(globalThis["myFunction3"]);
$assert.constructable(globalThis["myFunction3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction3"]), ['length', 'name', 'prototype'], globalThis["myFunction3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction3"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction3"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction3"]?.["prototype"]), ['constructor'], globalThis["myFunction3"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction3"]?.["prototype"]?.["constructor"], globalThis["myFunction3"]);
$verifyProperty(globalThis["myFunction3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction3"], "name", {
  value: "myFunction3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction4"]), true);
$assert.callable(globalThis["myFunction4"]);
$assert.constructable(globalThis["myFunction4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction4"]), ['length', 'name', 'prototype'], globalThis["myFunction4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction4"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction4"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction4"]?.["prototype"]), ['constructor'], globalThis["myFunction4"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction4"]?.["prototype"]?.["constructor"], globalThis["myFunction4"]);
$verifyProperty(globalThis["myFunction4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction4"], "name", {
  value: "myFunction4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction4"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction5"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction5"]), true);
$assert.callable(globalThis["myFunction5"]);
$assert.constructable(globalThis["myFunction5"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction5"]), ['length', 'name', 'prototype'], globalThis["myFunction5"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction5"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction5"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction5"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction5"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction5"]?.["prototype"]), ['constructor'], globalThis["myFunction5"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction5"]?.["prototype"]?.["constructor"], globalThis["myFunction5"]);
$verifyProperty(globalThis["myFunction5"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction5"], "name", {
  value: "myFunction5",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction5"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction6"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction6"]), true);
$assert.callable(globalThis["myFunction6"]);
$assert.constructable(globalThis["myFunction6"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction6"]), ['length', 'name', 'prototype'], globalThis["myFunction6"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction6"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction6"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction6"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction6"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction6"]?.["prototype"]), ['constructor'], globalThis["myFunction6"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction6"]?.["prototype"]?.["constructor"], globalThis["myFunction6"]);
$verifyProperty(globalThis["myFunction6"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction6"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction6"], "name", {
  value: "myFunction6",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction6"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction7"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction7"]), true);
$assert.callable(globalThis["myFunction7"]);
$assert.constructable(globalThis["myFunction7"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction7"]), ['length', 'name', 'prototype'], globalThis["myFunction7"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction7"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction7"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction7"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction7"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction7"]?.["prototype"]), ['constructor'], globalThis["myFunction7"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction7"]?.["prototype"]?.["constructor"], globalThis["myFunction7"]);
$verifyProperty(globalThis["myFunction7"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction7"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction7"], "name", {
  value: "myFunction7",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction7"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction8"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction8"]), true);
$assert.callable(globalThis["myFunction8"]);
$assert.constructable(globalThis["myFunction8"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction8"]), ['length', 'name', 'prototype'], globalThis["myFunction8"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myFunction8"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myFunction8"]?.["prototype"]), true);
$assert.notCallable(globalThis["myFunction8"]?.["prototype"]);
$assert.notConstructable(globalThis["myFunction8"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myFunction8"]?.["prototype"]), ['constructor'], globalThis["myFunction8"]?.["prototype"]);
$assert.sameValue(globalThis["myFunction8"]?.["prototype"]?.["constructor"], globalThis["myFunction8"]);
$verifyProperty(globalThis["myFunction8"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction8"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myFunction8"], "name", {
  value: "myFunction8",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myFunction8"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["x1"], 1.0);
$assert.sameValue(globalThis["x2"], undefined);
$assert.sameValue(globalThis["x3"], undefined);
$assert.sameValue(globalThis["x4"], undefined);
$assert.sameValue(globalThis["x5"], undefined);
$assert.sameValue(globalThis["x6"], undefined);
$assert.sameValue(globalThis["x7"], 2.0);
$assert.sameValue(globalThis["x8"], 2.0);
