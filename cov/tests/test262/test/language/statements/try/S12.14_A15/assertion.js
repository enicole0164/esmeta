...
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest1"]), true);
$assert.callable(globalThis["SwitchTest1"]);
$assert.constructable(globalThis["SwitchTest1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest1"]), ['length', 'name', 'prototype'], globalThis["SwitchTest1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest1"]?.["prototype"]), true);
$assert.notCallable(globalThis["SwitchTest1"]?.["prototype"]);
$assert.notConstructable(globalThis["SwitchTest1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest1"]?.["prototype"]), ['constructor'], globalThis["SwitchTest1"]?.["prototype"]);
$assert.sameValue(globalThis["SwitchTest1"]?.["prototype"]?.["constructor"], globalThis["SwitchTest1"]);
$verifyProperty(globalThis["SwitchTest1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SwitchTest1"], "name", {
  value: "SwitchTest1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest2"]), true);
$assert.callable(globalThis["SwitchTest2"]);
$assert.constructable(globalThis["SwitchTest2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest2"]), ['length', 'name', 'prototype'], globalThis["SwitchTest2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest2"]?.["prototype"]), true);
$assert.notCallable(globalThis["SwitchTest2"]?.["prototype"]);
$assert.notConstructable(globalThis["SwitchTest2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest2"]?.["prototype"]), ['constructor'], globalThis["SwitchTest2"]?.["prototype"]);
$assert.sameValue(globalThis["SwitchTest2"]?.["prototype"]?.["constructor"], globalThis["SwitchTest2"]);
$verifyProperty(globalThis["SwitchTest2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SwitchTest2"], "name", {
  value: "SwitchTest2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest2"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest3"]), true);
$assert.callable(globalThis["SwitchTest3"]);
$assert.constructable(globalThis["SwitchTest3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest3"]), ['length', 'name', 'prototype'], globalThis["SwitchTest3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest3"]?.["prototype"]), true);
$assert.notCallable(globalThis["SwitchTest3"]?.["prototype"]);
$assert.notConstructable(globalThis["SwitchTest3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest3"]?.["prototype"]), ['constructor'], globalThis["SwitchTest3"]?.["prototype"]);
$assert.sameValue(globalThis["SwitchTest3"]?.["prototype"]?.["constructor"], globalThis["SwitchTest3"]);
$verifyProperty(globalThis["SwitchTest3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SwitchTest3"], "name", {
  value: "SwitchTest3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest3"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["x3"], 2.0);
