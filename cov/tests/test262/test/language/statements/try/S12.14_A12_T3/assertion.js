...
$assert.sameValue(globalThis["c5"], 0.0);
$assert.sameValue(globalThis["c6"], 1.0);
$assert.sameValue(globalThis["c7"], 1.0);
$assert.sameValue(globalThis["fin"], 1.0);
$assert.sameValue(globalThis["fin2"], 1.0);
$assert.sameValue(globalThis["fin3"], 1.0);
$assert.sameValue(globalThis["fin4"], 1.0);
$assert.sameValue(globalThis["fin7"], 1.0);
...
$assert.sameValue(globalThis["x"], "0");
