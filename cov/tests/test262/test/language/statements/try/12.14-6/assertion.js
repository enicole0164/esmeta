...
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["foo"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["foo"]), true);
$assert.callable(globalThis["o"]?.["foo"]);
$assert.constructable(globalThis["o"]?.["foo"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["foo"]), ['length', 'name', 'prototype'], globalThis["o"]?.["foo"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]?.["foo"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]?.["foo"]?.["prototype"]), true);
$assert.notCallable(globalThis["o"]?.["foo"]?.["prototype"]);
$assert.notConstructable(globalThis["o"]?.["foo"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]?.["foo"]?.["prototype"]), ['constructor'], globalThis["o"]?.["foo"]?.["prototype"]);
$assert.sameValue(globalThis["o"]?.["foo"]?.["prototype"]?.["constructor"], globalThis["o"]?.["foo"]);
$verifyProperty(globalThis["o"]?.["foo"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["foo"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["o"]?.["foo"], "name", {
  value: "foo",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["o"]?.["foo"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
