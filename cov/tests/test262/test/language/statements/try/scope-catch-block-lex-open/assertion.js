...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeBlock"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeBlock"]), true);
$assert.callable(globalThis["probeBlock"]);
$assert.constructable(globalThis["probeBlock"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeBlock"]), ['length', 'name', 'prototype'], globalThis["probeBlock"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeBlock"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeBlock"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeBlock"]?.["prototype"]);
$assert.notConstructable(globalThis["probeBlock"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeBlock"]?.["prototype"]), ['constructor'], globalThis["probeBlock"]?.["prototype"]);
$assert.sameValue(globalThis["probeBlock"]?.["prototype"]?.["constructor"], globalThis["probeBlock"]);
$verifyProperty(globalThis["probeBlock"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeBlock"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeBlock"], "name", {
  value: "probeBlock",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeBlock"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
