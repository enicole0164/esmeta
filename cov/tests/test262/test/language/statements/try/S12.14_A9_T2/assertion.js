...
$assert.sameValue(globalThis["c1"], 2.0);
$assert.sameValue(globalThis["c2"], 2.0);
$assert.sameValue(globalThis["c3"], 2.0);
$assert.sameValue(globalThis["c4"], 2.0);
$assert.sameValue(globalThis["c5"], 2.0);
$assert.sameValue(globalThis["c6"], 2.0);
