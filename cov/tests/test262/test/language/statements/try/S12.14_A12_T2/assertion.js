...
$assert.sameValue(globalThis["c2"], 3.0);
$assert.sameValue(globalThis["c3"], 3.0);
$assert.sameValue(globalThis["c5"], 3.0);
$assert.sameValue(globalThis["c6"], 3.0);
$assert.sameValue(globalThis["fin"], 1.0);
$assert.sameValue(globalThis["fin2"], 1.0);
$assert.sameValue(globalThis["fin3"], 1.0);
$assert.sameValue(globalThis["fin6"], 1.0);
...
$assert.sameValue(globalThis["x"], "2");
