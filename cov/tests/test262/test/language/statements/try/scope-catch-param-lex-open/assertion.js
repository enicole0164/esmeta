...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeParam"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeParam"]), true);
$assert.callable(globalThis["probeParam"]);
$assert.constructable(globalThis["probeParam"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeParam"]), ['length', 'name', 'prototype'], globalThis["probeParam"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeParam"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeParam"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeParam"]?.["prototype"]);
$assert.notConstructable(globalThis["probeParam"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeParam"]?.["prototype"]), ['constructor'], globalThis["probeParam"]?.["prototype"]);
$assert.sameValue(globalThis["probeParam"]?.["prototype"]?.["constructor"], globalThis["probeParam"]);
$verifyProperty(globalThis["probeParam"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeParam"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeParam"], "name", {
  value: "probeParam",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeParam"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeTry"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeTry"]), true);
$assert.callable(globalThis["probeTry"]);
$assert.constructable(globalThis["probeTry"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeTry"]), ['length', 'name', 'prototype'], globalThis["probeTry"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeTry"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeTry"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeTry"]?.["prototype"]);
$assert.notConstructable(globalThis["probeTry"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeTry"]?.["prototype"]), ['constructor'], globalThis["probeTry"]?.["prototype"]);
$assert.sameValue(globalThis["probeTry"]?.["prototype"]?.["constructor"], globalThis["probeTry"]);
$verifyProperty(globalThis["probeTry"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeTry"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeTry"], "name", {
  value: "probeTry",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeTry"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
