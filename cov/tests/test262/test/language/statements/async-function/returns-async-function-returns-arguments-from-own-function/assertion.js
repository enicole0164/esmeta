...
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncFn"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["asyncFn"]), true);
$assert.callable(globalThis["asyncFn"]);
$assert.notConstructable(globalThis["asyncFn"]);
$assert.compareArray($Reflect_ownKeys(globalThis["asyncFn"]), ['length', 'name'], globalThis["asyncFn"]);
$verifyProperty(globalThis["asyncFn"], "name", {
  value: "asyncFn",
  writable: false,
  enumerable: false,
  configurable: true,
