...
$assert.sameValue($Object_getPrototypeOf(globalThis["adding1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding1"]), true);
$assert.callable(globalThis["adding1"]);
$assert.constructable(globalThis["adding1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding1"]), ['length', 'name', 'prototype'], globalThis["adding1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["adding1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding1"]?.["prototype"]), true);
$assert.notCallable(globalThis["adding1"]?.["prototype"]);
$assert.notConstructable(globalThis["adding1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding1"]?.["prototype"]), ['constructor'], globalThis["adding1"]?.["prototype"]);
$assert.sameValue(globalThis["adding1"]?.["prototype"]?.["constructor"], globalThis["adding1"]);
$verifyProperty(globalThis["adding1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["adding1"], "name", {
  value: "adding1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["adding2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding2"]), true);
$assert.callable(globalThis["adding2"]);
$assert.constructable(globalThis["adding2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding2"]), ['length', 'name', 'prototype'], globalThis["adding2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["adding2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding2"]?.["prototype"]), true);
$assert.notCallable(globalThis["adding2"]?.["prototype"]);
$assert.notConstructable(globalThis["adding2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding2"]?.["prototype"]), ['constructor'], globalThis["adding2"]?.["prototype"]);
$assert.sameValue(globalThis["adding2"]?.["prototype"]?.["constructor"], globalThis["adding2"]);
$verifyProperty(globalThis["adding2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["adding2"], "name", {
  value: "adding2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["adding3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding3"]), true);
$assert.callable(globalThis["adding3"]);
$assert.constructable(globalThis["adding3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding3"]), ['length', 'name', 'prototype'], globalThis["adding3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["adding3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding3"]?.["prototype"]), true);
$assert.notCallable(globalThis["adding3"]?.["prototype"]);
$assert.notConstructable(globalThis["adding3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding3"]?.["prototype"]), ['constructor'], globalThis["adding3"]?.["prototype"]);
$assert.sameValue(globalThis["adding3"]?.["prototype"]?.["constructor"], globalThis["adding3"]);
$verifyProperty(globalThis["adding3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["adding3"], "name", {
  value: "adding3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["adding4"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding4"]), true);
$assert.callable(globalThis["adding4"]);
$assert.constructable(globalThis["adding4"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding4"]), ['length', 'name', 'prototype'], globalThis["adding4"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["adding4"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["adding4"]?.["prototype"]), true);
$assert.notCallable(globalThis["adding4"]?.["prototype"]);
$assert.notConstructable(globalThis["adding4"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["adding4"]?.["prototype"]), ['constructor'], globalThis["adding4"]?.["prototype"]);
$assert.sameValue(globalThis["adding4"]?.["prototype"]?.["constructor"], globalThis["adding4"]);
$verifyProperty(globalThis["adding4"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding4"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["adding4"], "name", {
  value: "adding4",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["adding4"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
