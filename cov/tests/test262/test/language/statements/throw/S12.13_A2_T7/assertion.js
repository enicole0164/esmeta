...
$assert.sameValue($Object_getPrototypeOf(globalThis["mycars"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mycars"]), true);
$assert.notCallable(globalThis["mycars"]);
$assert.notConstructable(globalThis["mycars"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mycars"]), ['0', '1', '2', 'length'], globalThis["mycars"]);
$verifyProperty(globalThis["mycars"], "1", {
  value: "Volvo",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["mycars"], "2", {
  value: "BMW",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["mycars"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["mycars"], "0", {
  value: "Saab",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["mycars2"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["mycars2"]), true);
$assert.notCallable(globalThis["mycars2"]);
$assert.notConstructable(globalThis["mycars2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["mycars2"]), ['0', '1', '2', 'length'], globalThis["mycars2"]);
$verifyProperty(globalThis["mycars2"], "1", {
  value: "Jeep",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["mycars2"], "2", {
  value: "Suzuki",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["mycars2"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["mycars2"], "0", {
  value: "Mercedes",
  writable: true,
  enumerable: true,
  configurable: true,
