...
$assert.sameValue(globalThis["__in__do__IN__before__break"], "in");
$assert.sameValue(globalThis["__in__do__after__break"], undefined);
$assert.sameValue(globalThis["__in__do__before__break"], "once");
