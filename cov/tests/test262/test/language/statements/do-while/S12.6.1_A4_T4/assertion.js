...
$assert.sameValue(globalThis["__in__do__IN__after__break"], undefined);
$assert.sameValue(globalThis["__in__do__IN__before__break"], "reached");
$assert.sameValue(globalThis["__in__do__after__break"], "where am i");
$assert.sameValue(globalThis["__in__do__before__break"], "reached");
