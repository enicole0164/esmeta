...
$assert.sameValue(globalThis["__in__do__IN__before__break"], "hole");
$assert.sameValue(globalThis["__in__do__after__break"], "won't you come");
$assert.sameValue(globalThis["__in__do__before__break"], "black");
