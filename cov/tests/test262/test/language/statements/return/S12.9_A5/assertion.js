...
$assert.sameValue($Object_getPrototypeOf(globalThis["myfunc1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myfunc1"]), true);
$assert.callable(globalThis["myfunc1"]);
$assert.constructable(globalThis["myfunc1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myfunc1"]), ['length', 'name', 'prototype'], globalThis["myfunc1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myfunc1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myfunc1"]?.["prototype"]), true);
$assert.notCallable(globalThis["myfunc1"]?.["prototype"]);
$assert.notConstructable(globalThis["myfunc1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myfunc1"]?.["prototype"]), ['constructor'], globalThis["myfunc1"]?.["prototype"]);
$assert.sameValue(globalThis["myfunc1"]?.["prototype"]?.["constructor"], globalThis["myfunc1"]);
$verifyProperty(globalThis["myfunc1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myfunc1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myfunc1"], "name", {
  value: "myfunc1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myfunc1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myfunc2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myfunc2"]), true);
$assert.callable(globalThis["myfunc2"]);
$assert.constructable(globalThis["myfunc2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myfunc2"]), ['length', 'name', 'prototype'], globalThis["myfunc2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myfunc2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myfunc2"]?.["prototype"]), true);
$assert.notCallable(globalThis["myfunc2"]?.["prototype"]);
$assert.notConstructable(globalThis["myfunc2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myfunc2"]?.["prototype"]), ['constructor'], globalThis["myfunc2"]?.["prototype"]);
$assert.sameValue(globalThis["myfunc2"]?.["prototype"]?.["constructor"], globalThis["myfunc2"]);
$verifyProperty(globalThis["myfunc2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myfunc2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myfunc2"], "name", {
  value: "myfunc2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myfunc2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["myfunc3"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myfunc3"]), true);
$assert.callable(globalThis["myfunc3"]);
$assert.constructable(globalThis["myfunc3"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myfunc3"]), ['length', 'name', 'prototype'], globalThis["myfunc3"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["myfunc3"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["myfunc3"]?.["prototype"]), true);
$assert.notCallable(globalThis["myfunc3"]?.["prototype"]);
$assert.notConstructable(globalThis["myfunc3"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["myfunc3"]?.["prototype"]), ['constructor'], globalThis["myfunc3"]?.["prototype"]);
$assert.sameValue(globalThis["myfunc3"]?.["prototype"]?.["constructor"], globalThis["myfunc3"]);
$verifyProperty(globalThis["myfunc3"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myfunc3"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["myfunc3"], "name", {
  value: "myfunc3",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["myfunc3"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["x1"], 2.0);
