...
$assert.sameValue($Object_getPrototypeOf(globalThis["probe1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probe1"]), true);
$assert.callable(globalThis["probe1"]);
$assert.constructable(globalThis["probe1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probe1"]), ['length', 'name', 'prototype'], globalThis["probe1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probe1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probe1"]?.["prototype"]), true);
$assert.notCallable(globalThis["probe1"]?.["prototype"]);
$assert.notConstructable(globalThis["probe1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probe1"]?.["prototype"]), ['constructor'], globalThis["probe1"]?.["prototype"]);
$assert.sameValue(globalThis["probe1"]?.["prototype"]?.["constructor"], globalThis["probe1"]);
$verifyProperty(globalThis["probe1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probe1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probe1"], "name", {
  value: "probe1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probe1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probe2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probe2"]), true);
$assert.callable(globalThis["probe2"]);
$assert.constructable(globalThis["probe2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probe2"]), ['length', 'name', 'prototype'], globalThis["probe2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probe2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probe2"]?.["prototype"]), true);
$assert.notCallable(globalThis["probe2"]?.["prototype"]);
$assert.notConstructable(globalThis["probe2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probe2"]?.["prototype"]), ['constructor'], globalThis["probe2"]?.["prototype"]);
$assert.sameValue(globalThis["probe2"]?.["prototype"]?.["constructor"], globalThis["probe2"]);
$verifyProperty(globalThis["probe2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probe2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probe2"], "name", {
  value: "probe2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probe2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
