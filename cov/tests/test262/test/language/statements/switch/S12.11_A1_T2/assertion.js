...
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest"]), true);
$assert.callable(globalThis["SwitchTest"]);
$assert.constructable(globalThis["SwitchTest"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest"]), ['length', 'name', 'prototype'], globalThis["SwitchTest"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["SwitchTest"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["SwitchTest"]?.["prototype"]), true);
$assert.notCallable(globalThis["SwitchTest"]?.["prototype"]);
$assert.notConstructable(globalThis["SwitchTest"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["SwitchTest"]?.["prototype"]), ['constructor'], globalThis["SwitchTest"]?.["prototype"]);
$assert.sameValue(globalThis["SwitchTest"]?.["prototype"]?.["constructor"], globalThis["SwitchTest"]);
$verifyProperty(globalThis["SwitchTest"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["SwitchTest"], "name", {
  value: "SwitchTest",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["SwitchTest"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["x"]), Number.prototype);
