...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeSelector"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeSelector"]), true);
$assert.callable(globalThis["probeSelector"]);
$assert.constructable(globalThis["probeSelector"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeSelector"]), ['length', 'name', 'prototype'], globalThis["probeSelector"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeSelector"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeSelector"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeSelector"]?.["prototype"]);
$assert.notConstructable(globalThis["probeSelector"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeSelector"]?.["prototype"]), ['constructor'], globalThis["probeSelector"]?.["prototype"]);
$assert.sameValue(globalThis["probeSelector"]?.["prototype"]?.["constructor"], globalThis["probeSelector"]);
$verifyProperty(globalThis["probeSelector"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeSelector"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeSelector"], "name", {
  value: "probeSelector",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeSelector"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeStmt"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeStmt"]), true);
$assert.callable(globalThis["probeStmt"]);
$assert.constructable(globalThis["probeStmt"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeStmt"]), ['length', 'name', 'prototype'], globalThis["probeStmt"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeStmt"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeStmt"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeStmt"]?.["prototype"]);
$assert.notConstructable(globalThis["probeStmt"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeStmt"]?.["prototype"]), ['constructor'], globalThis["probeStmt"]?.["prototype"]);
$assert.sameValue(globalThis["probeStmt"]?.["prototype"]?.["constructor"], globalThis["probeStmt"]);
$verifyProperty(globalThis["probeStmt"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeStmt"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeStmt"], "name", {
  value: "probeStmt",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeStmt"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
