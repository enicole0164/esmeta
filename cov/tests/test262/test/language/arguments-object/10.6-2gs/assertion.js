...
$assert.sameValue($Object_getPrototypeOf(globalThis["f_10_6_1_gs"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f_10_6_1_gs"]), true);
$assert.callable(globalThis["f_10_6_1_gs"]);
$assert.constructable(globalThis["f_10_6_1_gs"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f_10_6_1_gs"]), ['length', 'name', 'prototype'], globalThis["f_10_6_1_gs"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f_10_6_1_gs"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f_10_6_1_gs"]?.["prototype"]), true);
$assert.notCallable(globalThis["f_10_6_1_gs"]?.["prototype"]);
$assert.notConstructable(globalThis["f_10_6_1_gs"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f_10_6_1_gs"]?.["prototype"]), ['constructor'], globalThis["f_10_6_1_gs"]?.["prototype"]);
$assert.sameValue(globalThis["f_10_6_1_gs"]?.["prototype"]?.["constructor"], globalThis["f_10_6_1_gs"]);
$verifyProperty(globalThis["f_10_6_1_gs"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f_10_6_1_gs"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f_10_6_1_gs"], "name", {
  value: "f_10_6_1_gs",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f_10_6_1_gs"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
