...
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]), ['length', 'name', 'prototype'], globalThis["f1"]);
...
$verifyProperty(globalThis["f1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["f2"]), ['length', 'name', 'prototype'], globalThis["f2"]);
...
$verifyProperty(globalThis["f2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['length', 'callee', Symbol.iterator], globalThis["x"]);
$assert.sameValue(globalThis["x"]?.[Symbol.iterator], Array.prototype.values);
$verifyProperty(globalThis["x"], Symbol.iterator, {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["x"], "callee")?.get, ThrowTypeError);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["x"], "callee")?.set, ThrowTypeError);
$verifyProperty(globalThis["x"], "callee", {
  enumerable: false,
  configurable: false,
});
