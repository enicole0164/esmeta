...
$assert.sameValue($Object_getPrototypeOf(globalThis["dflt"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["dflt"]), true);
$assert.callable(globalThis["dflt"]);
$assert.constructable(globalThis["dflt"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dflt"]), ['length', 'name', 'prototype'], globalThis["dflt"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["dflt"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["dflt"]?.["prototype"]), true);
$assert.notCallable(globalThis["dflt"]?.["prototype"]);
$assert.notConstructable(globalThis["dflt"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dflt"]?.["prototype"]), ['constructor'], globalThis["dflt"]?.["prototype"]);
$assert.sameValue(globalThis["dflt"]?.["prototype"]?.["constructor"], globalThis["dflt"]);
$verifyProperty(globalThis["dflt"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["dflt"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["dflt"], "name", {
  value: "dflt",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["dflt"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
