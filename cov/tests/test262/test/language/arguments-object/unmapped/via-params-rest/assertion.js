...
$assert.sameValue($Object_getPrototypeOf(globalThis["rest"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rest"]), true);
$assert.callable(globalThis["rest"]);
$assert.constructable(globalThis["rest"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rest"]), ['length', 'name', 'prototype'], globalThis["rest"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["rest"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rest"]?.["prototype"]), true);
$assert.notCallable(globalThis["rest"]?.["prototype"]);
$assert.notConstructable(globalThis["rest"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rest"]?.["prototype"]), ['constructor'], globalThis["rest"]?.["prototype"]);
$assert.sameValue(globalThis["rest"]?.["prototype"]?.["constructor"], globalThis["rest"]);
$verifyProperty(globalThis["rest"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rest"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["rest"], "name", {
  value: "rest",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["rest"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["value"], 1.0);
