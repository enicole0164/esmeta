...
$assert.sameValue($Object_getPrototypeOf(globalThis["dstr"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["dstr"]), true);
$assert.callable(globalThis["dstr"]);
$assert.constructable(globalThis["dstr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dstr"]), ['length', 'name', 'prototype'], globalThis["dstr"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["dstr"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["dstr"]?.["prototype"]), true);
$assert.notCallable(globalThis["dstr"]?.["prototype"]);
$assert.notConstructable(globalThis["dstr"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["dstr"]?.["prototype"]), ['constructor'], globalThis["dstr"]?.["prototype"]);
$assert.sameValue(globalThis["dstr"]?.["prototype"]?.["constructor"], globalThis["dstr"]);
$verifyProperty(globalThis["dstr"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["dstr"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["dstr"], "name", {
  value: "dstr",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["dstr"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
