...
$assert.sameValue(globalThis["ARG_STRING"], "value of the argument property");
...
$assert.compareArray($Reflect_ownKeys(globalThis["f1"]?.["prototype"]), ['constructor', 'arguments'], globalThis["f1"]?.["prototype"]);
$verifyProperty(globalThis["f1"]?.["prototype"], "arguments", {
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['0', '1', '2', '4', 'length', 'callee', Symbol.iterator], globalThis["x"]);
