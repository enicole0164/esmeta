...
$assert.sameValue($Object_getPrototypeOf(globalThis["getArguments"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getArguments"]), true);
$assert.callable(globalThis["getArguments"]);
$assert.constructable(globalThis["getArguments"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getArguments"]), ['length', 'name', 'prototype'], globalThis["getArguments"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getArguments"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getArguments"]?.["prototype"]), true);
$assert.notCallable(globalThis["getArguments"]?.["prototype"]);
$assert.notConstructable(globalThis["getArguments"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getArguments"]?.["prototype"]), ['constructor'], globalThis["getArguments"]?.["prototype"]);
$assert.sameValue(globalThis["getArguments"]?.["prototype"]?.["constructor"], globalThis["getArguments"]);
$verifyProperty(globalThis["getArguments"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getArguments"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getArguments"], "name", {
  value: "getArguments",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getArguments"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
