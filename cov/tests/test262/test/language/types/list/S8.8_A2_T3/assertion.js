...
$assert.sameValue($Object_getPrototypeOf(globalThis["__mFunc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__mFunc"]), true);
$assert.callable(globalThis["__mFunc"]);
$assert.constructable(globalThis["__mFunc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__mFunc"]), ['length', 'name', 'prototype'], globalThis["__mFunc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["__mFunc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["__mFunc"]?.["prototype"]), true);
$assert.notCallable(globalThis["__mFunc"]?.["prototype"]);
$assert.notConstructable(globalThis["__mFunc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__mFunc"]?.["prototype"]), ['constructor'], globalThis["__mFunc"]?.["prototype"]);
$assert.sameValue(globalThis["__mFunc"]?.["prototype"]?.["constructor"], globalThis["__mFunc"]);
$verifyProperty(globalThis["__mFunc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__mFunc"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["__mFunc"], "name", {
  value: "__mFunc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["__mFunc"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
