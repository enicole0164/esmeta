...
$assert.sameValue(globalThis["__str"], "BCDEFGH");
...
$assert.sameValue(globalThis["str"], "abcdfg");
$assert.sameValue(globalThis["str2"], "qwerty");
$assert.sameValue(globalThis["str__"], "BCDEFGH");
