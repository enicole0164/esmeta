...
$assert.sameValue($Object_getPrototypeOf(globalThis["FooObj"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FooObj"]), true);
$assert.callable(globalThis["FooObj"]);
$assert.constructable(globalThis["FooObj"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FooObj"]), ['length', 'name', 'prototype'], globalThis["FooObj"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["FooObj"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FooObj"]?.["prototype"]), true);
$assert.notCallable(globalThis["FooObj"]?.["prototype"]);
$assert.notConstructable(globalThis["FooObj"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FooObj"]?.["prototype"]), [], globalThis["FooObj"]?.["prototype"]);
$verifyProperty(globalThis["FooObj"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["FooObj"], "name", {
  value: "FooObj",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FooObj"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["__foo"]), globalThis["FooObj"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["__foo"]), true);
$assert.notCallable(globalThis["__foo"]);
$assert.notConstructable(globalThis["__foo"]);
$assert.compareArray($Reflect_ownKeys(globalThis["__foo"]), [], globalThis["__foo"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), [], globalThis["__obj"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["obj__"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["obj__"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["obj__"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["obj__"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["obj__"])), ['constructor'], $Object_getPrototypeOf(globalThis["obj__"]));
$assert.sameValue($Object_getPrototypeOf(globalThis["obj__"])?.["constructor"], globalThis["FooObj"]);
$verifyProperty($Object_getPrototypeOf(globalThis["obj__"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["obj__"]), true);
$assert.notCallable(globalThis["obj__"]);
$assert.notConstructable(globalThis["obj__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj__"]), [], globalThis["obj__"]);
$assert.sameValue(globalThis["protoObj"], globalThis["FooObj"]?.["prototype"]);
