...
$assert.sameValue(globalThis["position"], 2.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["seat"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["seat"]), true);
$assert.notCallable(globalThis["seat"]);
$assert.notConstructable(globalThis["seat"]);
$assert.compareArray($Reflect_ownKeys(globalThis["seat"]), ['move'], globalThis["seat"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["seat"]?.["move"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["seat"]?.["move"]), true);
$assert.callable(globalThis["seat"]?.["move"]);
$assert.constructable(globalThis["seat"]?.["move"]);
$assert.compareArray($Reflect_ownKeys(globalThis["seat"]?.["move"]), ['length', 'name', 'prototype'], globalThis["seat"]?.["move"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["seat"]?.["move"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["seat"]?.["move"]?.["prototype"]), true);
$assert.notCallable(globalThis["seat"]?.["move"]?.["prototype"]);
$assert.notConstructable(globalThis["seat"]?.["move"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["seat"]?.["move"]?.["prototype"]), ['constructor'], globalThis["seat"]?.["move"]?.["prototype"]);
$assert.sameValue(globalThis["seat"]?.["move"]?.["prototype"]?.["constructor"], globalThis["seat"]?.["move"]);
$verifyProperty(globalThis["seat"]?.["move"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["seat"]?.["move"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["seat"]?.["move"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["seat"]?.["move"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["seat"], "move", {
  writable: true,
  enumerable: true,
  configurable: true,
});
