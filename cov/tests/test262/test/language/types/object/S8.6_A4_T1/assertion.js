...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['bar', 'some', 'foo'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "some", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj"], "bar", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["obj_"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["obj_"]), true);
$assert.notCallable(globalThis["obj_"]);
$assert.notConstructable(globalThis["obj_"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj_"]), ['bar', 'some', 'foo'], globalThis["obj_"]);
$verifyProperty(globalThis["obj_"], "some", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj_"], "bar", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj_"], "foo", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["obj__"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["obj__"]), ['bar', 'some', 'foo'], globalThis["obj__"]);
$verifyProperty(globalThis["obj__"], "some", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj__"], "bar", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["obj__"], "foo", {
  value: "a",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["property"], "foo");
