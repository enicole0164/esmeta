...
$assert.compareArray($Reflect_ownKeys(globalThis["FooObj"]?.["prototype"]), ['constructor', 'prop'], globalThis["FooObj"]?.["prototype"]);
$verifyProperty(globalThis["FooObj"]?.["prototype"], "prop", {
  value: "some",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["FooObj"]?.["prototype"]?.["constructor"], globalThis["FooObj"]);
$verifyProperty(globalThis["FooObj"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]), globalThis["FooObj"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["foo"]), true);
$assert.notCallable(globalThis["foo"]);
$assert.notConstructable(globalThis["foo"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]), ['prop'], globalThis["foo"]);
$verifyProperty(globalThis["foo"], "prop", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["foo__"]), globalThis["FooObj"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["foo__"]), true);
$assert.notCallable(globalThis["foo__"]);
$assert.notConstructable(globalThis["foo__"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foo__"]), [], globalThis["foo__"]);
