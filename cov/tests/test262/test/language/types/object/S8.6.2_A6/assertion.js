...
$assert.sameValue($Object_getPrototypeOf(globalThis["numInstance"]), Number.prototype);
$assert.sameValue(Object.isExtensible(globalThis["numInstance"]), true);
$assert.notCallable(globalThis["numInstance"]);
$assert.notConstructable(globalThis["numInstance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["numInstance"]), [], globalThis["numInstance"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["objInstance"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["objInstance"]), true);
$assert.notCallable(globalThis["objInstance"]);
$assert.notConstructable(globalThis["objInstance"]);
$assert.compareArray($Reflect_ownKeys(globalThis["objInstance"]), [], globalThis["objInstance"]);
