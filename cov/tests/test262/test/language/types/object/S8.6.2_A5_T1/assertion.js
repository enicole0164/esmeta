...
$assert.sameValue($Object_getPrototypeOf(globalThis["testScreen"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testScreen"]), true);
$assert.notCallable(globalThis["testScreen"]);
$assert.notConstructable(globalThis["testScreen"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testScreen"]), ['touch'], globalThis["testScreen"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testScreen"]?.["touch"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testScreen"]?.["touch"]), true);
$assert.callable(globalThis["testScreen"]?.["touch"]);
$assert.constructable(globalThis["testScreen"]?.["touch"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testScreen"]?.["touch"]), ['length', 'name', 'prototype'], globalThis["testScreen"]?.["touch"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testScreen"]?.["touch"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testScreen"]?.["touch"]?.["prototype"]), true);
$assert.notCallable(globalThis["testScreen"]?.["touch"]?.["prototype"]);
$assert.notConstructable(globalThis["testScreen"]?.["touch"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testScreen"]?.["touch"]?.["prototype"]), ['constructor'], globalThis["testScreen"]?.["touch"]?.["prototype"]);
$assert.sameValue(globalThis["testScreen"]?.["touch"]?.["prototype"]?.["constructor"], globalThis["testScreen"]?.["touch"]);
$verifyProperty(globalThis["testScreen"]?.["touch"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testScreen"]?.["touch"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testScreen"]?.["touch"], "name", {
  value: "touch",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testScreen"]?.["touch"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testScreen"], "touch", {
  writable: true,
  enumerable: true,
  configurable: true,
});
