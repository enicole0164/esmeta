...
$assert.sameValue($Object_getPrototypeOf(globalThis["knock"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["knock"]), true);
$assert.callable(globalThis["knock"]);
$assert.constructable(globalThis["knock"]);
$assert.compareArray($Reflect_ownKeys(globalThis["knock"]), ['length', 'name', 'prototype'], globalThis["knock"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["knock"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["knock"]?.["prototype"]), true);
$assert.notCallable(globalThis["knock"]?.["prototype"]);
$assert.notConstructable(globalThis["knock"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["knock"]?.["prototype"]), ['constructor'], globalThis["knock"]?.["prototype"]);
$assert.sameValue(globalThis["knock"]?.["prototype"]?.["constructor"], globalThis["knock"]);
$verifyProperty(globalThis["knock"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["knock"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["knock"], "name", {
  value: "knock",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["knock"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
