...
$assert.sameValue(globalThis["__count"], 2.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["beep"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["beep"]), true);
$assert.callable(globalThis["beep"]);
$assert.constructable(globalThis["beep"]);
$assert.compareArray($Reflect_ownKeys(globalThis["beep"]), ['length', 'name', 'prototype'], globalThis["beep"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["beep"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["beep"]?.["prototype"]), true);
$assert.notCallable(globalThis["beep"]?.["prototype"]);
$assert.notConstructable(globalThis["beep"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["beep"]?.["prototype"]), ['constructor'], globalThis["beep"]?.["prototype"]);
$assert.sameValue(globalThis["beep"]?.["prototype"]?.["constructor"], globalThis["beep"]);
$verifyProperty(globalThis["beep"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["beep"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["beep"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["beep"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
