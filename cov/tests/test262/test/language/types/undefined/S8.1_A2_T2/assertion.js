...
$assert.sameValue($Object_getPrototypeOf(globalThis["test1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["test1"]), true);
$assert.callable(globalThis["test1"]);
$assert.constructable(globalThis["test1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["test1"]), ['length', 'name', 'prototype'], globalThis["test1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["test1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["test1"]?.["prototype"]), true);
$assert.notCallable(globalThis["test1"]?.["prototype"]);
$assert.notConstructable(globalThis["test1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["test1"]?.["prototype"]), ['constructor'], globalThis["test1"]?.["prototype"]);
$assert.sameValue(globalThis["test1"]?.["prototype"]?.["constructor"], globalThis["test1"]);
$verifyProperty(globalThis["test1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["test1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["test1"], "name", {
  value: "test1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["test1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["test2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["test2"]), true);
$assert.callable(globalThis["test2"]);
$assert.constructable(globalThis["test2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["test2"]), ['length', 'name', 'prototype'], globalThis["test2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["test2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["test2"]?.["prototype"]), true);
$assert.notCallable(globalThis["test2"]?.["prototype"]);
$assert.notConstructable(globalThis["test2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["test2"]?.["prototype"]), ['constructor'], globalThis["test2"]?.["prototype"]);
$assert.sameValue(globalThis["test2"]?.["prototype"]?.["constructor"], globalThis["test2"]);
$verifyProperty(globalThis["test2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["test2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["test2"], "name", {
  value: "test2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["test2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
