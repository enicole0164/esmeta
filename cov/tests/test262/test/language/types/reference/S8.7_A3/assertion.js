...
$assert.sameValue($Object_getPrototypeOf(globalThis["items"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["items"]), ['0', '1', 'length'], globalThis["items"]);
$verifyProperty(globalThis["items"], "1", {
  value: "array",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["items"], "0", {
  value: "new",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["itemsRef"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["itemsRef"]), true);
$assert.notCallable(globalThis["itemsRef"]);
$assert.notConstructable(globalThis["itemsRef"]);
$assert.compareArray($Reflect_ownKeys(globalThis["itemsRef"]), ['0', '1', '2', 'length'], globalThis["itemsRef"]);
$verifyProperty(globalThis["itemsRef"], "1", {
  value: "two",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["itemsRef"], "2", {
  value: "three",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["itemsRef"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["itemsRef"], "0", {
  value: "one",
  writable: true,
  enumerable: true,
  configurable: true,
