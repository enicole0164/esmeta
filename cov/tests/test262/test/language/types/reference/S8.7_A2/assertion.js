...
$assert.compareArray($Reflect_ownKeys(globalThis["items"]), ['0', '1', '2', 'length'], globalThis["items"]);
...
$verifyProperty(globalThis["items"], "2", {
  value: "three",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["itemsRef"], globalThis["items"]);
