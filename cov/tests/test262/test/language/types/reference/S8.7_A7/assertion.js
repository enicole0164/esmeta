...
$assert.sameValue($Object_getPrototypeOf(globalThis["m"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["m"]), true);
$assert.notCallable(globalThis["m"]);
$assert.notConstructable(globalThis["m"]);
$assert.compareArray($Reflect_ownKeys(globalThis["m"]), ['age'], globalThis["m"]);
$verifyProperty(globalThis["m"], "age", {
  value: 50.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["n"], globalThis["m"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["populateAge"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["populateAge"]), true);
$assert.callable(globalThis["populateAge"]);
$assert.constructable(globalThis["populateAge"]);
$assert.compareArray($Reflect_ownKeys(globalThis["populateAge"]), ['length', 'name', 'prototype'], globalThis["populateAge"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["populateAge"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["populateAge"]?.["prototype"]), true);
$assert.notCallable(globalThis["populateAge"]?.["prototype"]);
$assert.notConstructable(globalThis["populateAge"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["populateAge"]?.["prototype"]), ['constructor'], globalThis["populateAge"]?.["prototype"]);
$assert.sameValue(globalThis["populateAge"]?.["prototype"]?.["constructor"], globalThis["populateAge"]);
$verifyProperty(globalThis["populateAge"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["populateAge"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["populateAge"], "name", {
  value: "populateAge",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["populateAge"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
