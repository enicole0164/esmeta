...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['oneProperty'], globalThis["obj"]);
$verifyProperty(globalThis["obj"], "oneProperty", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["objRef"], globalThis["obj"]);
