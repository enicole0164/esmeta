...
$assert.sameValue($Object_getPrototypeOf(globalThis["addFirst2Second"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["addFirst2Second"]), true);
$assert.callable(globalThis["addFirst2Second"]);
$assert.constructable(globalThis["addFirst2Second"]);
$assert.compareArray($Reflect_ownKeys(globalThis["addFirst2Second"]), ['length', 'name', 'prototype'], globalThis["addFirst2Second"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["addFirst2Second"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["addFirst2Second"]?.["prototype"]), true);
$assert.notCallable(globalThis["addFirst2Second"]?.["prototype"]);
$assert.notConstructable(globalThis["addFirst2Second"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["addFirst2Second"]?.["prototype"]), ['constructor'], globalThis["addFirst2Second"]?.["prototype"]);
$assert.sameValue(globalThis["addFirst2Second"]?.["prototype"]?.["constructor"], globalThis["addFirst2Second"]);
$verifyProperty(globalThis["addFirst2Second"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["addFirst2Second"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["addFirst2Second"], "name", {
  value: "addFirst2Second",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["addFirst2Second"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["m"], 1.0);
$assert.sameValue(globalThis["n"], 1.0);
