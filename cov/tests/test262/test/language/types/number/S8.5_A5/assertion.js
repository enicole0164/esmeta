...
$assert.sameValue(globalThis["x"], NaN);
$assert.sameValue(globalThis["x_geq_0"], false);
$assert.sameValue(globalThis["x_geq_0_ADD_leq_0"], 0.0);
$assert.sameValue(globalThis["x_leq_0"], false);
$assert.sameValue(globalThis["x_leq_0_OR_geq_0"], false);
