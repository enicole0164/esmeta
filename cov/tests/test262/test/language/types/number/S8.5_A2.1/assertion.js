...
$assert.sameValue(globalThis["d"], 0.0);
$assert.sameValue(globalThis["x"], 9.007199254740994E15);
$assert.sameValue(globalThis["y"], 0.9999847412109375);
$assert.sameValue(globalThis["z"], 9.007199254740994E15);
