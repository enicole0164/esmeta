...
$assert.compareArray($Reflect_ownKeys(globalThis["props"]), ['length', 'name', 'prototype'], globalThis["props"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["subject"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["subject"]), true);
$assert.notCallable(globalThis["subject"]);
$assert.notConstructable(globalThis["subject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["subject"]), ['0', '1', '2', 'length'], globalThis["subject"]);
$verifyProperty(globalThis["subject"], "1", {
  value: "y",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["subject"], "2", {
  value: "zoom",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["subject"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["subject"], "0", {
  value: "x",
  writable: true,
  enumerable: true,
  configurable: true,
