...
$assert.sameValue($Object_getPrototypeOf(globalThis["f5"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f5"]), true);
$assert.callable(globalThis["f5"]);
$assert.constructable(globalThis["f5"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f5"]), ['length', 'name', 'prototype'], globalThis["f5"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["f5"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["f5"]?.["prototype"]), true);
$assert.notCallable(globalThis["f5"]?.["prototype"]);
$assert.notConstructable(globalThis["f5"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["f5"]?.["prototype"]), ['constructor'], globalThis["f5"]?.["prototype"]);
$assert.sameValue(globalThis["f5"]?.["prototype"]?.["constructor"], globalThis["f5"]);
$verifyProperty(globalThis["f5"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f5"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["f5"], "name", {
  value: "f5",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["f5"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
