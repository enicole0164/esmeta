...
$assert.sameValue($Object_getPrototypeOf(_), Function.prototype);
$assert.sameValue(Object.isExtensible(_), true);
$assert.callable(_);
$assert.constructable(_);
$assert.compareArray($Reflect_ownKeys(_), ['length', 'name', 'prototype'], _);
$assert.sameValue($Object_getPrototypeOf(_?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(_?.["prototype"]), true);
$assert.notCallable(_?.["prototype"]);
$assert.notConstructable(_?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(_?.["prototype"]), ['constructor'], _?.["prototype"]);
$assert.sameValue(_?.["prototype"]?.["constructor"], _);
$verifyProperty(_?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(_, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(_, "name", {
  value: "_",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(_, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
