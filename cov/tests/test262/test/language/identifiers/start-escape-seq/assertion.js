// [EXIT] normal
$assert.sameValue(globalThis["$"], 3.0);
$assert.sameValue(globalThis["$$"], 5.0);
...
$assert.sameValue(globalThis["$_"], 6.0);
...
$assert.sameValue(globalThis["_"], 7.0);
$assert.sameValue(globalThis["_$"], 9.0);
$assert.sameValue(globalThis["__"], 10.0);
$assert.sameValue(globalThis["_x"], 8.0);
...
$assert.sameValue(globalThis["xx"], 2.0);
