...
$assert.sameValue(globalThis["㐀"], 1.0);
$assert.sameValue(globalThis["㘮"], 1.0);
$assert.sameValue(globalThis["䶵"], 1.0);
$assert.sameValue(globalThis["一"], 1.0);
$assert.sameValue(globalThis["江"], 1.0);
$assert.sameValue(globalThis["龥"], 1.0);
