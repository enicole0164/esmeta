// [EXIT] normal
$assert.sameValue(globalThis["$0"], 0.0);
$assert.sameValue(globalThis["$1"], 1.0);
$assert.sameValue(globalThis["$2"], 2.0);
$assert.sameValue(globalThis["$3"], 3.0);
$assert.sameValue(globalThis["$4"], 4.0);
$assert.sameValue(globalThis["$5"], 5.0);
$assert.sameValue(globalThis["$6"], 6.0);
$assert.sameValue(globalThis["$7"], 7.0);
$assert.sameValue(globalThis["$8"], 8.0);
$assert.sameValue(globalThis["$9"], 9.0);
