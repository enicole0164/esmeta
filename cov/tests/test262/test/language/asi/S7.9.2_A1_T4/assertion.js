...
$assert.sameValue(globalThis["a"], 1.0);
...
$assert.sameValue(globalThis["b"], 2.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["test"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["test"]), true);
$assert.callable(globalThis["test"]);
$assert.constructable(globalThis["test"]);
$assert.compareArray($Reflect_ownKeys(globalThis["test"]), ['length', 'name', 'prototype'], globalThis["test"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["test"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["test"]?.["prototype"]), true);
$assert.notCallable(globalThis["test"]?.["prototype"]);
$assert.notConstructable(globalThis["test"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["test"]?.["prototype"]), ['constructor'], globalThis["test"]?.["prototype"]);
$assert.sameValue(globalThis["test"]?.["prototype"]?.["constructor"], globalThis["test"]);
$verifyProperty(globalThis["test"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["test"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["test"], "name", {
  value: "test",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["test"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
