...
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]), true);
$assert.callable(globalThis["result"]);
$assert.constructable(globalThis["result"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['length', 'name', 'prototype'], globalThis["result"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["result"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["result"]?.["prototype"]), true);
$assert.notCallable(globalThis["result"]?.["prototype"]);
$assert.notConstructable(globalThis["result"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["result"]?.["prototype"]), ['constructor'], globalThis["result"]?.["prototype"]);
$assert.sameValue(globalThis["result"]?.["prototype"]?.["constructor"], globalThis["result"]);
$verifyProperty(globalThis["result"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["result"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["result"], "name", {
  value: "f",
  writable: false,
  enumerable: false,
  configurable: true,
