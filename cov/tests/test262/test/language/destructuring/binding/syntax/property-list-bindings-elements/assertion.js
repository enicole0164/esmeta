...
$assert.sameValue($Object_getPrototypeOf(globalThis["fna"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fna"]), true);
$assert.callable(globalThis["fna"]);
$assert.constructable(globalThis["fna"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fna"]), ['length', 'name', 'prototype'], globalThis["fna"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fna"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fna"]?.["prototype"]), true);
$assert.notCallable(globalThis["fna"]?.["prototype"]);
$assert.notConstructable(globalThis["fna"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fna"]?.["prototype"]), ['constructor'], globalThis["fna"]?.["prototype"]);
$assert.sameValue(globalThis["fna"]?.["prototype"]?.["constructor"], globalThis["fna"]);
$verifyProperty(globalThis["fna"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fna"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fna"], "name", {
  value: "fna",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fna"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fnb"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnb"]), true);
$assert.callable(globalThis["fnb"]);
$assert.constructable(globalThis["fnb"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnb"]), ['length', 'name', 'prototype'], globalThis["fnb"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fnb"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnb"]?.["prototype"]), true);
$assert.notCallable(globalThis["fnb"]?.["prototype"]);
$assert.notConstructable(globalThis["fnb"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnb"]?.["prototype"]), ['constructor'], globalThis["fnb"]?.["prototype"]);
$assert.sameValue(globalThis["fnb"]?.["prototype"]?.["constructor"], globalThis["fnb"]);
$verifyProperty(globalThis["fnb"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnb"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fnb"], "name", {
  value: "fnb",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnb"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fnc"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnc"]), true);
$assert.callable(globalThis["fnc"]);
$assert.constructable(globalThis["fnc"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnc"]), ['length', 'name', 'prototype'], globalThis["fnc"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fnc"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnc"]?.["prototype"]), true);
$assert.notCallable(globalThis["fnc"]?.["prototype"]);
$assert.notConstructable(globalThis["fnc"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnc"]?.["prototype"]), ['constructor'], globalThis["fnc"]?.["prototype"]);
$assert.sameValue(globalThis["fnc"]?.["prototype"]?.["constructor"], globalThis["fnc"]);
$verifyProperty(globalThis["fnc"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnc"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fnc"], "name", {
  value: "fnc",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnc"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fnd"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnd"]), true);
$assert.callable(globalThis["fnd"]);
$assert.constructable(globalThis["fnd"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnd"]), ['length', 'name', 'prototype'], globalThis["fnd"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fnd"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnd"]?.["prototype"]), true);
$assert.notCallable(globalThis["fnd"]?.["prototype"]);
$assert.notConstructable(globalThis["fnd"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnd"]?.["prototype"]), ['constructor'], globalThis["fnd"]?.["prototype"]);
$assert.sameValue(globalThis["fnd"]?.["prototype"]?.["constructor"], globalThis["fnd"]);
$verifyProperty(globalThis["fnd"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnd"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fnd"], "name", {
  value: "fnd",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnd"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fne"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fne"]), true);
$assert.callable(globalThis["fne"]);
$assert.constructable(globalThis["fne"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fne"]), ['length', 'name', 'prototype'], globalThis["fne"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fne"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fne"]?.["prototype"]), true);
$assert.notCallable(globalThis["fne"]?.["prototype"]);
$assert.notConstructable(globalThis["fne"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fne"]?.["prototype"]), ['constructor'], globalThis["fne"]?.["prototype"]);
$assert.sameValue(globalThis["fne"]?.["prototype"]?.["constructor"], globalThis["fne"]);
$verifyProperty(globalThis["fne"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fne"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fne"], "name", {
  value: "fne",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fne"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["fnf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnf"]), true);
$assert.callable(globalThis["fnf"]);
$assert.constructable(globalThis["fnf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnf"]), ['length', 'name', 'prototype'], globalThis["fnf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["fnf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["fnf"]?.["prototype"]), true);
$assert.notCallable(globalThis["fnf"]?.["prototype"]);
$assert.notConstructable(globalThis["fnf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["fnf"]?.["prototype"]), ['constructor'], globalThis["fnf"]?.["prototype"]);
$assert.sameValue(globalThis["fnf"]?.["prototype"]?.["constructor"], globalThis["fnf"]);
$verifyProperty(globalThis["fnf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["fnf"], "name", {
  value: "fnf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["fnf"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
