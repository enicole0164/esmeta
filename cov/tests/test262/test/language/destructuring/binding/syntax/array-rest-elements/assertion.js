...
$assert.compareArray($Reflect_ownKeys(globalThis["fn1"]), ['length', 'name', 'prototype'], globalThis["fn1"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fn2"]), ['length', 'name', 'prototype'], globalThis["fn2"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fn3"]), ['length', 'name', 'prototype'], globalThis["fn3"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fn4"]), ['length', 'name', 'prototype'], globalThis["fn4"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["fn5"]), ['length', 'name', 'prototype'], globalThis["fn5"]);
