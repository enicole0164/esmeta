...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['0', '1.2', '1e+55', '0.000001', 'Infinity', '-Infinity', 'NaN'], globalThis["object"]);
$verifyProperty(globalThis["object"], "-Infinity", {
  value: "F",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["object"], "1e+55", {
  value: "B",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["object"], "0.000001", {
  value: "C",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["object"], "1.2", {
  value: "A",
  writable: true,
  enumerable: true,
  configurable: true,
...
$verifyProperty(globalThis["object"], "NaN", {
  value: "G",
  writable: true,
  enumerable: true,
  configurable: true,
