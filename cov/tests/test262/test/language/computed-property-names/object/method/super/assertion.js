...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["1"]), true);
$assert.callable(globalThis["object"]?.["1"]);
$assert.notConstructable(globalThis["object"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["1"]), ['length', 'name'], globalThis["object"]?.["1"]);
$verifyProperty(globalThis["object"]?.["1"], "name", {
  value: "1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["0"]), true);
$assert.callable(globalThis["object"]?.["0"]);
$assert.notConstructable(globalThis["object"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["0"]), ['length', 'name'], globalThis["object"]?.["0"]);
$verifyProperty(globalThis["object"]?.["0"], "name", {
  value: "0",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["0"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
