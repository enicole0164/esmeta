...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['a'], globalThis["object"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["a"]), GeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["a"]), ['length', 'name', 'prototype'], globalThis["object"]?.["a"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["a"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["a"]?.["prototype"]), true);
$assert.notCallable(globalThis["object"]?.["a"]?.["prototype"]);
$assert.notConstructable(globalThis["object"]?.["a"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["a"]?.["prototype"]), [], globalThis["object"]?.["a"]?.["prototype"]);
$verifyProperty(globalThis["object"]?.["a"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
