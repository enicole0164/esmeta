...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["2"]), true);
$assert.callable(globalThis["object"]?.["2"]);
$assert.notConstructable(globalThis["object"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["2"]), ['length', 'name'], globalThis["object"]?.["2"]);
$verifyProperty(globalThis["object"]?.["2"], "name", {
  value: "2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
