...
$assert.sameValue(globalThis["counter"], 2.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["key1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1"]), true);
$assert.notCallable(globalThis["key1"]);
$assert.notConstructable(globalThis["key1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1"]), ['toString'], globalThis["key1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key1"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1"]?.["toString"]), true);
$assert.callable(globalThis["key1"]?.["toString"]);
$assert.constructable(globalThis["key1"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["key1"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key1"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["key1"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["key1"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["key1"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["key1"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["key1"]?.["toString"]);
$verifyProperty(globalThis["key1"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key1"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key1"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key1"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key1"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["key1ToString"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1ToString"]), true);
$assert.notCallable(globalThis["key1ToString"]);
$assert.notConstructable(globalThis["key1ToString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1ToString"]), ['0', 'length'], globalThis["key1ToString"]);
$verifyProperty(globalThis["key1ToString"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key1ToString"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["key2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2"]), true);
$assert.notCallable(globalThis["key2"]);
$assert.notConstructable(globalThis["key2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2"]), ['toString'], globalThis["key2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key2"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2"]?.["toString"]), true);
$assert.callable(globalThis["key2"]?.["toString"]);
$assert.constructable(globalThis["key2"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["key2"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key2"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["key2"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["key2"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["key2"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["key2"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["key2"]?.["toString"]);
$verifyProperty(globalThis["key2"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key2"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key2"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key2"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key2"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["key2ToString"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2ToString"]), true);
$assert.notCallable(globalThis["key2ToString"]);
$assert.notConstructable(globalThis["key2ToString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2ToString"]), ['0', 'length'], globalThis["key2ToString"]);
$verifyProperty(globalThis["key2ToString"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key2ToString"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'a', 'b', 'c', 'd'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["a"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["a"]), true);
$assert.callable(C?.["prototype"]?.["a"]);
$assert.notConstructable(C?.["prototype"]?.["a"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["a"]), ['length', 'name'], C?.["prototype"]?.["a"]);
$verifyProperty(C?.["prototype"]?.["a"], "name", {
  value: "a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["a"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "a", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["d"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["d"]), true);
$assert.callable(C?.["prototype"]?.["d"]);
$assert.notConstructable(C?.["prototype"]?.["d"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["d"]), ['length', 'name'], C?.["prototype"]?.["d"]);
$verifyProperty(C?.["prototype"]?.["d"], "name", {
  value: "d",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["d"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "d", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["c"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["c"]), true);
$assert.callable(C?.["prototype"]?.["c"]);
$assert.notConstructable(C?.["prototype"]?.["c"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["c"]), ['length', 'name'], C?.["prototype"]?.["c"]);
$verifyProperty(C?.["prototype"]?.["c"], "name", {
  value: "c",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["c"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "c", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["b"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["b"]), true);
$assert.callable(C?.["prototype"]?.["b"]);
$assert.notConstructable(C?.["prototype"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["b"]), ['length', 'name'], C?.["prototype"]?.["b"]);
$verifyProperty(C?.["prototype"]?.["b"], "name", {
  value: "b",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["b"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "b", {
  writable: true,
  enumerable: false,
  configurable: true,
});
