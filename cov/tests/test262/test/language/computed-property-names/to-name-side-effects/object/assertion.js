...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['a', 'b', 'c', 'd'], globalThis["object"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["b"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["b"]), true);
$assert.callable(globalThis["object"]?.["b"]);
$assert.notConstructable(globalThis["object"]?.["b"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["b"]), ['length', 'name'], globalThis["object"]?.["b"]);
$verifyProperty(globalThis["object"]?.["b"], "name", {
  value: "b",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["b"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["d"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["d"]), true);
$assert.callable(globalThis["object"]?.["d"]);
$assert.notConstructable(globalThis["object"]?.["d"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["d"]), ['length', 'name'], globalThis["object"]?.["d"]);
$verifyProperty(globalThis["object"]?.["d"], "name", {
  value: "d",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["d"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "d", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["a"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["a"]), true);
$assert.callable(globalThis["object"]?.["a"]);
$assert.notConstructable(globalThis["object"]?.["a"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["a"]), ['length', 'name'], globalThis["object"]?.["a"]);
$verifyProperty(globalThis["object"]?.["a"], "name", {
  value: "a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["a"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["c"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["c"]), true);
$assert.callable(globalThis["object"]?.["c"]);
$assert.notConstructable(globalThis["object"]?.["c"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["c"]), ['length', 'name'], globalThis["object"]?.["c"]);
$verifyProperty(globalThis["object"]?.["c"], "name", {
  value: "c",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["c"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "c", {
  writable: true,
  enumerable: true,
  configurable: true,
});
