...
$assert.compareArray($Reflect_ownKeys(globalThis["key1"]), ['valueOf', 'toString'], globalThis["key1"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["key1"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1"]?.["valueOf"]), true);
$assert.callable(globalThis["key1"]?.["valueOf"]);
$assert.constructable(globalThis["key1"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["key1"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key1"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["key1"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["key1"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["key1"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["key1"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["key1"]?.["valueOf"]);
$verifyProperty(globalThis["key1"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key1"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key1"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key1"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["key1vof"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key1vof"]), true);
$assert.notCallable(globalThis["key1vof"]);
$assert.notConstructable(globalThis["key1vof"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key1vof"]), ['0', 'length'], globalThis["key1vof"]);
$verifyProperty(globalThis["key1vof"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key1vof"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["key2"]), ['valueOf', 'toString'], globalThis["key2"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["key2"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2"]?.["valueOf"]), true);
$assert.callable(globalThis["key2"]?.["valueOf"]);
$assert.constructable(globalThis["key2"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["key2"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["key2"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["key2"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["key2"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["key2"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["key2"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["key2"]?.["valueOf"]);
$verifyProperty(globalThis["key2"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key2"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key2"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key2"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["key2"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["key2vof"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["key2vof"]), true);
$assert.notCallable(globalThis["key2vof"]);
$assert.notConstructable(globalThis["key2vof"]);
$assert.compareArray($Reflect_ownKeys(globalThis["key2vof"]), ['0', 'length'], globalThis["key2vof"]);
$verifyProperty(globalThis["key2vof"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["key2vof"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['1', '2', 'constructor', 'a', 'c'], C?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["2"]), true);
$assert.callable(C?.["prototype"]?.["2"]);
$assert.notConstructable(C?.["prototype"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["2"]), ['length', 'name'], C?.["prototype"]?.["2"]);
$verifyProperty(C?.["prototype"]?.["2"], "name", {
  value: "2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
