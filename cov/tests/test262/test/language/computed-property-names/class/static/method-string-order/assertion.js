...
$assert.compareArray($Reflect_ownKeys(C), ['length', 'name', 'prototype', 'a', 'b', 'c', 'd'], C);
...
$assert.callable(C?.["b"]);
$assert.notConstructable(C?.["b"]);
$assert.compareArray($Reflect_ownKeys(C?.["b"]), ['length', 'name'], C?.["b"]);
...
$assert.sameValue($Object_getPrototypeOf(C?.["d"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["d"]), true);
$assert.callable(C?.["d"]);
$assert.notConstructable(C?.["d"]);
$assert.compareArray($Reflect_ownKeys(C?.["d"]), ['length', 'name'], C?.["d"]);
$verifyProperty(C?.["d"], "name", {
  value: "d",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["d"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
