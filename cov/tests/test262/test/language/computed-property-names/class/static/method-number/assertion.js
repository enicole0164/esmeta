...
$assert.compareArray($Reflect_ownKeys(C), ['1', '2', 'length', 'name', 'prototype', 'a', 'c'], C);
$assert.sameValue($Object_getPrototypeOf(C?.["a"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["a"]), true);
$assert.callable(C?.["a"]);
$assert.notConstructable(C?.["a"]);
$assert.compareArray($Reflect_ownKeys(C?.["a"]), ['length', 'name'], C?.["a"]);
$verifyProperty(C?.["a"], "name", {
  value: "a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["a"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["2"]), true);
$assert.callable(C?.["2"]);
$assert.notConstructable(C?.["2"]);
$assert.compareArray($Reflect_ownKeys(C?.["2"]), ['length', 'name'], C?.["2"]);
$verifyProperty(C?.["2"], "name", {
  value: "2",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["2"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["1"]), true);
$assert.callable(C?.["1"]);
$assert.notConstructable(C?.["1"]);
$assert.compareArray($Reflect_ownKeys(C?.["1"]), ['length', 'name'], C?.["1"]);
$verifyProperty(C?.["1"], "name", {
  value: "1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C?.["c"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["c"]), true);
$assert.callable(C?.["c"]);
$assert.notConstructable(C?.["c"]);
$assert.compareArray($Reflect_ownKeys(C?.["c"]), ['length', 'name'], C?.["c"]);
$verifyProperty(C?.["c"], "name", {
  value: "c",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["c"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
