...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set, "name", {
  value: "set constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
