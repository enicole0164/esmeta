...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["constructor"]), true);
$assert.callable(C?.["prototype"]?.["constructor"]);
$assert.notConstructable(C?.["prototype"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["constructor"]), ['length', 'name'], C?.["prototype"]?.["constructor"]);
$verifyProperty(C?.["prototype"]?.["constructor"], "name", {
  value: "constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
