...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["a"]), GeneratorFunction.prototype);
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["a"]), ['length', 'name', 'prototype'], C?.["prototype"]?.["a"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["a"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["a"]?.["prototype"]), true);
$assert.notCallable(C?.["prototype"]?.["a"]?.["prototype"]);
$assert.notConstructable(C?.["prototype"]?.["a"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["a"]?.["prototype"]), [], C?.["prototype"]?.["a"]?.["prototype"]);
$verifyProperty(C?.["prototype"]?.["a"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
