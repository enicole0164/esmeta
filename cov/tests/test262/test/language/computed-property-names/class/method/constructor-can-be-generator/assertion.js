...
$assert.sameValue($Object_getPrototypeOf(C4?.["prototype"]?.["constructor"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(C4?.["prototype"]?.["constructor"]), true);
$assert.callable(C4?.["prototype"]?.["constructor"]);
$assert.notConstructable(C4?.["prototype"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(C4?.["prototype"]?.["constructor"]), ['length', 'name', 'prototype'], C4?.["prototype"]?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(C4?.["prototype"]?.["constructor"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(C4?.["prototype"]?.["constructor"]?.["prototype"]), true);
$assert.notCallable(C4?.["prototype"]?.["constructor"]?.["prototype"]);
$assert.notConstructable(C4?.["prototype"]?.["constructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(C4?.["prototype"]?.["constructor"]?.["prototype"]), [], C4?.["prototype"]?.["constructor"]?.["prototype"]);
$verifyProperty(C4?.["prototype"]?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(C4?.["prototype"]?.["constructor"], "name", {
  value: "constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C4?.["prototype"]?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
