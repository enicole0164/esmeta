...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get, "name", {
  value: "get constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(C4?.["prototype"], "constructor")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
