...
$assert.sameValue($Object_getPrototypeOf(descriptor), Object.prototype);
$assert.sameValue(Object.isExtensible(descriptor), true);
$assert.notCallable(descriptor);
$assert.notConstructable(descriptor);
$assert.compareArray($Reflect_ownKeys(descriptor), ['value', 'writable', 'enumerable', 'configurable'], descriptor);
$assert.sameValue(descriptor?.["value"], Array);
$verifyProperty(descriptor, "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(descriptor, "writable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(descriptor, "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(descriptor, "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
