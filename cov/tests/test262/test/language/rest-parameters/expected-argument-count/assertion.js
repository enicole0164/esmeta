...
$assert.sameValue($Object_getPrototypeOf(globalThis["af"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["af"]), true);
$assert.callable(globalThis["af"]);
$assert.constructable(globalThis["af"]);
$assert.compareArray($Reflect_ownKeys(globalThis["af"]), ['length', 'name', 'prototype'], globalThis["af"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["af"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["af"]?.["prototype"]), true);
$assert.notCallable(globalThis["af"]?.["prototype"]);
$assert.notConstructable(globalThis["af"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["af"]?.["prototype"]), ['constructor'], globalThis["af"]?.["prototype"]);
$assert.sameValue(globalThis["af"]?.["prototype"]?.["constructor"], globalThis["af"]);
$verifyProperty(globalThis["af"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["af"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["af"], "name", {
  value: "af",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["af"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["bf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bf"]), true);
$assert.callable(globalThis["bf"]);
$assert.constructable(globalThis["bf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bf"]), ['length', 'name', 'prototype'], globalThis["bf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["bf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bf"]?.["prototype"]), true);
$assert.notCallable(globalThis["bf"]?.["prototype"]);
$assert.notConstructable(globalThis["bf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bf"]?.["prototype"]), ['constructor'], globalThis["bf"]?.["prototype"]);
$assert.sameValue(globalThis["bf"]?.["prototype"]?.["constructor"], globalThis["bf"]);
$verifyProperty(globalThis["bf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["bf"], "name", {
  value: "bf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bf"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
