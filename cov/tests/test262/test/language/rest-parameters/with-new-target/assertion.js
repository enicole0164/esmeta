...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"], "name", {
  value: "Base",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["c"]), ['base', 'child'], globalThis["c"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["c"]?.["base"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["c"]?.["base"]), true);
$assert.notCallable(globalThis["c"]?.["base"]);
$assert.notConstructable(globalThis["c"]?.["base"]);
$assert.compareArray($Reflect_ownKeys(globalThis["c"]?.["base"]), ['0', '1', '2', 'length'], globalThis["c"]?.["base"]);
$verifyProperty(globalThis["c"]?.["base"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["c"]?.["base"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["c"]?.["base"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["c"]?.["base"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["c"], "base", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["c"]?.["child"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["c"]?.["child"]), true);
$assert.notCallable(globalThis["c"]?.["child"]);
$assert.notConstructable(globalThis["c"]?.["child"]);
$assert.compareArray($Reflect_ownKeys(globalThis["c"]?.["child"]), ['0', '1', '2', 'length'], globalThis["c"]?.["child"]);
$verifyProperty(globalThis["c"]?.["child"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["c"]?.["child"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["c"]?.["child"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["c"]?.["child"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["c"], "child", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(Base, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["c"]))?.["constructor"]);
$assert.sameValue(Child, $Object_getPrototypeOf(globalThis["c"])?.["constructor"]);
