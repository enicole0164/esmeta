...
$assert.sameValue(globalThis["_10_4_2_3_c_3_s"], 0.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["testcase"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testcase"]), true);
$assert.callable(globalThis["testcase"]);
$assert.constructable(globalThis["testcase"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testcase"]), ['length', 'name', 'prototype'], globalThis["testcase"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["testcase"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["testcase"]?.["prototype"]), true);
$assert.notCallable(globalThis["testcase"]?.["prototype"]);
$assert.notConstructable(globalThis["testcase"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["testcase"]?.["prototype"]), ['constructor'], globalThis["testcase"]?.["prototype"]);
$assert.sameValue(globalThis["testcase"]?.["prototype"]?.["constructor"], globalThis["testcase"]);
$verifyProperty(globalThis["testcase"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testcase"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["testcase"], "name", {
  value: "testcase",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["testcase"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
