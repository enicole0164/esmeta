...
$assert.sameValue($Object_getPrototypeOf(globalThis["getNewTarget"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getNewTarget"]), true);
$assert.callable(globalThis["getNewTarget"]);
$assert.constructable(globalThis["getNewTarget"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getNewTarget"]), ['length', 'name', 'prototype'], globalThis["getNewTarget"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["getNewTarget"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["getNewTarget"]?.["prototype"]), true);
$assert.notCallable(globalThis["getNewTarget"]?.["prototype"]);
$assert.notConstructable(globalThis["getNewTarget"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["getNewTarget"]?.["prototype"]), ['constructor'], globalThis["getNewTarget"]?.["prototype"]);
$assert.sameValue(globalThis["getNewTarget"]?.["prototype"]?.["constructor"], globalThis["getNewTarget"]);
$verifyProperty(globalThis["getNewTarget"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getNewTarget"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["getNewTarget"], "name", {
  value: "getNewTarget",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["getNewTarget"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(globalThis["newTarget"], globalThis["getNewTarget"]);
