...
$assert.sameValue($Object_getPrototypeOf(outside), Function.prototype);
$assert.sameValue(Object.isExtensible(outside), true);
$assert.callable(outside);
$assert.constructable(outside);
$assert.compareArray($Reflect_ownKeys(outside), ['length', 'name', 'prototype'], outside);
$assert.sameValue($Object_getPrototypeOf(outside?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(outside?.["prototype"]), true);
$assert.notCallable(outside?.["prototype"]);
$assert.notConstructable(outside?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(outside?.["prototype"]), ['constructor'], outside?.["prototype"]);
$assert.sameValue(outside?.["prototype"]?.["constructor"], outside);
$verifyProperty(outside?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(outside, "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty(outside, "name", {
  value: "outside",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(outside, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
