...
$assert.compareArray($Reflect_ownKeys(globalThis["bar"]), ['length', 'name', 'prototype'], globalThis["bar"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["foobar"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["foobar"]), true);
$assert.callable(globalThis["foobar"]);
$assert.constructable(globalThis["foobar"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foobar"]), ['length', 'name', 'prototype'], globalThis["foobar"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["foobar"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["foobar"]?.["prototype"]), true);
$assert.notCallable(globalThis["foobar"]?.["prototype"]);
$assert.notConstructable(globalThis["foobar"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foobar"]?.["prototype"]), ['constructor'], globalThis["foobar"]?.["prototype"]);
$assert.sameValue(globalThis["foobar"]?.["prototype"]?.["constructor"], globalThis["foobar"]);
$verifyProperty(globalThis["foobar"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["foobar"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["foobar"], "name", {
  value: "foobar",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["foobar"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
