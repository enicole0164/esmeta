...
$assert.sameValue($Object_getPrototypeOf(globalThis["probeCase"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeCase"]), true);
$assert.callable(globalThis["probeCase"]);
$assert.constructable(globalThis["probeCase"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeCase"]), ['length', 'name', 'prototype'], globalThis["probeCase"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeCase"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeCase"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeCase"]?.["prototype"]);
$assert.notConstructable(globalThis["probeCase"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeCase"]?.["prototype"]), ['constructor'], globalThis["probeCase"]?.["prototype"]);
$assert.sameValue(globalThis["probeCase"]?.["prototype"]?.["constructor"], globalThis["probeCase"]);
$verifyProperty(globalThis["probeCase"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeCase"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeCase"], "name", {
  value: "probeCase",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeCase"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeDefault"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeDefault"]), true);
$assert.callable(globalThis["probeDefault"]);
$assert.constructable(globalThis["probeDefault"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeDefault"]), ['length', 'name', 'prototype'], globalThis["probeDefault"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeDefault"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeDefault"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeDefault"]?.["prototype"]);
$assert.notConstructable(globalThis["probeDefault"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeDefault"]?.["prototype"]), ['constructor'], globalThis["probeDefault"]?.["prototype"]);
$assert.sameValue(globalThis["probeDefault"]?.["prototype"]?.["constructor"], globalThis["probeDefault"]);
$verifyProperty(globalThis["probeDefault"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeDefault"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeDefault"], "name", {
  value: "probeDefault",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeDefault"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["probeDefaultBeforeCase"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeDefaultBeforeCase"]), true);
$assert.callable(globalThis["probeDefaultBeforeCase"]);
$assert.constructable(globalThis["probeDefaultBeforeCase"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeDefaultBeforeCase"]), ['length', 'name', 'prototype'], globalThis["probeDefaultBeforeCase"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["probeDefaultBeforeCase"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["probeDefaultBeforeCase"]?.["prototype"]), true);
$assert.notCallable(globalThis["probeDefaultBeforeCase"]?.["prototype"]);
$assert.notConstructable(globalThis["probeDefaultBeforeCase"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["probeDefaultBeforeCase"]?.["prototype"]), ['constructor'], globalThis["probeDefaultBeforeCase"]?.["prototype"]);
$assert.sameValue(globalThis["probeDefaultBeforeCase"]?.["prototype"]?.["constructor"], globalThis["probeDefaultBeforeCase"]);
$verifyProperty(globalThis["probeDefaultBeforeCase"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeDefaultBeforeCase"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["probeDefaultBeforeCase"], "name", {
  value: "probeDefaultBeforeCase",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["probeDefaultBeforeCase"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
