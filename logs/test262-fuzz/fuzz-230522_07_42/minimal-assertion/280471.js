...
$assert.notConstructable(globalThis["object"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["toString"]), ['length', 'name'], globalThis["object"]?.["toString"]);
...
$assert.notConstructable(globalThis["object"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["valueOf"]), ['length', 'name'], globalThis["object"]?.["valueOf"]);
