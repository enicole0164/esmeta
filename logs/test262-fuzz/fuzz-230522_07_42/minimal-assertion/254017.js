...
$assert.compareArray($Reflect_ownKeys(globalThis["syncIterator"]), ['next', 'return', Symbol.iterator], globalThis["syncIterator"]);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get, "name", {
  value: "get return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["syncIterator"], "return")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"], "return", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
