...
$assert.sameValue($Object_getPrototypeOf(globalThis["newInstance"]), Boolean.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["newInstance"]), [], globalThis["newInstance"]);
