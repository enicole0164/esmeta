...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterThrows"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterThrows"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["iterThrows"]?.[Symbol.iterator]);
$assert.constructable(globalThis["iterThrows"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterThrows"]?.[Symbol.iterator]), ['length', 'name', 'prototype'], globalThis["iterThrows"]?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]), ['constructor'], globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"]?.["constructor"], globalThis["iterThrows"]?.[Symbol.iterator]);
$verifyProperty(globalThis["iterThrows"]?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterThrows"]?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["iterThrows"]?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterThrows"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
