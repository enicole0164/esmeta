...
$assert.sameValue($Object_getPrototypeOf(fulfillables), Array.prototype);
$assert.sameValue(Object.isExtensible(fulfillables), true);
$assert.notCallable(fulfillables);
$assert.notConstructable(fulfillables);
$assert.compareArray($Reflect_ownKeys(fulfillables), ['0', '1', '2', '3', 'length'], fulfillables);
$assert.sameValue($Object_getPrototypeOf(fulfillables?.["2"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(fulfillables?.["2"]), true);
$assert.notCallable(fulfillables?.["2"]);
$assert.notConstructable(fulfillables?.["2"]);
$assert.compareArray($Reflect_ownKeys(fulfillables?.["2"]), [], fulfillables?.["2"]);
$verifyProperty(fulfillables, "2", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(fulfillables, "length", {
  value: 4.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(fulfillables?.["1"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(fulfillables?.["1"]), true);
$assert.notCallable(fulfillables?.["1"]);
$assert.notConstructable(fulfillables?.["1"]);
$assert.compareArray($Reflect_ownKeys(fulfillables?.["1"]), [], fulfillables?.["1"]);
$verifyProperty(fulfillables, "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(fulfillables?.["3"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(fulfillables?.["3"]), true);
$assert.notCallable(fulfillables?.["3"]);
$assert.notConstructable(fulfillables?.["3"]);
$assert.compareArray($Reflect_ownKeys(fulfillables?.["3"]), [], fulfillables?.["3"]);
$verifyProperty(fulfillables, "3", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(fulfillables?.["0"]), Promise.prototype);
$assert.sameValue(Object.isExtensible(fulfillables?.["0"]), true);
$assert.notCallable(fulfillables?.["0"]);
$assert.notConstructable(fulfillables?.["0"]);
$assert.compareArray($Reflect_ownKeys(fulfillables?.["0"]), [], fulfillables?.["0"]);
$verifyProperty(fulfillables, "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
