...
$assert.sameValue($Object_getPrototypeOf(globalThis["coercibleKey1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["coercibleKey1"]), true);
$assert.notCallable(globalThis["coercibleKey1"]);
$assert.notConstructable(globalThis["coercibleKey1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["coercibleKey1"]), ['toString', 'valueOf', 'hint'], globalThis["coercibleKey1"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get, "name", {
  value: "get toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "toString")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey1"], "toString", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get, "name", {
  value: "get valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["coercibleKey1"], "valueOf")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey1"], "valueOf", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey1"], "hint", {
  value: "string",
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["coercibleKey2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["coercibleKey2"]), true);
$assert.notCallable(globalThis["coercibleKey2"]);
$assert.notConstructable(globalThis["coercibleKey2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["coercibleKey2"]), ['hint', Symbol.toPrimitive], globalThis["coercibleKey2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]);
$assert.constructable(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["coercibleKey2"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]), ['constructor'], globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.sameValue(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"]?.["constructor"], globalThis["coercibleKey2"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["coercibleKey2"]?.[Symbol.toPrimitive]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey2"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["coercibleKey2"]?.[Symbol.toPrimitive], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey2"]?.[Symbol.toPrimitive], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey2"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["coercibleKey2"], "hint", {
  value: "string",
  writable: true,
  enumerable: true,
  configurable: true,
