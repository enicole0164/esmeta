...
$assert.sameValue($Object_getPrototypeOf(globalThis["_toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_toString"]), true);
$assert.callable(globalThis["_toString"]);
$assert.constructable(globalThis["_toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_toString"]), ['length', 'name', 'prototype'], globalThis["_toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["_toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["_toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["_toString"]?.["prototype"]);
$assert.notConstructable(globalThis["_toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["_toString"]?.["prototype"]), ['constructor'], globalThis["_toString"]?.["prototype"]);
$assert.sameValue(globalThis["_toString"]?.["prototype"]?.["constructor"], globalThis["_toString"]);
$verifyProperty(globalThis["_toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["_toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["_toString"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["_toString"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
