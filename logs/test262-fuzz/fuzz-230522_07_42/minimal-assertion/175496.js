...
$assert.compareArray($Reflect_ownKeys(globalThis["Test262Error"]?.["prototype"]?.["toString"]), ['index'], globalThis["Test262Error"]?.["prototype"]?.["toString"]);
$verifyProperty(globalThis["Test262Error"]?.["prototype"]?.["toString"], "index", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["bar"])), ['0', 'length'], $Object_getPrototypeOf(globalThis["bar"]));
$verifyProperty($Object_getPrototypeOf(globalThis["bar"]), "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["bar"]), "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["bar"]), ['name', 'prototype'], globalThis["bar"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["bar"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["bar"]?.["prototype"]), true);
$assert.notCallable(globalThis["bar"]?.["prototype"]);
$assert.notConstructable(globalThis["bar"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bar"]?.["prototype"]), ['constructor'], globalThis["bar"]?.["prototype"]);
$assert.sameValue(globalThis["bar"]?.["prototype"]?.["constructor"], globalThis["bar"]);
$verifyProperty(globalThis["bar"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bar"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["bound"]), $Object_getPrototypeOf(globalThis["bar"]));
$assert.sameValue(Object.isExtensible(globalThis["bound"]), true);
$assert.callable(globalThis["bound"]);
$assert.constructable(globalThis["bound"]);
$assert.compareArray($Reflect_ownKeys(globalThis["bound"]), ['length', 'name'], globalThis["bound"]);
$verifyProperty(globalThis["bound"], "name", {
  value: "bound bar",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["bound"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]?.["length"]), Number.prototype);
$assert.sameValue(Object.isExtensible(globalThis["foo"]?.["length"]), true);
$assert.notCallable(globalThis["foo"]?.["length"]);
$assert.notConstructable(globalThis["foo"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]?.["length"]), [], globalThis["foo"]?.["length"]);
