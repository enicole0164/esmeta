...
$assert.sameValue($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FORCEDUSER_FACTORY"]), true);
$assert.callable(globalThis["FORCEDUSER_FACTORY"]);
$assert.constructable(globalThis["FORCEDUSER_FACTORY"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FORCEDUSER_FACTORY"]), ['length', 'name', 'prototype'], globalThis["FORCEDUSER_FACTORY"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])), ['constructor'], $Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]));
$verifyProperty($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"], "name", {
  value: "USER_FACTORY",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]), true);
$assert.notCallable(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]);
$assert.notConstructable(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]), ['name', 'getName'], globalThis["FORCEDUSER_FACTORY"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]), true);
$assert.callable(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]);
$assert.constructable(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]), ['length', 'name', 'prototype'], globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]), true);
$assert.notCallable(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]);
$assert.notConstructable(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]), ['constructor'], globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]);
$assert.sameValue(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"]?.["constructor"], globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]);
$verifyProperty(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"]?.["prototype"]?.["getName"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"]?.["prototype"], "getName", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"]?.["prototype"], "name", {
  value: "noname",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"], "name", {
  value: "FORCEDUSER_FACTORY",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["FORCEDUSER_FACTORY"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue(globalThis["USER_FACTORY"], $Object_getPrototypeOf(globalThis["FORCEDUSER_FACTORY"]?.["prototype"])?.["constructor"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["luke"]), globalThis["FORCEDUSER_FACTORY"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(globalThis["luke"]), true);
$assert.notCallable(globalThis["luke"]);
$assert.notConstructable(globalThis["luke"]);
$assert.compareArray($Reflect_ownKeys(globalThis["luke"]), ['name', 'grade', 'getGrade'], globalThis["luke"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["luke"]?.["getGrade"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["luke"]?.["getGrade"]), true);
$assert.callable(globalThis["luke"]?.["getGrade"]);
$assert.constructable(globalThis["luke"]?.["getGrade"]);
$assert.compareArray($Reflect_ownKeys(globalThis["luke"]?.["getGrade"]), ['length', 'name', 'prototype'], globalThis["luke"]?.["getGrade"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["luke"]?.["getGrade"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["luke"]?.["getGrade"]?.["prototype"]), true);
$assert.notCallable(globalThis["luke"]?.["getGrade"]?.["prototype"]);
$assert.notConstructable(globalThis["luke"]?.["getGrade"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["luke"]?.["getGrade"]?.["prototype"]), ['constructor'], globalThis["luke"]?.["getGrade"]?.["prototype"]);
$assert.sameValue(globalThis["luke"]?.["getGrade"]?.["prototype"]?.["constructor"], globalThis["luke"]?.["getGrade"]);
$verifyProperty(globalThis["luke"]?.["getGrade"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["luke"]?.["getGrade"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["luke"]?.["getGrade"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["luke"]?.["getGrade"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["luke"], "getGrade", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["luke"], "name", {
  value: "Luke Skywalker",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["luke"], "grade", {
  value: 12.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["proto"], globalThis["FORCEDUSER_FACTORY"]?.["prototype"]);
