...
$assert.compareArray($Reflect_ownKeys(globalThis["object"]), ['valueOf', 'toString'], globalThis["object"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["toString"]), true);
$assert.callable(globalThis["object"]?.["toString"]);
$assert.constructable(globalThis["object"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["object"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["object"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["object"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["object"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["object"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["object"]?.["toString"]);
$verifyProperty(globalThis["object"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["object"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["valueOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["valueOf"]), true);
$assert.callable(globalThis["object"]?.["valueOf"]);
$assert.constructable(globalThis["object"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["valueOf"]), ['length', 'name', 'prototype'], globalThis["object"]?.["valueOf"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["object"]?.["valueOf"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["object"]?.["valueOf"]?.["prototype"]), true);
$assert.notCallable(globalThis["object"]?.["valueOf"]?.["prototype"]);
$assert.notConstructable(globalThis["object"]?.["valueOf"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["object"]?.["valueOf"]?.["prototype"]), ['constructor'], globalThis["object"]?.["valueOf"]?.["prototype"]);
$assert.sameValue(globalThis["object"]?.["valueOf"]?.["prototype"]?.["constructor"], globalThis["object"]?.["valueOf"]);
$verifyProperty(globalThis["object"]?.["valueOf"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["valueOf"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["object"]?.["valueOf"], "name", {
  value: "valueOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"]?.["valueOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["object"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
