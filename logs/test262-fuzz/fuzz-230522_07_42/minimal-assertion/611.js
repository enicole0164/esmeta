...
$assert.sameValue($Object_getPrototypeOf(globalThis["arr"]?.["2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["arr"]?.["2"]), true);
$assert.callable(globalThis["arr"]?.["2"]);
$assert.notConstructable(globalThis["arr"]?.["2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]?.["2"]), ['length', 'name'], globalThis["arr"]?.["2"]);
$verifyProperty(globalThis["arr"]?.["2"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["arr"]?.["2"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
