...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['cause'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["cause"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["cause"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["cause"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["cause"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["cause"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["notSameValue"]?.["cause"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["cause"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["cause"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["notSameValue"]?.["cause"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["cause"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["cause"]?.["prototype"]), [], globalThis["assert"]?.["notSameValue"]?.["cause"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["cause"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["cause"], "name", {
  value: "cause",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["cause"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "cause", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['set'], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], "set", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
