...
$assert.sameValue($Object_getPrototypeOf(globalThis["case2"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case2"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["case2"]?.[Symbol.toPrimitive]);
$assert.notConstructable(globalThis["case2"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["case2"]?.[Symbol.toPrimitive]), ['length', 'name'], globalThis["case2"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["case2"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case2"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
