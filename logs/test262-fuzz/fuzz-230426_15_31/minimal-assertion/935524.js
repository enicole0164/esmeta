...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), ['add'], globalThis["assert"]?.["throws"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["throws"]?.["add"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["throws"]?.["add"]), true);
$assert.callable(globalThis["assert"]?.["throws"]?.["add"]);
$assert.notConstructable(globalThis["assert"]?.["throws"]?.["add"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]?.["add"]), ['length', 'name'], globalThis["assert"]?.["throws"]?.["add"]);
$verifyProperty(globalThis["assert"]?.["throws"]?.["add"], "name", {
  value: "add",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"]?.["add"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"], "add", {
  writable: true,
  enumerable: true,
  configurable: true,
});
