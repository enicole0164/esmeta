...
$assert.compareArray($Reflect_ownKeys(globalThis["__obj"]), ['toString', 'toLowerCase'], globalThis["__obj"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), [Symbol.toPrimitive], globalThis["assert"]?.["throws"]);
$verifyProperty(globalThis["assert"]?.["throws"], Symbol.toPrimitive, {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
