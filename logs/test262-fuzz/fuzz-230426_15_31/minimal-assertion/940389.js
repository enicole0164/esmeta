...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['0', '1', 'length'], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], "1", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
