...
$assert.sameValue($Object_getPrototypeOf(globalThis["A1"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["A1"]), true);
$assert.callable(globalThis["A1"]);
$assert.constructable(globalThis["A1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["A1"]), ['length', 'name', 'prototype'], globalThis["A1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["A1"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["A1"]?.["prototype"]), true);
$assert.notCallable(globalThis["A1"]?.["prototype"]);
$assert.notConstructable(globalThis["A1"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["A1"]?.["prototype"]), ['constructor'], globalThis["A1"]?.["prototype"]);
$assert.sameValue(globalThis["A1"]?.["prototype"]?.["constructor"], globalThis["A1"]);
$verifyProperty(globalThis["A1"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["A1"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["A1"], "name", {
  value: "A1",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["A2"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["A2"]), true);
$assert.callable(globalThis["A2"]);
$assert.constructable(globalThis["A2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["A2"]), ['length', 'name', 'prototype'], globalThis["A2"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["A2"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["A2"]?.["prototype"]), true);
$assert.notCallable(globalThis["A2"]?.["prototype"]);
$assert.notConstructable(globalThis["A2"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["A2"]?.["prototype"]), ['constructor'], globalThis["A2"]?.["prototype"]);
$assert.sameValue(globalThis["A2"]?.["prototype"]?.["constructor"], globalThis["A2"]);
$verifyProperty(globalThis["A2"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["A2"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["A2"], "name", {
  value: "A2",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["items"]), ['length'], globalThis["items"]);
$verifyProperty(globalThis["items"], "length", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
