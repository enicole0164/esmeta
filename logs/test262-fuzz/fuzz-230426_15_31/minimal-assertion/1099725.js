...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), [Symbol.species], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.[Symbol.species]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.[Symbol.species]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.[Symbol.species]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.[Symbol.species]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.[Symbol.species]), ['length', 'name'], globalThis["assert"]?.["notSameValue"]?.[Symbol.species]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.[Symbol.species], "name", {
  value: "[Symbol.species]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.[Symbol.species], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], Symbol.species, {
  writable: true,
  enumerable: true,
  configurable: true,
});
