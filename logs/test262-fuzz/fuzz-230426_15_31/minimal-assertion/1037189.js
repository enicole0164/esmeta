...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['push', 'length'], globalThis["obj"]);
$assert.sameValue(globalThis["obj"]?.["push"], Array.prototype.push);
$verifyProperty(globalThis["obj"], "push", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["push"], 1.0);
