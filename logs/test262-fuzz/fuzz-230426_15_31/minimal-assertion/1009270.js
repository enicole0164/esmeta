...
$assert.sameValue(globalThis["caughtErr"], undefined);
...
$assert.sameValue(globalThis["order"], 1.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["thrownErr"]), Error.prototype);
$assert.sameValue(Object.isExtensible(globalThis["thrownErr"]), true);
$assert.notCallable(globalThis["thrownErr"]);
$assert.notConstructable(globalThis["thrownErr"]);
$assert.compareArray($Reflect_ownKeys(globalThis["thrownErr"]), ['message'], globalThis["thrownErr"]);
$verifyProperty(globalThis["thrownErr"], "message", {
  value: "Catch me.",
  writable: true,
  enumerable: false,
  configurable: true,
