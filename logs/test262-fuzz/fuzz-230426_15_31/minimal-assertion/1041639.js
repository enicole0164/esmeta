...
$assert.sameValue(globalThis["called"], 0.0);
$assert.sameValue($Object_getPrototypeOf(globalThis["poison"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["poison"]), ['0', 'length'], globalThis["poison"]);
$verifyProperty(globalThis["poison"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["poison"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["thisValueCalled"], 0.0);
