...
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncIter"]?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["asyncIter"]?.["return"]), true);
$assert.callable(globalThis["asyncIter"]?.["return"]);
$assert.notConstructable(globalThis["asyncIter"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIter"]?.["return"]), ['length', 'name'], globalThis["asyncIter"]?.["return"]);
$verifyProperty(globalThis["asyncIter"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["asyncIter"]?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
