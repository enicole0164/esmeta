...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['0', '1', 'length'], globalThis["a"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["1"]), true);
$assert.notCallable(globalThis["a"]?.["1"]);
$assert.notConstructable(globalThis["a"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["1"]), ['0', '1', 'length'], globalThis["a"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["1"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["1"]?.["1"]), true);
$assert.notCallable(globalThis["a"]?.["1"]?.["1"]);
$assert.notConstructable(globalThis["a"]?.["1"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["1"]?.["1"]), ['0', '1', 'length'], globalThis["a"]?.["1"]?.["1"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["a"]?.["1"]?.["1"]?.["1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a"]?.["1"]?.["1"]?.["1"]), true);
$assert.notCallable(globalThis["a"]?.["1"]?.["1"]?.["1"]);
$assert.notConstructable(globalThis["a"]?.["1"]?.["1"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["1"]?.["1"]?.["1"]), ['0', 'length'], globalThis["a"]?.["1"]?.["1"]?.["1"]);
$verifyProperty(globalThis["a"]?.["1"]?.["1"]?.["1"], "length", {
  value: 1.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["1"]?.["1"]?.["1"], "0", {
  value: 4.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["1"]?.["1"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["1"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["1"]?.["1"], "0", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["1"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["a"]?.["1"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["a"]?.["1"], "0", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['length', 'name', 'prototype', '_isSameValue', 'notSameValue', '_toString', 'compareArray'], globalThis["assert"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["compareArray"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["compareArray"]), true);
$assert.callable(globalThis["assert"]?.["compareArray"]);
$assert.notConstructable(globalThis["assert"]?.["compareArray"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["compareArray"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["compareArray"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["compareArray"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["compareArray"]?.["prototype"]), [], globalThis["assert"]?.["compareArray"]?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["compareArray"]), ['length', 'name', 'prototype', 'format'], globalThis["compareArray"]);
