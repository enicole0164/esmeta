...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), ['length'], globalThis["assert"]?.["throws"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['index'], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], "index", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(errorArray), ['0', 'length'], errorArray);
