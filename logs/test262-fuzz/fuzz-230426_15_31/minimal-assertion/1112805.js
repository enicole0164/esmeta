...
$assert.sameValue($Object_getPrototypeOf(globalThis["rejection"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["rejection"]), true);
$assert.notCallable(globalThis["rejection"]);
$assert.notConstructable(globalThis["rejection"]);
$assert.compareArray($Reflect_ownKeys(globalThis["rejection"]), [], globalThis["rejection"]);
