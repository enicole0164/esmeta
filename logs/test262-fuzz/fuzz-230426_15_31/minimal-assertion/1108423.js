...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get, "name", {
  value: "get [Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["thisVal"], Symbol.toPrimitive)?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
