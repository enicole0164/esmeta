...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), ['throw'], globalThis["assert"]?.["throws"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["throws"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["throws"]?.["throw"]), true);
$assert.callable(globalThis["assert"]?.["throws"]?.["throw"]);
$assert.notConstructable(globalThis["assert"]?.["throws"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]?.["throw"]), ['length', 'name'], globalThis["assert"]?.["throws"]?.["throw"]);
$verifyProperty(globalThis["assert"]?.["throws"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"], "throw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]), ['constructor', 'checkPrivateGetter'], C?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]?.["checkPrivateGetter"]), Function.prototype);
$assert.sameValue(Object.isExtensible(C?.["prototype"]?.["checkPrivateGetter"]), true);
$assert.callable(C?.["prototype"]?.["checkPrivateGetter"]);
$assert.notConstructable(C?.["prototype"]?.["checkPrivateGetter"]);
$assert.compareArray($Reflect_ownKeys(C?.["prototype"]?.["checkPrivateGetter"]), ['length', 'name'], C?.["prototype"]?.["checkPrivateGetter"]);
$verifyProperty(C?.["prototype"]?.["checkPrivateGetter"], "name", {
  value: "checkPrivateGetter",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"]?.["checkPrivateGetter"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(C?.["prototype"], "checkPrivateGetter", {
  writable: true,
  enumerable: false,
  configurable: true,
});
