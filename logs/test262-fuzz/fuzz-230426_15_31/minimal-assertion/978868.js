...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.["length"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.["length"]), true);
$assert.callable(globalThis["assert"]?.["_toString"]?.["length"]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.["length"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.["length"]), ['length', 'name'], globalThis["assert"]?.["_toString"]?.["length"]);
$verifyProperty(globalThis["assert"]?.["_toString"]?.["length"], "name", {
  value: "length",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.["length"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
