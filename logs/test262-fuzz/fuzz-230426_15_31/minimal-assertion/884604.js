...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['throw'], globalThis["assert"]?.["_isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.["throw"]), true);
$assert.callable(globalThis["assert"]?.["_isSameValue"]?.["throw"]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["throw"]), ['length', 'name'], globalThis["assert"]?.["_isSameValue"]?.["throw"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "throw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
