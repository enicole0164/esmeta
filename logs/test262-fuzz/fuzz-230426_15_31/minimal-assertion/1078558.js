...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['length', 'name', 'prototype', '_isSameValue', 'throws', '_toString'], globalThis["assert"]);
...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))), Object.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))), true);
$assert.notCallable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"])));
$assert.notConstructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"])));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))), ['constructor'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"])));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]);
$assert.constructable($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]?.["prototype"], $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"])));
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"], "name", {
  value: "A",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"])), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["containsprivatex"])), true);
$assert.notCallable($Object_getPrototypeOf(globalThis["containsprivatex"]));
$assert.notConstructable($Object_getPrototypeOf(globalThis["containsprivatex"]));
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["containsprivatex"])), ['constructor'], $Object_getPrototypeOf(globalThis["containsprivatex"]));
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]), $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]);
$assert.sameValue(Object.isExtensible($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]), true);
$assert.callable($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]);
$assert.constructable($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]);
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]), ['length', 'name', 'prototype'], $Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]?.["prototype"], $Object_getPrototypeOf(globalThis["containsprivatex"]));
$verifyProperty($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"], "prototype", {
  writable: false,
  enumerable: false,
  configurable: false,
});
$verifyProperty($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"], "name", {
  value: "C",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty($Object_getPrototypeOf(globalThis["containsprivatex"]), "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(Object.isExtensible(globalThis["containsprivatex"]), true);
$assert.notCallable(globalThis["containsprivatex"]);
$assert.notConstructable(globalThis["containsprivatex"]);
$assert.compareArray($Reflect_ownKeys(globalThis["containsprivatex"]), [], globalThis["containsprivatex"]);
$assert.sameValue(A, $Object_getPrototypeOf($Object_getPrototypeOf(globalThis["containsprivatex"]))?.["constructor"]);
$assert.sameValue(C, $Object_getPrototypeOf(globalThis["containsprivatex"])?.["constructor"]);
