...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['0', '1', '2', 'length'], globalThis["a"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.[Symbol.asyncIterator]), Function.prototype);
