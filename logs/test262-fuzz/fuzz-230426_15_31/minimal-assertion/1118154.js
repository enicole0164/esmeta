...
$assert.sameValue($Object_getPrototypeOf(globalThis["Test262Error"]?.["toString"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Test262Error"]?.["toString"]), true);
$assert.notCallable(globalThis["Test262Error"]?.["toString"]);
$assert.notConstructable(globalThis["Test262Error"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Test262Error"]?.["toString"]), ['length'], globalThis["Test262Error"]?.["toString"]);
