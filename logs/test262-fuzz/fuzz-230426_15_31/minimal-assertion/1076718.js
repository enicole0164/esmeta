...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), [Symbol.toPrimitive], globalThis["assert"]?.["sameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive]), ['length', 'name'], globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.[Symbol.toPrimitive], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(Test?.["prototype"]), ['constructor'], Test?.["prototype"]);
