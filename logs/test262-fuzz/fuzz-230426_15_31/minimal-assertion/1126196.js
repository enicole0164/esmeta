...
$assert.sameValue($Object_getPrototypeOf(globalThis["compareArray"]?.["isSameValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["compareArray"]?.["isSameValue"]), true);
$assert.notCallable(globalThis["compareArray"]?.["isSameValue"]);
$assert.notConstructable(globalThis["compareArray"]?.["isSameValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["compareArray"]?.["isSameValue"]), ['0'], globalThis["compareArray"]?.["isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["compareArray"]?.["isSameValue"]?.["0"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["compareArray"]?.["isSameValue"]?.["0"]), true);
$assert.callable(globalThis["compareArray"]?.["isSameValue"]?.["0"]);
$assert.notConstructable(globalThis["compareArray"]?.["isSameValue"]?.["0"]);
$assert.compareArray($Reflect_ownKeys(globalThis["compareArray"]?.["isSameValue"]?.["0"]), ['length', 'name'], globalThis["compareArray"]?.["isSameValue"]?.["0"]);
$verifyProperty(globalThis["compareArray"]?.["isSameValue"]?.["0"], "name", {
  value: "0",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["compareArray"]?.["isSameValue"]?.["0"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["compareArray"]?.["isSameValue"], "0", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["expected"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]), ['then'], globalThis["expected"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["expected"]?.["then"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["expected"]?.["then"]), true);
$assert.callable(globalThis["expected"]?.["then"]);
$assert.notConstructable(globalThis["expected"]?.["then"]);
$assert.compareArray($Reflect_ownKeys(globalThis["expected"]?.["then"]), ['length', 'name'], globalThis["expected"]?.["then"]);
$verifyProperty(globalThis["expected"]?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["expected"]?.["then"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["expected"], "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
