...
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]), ['length', 'name'], globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]);
