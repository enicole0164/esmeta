...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['length', 'getClass'], globalThis["arr"]);
$assert.sameValue(globalThis["arr"]?.["getClass"], Object.prototype.toString);
$verifyProperty(globalThis["arr"], "getClass", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['cause'], globalThis["assert"]?.["_isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["cause"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.["cause"]), true);
$assert.callable(globalThis["assert"]?.["_isSameValue"]?.["cause"]);
$assert.constructable(globalThis["assert"]?.["_isSameValue"]?.["cause"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["cause"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["_isSameValue"]?.["cause"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]), ['constructor'], globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]);
$assert.sameValue(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"]?.["constructor"], globalThis["assert"]?.["_isSameValue"]?.["cause"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["cause"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["cause"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["cause"], "name", {
  value: "cause",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["cause"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "cause", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["x"]), ['0', '1', '2', '3', '4', 'length'], globalThis["x"]);
