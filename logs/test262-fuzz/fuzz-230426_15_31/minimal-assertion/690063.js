...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['constructor'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["constructor"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["constructor"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["constructor"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["constructor"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["notSameValue"]?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["constructor"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["constructor"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["notSameValue"]?.["constructor"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["constructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["constructor"]?.["prototype"]), [], globalThis["assert"]?.["notSameValue"]?.["constructor"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["constructor"], "name", {
  value: "constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "constructor", {
  writable: true,
  enumerable: true,
  configurable: true,
});
