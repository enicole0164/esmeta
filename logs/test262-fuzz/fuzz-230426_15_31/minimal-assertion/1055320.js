...
$assert.compareArray($Reflect_ownKeys(globalThis["P"]), ['getPrototypeOf'], globalThis["P"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["P"]?.["getPrototypeOf"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["P"]?.["getPrototypeOf"]), true);
$assert.callable(globalThis["P"]?.["getPrototypeOf"]);
$assert.notConstructable(globalThis["P"]?.["getPrototypeOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["P"]?.["getPrototypeOf"]), ['length', 'name'], globalThis["P"]?.["getPrototypeOf"]);
$verifyProperty(globalThis["P"]?.["getPrototypeOf"], "name", {
  value: "getPrototypeOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["P"]?.["getPrototypeOf"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["P"], "getPrototypeOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
