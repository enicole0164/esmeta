...
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIterable"]), [Symbol.asyncIterator], globalThis["asyncIterable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncIterable"]?.[Symbol.asyncIterator]), AsyncFunction.prototype);
...
$assert.notConstructable(globalThis["asyncIterable"]?.[Symbol.asyncIterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["asyncIterable"]?.[Symbol.asyncIterator]), ['length', 'name'], globalThis["asyncIterable"]?.[Symbol.asyncIterator]);
