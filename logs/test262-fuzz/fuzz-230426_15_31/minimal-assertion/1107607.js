...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["deleteProperty"]), GeneratorFunction.prototype);
...
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["deleteProperty"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["deleteProperty"]?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["deleteProperty"]?.["prototype"]), [], globalThis["assert"]?.["notSameValue"]?.["deleteProperty"]?.["prototype"]);
