...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]?.[Symbol.iterator]), AsyncGeneratorFunction.prototype);
...
$assert.notConstructable(globalThis["iterable"]?.[Symbol.iterator]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterable"]?.[Symbol.iterator]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["iterable"]?.[Symbol.iterator]?.["prototype"]), [], globalThis["iterable"]?.[Symbol.iterator]?.["prototype"]);
