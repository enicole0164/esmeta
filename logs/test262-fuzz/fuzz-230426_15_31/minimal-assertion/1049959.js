...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['length', 'name', 'prototype', '_isSameValue', 'notSameValue', '_toString'], globalThis["assert"]);
...
$assert.sameValue(globalThis["resolve"], undefined);
