...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['throw'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["throw"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["throw"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["throw"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["throw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["throw"]), ['length', 'name'], globalThis["assert"]?.["notSameValue"]?.["throw"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["throw"], "name", {
  value: "throw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["throw"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "throw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['has'], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], "has", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
