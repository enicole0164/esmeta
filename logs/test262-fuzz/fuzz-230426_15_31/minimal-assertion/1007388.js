...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['setPrototypeOf'], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], "setPrototypeOf", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
