...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['0', 'pop', 'length'], globalThis["obj"]);
$assert.sameValue(globalThis["obj"]?.["pop"], Array.prototype.pop);
$verifyProperty(globalThis["obj"], "pop", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["pop"], undefined);
