...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "1")?.get), GeneratorFunction.prototype);
...
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["arr"], "1")?.get);
...
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["arr"], "1")?.get?.["prototype"]), GeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["arr"], "1")?.get?.["prototype"]), [], Object.getOwnPropertyDescriptor(globalThis["arr"], "1")?.get?.["prototype"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['prototype'], globalThis["assert"]?.["notSameValue"]);
