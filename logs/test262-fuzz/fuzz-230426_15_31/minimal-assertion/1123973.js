...
$assert.compareArray($Reflect_ownKeys(globalThis["Constructor"]), ['length', 'name', 'prototype', 'resolve', 'reject'], globalThis["Constructor"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["Constructor"]?.["reject"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Constructor"]?.["reject"]), true);
$assert.callable(globalThis["Constructor"]?.["reject"]);
$assert.constructable(globalThis["Constructor"]?.["reject"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Constructor"]?.["reject"]), ['length', 'name', 'prototype'], globalThis["Constructor"]?.["reject"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["Constructor"]?.["reject"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["Constructor"]?.["reject"]?.["prototype"]), true);
$assert.notCallable(globalThis["Constructor"]?.["reject"]?.["prototype"]);
$assert.notConstructable(globalThis["Constructor"]?.["reject"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["Constructor"]?.["reject"]?.["prototype"]), ['constructor'], globalThis["Constructor"]?.["reject"]?.["prototype"]);
$assert.sameValue(globalThis["Constructor"]?.["reject"]?.["prototype"]?.["constructor"], globalThis["Constructor"]?.["reject"]);
$verifyProperty(globalThis["Constructor"]?.["reject"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Constructor"]?.["reject"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["Constructor"]?.["reject"], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Constructor"]?.["reject"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["Constructor"], "reject", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(p), Object.prototype);
$assert.sameValue(Object.isExtensible(p), true);
$assert.notCallable(p);
$assert.notConstructable(p);
$assert.compareArray($Reflect_ownKeys(p), ['then'], p);
$assert.sameValue($Object_getPrototypeOf(p?.["then"]), Function.prototype);
$assert.sameValue(Object.isExtensible(p?.["then"]), true);
$assert.callable(p?.["then"]);
$assert.notConstructable(p?.["then"]);
$assert.compareArray($Reflect_ownKeys(p?.["then"]), ['length', 'name'], p?.["then"]);
$verifyProperty(p?.["then"], "name", {
  value: "then",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(p?.["then"], "length", {
  value: 2.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(p, "then", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(pOnRejected), Function.prototype);
$assert.sameValue(Object.isExtensible(pOnRejected), true);
$assert.callable(pOnRejected);
$assert.notConstructable(pOnRejected);
$assert.compareArray($Reflect_ownKeys(pOnRejected), ['length', 'name'], pOnRejected);
$verifyProperty(pOnRejected, "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(pOnRejected, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$assert.sameValue(rejectCallCount, 1.0);
$assert.sameValue($Object_getPrototypeOf(returnValue), Object.prototype);
$assert.sameValue(Object.isExtensible(returnValue), true);
$assert.notCallable(returnValue);
$assert.notConstructable(returnValue);
$assert.compareArray($Reflect_ownKeys(returnValue), [], returnValue);
