...
$assert.compareArray($Reflect_ownKeys(globalThis["custom"]?.["prototype"]), ['constructor'], globalThis["custom"]?.["prototype"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["symbol"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["symbol"]), true);
$assert.callable(globalThis["symbol"]);
$assert.constructable(globalThis["symbol"]);
$assert.compareArray($Reflect_ownKeys(globalThis["symbol"]), ['length', 'name', 'prototype'], globalThis["symbol"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["symbol"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["symbol"]?.["prototype"]), true);
$assert.notCallable(globalThis["symbol"]?.["prototype"]);
$assert.notConstructable(globalThis["symbol"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["symbol"]?.["prototype"]), ['constructor'], globalThis["symbol"]?.["prototype"]);
$assert.sameValue(globalThis["symbol"]?.["prototype"]?.["constructor"], globalThis["symbol"]);
$verifyProperty(globalThis["symbol"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["symbol"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["symbol"], "name", {
  value: "symbol",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["symbol"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
