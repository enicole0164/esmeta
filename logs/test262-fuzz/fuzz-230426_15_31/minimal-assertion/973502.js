...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['length', 'name', 'prototype', '_isSameValue', 'sameValue', 'throws', '_toString'], globalThis["assert"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), ['preventExtensions'], globalThis["assert"]?.["sameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["sameValue"]?.["preventExtensions"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["preventExtensions"]?.["prototype"]), [], globalThis["assert"]?.["sameValue"]?.["preventExtensions"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["preventExtensions"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["preventExtensions"], "name", {
  value: "preventExtensions",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["preventExtensions"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"], "preventExtensions", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["descriptor"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["descriptor"]), true);
$assert.notCallable(globalThis["descriptor"]);
$assert.notConstructable(globalThis["descriptor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["descriptor"]), ['get', 'set', 'enumerable', 'configurable'], globalThis["descriptor"]);
$assert.sameValue(globalThis["descriptor"]?.["get"], get Map.prototype.size);
$verifyProperty(globalThis["descriptor"], "get", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descriptor"], "enumerable", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descriptor"], "configurable", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["descriptor"], "set", {
  value: undefined,
  writable: true,
  enumerable: true,
  configurable: true,
