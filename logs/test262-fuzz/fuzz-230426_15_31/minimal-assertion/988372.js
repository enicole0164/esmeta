...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), ['isExtensible'], globalThis["assert"]?.["throws"]);
$verifyProperty(globalThis["assert"]?.["throws"], "isExtensible", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
