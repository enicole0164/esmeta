...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"]), true);
$assert.callable(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"]), ['length', 'name'], globalThis["assert"]?.["_toString"]?.["setPrototypeOf"]);
$verifyProperty(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"], "name", {
  value: "setPrototypeOf",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.["setPrototypeOf"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
