...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['set'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["set"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["set"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["set"]);
$assert.constructable(globalThis["assert"]?.["notSameValue"]?.["set"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["set"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["notSameValue"]?.["set"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]), ['constructor'], globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]);
$assert.sameValue(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"]?.["constructor"], globalThis["assert"]?.["notSameValue"]?.["set"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["set"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["set"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["set"], "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["set"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "set", {
  writable: true,
  enumerable: true,
  configurable: true,
});
