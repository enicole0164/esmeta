...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]), AsyncGeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["prototype"]), [], globalThis["assert"]?.["_isSameValue"]?.["prototype"]);
...
$assert.sameValue(globalThis["delegationComplete"], true);
$assert.sameValue(globalThis["errorCompletion"], false);
...
$assert.sameValue(globalThis["normalCompletion"], false);
$assert.sameValue($Object_getPrototypeOf(globalThis["spyValue"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spyValue"]), true);
$assert.notCallable(globalThis["spyValue"]);
$assert.notConstructable(globalThis["spyValue"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spyValue"]), ['done', 'value'], globalThis["spyValue"]);
$verifyProperty(globalThis["spyValue"], "done", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["spyValue"], "value")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spyValue"], "value", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
