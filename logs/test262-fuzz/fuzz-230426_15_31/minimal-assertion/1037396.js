...
$assert.compareArray($Reflect_ownKeys(globalThis["arr"]), ['0', '1', '2', 'length', 'getClass'], globalThis["arr"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['source'], globalThis["assert"]?.["_isSameValue"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "source", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
