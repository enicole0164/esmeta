...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['has'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["has"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["has"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["has"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["has"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["has"]), ['length', 'name'], globalThis["assert"]?.["notSameValue"]?.["has"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["has"], "name", {
  value: "has",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["has"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "has", {
  writable: true,
  enumerable: true,
  configurable: true,
});
