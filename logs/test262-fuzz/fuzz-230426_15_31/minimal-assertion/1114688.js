...
$assert.sameValue($Object_getPrototypeOf(globalThis["target1"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target1"]), false);
$assert.notCallable(globalThis["target1"]);
$assert.notConstructable(globalThis["target1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["target1"]), ['foo'], globalThis["target1"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set, "name", {
  value: "set foo",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["target1"], "foo")?.set, "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["target1"], "foo", {
  get: undefined,
  enumerable: true,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["target2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["target2"]), false);
$assert.notCallable(globalThis["target2"]);
$assert.notConstructable(globalThis["target2"]);
$assert.sameValue(globalThis["value1"], 2.0);
$assert.sameValue(globalThis["value2"], 2.0);
