...
$assert.sameValue(globalThis["P"], 0.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), [Symbol.unscopables], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables]), ['length', 'name'], globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables], "name", {
  value: "[Symbol.unscopables]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.[Symbol.unscopables], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], Symbol.unscopables, {
  writable: true,
  enumerable: true,
  configurable: true,
});
