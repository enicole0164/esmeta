...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['preventExtensions'], globalThis["assert"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["preventExtensions"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["preventExtensions"]), true);
$assert.callable(globalThis["assert"]?.["preventExtensions"]);
$assert.notConstructable(globalThis["assert"]?.["preventExtensions"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["preventExtensions"]), ['length', 'name'], globalThis["assert"]?.["preventExtensions"]);
$verifyProperty(globalThis["assert"]?.["preventExtensions"], "name", {
  value: "preventExtensions",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["preventExtensions"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"], "preventExtensions", {
  writable: true,
  enumerable: true,
  configurable: true,
});
