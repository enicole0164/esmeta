...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['source'], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], "source", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), ['function Symbol() { [native code] }'], globalThis["assert"]?.["sameValue"]);
$verifyProperty(globalThis["assert"]?.["sameValue"], "function Symbol() { [native code] }", {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
