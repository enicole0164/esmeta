...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['ownKeys'], globalThis["assert"]?.["_toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.["ownKeys"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.["ownKeys"]), true);
$assert.callable(globalThis["assert"]?.["_toString"]?.["ownKeys"]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.["ownKeys"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.["ownKeys"]), ['length', 'name'], globalThis["assert"]?.["_toString"]?.["ownKeys"]);
$verifyProperty(globalThis["assert"]?.["_toString"]?.["ownKeys"], "name", {
  value: "ownKeys",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.["ownKeys"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"], "ownKeys", {
  writable: true,
  enumerable: true,
  configurable: true,
});
