...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['ownKeys'], globalThis["assert"]?.["_isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"]), true);
$assert.callable(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"]), ['length', 'name'], globalThis["assert"]?.["_isSameValue"]?.["ownKeys"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"], "name", {
  value: "ownKeys",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["ownKeys"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "ownKeys", {
  writable: true,
  enumerable: true,
  configurable: true,
});
