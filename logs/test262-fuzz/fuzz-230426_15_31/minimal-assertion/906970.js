...
$assert.sameValue($Object_getPrototypeOf(globalThis["s1"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["s1"]), ['x', 'valueOf'], globalThis["s1"]);
...
$assert.sameValue(globalThis["s1"]?.["valueOf"], Number.prototype.valueOf);
$verifyProperty(globalThis["s1"], "valueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["s2"]), ['x', 'myValueOf'], globalThis["s2"]);
$assert.sameValue(globalThis["s2"]?.["myValueOf"], Number.prototype.valueOf);
$verifyProperty(globalThis["s2"], "myValueOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue(globalThis["v1"], undefined);
$assert.sameValue(globalThis["v2"], undefined);
