...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), [Symbol.unscopables], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], Symbol.unscopables, {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["substring"], String.prototype.substring);
