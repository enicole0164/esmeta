...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), [Symbol.search], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], Symbol.search, {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["expected"], 3000.0);
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), ['length', 'name'], globalThis["result"]);
