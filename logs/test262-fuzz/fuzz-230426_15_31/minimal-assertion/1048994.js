...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), [Symbol.matchAll], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], Symbol.matchAll, {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
