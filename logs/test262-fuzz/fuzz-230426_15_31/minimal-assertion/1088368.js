...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]), ['length', 'constructor', Symbol.species], globalThis["a"]);
$verifyProperty(globalThis["a"], Symbol.species, {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["a"]?.["constructor"]), [], globalThis["a"]?.["constructor"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), [Symbol.toPrimitive], globalThis["assert"]?.["_isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]), true);
$assert.callable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]), ['length', 'name', 'prototype'], globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]?.["prototype"]), [], globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive], "name", {
  value: "[Symbol.toPrimitive]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.toPrimitive], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"], Symbol.toPrimitive, {
  writable: true,
  enumerable: true,
  configurable: true,
});
