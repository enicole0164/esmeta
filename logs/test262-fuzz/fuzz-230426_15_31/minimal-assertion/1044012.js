...
$assert.compareArray($Reflect_ownKeys(globalThis["Test262Error"]?.["prototype"]?.["toString"]), [Symbol.matchAll], globalThis["Test262Error"]?.["prototype"]?.["toString"]);
$verifyProperty(globalThis["Test262Error"]?.["prototype"]?.["toString"], Symbol.matchAll, {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
