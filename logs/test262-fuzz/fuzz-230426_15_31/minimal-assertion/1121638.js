...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['length'], globalThis["assert"]?.["_toString"]);
...
$assert.sameValue(globalThis["returnArgumentsLength"], 0.0);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["syncIterator"]?.["return"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["syncIterator"]?.["return"]), true);
$assert.callable(globalThis["syncIterator"]?.["return"]);
$assert.notConstructable(globalThis["syncIterator"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["syncIterator"]?.["return"]), ['length', 'name'], globalThis["syncIterator"]?.["return"]);
$verifyProperty(globalThis["syncIterator"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["syncIterator"]?.["return"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
