...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), [], globalThis["assert"]?.["throws"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), ['1'], globalThis["assert"]?.["sameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["1"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["1"]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.["1"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["1"]), ['length', 'name'], globalThis["assert"]?.["sameValue"]?.["1"]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["1"], "name", {
  value: "1",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["1"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"], "1", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["iter"]), globalThis["asyncg"]?.["prototype"]);
