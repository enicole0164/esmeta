...
$assert.compareArray($Reflect_ownKeys(x?.["prototype"]), ['constructor', 'x'], x?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(x?.["prototype"]?.["x"]), Function.prototype);
$assert.sameValue(Object.isExtensible(x?.["prototype"]?.["x"]), true);
$assert.callable(x?.["prototype"]?.["x"]);
$assert.notConstructable(x?.["prototype"]?.["x"]);
$assert.compareArray($Reflect_ownKeys(x?.["prototype"]?.["x"]), ['length', 'name'], x?.["prototype"]?.["x"]);
$verifyProperty(x?.["prototype"]?.["x"], "name", {
  value: "x",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(x?.["prototype"]?.["x"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(x?.["prototype"], "x", {
  writable: true,
  enumerable: false,
  configurable: true,
});
