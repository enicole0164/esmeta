...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), [Symbol.toStringTag], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], Symbol.toStringTag, {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(C), Base);
...
$assert.sameValue($Object_getPrototypeOf(C?.["prototype"]), Base?.["prototype"]);
