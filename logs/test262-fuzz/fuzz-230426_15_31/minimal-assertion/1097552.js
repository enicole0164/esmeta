...
$assert.compareArray($Reflect_ownKeys(globalThis["case11"]), ['deleteProperty'], globalThis["case11"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["case11"]?.["deleteProperty"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["case11"]?.["deleteProperty"]), true);
$assert.callable(globalThis["case11"]?.["deleteProperty"]);
$assert.notConstructable(globalThis["case11"]?.["deleteProperty"]);
$assert.compareArray($Reflect_ownKeys(globalThis["case11"]?.["deleteProperty"]), ['length', 'name'], globalThis["case11"]?.["deleteProperty"]);
$verifyProperty(globalThis["case11"]?.["deleteProperty"], "name", {
  value: "deleteProperty",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case11"]?.["deleteProperty"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["case11"], "deleteProperty", {
  writable: true,
  enumerable: true,
  configurable: true,
});
