...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["lastIndex"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["lastIndex"]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.["lastIndex"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["lastIndex"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["lastIndex"]), ['length', 'name'], globalThis["assert"]?.["sameValue"]?.["lastIndex"]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["lastIndex"], "name", {
  value: "lastIndex",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["lastIndex"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["bar"]), Object.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["baz"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["baz"]), true);
$assert.notCallable(globalThis["baz"]);
$assert.notConstructable(globalThis["baz"]);
$assert.compareArray($Reflect_ownKeys(globalThis["baz"]), [], globalThis["baz"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["foo"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["foo"]), [], globalThis["foo"]);
