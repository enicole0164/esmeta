...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['sticky'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["sticky"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["sticky"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["sticky"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["sticky"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["sticky"]), ['length', 'name'], globalThis["assert"]?.["notSameValue"]?.["sticky"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["sticky"], "name", {
  value: "sticky",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["sticky"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "sticky", {
  writable: true,
  enumerable: true,
  configurable: true,
});
