...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]), true);
$assert.notCallable(globalThis["assert"]);
$assert.notConstructable(globalThis["assert"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['0', 'length', 'throws', '_toString'], globalThis["assert"]);
...
$verifyProperty(globalThis["assert"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["predicate"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["predicate"]), true);
$assert.notCallable(globalThis["predicate"]);
$assert.notConstructable(globalThis["predicate"]);
$assert.compareArray($Reflect_ownKeys(globalThis["predicate"]), ['0', 'length'], globalThis["predicate"]);
...
$verifyProperty(globalThis["predicate"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
