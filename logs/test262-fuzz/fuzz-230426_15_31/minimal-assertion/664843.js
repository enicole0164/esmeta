...
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]), ['unshift', 'length'], globalThis["obj"]);
$assert.sameValue(globalThis["obj"]?.["unshift"], Array.prototype.unshift);
$verifyProperty(globalThis["obj"], "unshift", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.notConstructable(globalThis["obj"]?.["length"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["length"]?.["toString"]), ['length', 'name'], globalThis["obj"]?.["length"]?.["toString"]);
...
$assert.notConstructable(globalThis["obj"]?.["length"]?.["valueOf"]);
$assert.compareArray($Reflect_ownKeys(globalThis["obj"]?.["length"]?.["valueOf"]), ['length', 'name'], globalThis["obj"]?.["length"]?.["valueOf"]);
...
$assert.sameValue(globalThis["unshift"], 1.0);
