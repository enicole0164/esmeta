...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), [Symbol.replace], globalThis["assert"]?.["_isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]), true);
$assert.callable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]);
$assert.constructable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]), ['length', 'name', 'prototype'], globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]), ['constructor'], globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]);
$assert.sameValue(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"]?.["constructor"], globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace], "name", {
  value: "[Symbol.replace]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.[Symbol.replace], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"], Symbol.replace, {
  writable: true,
  enumerable: true,
  configurable: true,
});
