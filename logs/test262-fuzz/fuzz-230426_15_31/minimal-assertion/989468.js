...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['getPrototypeOf'], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], "getPrototypeOf", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['name'], globalThis["assert"]?.["_toString"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterator"]), MapIteratorPrototype);
