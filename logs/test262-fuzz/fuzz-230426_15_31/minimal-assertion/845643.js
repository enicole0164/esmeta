...
$assert.sameValue($Object_getPrototypeOf($Object_getPrototypeOf(globalThis["bar"])), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys($Object_getPrototypeOf(globalThis["bar"])), ['length'], $Object_getPrototypeOf(globalThis["bar"]));
