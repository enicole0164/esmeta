// [EXIT] normal
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["prototype"]), [], globalThis["assert"]?.["prototype"]);
