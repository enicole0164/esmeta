...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), [], globalThis["assert"]?.["_isSameValue"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]), ['flags', 'toString', Symbol.match, Symbol.replace], globalThis["searchValue"]);
...
$assert.notConstructable(globalThis["searchValue"]?.[Symbol.replace]);
$assert.compareArray($Reflect_ownKeys(globalThis["searchValue"]?.[Symbol.replace]), ['length', 'name'], globalThis["searchValue"]?.[Symbol.replace]);
