...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["return"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["return"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["return"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["return"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["return"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["notSameValue"]?.["return"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["return"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["return"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["notSameValue"]?.["return"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["return"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["return"]?.["prototype"]), [], globalThis["assert"]?.["notSameValue"]?.["return"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["return"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["return"], "name", {
  value: "return",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["return"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
