...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), ['exec'], globalThis["assert"]?.["throws"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["throws"]?.["exec"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["throws"]?.["exec"]), true);
$assert.callable(globalThis["assert"]?.["throws"]?.["exec"]);
$assert.notConstructable(globalThis["assert"]?.["throws"]?.["exec"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]?.["exec"]), ['length', 'name'], globalThis["assert"]?.["throws"]?.["exec"]);
$verifyProperty(globalThis["assert"]?.["throws"]?.["exec"], "name", {
  value: "exec",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"]?.["exec"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"], "exec", {
  writable: true,
  enumerable: true,
  configurable: true,
});
