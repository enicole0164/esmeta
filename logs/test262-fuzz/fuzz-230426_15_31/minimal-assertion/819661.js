...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['construct'], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], "construct", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["body"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["body"]), true);
$assert.notCallable(globalThis["body"]);
$assert.notConstructable(globalThis["body"]);
$assert.compareArray($Reflect_ownKeys(globalThis["body"]), ['toString'], globalThis["body"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["body"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["body"]?.["toString"]), true);
$assert.callable(globalThis["body"]?.["toString"]);
$assert.constructable(globalThis["body"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["body"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["body"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["body"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["body"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["body"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["body"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["body"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["body"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["body"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["body"]?.["toString"]);
$verifyProperty(globalThis["body"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["body"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["body"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["body"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["body"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue(globalThis["f"], undefined);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["p"]), ['toString'], globalThis["p"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]?.["toString"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p"]?.["toString"]), true);
$assert.callable(globalThis["p"]?.["toString"]);
$assert.constructable(globalThis["p"]?.["toString"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p"]?.["toString"]), ['length', 'name', 'prototype'], globalThis["p"]?.["toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["p"]?.["toString"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["p"]?.["toString"]?.["prototype"]), true);
$assert.notCallable(globalThis["p"]?.["toString"]?.["prototype"]);
$assert.notConstructable(globalThis["p"]?.["toString"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["p"]?.["toString"]?.["prototype"]), ['constructor'], globalThis["p"]?.["toString"]?.["prototype"]);
$assert.sameValue(globalThis["p"]?.["toString"]?.["prototype"]?.["constructor"], globalThis["p"]?.["toString"]);
$verifyProperty(globalThis["p"]?.["toString"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p"]?.["toString"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["p"]?.["toString"], "name", {
  value: "toString",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p"]?.["toString"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["p"], "toString", {
  writable: true,
  enumerable: true,
  configurable: true,
});
