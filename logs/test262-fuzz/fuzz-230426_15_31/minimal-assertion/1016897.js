...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['lastIndexOf'], globalThis["__instance"]);
$assert.sameValue(globalThis["__instance"]?.["lastIndexOf"], String.prototype.lastIndexOf);
$verifyProperty(globalThis["__instance"], "lastIndexOf", {
  writable: true,
  enumerable: true,
  configurable: true,
});
