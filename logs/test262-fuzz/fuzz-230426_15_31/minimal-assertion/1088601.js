...
$assert.sameValue($Object_getPrototypeOf(globalThis["expects"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["expects"]), true);
$assert.notCallable(globalThis["expects"]);
$assert.notConstructable(globalThis["expects"]);
$assert.compareArray($Reflect_ownKeys(globalThis["expects"]), ['0', '1', '2', 'length'], globalThis["expects"]);
$verifyProperty(globalThis["expects"], "1", {
  value: 2.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["expects"], "2", {
  value: 3.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["expects"], "length", {
  value: 3.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["expects"], "0", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
