...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), ['prototype'], globalThis["assert"]?.["sameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["prototype"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["prototype"]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["prototype"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["sameValue"]?.["prototype"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["prototype"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["prototype"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["sameValue"]?.["prototype"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["prototype"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["prototype"]?.["prototype"]), [], globalThis["assert"]?.["sameValue"]?.["prototype"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["prototype"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["prototype"], "name", {
  value: "prototype",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["prototype"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["trappedKey"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["trappedKey"]), true);
$assert.notCallable(globalThis["trappedKey"]);
$assert.notConstructable(globalThis["trappedKey"]);
$assert.compareArray($Reflect_ownKeys(globalThis["trappedKey"]), ['a', 'b'], globalThis["trappedKey"]);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get, "name", {
  value: "get b",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "b")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["trappedKey"], "b", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get, "name", {
  value: "get a",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["trappedKey"], "a")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["trappedKey"], "a", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
