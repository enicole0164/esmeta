...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['name'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["name"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["name"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["name"]);
$assert.constructable(globalThis["assert"]?.["notSameValue"]?.["name"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["name"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["notSameValue"]?.["name"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]), ['constructor'], globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]);
$assert.sameValue(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"]?.["constructor"], globalThis["assert"]?.["notSameValue"]?.["name"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["name"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["name"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["name"], "name", {
  value: "name",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["name"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
