...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]), ['message'], globalThis["assert"]?.["throws"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["throws"]?.["message"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["throws"]?.["message"]), true);
$assert.callable(globalThis["assert"]?.["throws"]?.["message"]);
$assert.notConstructable(globalThis["assert"]?.["throws"]?.["message"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["throws"]?.["message"]), ['length', 'name'], globalThis["assert"]?.["throws"]?.["message"]);
$verifyProperty(globalThis["assert"]?.["throws"]?.["message"], "name", {
  value: "message",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"]?.["message"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["throws"], "message", {
  writable: true,
  enumerable: true,
  configurable: true,
});
