...
$assert.compareArray($Reflect_ownKeys(globalThis["Test262Error"]?.["prototype"]?.["toString"]), ['raw'], globalThis["Test262Error"]?.["prototype"]?.["toString"]);
$verifyProperty(globalThis["Test262Error"]?.["prototype"]?.["toString"], "raw", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['flags'], globalThis["assert"]?.["_isSameValue"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "flags", {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue($Object_getPrototypeOf(globalThis["item"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["item"]), true);
$assert.notCallable(globalThis["item"]);
$assert.notConstructable(globalThis["item"]);
$assert.compareArray($Reflect_ownKeys(globalThis["item"]), ['0', '1', 'length'], globalThis["item"]);
$verifyProperty(globalThis["item"], "1", {
  value: "bar",
  writable: true,
  enumerable: true,
  configurable: true,
});
$verifyProperty(globalThis["item"], "length", {
  value: 2.0,
  writable: true,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["item"], "0")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["item"], "0", {
  set: undefined,
  enumerable: true,
  configurable: true,
});
