...
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncIterable"]?.["next"]), AsyncGeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["asyncIterable"]?.["next"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
...
$assert.sameValue(globalThis["await"], globalThis["asyncIterable"]?.["next"]);
