...
$assert.compareArray($Reflect_ownKeys(globalThis["keys"]), ['length'], globalThis["keys"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["o"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["o"]), true);
$assert.callable(globalThis["o"]);
$assert.notConstructable(globalThis["o"]);
$assert.compareArray($Reflect_ownKeys(globalThis["o"]), ['length', 'name'], globalThis["o"]);
$verifyProperty(globalThis["o"], "name", {
  value: "o",
  writable: false,
  enumerable: false,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["result"]), [Symbol.split], globalThis["result"]);
$verifyProperty(globalThis["result"], Symbol.split, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.compareArray($Reflect_ownKeys(globalThis["z"]), [Symbol.split], globalThis["z"]);
$verifyProperty(globalThis["z"], Symbol.split, {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
