...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), [Symbol.iterator], globalThis["assert"]?.["_isSameValue"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"], Symbol.iterator, {
  value: "",
  writable: true,
  enumerable: true,
  configurable: true,
