...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['value'], globalThis["assert"]?.["_toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.["value"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.["value"]), true);
$assert.callable(globalThis["assert"]?.["_toString"]?.["value"]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.["value"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.["value"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["_toString"]?.["value"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.["value"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.["value"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["_toString"]?.["value"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.["value"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.["value"]?.["prototype"]), [], globalThis["assert"]?.["_toString"]?.["value"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["_toString"]?.["value"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.["value"], "name", {
  value: "value",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.["value"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"], "value", {
  writable: true,
  enumerable: true,
  configurable: true,
});
