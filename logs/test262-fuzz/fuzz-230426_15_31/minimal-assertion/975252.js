...
$assert.sameValue($Object_getPrototypeOf(globalThis["a1"]), Array.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a1"]), false);
$assert.notCallable(globalThis["a1"]);
$assert.notConstructable(globalThis["a1"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a1"]), ['length'], globalThis["a1"]);
$verifyProperty(globalThis["a1"], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: false,
});
$assert.sameValue($Object_getPrototypeOf(globalThis["a2"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["a2"]), true);
$assert.notCallable(globalThis["a2"]);
$assert.notConstructable(globalThis["a2"]);
$assert.compareArray($Reflect_ownKeys(globalThis["a2"]), ['0', 'length'], globalThis["a2"]);
$verifyProperty(globalThis["a2"], "length", {
  value: 1.0,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set), true);
$assert.callable(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set);
$assert.constructable(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set), ['length', 'name', 'prototype'], Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set);
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]), true);
$assert.notCallable(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]);
$assert.notConstructable(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]), ['constructor'], Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]);
$assert.sameValue(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"]?.["constructor"], Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set);
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set, "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set, "name", {
  value: "set",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(globalThis["a2"], "0")?.set, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["a2"], "0", {
  get: undefined,
  enumerable: false,
  configurable: false,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]), Array.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), ['0', 'length'], globalThis["assert"]?.["_toString"]);
...
$verifyProperty(globalThis["assert"]?.["_toString"], "0", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
