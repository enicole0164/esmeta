...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['next'], globalThis["assert"]?.["notSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["next"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["next"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["next"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["next"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["next"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["notSameValue"]?.["next"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["next"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["next"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["notSameValue"]?.["next"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["next"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["next"]?.["prototype"]), [], globalThis["assert"]?.["notSameValue"]?.["next"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["next"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["next"], "name", {
  value: "next",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["next"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"], "next", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["iterDoneSpy"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterDoneSpy"]), true);
$assert.notCallable(globalThis["iterDoneSpy"]);
$assert.notConstructable(globalThis["iterDoneSpy"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterDoneSpy"]), [Symbol.iterator], globalThis["iterDoneSpy"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterDoneSpy"]?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterDoneSpy"]?.[Symbol.iterator]), true);
$assert.callable(globalThis["iterDoneSpy"]?.[Symbol.iterator]);
$assert.constructable(globalThis["iterDoneSpy"]?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterDoneSpy"]?.[Symbol.iterator]), ['length', 'name', 'prototype'], globalThis["iterDoneSpy"]?.[Symbol.iterator]);
$assert.sameValue($Object_getPrototypeOf(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]), true);
$assert.notCallable(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]);
$assert.notConstructable(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]), ['constructor'], globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]);
$assert.sameValue(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"]?.["constructor"], globalThis["iterDoneSpy"]?.[Symbol.iterator]);
$verifyProperty(globalThis["iterDoneSpy"]?.[Symbol.iterator]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterDoneSpy"]?.[Symbol.iterator], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["iterDoneSpy"]?.[Symbol.iterator], "name", {
  value: "",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterDoneSpy"]?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["iterDoneSpy"], Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
