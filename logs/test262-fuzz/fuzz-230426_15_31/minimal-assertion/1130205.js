...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), [Symbol.isConcatSpreadable], globalThis["assert"]?.["sameValue"]);
$verifyProperty(globalThis["assert"]?.["sameValue"], Symbol.isConcatSpreadable, {
  value: null,
  writable: true,
  enumerable: true,
  configurable: true,
