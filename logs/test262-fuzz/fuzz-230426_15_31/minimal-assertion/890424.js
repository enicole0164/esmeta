...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['length'], globalThis["assert"]?.["notSameValue"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), [Symbol.split], globalThis["assert"]?.["_toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.[Symbol.split]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.[Symbol.split]), true);
$assert.callable(globalThis["assert"]?.["_toString"]?.[Symbol.split]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.[Symbol.split]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.[Symbol.split]), ['length', 'name'], globalThis["assert"]?.["_toString"]?.[Symbol.split]);
$verifyProperty(globalThis["assert"]?.["_toString"]?.[Symbol.split], "name", {
  value: "[Symbol.split]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.[Symbol.split], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"], Symbol.split, {
  writable: true,
  enumerable: true,
  configurable: true,
});
