...
$assert.sameValue(globalThis["FACTORY"]?.["prototype"], Function.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]), ['length', 'name', 'prototype', '_isSameValue', 'sameValue', 'notSameValue'], globalThis["assert"]);
