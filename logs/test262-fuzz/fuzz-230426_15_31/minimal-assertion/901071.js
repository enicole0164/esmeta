...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['name'], globalThis["assert"]?.["_isSameValue"]);
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), ['raw'], globalThis["assert"]?.["sameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["raw"]), GeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["raw"]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.["raw"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["raw"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["raw"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["sameValue"]?.["raw"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["raw"]?.["prototype"]), GeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["raw"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["sameValue"]?.["raw"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["raw"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["raw"]?.["prototype"]), [], globalThis["assert"]?.["sameValue"]?.["raw"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["raw"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["raw"], "name", {
  value: "raw",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["raw"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"], "raw", {
  writable: true,
  enumerable: true,
  configurable: true,
});
