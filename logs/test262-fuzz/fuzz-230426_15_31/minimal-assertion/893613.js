...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['multiline'], globalThis["assert"]?.["_isSameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["multiline"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.["multiline"]), true);
$assert.callable(globalThis["assert"]?.["_isSameValue"]?.["multiline"]);
$assert.constructable(globalThis["assert"]?.["_isSameValue"]?.["multiline"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["multiline"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["_isSameValue"]?.["multiline"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]), ['constructor'], globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]);
$assert.sameValue(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"]?.["constructor"], globalThis["assert"]?.["_isSameValue"]?.["multiline"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["multiline"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["multiline"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["multiline"], "name", {
  value: "multiline",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"]?.["multiline"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "multiline", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]), AsyncGeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
