...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), [Symbol.match], globalThis["assert"]?.["_toString"]);
$verifyProperty(globalThis["assert"]?.["_toString"], Symbol.match, {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
