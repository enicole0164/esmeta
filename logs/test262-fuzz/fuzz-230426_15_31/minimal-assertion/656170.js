...
$assert.sameValue($Object_getPrototypeOf(globalThis["__instance"]), Object.prototype);
...
$assert.compareArray($Reflect_ownKeys(globalThis["__instance"]), ['toString', 'concat'], globalThis["__instance"]);
...
$assert.sameValue(globalThis["__instance"]?.["concat"], String.prototype.concat);
$verifyProperty(globalThis["__instance"], "concat", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]), ['getOwnPropertyDescriptor'], globalThis["assert"]?.["notSameValue"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"], "getOwnPropertyDescriptor", {
  value: 0.0,
  writable: true,
  enumerable: true,
  configurable: true,
...
$assert.sameValue(globalThis["notexist"], undefined);
