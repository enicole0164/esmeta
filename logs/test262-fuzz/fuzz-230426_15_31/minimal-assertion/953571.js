...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]), ['configurable'], globalThis["assert"]?.["sameValue"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["configurable"]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["configurable"]), true);
$assert.callable(globalThis["assert"]?.["sameValue"]?.["configurable"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["configurable"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["configurable"]), ['length', 'name', 'prototype'], globalThis["assert"]?.["sameValue"]?.["configurable"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["sameValue"]?.["configurable"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["sameValue"]?.["configurable"]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["sameValue"]?.["configurable"]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["sameValue"]?.["configurable"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["sameValue"]?.["configurable"]?.["prototype"]), [], globalThis["assert"]?.["sameValue"]?.["configurable"]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["configurable"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["configurable"], "name", {
  value: "configurable",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"]?.["configurable"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["sameValue"], "configurable", {
  writable: true,
  enumerable: true,
  configurable: true,
});
...
$assert.sameValue($Object_getPrototypeOf(error), globalThis["Test262Error"]?.["prototype"]);
$assert.sameValue(Object.isExtensible(error), true);
$assert.notCallable(error);
$assert.notConstructable(error);
$assert.compareArray($Reflect_ownKeys(error), ['message'], error);
...
$assert.sameValue($Object_getPrototypeOf(iterNextValThrows), Object.prototype);
$assert.sameValue(Object.isExtensible(iterNextValThrows), true);
$assert.notCallable(iterNextValThrows);
$assert.notConstructable(iterNextValThrows);
$assert.compareArray($Reflect_ownKeys(iterNextValThrows), [Symbol.iterator], iterNextValThrows);
$assert.sameValue($Object_getPrototypeOf(iterNextValThrows?.[Symbol.iterator]), Function.prototype);
$assert.sameValue(Object.isExtensible(iterNextValThrows?.[Symbol.iterator]), true);
$assert.callable(iterNextValThrows?.[Symbol.iterator]);
$assert.notConstructable(iterNextValThrows?.[Symbol.iterator]);
$assert.compareArray($Reflect_ownKeys(iterNextValThrows?.[Symbol.iterator]), ['length', 'name'], iterNextValThrows?.[Symbol.iterator]);
$verifyProperty(iterNextValThrows?.[Symbol.iterator], "name", {
  value: "[Symbol.iterator]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterNextValThrows?.[Symbol.iterator], "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(iterNextValThrows, Symbol.iterator, {
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(poisoned), Object.prototype);
$assert.sameValue(Object.isExtensible(poisoned), true);
$assert.notCallable(poisoned);
$assert.notConstructable(poisoned);
$assert.compareArray($Reflect_ownKeys(poisoned), ['done', 'value'], poisoned);
$verifyProperty(poisoned, "done", {
  value: false,
  writable: true,
  enumerable: true,
  configurable: true,
});
$assert.sameValue($Object_getPrototypeOf(Object.getOwnPropertyDescriptor(poisoned, "value")?.get), Function.prototype);
$assert.sameValue(Object.isExtensible(Object.getOwnPropertyDescriptor(poisoned, "value")?.get), true);
$assert.callable(Object.getOwnPropertyDescriptor(poisoned, "value")?.get);
$assert.notConstructable(Object.getOwnPropertyDescriptor(poisoned, "value")?.get);
$assert.compareArray($Reflect_ownKeys(Object.getOwnPropertyDescriptor(poisoned, "value")?.get), ['length', 'name'], Object.getOwnPropertyDescriptor(poisoned, "value")?.get);
$verifyProperty(Object.getOwnPropertyDescriptor(poisoned, "value")?.get, "name", {
  value: "get",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(Object.getOwnPropertyDescriptor(poisoned, "value")?.get, "length", {
  value: 0.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(poisoned, "value", {
  set: undefined,
  enumerable: false,
  configurable: false,
});
