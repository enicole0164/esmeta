...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["construct"]), AsyncFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["notSameValue"]?.["construct"]), true);
$assert.callable(globalThis["assert"]?.["notSameValue"]?.["construct"]);
$assert.notConstructable(globalThis["assert"]?.["notSameValue"]?.["construct"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["notSameValue"]?.["construct"]), ['length', 'name'], globalThis["assert"]?.["notSameValue"]?.["construct"]);
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["construct"], "name", {
  value: "construct",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["notSameValue"]?.["construct"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
