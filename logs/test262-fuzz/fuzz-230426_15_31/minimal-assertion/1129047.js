...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_isSameValue"]), ['lastIndex'], globalThis["assert"]?.["_isSameValue"]);
$verifyProperty(globalThis["assert"]?.["_isSameValue"], "lastIndex", {
  value: true,
  writable: true,
  enumerable: true,
  configurable: true,
