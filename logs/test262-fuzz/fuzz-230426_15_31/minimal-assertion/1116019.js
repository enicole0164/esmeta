...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["groups"]), AsyncGeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["notSameValue"]?.["groups"]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
