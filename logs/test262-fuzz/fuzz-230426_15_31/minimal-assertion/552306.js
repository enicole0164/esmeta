...
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]), [Symbol.species], globalThis["assert"]?.["_toString"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.[Symbol.species]), AsyncGeneratorFunction.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.[Symbol.species]), true);
$assert.callable(globalThis["assert"]?.["_toString"]?.[Symbol.species]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.[Symbol.species]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.[Symbol.species]), ['length', 'name', 'prototype'], globalThis["assert"]?.["_toString"]?.[Symbol.species]);
$assert.sameValue($Object_getPrototypeOf(globalThis["assert"]?.["_toString"]?.[Symbol.species]?.["prototype"]), AsyncGeneratorFunction.prototype.prototype);
$assert.sameValue(Object.isExtensible(globalThis["assert"]?.["_toString"]?.[Symbol.species]?.["prototype"]), true);
$assert.notCallable(globalThis["assert"]?.["_toString"]?.[Symbol.species]?.["prototype"]);
$assert.notConstructable(globalThis["assert"]?.["_toString"]?.[Symbol.species]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["assert"]?.["_toString"]?.[Symbol.species]?.["prototype"]), [], globalThis["assert"]?.["_toString"]?.[Symbol.species]?.["prototype"]);
$verifyProperty(globalThis["assert"]?.["_toString"]?.[Symbol.species], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.[Symbol.species], "name", {
  value: "[Symbol.species]",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"]?.[Symbol.species], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["assert"]?.["_toString"], Symbol.species, {
  writable: true,
  enumerable: true,
  configurable: true,
});
