...
$assert.compareArray($Reflect_ownKeys(globalThis["spreadableHasPoisonedIndex"]), ['constructor', Symbol.isConcatSpreadable], globalThis["spreadableHasPoisonedIndex"]);
...
$assert.sameValue($Object_getPrototypeOf(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]), Function.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]), true);
$assert.callable(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]);
$assert.constructable(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]), ['length', 'name', 'prototype'], globalThis["spreadableHasPoisonedIndex"]?.["constructor"]);
$assert.sameValue($Object_getPrototypeOf(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]), Object.prototype);
$assert.sameValue(Object.isExtensible(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]), true);
$assert.notCallable(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]);
$assert.notConstructable(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]);
$assert.compareArray($Reflect_ownKeys(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]), ['constructor'], globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]);
$assert.sameValue(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"]?.["constructor"], globalThis["spreadableHasPoisonedIndex"]?.["constructor"]);
$verifyProperty(globalThis["spreadableHasPoisonedIndex"]?.["constructor"]?.["prototype"], "constructor", {
  writable: true,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spreadableHasPoisonedIndex"]?.["constructor"], "prototype", {
  writable: true,
  enumerable: false,
  configurable: false,
});
$verifyProperty(globalThis["spreadableHasPoisonedIndex"]?.["constructor"], "name", {
  value: "constructor",
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spreadableHasPoisonedIndex"]?.["constructor"], "length", {
  value: 1.0,
  writable: false,
  enumerable: false,
  configurable: true,
});
$verifyProperty(globalThis["spreadableHasPoisonedIndex"], "constructor", {
  writable: true,
  enumerable: true,
  configurable: true,
});
