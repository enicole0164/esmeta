...
var x = /*#__PURE__*/function () {
  ...
  _createClass(x, [{
    key: "0",
    value: /*#__PURE__*/_regeneratorRuntime().mark(function _() {
      return _regeneratorRuntime().wrap(function _$(_context) {
        while (1) {
...
$assert.sameValue($Object_getPrototypeOf(x?.["prototype"]?.["0"]), GeneratorFunction.prototype);
...
$assert.sameValue($Object_getPrototypeOf(x?.["prototype"]?.["0"]?.["prototype"]), GeneratorFunction.prototype.prototype);
